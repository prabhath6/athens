...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__50846 = goog.object.get(JSJodaLocale,"Locale");
if((G__50846 == null)){
return null;
} else {
return goog.object.get(G__50846,"US");
}
}catch (e50845){if((e50845 instanceof Error)){
var e = e50845;
return null;
} else {
throw e50845;
