...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__50858 = goog.object.get(JSJodaLocale,"Locale");
if((G__50858 == null)){
return null;
} else {
return goog.object.get(G__50858,"US");
}
}catch (e50857){if((e50857 instanceof Error)){
var e = e50857;
return null;
} else {
throw e50857;
