...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__50857 = goog.object.get(JSJodaLocale,"Locale");
if((G__50857 == null)){
return null;
} else {
return goog.object.get(G__50857,"US");
}
}catch (e50855){if((e50855 instanceof Error)){
var e = e50855;
return null;
} else {
throw e50855;
