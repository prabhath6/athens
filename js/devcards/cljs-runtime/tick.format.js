...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__50898 = goog.object.get(JSJodaLocale,"Locale");
if((G__50898 == null)){
return null;
} else {
return goog.object.get(G__50898,"US");
}
