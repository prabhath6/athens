...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__50691 = goog.object.get(JSJodaLocale,"Locale");
if((G__50691 == null)){
return null;
} else {
return goog.object.get(G__50691,"US");
}
}catch (e50688){if((e50688 instanceof Error)){
var e = e50688;
return null;
} else {
throw e50688;
