...
var G__26279 = datascript.lru.__GT_LRU(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(key_value,k,v),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(gen_key,gen,k),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(key_gen,k,gen),(gen + (1)),limit);
return (datascript.lru.cleanup_lru.cljs$core$IFn$_invoke$arity$1 ? datascript.lru.cleanup_lru.cljs$core$IFn$_invoke$arity$1(G__26279) : datascript.lru.cleanup_lru.call(null,G__26279));
}
});
...
var gen = lru.gen;
var limit = lru.limit;
var vec__26280 = cljs.core.first(gen_key);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26280,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26280,(1),null);
