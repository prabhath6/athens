...
}catch (e24202){var _e__20490__auto__ = e24202;
return false;
...
}catch (e24204){var _e__20490__auto__ = e24204;
return false;
...
}catch (e24206){var _e__20490__auto__ = e24206;
return false;
...
}catch (e24208){var _e__20490__auto__ = e24208;
return false;
...
}catch (e24210){var _e__20490__auto__ = e24210;
return false;
}})())){
...
}catch (e24212){var _e__20490__auto__ = e24212;
return false;
}})())){
...
var _STAR_current_state_STAR__orig_val__24214 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__24215 = (function (){var or__4185__auto__ = config;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
...
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__24215);

try{return (raw_fn.cljs$core$IFn$_invoke$arity$1 ? raw_fn.cljs$core$IFn$_invoke$arity$1(value) : raw_fn.call(null,value));
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__24214);
}});
});
...
while (G__24224__i < G__24224__a.length) {G__24224__a[G__24224__i] = arguments[G__24224__i + 0]; ++G__24224__i;}
  args = new cljs.core.IndexedSeq(G__24224__a,0,null);
} 
return G__24222__delegate.call(this,args);};
G__24222.cljs$lang$maxFixedArity = 0;
G__24222.cljs$lang$applyTo = (function (arglist__24225){
