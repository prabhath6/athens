...
var vec__57314 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57314,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57314,(1),null);
...
var vec__57317 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57317,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57317,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__57320 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57320,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57320,(1),null);
...
var G__57381 = cljs.core.next(parses__$1);
parses__$1 = G__57381;
continue;
}
...
var G__57328 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57329 = G__57328;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57329,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57329,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57329,(2),null);
var selection = vec__57329;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57328__$1 = G__57328;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57335 = G__57328__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57335,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57335,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57335,(2),null);
var selection__$1 = vec__57335;
...
var G__57383 = cljs.core.long$(end__$1);
var G__57384 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57385 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57383;
parses__$1 = G__57384;
G__57328__$1 = G__57385;
continue;
...
var G__57343 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57344 = G__57343;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57344,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57344,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57344,(2),null);
var selection = vec__57344;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57343__$1 = G__57343;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57350 = G__57343__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57350,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57350,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57350,(2),null);
var selection__$1 = vec__57350;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__57387 = cljs.core.long$(end__$1);
var G__57388 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57389 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57387;
parses__$1 = G__57388;
G__57343__$1 = G__57389;
continue;
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__57358 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57359 = G__57358;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57359,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57359,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57359,(2),null);
var selection = vec__57359;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57358__$1 = G__57358;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57365 = G__57358__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57365,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57365,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57365,(2),null);
var selection__$1 = vec__57365;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__57391 = cljs.core.long$(end__$1);
var G__57392 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57393 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57391;
parses__$1 = G__57392;
G__57358__$1 = G__57393;
continue;
...
if(cljs.core.truth_((function (){var fexpr__57370 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__57370.cljs$core$IFn$_invoke$arity$1 ? fexpr__57370.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__57370.call(null,output_format));
})())){
} else {
...
var G__57371 = output_format;
var G__57371__$1 = (((G__57371 instanceof cljs.core.Keyword))?G__57371.fqn:null);
switch (G__57371__$1) {
case "enlive":
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4174__auto__ = (function (){var G__57379 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__57378 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__57378.cljs$core$IFn$_invoke$arity$1 ? fexpr__57378.cljs$core$IFn$_invoke$arity$1(G__57379) : fexpr__57378.call(null,G__57379));
})();
