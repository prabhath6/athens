...
var vec__57400 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57400,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57400,(1),null);
...
var vec__57403 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57403,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57403,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__57406 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57406,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57406,(1),null);
...
var G__57467 = cljs.core.next(parses__$1);
parses__$1 = G__57467;
continue;
}
...
var G__57414 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57415 = G__57414;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57415,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57415,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57415,(2),null);
var selection = vec__57415;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57414__$1 = G__57414;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57421 = G__57414__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57421,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57421,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57421,(2),null);
var selection__$1 = vec__57421;
...
var G__57469 = cljs.core.long$(end__$1);
var G__57470 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57471 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57469;
parses__$1 = G__57470;
G__57414__$1 = G__57471;
continue;
...
var G__57429 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57430 = G__57429;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57430,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57430,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57430,(2),null);
var selection = vec__57430;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57429__$1 = G__57429;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57436 = G__57429__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57436,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57436,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57436,(2),null);
var selection__$1 = vec__57436;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__57473 = cljs.core.long$(end__$1);
var G__57474 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57475 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57473;
parses__$1 = G__57474;
G__57429__$1 = G__57475;
continue;
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__57444 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57445 = G__57444;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57445,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57445,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57445,(2),null);
var selection = vec__57445;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57444__$1 = G__57444;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57451 = G__57444__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57451,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57451,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57451,(2),null);
var selection__$1 = vec__57451;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__57477 = cljs.core.long$(end__$1);
var G__57478 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57479 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57477;
parses__$1 = G__57478;
G__57444__$1 = G__57479;
continue;
...
if(cljs.core.truth_((function (){var fexpr__57456 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__57456.cljs$core$IFn$_invoke$arity$1 ? fexpr__57456.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__57456.call(null,output_format));
})())){
} else {
...
var G__57457 = output_format;
var G__57457__$1 = (((G__57457 instanceof cljs.core.Keyword))?G__57457.fqn:null);
switch (G__57457__$1) {
case "enlive":
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4174__auto__ = (function (){var G__57465 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__57464 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__57464.cljs$core$IFn$_invoke$arity$1 ? fexpr__57464.cljs$core$IFn$_invoke$arity$1(G__57465) : fexpr__57464.call(null,G__57465));
})();
