...
var vec__57295 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57295,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57295,(1),null);
...
var vec__57298 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57298,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57298,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__57301 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57301,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57301,(1),null);
...
var G__57362 = cljs.core.next(parses__$1);
parses__$1 = G__57362;
continue;
}
...
var G__57309 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57310 = G__57309;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57310,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57310,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57310,(2),null);
var selection = vec__57310;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57309__$1 = G__57309;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57316 = G__57309__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57316,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57316,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57316,(2),null);
var selection__$1 = vec__57316;
...
var G__57364 = cljs.core.long$(end__$1);
var G__57365 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57366 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57364;
parses__$1 = G__57365;
G__57309__$1 = G__57366;
continue;
...
var G__57324 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57325 = G__57324;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57325,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57325,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57325,(2),null);
var selection = vec__57325;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57324__$1 = G__57324;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57331 = G__57324__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57331,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57331,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57331,(2),null);
var selection__$1 = vec__57331;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__57368 = cljs.core.long$(end__$1);
var G__57369 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57370 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57368;
parses__$1 = G__57369;
G__57324__$1 = G__57370;
continue;
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__57339 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57340 = G__57339;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57340,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57340,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57340,(2),null);
var selection = vec__57340;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57339__$1 = G__57339;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57346 = G__57339__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57346,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57346,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57346,(2),null);
var selection__$1 = vec__57346;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__57372 = cljs.core.long$(end__$1);
var G__57373 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57374 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57372;
parses__$1 = G__57373;
G__57339__$1 = G__57374;
continue;
...
if(cljs.core.truth_((function (){var fexpr__57351 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__57351.cljs$core$IFn$_invoke$arity$1 ? fexpr__57351.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__57351.call(null,output_format));
})())){
} else {
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4174__auto__ = (function (){var G__57360 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__57359 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__57359.cljs$core$IFn$_invoke$arity$1 ? fexpr__57359.cljs$core$IFn$_invoke$arity$1(G__57360) : fexpr__57359.call(null,G__57360));
})();
