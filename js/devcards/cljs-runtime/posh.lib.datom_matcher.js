...
var or__4185__auto____$1 = ((cljs.core.set_QMARK_(p))?(function (){var G__29063 = cljs.core.first(datom);
...
var G__29072 = cljs.core.rest(pattern);
var G__29073 = cljs.core.rest(datom);
pattern = G__29072;
datom = G__29073;
continue;
} else {
...
var G__29082 = clojure.set.union.cljs$core$IFn$_invoke$arity$2(entids,((cljs.core.set_QMARK_(cljs.core.ffirst(patterns)))?cljs.core.ffirst(patterns):cljs.core.set(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.ffirst(patterns)], null))));
var G__29083 = rest_datom;
var G__29084 = cljs.core.rest(patterns);
var G__29085 = new_patterns;
var G__29086 = leftover_patterns;
entids = G__29082;
rest_datom = G__29083;
patterns = G__29084;
new_patterns = G__29085;
leftover_patterns = G__29086;
continue;
} else {
var G__29091 = entids;
var G__29092 = rest_datom;
var G__29093 = cljs.core.rest(patterns);
var G__29094 = new_patterns;
var G__29095 = cljs.core.cons(cljs.core.first(patterns),leftover_patterns);
entids = G__29091;
rest_datom = G__29092;
patterns = G__29093;
new_patterns = G__29094;
leftover_patterns = G__29095;
continue;
}
}
break;
...
var G__29106 = new cljs.core.Keyword(null,"new-patterns","new-patterns",404552774).cljs$core$IFn$_invoke$arity$1(r);
var G__29107 = new cljs.core.Keyword(null,"leftover-patterns","leftover-patterns",377032963).cljs$core$IFn$_invoke$arity$1(r);
new_patterns = G__29106;
leftover_patterns = G__29107;
continue;
} else {
var G__29112 = cljs.core.cons(cljs.core.first(leftover_patterns),new_patterns);
var G__29113 = cljs.core.rest(leftover_patterns);
new_patterns = G__29112;
leftover_patterns = G__29113;
continue;
}
}
break;
