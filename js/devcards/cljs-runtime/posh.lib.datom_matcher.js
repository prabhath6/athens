...
var or__4185__auto____$1 = ((cljs.core.set_QMARK_(p))?(function (){var G__29060 = cljs.core.first(datom);
...
var G__29068 = cljs.core.rest(pattern);
var G__29069 = cljs.core.rest(datom);
pattern = G__29068;
datom = G__29069;
continue;
} else {
...
return cljs.core.some((function (p1__29061_SHARP_){
return posh.lib.datom_matcher.datom_match_pattern_QMARK_(p1__29061_SHARP_,datom);
}),patterns);
});
...
var G__29071 = clojure.set.union.cljs$core$IFn$_invoke$arity$2(entids,((cljs.core.set_QMARK_(cljs.core.ffirst(patterns)))?cljs.core.ffirst(patterns):cljs.core.set(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.ffirst(patterns)], null))));
var G__29072 = rest_datom;
var G__29073 = cljs.core.rest(patterns);
var G__29074 = new_patterns;
var G__29075 = leftover_patterns;
entids = G__29071;
rest_datom = G__29072;
patterns = G__29073;
...
var G__29076 = entids;
var G__29077 = rest_datom;
var G__29078 = cljs.core.rest(patterns);
var G__29079 = new_patterns;
var G__29080 = cljs.core.cons(cljs.core.first(patterns),leftover_patterns);
entids = G__29076;
rest_datom = G__29077;
patterns = G__29078;
...
var G__29081 = new cljs.core.Keyword(null,"new-patterns","new-patterns",404552774).cljs$core$IFn$_invoke$arity$1(r);
var G__29082 = new cljs.core.Keyword(null,"leftover-patterns","leftover-patterns",377032963).cljs$core$IFn$_invoke$arity$1(r);
new_patterns = G__29081;
leftover_patterns = G__29082;
continue;
} else {
var G__29083 = cljs.core.cons(cljs.core.first(leftover_patterns),new_patterns);
var G__29084 = cljs.core.rest(leftover_patterns);
new_patterns = G__29083;
leftover_patterns = G__29084;
continue;
}
}
break;
