...
var G__57955 = new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"block","block",664686210),(function() { 
var G__57973__delegate = function (contents){
...
var G__57974__i = 0, G__57974__a = new Array(arguments.length -  0);
while (G__57974__i < G__57974__a.length) {G__57974__a[G__57974__i] = arguments[G__57974__i + 0]; ++G__57974__i;}
  contents = new cljs.core.IndexedSeq(G__57974__a,0,null);
} 
return G__57973__delegate.call(this,contents);};
G__57973.cljs$lang$maxFixedArity = 0;
G__57973.cljs$lang$applyTo = (function (arglist__57975){
var contents = cljs.core.seq(arglist__57975);
return G__57973__delegate(contents);
});
...
var node = (function (){var G__57957 = athens.db.dsdb;
var G__57958 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__57959 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),title], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__57957,G__57958,G__57959) : posh.reagent.pull.call(null,G__57957,G__57958,G__57959));
})();
...
var block = (function (){var G__57960 = athens.db.dsdb;
var G__57961 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__57962 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),uid], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__57960,G__57961,G__57962) : posh.reagent.pull.call(null,G__57960,G__57961,G__57962));
})();
...
})], null),(function (){var G__57963 = new cljs.core.Keyword("block","string","block/string",-2066596447).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(block));
return (athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$1 ? athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$1(G__57963) : athens.parse_renderer.parse_and_render.call(null,G__57963));
})()], null)], null);
}),new cljs.core.Keyword(null,"hashtag","hashtag",-529028899),(function (tag_name){
var node = (function (){var G__57964 = athens.db.dsdb;
var G__57965 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__57966 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),tag_name], null);
...
}),new cljs.core.Keyword(null,"url-image","url-image",535142411),(function (p__57967){
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57968__$1,new cljs.core.Keyword(null,"url","url",276297046));
var alt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57968__$1,new cljs.core.Keyword(null,"alt","alt",-3214426));
...
}),new cljs.core.Keyword(null,"url-link","url-link",1615670141),(function (p__57970,text){
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57971__$1,new cljs.core.Keyword(null,"url","url",276297046));
...
var G__57956 = tree;
return (instaparse.core.transform.cljs$core$IFn$_invoke$arity$2 ? instaparse.core.transform.cljs$core$IFn$_invoke$arity$2(G__57955,G__57956) : instaparse.core.transform.call(null,G__57955,G__57956));
});
/**
