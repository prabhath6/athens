...
var G__51848 = new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"block","block",664686210),(function() { 
var G__51860__delegate = function (contents){
...
var G__51860 = function (var_args){
var contents = null;
if (arguments.length > 0) {
var G__51861__i = 0, G__51861__a = new Array(arguments.length -  0);
while (G__51861__i < G__51861__a.length) {G__51861__a[G__51861__i] = arguments[G__51861__i + 0]; ++G__51861__i;}
  contents = new cljs.core.IndexedSeq(G__51861__a,0,null);
} 
return G__51860__delegate.call(this,contents);};
G__51860.cljs$lang$maxFixedArity = 0;
G__51860.cljs$lang$applyTo = (function (arglist__51862){
var contents = cljs.core.seq(arglist__51862);
return G__51860__delegate(contents);
});
G__51860.cljs$core$IFn$_invoke$arity$variadic = G__51860__delegate;
return G__51860;
})()
,new cljs.core.Keyword(null,"page-link","page-link",-169621200),(function (title){
var id = (function (){var G__51850 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),title], null)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__51850) : re_frame.core.subscribe.call(null,G__51850));
})();
...
var string = (function (){var G__51851 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","string","block/string",-2066596447),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),uid], null)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__51851) : re_frame.core.subscribe.call(null,G__51851));
})();
...
})], null),(function (){var G__51852 = new cljs.core.Keyword("block","string","block/string",-2066596447).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(string));
return (athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$1 ? athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$1(G__51852) : athens.parse_renderer.parse_and_render.call(null,G__51852));
})()], null)], null);
}),new cljs.core.Keyword(null,"hashtag","hashtag",-529028899),(function (tag_name){
var id = (function (){var G__51853 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),tag_name], null)], null);
...
}),new cljs.core.Keyword(null,"url-image","url-image",535142411),(function (p__51854){
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51855__$1,new cljs.core.Keyword(null,"url","url",276297046));
var alt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51855__$1,new cljs.core.Keyword(null,"alt","alt",-3214426));
...
}),new cljs.core.Keyword(null,"url-link","url-link",1615670141),(function (p__51857,text){
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51858__$1,new cljs.core.Keyword(null,"url","url",276297046));
...
var G__51849 = tree;
return (instaparse.core.transform.cljs$core$IFn$_invoke$arity$2 ? instaparse.core.transform.cljs$core$IFn$_invoke$arity$2(G__51848,G__51849) : instaparse.core.transform.call(null,G__51848,G__51849));
});
/**
