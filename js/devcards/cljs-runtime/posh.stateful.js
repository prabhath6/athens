...
var len__4789__auto___31269 = arguments.length;
var i__4790__auto___31270 = (0);
while(true){
if((i__4790__auto___31270 < len__4789__auto___31269)){
args__4795__auto__.push((arguments[i__4790__auto___31270]));

var G__31271 = (i__4790__auto___31270 + (1));
i__4790__auto___31270 = G__31271;
continue;
} else {
}
break;
...
/** @this {Function} */
(posh.stateful.add_q.cljs$lang$applyTo = (function (seq31248){
var G__31249 = cljs.core.first(seq31248);
var seq31248__$1 = cljs.core.next(seq31248);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31249,seq31248__$1);
}));

posh.stateful.add_filter_tx = (function posh$stateful$add_filter_tx(poshdb,tx_patterns){
var posh_atom = posh.stateful.get_posh_atom(poshdb);
return cljs.core.with_meta(new cljs.core.Keyword(null,"return","return",-1891502105).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(posh_atom,(function (p1__31250_SHARP_){
return posh.core.add_filter_tx(p1__31250_SHARP_,poshdb,tx_patterns);
...
var posh_atom = posh.stateful.get_posh_atom(poshdb);
return cljs.core.with_meta(new cljs.core.Keyword(null,"return","return",-1891502105).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(posh_atom,(function (p1__31251_SHARP_){
return posh.core.add_filter_pull(p1__31251_SHARP_,poshdb,pull_pattern,eid);
}))),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"posh","posh",-1205664462),posh_atom], null));
});
posh.stateful.add_filter_q = (function posh$stateful$add_filter_q(var_args){
var args__4795__auto__ = [];
var len__4789__auto___31272 = arguments.length;
var i__4790__auto___31273 = (0);
while(true){
if((i__4790__auto___31273 < len__4789__auto___31272)){
args__4795__auto__.push((arguments[i__4790__auto___31273]));

var G__31274 = (i__4790__auto___31273 + (1));
i__4790__auto___31273 = G__31274;
continue;
} else {
}
break;
...
var posh_atom = cljs.core.first(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2(posh.stateful.get_posh_atom,args)));
return cljs.core.with_meta(new cljs.core.Keyword(null,"return","return",-1891502105).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(posh_atom,(function (p1__31252_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$4(posh.core.add_filter_q,p1__31252_SHARP_,query,args);
}))),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"posh","posh",-1205664462),posh_atom], null));
}));
...
/** @this {Function} */
(posh.stateful.add_filter_q.cljs$lang$applyTo = (function (seq31253){
var G__31254 = cljs.core.first(seq31253);
var seq31253__$1 = cljs.core.next(seq31253);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31254,seq31253__$1);
}));
