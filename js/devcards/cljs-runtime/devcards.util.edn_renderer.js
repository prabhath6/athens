...
}catch (e41186){if((e41186 instanceof Error)){
var e = e41186;
return devcards.util.edn_renderer.clearfix_separator_STAR_;
} else {
throw e41186;
...
devcards.util.edn_renderer.html_keyval = (function devcards$util$edn_renderer$html_keyval(p__41191){
var vec__41192 = p__41191;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41192,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41192,(1),null);
...
var _STAR_key_counter_STAR__orig_val__41202 = devcards.util.edn_renderer._STAR_key_counter_STAR_;
var _STAR_key_counter_STAR__temp_val__41203 = cljs.core.atom.cljs$core$IFn$_invoke$arity$1((0));
(devcards.util.edn_renderer._STAR_key_counter_STAR_ = _STAR_key_counter_STAR__temp_val__41203);
...
}finally {(devcards.util.edn_renderer._STAR_key_counter_STAR_ = _STAR_key_counter_STAR__orig_val__41202);
}});
