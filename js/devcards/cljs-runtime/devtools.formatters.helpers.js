...
var G__22007 = devtools.prefs.pref(v);
v = G__22007;
continue;
} else {
return v;
...
}catch (e21956){var _e__20490__auto__ = e21956;
return false;
}})();
...
}catch (e21966){var _e__20490__auto__ = e21966;
return false;
}})();
...
}catch (e21971){var _e__20490__auto__ = e21971;
return false;
}}
}
});
...
var vec__21989 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21989,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21989,(1),null);
...
return cljs.core.some((function (p1__21995_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__21995_SHARP_);
}),template);
});
