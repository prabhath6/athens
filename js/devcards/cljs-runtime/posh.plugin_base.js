...
var G__31176_31341 = conn;
var G__31177_31342 = new cljs.core.Keyword(null,"posh-dispenser","posh-dispenser",-482466766);
var G__31178_31343 = (function (var$){
...
var fexpr__31175_31344 = new cljs.core.Keyword(null,"listen!","listen!",-1756109477).cljs$core$IFn$_invoke$arity$1(dcfg);
(fexpr__31175_31344.cljs$core$IFn$_invoke$arity$3 ? fexpr__31175_31344.cljs$core$IFn$_invoke$arity$3(G__31176_31341,G__31177_31342,G__31178_31343) : fexpr__31175_31344.call(null,G__31176_31341,G__31177_31342,G__31178_31343));
...
var vec__31199 = chunk__31186.cljs$core$IIndexed$_nth$arity$2(null,i__31188);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31199,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31199,(1),null);
...
var vec__31204 = cljs.core.first(seq__31185__$1);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31204,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31204,(1),null);
cljs.core.reset_BANG_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(ratoms,k),new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(v));
...
/** @this {Function} */
(posh.plugin_base.posh_BANG_.cljs$lang$applyTo = (function (seq31209){
var G__31211 = cljs.core.first(seq31209);
var seq31209__$1 = cljs.core.next(seq31209);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31211,seq31209__$1);
}));

posh.plugin_base.get_conn_var = (function posh$plugin_base$get_conn_var(dcfg,conn,var$){
var fexpr__31223 = new cljs.core.Keyword(null,"posh-dispenser","posh-dispenser",-482466766).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(new cljs.core.Keyword(null,"listeners","listeners",394544445).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(conn))));
return (fexpr__31223.cljs$core$IFn$_invoke$arity$1 ? fexpr__31223.cljs$core$IFn$_invoke$arity$1(var$) : fexpr__31223.call(null,var$));
});
posh.plugin_base.get_posh_atom = (function posh$plugin_base$get_posh_atom(dcfg,poshdb_or_conn){
if(cljs.core.truth_((function (){var fexpr__31224 = new cljs.core.Keyword(null,"conn?","conn?",167224275).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__31224.cljs$core$IFn$_invoke$arity$1 ? fexpr__31224.cljs$core$IFn$_invoke$arity$1(poshdb_or_conn) : fexpr__31224.call(null,poshdb_or_conn));
})())){
...
if(cljs.core.truth_((function (){var fexpr__31230 = new cljs.core.Keyword(null,"conn?","conn?",167224275).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__31230.cljs$core$IFn$_invoke$arity$1 ? fexpr__31230.cljs$core$IFn$_invoke$arity$1(poshdb_or_conn) : fexpr__31230.call(null,poshdb_or_conn));
})())){
...
var fexpr__31246 = new cljs.core.Keyword(null,"ratom","ratom",-126521267).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__31246.cljs$core$IFn$_invoke$arity$1 ? fexpr__31246.cljs$core$IFn$_invoke$arity$1(query_result) : fexpr__31246.call(null,query_result));
}
})();
var query_reaction = (function (){var G__31250 = (function (){
return cljs.core.deref(query_ratom);
});
var G__31251 = new cljs.core.Keyword(null,"on-dispose","on-dispose",2105306360);
var G__31252 = (function (_,___$1){
...
var fexpr__31249 = new cljs.core.Keyword(null,"make-reaction","make-reaction",295148585).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__31249.cljs$core$IFn$_invoke$arity$3 ? fexpr__31249.cljs$core$IFn$_invoke$arity$3(G__31250,G__31251,G__31252) : fexpr__31249.call(null,G__31250,G__31251,G__31252));
})();
...
return posh.plugin_base.make_query_reaction.cljs$core$IFn$_invoke$arity$5(dcfg,posh_atom,storage_key,(function (p1__31259_SHARP_){
return posh.core.add_pull(p1__31259_SHARP_,true_poshdb,pull_pattern,eid);
}),options);
}));
...
var posh_atom = posh.plugin_base.get_posh_atom(dcfg,poshdb);
return posh.plugin_base.make_query_reaction.cljs$core$IFn$_invoke$arity$5(dcfg,posh_atom,storage_key,(function (p1__31272_SHARP_){
return posh.core.add_pull_many(p1__31272_SHARP_,true_poshdb,pull_pattern,eids);
}),options);
}));
...
return cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__31287,query_item){
var vec__31289 = p__31287;
var parsed_query = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31289,(0),null);
var last_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31289,(1),null);
...
var vec__31307 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(n_query_args,cljs.core.count(args)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [args,cljs.core.PersistentArrayMap.EMPTY], null):((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((n_query_args + (1)),cljs.core.count(args)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.butlast(args),cljs.core.last(args)], null):(function(){throw "Incorrect number of args passed to posh query"})()
));
var args__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31307,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31307,(1),null);
var true_poshdb_args = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31296_SHARP_){
if(cljs.core.truth_((function (){var fexpr__31312 = new cljs.core.Keyword(null,"conn?","conn?",167224275).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__31312.cljs$core$IFn$_invoke$arity$1 ? fexpr__31312.cljs$core$IFn$_invoke$arity$1(p1__31296_SHARP_) : fexpr__31312.call(null,p1__31296_SHARP_));
})())){
return posh.plugin_base.get_db(dcfg,p1__31296_SHARP_);
} else {
return p1__31296_SHARP_;
}
}),args__$1);
var posh_atom = cljs.core.first(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31297_SHARP_){
return posh.plugin_base.get_posh_atom(dcfg,p1__31297_SHARP_);
}),args__$1)));
...
return posh.plugin_base.make_query_reaction.cljs$core$IFn$_invoke$arity$5(dcfg,posh_atom,storage_key,(function (p1__31298_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$3(posh.core.add_q,p1__31298_SHARP_,query),true_poshdb_args);
}),options);
}));
...
/** @this {Function} */
(posh.plugin_base.q.cljs$lang$applyTo = (function (seq31300){
var G__31301 = cljs.core.first(seq31300);
var seq31300__$1 = cljs.core.next(seq31300);
var G__31302 = cljs.core.first(seq31300__$1);
var seq31300__$2 = cljs.core.next(seq31300__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31301,G__31302,seq31300__$2);
}));
...
return (fexpr__31321.cljs$core$IFn$_invoke$arity$1 ? fexpr__31321.cljs$core$IFn$_invoke$arity$1(p1__31316_SHARP_) : fexpr__31321.call(null,p1__31316_SHARP_));
})())){
...
/** @this {Function} */
(posh.plugin_base.q_info.cljs$lang$applyTo = (function (seq31318){
...
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31319,G__31320,seq31318__$2);
}));
...
/** @this {Function} */
(posh.plugin_base.q_tx.cljs$lang$applyTo = (function (seq31322){
var G__31323 = cljs.core.first(seq31322);
var seq31322__$1 = cljs.core.next(seq31322);
var G__31324 = cljs.core.first(seq31322__$1);
var seq31322__$2 = cljs.core.next(seq31322__$1);
var G__31325 = cljs.core.first(seq31322__$2);
var seq31322__$3 = cljs.core.next(seq31322__$2);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31323,G__31324,G__31325,seq31322__$3);
}));
