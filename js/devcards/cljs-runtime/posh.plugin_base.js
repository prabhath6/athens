...
var fexpr__31208 = new cljs.core.Keyword(null,"posh-dispenser","posh-dispenser",-482466766).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(new cljs.core.Keyword(null,"listeners","listeners",394544445).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(conn))));
return (fexpr__31208.cljs$core$IFn$_invoke$arity$1 ? fexpr__31208.cljs$core$IFn$_invoke$arity$1(var$) : fexpr__31208.call(null,var$));
});
posh.plugin_base.get_posh_atom = (function posh$plugin_base$get_posh_atom(dcfg,poshdb_or_conn){
if(cljs.core.truth_((function (){var fexpr__31210 = new cljs.core.Keyword(null,"conn?","conn?",167224275).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__31210.cljs$core$IFn$_invoke$arity$1 ? fexpr__31210.cljs$core$IFn$_invoke$arity$1(poshdb_or_conn) : fexpr__31210.call(null,poshdb_or_conn));
})())){
...
if(cljs.core.truth_((function (){var fexpr__31212 = new cljs.core.Keyword(null,"conn?","conn?",167224275).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__31212.cljs$core$IFn$_invoke$arity$1 ? fexpr__31212.cljs$core$IFn$_invoke$arity$1(poshdb_or_conn) : fexpr__31212.call(null,poshdb_or_conn));
})())){
...
var fexpr__31229 = new cljs.core.Keyword(null,"ratom","ratom",-126521267).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__31229.cljs$core$IFn$_invoke$arity$1 ? fexpr__31229.cljs$core$IFn$_invoke$arity$1(query_result) : fexpr__31229.call(null,query_result));
}
})();
var query_reaction = (function (){var G__31231 = (function (){
return cljs.core.deref(query_ratom);
});
var G__31232 = new cljs.core.Keyword(null,"on-dispose","on-dispose",2105306360);
var G__31233 = (function (_,___$1){
...
var fexpr__31230 = new cljs.core.Keyword(null,"make-reaction","make-reaction",295148585).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__31230.cljs$core$IFn$_invoke$arity$3 ? fexpr__31230.cljs$core$IFn$_invoke$arity$3(G__31231,G__31232,G__31233) : fexpr__31230.call(null,G__31231,G__31232,G__31233));
})();
...
return posh.plugin_base.make_query_reaction.cljs$core$IFn$_invoke$arity$5(dcfg,posh_atom,storage_key,(function (p1__31241_SHARP_){
return posh.core.add_pull(p1__31241_SHARP_,true_poshdb,pull_pattern,eid);
}),options);
}));
...
var posh_atom = posh.plugin_base.get_posh_atom(dcfg,poshdb);
return posh.plugin_base.make_query_reaction.cljs$core$IFn$_invoke$arity$5(dcfg,posh_atom,storage_key,(function (p1__31256_SHARP_){
return posh.core.add_pull_many(p1__31256_SHARP_,true_poshdb,pull_pattern,eids);
}),options);
}));
...
return cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__31273,query_item){
var vec__31274 = p__31273;
var parsed_query = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31274,(0),null);
var last_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31274,(1),null);
...
var vec__31295 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(n_query_args,cljs.core.count(args)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [args,cljs.core.PersistentArrayMap.EMPTY], null):((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((n_query_args + (1)),cljs.core.count(args)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.butlast(args),cljs.core.last(args)], null):(function(){throw "Incorrect number of args passed to posh query"})()
));
var args__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31295,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31295,(1),null);
var true_poshdb_args = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31284_SHARP_){
if(cljs.core.truth_((function (){var fexpr__31300 = new cljs.core.Keyword(null,"conn?","conn?",167224275).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__31300.cljs$core$IFn$_invoke$arity$1 ? fexpr__31300.cljs$core$IFn$_invoke$arity$1(p1__31284_SHARP_) : fexpr__31300.call(null,p1__31284_SHARP_));
})())){
return posh.plugin_base.get_db(dcfg,p1__31284_SHARP_);
} else {
return p1__31284_SHARP_;
}
}),args__$1);
var posh_atom = cljs.core.first(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31285_SHARP_){
return posh.plugin_base.get_posh_atom(dcfg,p1__31285_SHARP_);
}),args__$1)));
...
return posh.plugin_base.make_query_reaction.cljs$core$IFn$_invoke$arity$5(dcfg,posh_atom,storage_key,(function (p1__31287_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$3(posh.core.add_q,p1__31287_SHARP_,query),true_poshdb_args);
}),options);
}));
...
/** @this {Function} */
(posh.plugin_base.q.cljs$lang$applyTo = (function (seq31289){
var G__31290 = cljs.core.first(seq31289);
var seq31289__$1 = cljs.core.next(seq31289);
var G__31291 = cljs.core.first(seq31289__$1);
var seq31289__$2 = cljs.core.next(seq31289__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31290,G__31291,seq31289__$2);
}));
...
if(cljs.core.truth_((function (){var fexpr__31316 = new cljs.core.Keyword(null,"conn?","conn?",167224275).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__31316.cljs$core$IFn$_invoke$arity$1 ? fexpr__31316.cljs$core$IFn$_invoke$arity$1(p1__31306_SHARP_) : fexpr__31316.call(null,p1__31306_SHARP_));
})())){
...
var posh_atom = cljs.core.first(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31307_SHARP_){
return posh.plugin_base.get_posh_atom(dcfg,p1__31307_SHARP_);
}),args)));
var storage_key = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"q","q",689001697),query,true_poshdb_args], null);
...
/** @this {Function} */
(posh.plugin_base.q_info.cljs$lang$applyTo = (function (seq31308){
var G__31309 = cljs.core.first(seq31308);
var seq31308__$1 = cljs.core.next(seq31308);
var G__31310 = cljs.core.first(seq31308__$1);
var seq31308__$2 = cljs.core.next(seq31308__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31309,G__31310,seq31308__$2);
}));
...
var true_poshdb_args = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31327_SHARP_){
...
return (fexpr__31336.cljs$core$IFn$_invoke$arity$1 ? fexpr__31336.cljs$core$IFn$_invoke$arity$1(p1__31327_SHARP_) : fexpr__31336.call(null,p1__31327_SHARP_));
})())){
return posh.plugin_base.get_db(dcfg,p1__31327_SHARP_);
} else {
...
/** @this {Function} */
(posh.plugin_base.filter_q.cljs$lang$applyTo = (function (seq31328){
...
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31329,G__31330,seq31328__$2);
}));
