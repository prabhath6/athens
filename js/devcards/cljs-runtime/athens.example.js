...
goog.require('athens.devcards.block');
...
var data = map__46818__$1;
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46818__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var weight = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46818__$1,new cljs.core.Keyword(null,"weight","weight",-1262796205));
var bmi = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46818__$1,new cljs.core.Keyword(null,"bmi","bmi",1421979636));
var h = (height / (100));
if((bmi == null)){
...
var map__46820 = athens.devcards.calc_bmi(cljs.core.deref(bmi_data));
...
var weight = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46820__$1,new cljs.core.Keyword(null,"weight","weight",-1262796205));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46820__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var bmi = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46820__$1,new cljs.core.Keyword(null,"bmi","bmi",1421979636));
var vec__46821 = (((bmi < 18.5))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["orange","underweight"], null):(((bmi < (25)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["inherit","normal"], null):(((bmi < (30)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["orange","overweight"], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["red","obese"], null)
)));
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46821,(0),null);
var diagnose = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46821,(1),null);
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.t_athens$devcards46825 !== 'undefined')){
} else {
...
*/
athens.devcards.t_athens$devcards46825 = (function (meta46826){
this.meta46826 = meta46826;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.t_athens$devcards46825.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_46827,meta46826__$1){
var self__ = this;
var _46827__$1 = this;
return (new athens.devcards.t_athens$devcards46825(meta46826__$1));
}));

(athens.devcards.t_athens$devcards46825.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_46827){
var self__ = this;
var _46827__$1 = this;
return self__.meta46826;
}));

(athens.devcards.t_athens$devcards46825.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.t_athens$devcards46825.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__46709__auto__,devcard_opts__46710__auto__){
var self__ = this;
...
(athens.devcards.t_athens$devcards46825.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta46826","meta46826",393654747,null)], null);
}));

(athens.devcards.t_athens$devcards46825.cljs$lang$type = true);

(athens.devcards.t_athens$devcards46825.cljs$lang$ctorStr = "athens.devcards/t_athens$devcards46825");

(athens.devcards.t_athens$devcards46825.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards/t_athens$devcards46825");
}));

/**
 * Positional factory function for athens.devcards/t_athens$devcards46825.
 */
athens.devcards.__GT_t_athens$devcards46825 = (function athens$devcards$__GT_t_athens$devcards46825(meta46826){
return (new athens.devcards.t_athens$devcards46825(meta46826));
});

}

return (new athens.devcards.t_athens$devcards46825(null));
})()
...
//# sourceMappingURL=athens.example.js.map
