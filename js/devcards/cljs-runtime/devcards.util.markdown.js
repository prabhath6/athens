...
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__62278 = cljs.core.get_global_hierarchy;
return (fexpr__62278.cljs$core$IFn$_invoke$arity$0 ? fexpr__62278.cljs$core$IFn$_invoke$arity$0() : fexpr__62278.call(null));
})());
return (new cljs.core.MultiFn(cljs.core.symbol.cljs$core$IFn$_invoke$arity$2("devcards.util.markdown","block-parser"),(function (p__62281,line){
...
var stage = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62282__$1,new cljs.core.Keyword(null,"stage","stage",1843544772));
...
devcards.util.markdown.block_parser.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"markdown","markdown",1227225089)], null),(function (p__62287,line){
var map__62288 = p__62287;
...
var st = map__62288__$1;
var stage = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62288__$1,new cljs.core.Keyword(null,"stage","stage",1843544772));
var left_margin = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62288__$1,new cljs.core.Keyword(null,"left-margin","left-margin",1869643147));
...
devcards.util.markdown.block_parser.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"code-block","code-block",-2113425141)], null),(function (p__62290,line){
var map__62291 = p__62290;
var map__62291__$1 = (((((!((map__62291 == null))))?(((((map__62291.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__62291.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__62291):map__62291);
var st = map__62291__$1;
var stage = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62291__$1,new cljs.core.Keyword(null,"stage","stage",1843544772));
...
devcards.util.markdown.block_parser.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"delim","delim",1621565472),new cljs.core.Keyword(null,"markdown","markdown",1227225089)], null),(function (p__62296,line){
...
var st = map__62297__$1;
var stage = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62297__$1,new cljs.core.Keyword(null,"stage","stage",1843544772));
var accum = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62297__$1,new cljs.core.Keyword(null,"accum","accum",-1892427250));
...
devcards.util.markdown.block_parser.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"delim","delim",1621565472),new cljs.core.Keyword(null,"code-block","code-block",-2113425141)], null),(function (p__62300,line){
var map__62304 = p__62300;
var map__62304__$1 = (((((!((map__62304 == null))))?(((((map__62304.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__62304.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__62304):map__62304);
var st = map__62304__$1;
var stage = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62304__$1,new cljs.core.Keyword(null,"stage","stage",1843544772));
var accum = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62304__$1,new cljs.core.Keyword(null,"accum","accum",-1892427250));
...
var map__62312 = devcards.util.markdown.parse_out_blocks_STAR_(m);
...
var stage = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62312__$1,new cljs.core.Keyword(null,"stage","stage",1843544772));
var accum = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62312__$1,new cljs.core.Keyword(null,"accum","accum",-1892427250));
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(x,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"content","content",15833224)], null),(function (p1__62311_SHARP_){
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",p1__62311_SHARP_);
}));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p__62314){
var map__62315 = p__62314;
...
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62315__$1,new cljs.core.Keyword(null,"content","content",15833224));
