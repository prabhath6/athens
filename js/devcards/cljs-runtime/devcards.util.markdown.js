...
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__41489 = cljs.core.get_global_hierarchy;
return (fexpr__41489.cljs$core$IFn$_invoke$arity$0 ? fexpr__41489.cljs$core$IFn$_invoke$arity$0() : fexpr__41489.call(null));
})());
return (new cljs.core.MultiFn(cljs.core.symbol.cljs$core$IFn$_invoke$arity$2("devcards.util.markdown","block-parser"),(function (p__41491,line){
var map__41492 = p__41491;
var map__41492__$1 = (((((!((map__41492 == null))))?(((((map__41492.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__41492.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__41492):map__41492);
var stage = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41492__$1,new cljs.core.Keyword(null,"stage","stage",1843544772));
...
devcards.util.markdown.block_parser.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"markdown","markdown",1227225089)], null),(function (p__41494,line){
var map__41495 = p__41494;
var map__41495__$1 = (((((!((map__41495 == null))))?(((((map__41495.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__41495.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__41495):map__41495);
var st = map__41495__$1;
var stage = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41495__$1,new cljs.core.Keyword(null,"stage","stage",1843544772));
var left_margin = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41495__$1,new cljs.core.Keyword(null,"left-margin","left-margin",1869643147));
...
devcards.util.markdown.block_parser.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"code-block","code-block",-2113425141)], null),(function (p__41499,line){
...
var st = map__41500__$1;
var stage = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41500__$1,new cljs.core.Keyword(null,"stage","stage",1843544772));
...
devcards.util.markdown.block_parser.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"delim","delim",1621565472),new cljs.core.Keyword(null,"markdown","markdown",1227225089)], null),(function (p__41505,line){
...
var st = map__41506__$1;
var stage = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41506__$1,new cljs.core.Keyword(null,"stage","stage",1843544772));
var accum = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41506__$1,new cljs.core.Keyword(null,"accum","accum",-1892427250));
...
devcards.util.markdown.block_parser.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"delim","delim",1621565472),new cljs.core.Keyword(null,"code-block","code-block",-2113425141)], null),(function (p__41510,line){
var map__41512 = p__41510;
var map__41512__$1 = (((((!((map__41512 == null))))?(((((map__41512.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__41512.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__41512):map__41512);
var st = map__41512__$1;
var stage = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41512__$1,new cljs.core.Keyword(null,"stage","stage",1843544772));
var accum = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41512__$1,new cljs.core.Keyword(null,"accum","accum",-1892427250));
...
var map__41519 = devcards.util.markdown.parse_out_blocks_STAR_(m);
var map__41519__$1 = (((((!((map__41519 == null))))?(((((map__41519.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__41519.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__41519):map__41519);
var stage = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41519__$1,new cljs.core.Keyword(null,"stage","stage",1843544772));
var accum = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41519__$1,new cljs.core.Keyword(null,"accum","accum",-1892427250));
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(x,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"content","content",15833224)], null),(function (p1__41517_SHARP_){
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",p1__41517_SHARP_);
}));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p__41523){
...
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41524__$1,new cljs.core.Keyword(null,"content","content",15833224));
