...
if((i < len)){
var k = (ks[i]);
var G__31891 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__31892 = (i + (1));
m = G__31891;
i = G__31892;
continue;
...
var temp__5737__auto__ = p.argv;
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__31738 = p.children;
return module$node_modules$react$index.Children.toArray(G__31738);
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__31740 = c;
var G__31740__$1 = (((G__31740 == null))?null:G__31740.prototype);
if((G__31740__$1 == null)){
return null;
} else {
return G__31740__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__31742 = c;
var G__31742__$1 = (((G__31742 == null))?null:G__31742.prototype);
if((G__31742__$1 == null)){
return null;
} else {
return G__31742__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__31922__delegate = function (args){
var G__31752 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__31752) : reagent.impl.component.as_element.call(null,G__31752));
};
...
while (G__31924__i < G__31924__a.length) {G__31924__a[G__31924__i] = arguments[G__31924__i + 0]; ++G__31924__i;}
  args = new cljs.core.IndexedSeq(G__31924__a,0,null);
} 
return G__31922__delegate.call(this,args);};
G__31922.cljs$lang$maxFixedArity = 0;
G__31922.cljs$lang$applyTo = (function (arglist__31925){
var args = cljs.core.seq(arglist__31925);
return G__31922__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__31755 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__31756 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__31756);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__31755);
}});
...
var c = this;
var G__31783_31956 = goog.object.get(c,"cljsRatom");
if((G__31783_31956 == null)){
} else {
reagent.ratom.dispose_BANG_(G__31783_31956);
}
...
var renders_31960 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_31961 = cljs.core.first(cljs.core.vals(renders_31960));
...
if((cljs.core.count(renders_31960) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_31960))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_31961)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_31961], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__31805 = o;
var G__31806_31965 = G__31805;
var G__31807_31966 = cljs.core.name(k);
var G__31808_31967 = v;
goog.object.set(G__31806_31965,G__31807_31966,G__31808_31967);
...
var G__31828_31972 = cmp.prototype;
var G__31829_31973 = module$node_modules$react$index.Component.prototype;
var G__31830_31974 = methods$;
goog.object.extend(G__31828_31972,G__31829_31973,G__31830_31974);
...
var name = (function (){var G__31836 = fiber;
var G__31836__$1 = (((G__31836 == null))?null:G__31836.type);
if((G__31836__$1 == null)){
return null;
} else {
return G__31836__$1.displayName;
}
})();
var parent = (function (){var G__31837 = fiber;
if((G__31837 == null)){
return null;
} else {
return G__31837.return;
}
})();
var path = (function (){var G__31838 = parent;
var G__31838__$1 = (((G__31838 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__31838) : reagent.impl.component.fiber_component_path.call(null,G__31838)));
if((G__31838__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__31838__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4185__auto__ = (function (){var G__31842 = c;
if((G__31842 == null)){
return null;
} else {
return goog.object.get(G__31842,"_reactInternalFiber");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__31844._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4185__auto__ = (function (){var G__31848 = c;
if((G__31848 == null)){
return null;
} else {
return goog.object.get(G__31848,"_reactInternalInstance");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var or__4185__auto____$1 = (function (){var G__31852 = c;
if((G__31852 == null)){
return null;
} else {
return G__31852._reactInternalInstance;
}
})();
if(cljs.core.truth_(or__4185__auto____$1)){
return or__4185__auto____$1;
...
var elem = (function (){var or__4185__auto__ = (function (){var G__31855 = instance;
if((G__31855 == null)){
return null;
} else {
return goog.object.get(G__31855,"_currentElement");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var G__31856 = instance;
if((G__31856 == null)){
return null;
} else {
return G__31856._currentElement;
}
}
})();
var name = (function (){var G__31857 = elem;
...
var owner = (function (){var or__4185__auto__ = (function (){var G__31864 = elem;
if((G__31864 == null)){
return null;
} else {
return goog.object.get(G__31864,"_owner");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__31869._owner;
}
}
})();
var path = (function (){var G__31870 = owner;
var G__31870__$1 = (((G__31870 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__31870) : reagent.impl.component.component_path.call(null,G__31870)));
if((G__31870__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__31870__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__31872 = c;
var G__31872__$1 = (((G__31872 == null))?null:G__31872.constructor);
if((G__31872__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__31872__$1);
}
}
})();
