...
var num_filters = cljs.core.count(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p__60730){
var vec__60731 = p__60730;
var _k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60731,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60731,(1),null);
...
})], null)], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.devcards.filters.filter_list_style),(((cljs.core.count(items__$2) > (0)))?cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4582__auto__ = (function athens$devcards$filters$filters_el_$_iter__60734(s__60735){
return (new cljs.core.LazySeq(null,(function (){
var s__60735__$1 = s__60735;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__60735__$1);
if(temp__5735__auto__){
var s__60735__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__60735__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__60735__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__60737 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__60736 = (0);
while(true){
if((i__60736 < size__4581__auto__)){
var vec__60738 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__60736);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60738,(0),null);
...
var count = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60741__$1,new cljs.core.Keyword(null,"count","count",2139924085));
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60741__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
...
cljs.core.chunk_append(b__60737,cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([athens.devcards.filters.filter_style,((added_QMARK_)?athens.devcards.filters.added_style:((excluded_QMARK_)?athens.devcards.filters.excluded_style:null))], 0)),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__60736,added_QMARK_,excluded_QMARK_,vec__60738,k,map__60741,map__60741__$1,count,state,c__4580__auto__,size__4581__auto__,b__60737,s__60735__$2,temp__5735__auto__,sort_,filtered_items,items__$2,num_filters,s){
return (function (_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(s,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"items","items",1031954938),k,new cljs.core.Keyword(null,"state","state",-1988618099)], null),(function (){var G__60743 = state;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__60743)){
return new cljs.core.Keyword(null,"added","added",2057651688);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"added","added",2057651688),G__60743)){
return new cljs.core.Keyword(null,"excluded","excluded",-715952088);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"excluded","excluded",-715952088),G__60743)){
return null;
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__60743)].join('')));

}
}
}
})());
});})(i__60736,added_QMARK_,excluded_QMARK_,vec__60738,k,map__60741,map__60741__$1,count,state,c__4580__auto__,size__4581__auto__,b__60737,s__60735__$2,temp__5735__auto__,sort_,filtered_items,items__$2,num_filters,s))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60737),athens$devcards$filters$filters_el_$_iter__60734(cljs.core.chunk_rest(s__60735__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60737),null);
}
} else {
var vec__60744 = cljs.core.first(s__60735__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60744,(0),null);
var map__60747 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60744,(1),null);
...
var count = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60747__$1,new cljs.core.Keyword(null,"count","count",2139924085));
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60747__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var added_QMARK_ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(state,new cljs.core.Keyword(null,"added","added",2057651688));
var excluded_QMARK_ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(state,new cljs.core.Keyword(null,"excluded","excluded",-715952088));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([athens.devcards.filters.filter_style,((added_QMARK_)?athens.devcards.filters.added_style:((excluded_QMARK_)?athens.devcards.filters.excluded_style:null))], 0)),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (added_QMARK_,excluded_QMARK_,vec__60744,k,map__60747,map__60747__$1,count,state,s__60735__$2,temp__5735__auto__,sort_,filtered_items,items__$2,num_filters,s){
return (function (_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(s,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"items","items",1031954938),k,new cljs.core.Keyword(null,"state","state",-1988618099)], null),(function (){var G__60749 = state;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__60749)){
return new cljs.core.Keyword(null,"added","added",2057651688);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"added","added",2057651688),G__60749)){
return new cljs.core.Keyword(null,"excluded","excluded",-715952088);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"excluded","excluded",-715952088),G__60749)){
return null;
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__60749)].join('')));

}
}
}
})());
});})(added_QMARK_,excluded_QMARK_,vec__60744,k,map__60747,map__60747__$1,count,state,s__60735__$2,temp__5735__auto__,sort_,filtered_items,items__$2,num_filters,s))
], null)),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.devcards.filters.count_style),count], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.devcards.filters.filter_name_style),k], null),((((added_QMARK_) || (excluded_QMARK_)))?new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.devcards.filters.state_style),state,((added_QMARK_)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$material_ui$icons$index.Check], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$material_ui$icons$index.Block], null))], null):null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),k], null)),athens$devcards$filters$filters_el_$_iter__60734(cljs.core.rest(s__60735__$2)));
}
} else {
return null;
}
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.filters !== 'undefined') && (typeof athens.devcards.filters.t_athens$devcards$filters60750 !== 'undefined')){
} else {
...
*/
athens.devcards.filters.t_athens$devcards$filters60750 = (function (meta60751){
this.meta60751 = meta60751;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.filters.t_athens$devcards$filters60750.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60752,meta60751__$1){
var self__ = this;
var _60752__$1 = this;
return (new athens.devcards.filters.t_athens$devcards$filters60750(meta60751__$1));
}));

(athens.devcards.filters.t_athens$devcards$filters60750.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60752){
var self__ = this;
var _60752__$1 = this;
return self__.meta60751;
}));

(athens.devcards.filters.t_athens$devcards$filters60750.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.filters.t_athens$devcards$filters60750.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
...
(athens.devcards.filters.t_athens$devcards$filters60750.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta60751","meta60751",-818732635,null)], null);
}));

(athens.devcards.filters.t_athens$devcards$filters60750.cljs$lang$type = true);

(athens.devcards.filters.t_athens$devcards$filters60750.cljs$lang$ctorStr = "athens.devcards.filters/t_athens$devcards$filters60750");

(athens.devcards.filters.t_athens$devcards$filters60750.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.filters/t_athens$devcards$filters60750");
}));

/**
 * Positional factory function for athens.devcards.filters/t_athens$devcards$filters60750.
 */
athens.devcards.filters.__GT_t_athens$devcards$filters60750 = (function athens$devcards$filters$__GT_t_athens$devcards$filters60750(meta60751){
return (new athens.devcards.filters.t_athens$devcards$filters60750(meta60751));
});

}

return (new athens.devcards.filters.t_athens$devcards$filters60750(null));
})()
