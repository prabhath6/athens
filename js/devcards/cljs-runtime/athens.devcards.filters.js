...
var num_filters = cljs.core.count(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p__60685){
var vec__60686 = p__60685;
var _k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60686,(0),null);
...
})], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.devcards.filters.sort_indicator_style),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"<>","<>",1280186386),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$material_ui$icons$index.ArrowDownward], null),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sort_,new cljs.core.Keyword(null,"lex","lex",1572323917)))?"Title":"Number")], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(num_filters)," Filters"].join('')], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.buttons.button,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"label","label",1718410804),"Reset",new cljs.core.Keyword(null,"style","style",-496642736),athens.devcards.filters.reset_control_style,new cljs.core.Keyword(null,"on-click-fn","on-click-fn",739785852),(function (_){
...
})], null)], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.devcards.filters.filter_list_style),cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4582__auto__ = (function athens$devcards$filters$filters_el_$_iter__60689(s__60690){
...
var vec__60693 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__60691);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60693,(0),null);
var map__60696 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60693,(1),null);
...
var count = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60696__$1,new cljs.core.Keyword(null,"count","count",2139924085));
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60696__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
...
cljs.core.chunk_append(b__60692,cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([athens.devcards.filters.filter_style,((added_QMARK_)?athens.devcards.filters.added_style:((excluded_QMARK_)?athens.devcards.filters.excluded_style:null))], 0)),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__60691,added_QMARK_,excluded_QMARK_,vec__60693,k,map__60696,map__60696__$1,count,state,c__4580__auto__,size__4581__auto__,b__60692,s__60690__$2,temp__5735__auto__,sort_,filtered_items,items__$2,num_filters,s){
return (function (_){
...
});})(i__60691,added_QMARK_,excluded_QMARK_,vec__60693,k,map__60696,map__60696__$1,count,state,c__4580__auto__,size__4581__auto__,b__60692,s__60690__$2,temp__5735__auto__,sort_,filtered_items,items__$2,num_filters,s))
...
var vec__60702 = cljs.core.first(s__60690__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60702,(0),null);
var map__60705 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60702,(1),null);
...
var count = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60705__$1,new cljs.core.Keyword(null,"count","count",2139924085));
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60705__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var added_QMARK_ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(state,new cljs.core.Keyword(null,"added","added",2057651688));
var excluded_QMARK_ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(state,new cljs.core.Keyword(null,"excluded","excluded",-715952088));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([athens.devcards.filters.filter_style,((added_QMARK_)?athens.devcards.filters.added_style:((excluded_QMARK_)?athens.devcards.filters.excluded_style:null))], 0)),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (added_QMARK_,excluded_QMARK_,vec__60702,k,map__60705,map__60705__$1,count,state,s__60690__$2,temp__5735__auto__,sort_,filtered_items,items__$2,num_filters,s){
return (function (_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(s,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"items","items",1031954938),k,new cljs.core.Keyword(null,"state","state",-1988618099)], null),(function (){var G__60710 = state;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__60710)){
return new cljs.core.Keyword(null,"added","added",2057651688);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"added","added",2057651688),G__60710)){
return new cljs.core.Keyword(null,"excluded","excluded",-715952088);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"excluded","excluded",-715952088),G__60710)){
return null;
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__60710)].join('')));

}
}
}
})());
});})(added_QMARK_,excluded_QMARK_,vec__60702,k,map__60705,map__60705__$1,count,state,s__60690__$2,temp__5735__auto__,sort_,filtered_items,items__$2,num_filters,s))
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.filters !== 'undefined') && (typeof athens.devcards.filters.t_athens$devcards$filters60714 !== 'undefined')){
} else {
...
*/
athens.devcards.filters.t_athens$devcards$filters60714 = (function (meta60715){
this.meta60715 = meta60715;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.filters.t_athens$devcards$filters60714.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60716,meta60715__$1){
var self__ = this;
var _60716__$1 = this;
return (new athens.devcards.filters.t_athens$devcards$filters60714(meta60715__$1));
}));

(athens.devcards.filters.t_athens$devcards$filters60714.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60716){
var self__ = this;
var _60716__$1 = this;
return self__.meta60715;
}));

(athens.devcards.filters.t_athens$devcards$filters60714.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.filters.t_athens$devcards$filters60714.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
...
(athens.devcards.filters.t_athens$devcards$filters60714.getBasis = (function (){
...
(athens.devcards.filters.t_athens$devcards$filters60714.cljs$lang$type = true);

(athens.devcards.filters.t_athens$devcards$filters60714.cljs$lang$ctorStr = "athens.devcards.filters/t_athens$devcards$filters60714");

(athens.devcards.filters.t_athens$devcards$filters60714.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.filters/t_athens$devcards$filters60714");
}));

/**
 * Positional factory function for athens.devcards.filters/t_athens$devcards$filters60714.
 */
athens.devcards.filters.__GT_t_athens$devcards$filters60714 = (function athens$devcards$filters$__GT_t_athens$devcards$filters60714(meta60715){
return (new athens.devcards.filters.t_athens$devcards$filters60714(meta60715));
});

}

return (new athens.devcards.filters.t_athens$devcards$filters60714(null));
})()
