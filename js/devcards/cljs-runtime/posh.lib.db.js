...
var G__30688 = cljs.core.cons(pdb,path);
var G__30689 = posh.lib.db.get_parent_db(pdb);
path = G__30688;
pdb = G__30689;
continue;
} else {
...
var db__$3 = (cljs.core.truth_(as_of)?(function (){var fexpr__30667 = new cljs.core.Keyword(null,"as-of","as-of",-1841962382).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__30667.cljs$core$IFn$_invoke$arity$2 ? fexpr__30667.cljs$core$IFn$_invoke$arity$2(db__$2,as_of) : fexpr__30667.call(null,db__$2,as_of));
})():db__$2);
...
var G__30679 = (function (){var G__30681 = posh_tree;
var G__30682 = posh.lib.db.get_parent_db(poshdb);
return (posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2 ? posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2(G__30681,G__30682) : posh.lib.db.poshdb__GT_db.call(null,G__30681,G__30682));
})();
var G__30680 = posh.lib.db.make_filter_pred(new cljs.core.Keyword(null,"pass-patterns","pass-patterns",1090887263).cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cache,poshdb)));
