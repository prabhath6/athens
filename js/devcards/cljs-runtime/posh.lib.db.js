...
var G__27640 = cljs.core.first(poshdb);
...
var G__27731 = cljs.core.cons(pdb,path);
var G__27733 = posh.lib.db.get_parent_db(pdb);
path = G__27731;
pdb = G__27733;
continue;
} else {
...
var G__27753 = posh.lib.db.get_parent_db(poshdb);
poshdb = G__27753;
continue;
}
break;
...
var filter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27672__$1,new cljs.core.Keyword(null,"filter","filter",-948537934));
var as_of = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27672__$1,new cljs.core.Keyword(null,"as-of","as-of",-1841962382));
var since = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27672__$1,new cljs.core.Keyword(null,"since","since",315379842));
var with$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27672__$1,new cljs.core.Keyword(null,"with","with",-1536296876));
var db__$1 = (function (){var or__4185__auto__ = db;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var fexpr__27682 = new cljs.core.Keyword(null,"db","db",993250759).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__27682.cljs$core$IFn$_invoke$arity$1 ? fexpr__27682.cljs$core$IFn$_invoke$arity$1(conn) : fexpr__27682.call(null,conn));
}
})();
var db__$2 = (cljs.core.truth_(since)?(function (){var fexpr__27685 = new cljs.core.Keyword(null,"since","since",315379842).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__27685.cljs$core$IFn$_invoke$arity$2 ? fexpr__27685.cljs$core$IFn$_invoke$arity$2(db__$1,since) : fexpr__27685.call(null,db__$1,since));
})():db__$1);
var db__$3 = (cljs.core.truth_(as_of)?(function (){var fexpr__27686 = new cljs.core.Keyword(null,"as-of","as-of",-1841962382).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__27686.cljs$core$IFn$_invoke$arity$2 ? fexpr__27686.cljs$core$IFn$_invoke$arity$2(db__$2,as_of) : fexpr__27686.call(null,db__$2,as_of));
})():db__$2);
var db__$4 = (cljs.core.truth_(with$)?new cljs.core.Keyword(null,"db-after","db-after",-571884666).cljs$core$IFn$_invoke$arity$1((function (){var fexpr__27688 = new cljs.core.Keyword(null,"with","with",-1536296876).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__27688.cljs$core$IFn$_invoke$arity$2 ? fexpr__27688.cljs$core$IFn$_invoke$arity$2(db__$3,with$) : fexpr__27688.call(null,db__$3,with$));
})()):db__$3);
var db__$5 = (cljs.core.truth_(filter)?(function (){var G__27690 = db__$4;
var G__27691 = (((filter instanceof cljs.core.Symbol))?null:filter);
var fexpr__27689 = new cljs.core.Keyword(null,"filter","filter",-948537934).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__27689.cljs$core$IFn$_invoke$arity$2 ? fexpr__27689.cljs$core$IFn$_invoke$arity$2(G__27690,G__27691) : fexpr__27689.call(null,G__27690,G__27691));
})():db__$4);
return db__$5;
}));
...
posh.lib.db.poshdb__GT_db = (function posh$lib$db$poshdb__GT_db(p__27698,poshdb){
...
var posh_tree = map__27700__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27700__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var cache = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27700__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(poshdb),new cljs.core.Keyword(null,"db","db",993250759))){
return posh.lib.db.db_id__GT_db(posh_tree,cljs.core.second(poshdb));
} else {
var G__27707 = (function (){var G__27711 = posh_tree;
var G__27712 = posh.lib.db.get_parent_db(poshdb);
return (posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2 ? posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2(G__27711,G__27712) : posh.lib.db.poshdb__GT_db.call(null,G__27711,G__27712));
})();
var G__27708 = posh.lib.db.make_filter_pred(new cljs.core.Keyword(null,"pass-patterns","pass-patterns",1090887263).cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cache,poshdb)));
var fexpr__27706 = new cljs.core.Keyword(null,"filter","filter",-948537934).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__27706.cljs$core$IFn$_invoke$arity$2 ? fexpr__27706.cljs$core$IFn$_invoke$arity$2(G__27707,G__27708) : fexpr__27706.call(null,G__27707,G__27708));
}
});
