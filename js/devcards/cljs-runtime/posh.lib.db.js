...
var G__30650 = cljs.core.first(poshdb);
var G__30650__$1 = (((G__30650 instanceof cljs.core.Keyword))?G__30650.fqn:null);
switch (G__30650__$1) {
case "db":
return null;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__30650__$1)].join('')));
...
var filter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30664__$1,new cljs.core.Keyword(null,"filter","filter",-948537934));
var as_of = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30664__$1,new cljs.core.Keyword(null,"as-of","as-of",-1841962382));
var since = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30664__$1,new cljs.core.Keyword(null,"since","since",315379842));
var with$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30664__$1,new cljs.core.Keyword(null,"with","with",-1536296876));
var db__$1 = (function (){var or__4185__auto__ = db;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var fexpr__30668 = new cljs.core.Keyword(null,"db","db",993250759).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__30668.cljs$core$IFn$_invoke$arity$1 ? fexpr__30668.cljs$core$IFn$_invoke$arity$1(conn) : fexpr__30668.call(null,conn));
}
})();
var db__$2 = (cljs.core.truth_(since)?(function (){var fexpr__30670 = new cljs.core.Keyword(null,"since","since",315379842).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__30670.cljs$core$IFn$_invoke$arity$2 ? fexpr__30670.cljs$core$IFn$_invoke$arity$2(db__$1,since) : fexpr__30670.call(null,db__$1,since));
})():db__$1);
var db__$3 = (cljs.core.truth_(as_of)?(function (){var fexpr__30672 = new cljs.core.Keyword(null,"as-of","as-of",-1841962382).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__30672.cljs$core$IFn$_invoke$arity$2 ? fexpr__30672.cljs$core$IFn$_invoke$arity$2(db__$2,as_of) : fexpr__30672.call(null,db__$2,as_of));
})():db__$2);
...
posh.lib.db.poshdb__GT_db = (function posh$lib$db$poshdb__GT_db(p__30678,poshdb){
...
var posh_tree = map__30679__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30679__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var cache = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30679__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(poshdb),new cljs.core.Keyword(null,"db","db",993250759))){
return posh.lib.db.db_id__GT_db(posh_tree,cljs.core.second(poshdb));
} else {
var G__30683 = (function (){var G__30685 = posh_tree;
var G__30686 = posh.lib.db.get_parent_db(poshdb);
return (posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2 ? posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2(G__30685,G__30686) : posh.lib.db.poshdb__GT_db.call(null,G__30685,G__30686));
})();
var G__30684 = posh.lib.db.make_filter_pred(new cljs.core.Keyword(null,"pass-patterns","pass-patterns",1090887263).cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cache,poshdb)));
var fexpr__30682 = new cljs.core.Keyword(null,"filter","filter",-948537934).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__30682.cljs$core$IFn$_invoke$arity$2 ? fexpr__30682.cljs$core$IFn$_invoke$arity$2(G__30683,G__30684) : fexpr__30682.call(null,G__30683,G__30684));
}
});
