...
var i__4790__auto___58973 = (0);
while(true){
if((i__4790__auto___58973 < len__4789__auto___58971)){
args__4795__auto__.push((arguments[i__4790__auto___58973]));

var G__58975 = (i__4790__auto___58973 + (1));
i__4790__auto___58973 = G__58975;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.opts.process_permissions.cljs$lang$applyTo = (function (seq58952){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq58952));
}));
...
var G__58977 = null;
var G__58977__1 = (function (msg){
return (new Error(msg));
});
var G__58977__2 = (function (msg,filename){
return (new Error(msg,filename));
});
var G__58977__3 = (function (msg,filename,line){
return (new Error(msg,filename,line));
});
G__58977 = function(msg,filename,line){
switch(arguments.length){
case 1:
return G__58977__1.call(this,msg);
case 2:
return G__58977__2.call(this,msg,filename);
case 3:
return G__58977__3.call(this,msg,filename,line);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__58977.cljs$core$IFn$_invoke$arity$1 = G__58977__1;
G__58977.cljs$core$IFn$_invoke$arity$2 = G__58977__2;
G__58977.cljs$core$IFn$_invoke$arity$3 = G__58977__3;
return G__58977;
})()
], null),new cljs.core.Symbol(null,"cljs.core.Delay","cljs.core.Delay",-1917476777,null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.Delay,new cljs.core.Keyword(null,"constructor","constructor",-1953928811),(function (p1__58956_SHARP_){
return (new cljs.core.Delay(p1__58956_SHARP_,null));
})], null),new cljs.core.Symbol(null,"goog.string.StringBuffer","goog.string.StringBuffer",-1220229842,null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),goog.string.StringBuffer,new cljs.core.Keyword(null,"constructor","constructor",-1953928811),(function (p1__58957_SHARP_){
return (new goog.string.StringBuffer(p1__58957_SHARP_));
})], null)], null);
...
var vec__58958 = temp__5733__auto__;
var sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58958,(0),null);
var class_opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58958,(1),null);
var G__58980 = cljs.core.assoc_BANG_.cljs$core$IFn$_invoke$arity$3(class__GT_opts,sym,((cljs.core.map_QMARK_(class_opts))?class_opts:new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),class_opts], null)));
var G__58981 = cljs.core.rest(kvs);
class__GT_opts = G__58980;
kvs = G__58981;
continue;
} else {
 ...
 * Initializes options
 */
sci.impl.opts.init = (function sci$impl$opts$init(p__58962){
var map__58963 = p__58962;
var map__58963__$1 = (((((!((map__58963 == null))))?(((((map__58963.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__58963.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__58963):map__58963);
var features = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58963__$1,new cljs.core.Keyword(null,"features","features",-1146962336));
var namespaces = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58963__$1,new cljs.core.Keyword(null,"namespaces","namespaces",-1444157469));
var bindings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58963__$1,new cljs.core.Keyword(null,"bindings","bindings",1271397192));
var readers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58963__$1,new cljs.core.Keyword(null,"readers","readers",-2118263030));
var env = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58963__$1,new cljs.core.Keyword(null,"env","env",-1815813235));
var imports = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58963__$1,new cljs.core.Keyword(null,"imports","imports",-1249933394));
var allow = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58963__$1,new cljs.core.Keyword(null,"allow","allow",-1857325745));
var preset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58963__$1,new cljs.core.Keyword(null,"preset","preset",777387345));
var realize_max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58963__$1,new cljs.core.Keyword(null,"realize-max","realize-max",-1846442543));
var load_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58963__$1,new cljs.core.Keyword(null,"load-fn","load-fn",-2121144334));
var dry_run = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58963__$1,new cljs.core.Keyword(null,"dry-run","dry-run",-1102788647));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58963__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
var deny = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58963__$1,new cljs.core.Keyword(null,"deny","deny",1589338523));
var classes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58963__$1,new cljs.core.Keyword(null,"classes","classes",2037804510));
