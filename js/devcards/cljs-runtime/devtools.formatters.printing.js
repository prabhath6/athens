...
var len__4789__auto___22393 = arguments.length;
var i__4790__auto___22394 = (0);
while(true){
if((i__4790__auto___22394 < len__4789__auto___22393)){
args__4795__auto__.push((arguments[i__4790__auto___22394]));

var G__22395 = (i__4790__auto___22394 + (1));
i__4790__auto___22394 = G__22395;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq22320){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22321,G__22322,seq22320__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__22348_SHARP_){
return (!((cljs.core.meta(p1__22348_SHARP_) == null)));
})))){
...
var map__22366 = opts;
var map__22366__$1 = (((((!((map__22366 == null))))?(((((map__22366.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__22366.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__22366):map__22366);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22366__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e22370){var _e__20490__auto__ = e22370;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
}catch (e22372){var _e__20490__auto__ = e22372;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__22375 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__22376 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__22376);

try{var map__22377 = opts;
var map__22377__$1 = (((((!((map__22377 == null))))?(((((map__22377.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__22377.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__22377):map__22377);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22377__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__22375);
}});
...
var temp__5733__auto___22432 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___22432)){
var managed_print_level_22436 = temp__5733__auto___22432;
var _STAR_print_level_STAR__orig_val__22385_22437 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__22386_22438 = managed_print_level_22436;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__22386_22438);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__22380_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__22380_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__22385_22437);
}} else {
job_fn();
}
