...
var len__4789__auto___23855 = arguments.length;
var i__4790__auto___23856 = (0);
while(true){
if((i__4790__auto___23856 < len__4789__auto___23855)){
args__4795__auto__.push((arguments[i__4790__auto___23856]));

var G__23857 = (i__4790__auto___23856 + (1));
i__4790__auto___23856 = G__23857;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq23813){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23814,G__23815,seq23813__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__23822_SHARP_){
return (!((cljs.core.meta(p1__23822_SHARP_) == null)));
})))){
...
var map__23827 = opts;
var map__23827__$1 = (((((!((map__23827 == null))))?(((((map__23827.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__23827.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__23827):map__23827);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23827__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e23836){var _e__20680__auto__ = e23836;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
}catch (e23838){var _e__20680__auto__ = e23838;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__23842 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__23843 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__23843);

try{var map__23844 = opts;
var map__23844__$1 = (((((!((map__23844 == null))))?(((((map__23844.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__23844.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__23844):map__23844);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23844__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__23842);
}});
...
var temp__5733__auto___23917 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___23917)){
var managed_print_level_23920 = temp__5733__auto___23917;
var _STAR_print_level_STAR__orig_val__23848_23921 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__23849_23922 = managed_print_level_23920;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__23849_23922);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__23846_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__23846_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__23848_23921);
}} else {
job_fn();
}
