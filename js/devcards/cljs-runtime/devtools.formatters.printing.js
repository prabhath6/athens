...
var len__4789__auto___23859 = arguments.length;
var i__4790__auto___23860 = (0);
while(true){
if((i__4790__auto___23860 < len__4789__auto___23859)){
args__4795__auto__.push((arguments[i__4790__auto___23860]));

var G__23861 = (i__4790__auto___23860 + (1));
i__4790__auto___23860 = G__23861;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq23815){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23816,G__23817,seq23815__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__23826_SHARP_){
return (!((cljs.core.meta(p1__23826_SHARP_) == null)));
})))){
...
var map__23834 = opts;
var map__23834__$1 = (((((!((map__23834 == null))))?(((((map__23834.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__23834.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__23834):map__23834);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23834__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e23838){var _e__20778__auto__ = e23838;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
}catch (e23840){var _e__20778__auto__ = e23840;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__23843 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__23844 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__23844);

try{var map__23845 = opts;
var map__23845__$1 = (((((!((map__23845 == null))))?(((((map__23845.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__23845.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__23845):map__23845);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23845__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__23843);
}});
...
var temp__5733__auto___23924 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___23924)){
var managed_print_level_23925 = temp__5733__auto___23924;
var _STAR_print_level_STAR__orig_val__23853_23926 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__23854_23927 = managed_print_level_23925;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__23854_23927);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__23847_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__23847_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__23853_23926);
}} else {
job_fn();
}
