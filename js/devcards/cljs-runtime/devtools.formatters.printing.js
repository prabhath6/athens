...
var len__4789__auto___43167 = arguments.length;
var i__4790__auto___43168 = (0);
while(true){
if((i__4790__auto___43168 < len__4789__auto___43167)){
args__4795__auto__.push((arguments[i__4790__auto___43168]));

var G__43169 = (i__4790__auto___43168 + (1));
i__4790__auto___43168 = G__43169;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq43009){
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__43071_SHARP_){
return (!((cljs.core.meta(p1__43071_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43119__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e43127){var _e__40276__auto__ = e43127;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
}catch (e43131){var _e__40276__auto__ = e43131;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__43142 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__43143 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__43143);

try{var map__43144 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43144__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__43142);
}});
...
var temp__5733__auto___43202 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___43202)){
var managed_print_level_43203 = temp__5733__auto___43202;
var _STAR_print_level_STAR__orig_val__43150_43204 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__43151_43205 = managed_print_level_43203;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__43151_43205);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__43146_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__43146_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__43150_43204);
}} else {
job_fn();
}
