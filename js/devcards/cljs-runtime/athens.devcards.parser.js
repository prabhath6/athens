...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.parser !== 'undefined') && (typeof athens.devcards.parser.t_athens$devcards$parser60166 !== 'undefined')){
} else {
...
*/
athens.devcards.parser.t_athens$devcards$parser60166 = (function (meta60167){
this.meta60167 = meta60167;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.parser.t_athens$devcards$parser60166.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60168,meta60167__$1){
var self__ = this;
var _60168__$1 = this;
return (new athens.devcards.parser.t_athens$devcards$parser60166(meta60167__$1));
}));

(athens.devcards.parser.t_athens$devcards$parser60166.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60168){
var self__ = this;
var _60168__$1 = this;
return self__.meta60167;
}));

(athens.devcards.parser.t_athens$devcards$parser60166.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.parser.t_athens$devcards$parser60166.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
var this__38815__auto____$1 = this;
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(devcard_opts__38816__auto__,new cljs.core.Keyword(null,"main-obj","main-obj",-1544409742),(function (){var v__38834__auto__ = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"<>","<>",1280186386),(function (){var iter__4582__auto__ = (function athens$devcards$parser$iter__60169(s__60170){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60172),athens$devcards$parser$iter__60169(cljs.core.chunk_rest(s__60170__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60172),null);
}
} else {
var s = cljs.core.first(s__60170__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.blocks.block_el,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("block","string","block/string",-2066596447),s], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),s], null)),athens$devcards$parser$iter__60169(cljs.core.rest(s__60170__$2)));
}
} else {
return null;
}
...
(athens.devcards.parser.t_athens$devcards$parser60166.getBasis = (function (){
...
(athens.devcards.parser.t_athens$devcards$parser60166.cljs$lang$type = true);

(athens.devcards.parser.t_athens$devcards$parser60166.cljs$lang$ctorStr = "athens.devcards.parser/t_athens$devcards$parser60166");

(athens.devcards.parser.t_athens$devcards$parser60166.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.parser/t_athens$devcards$parser60166");
}));

/**
 * Positional factory function for athens.devcards.parser/t_athens$devcards$parser60166.
 */
athens.devcards.parser.__GT_t_athens$devcards$parser60166 = (function athens$devcards$parser$__GT_t_athens$devcards$parser60166(meta60167){
return (new athens.devcards.parser.t_athens$devcards$parser60166(meta60167));
});

}

return (new athens.devcards.parser.t_athens$devcards$parser60166(null));
})()
