...
if((diff < (0))){
var G__25949 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(only_a,first_a);
var G__25950 = only_b;
var G__25951 = both;
...
(datascript.db.validate_attr.cljs$core$IFn$_invoke$arity$2 ? datascript.db.validate_attr.cljs$core$IFn$_invoke$arity$2(G__25737_26016,G__25738_26017) : datascript.db.validate_attr.call(null,G__25737_26016,G__25738_26017));
...
var comp_QMARK__26065 = new cljs.core.Keyword("db","isComponent","db/isComponent",423352398).cljs$core$IFn$_invoke$arity$2(kv,false);
...
if(cljs.core.truth_((function (){var and__4174__auto__ = comp_QMARK__26065;
...
var G__26073 = seq__25776;
var G__26074 = chunk__25777;
var G__26075 = count__25778;
var G__26076 = (i__25779 + (1));
seq__25776 = G__26073;
chunk__25777 = G__26074;
count__25778 = G__26075;
i__25779 = G__26076;
continue;
} else {
...
var G__26077 = cljs.core.chunk_rest(seq__25776__$1);
var G__26078 = c__4609__auto__;
var G__26079 = cljs.core.count(c__4609__auto__);
var G__26080 = (0);
seq__25776 = G__26077;
chunk__25777 = G__26078;
count__25778 = G__26079;
i__25779 = G__26080;
continue;
} else {
...
var comp_QMARK__26081 = new cljs.core.Keyword("db","isComponent","db/isComponent",423352398).cljs$core$IFn$_invoke$arity$2(kv,false);
datascript.db.validate_schema_key(a,new cljs.core.Keyword("db","isComponent","db/isComponent",423352398),new cljs.core.Keyword("db","isComponent","db/isComponent",423352398).cljs$core$IFn$_invoke$arity$1(kv),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [true,null,false,null], null), null));

if(cljs.core.truth_((function (){var and__4174__auto__ = comp_QMARK__26081;
if(cljs.core.truth_(and__4174__auto__)){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("db","valueType","db/valueType",1827971944).cljs$core$IFn$_invoke$arity$1(kv),new cljs.core.Keyword("db.type","ref","db.type/ref",-1728373079));
} else {
return and__4174__auto__;
...
var G__26088 = cljs.core.next(seq__25776__$1);
var G__26089 = null;
var G__26090 = (0);
var G__26091 = (0);
seq__25776 = G__26088;
chunk__25777 = G__26089;
count__25778 = G__26090;
i__25779 = G__26091;
continue;
}
} else {
...
var G__26100 = cljs.core.next(xs);
var G__26101 = cljs.core.next(ys);
xs = G__26100;
ys = G__26101;
continue;
} else {
...
if(cljs.core.truth_(a)){
var G__25804_26110 = a;
var G__25805_26111 = (new cljs.core.List(null,new cljs.core.Symbol(null,"resolve-datom","resolve-datom",-294110827,null),(new cljs.core.List(null,new cljs.core.Symbol(null,"db","db",-1661185010,null),(new cljs.core.List(null,e,(new cljs.core.List(null,a,(new cljs.core.List(null,v,(new cljs.core.List(null,t,null,(1),null)),(2),null)),(3),null)),(4),null)),(5),null)),(6),null));
(datascript.db.validate_attr.cljs$core$IFn$_invoke$arity$2 ? datascript.db.validate_attr.cljs$core$IFn$_invoke$arity$2(G__25804_26110,G__25805_26111) : datascript.db.validate_attr.call(null,G__25804_26110,G__25805_26111));
} else {
}
...
var G__26137 = db;
var G__26138 = cljs.core.array_seq.cljs$core$IFn$_invoke$arity$1(eid);
db = G__26137;
eid = G__26138;
continue;
} else {
...
var G__26158 = datascript.db.allocate_eid.cljs$core$IFn$_invoke$arity$3(report,old_eid,id);
...
var G__26160 = report;
var G__26161 = cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(entity,new cljs.core.Keyword("db","id","db/id",-1388397098),id),entities);
report = G__26160;
es = G__26161;
continue;
} else {
...
var G__26162 = datascript.db.allocate_eid.cljs$core$IFn$_invoke$arity$3(report,old_eid,upserted_eid);
var G__26163 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(datascript.db.explode(db,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(entity,new cljs.core.Keyword("db","id","db/id",-1388397098),upserted_eid)),entities);
report = G__26162;
es = G__26163;
continue;
}
...
var G__26173 = datascript.db.transact_add(report,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","add","db/add",235286841),e__$2,a__$1,nv__$1], null));
var G__26174 = entities;
report = G__26173;
es = G__26174;
continue;
} else {
...
var G__26175 = datascript.db.allocate_eid.cljs$core$IFn$_invoke$arity$3(report,e,datascript.db.current_tx(report));
var G__26176 = cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [op,datascript.db.current_tx(report),a,v], null),entities);
report = G__26175;
es = G__26176;
continue;
} else {
...
var G__26200 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(datascript.db.transact_retract_datom,report,cljs.core.concat.cljs$core$IFn$_invoke$arity$2(e_datoms,v_datoms));
var G__26201 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(datascript.db.retract_components(db,e_datoms),entities);
report = G__26200;
es = G__26201;
continue;
}
...
var G__26202 = datascript.db.transact_add(report,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","add","db/add",235286841),e,a,v,tx], null));
var G__26203 = entities;
report = G__26202;
es = G__26203;
continue;
} else {
var G__26204 = report;
var G__26205 = cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","retract","db/retract",-1549825231),e,a,v], null),entities);
report = G__26204;
es = G__26205;
continue;
}
