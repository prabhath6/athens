...
var username = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41502,(0),null);
var password = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41502,(1),null);
 ...
 */
cljs_http.util.build_url = (function cljs_http$util$build_url(p__41508){
...
var scheme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41509__$1,new cljs.core.Keyword(null,"scheme","scheme",90199613));
var server_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41509__$1,new cljs.core.Keyword(null,"server-name","server-name",-1012104295));
var server_port = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41509__$1,new cljs.core.Keyword(null,"server-port","server-port",663745648));
var uri = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41509__$1,new cljs.core.Keyword(null,"uri","uri",-774711847));
var query_string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41509__$1,new cljs.core.Keyword(null,"query-string","query-string",-1018845061));
return cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__41518 = (new goog.Uri());
G__41518.setScheme(cljs.core.name((function (){var or__4185__auto__ = scheme;
...
G__41518.setDomain(server_name);

G__41518.setPort(server_port);

G__41518.setPath(uri);

G__41518.setQuery(query_string,true);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__41527_SHARP_,p2__41526_SHARP_){
var vec__41528 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(p2__41526_SHARP_,/:\s+/);
...
return p1__41527_SHARP_;
} else {
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__41527_SHARP_,clojure.string.lower_case(k),v);
}
