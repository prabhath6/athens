...
var vec__42423 = ((cljs.core.map_QMARK_(credentials))?cljs.core.map.cljs$core$IFn$_invoke$arity$2(credentials,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"username","username",1605666410),new cljs.core.Keyword(null,"password","password",417022471)], null)):credentials);
var username = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42423,(0),null);
var password = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42423,(1),null);
 ...
 */
cljs_http.util.build_url = (function cljs_http$util$build_url(p__42426){
...
var scheme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42427__$1,new cljs.core.Keyword(null,"scheme","scheme",90199613));
var server_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42427__$1,new cljs.core.Keyword(null,"server-name","server-name",-1012104295));
var server_port = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42427__$1,new cljs.core.Keyword(null,"server-port","server-port",663745648));
var uri = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42427__$1,new cljs.core.Keyword(null,"uri","uri",-774711847));
var query_string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42427__$1,new cljs.core.Keyword(null,"query-string","query-string",-1018845061));
return cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__42430 = (new goog.Uri());
G__42430.setScheme(cljs.core.name((function (){var or__4185__auto__ = scheme;
...
G__42430.setDomain(server_name);

G__42430.setPort(server_port);

G__42430.setPath(uri);

G__42430.setQuery(query_string,true);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__42432_SHARP_,p2__42431_SHARP_){
var vec__42433 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(p2__42431_SHARP_,/:\s+/);
...
return p1__42432_SHARP_;
} else {
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__42432_SHARP_,clojure.string.lower_case(k),v);
}
