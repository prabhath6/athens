...
try{try{var map__46854 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46854__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46854__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
try{try{var map__46880 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var end__45912__auto___46906 = re_frame.interop.now();
var duration__45913__auto___46907 = (end__45912__auto___46906 - new cljs.core.Keyword(null,"start","start",-355208981).cljs$core$IFn$_invoke$arity$1(re_frame.trace._STAR_current_trace_STAR_));
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$3(re_frame.trace.traces,cljs.core.conj,cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(re_frame.trace._STAR_current_trace_STAR_,new cljs.core.Keyword(null,"duration","duration",1444101068),duration__45913__auto___46907,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"end","end",-268185958),re_frame.interop.now()], 0)));

re_frame.trace.run_tracing_callbacks_BANG_(end__45912__auto___46906);
} else {
}
...
var args__4795__auto__ = [];
var len__4789__auto___46925 = arguments.length;
var i__4790__auto___46926 = (0);
while(true){
if((i__4790__auto___46926 < len__4789__auto___46925)){
args__4795__auto__.push((arguments[i__4790__auto___46926]));

var G__46927 = (i__4790__auto___46926 + (1));
i__4790__auto___46926 = G__46927;
continue;
} else {
}
break;
