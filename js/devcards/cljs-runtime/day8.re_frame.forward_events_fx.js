...
return (function (p__111142){
var vec__111143 = p__111142;
var event_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__111143,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__111143,(1),null);
...
var G__111146_111155 = new cljs.core.Keyword(null,"forward-events","forward-events",1216790539);
var G__111147_111156 = (function (){var process_one_entry = (function (p__111148){
var map__111149 = p__111148;
var map__111149__$1 = (((((!((map__111149 == null))))?(((((map__111149.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__111149.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__111149):map__111149);
var m = map__111149__$1;
var unregister = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__111149__$1,new cljs.core.Keyword(null,"unregister","unregister",2105339971));
var register = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__111149__$1,new cljs.core.Keyword(null,"register","register",1968522516));
var events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__111149__$1,new cljs.core.Keyword(null,"events","events",1792552201));
var dispatch_to = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__111149__$1,new cljs.core.Keyword(null,"dispatch-to","dispatch-to",-354764401));
...
var G__111151 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(dispatch_to,event_v);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__111151) : re_frame.core.dispatch.call(null,G__111151));
} else {
return null;
}
});
...
var G__111152 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__111153 = ":forward-events expected a map or a list of maps, but got: ";
var G__111154 = val;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__111152,G__111153,G__111154) : re_frame.core.console.call(null,G__111152,G__111153,G__111154));

}
}
});
})();
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__111146_111155,G__111147_111156) : re_frame.core.reg_fx.call(null,G__111146_111155,G__111147_111156));
