...
return (function (p__60930){
var vec__60931 = p__60930;
var event_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60931,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60931,(1),null);
...
var G__60934_60943 = new cljs.core.Keyword(null,"forward-events","forward-events",1216790539);
var G__60935_60944 = (function (){var process_one_entry = (function (p__60936){
var map__60937 = p__60936;
var map__60937__$1 = (((((!((map__60937 == null))))?(((((map__60937.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__60937.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__60937):map__60937);
var m = map__60937__$1;
var unregister = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60937__$1,new cljs.core.Keyword(null,"unregister","unregister",2105339971));
var register = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60937__$1,new cljs.core.Keyword(null,"register","register",1968522516));
var events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60937__$1,new cljs.core.Keyword(null,"events","events",1792552201));
var dispatch_to = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60937__$1,new cljs.core.Keyword(null,"dispatch-to","dispatch-to",-354764401));
...
var G__60939 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(dispatch_to,event_v);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__60939) : re_frame.core.dispatch.call(null,G__60939));
} else {
return null;
}
});
...
var G__60940 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__60941 = ":forward-events expected a map or a list of maps, but got: ";
var G__60942 = val;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__60940,G__60941,G__60942) : re_frame.core.console.call(null,G__60940,G__60941,G__60942));

}
}
});
})();
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__60934_60943,G__60935_60944) : re_frame.core.reg_fx.call(null,G__60934_60943,G__60935_60944));
