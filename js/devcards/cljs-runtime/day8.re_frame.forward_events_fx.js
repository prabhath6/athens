...
return (function (p__55632){
var vec__55633 = p__55632;
var event_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55633,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55633,(1),null);
...
var G__55636_55645 = new cljs.core.Keyword(null,"forward-events","forward-events",1216790539);
var G__55637_55646 = (function (){var process_one_entry = (function (p__55638){
var map__55639 = p__55638;
var map__55639__$1 = (((((!((map__55639 == null))))?(((((map__55639.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__55639.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__55639):map__55639);
var m = map__55639__$1;
var unregister = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55639__$1,new cljs.core.Keyword(null,"unregister","unregister",2105339971));
var register = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55639__$1,new cljs.core.Keyword(null,"register","register",1968522516));
var events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55639__$1,new cljs.core.Keyword(null,"events","events",1792552201));
var dispatch_to = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55639__$1,new cljs.core.Keyword(null,"dispatch-to","dispatch-to",-354764401));
...
var G__55641 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(dispatch_to,event_v);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__55641) : re_frame.core.dispatch.call(null,G__55641));
} else {
return null;
}
});
...
var G__55642 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__55643 = ":forward-events expected a map or a list of maps, but got: ";
var G__55644 = val;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__55642,G__55643,G__55644) : re_frame.core.console.call(null,G__55642,G__55643,G__55644));

}
}
});
})();
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__55636_55645,G__55637_55646) : re_frame.core.reg_fx.call(null,G__55636_55645,G__55637_55646));
