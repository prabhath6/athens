...
var G__63529 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__63530 = n;
var G__63531 = cljs.core.nnext(bs);
var G__63532 = true;
ret = G__63529;
n = G__63530;
bs = G__63531;
seen_rest_QMARK_ = G__63532;
continue;
} else {
...
});})(G__63510,gmap,defaults,pvec,bents))
;
return fexpr__63509(G__63510);
})();
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__63459_SHARP_){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__63459_SHARP_);
}
})(),cljs.core.name(p1__63459_SHARP_));
}));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(mkn,"syms")){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__63460_SHARP_){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__63460_SHARP_);
}
})(),cljs.core.name(p1__63460_SHARP_));
}));
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__63461_SHARP_,p2__63462_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__63461_SHARP_,p2__63462_SHARP_,(function (){var fexpr__63514 = cljs.core.val(entry);
return (fexpr__63514.cljs$core$IFn$_invoke$arity$1 ? fexpr__63514.cljs$core$IFn$_invoke$arity$1(p2__63462_SHARP_) : fexpr__63514.call(null,p2__63462_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__63515 = cljs.core.key(entry);
return (fexpr__63515.cljs$core$IFn$_invoke$arity$1 ? fexpr__63515.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__63515.call(null,bes));
})());
...
var G__63545 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__63546 = cljs.core.next(bes);
ret = G__63545;
bes = G__63546;
continue;
} else {
...
var temp__5733__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__63466_SHARP_){
return (cljs.core.first(p1__63466_SHARP_) instanceof cljs.core.Keyword);
}),bents));
