...
var G__58233 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__58234 = n;
var G__58235 = cljs.core.nnext(bs);
var G__58236 = true;
ret = G__58233;
n = G__58234;
bs = G__58235;
seen_rest_QMARK_ = G__58236;
continue;
} else {
...
});})(G__58222,gmap,defaults,pvec,bents))
;
return fexpr__58221(G__58222);
})();
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__58173_SHARP_){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__58173_SHARP_);
}
})(),cljs.core.name(p1__58173_SHARP_));
}));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(mkn,"syms")){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__58174_SHARP_){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__58174_SHARP_);
}
})(),cljs.core.name(p1__58174_SHARP_));
}));
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__58175_SHARP_,p2__58176_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58175_SHARP_,p2__58176_SHARP_,(function (){var fexpr__58230 = cljs.core.val(entry);
return (fexpr__58230.cljs$core$IFn$_invoke$arity$1 ? fexpr__58230.cljs$core$IFn$_invoke$arity$1(p2__58176_SHARP_) : fexpr__58230.call(null,p2__58176_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__58231 = cljs.core.key(entry);
return (fexpr__58231.cljs$core$IFn$_invoke$arity$1 ? fexpr__58231.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__58231.call(null,bes));
})());
...
var G__58253 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__58254 = cljs.core.next(bes);
ret = G__58253;
bes = G__58254;
continue;
} else {
...
var temp__5733__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__58177_SHARP_){
return (cljs.core.first(p1__58177_SHARP_) instanceof cljs.core.Keyword);
}),bents));
