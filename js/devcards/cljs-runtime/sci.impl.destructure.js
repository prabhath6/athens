...
var G__58184 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__58185 = n;
var G__58186 = cljs.core.nnext(bs);
var G__58187 = true;
ret = G__58184;
n = G__58185;
bs = G__58186;
seen_rest_QMARK_ = G__58187;
continue;
} else {
...
});})(G__58177,gmap,defaults,pvec,bents))
;
return fexpr__58176(G__58177);
})();
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__58160_SHARP_){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__58160_SHARP_);
}
})(),cljs.core.name(p1__58160_SHARP_));
}));
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__58162_SHARP_,p2__58163_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58162_SHARP_,p2__58163_SHARP_,(function (){var fexpr__58181 = cljs.core.val(entry);
return (fexpr__58181.cljs$core$IFn$_invoke$arity$1 ? fexpr__58181.cljs$core$IFn$_invoke$arity$1(p2__58163_SHARP_) : fexpr__58181.call(null,p2__58163_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__58182 = cljs.core.key(entry);
return (fexpr__58182.cljs$core$IFn$_invoke$arity$1 ? fexpr__58182.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__58182.call(null,bes));
})());
...
var G__58192 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__58193 = cljs.core.next(bes);
ret = G__58192;
bes = G__58193;
continue;
} else {
...
var temp__5733__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__58164_SHARP_){
return (cljs.core.first(p1__58164_SHARP_) instanceof cljs.core.Keyword);
}),bents));
