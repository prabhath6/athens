...
var G__58083 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__58084 = n;
var G__58085 = cljs.core.nnext(bs);
var G__58086 = true;
ret = G__58083;
n = G__58084;
bs = G__58085;
seen_rest_QMARK_ = G__58086;
continue;
} else {
...
});})(G__58070,gmap,defaults,pvec,bents))
;
return fexpr__58069(G__58070);
})();
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__58059_SHARP_){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__58059_SHARP_);
}
})(),cljs.core.name(p1__58059_SHARP_));
}));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(mkn,"syms")){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__58060_SHARP_){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__58060_SHARP_);
}
})(),cljs.core.name(p1__58060_SHARP_));
}));
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__58061_SHARP_,p2__58062_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58061_SHARP_,p2__58062_SHARP_,(function (){var fexpr__58073 = cljs.core.val(entry);
return (fexpr__58073.cljs$core$IFn$_invoke$arity$1 ? fexpr__58073.cljs$core$IFn$_invoke$arity$1(p2__58062_SHARP_) : fexpr__58073.call(null,p2__58062_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__58076 = cljs.core.key(entry);
return (fexpr__58076.cljs$core$IFn$_invoke$arity$1 ? fexpr__58076.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__58076.call(null,bes));
})());
...
var G__58091 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__58092 = cljs.core.next(bes);
ret = G__58091;
bes = G__58092;
continue;
} else {
...
var temp__5733__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__58063_SHARP_){
return (cljs.core.first(p1__58063_SHARP_) instanceof cljs.core.Keyword);
}),bents));
