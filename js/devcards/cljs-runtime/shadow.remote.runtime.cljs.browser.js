...
shadow.remote.runtime.cljs.browser.abort_BANG_ = (function shadow$remote$runtime$cljs$browser$abort_BANG_(p__60585,action,ex){
var map__60586 = p__60585;
...
var state = map__60586__$1;
var callback = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60586__$1,new cljs.core.Keyword(null,"callback","callback",-705136228));
var G__60588 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(state,new cljs.core.Keyword(null,"failed","failed",-1397425762),true,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"completed","completed",-486056503),false,new cljs.core.Keyword(null,"ex","ex",-1413771341),ex,new cljs.core.Keyword(null,"ex-action","ex-action",672251553),action], 0));
return (callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(G__60588) : callback.call(null,G__60588));
});
shadow.remote.runtime.cljs.browser.interpret_action = (function shadow$remote$runtime$cljs$browser$interpret_action(p__60589,p__60590){
...
var state = map__60591__$1;
var runtime = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60591__$1,new cljs.core.Keyword(null,"runtime","runtime",-1331573996));
...
var action = map__60592__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60592__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var G__60595 = type;
var G__60595__$1 = (((G__60595 instanceof cljs.core.Keyword))?G__60595.fqn:null);
switch (G__60595__$1) {
case "repl/invoke":
var map__60596 = action;
...
var js = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60596__$1,new cljs.core.Keyword(null,"js","js",1768080579));
try{var res = runtime.eval_js(js);
var G__60599 = cljs.core.update.cljs$core$IFn$_invoke$arity$4(state,new cljs.core.Keyword(null,"eval-results","eval-results",553789722),cljs.core.conj,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"value","value",305978217),res,new cljs.core.Keyword(null,"action","action",-811238024),action], null));
return (shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1 ? shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1(G__60599) : shadow.remote.runtime.cljs.browser.interpret_actions.call(null,G__60599));
}catch (e60598){var ex = e60598;
return shadow.remote.runtime.cljs.browser.abort_BANG_(state,action,ex);
}
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__60595__$1)].join('')));

}
});
shadow.remote.runtime.cljs.browser.interpret_actions = (function shadow$remote$runtime$cljs$browser$interpret_actions(p__60600){
...
var state = map__60601__$1;
var actions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60601__$1,new cljs.core.Keyword(null,"actions","actions",-812656882));
if(cljs.core.empty_QMARK_(actions)){
var fexpr__60603 = new cljs.core.Keyword(null,"callback","callback",-705136228).cljs$core$IFn$_invoke$arity$1(state);
return (fexpr__60603.cljs$core$IFn$_invoke$arity$1 ? fexpr__60603.cljs$core$IFn$_invoke$arity$1(state) : fexpr__60603.call(null,state));
} else {
var map__60604 = cljs.core.first(actions);
...
var action = map__60604__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60604__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
var self__ = this;
var this$ = this;
var G__60611 = [shadow.cljs.devtools.client.env.get_url_base(),"/worker/compile/",shadow.cljs.devtools.client.env.build_id,"/",shadow.cljs.devtools.client.env.proc_id,"/browser"].join('');
var G__60612 = (function (res){
var req = this;
var map__60616 = shadow.remote.runtime.cljs.browser.transit_read(req.getResponseText());
...
var result = map__60616__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60616__$1,new cljs.core.Keyword(null,"type","type",1174270348));
if((!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("repl","actions","repl/actions",-809718877),type)))){
var G__60618 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"failed","failed",-1397425762),true,new cljs.core.Keyword(null,"result","result",1415092211),result], null);
return (callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(G__60618) : callback.call(null,G__60618));
} else {
...
var G__60613 = "POST";
var G__60614 = shadow.remote.runtime.cljs.browser.transit_str(msg);
var G__60615 = ({"content-type": "application/transit+json; charset=utf-8"});
return goog.net.XhrIo.send(G__60611,G__60612,G__60613,G__60614,G__60615);
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k60607,else__4442__auto__){
var self__ = this;
var this__4441__auto____$1 = this;
var G__60619 = k60607;
var G__60619__$1 = (((G__60619 instanceof cljs.core.Keyword))?G__60619.fqn:null);
switch (G__60619__$1) {
case "ws":
return self__.ws;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k60607,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__60620){
var vec__60621 = p__60620;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60621,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60621,(1),null);
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__60606){
var self__ = this;
var G__60606__$1 = this;
return (new cljs.core.RecordIter((0),G__60606__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ws","ws",86841443),new cljs.core.Keyword(null,"state-ref","state-ref",2127874952)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var h__4297__auto____$1 = (function (){var fexpr__60624 = (function (coll__4436__auto__){
return (725844968 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__60624(this__4435__auto____$1);
})();
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this60608,other60609){
var self__ = this;
var this60608__$1 = this;
return (((!((other60609 == null)))) && ((this60608__$1.constructor === other60609.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this60608__$1.ws,other60609.ws)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this60608__$1.state_ref,other60609.state_ref)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this60608__$1.__extmap,other60609.__extmap)));
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__60606){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__60625 = cljs.core.keyword_identical_QMARK_;
var expr__60626 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__60628 = new cljs.core.Keyword(null,"ws","ws",86841443);
var G__60629 = expr__60626;
return (pred__60625.cljs$core$IFn$_invoke$arity$2 ? pred__60625.cljs$core$IFn$_invoke$arity$2(G__60628,G__60629) : pred__60625.call(null,G__60628,G__60629));
})())){
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(G__60606,self__.state_ref,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__60630 = new cljs.core.Keyword(null,"state-ref","state-ref",2127874952);
var G__60631 = expr__60626;
return (pred__60625.cljs$core$IFn$_invoke$arity$2 ? pred__60625.cljs$core$IFn$_invoke$arity$2(G__60630,G__60631) : pred__60625.call(null,G__60630,G__60631));
})())){
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,G__60606,self__.__meta,self__.__extmap,null));
} else {
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__60606),null));
}
}
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__60606){
var self__ = this;
var this__4438__auto____$1 = this;
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,G__60606,self__.__extmap,self__.__hash));
}));
 ...
 */
shadow.remote.runtime.cljs.browser.map__GT_BrowserRuntime = (function shadow$remote$runtime$cljs$browser$map__GT_BrowserRuntime(G__60610){
var extmap__4478__auto__ = (function (){var G__60632 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__60610,new cljs.core.Keyword(null,"ws","ws",86841443),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"state-ref","state-ref",2127874952)], 0));
if(cljs.core.record_QMARK_(G__60610)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__60632);
} else {
return G__60632;
}
})();
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(new cljs.core.Keyword(null,"ws","ws",86841443).cljs$core$IFn$_invoke$arity$1(G__60610),new cljs.core.Keyword(null,"state-ref","state-ref",2127874952).cljs$core$IFn$_invoke$arity$1(G__60610),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var runtime = (function (){var G__60633 = (new shadow.remote.runtime.cljs.browser.BrowserRuntime(socket,state_ref,null,null,null));
shadow.remote.runtime.shared.add_defaults(G__60633);
...
var map__60634 = temp__5737__auto__;
...
var stop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60634__$1,new cljs.core.Keyword(null,"stop","stop",-2140911342));
