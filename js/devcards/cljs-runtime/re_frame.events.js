...
var make_chain = (function (p1__46577_SHARP_){
return cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.flatten(p1__46577_SHARP_));
});
...
re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["re-frame: when registering",id,", expected interceptors, but got:",not_i_46591], 0));
}
} else {
}
...
var _STAR_handling_STAR__orig_val__46583 = re_frame.events._STAR_handling_STAR_;
var _STAR_handling_STAR__temp_val__46584 = event_v;
(re_frame.events._STAR_handling_STAR_ = _STAR_handling_STAR__temp_val__46584);
...
}finally {(re_frame.events._STAR_handling_STAR_ = _STAR_handling_STAR__orig_val__46583);
}}
} else {
return null;
}
