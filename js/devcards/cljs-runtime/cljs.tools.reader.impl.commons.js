...
var G__24359 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__24359;
continue;
} else {
return ch;
...
var vec__24349 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24349,(0),null);
return (match === s);
});
