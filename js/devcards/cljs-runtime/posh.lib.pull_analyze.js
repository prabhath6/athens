...
return cljs.core.vec(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29084_SHARP_){
if(cljs.core.coll_QMARK_(p1__29084_SHARP_)){
return (posh.lib.pull_analyze.insert_dbid.cljs$core$IFn$_invoke$arity$1 ? posh.lib.pull_analyze.insert_dbid.cljs$core$IFn$_invoke$arity$1(p1__29084_SHARP_) : posh.lib.pull_analyze.insert_dbid.call(null,p1__29084_SHARP_));
} else {
return p1__29084_SHARP_;
}
...
var vec__29093 = cljs.core.first(pull_map);
...
})())?cljs.core.concat.cljs$core$IFn$_invoke$arity$2((((!(r_QMARK_)))?cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__29090_SHARP_){
return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [entity_id,k__$1,new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(p1__29090_SHARP_)], null)],null));
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([v], 0)):null),cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__29091_SHARP_){
var G__29102 = schema;
var G__29103 = new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(p1__29091_SHARP_);
var G__29104 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([((r_QMARK_)?cljs.core.PersistentArrayMap.createAsIfByAssoc([k__$1,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("db","id","db/id",-1388397098),entity_id], null)]):null),p1__29091_SHARP_], 0));
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2((cljs.core.truth_(posh.lib.pull_analyze.cardinality_many_QMARK_(schema,k__$1))?cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__29092_SHARP_){
return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [entity_id,k__$1,p1__29092_SHARP_], null)],null));
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([v], 0)):new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [entity_id,k__$1,v], null)], null)),(function (){var G__29109 = schema;
var G__29110 = entity_id;
var G__29111 = cljs.core.rest(pull_map);
return (posh.lib.pull_analyze.tx_datoms_for_pull_map.cljs$core$IFn$_invoke$arity$3 ? posh.lib.pull_analyze.tx_datoms_for_pull_map.cljs$core$IFn$_invoke$arity$3(G__29109,G__29110,G__29111) : posh.lib.pull_analyze.tx_datoms_for_pull_map.call(null,G__29109,G__29110,G__29111));
})());
...
var G__29116 = cljs.core.first(x);
var fexpr__29115 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol(null,"limit","limit",284709164,null),null,"limit",null], null), null);
return (fexpr__29115.cljs$core$IFn$_invoke$arity$1 ? fexpr__29115.cljs$core$IFn$_invoke$arity$1(G__29116) : fexpr__29115.call(null,G__29116));
} else {
return false;
}
});
...
var entity_keys = cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__29125_SHARP_){
return ((cljs.core.map_QMARK_(p1__29125_SHARP_)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("db","id","db/id",-1388397098),p1__29125_SHARP_)));
}),pull_pattern);
var val_keys = cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__29130_SHARP_){
return ((posh.lib.pull_analyze.reverse_lookup_QMARK_(p1__29130_SHARP_)) || (posh.lib.pull_analyze.ref_QMARK_(schema,p1__29130_SHARP_)));
}),entity_keys);
...
})())?cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__29139_SHARP_){
return (posh.lib.pull_analyze.tx_pattern_for_pull.cljs$core$IFn$_invoke$arity$4 ? posh.lib.pull_analyze.tx_pattern_for_pull.cljs$core$IFn$_invoke$arity$4(schema,ref_pull,p1__29139_SHARP_,refs_only_QMARK_) : posh.lib.pull_analyze.tx_pattern_for_pull.call(null,schema,ref_pull,p1__29139_SHARP_,refs_only_QMARK_));
...
posh.lib.pull_analyze.pull_analyze = (function posh$lib$pull_analyze$pull_analyze(dcfg,retrieve,p__29195,pull_pattern,ent_id){
var map__29200 = p__29195;
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29200__$1,new cljs.core.Keyword(null,"db","db",993250759));
var db_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29200__$1,new cljs.core.Keyword(null,"db-id","db-id",747248515));
var schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29200__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
