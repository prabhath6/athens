...
var len__4789__auto___58100 = arguments.length;
var i__4790__auto___58101 = (0);
while(true){
if((i__4790__auto___58101 < len__4789__auto___58100)){
args__4795__auto__.push((arguments[i__4790__auto___58101]));

var G__58102 = (i__4790__auto___58101 + (1));
i__4790__auto___58101 = G__58102;
continue;
} else {
}
break;
...
/** @this {Function} */
(athens.devcards.breadcrumbs.breadcrumbs_list.cljs$lang$applyTo = (function (seq58085){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq58085));
}));

athens.devcards.breadcrumbs.breadcrumb = (function athens$devcards$breadcrumbs$breadcrumb(var_args){
var args__4795__auto__ = [];
var len__4789__auto___58103 = arguments.length;
var i__4790__auto___58104 = (0);
while(true){
if((i__4790__auto___58104 < len__4789__auto___58103)){
args__4795__auto__.push((arguments[i__4790__auto___58104]));

var G__58105 = (i__4790__auto___58104 + (1));
i__4790__auto___58104 = G__58105;
continue;
} else {
}
break;
...
(athens.devcards.breadcrumbs.breadcrumb.cljs$core$IFn$_invoke$arity$variadic = (function (p__58088,label){
...
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58089__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
/** @this {Function} */
(athens.devcards.breadcrumbs.breadcrumb.cljs$lang$applyTo = (function (seq58086){
var G__58087 = cljs.core.first(seq58086);
var seq58086__$1 = cljs.core.next(seq58086);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__58087,seq58086__$1);
}));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.breadcrumbs !== 'undefined') && (typeof athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58091 !== 'undefined')){
} else {
...
*/
athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58091 = (function (meta58092){
this.meta58092 = meta58092;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58091.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_58093,meta58092__$1){
var self__ = this;
var _58093__$1 = this;
return (new athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58091(meta58092__$1));
}));

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58091.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_58093){
var self__ = this;
var _58093__$1 = this;
return self__.meta58092;
}));

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58091.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58091.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38808__auto__,devcard_opts__38809__auto__){
var self__ = this;
var this__38808__auto____$1 = this;
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(devcard_opts__38809__auto__,new cljs.core.Keyword(null,"main-obj","main-obj",-1544409742),(function (){var v__38827__auto__ = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.breadcrumbs.breadcrumbs_list,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.breadcrumbs.breadcrumb,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),(0)], null),"Athens"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.breadcrumbs.breadcrumb,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),(1)], null),"Components"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.breadcrumbs.breadcrumb,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),(2)], null),"Breadcrumbs"], null)], null);
...
(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58091.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta58092","meta58092",-1112591739,null)], null);
}));

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58091.cljs$lang$type = true);

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58091.cljs$lang$ctorStr = "athens.devcards.breadcrumbs/t_athens$devcards$breadcrumbs58091");

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58091.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.breadcrumbs/t_athens$devcards$breadcrumbs58091");
}));

/**
 * Positional factory function for athens.devcards.breadcrumbs/t_athens$devcards$breadcrumbs58091.
 */
athens.devcards.breadcrumbs.__GT_t_athens$devcards$breadcrumbs58091 = (function athens$devcards$breadcrumbs$__GT_t_athens$devcards$breadcrumbs58091(meta58092){
return (new athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58091(meta58092));
});

}

return (new athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58091(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.breadcrumbs !== 'undefined') && (typeof athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58094 !== 'undefined')){
} else {
...
(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58094.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta58095","meta58095",1589776977,null)], null);
}));

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58094.cljs$lang$type = true);

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58094.cljs$lang$ctorStr = "athens.devcards.breadcrumbs/t_athens$devcards$breadcrumbs58094");

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58094.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.breadcrumbs/t_athens$devcards$breadcrumbs58094");
}));

/**
 * Positional factory function for athens.devcards.breadcrumbs/t_athens$devcards$breadcrumbs58094.
 */
athens.devcards.breadcrumbs.__GT_t_athens$devcards$breadcrumbs58094 = (function athens$devcards$breadcrumbs$__GT_t_athens$devcards$breadcrumbs58094(meta58095){
return (new athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58094(meta58095));
});

}

return (new athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58094(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.breadcrumbs !== 'undefined') && (typeof athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58097 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58097 = (function (meta58098){
this.meta58098 = meta58098;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58097.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_58099,meta58098__$1){
var self__ = this;
var _58099__$1 = this;
return (new athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58097(meta58098__$1));
}));

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58097.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_58099){
var self__ = this;
var _58099__$1 = this;
return self__.meta58098;
}));

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58097.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58097.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38808__auto__,devcard_opts__38809__auto__){
var self__ = this;
var this__38808__auto____$1 = this;
...
(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58097.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta58098","meta58098",1404070107,null)], null);
}));

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58097.cljs$lang$type = true);

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58097.cljs$lang$ctorStr = "athens.devcards.breadcrumbs/t_athens$devcards$breadcrumbs58097");

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58097.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.breadcrumbs/t_athens$devcards$breadcrumbs58097");
}));

/**
 * Positional factory function for athens.devcards.breadcrumbs/t_athens$devcards$breadcrumbs58097.
 */
athens.devcards.breadcrumbs.__GT_t_athens$devcards$breadcrumbs58097 = (function athens$devcards$breadcrumbs$__GT_t_athens$devcards$breadcrumbs58097(meta58098){
return (new athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58097(meta58098));
});

}

return (new athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58097(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
