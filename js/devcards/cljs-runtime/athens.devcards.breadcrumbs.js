...
var len__4789__auto___52008 = arguments.length;
var i__4790__auto___52009 = (0);
while(true){
if((i__4790__auto___52009 < len__4789__auto___52008)){
args__4795__auto__.push((arguments[i__4790__auto___52009]));

var G__52010 = (i__4790__auto___52009 + (1));
i__4790__auto___52009 = G__52010;
continue;
} else {
}
break;
...
/** @this {Function} */
(athens.devcards.breadcrumbs.breadcrumbs_list.cljs$lang$applyTo = (function (seq51993){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq51993));
}));

athens.devcards.breadcrumbs.breadcrumb = (function athens$devcards$breadcrumbs$breadcrumb(var_args){
var args__4795__auto__ = [];
var len__4789__auto___52011 = arguments.length;
var i__4790__auto___52012 = (0);
while(true){
if((i__4790__auto___52012 < len__4789__auto___52011)){
args__4795__auto__.push((arguments[i__4790__auto___52012]));

var G__52013 = (i__4790__auto___52012 + (1));
i__4790__auto___52012 = G__52013;
continue;
} else {
}
break;
...
(athens.devcards.breadcrumbs.breadcrumb.cljs$core$IFn$_invoke$arity$variadic = (function (p__51996,label){
...
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51997__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
/** @this {Function} */
(athens.devcards.breadcrumbs.breadcrumb.cljs$lang$applyTo = (function (seq51994){
var G__51995 = cljs.core.first(seq51994);
var seq51994__$1 = cljs.core.next(seq51994);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51995,seq51994__$1);
}));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.breadcrumbs !== 'undefined') && (typeof athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs51999 !== 'undefined')){
} else {
...
*/
athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs51999 = (function (meta52000){
this.meta52000 = meta52000;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs51999.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_52001,meta52000__$1){
var self__ = this;
var _52001__$1 = this;
return (new athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs51999(meta52000__$1));
}));

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs51999.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_52001){
var self__ = this;
var _52001__$1 = this;
return self__.meta52000;
}));

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs51999.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs51999.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__46449__auto__,devcard_opts__46450__auto__){
var self__ = this;
var this__46449__auto____$1 = this;
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(devcard_opts__46450__auto__,new cljs.core.Keyword(null,"main-obj","main-obj",-1544409742),(function (){var v__46468__auto__ = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.breadcrumbs.breadcrumbs_list,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.breadcrumbs.breadcrumb,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),(0)], null),"Athens"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.breadcrumbs.breadcrumb,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),(1)], null),"Components"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.breadcrumbs.breadcrumb,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),(2)], null),"Breadcrumbs"], null)], null);
...
(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs51999.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta52000","meta52000",-2012098974,null)], null);
}));

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs51999.cljs$lang$type = true);

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs51999.cljs$lang$ctorStr = "athens.devcards.breadcrumbs/t_athens$devcards$breadcrumbs51999");

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs51999.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.breadcrumbs/t_athens$devcards$breadcrumbs51999");
}));

/**
 * Positional factory function for athens.devcards.breadcrumbs/t_athens$devcards$breadcrumbs51999.
 */
athens.devcards.breadcrumbs.__GT_t_athens$devcards$breadcrumbs51999 = (function athens$devcards$breadcrumbs$__GT_t_athens$devcards$breadcrumbs51999(meta52000){
return (new athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs51999(meta52000));
});

}

return (new athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs51999(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.breadcrumbs !== 'undefined') && (typeof athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs52002 !== 'undefined')){
} else {
...
(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs52002.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta52003","meta52003",1773158770,null)], null);
}));

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs52002.cljs$lang$type = true);

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs52002.cljs$lang$ctorStr = "athens.devcards.breadcrumbs/t_athens$devcards$breadcrumbs52002");

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs52002.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.breadcrumbs/t_athens$devcards$breadcrumbs52002");
}));

/**
 * Positional factory function for athens.devcards.breadcrumbs/t_athens$devcards$breadcrumbs52002.
 */
athens.devcards.breadcrumbs.__GT_t_athens$devcards$breadcrumbs52002 = (function athens$devcards$breadcrumbs$__GT_t_athens$devcards$breadcrumbs52002(meta52003){
return (new athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs52002(meta52003));
});

}

return (new athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs52002(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.breadcrumbs !== 'undefined') && (typeof athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs52005 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs52005 = (function (meta52006){
this.meta52006 = meta52006;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs52005.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_52007,meta52006__$1){
var self__ = this;
var _52007__$1 = this;
return (new athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs52005(meta52006__$1));
}));

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs52005.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_52007){
var self__ = this;
var _52007__$1 = this;
return self__.meta52006;
}));

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs52005.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs52005.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__46449__auto__,devcard_opts__46450__auto__){
var self__ = this;
var this__46449__auto____$1 = this;
...
(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs52005.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta52006","meta52006",-517686374,null)], null);
}));

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs52005.cljs$lang$type = true);

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs52005.cljs$lang$ctorStr = "athens.devcards.breadcrumbs/t_athens$devcards$breadcrumbs52005");

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs52005.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.breadcrumbs/t_athens$devcards$breadcrumbs52005");
}));

/**
 * Positional factory function for athens.devcards.breadcrumbs/t_athens$devcards$breadcrumbs52005.
 */
athens.devcards.breadcrumbs.__GT_t_athens$devcards$breadcrumbs52005 = (function athens$devcards$breadcrumbs$__GT_t_athens$devcards$breadcrumbs52005(meta52006){
return (new athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs52005(meta52006));
});

}

return (new athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs52005(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
