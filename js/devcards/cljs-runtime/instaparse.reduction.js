...
var G__55967 = new cljs.core.Keyword(null,"reduction-type","reduction-type",-488293450).cljs$core$IFn$_invoke$arity$1(f);
var G__55967__$1 = (((G__55967 instanceof cljs.core.Keyword))?G__55967.fqn:null);
switch (G__55967__$1) {
case "raw":
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$reduction$iter__55970(s__55971){
return (new cljs.core.LazySeq(null,(function (){
var s__55971__$1 = s__55971;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__55971__$1);
if(temp__5735__auto__){
var s__55971__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__55971__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__55971__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__55973 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__55972 = (0);
while(true){
if((i__55972 < size__4581__auto__)){
var vec__55974 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__55972);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55974,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55974,(1),null);
cljs.core.chunk_append(b__55973,(cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)));

var G__55982 = (i__55972 + (1));
i__55972 = G__55982;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__55973),instaparse$reduction$iter__55970(cljs.core.chunk_rest(s__55971__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__55973),null);
}
} else {
var vec__55977 = cljs.core.first(s__55971__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55977,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55977,(1),null);
return cljs.core.cons((cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)),instaparse$reduction$iter__55970(cljs.core.rest(s__55971__$2)));
}
} else {
return null;
}
