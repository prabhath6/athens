...
var G__42059 = new cljs.core.Keyword(null,"reduction-type","reduction-type",-488293450).cljs$core$IFn$_invoke$arity$1(f);
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$reduction$iter__42062(s__42063){
return (new cljs.core.LazySeq(null,(function (){
var s__42063__$1 = s__42063;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__42063__$1);
if(temp__5735__auto__){
var s__42063__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__42063__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__42063__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__42065 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__42064 = (0);
while(true){
if((i__42064 < size__4581__auto__)){
var vec__42066 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__42064);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42066,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42066,(1),null);
cljs.core.chunk_append(b__42065,(cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)));

var G__42090 = (i__42064 + (1));
i__42064 = G__42090;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__42065),instaparse$reduction$iter__42062(cljs.core.chunk_rest(s__42063__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__42065),null);
}
} else {
var vec__42069 = cljs.core.first(s__42063__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42069,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42069,(1),null);
return cljs.core.cons((cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)),instaparse$reduction$iter__42062(cljs.core.rest(s__42063__$2)));
}
} else {
return null;
}
