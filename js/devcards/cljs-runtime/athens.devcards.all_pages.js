...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.all_pages !== 'undefined') && (typeof athens.devcards.all_pages.t_athens$devcards$all_pages55570 !== 'undefined')){
} else {
...
*/
athens.devcards.all_pages.t_athens$devcards$all_pages55570 = (function (meta55571){
this.meta55571 = meta55571;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.all_pages.t_athens$devcards$all_pages55570.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_55572,meta55571__$1){
var self__ = this;
var _55572__$1 = this;
return (new athens.devcards.all_pages.t_athens$devcards$all_pages55570(meta55571__$1));
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55570.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_55572){
var self__ = this;
var _55572__$1 = this;
return self__.meta55571;
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55570.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.all_pages.t_athens$devcards$all_pages55570.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
...
(athens.devcards.all_pages.t_athens$devcards$all_pages55570.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta55571","meta55571",-1500746964,null)], null);
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55570.cljs$lang$type = true);

(athens.devcards.all_pages.t_athens$devcards$all_pages55570.cljs$lang$ctorStr = "athens.devcards.all-pages/t_athens$devcards$all_pages55570");

(athens.devcards.all_pages.t_athens$devcards$all_pages55570.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.all-pages/t_athens$devcards$all_pages55570");
}));

/**
 * Positional factory function for athens.devcards.all-pages/t_athens$devcards$all_pages55570.
 */
athens.devcards.all_pages.__GT_t_athens$devcards$all_pages55570 = (function athens$devcards$all_pages$__GT_t_athens$devcards$all_pages55570(meta55571){
return (new athens.devcards.all_pages.t_athens$devcards$all_pages55570(meta55571));
});

}

return (new athens.devcards.all_pages.t_athens$devcards$all_pages55570(null));
})()
...
(athens.devcards.all_pages.t_athens$devcards$all_pages55587.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
var this__38815__auto____$1 = this;
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.all_pages !== 'undefined') && (typeof athens.devcards.all_pages.t_athens$devcards$all_pages55591 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.all_pages.t_athens$devcards$all_pages55591 = (function (meta55592){
this.meta55592 = meta55592;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.all_pages.t_athens$devcards$all_pages55591.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_55593,meta55592__$1){
var self__ = this;
var _55593__$1 = this;
return (new athens.devcards.all_pages.t_athens$devcards$all_pages55591(meta55592__$1));
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55591.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_55593){
var self__ = this;
var _55593__$1 = this;
return self__.meta55592;
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55591.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.all_pages.t_athens$devcards$all_pages55591.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
var this__38815__auto____$1 = this;
...
(athens.devcards.all_pages.t_athens$devcards$all_pages55591.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta55592","meta55592",1094118965,null)], null);
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55591.cljs$lang$type = true);

(athens.devcards.all_pages.t_athens$devcards$all_pages55591.cljs$lang$ctorStr = "athens.devcards.all-pages/t_athens$devcards$all_pages55591");

(athens.devcards.all_pages.t_athens$devcards$all_pages55591.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.all-pages/t_athens$devcards$all_pages55591");
}));

/**
 * Positional factory function for athens.devcards.all-pages/t_athens$devcards$all_pages55591.
 */
athens.devcards.all_pages.__GT_t_athens$devcards$all_pages55591 = (function athens$devcards$all_pages$__GT_t_athens$devcards$all_pages55591(meta55592){
return (new athens.devcards.all_pages.t_athens$devcards$all_pages55591(meta55592));
});

}

return (new athens.devcards.all_pages.t_athens$devcards$all_pages55591(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
