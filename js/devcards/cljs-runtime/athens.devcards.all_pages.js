...
var c__4580__auto__ = cljs.core.chunk_first(s__55562__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__55564 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__55563 = (0);
while(true){
if((i__55563 < size__4581__auto__)){
var map__55567 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__55563);
...
cljs.core.chunk_append(b__55564,cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tr","tr",-1424774646),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),athens.lib.dom.attributes.with_attributes.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([stylefy.core.use_sub_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.all_pages.table_style,new cljs.core.Keyword(null,"td-title","td-title",-2048420439)),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__55563,map__55567,map__55567__$1,uid,title,modified,created,children,c__4580__auto__,size__4581__auto__,b__55564,s__55562__$2,temp__5735__auto__,page_eids,pages){
return (function (){
return athens.router.navigate_uid(uid);
});})(i__55563,map__55567,map__55567__$1,uid,title,modified,created,children,c__4580__auto__,size__4581__auto__,b__55564,s__55562__$2,temp__5735__auto__,page_eids,pages))
], null)], 0)),title], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_sub_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.all_pages.table_style,new cljs.core.Keyword(null,"body-preview","body-preview",-543779304)),clojure.string.join.cljs$core$IFn$_invoke$arity$1(" "),cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (i__55563,map__55567,map__55567__$1,uid,title,modified,created,children,c__4580__auto__,size__4581__auto__,b__55564,s__55562__$2,temp__5735__auto__,page_eids,pages){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__55564),athens$devcards$all_pages$table_$_iter__55561(cljs.core.chunk_rest(s__55562__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__55564),null);
}
} else {
var map__55570 = cljs.core.first(s__55562__$2);
...
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tr","tr",-1424774646),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),athens.lib.dom.attributes.with_attributes.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([stylefy.core.use_sub_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.all_pages.table_style,new cljs.core.Keyword(null,"td-title","td-title",-2048420439)),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (map__55570,map__55570__$1,uid,title,modified,created,children,s__55562__$2,temp__5735__auto__,page_eids,pages){
return (function (){
return athens.router.navigate_uid(uid);
});})(map__55570,map__55570__$1,uid,title,modified,created,children,s__55562__$2,temp__5735__auto__,page_eids,pages))
], null)], 0)),title], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_sub_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.all_pages.table_style,new cljs.core.Keyword(null,"body-preview","body-preview",-543779304)),clojure.string.join.cljs$core$IFn$_invoke$arity$1(" "),cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (map__55570,map__55570__$1,uid,title,modified,created,children,s__55562__$2,temp__5735__auto__,page_eids,pages){
return (function (p1__55553_SHARP_){
return ["\u2022 ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("block","string","block/string",-2066596447).cljs$core$IFn$_invoke$arity$1(p1__55553_SHARP_))].join('');
});})(map__55570,map__55570__$1,uid,title,modified,created,children,s__55562__$2,temp__5735__auto__,page_eids,pages))
,children)], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),stylefy.core.use_sub_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.all_pages.table_style,new cljs.core.Keyword(null,"td-date","td-date",-1089366042)),athens.devcards.all_pages.date_string(modified)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),stylefy.core.use_sub_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.all_pages.table_style,new cljs.core.Keyword(null,"td-date","td-date",-1089366042)),athens.devcards.all_pages.date_string(created)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid], null)),athens$devcards$all_pages$table_$_iter__55561(cljs.core.rest(s__55562__$2)));
}
} else {
return null;
}
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.all_pages !== 'undefined') && (typeof athens.devcards.all_pages.t_athens$devcards$all_pages55609 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.all_pages.t_athens$devcards$all_pages55609 = (function (meta55610){
this.meta55610 = meta55610;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.all_pages.t_athens$devcards$all_pages55609.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_55611,meta55610__$1){
var self__ = this;
var _55611__$1 = this;
return (new athens.devcards.all_pages.t_athens$devcards$all_pages55609(meta55610__$1));
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55609.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_55611){
var self__ = this;
var _55611__$1 = this;
return self__.meta55610;
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55609.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.all_pages.t_athens$devcards$all_pages55609.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
var this__38815__auto____$1 = this;
...
(athens.devcards.all_pages.t_athens$devcards$all_pages55609.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta55610","meta55610",-1409298789,null)], null);
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55609.cljs$lang$type = true);

(athens.devcards.all_pages.t_athens$devcards$all_pages55609.cljs$lang$ctorStr = "athens.devcards.all-pages/t_athens$devcards$all_pages55609");

(athens.devcards.all_pages.t_athens$devcards$all_pages55609.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.all-pages/t_athens$devcards$all_pages55609");
}));

/**
 * Positional factory function for athens.devcards.all-pages/t_athens$devcards$all_pages55609.
 */
athens.devcards.all_pages.__GT_t_athens$devcards$all_pages55609 = (function athens$devcards$all_pages$__GT_t_athens$devcards$all_pages55609(meta55610){
return (new athens.devcards.all_pages.t_athens$devcards$all_pages55609(meta55610));
});

}

return (new athens.devcards.all_pages.t_athens$devcards$all_pages55609(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
