...
athens.devcards.spinner.spinner_component = (function athens$devcards$spinner$spinner_component(p__60931){
...
var message = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60932__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60932__$1,new cljs.core.Keyword(null,"style","style",-496642736));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner60934 !== 'undefined')){
} else {
...
*/
athens.devcards.spinner.t_athens$devcards$spinner60934 = (function (meta60935){
this.meta60935 = meta60935;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner60934.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60936,meta60935__$1){
var self__ = this;
var _60936__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner60934(meta60935__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner60934.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60936){
var self__ = this;
var _60936__$1 = this;
return self__.meta60935;
}));

(athens.devcards.spinner.t_athens$devcards$spinner60934.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner60934.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(devcard_opts__41677__auto__,new cljs.core.Keyword(null,"main-obj","main-obj",-1544409742),(function (){var v__41695__auto__ = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.spinner.spinner_component,stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.devcards.spinner.spinner_style)], null);
...
(athens.devcards.spinner.t_athens$devcards$spinner60934.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta60935","meta60935",1897154304,null)], null);
}));

(athens.devcards.spinner.t_athens$devcards$spinner60934.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner60934.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner60934");

(athens.devcards.spinner.t_athens$devcards$spinner60934.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner60934");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner60934.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner60934 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner60934(meta60935){
return (new athens.devcards.spinner.t_athens$devcards$spinner60934(meta60935));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner60934(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner60937 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.spinner.t_athens$devcards$spinner60937 = (function (meta60938){
this.meta60938 = meta60938;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner60937.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60939,meta60938__$1){
var self__ = this;
var _60939__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner60937(meta60938__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner60937.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60939){
var self__ = this;
var _60939__$1 = this;
return self__.meta60938;
}));

(athens.devcards.spinner.t_athens$devcards$spinner60937.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner60937.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner60937.getBasis = (function (){
...
(athens.devcards.spinner.t_athens$devcards$spinner60937.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner60937.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner60937");

(athens.devcards.spinner.t_athens$devcards$spinner60937.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner60937");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner60937.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner60937 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner60937(meta60938){
return (new athens.devcards.spinner.t_athens$devcards$spinner60937(meta60938));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner60937(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
