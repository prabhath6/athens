...
athens.devcards.spinner.spinner_component = (function athens$devcards$spinner$spinner_component(p__60340){
...
var message = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60341__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60341__$1,new cljs.core.Keyword(null,"style","style",-496642736));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner60343 !== 'undefined')){
} else {
...
*/
athens.devcards.spinner.t_athens$devcards$spinner60343 = (function (meta60344){
this.meta60344 = meta60344;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner60343.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60345,meta60344__$1){
var self__ = this;
var _60345__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner60343(meta60344__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner60343.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60345){
var self__ = this;
var _60345__$1 = this;
return self__.meta60344;
}));

(athens.devcards.spinner.t_athens$devcards$spinner60343.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner60343.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38808__auto__,devcard_opts__38809__auto__){
var self__ = this;
var this__38808__auto____$1 = this;
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(devcard_opts__38809__auto__,new cljs.core.Keyword(null,"main-obj","main-obj",-1544409742),(function (){var v__38827__auto__ = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.spinner.spinner_component,stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.devcards.spinner.spinner_style)], null);
...
(athens.devcards.spinner.t_athens$devcards$spinner60343.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta60344","meta60344",-623799242,null)], null);
}));

(athens.devcards.spinner.t_athens$devcards$spinner60343.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner60343.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner60343");

(athens.devcards.spinner.t_athens$devcards$spinner60343.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner60343");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner60343.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner60343 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner60343(meta60344){
return (new athens.devcards.spinner.t_athens$devcards$spinner60343(meta60344));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner60343(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner60346 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.spinner.t_athens$devcards$spinner60346 = (function (meta60347){
this.meta60347 = meta60347;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner60346.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60348,meta60347__$1){
var self__ = this;
var _60348__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner60346(meta60347__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner60346.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60348){
var self__ = this;
var _60348__$1 = this;
return self__.meta60347;
}));

(athens.devcards.spinner.t_athens$devcards$spinner60346.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner60346.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38808__auto__,devcard_opts__38809__auto__){
var self__ = this;
var this__38808__auto____$1 = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner60346.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta60347","meta60347",-362957576,null)], null);
}));

(athens.devcards.spinner.t_athens$devcards$spinner60346.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner60346.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner60346");

(athens.devcards.spinner.t_athens$devcards$spinner60346.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner60346");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner60346.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner60346 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner60346(meta60347){
return (new athens.devcards.spinner.t_athens$devcards$spinner60346(meta60347));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner60346(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
