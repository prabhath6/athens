...
athens.devcards.spinner.spinner_component = (function athens$devcards$spinner$spinner_component(p__60835){
...
var message = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60836__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60836__$1,new cljs.core.Keyword(null,"style","style",-496642736));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner60841 !== 'undefined')){
} else {
...
*/
athens.devcards.spinner.t_athens$devcards$spinner60841 = (function (meta60842){
this.meta60842 = meta60842;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner60841.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60843,meta60842__$1){
var self__ = this;
var _60843__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner60841(meta60842__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner60841.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60843){
var self__ = this;
var _60843__$1 = this;
return self__.meta60842;
}));

(athens.devcards.spinner.t_athens$devcards$spinner60841.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner60841.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner60841.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta60842","meta60842",-330185468,null)], null);
}));

(athens.devcards.spinner.t_athens$devcards$spinner60841.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner60841.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner60841");

(athens.devcards.spinner.t_athens$devcards$spinner60841.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner60841");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner60841.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner60841 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner60841(meta60842){
return (new athens.devcards.spinner.t_athens$devcards$spinner60841(meta60842));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner60841(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner60847 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.spinner.t_athens$devcards$spinner60847 = (function (meta60848){
this.meta60848 = meta60848;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner60847.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60849,meta60848__$1){
var self__ = this;
var _60849__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner60847(meta60848__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner60847.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60849){
var self__ = this;
var _60849__$1 = this;
return self__.meta60848;
}));

(athens.devcards.spinner.t_athens$devcards$spinner60847.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner60847.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
var this__38815__auto____$1 = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner60847.getBasis = (function (){
...
(athens.devcards.spinner.t_athens$devcards$spinner60847.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner60847.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner60847");

(athens.devcards.spinner.t_athens$devcards$spinner60847.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner60847");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner60847.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner60847 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner60847(meta60848){
return (new athens.devcards.spinner.t_athens$devcards$spinner60847(meta60848));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner60847(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
