...
athens.devcards.spinner.spinner_component = (function athens$devcards$spinner$spinner_component(p__60867){
var map__60868 = p__60867;
...
var message = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60868__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60868__$1,new cljs.core.Keyword(null,"style","style",-496642736));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner60870 !== 'undefined')){
} else {
...
*/
athens.devcards.spinner.t_athens$devcards$spinner60870 = (function (meta60871){
this.meta60871 = meta60871;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner60870.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60872,meta60871__$1){
var self__ = this;
var _60872__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner60870(meta60871__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner60870.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60872){
var self__ = this;
var _60872__$1 = this;
return self__.meta60871;
}));

(athens.devcards.spinner.t_athens$devcards$spinner60870.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner60870.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner60870.getBasis = (function (){
...
(athens.devcards.spinner.t_athens$devcards$spinner60870.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner60870.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner60870");

(athens.devcards.spinner.t_athens$devcards$spinner60870.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner60870");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner60870.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner60870 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner60870(meta60871){
return (new athens.devcards.spinner.t_athens$devcards$spinner60870(meta60871));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner60870(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner60873 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.spinner.t_athens$devcards$spinner60873 = (function (meta60874){
this.meta60874 = meta60874;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner60873.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60875,meta60874__$1){
var self__ = this;
var _60875__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner60873(meta60874__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner60873.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60875){
var self__ = this;
var _60875__$1 = this;
return self__.meta60874;
}));

(athens.devcards.spinner.t_athens$devcards$spinner60873.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner60873.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
var this__38815__auto____$1 = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner60873.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta60874","meta60874",178041760,null)], null);
}));

(athens.devcards.spinner.t_athens$devcards$spinner60873.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner60873.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner60873");

(athens.devcards.spinner.t_athens$devcards$spinner60873.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner60873");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner60873.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner60873 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner60873(meta60874){
return (new athens.devcards.spinner.t_athens$devcards$spinner60873(meta60874));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner60873(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
