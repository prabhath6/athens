...
athens.devcards.spinner.spinner_component = (function athens$devcards$spinner$spinner_component(p__60924){
var map__60925 = p__60924;
...
var message = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60925__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60925__$1,new cljs.core.Keyword(null,"style","style",-496642736));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner60927 !== 'undefined')){
} else {
...
*/
athens.devcards.spinner.t_athens$devcards$spinner60927 = (function (meta60928){
this.meta60928 = meta60928;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner60927.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60929,meta60928__$1){
var self__ = this;
var _60929__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner60927(meta60928__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner60927.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60929){
var self__ = this;
var _60929__$1 = this;
return self__.meta60928;
}));

(athens.devcards.spinner.t_athens$devcards$spinner60927.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner60927.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner60927.getBasis = (function (){
...
(athens.devcards.spinner.t_athens$devcards$spinner60927.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner60927.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner60927");

(athens.devcards.spinner.t_athens$devcards$spinner60927.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner60927");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner60927.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner60927 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner60927(meta60928){
return (new athens.devcards.spinner.t_athens$devcards$spinner60927(meta60928));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner60927(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner60930 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.spinner.t_athens$devcards$spinner60930 = (function (meta60931){
this.meta60931 = meta60931;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner60930.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60932,meta60931__$1){
var self__ = this;
var _60932__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner60930(meta60931__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner60930.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60932){
var self__ = this;
var _60932__$1 = this;
return self__.meta60931;
}));

(athens.devcards.spinner.t_athens$devcards$spinner60930.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner60930.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner60930.getBasis = (function (){
...
(athens.devcards.spinner.t_athens$devcards$spinner60930.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner60930.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner60930");

(athens.devcards.spinner.t_athens$devcards$spinner60930.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner60930");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner60930.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner60930 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner60930(meta60931){
return (new athens.devcards.spinner.t_athens$devcards$spinner60930(meta60931));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner60930(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
