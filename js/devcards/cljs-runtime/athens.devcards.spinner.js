...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner60932 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.spinner.t_athens$devcards$spinner60932 = (function (meta60933){
this.meta60933 = meta60933;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner60932.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60934,meta60933__$1){
var self__ = this;
var _60934__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner60932(meta60933__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner60932.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60934){
var self__ = this;
var _60934__$1 = this;
return self__.meta60933;
}));

(athens.devcards.spinner.t_athens$devcards$spinner60932.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner60932.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
var this__38815__auto____$1 = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner60932.getBasis = (function (){
...
(athens.devcards.spinner.t_athens$devcards$spinner60932.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner60932.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner60932");

(athens.devcards.spinner.t_athens$devcards$spinner60932.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner60932");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner60932.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner60932 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner60932(meta60933){
return (new athens.devcards.spinner.t_athens$devcards$spinner60932(meta60933));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner60932(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
