...
athens.devcards.spinner.spinner_component = (function athens$devcards$spinner$spinner_component(p__60356){
...
var message = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60357__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60357__$1,new cljs.core.Keyword(null,"style","style",-496642736));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner60359 !== 'undefined')){
} else {
...
*/
athens.devcards.spinner.t_athens$devcards$spinner60359 = (function (meta60360){
this.meta60360 = meta60360;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner60359.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60361,meta60360__$1){
var self__ = this;
var _60361__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner60359(meta60360__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner60359.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60361){
var self__ = this;
var _60361__$1 = this;
return self__.meta60360;
}));

(athens.devcards.spinner.t_athens$devcards$spinner60359.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner60359.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38808__auto__,devcard_opts__38809__auto__){
var self__ = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner60359.getBasis = (function (){
...
(athens.devcards.spinner.t_athens$devcards$spinner60359.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner60359.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner60359");

(athens.devcards.spinner.t_athens$devcards$spinner60359.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner60359");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner60359.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner60359 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner60359(meta60360){
return (new athens.devcards.spinner.t_athens$devcards$spinner60359(meta60360));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner60359(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner60362 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.spinner.t_athens$devcards$spinner60362 = (function (meta60363){
this.meta60363 = meta60363;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner60362.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60364,meta60363__$1){
var self__ = this;
var _60364__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner60362(meta60363__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner60362.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60364){
var self__ = this;
var _60364__$1 = this;
return self__.meta60363;
}));

(athens.devcards.spinner.t_athens$devcards$spinner60362.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner60362.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38808__auto__,devcard_opts__38809__auto__){
var self__ = this;
var this__38808__auto____$1 = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner60362.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta60363","meta60363",1298937402,null)], null);
}));

(athens.devcards.spinner.t_athens$devcards$spinner60362.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner60362.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner60362");

(athens.devcards.spinner.t_athens$devcards$spinner60362.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner60362");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner60362.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner60362 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner60362(meta60363){
return (new athens.devcards.spinner.t_athens$devcards$spinner60362(meta60363));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner60362(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
