...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__77220_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__77220_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__77219_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__77219_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__77221_SHARP_){
return (((p1__77221_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__77221_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__77225,mapping){
var map__77226 = p__77225;
var map__77226__$1 = (((((!((map__77226 == null))))?(((((map__77226.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__77226.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__77226):map__77226);
var state = map__77226__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77226__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77226__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77226__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__77223_SHARP_){
if((p1__77223_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__77223_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__77277 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__77278 = clojure.zip.next(loc);
loc = G__77278;
continue;
}
}
...
var len__4789__auto___77283 = arguments.length;
var i__4790__auto___77284 = (0);
while(true){
if((i__4790__auto___77284 < len__4789__auto___77283)){
args__4795__auto__.push((arguments[i__4790__auto___77284]));

var G__77285 = (i__4790__auto___77284 + (1));
i__4790__auto___77284 = G__77285;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__77236){
var vec__77237 = p__77236;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77237,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq77233){
var G__77234 = cljs.core.first(seq77233);
var seq77233__$1 = cljs.core.next(seq77233);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__77234,seq77233__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__77240_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__77240_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__77243_77286 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__77244_77287 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__77245_77288 = true;
var _STAR_print_fn_STAR__temp_val__77246_77289 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__77245_77288);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__77246_77289);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__77244_77287);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__77243_77286);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__77241_SHARP_){
return debux.common.util.prepend_bars(p1__77241_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__77290 = cljs.core.next(opts__$1);
var G__77291 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__77290;
acc = G__77291;
continue;
} else {
if(typeof f === 'string'){
var G__77292 = cljs.core.next(opts__$1);
var G__77293 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__77292;
acc = G__77293;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__77294 = cljs.core.nnext(opts__$1);
var G__77295 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__77294;
acc = G__77295;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__77296 = cljs.core.next(opts__$1);
var G__77297 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__77296;
acc = G__77297;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__77249 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__77249.cljs$core$IFn$_invoke$arity$1 ? fexpr__77249.cljs$core$IFn$_invoke$arity$1(f) : fexpr__77249.call(null,f));
})())){
var G__77298 = cljs.core.next(opts__$1);
var G__77299 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__77298;
acc = G__77299;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__77250 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__77250.cljs$core$IFn$_invoke$arity$1 ? fexpr__77250.cljs$core$IFn$_invoke$arity$1(f) : fexpr__77250.call(null,f));
})())){
var G__77300 = cljs.core.nnext(opts__$1);
var G__77301 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__77300;
acc = G__77301;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__77302 = cljs.core.next(opts__$1);
var G__77303 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__77302;
acc = G__77303;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__77251){
var vec__77252 = p__77251;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77252,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77252,(1),null);
...
var G__77257 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__77256 = (function (){var fexpr__77258 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten);
return (fexpr__77258.cljs$core$IFn$_invoke$arity$1 ? fexpr__77258.cljs$core$IFn$_invoke$arity$1(form) : fexpr__77258.call(null,form));
})();
return (fexpr__77256.cljs$core$IFn$_invoke$arity$1 ? fexpr__77256.cljs$core$IFn$_invoke$arity$1(G__77257) : fexpr__77256.call(null,G__77257));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__77260 = quoted_form;
var G__77261 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__77260,G__77261) : debux.common.util.remove_d.call(null,G__77260,G__77261));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__77262 = quoted_form;
var G__77263 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__77262,G__77263) : debux.common.util.remove_d.call(null,G__77262,G__77263));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__77313__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__77264 = quoted_form;
var G__77265 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__77264,G__77265) : debux.common.util.remove_d.call(null,G__77264,G__77265));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
while (G__77325__i < G__77325__a.length) {G__77325__a[G__77325__i] = arguments[G__77325__i + 0]; ++G__77325__i;}
  arg = new cljs.core.IndexedSeq(G__77325__a,0,null);
} 
return G__77313__delegate.call(this,arg);};
G__77313.cljs$lang$maxFixedArity = 0;
G__77313.cljs$lang$applyTo = (function (arglist__77326){
var arg = cljs.core.seq(arglist__77326);
return G__77313__delegate(arg);
});
...
var G__77334 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__77334;
continue;
} else {
...
var G__77335 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__77335;
continue;
} else {
var G__77337 = clojure.zip.next(loc);
loc = G__77337;
continue;
