...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__46005_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__46005_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46004_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__46004_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__46006_SHARP_){
return (((p1__46006_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__46006_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__46009,mapping){
...
var state = map__46010__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46010__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46010__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46010__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__46007_SHARP_){
if((p1__46007_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__46007_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__46047 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__46048 = clojure.zip.next(loc);
loc = G__46048;
continue;
}
}
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__46015){
var vec__46016 = p__46015;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46016,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq46013){
var G__46014 = cljs.core.first(seq46013);
var seq46013__$1 = cljs.core.next(seq46013);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46014,seq46013__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__46019_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__46019_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__46021_46054 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__46022_46055 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__46023_46056 = true;
var _STAR_print_fn_STAR__temp_val__46024_46057 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__46023_46056);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__46024_46057);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__46022_46055);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__46021_46054);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__46020_SHARP_){
return debux.common.util.prepend_bars(p1__46020_SHARP_,indent_level);
...
var fexpr__46034 = (function (){var fexpr__46036 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten);
return (fexpr__46036.cljs$core$IFn$_invoke$arity$1 ? fexpr__46036.cljs$core$IFn$_invoke$arity$1(form) : fexpr__46036.call(null,form));
})();
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__46040 = quoted_form;
var G__46041 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__46040,G__46041) : debux.common.util.remove_d.call(null,G__46040,G__46041));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__46042 = quoted_form;
var G__46043 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__46042,G__46043) : debux.common.util.remove_d.call(null,G__46042,G__46043));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__46078__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__46044 = quoted_form;
var G__46045 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__46044,G__46045) : debux.common.util.remove_d.call(null,G__46044,G__46045));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));

return result;
};
var G__46078 = function (var_args){
var arg = null;
...
return G__46078__delegate.call(this,arg);};
G__46078.cljs$lang$maxFixedArity = 0;
G__46078.cljs$lang$applyTo = (function (arglist__46080){
var arg = cljs.core.seq(arglist__46080);
return G__46078__delegate(arg);
});
G__46078.cljs$core$IFn$_invoke$arity$variadic = G__46078__delegate;
return G__46078;
})()
;
});
...
var G__46081 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__46081;
continue;
} else {
...
var G__46083 = clojure.zip.next(loc);
loc = G__46083;
continue;
