...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__45742_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__45742_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__45741_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__45741_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__45743_SHARP_){
return (((p1__45743_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__45743_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__45751,mapping){
...
var state = map__45752__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45752__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45752__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45752__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__45746_SHARP_){
if((p1__45746_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__45746_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__45843 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__45844 = clojure.zip.next(loc);
loc = G__45844;
continue;
}
}
...
var len__4789__auto___45854 = arguments.length;
var i__4790__auto___45855 = (0);
while(true){
if((i__4790__auto___45855 < len__4789__auto___45854)){
args__4795__auto__.push((arguments[i__4790__auto___45855]));

var G__45856 = (i__4790__auto___45855 + (1));
i__4790__auto___45855 = G__45856;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__45763){
var vec__45764 = p__45763;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45764,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq45761){
var G__45762 = cljs.core.first(seq45761);
var seq45761__$1 = cljs.core.next(seq45761);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45762,seq45761__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__45768_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__45768_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__45770_45857 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__45771_45858 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__45772_45859 = true;
var _STAR_print_fn_STAR__temp_val__45773_45860 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__45772_45859);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__45773_45860);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__45771_45858);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__45770_45857);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__45769_SHARP_){
return debux.common.util.prepend_bars(p1__45769_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__45861 = cljs.core.next(opts__$1);
var G__45862 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__45861;
acc = G__45862;
continue;
} else {
if(typeof f === 'string'){
var G__45863 = cljs.core.next(opts__$1);
var G__45864 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__45863;
acc = G__45864;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__45865 = cljs.core.nnext(opts__$1);
var G__45866 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__45865;
acc = G__45866;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__45868 = cljs.core.next(opts__$1);
var G__45869 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__45868;
acc = G__45869;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__45782 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__45782.cljs$core$IFn$_invoke$arity$1 ? fexpr__45782.cljs$core$IFn$_invoke$arity$1(f) : fexpr__45782.call(null,f));
})())){
var G__45871 = cljs.core.next(opts__$1);
var G__45872 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__45871;
acc = G__45872;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__45787 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__45787.cljs$core$IFn$_invoke$arity$1 ? fexpr__45787.cljs$core$IFn$_invoke$arity$1(f) : fexpr__45787.call(null,f));
})())){
var G__45873 = cljs.core.nnext(opts__$1);
var G__45874 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__45873;
acc = G__45874;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__45875 = cljs.core.next(opts__$1);
var G__45876 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__45875;
acc = G__45876;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__45794){
var vec__45798 = p__45794;
...
var G__45810 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__45809 = (function (){var fexpr__45811 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten);
return (fexpr__45811.cljs$core$IFn$_invoke$arity$1 ? fexpr__45811.cljs$core$IFn$_invoke$arity$1(form) : fexpr__45811.call(null,form));
})();
return (fexpr__45809.cljs$core$IFn$_invoke$arity$1 ? fexpr__45809.cljs$core$IFn$_invoke$arity$1(G__45810) : fexpr__45809.call(null,G__45810));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__45817 = quoted_form;
var G__45818 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__45817,G__45818) : debux.common.util.remove_d.call(null,G__45817,G__45818));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__45820 = quoted_form;
var G__45821 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__45820,G__45821) : debux.common.util.remove_d.call(null,G__45820,G__45821));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__45881__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__45829 = quoted_form;
var G__45830 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__45829,G__45830) : debux.common.util.remove_d.call(null,G__45829,G__45830));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
while (G__45884__i < G__45884__a.length) {G__45884__a[G__45884__i] = arguments[G__45884__i + 0]; ++G__45884__i;}
  arg = new cljs.core.IndexedSeq(G__45884__a,0,null);
} 
return G__45881__delegate.call(this,arg);};
G__45881.cljs$lang$maxFixedArity = 0;
G__45881.cljs$lang$applyTo = (function (arglist__45885){
var arg = cljs.core.seq(arglist__45885);
return G__45881__delegate(arg);
});
...
var G__45890 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__45890;
continue;
} else {
...
var G__45891 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__45891;
continue;
} else {
var G__45893 = clojure.zip.next(loc);
loc = G__45893;
continue;
