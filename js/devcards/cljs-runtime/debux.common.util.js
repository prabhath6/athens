...
var G__46053 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__46054 = clojure.zip.next(loc);
loc = G__46054;
continue;
}
}
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__46017){
var vec__46018 = p__46017;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46018,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq46015){
var G__46016 = cljs.core.first(seq46015);
var seq46015__$1 = cljs.core.next(seq46015);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46016,seq46015__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__46021_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__46021_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__46023_46062 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__46024_46063 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__46025_46064 = true;
var _STAR_print_fn_STAR__temp_val__46026_46065 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__46025_46064);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__46026_46065);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__46024_46063);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__46023_46062);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__46022_SHARP_){
return debux.common.util.prepend_bars(p1__46022_SHARP_,indent_level);
...
var G__46073 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__46072;
acc = G__46073;
continue;
} else {
if(typeof f === 'string'){
var G__46074 = cljs.core.next(opts__$1);
var G__46075 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__46074;
acc = G__46075;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__46076 = cljs.core.nnext(opts__$1);
var G__46077 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__46076;
acc = G__46077;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__46081 = cljs.core.next(opts__$1);
var G__46082 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__46081;
acc = G__46082;
continue;
} else {
...
var G__46084 = cljs.core.next(opts__$1);
var G__46085 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__46084;
acc = G__46085;
continue;
} else {
...
var G__46087 = cljs.core.nnext(opts__$1);
var G__46088 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__46087;
acc = G__46088;
continue;
} else {
...
var G__46090 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__46089;
acc = G__46090;
continue;
} else {
...
return (function() { 
var G__46100__delegate = function (arg){
...
while (G__46101__i < G__46101__a.length) {G__46101__a[G__46101__i] = arguments[G__46101__i + 0]; ++G__46101__i;}
  arg = new cljs.core.IndexedSeq(G__46101__a,0,null);
} 
...
var G__46110 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__46110;
continue;
} else {
var G__46111 = clojure.zip.next(loc);
loc = G__46111;
continue;
