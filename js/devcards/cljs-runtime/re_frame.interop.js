...
return [(function (){var pred__45410 = cljs.core.instance_QMARK_;
var expr__45411 = reactive_val;
if(cljs.core.truth_((pred__45410.cljs$core$IFn$_invoke$arity$2 ? pred__45410.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__45411) : pred__45410.call(null,reagent.ratom.RAtom,expr__45411)))){
return "ra";
} else {
if(cljs.core.truth_((pred__45410.cljs$core$IFn$_invoke$arity$2 ? pred__45410.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__45411) : pred__45410.call(null,reagent.ratom.RCursor,expr__45411)))){
return "rc";
} else {
if(cljs.core.truth_((pred__45410.cljs$core$IFn$_invoke$arity$2 ? pred__45410.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__45411) : pred__45410.call(null,reagent.ratom.Reaction,expr__45411)))){
return "rx";
} else {
if(cljs.core.truth_((pred__45410.cljs$core$IFn$_invoke$arity$2 ? pred__45410.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__45411) : pred__45410.call(null,reagent.ratom.Track,expr__45411)))){
return "tr";
} else {
return "other";
}
