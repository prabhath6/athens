...
return [(function (){var pred__45419 = cljs.core.instance_QMARK_;
var expr__45420 = reactive_val;
if(cljs.core.truth_((pred__45419.cljs$core$IFn$_invoke$arity$2 ? pred__45419.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__45420) : pred__45419.call(null,reagent.ratom.RAtom,expr__45420)))){
return "ra";
} else {
if(cljs.core.truth_((pred__45419.cljs$core$IFn$_invoke$arity$2 ? pred__45419.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__45420) : pred__45419.call(null,reagent.ratom.RCursor,expr__45420)))){
return "rc";
} else {
if(cljs.core.truth_((pred__45419.cljs$core$IFn$_invoke$arity$2 ? pred__45419.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__45420) : pred__45419.call(null,reagent.ratom.Reaction,expr__45420)))){
return "rx";
} else {
if(cljs.core.truth_((pred__45419.cljs$core$IFn$_invoke$arity$2 ? pred__45419.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__45420) : pred__45419.call(null,reagent.ratom.Track,expr__45420)))){
return "tr";
} else {
return "other";
}
