...
return [(function (){var pred__42728 = cljs.core.instance_QMARK_;
var expr__42729 = reactive_val;
if(cljs.core.truth_((pred__42728.cljs$core$IFn$_invoke$arity$2 ? pred__42728.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__42729) : pred__42728.call(null,reagent.ratom.RAtom,expr__42729)))){
return "ra";
} else {
if(cljs.core.truth_((pred__42728.cljs$core$IFn$_invoke$arity$2 ? pred__42728.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__42729) : pred__42728.call(null,reagent.ratom.RCursor,expr__42729)))){
return "rc";
} else {
if(cljs.core.truth_((pred__42728.cljs$core$IFn$_invoke$arity$2 ? pred__42728.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__42729) : pred__42728.call(null,reagent.ratom.Reaction,expr__42729)))){
return "rx";
} else {
if(cljs.core.truth_((pred__42728.cljs$core$IFn$_invoke$arity$2 ? pred__42728.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__42729) : pred__42728.call(null,reagent.ratom.Track,expr__42729)))){
return "tr";
} else {
return "other";
}
