...
return [(function (){var pred__45422 = cljs.core.instance_QMARK_;
var expr__45423 = reactive_val;
if(cljs.core.truth_((pred__45422.cljs$core$IFn$_invoke$arity$2 ? pred__45422.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__45423) : pred__45422.call(null,reagent.ratom.RAtom,expr__45423)))){
return "ra";
} else {
if(cljs.core.truth_((pred__45422.cljs$core$IFn$_invoke$arity$2 ? pred__45422.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__45423) : pred__45422.call(null,reagent.ratom.RCursor,expr__45423)))){
return "rc";
} else {
if(cljs.core.truth_((pred__45422.cljs$core$IFn$_invoke$arity$2 ? pred__45422.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__45423) : pred__45422.call(null,reagent.ratom.Reaction,expr__45423)))){
return "rx";
} else {
if(cljs.core.truth_((pred__45422.cljs$core$IFn$_invoke$arity$2 ? pred__45422.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__45423) : pred__45422.call(null,reagent.ratom.Track,expr__45423)))){
return "tr";
} else {
return "other";
}
