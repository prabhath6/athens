...
return [(function (){var pred__45409 = cljs.core.instance_QMARK_;
var expr__45410 = reactive_val;
if(cljs.core.truth_((pred__45409.cljs$core$IFn$_invoke$arity$2 ? pred__45409.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__45410) : pred__45409.call(null,reagent.ratom.RAtom,expr__45410)))){
return "ra";
} else {
if(cljs.core.truth_((pred__45409.cljs$core$IFn$_invoke$arity$2 ? pred__45409.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__45410) : pred__45409.call(null,reagent.ratom.RCursor,expr__45410)))){
return "rc";
} else {
if(cljs.core.truth_((pred__45409.cljs$core$IFn$_invoke$arity$2 ? pred__45409.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__45410) : pred__45409.call(null,reagent.ratom.Reaction,expr__45410)))){
return "rx";
} else {
if(cljs.core.truth_((pred__45409.cljs$core$IFn$_invoke$arity$2 ? pred__45409.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__45410) : pred__45409.call(null,reagent.ratom.Track,expr__45410)))){
return "tr";
} else {
return "other";
}
