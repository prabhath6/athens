...
return [(function (){var pred__45413 = cljs.core.instance_QMARK_;
var expr__45414 = reactive_val;
if(cljs.core.truth_((pred__45413.cljs$core$IFn$_invoke$arity$2 ? pred__45413.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__45414) : pred__45413.call(null,reagent.ratom.RAtom,expr__45414)))){
return "ra";
} else {
if(cljs.core.truth_((pred__45413.cljs$core$IFn$_invoke$arity$2 ? pred__45413.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__45414) : pred__45413.call(null,reagent.ratom.RCursor,expr__45414)))){
return "rc";
} else {
if(cljs.core.truth_((pred__45413.cljs$core$IFn$_invoke$arity$2 ? pred__45413.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__45414) : pred__45413.call(null,reagent.ratom.Reaction,expr__45414)))){
return "rx";
} else {
if(cljs.core.truth_((pred__45413.cljs$core$IFn$_invoke$arity$2 ? pred__45413.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__45414) : pred__45413.call(null,reagent.ratom.Track,expr__45414)))){
return "tr";
} else {
return "other";
}
