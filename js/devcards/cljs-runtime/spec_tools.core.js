...
var G__48261 = cljs.spec.alpha.get_spec(x);
x = G__48261;
continue;
} else {
...
var G__48262 = cljs.spec.alpha.get_spec(new cljs.core.Keyword(null,"spec","spec",347520401).cljs$core$IFn$_invoke$arity$1(x));
x = G__48262;
continue;
} else {
...
if((x instanceof cljs.core.Keyword)){
var G__48305 = cljs.spec.alpha.get_spec(x);
x = G__48305;
continue;
} else {
