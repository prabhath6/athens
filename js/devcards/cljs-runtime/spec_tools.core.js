...
var G__48283 = cljs.spec.alpha.get_spec(x);
x = G__48283;
continue;
} else {
...
var G__48285 = cljs.spec.alpha.get_spec(new cljs.core.Keyword(null,"spec","spec",347520401).cljs$core$IFn$_invoke$arity$1(x));
x = G__48285;
continue;
} else {
...
if((x instanceof cljs.core.Keyword)){
var G__48325 = cljs.spec.alpha.get_spec(x);
x = G__48325;
continue;
} else {
