...
var G__48291 = cljs.spec.alpha.get_spec(x);
x = G__48291;
continue;
} else {
...
var G__48295 = cljs.spec.alpha.get_spec(new cljs.core.Keyword(null,"spec","spec",347520401).cljs$core$IFn$_invoke$arity$1(x));
x = G__48295;
continue;
} else {
...
if((x instanceof cljs.core.Keyword)){
var G__48332 = cljs.spec.alpha.get_spec(x);
x = G__48332;
continue;
} else {
