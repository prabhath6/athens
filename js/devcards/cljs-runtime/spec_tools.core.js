...
while(true){
if((i__4790__auto___48187 < len__4789__auto___48185)){
...
var G__48260 = cljs.spec.alpha.get_spec(x);
x = G__48260;
continue;
} else {
...
var G__48261 = cljs.spec.alpha.get_spec(new cljs.core.Keyword(null,"spec","spec",347520401).cljs$core$IFn$_invoke$arity$1(x));
x = G__48261;
continue;
} else {
...
if((x instanceof cljs.core.Keyword)){
var G__48302 = cljs.spec.alpha.get_spec(x);
x = G__48302;
continue;
} else {
