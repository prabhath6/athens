...
var G__48267 = cljs.spec.alpha.get_spec(x);
x = G__48267;
continue;
} else {
...
var G__48271 = cljs.spec.alpha.get_spec(new cljs.core.Keyword(null,"spec","spec",347520401).cljs$core$IFn$_invoke$arity$1(x));
x = G__48271;
continue;
} else {
...
if((x instanceof cljs.core.Keyword)){
var G__48311 = cljs.spec.alpha.get_spec(x);
x = G__48311;
continue;
} else {
