...
var G__48265 = cljs.spec.alpha.get_spec(new cljs.core.Keyword(null,"spec","spec",347520401).cljs$core$IFn$_invoke$arity$1(x));
x = G__48265;
continue;
} else {
...
if((x instanceof cljs.core.Keyword)){
var G__48306 = cljs.spec.alpha.get_spec(x);
x = G__48306;
continue;
} else {
