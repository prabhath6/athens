...
var G__20760 = cljs.core.PersistentArrayMap.EMPTY;
var G__20761 = native_stack_trace;
var G__20762 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__20763 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__20760,G__20761,G__20762,G__20763) : cljs.stacktrace.parse_stacktrace.call(null,G__20760,G__20761,G__20762,G__20763));
});
...
var map__20770 = top_item;
var map__20770__$1 = (((((!((map__20770 == null))))?(((((map__20770.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20770.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__20770):map__20770);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20770__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20770__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20770__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e20768){var _e = e20768;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___20813 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20813)){
var seen_errors_20814 = temp__5733__auto___20813;
if(cljs.core.truth_(seen_errors_20814.has(self))){
} else {
seen_errors_20814.add(self);

var temp__5735__auto___20815 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20815)){
var sense_20816 = temp__5735__auto___20815;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20816)].join(''));
} else {
}
}
} else {
