...
var G__20829 = cljs.core.PersistentArrayMap.EMPTY;
var G__20830 = native_stack_trace;
var G__20831 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__20832 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__20829,G__20830,G__20831,G__20832) : cljs.stacktrace.parse_stacktrace.call(null,G__20829,G__20830,G__20831,G__20832));
});
...
var map__20834 = top_item;
var map__20834__$1 = (((((!((map__20834 == null))))?(((((map__20834.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20834.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__20834):map__20834);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20834__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20834__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20834__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e20833){var _e = e20833;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___20846 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20846)){
var seen_errors_20847 = temp__5733__auto___20846;
if(cljs.core.truth_(seen_errors_20847.has(self))){
} else {
seen_errors_20847.add(self);

var temp__5735__auto___20848 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20848)){
var sense_20849 = temp__5735__auto___20848;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20849)].join(''));
} else {
}
}
} else {
