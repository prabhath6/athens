...
var temp__5733__auto___20835 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20835)){
var seen_errors_20836 = temp__5733__auto___20835;
if(cljs.core.truth_(seen_errors_20836.has(self))){
} else {
seen_errors_20836.add(self);

var temp__5735__auto___20837 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20837)){
var sense_20838 = temp__5735__auto___20837;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20838)].join(''));
} else {
}
}
} else {
