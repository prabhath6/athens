...
var G__20828 = cljs.core.PersistentArrayMap.EMPTY;
var G__20829 = native_stack_trace;
var G__20830 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__20831 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__20828,G__20829,G__20830,G__20831) : cljs.stacktrace.parse_stacktrace.call(null,G__20828,G__20829,G__20830,G__20831));
});
...
var temp__5733__auto___20843 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20843)){
var seen_errors_20844 = temp__5733__auto___20843;
if(cljs.core.truth_(seen_errors_20844.has(self))){
} else {
seen_errors_20844.add(self);

var temp__5735__auto___20845 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20845)){
var sense_20846 = temp__5735__auto___20845;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20846)].join(''));
} else {
}
}
} else {
