...
var G__21338 = cljs.core.PersistentArrayMap.EMPTY;
var G__21339 = native_stack_trace;
var G__21340 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__21341 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__21338,G__21339,G__21340,G__21341) : cljs.stacktrace.parse_stacktrace.call(null,G__21338,G__21339,G__21340,G__21341));
});
...
var map__21348 = top_item;
var map__21348__$1 = (((((!((map__21348 == null))))?(((((map__21348.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21348.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__21348):map__21348);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21348__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21348__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21348__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e21345){var _e = e21345;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___21433 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___21433)){
var seen_errors_21435 = temp__5733__auto___21433;
if(cljs.core.truth_(seen_errors_21435.has(self))){
} else {
seen_errors_21435.add(self);

var temp__5735__auto___21436 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___21436)){
var sense_21437 = temp__5735__auto___21436;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_21437)].join(''));
} else {
}
}
} else {
