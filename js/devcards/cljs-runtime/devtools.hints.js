...
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20929__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20929__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e20927){var _e = e20927;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___20960 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20960)){
var seen_errors_20961 = temp__5733__auto___20960;
if(cljs.core.truth_(seen_errors_20961.has(self))){
} else {
seen_errors_20961.add(self);

var temp__5735__auto___20962 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20962)){
var sense_20963 = temp__5735__auto___20962;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20963)].join(''));
} else {
}
}
} else {
