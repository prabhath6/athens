...
var G__20619 = cljs.core.PersistentArrayMap.EMPTY;
var G__20620 = native_stack_trace;
var G__20621 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__20622 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__20619,G__20620,G__20621,G__20622) : cljs.stacktrace.parse_stacktrace.call(null,G__20619,G__20620,G__20621,G__20622));
});
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20627__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20627__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20627__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e20626){var _e = e20626;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___20639 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20639)){
var seen_errors_20640 = temp__5733__auto___20639;
if(cljs.core.truth_(seen_errors_20640.has(self))){
} else {
seen_errors_20640.add(self);

var temp__5735__auto___20641 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20641)){
var sense_20642 = temp__5735__auto___20641;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20642)].join(''));
} else {
}
}
} else {
