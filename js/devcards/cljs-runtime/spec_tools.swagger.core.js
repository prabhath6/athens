...
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48532__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48532__$1,new cljs.core.Keyword(null,"in","in",-1531184865));
...
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48534,(1),null);
...
var method_cache__4674__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4675__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__48539 = cljs.core.get_global_hierarchy;
return (fexpr__48539.cljs$core$IFn$_invoke$arity$0 ? fexpr__48539.cljs$core$IFn$_invoke$arity$0() : fexpr__48539.call(null));
})());
...
var map__48540 = spec_tools.swagger.core.transform.cljs$core$IFn$_invoke$arity$2(spec,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),in$,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"parameter","parameter",1978789597)], null));
...
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48540__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48540__$1,new cljs.core.Keyword(null,"required","required",1807647006));
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__48542){
var vec__48543 = p__48542;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48543,(0),null);
var map__48546 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48543,(1),null);
...
var schema = map__48546__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48546__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
var method_cache__4674__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4675__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__48548 = cljs.core.get_global_hierarchy;
return (fexpr__48548.cljs$core$IFn$_invoke$arity$0 ? fexpr__48548.cljs$core$IFn$_invoke$arity$0() : fexpr__48548.call(null));
})());
...
})(),(function (){var iter__4582__auto__ = (function spec_tools$swagger$core$iter__48549(s__48550){
return (new cljs.core.LazySeq(null,(function (){
var s__48550__$1 = s__48550;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__48550__$1);
if(temp__5735__auto__){
var s__48550__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__48550__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__48550__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__48552 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__48551 = (0);
while(true){
if((i__48551 < size__4581__auto__)){
var vec__48553 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__48551);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48553,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48553,(1),null);
cljs.core.chunk_append(b__48552,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [status,(function (){var $ = response;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__48552),spec_tools$swagger$core$iter__48549(cljs.core.chunk_rest(s__48550__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__48552),null);
}
} else {
var vec__48556 = cljs.core.first(s__48550__$2);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48556,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48556,(1),null);
...
var $__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1($))?cljs.core.update.cljs$core$IFn$_invoke$arity$4($,new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.swagger.core.transform,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"schema","schema",-1582001791)], null)):$);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3($__$1,new cljs.core.Keyword(null,"description","description",-1428560544),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,""));
})()], null),spec_tools$swagger$core$iter__48549(cljs.core.rest(s__48550__$2)));
}
} else {
return null;
}
...
var new$ = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__48559){
var vec__48560 = p__48559;
var in$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48560,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48560,(1),null);
...
var merged = cljs.core.vec(cljs.core.reverse(cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__48563,p){
var vec__48564 = p__48563;
var ps = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48564,(0),null);
var cache = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48564,(1),null);
var acc__$1 = vec__48564;
