...
athens.devcards.sci_boxes.add_child = (function athens$devcards$sci_boxes$add_child(p__60835,idx,id){
...
var box = map__60836__$1;
var children_ids = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60836__$1,new cljs.core.Keyword(null,"children-ids","children-ids",-293558198));
var new_idx = (idx + (1));
...
athens.devcards.sci_boxes.add_sibling = (function athens$devcards$sci_boxes$add_sibling(p__60838,id){
...
var state = map__60839__$1;
var next_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60839__$1,new cljs.core.Keyword(null,"next-id","next-id",-224240762));
var boxes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60839__$1,new cljs.core.Keyword(null,"boxes","boxes",-420813822));
...
athens.devcards.sci_boxes.delete_box = (function athens$devcards$sci_boxes$delete_box(p__60841,id){
...
var state = map__60842__$1;
var boxes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60842__$1,new cljs.core.Keyword(null,"boxes","boxes",-420813822));
var parent_id = athens.devcards.sci_boxes.get_parent_id(boxes,id);
...
var map__60844 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(athens.devcards.sci_boxes.box_state_STAR_),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"boxes","boxes",-420813822),id], null));
...
var str_content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60844__$1,new cljs.core.Keyword(null,"str-content","str-content",297549190));
...
var G__60846 = k;
var G__60846__$1 = (((G__60846 instanceof cljs.core.Keyword))?G__60846.fqn:null);
switch (G__60846__$1) {
case "return":
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(athens.devcards.sci_boxes.box_state_STAR_,(function (p1__60847_SHARP_){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$5(p1__60847_SHARP_,new cljs.core.Keyword(null,"boxes","boxes",-420813822),athens.devcards.sci_boxes.update_box_content,id,value),new cljs.core.Keyword(null,"boxes","boxes",-420813822),athens.devcards.sci_boxes.eval_all_boxes);
}));
});
athens.devcards.sci_boxes.sci_result_component = (function athens$devcards$sci_boxes$sci_result_component(result){
if(cljs.core.truth_(result)){
var map__60848 = result;
...
var hiccup = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60848__$1,new cljs.core.Keyword(null,"hiccup","hiccup",1218876238));
...
var vec__60850 = cljs.core.deref(err_STAR_);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60850,(0),null);
var info = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60850,(1),null);
...
var map__60855 = cljs.core.deref(athens.devcards.sci_boxes.box_state_STAR_);
...
var boxes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60855__$1,new cljs.core.Keyword(null,"boxes","boxes",-420813822));
var map__60856 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(boxes,id);
...
var children_ids = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60856__$1,new cljs.core.Keyword(null,"children-ids","children-ids",-293558198));
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"display","display",242065432),"flex"], null)], null),id,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"textarea","textarea",-650375824),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"font-size","font-size",-1847940346),"1rem",new cljs.core.Keyword(null,"width","width",-384071477),"30rem"], null),new cljs.core.Keyword(null,"value","value",305978217),str_content,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__60853_SHARP_){
return athens.devcards.sci_boxes.handle_box_change_BANG_(p1__60853_SHARP_,id);
}),new cljs.core.Keyword(null,"on-key-down","on-key-down",-1374733765),(function (p1__60854_SHARP_){
return athens.devcards.sci_boxes.handle_box_key_down_BANG_(p1__60854_SHARP_,id);
})], null)], null),((athens.devcards.sci_boxes.sci_node_QMARK_(box))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.sci_boxes.sci_result_wrapper,result], null):null)], null),((cljs.core.seq(children_ids))?cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin-left","margin-left",2015598377),"1rem"], null)], null)], null),(function (){var iter__4582__auto__ = (function athens$devcards$sci_boxes$box_component_$_iter__60859(s__60860){
return (new cljs.core.LazySeq(null,(function (){
var s__60860__$1 = s__60860;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__60860__$1);
if(temp__5735__auto__){
var s__60860__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__60860__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__60860__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__60862 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__60861 = (0);
while(true){
if((i__60861 < size__4581__auto__)){
var id__$1 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__60861);
cljs.core.chunk_append(b__60862,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.sci_boxes.box_component,id__$1], null));

var G__60880 = (i__60861 + (1));
i__60861 = G__60880;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60862),athens$devcards$sci_boxes$box_component_$_iter__60859(cljs.core.chunk_rest(s__60860__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60862),null);
}
} else {
var id__$1 = cljs.core.first(s__60860__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.sci_boxes.box_component,id__$1], null),athens$devcards$sci_boxes$box_component_$_iter__60859(cljs.core.rest(s__60860__$2)));
}
} else {
return null;
}
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.sci_boxes !== 'undefined') && (typeof athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60863 !== 'undefined')){
} else {
...
*/
athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60863 = (function (meta60864){
this.meta60864 = meta60864;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60863.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60865,meta60864__$1){
var self__ = this;
var _60865__$1 = this;
return (new athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60863(meta60864__$1));
}));

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60863.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60865){
var self__ = this;
var _60865__$1 = this;
return self__.meta60864;
}));

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60863.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60863.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
...
(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60863.getBasis = (function (){
...
(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60863.cljs$lang$type = true);

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60863.cljs$lang$ctorStr = "athens.devcards.sci-boxes/t_athens$devcards$sci_boxes60863");

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60863.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.sci-boxes/t_athens$devcards$sci_boxes60863");
}));

/**
 * Positional factory function for athens.devcards.sci-boxes/t_athens$devcards$sci_boxes60863.
 */
athens.devcards.sci_boxes.__GT_t_athens$devcards$sci_boxes60863 = (function athens$devcards$sci_boxes$__GT_t_athens$devcards$sci_boxes60863(meta60864){
return (new athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60863(meta60864));
});

}

return (new athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60863(null));
})()
