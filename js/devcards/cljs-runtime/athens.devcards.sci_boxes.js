...
return devcards.core.card_base(new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"name","name",1843675177),"sci-examples",new cljs.core.Keyword(null,"documentation","documentation",1889593999),null,new cljs.core.Keyword(null,"main-obj","main-obj",-1544409742),(function (){var iter__4582__auto__ = (function athens$devcards$sci_boxes$iter__60871(s__60872){
...
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60875,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60875,(1),null);
cljs.core.chunk_append(b__60874,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),s,new cljs.core.Keyword(null,"result","result",1415092211),sci.core.eval_string.cljs$core$IFn$_invoke$arity$2(s,opts)], null),(cljs.core.truth_(opts)?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"opts","opts",155075701),opts], null):null)], 0)));

var G__60925 = (i__60873 + (1));
i__60873 = G__60925;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60874),athens$devcards$sci_boxes$iter__60871(cljs.core.chunk_rest(s__60872__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60874),null);
}
} else {
var vec__60878 = cljs.core.first(s__60872__$2);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60878,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60878,(1),null);
return cljs.core.cons(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),s,new cljs.core.Keyword(null,"result","result",1415092211),sci.core.eval_string.cljs$core$IFn$_invoke$arity$2(s,opts)], null),(cljs.core.truth_(opts)?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"opts","opts",155075701),opts], null):null)], 0)),athens$devcards$sci_boxes$iter__60871(cljs.core.rest(s__60872__$2)));
}
} else {
return null;
}
...
return cljs.core.some((function (p__60881){
var vec__60882 = p__60881;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60882,(0),null);
var box = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60882,(1),null);
...
athens.devcards.sci_boxes.sci_node_QMARK_ = (function athens$devcards$sci_boxes$sci_node_QMARK_(p__60885){
...
var str_content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60886__$1,new cljs.core.Keyword(null,"str-content","str-content",297549190));
return clojure.string.starts_with_QMARK_(str_content,":sci");
});
athens.devcards.sci_boxes.eval_box = (function athens$devcards$sci_boxes$eval_box(p__60888,parent){
...
var box = map__60889__$1;
var str_content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60889__$1,new cljs.core.Keyword(null,"str-content","str-content",297549190));
...
}catch (e60891){if((e60891 instanceof Error)){
var e = e60891;
...
var temp__5733__auto____$1 = cljs.core.some((function (p1__60892_SHARP_){
if(cljs.core.not((visited.cljs$core$IFn$_invoke$arity$1 ? visited.cljs$core$IFn$_invoke$arity$1(p1__60892_SHARP_) : visited.call(null,p1__60892_SHARP_)))){
return p1__60892_SHARP_;
} else {
return null;
}
}),children);
...
var temp__5733__auto____$1 = cljs.core.some((function (p1__60893_SHARP_){
if(cljs.core.not((visited.cljs$core$IFn$_invoke$arity$1 ? visited.cljs$core$IFn$_invoke$arity$1(p1__60893_SHARP_) : visited.call(null,p1__60893_SHARP_)))){
return p1__60893_SHARP_;
} else {
return null;
}
}),siblings);
...
var G__60926 = boxes_SINGLEQUOTE_;
var G__60927 = visited_SINGLEQUOTE_;
var G__60928 = id_SINGLEQUOTE_;
boxes__$1 = G__60926;
visited = G__60927;
id = G__60928;
continue;
...
athens.devcards.sci_boxes.add_child = (function athens$devcards$sci_boxes$add_child(p__60894,idx,id){
...
var box = map__60895__$1;
var children_ids = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60895__$1,new cljs.core.Keyword(null,"children-ids","children-ids",-293558198));
var new_idx = (idx + (1));
...
athens.devcards.sci_boxes.add_sibling = (function athens$devcards$sci_boxes$add_sibling(p__60897,id){
...
var state = map__60898__$1;
var next_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60898__$1,new cljs.core.Keyword(null,"next-id","next-id",-224240762));
var boxes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60898__$1,new cljs.core.Keyword(null,"boxes","boxes",-420813822));
...
athens.devcards.sci_boxes.delete_box = (function athens$devcards$sci_boxes$delete_box(p__60900,id){
...
var state = map__60901__$1;
var boxes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60901__$1,new cljs.core.Keyword(null,"boxes","boxes",-420813822));
var parent_id = athens.devcards.sci_boxes.get_parent_id(boxes,id);
...
var map__60903 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(athens.devcards.sci_boxes.box_state_STAR_),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"boxes","boxes",-420813822),id], null));
...
var str_content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60903__$1,new cljs.core.Keyword(null,"str-content","str-content",297549190));
...
var G__60905 = k;
var G__60905__$1 = (((G__60905 instanceof cljs.core.Keyword))?G__60905.fqn:null);
switch (G__60905__$1) {
case "return":
...
var hiccup = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60907__$1,new cljs.core.Keyword(null,"hiccup","hiccup",1218876238));
...
var vec__60909 = cljs.core.deref(err_STAR_);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60909,(0),null);
var info = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60909,(1),null);
...
var map__60914 = cljs.core.deref(athens.devcards.sci_boxes.box_state_STAR_);
...
var boxes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60914__$1,new cljs.core.Keyword(null,"boxes","boxes",-420813822));
var map__60915 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(boxes,id);
...
var box = map__60915__$1;
var str_content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60915__$1,new cljs.core.Keyword(null,"str-content","str-content",297549190));
var children_ids = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60915__$1,new cljs.core.Keyword(null,"children-ids","children-ids",-293558198));
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60915__$1,new cljs.core.Keyword(null,"result","result",1415092211));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"display","display",242065432),"flex"], null)], null),id,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"textarea","textarea",-650375824),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"font-size","font-size",-1847940346),"1rem",new cljs.core.Keyword(null,"width","width",-384071477),"30rem"], null),new cljs.core.Keyword(null,"value","value",305978217),str_content,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__60912_SHARP_){
return athens.devcards.sci_boxes.handle_box_change_BANG_(p1__60912_SHARP_,id);
}),new cljs.core.Keyword(null,"on-key-down","on-key-down",-1374733765),(function (p1__60913_SHARP_){
return athens.devcards.sci_boxes.handle_box_key_down_BANG_(p1__60913_SHARP_,id);
})], null)], null),((athens.devcards.sci_boxes.sci_node_QMARK_(box))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.sci_boxes.sci_result_wrapper,result], null):null)], null),((cljs.core.seq(children_ids))?cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin-left","margin-left",2015598377),"1rem"], null)], null)], null),(function (){var iter__4582__auto__ = (function athens$devcards$sci_boxes$box_component_$_iter__60918(s__60919){
return (new cljs.core.LazySeq(null,(function (){
...
var id__$1 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__60920);
cljs.core.chunk_append(b__60921,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.sci_boxes.box_component,id__$1], null));

var G__60930 = (i__60920 + (1));
i__60920 = G__60930;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60921),athens$devcards$sci_boxes$box_component_$_iter__60918(cljs.core.chunk_rest(s__60919__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60921),null);
}
} else {
var id__$1 = cljs.core.first(s__60919__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.sci_boxes.box_component,id__$1], null),athens$devcards$sci_boxes$box_component_$_iter__60918(cljs.core.rest(s__60919__$2)));
}
} else {
return null;
}
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.sci_boxes !== 'undefined') && (typeof athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60922 !== 'undefined')){
} else {
...
*/
athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60922 = (function (meta60923){
this.meta60923 = meta60923;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60922.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60924,meta60923__$1){
var self__ = this;
var _60924__$1 = this;
return (new athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60922(meta60923__$1));
}));

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60922.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60924){
var self__ = this;
var _60924__$1 = this;
return self__.meta60923;
}));

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60922.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60922.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
...
(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60922.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta60923","meta60923",-1054078522,null)], null);
}));

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60922.cljs$lang$type = true);

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60922.cljs$lang$ctorStr = "athens.devcards.sci-boxes/t_athens$devcards$sci_boxes60922");

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60922.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.sci-boxes/t_athens$devcards$sci_boxes60922");
}));

/**
 * Positional factory function for athens.devcards.sci-boxes/t_athens$devcards$sci_boxes60922.
 */
athens.devcards.sci_boxes.__GT_t_athens$devcards$sci_boxes60922 = (function athens$devcards$sci_boxes$__GT_t_athens$devcards$sci_boxes60922(meta60923){
return (new athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60922(meta60923));
});

}

return (new athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60922(null));
})()
