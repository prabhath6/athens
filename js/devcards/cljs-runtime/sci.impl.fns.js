...
var G__58197 = cljs.core.next(args__$1);
var G__58198 = cljs.core.next(params__$1);
var G__58199 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__58197;
params__$1 = G__58198;
ret = G__58199;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__58169 = ctx__$1;
var G__58170 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__58169,G__58170) : interpret.call(null,G__58169,G__58170));
...
var vec__58172 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58172,(0),null);
var vec__58175 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58172,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58175,(0),null);
...
var map__58178 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58178__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58178__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__58182){
...
var f = map__58183__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58183__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58183__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var G__58209__delegate = function (args){
...
while (G__58210__i < G__58210__a.length) {G__58210__a[G__58210__i] = arguments[G__58210__i + 0]; ++G__58210__i;}
  args = new cljs.core.IndexedSeq(G__58210__a,0,null);
} 
return G__58209__delegate.call(this,args);};
G__58209.cljs$lang$maxFixedArity = 0;
G__58209.cljs$lang$applyTo = (function (arglist__58211){
var args = cljs.core.seq(arglist__58211);
return G__58209__delegate(args);
});
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58180_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__58180_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
...
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__58181_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58181_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
