...
var G__58213 = cljs.core.next(args__$1);
var G__58214 = cljs.core.next(params__$1);
var G__58215 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__58213;
params__$1 = G__58214;
ret = G__58215;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__58186 = ctx__$1;
var G__58187 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__58186,G__58187) : interpret.call(null,G__58186,G__58187));
...
var G__58222 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__58222;
continue;
} else {
var G__58223 = recur_val;
args = G__58223;
continue;
}
} else {
...
while (G__58224__i < G__58224__a.length) {G__58224__a[G__58224__i] = arguments[G__58224__i + 0]; ++G__58224__i;}
  args = new cljs.core.IndexedSeq(G__58224__a,0,null);
} 
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__58225){
var args = cljs.core.seq(arglist__58225);
...
var map__58196 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58196__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58196__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__58202){
var map__58208 = p__58202;
...
var f = map__58208__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58208__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58208__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
while (G__58238__i < G__58238__a.length) {G__58238__a[G__58238__i] = arguments[G__58238__i + 0]; ++G__58238__i;}
  args = new cljs.core.IndexedSeq(G__58238__a,0,null);
} 
...
var args = cljs.core.seq(arglist__58239);
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58198_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__58198_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__58240__delegate = function (args){
...
while (G__58245__i < G__58245__a.length) {G__58245__a[G__58245__i] = arguments[G__58245__i + 0]; ++G__58245__i;}
  args = new cljs.core.IndexedSeq(G__58245__a,0,null);
} 
return G__58240__delegate.call(this,args);};
G__58240.cljs$lang$maxFixedArity = 0;
G__58240.cljs$lang$applyTo = (function (arglist__58246){
var args = cljs.core.seq(arglist__58246);
return G__58240__delegate(args);
});
