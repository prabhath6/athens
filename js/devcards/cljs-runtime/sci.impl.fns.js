...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__58180,fn_name,macro_QMARK_,with_meta_QMARK_){
...
var _m = map__58181__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58181__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58181__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58181__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58181__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__58211 = cljs.core.next(args__$1);
var G__58212 = cljs.core.next(params__$1);
var G__58213 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__58211;
params__$1 = G__58212;
ret = G__58213;
continue;
...
var vec__58187 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58187,(0),null);
var vec__58190 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58187,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58190,(0),null);
var G__58215 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__58215;
continue;
} else {
var G__58216 = recur_val;
args = G__58216;
continue;
}
} else {
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__58218){
var args = cljs.core.seq(arglist__58218);
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__58198){
...
var f = map__58199__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58199__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58199__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
return G__58226__delegate.call(this,args);};
G__58226.cljs$lang$maxFixedArity = 0;
G__58226.cljs$lang$applyTo = (function (arglist__58228){
var args = cljs.core.seq(arglist__58228);
return G__58226__delegate(args);
});
G__58226.cljs$core$IFn$_invoke$arity$variadic = G__58226__delegate;
return G__58226;
})()
;
...
G__58232.cljs$lang$applyTo = (function (arglist__58242){
...
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__58197_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58197_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
