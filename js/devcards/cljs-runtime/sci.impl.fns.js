...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__58276,fn_name,macro_QMARK_,with_meta_QMARK_){
var map__58279 = p__58276;
...
var G__58319 = cljs.core.next(args__$1);
var G__58320 = cljs.core.next(params__$1);
var G__58321 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__58319;
params__$1 = G__58320;
ret = G__58321;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__58284 = ctx__$1;
var G__58285 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__58284,G__58285) : interpret.call(null,G__58284,G__58285));
...
var vec__58287 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58287,(0),null);
var vec__58290 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58287,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58290,(0),null);
var G__58325 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__58325;
continue;
} else {
var G__58326 = recur_val;
args = G__58326;
continue;
}
} else {
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__58328){
...
var map__58295 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58295__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58295__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
while (G__58333__i < G__58333__a.length) {G__58333__a[G__58333__i] = arguments[G__58333__i + 0]; ++G__58333__i;}
  args = new cljs.core.IndexedSeq(G__58333__a,0,null);
} 
return G__58331__delegate.call(this,args);};
G__58331.cljs$lang$maxFixedArity = 0;
G__58331.cljs$lang$applyTo = (function (arglist__58334){
var args = cljs.core.seq(arglist__58334);
return G__58331__delegate(args);
});
G__58331.cljs$core$IFn$_invoke$arity$variadic = G__58331__delegate;
return G__58331;
})()
;
...
while (G__58336__i < G__58336__a.length) {G__58336__a[G__58336__i] = arguments[G__58336__i + 0]; ++G__58336__i;}
  args = new cljs.core.IndexedSeq(G__58336__a,0,null);
} 
...
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__58301_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58301_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
