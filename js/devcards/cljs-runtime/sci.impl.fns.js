...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__58267,fn_name,macro_QMARK_,with_meta_QMARK_){
...
var _m = map__58268__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58268__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58268__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58268__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58268__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__58305 = cljs.core.next(args__$1);
var G__58306 = cljs.core.next(params__$1);
var G__58307 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__58305;
params__$1 = G__58306;
ret = G__58307;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__58272 = ctx__$1;
var G__58273 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__58272,G__58273) : interpret.call(null,G__58272,G__58273));
...
var vec__58274 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58274,(0),null);
var vec__58277 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58274,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58277,(0),null);
var G__58308 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__58308;
continue;
} else {
var G__58309 = recur_val;
args = G__58309;
continue;
}
} else {
...
while (G__58310__i < G__58310__a.length) {G__58310__a[G__58310__i] = arguments[G__58310__i + 0]; ++G__58310__i;}
  args = new cljs.core.IndexedSeq(G__58310__a,0,null);
} 
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__58311){
var args = cljs.core.seq(arglist__58311);
...
var map__58282 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58282__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58282__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__58296){
var map__58297 = p__58296;
...
var f = map__58297__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58297__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58297__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var G__58321__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(self_ref),args);
};
var G__58321 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__58322__i = 0, G__58322__a = new Array(arguments.length -  0);
while (G__58322__i < G__58322__a.length) {G__58322__a[G__58322__i] = arguments[G__58322__i + 0]; ++G__58322__i;}
  args = new cljs.core.IndexedSeq(G__58322__a,0,null);
} 
return G__58321__delegate.call(this,args);};
G__58321.cljs$lang$maxFixedArity = 0;
G__58321.cljs$lang$applyTo = (function (arglist__58323){
var args = cljs.core.seq(arglist__58323);
return G__58321__delegate(args);
});
G__58321.cljs$core$IFn$_invoke$arity$variadic = G__58321__delegate;
return G__58321;
})()
;
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58291_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__58291_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__58325__delegate = function (args){
...
var G__58325 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__58326__i = 0, G__58326__a = new Array(arguments.length -  0);
while (G__58326__i < G__58326__a.length) {G__58326__a[G__58326__i] = arguments[G__58326__i + 0]; ++G__58326__i;}
  args = new cljs.core.IndexedSeq(G__58326__a,0,null);
} 
return G__58325__delegate.call(this,args);};
G__58325.cljs$lang$maxFixedArity = 0;
G__58325.cljs$lang$applyTo = (function (arglist__58327){
var args = cljs.core.seq(arglist__58327);
return G__58325__delegate(args);
});
G__58325.cljs$core$IFn$_invoke$arity$variadic = G__58325__delegate;
return G__58325;
})()
;
})());
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__58292_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58292_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
