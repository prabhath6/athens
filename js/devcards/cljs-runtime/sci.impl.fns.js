...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__58161,fn_name,macro_QMARK_,with_meta_QMARK_){
var map__58163 = p__58161;
...
var _m = map__58163__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58163__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58163__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58163__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58163__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__58200 = cljs.core.next(args__$1);
var G__58201 = cljs.core.next(params__$1);
var G__58202 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__58200;
params__$1 = G__58201;
ret = G__58202;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__58166 = ctx__$1;
var G__58167 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__58166,G__58167) : interpret.call(null,G__58166,G__58167));
...
var vec__58169 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58169,(0),null);
var vec__58172 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58169,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58172,(0),null);
var G__58204 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__58204;
continue;
} else {
var G__58205 = recur_val;
args = G__58205;
continue;
}
} else {
...
while (G__58206__i < G__58206__a.length) {G__58206__a[G__58206__i] = arguments[G__58206__i + 0]; ++G__58206__i;}
  args = new cljs.core.IndexedSeq(G__58206__a,0,null);
} 
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__58207){
...
var map__58176 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58176__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58176__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__58183){
var map__58187 = p__58183;
...
var f = map__58187__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58187__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58187__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var G__58210__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(self_ref),args);
};
var G__58210 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__58211__i = 0, G__58211__a = new Array(arguments.length -  0);
while (G__58211__i < G__58211__a.length) {G__58211__a[G__58211__i] = arguments[G__58211__i + 0]; ++G__58211__i;}
  args = new cljs.core.IndexedSeq(G__58211__a,0,null);
} 
return G__58210__delegate.call(this,args);};
G__58210.cljs$lang$maxFixedArity = 0;
G__58210.cljs$lang$applyTo = (function (arglist__58212){
var args = cljs.core.seq(arglist__58212);
return G__58210__delegate(args);
});
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58179_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__58179_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__58215__delegate = function (args){
...
var args = null;
if (arguments.length > 0) {
var G__58221__i = 0, G__58221__a = new Array(arguments.length -  0);
while (G__58221__i < G__58221__a.length) {G__58221__a[G__58221__i] = arguments[G__58221__i + 0]; ++G__58221__i;}
  args = new cljs.core.IndexedSeq(G__58221__a,0,null);
} 
return G__58215__delegate.call(this,args);};
G__58215.cljs$lang$maxFixedArity = 0;
G__58215.cljs$lang$applyTo = (function (arglist__58222){
var args = cljs.core.seq(arglist__58222);
return G__58215__delegate(args);
});
...
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__58182_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58182_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
