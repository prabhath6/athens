...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__58163,fn_name,macro_QMARK_,with_meta_QMARK_){
...
var _m = map__58164__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58164__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58164__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58164__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58164__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__58201 = cljs.core.next(args__$1);
var G__58202 = cljs.core.next(params__$1);
var G__58203 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__58201;
params__$1 = G__58202;
ret = G__58203;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__58168 = ctx__$1;
var G__58169 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__58168,G__58169) : interpret.call(null,G__58168,G__58169));
...
var vec__58170 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58170,(0),null);
var vec__58173 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58170,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58173,(0),null);
...
var map__58177 = cljs.core.meta(f);
...
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58177__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__58192){
...
var f = map__58193__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58193__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58193__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var G__58212__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(self_ref),args);
};
var G__58212 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__58217__i = 0, G__58217__a = new Array(arguments.length -  0);
while (G__58217__i < G__58217__a.length) {G__58217__a[G__58217__i] = arguments[G__58217__i + 0]; ++G__58217__i;}
  args = new cljs.core.IndexedSeq(G__58217__a,0,null);
} 
return G__58212__delegate.call(this,args);};
G__58212.cljs$lang$maxFixedArity = 0;
G__58212.cljs$lang$applyTo = (function (arglist__58219){
var args = cljs.core.seq(arglist__58219);
return G__58212__delegate(args);
});
G__58212.cljs$core$IFn$_invoke$arity$variadic = G__58212__delegate;
return G__58212;
})()
;
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58187_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__58187_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__58220__delegate = function (args){
...
var G__58220 = function (var_args){
var args = null;
if (arguments.length > 0) {
...
while (G__58222__i < G__58222__a.length) {G__58222__a[G__58222__i] = arguments[G__58222__i + 0]; ++G__58222__i;}
  args = new cljs.core.IndexedSeq(G__58222__a,0,null);
} 
return G__58220__delegate.call(this,args);};
G__58220.cljs$lang$maxFixedArity = 0;
G__58220.cljs$lang$applyTo = (function (arglist__58223){
var args = cljs.core.seq(arglist__58223);
return G__58220__delegate(args);
});
G__58220.cljs$core$IFn$_invoke$arity$variadic = G__58220__delegate;
return G__58220;
})()
;
})());
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__58188_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58188_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
