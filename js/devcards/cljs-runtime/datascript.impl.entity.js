...
var iter__4582__auto__ = (function datascript$impl$entity$js_seq_$_iter__26293(s__26294){
return (new cljs.core.LazySeq(null,(function (){
var s__26294__$1 = s__26294;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__26294__$1);
if(temp__5735__auto__){
var s__26294__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__26294__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__26294__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__26296 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__26295 = (0);
while(true){
if((i__26295 < size__4581__auto__)){
var vec__26297 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__26295);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26297,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26297,(1),null);
cljs.core.chunk_append(b__26296,((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)));

var G__26489 = (i__26295 + (1));
i__26295 = G__26489;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__26296),datascript$impl$entity$js_seq_$_iter__26293(cljs.core.chunk_rest(s__26294__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__26296),null);
}
} else {
var vec__26300 = cljs.core.first(s__26294__$2);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26300,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26300,(1),null);
return cljs.core.cons(((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)),datascript$impl$entity$js_seq_$_iter__26293(cljs.core.rest(s__26294__$2)));
}
} else {
return null;
}
...
var G__26495 = null;
var G__26495__1 = (function (f){
var self__ = this;
var this$ = this;
var seq__26304 = cljs.core.seq(datascript.impl.entity.js_seq(this$));
var chunk__26305 = null;
var count__26306 = (0);
var i__26307 = (0);
while(true){
if((i__26307 < count__26306)){
var vec__26316 = chunk__26305.cljs$core$IIndexed$_nth$arity$2(null,i__26307);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26316,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26316,(1),null);
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(v,a,this$) : f.call(null,v,a,this$));


var G__26498 = seq__26304;
var G__26499 = chunk__26305;
var G__26500 = count__26306;
var G__26501 = (i__26307 + (1));
seq__26304 = G__26498;
chunk__26305 = G__26499;
count__26306 = G__26500;
i__26307 = G__26501;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__26304);
if(temp__5735__auto__){
var seq__26304__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__26304__$1)){
var c__4609__auto__ = cljs.core.chunk_first(seq__26304__$1);
var G__26502 = cljs.core.chunk_rest(seq__26304__$1);
var G__26503 = c__4609__auto__;
var G__26504 = cljs.core.count(c__4609__auto__);
var G__26505 = (0);
seq__26304 = G__26502;
chunk__26305 = G__26503;
count__26306 = G__26504;
i__26307 = G__26505;
continue;
} else {
var vec__26321 = cljs.core.first(seq__26304__$1);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26321,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26321,(1),null);
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(v,a,this$) : f.call(null,v,a,this$));


var G__26507 = cljs.core.next(seq__26304__$1);
var G__26508 = null;
var G__26509 = (0);
var G__26510 = (0);
seq__26304 = G__26507;
chunk__26305 = G__26508;
count__26306 = G__26509;
i__26307 = G__26510;
continue;
}
} else {
...
var G__26495__2 = (function (f,use_as_this){
var self__ = this;
var this$ = this;
var seq__26326 = cljs.core.seq(datascript.impl.entity.js_seq(this$));
var chunk__26327 = null;
var count__26328 = (0);
var i__26329 = (0);
while(true){
if((i__26329 < count__26328)){
var vec__26338 = chunk__26327.cljs$core$IIndexed$_nth$arity$2(null,i__26329);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26338,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26338,(1),null);
f.call(use_as_this,v,a,this$);


var G__26514 = seq__26326;
var G__26515 = chunk__26327;
var G__26516 = count__26328;
var G__26517 = (i__26329 + (1));
seq__26326 = G__26514;
chunk__26327 = G__26515;
count__26328 = G__26516;
i__26329 = G__26517;
continue;
} else {
...
var c__4609__auto__ = cljs.core.chunk_first(seq__26326__$1);
var G__26518 = cljs.core.chunk_rest(seq__26326__$1);
var G__26519 = c__4609__auto__;
var G__26520 = cljs.core.count(c__4609__auto__);
var G__26521 = (0);
seq__26326 = G__26518;
chunk__26327 = G__26519;
count__26328 = G__26520;
i__26329 = G__26521;
continue;
} else {
var vec__26344 = cljs.core.first(seq__26326__$1);
...
var G__26533 = cljs.core.next(seq__26326__$1);
var G__26534 = null;
var G__26535 = (0);
var G__26536 = (0);
seq__26326 = G__26533;
chunk__26327 = G__26534;
count__26328 = G__26535;
i__26329 = G__26536;
continue;
}
} else {
...
G__26495 = function(f,use_as_this){
switch(arguments.length){
case 1:
return G__26495__1.call(this,f);
case 2:
return G__26495__2.call(this,f,use_as_this);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__26495.cljs$core$IFn$_invoke$arity$1 = G__26495__1;
...
var G__26362 = (datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$2 ? datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$2(this$,attr) : datascript.impl.entity.lookup_entity.call(null,this$,attr));
if(datascript.db.multival_QMARK_(self__.db,attr)){
return datascript.impl.entity.multival__GT_js(G__26362);
} else {
return G__26362;
}
}
...
var self__ = this;
var this$__$1 = this;
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("datascript.impl.entity","nf","datascript.impl.entity/nf",-953741353),(function (){var G__26409 = this$__$1;
var G__26410 = k;
var G__26411 = new cljs.core.Keyword("datascript.impl.entity","nf","datascript.impl.entity/nf",-953741353);
return (datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$3 ? datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$3(G__26409,G__26410,G__26411) : datascript.impl.entity.lookup_entity.call(null,G__26409,G__26410,G__26411));
})());
}));
...
var self__ = this;
var self__ = this;
var G__26421 = (arguments.length - (1));
switch (G__26421) {
case (1):
...
(datascript.impl.entity.Entity.prototype.apply = (function (self__,args26303){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args26303)));
}));
...
var temp__5737__auto__ = (function (){var fexpr__26450 = cljs.core.deref(this$.cache);
return (fexpr__26450.cljs$core$IFn$_invoke$arity$1 ? fexpr__26450.cljs$core$IFn$_invoke$arity$1(attr) : fexpr__26450.call(null,attr));
})();
...
var temp__5735__auto___26580 = cljs.core.not_empty(datascript.db._search(e.db,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [e.eid], null)));
if(cljs.core.truth_(temp__5735__auto___26580)){
var datoms_26582 = temp__5735__auto___26580;
cljs.core.vreset_BANG_(e.cache,datascript.impl.entity.touch_components(e.db,datascript.impl.entity.datoms__GT_cache(e.db,datoms_26582)));
