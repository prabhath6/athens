...
(reitit.frontend.history.FragmentHistory.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k50271,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k50271,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__50277){
var vec__50278 = p__50277;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50278,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50278,(1),null);
...
(reitit.frontend.history.FragmentHistory.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__50270){
var self__ = this;
var G__50270__$1 = this;
return (new cljs.core.RecordIter((0),G__50270__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908),new cljs.core.Keyword(null,"router","router",1091916230),new cljs.core.Keyword(null,"popstate-listener","popstate-listener",806944472),new cljs.core.Keyword(null,"hashchange-listener","hashchange-listener",-1234988801),new cljs.core.Keyword(null,"last-fragment","last-fragment",-919830173)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var h__4297__auto____$1 = (function (){var fexpr__50281 = (function (coll__4436__auto__){
return (354327177 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__50281(this__4435__auto____$1);
})();
...
(reitit.frontend.history.FragmentHistory.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this50272,other50273){
var self__ = this;
var this50272__$1 = this;
return (((!((other50273 == null)))) && ((this50272__$1.constructor === other50273.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this50272__$1.on_navigate,other50273.on_navigate)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this50272__$1.router,other50273.router)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this50272__$1.popstate_listener,other50273.popstate_listener)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this50272__$1.hashchange_listener,other50273.hashchange_listener)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this50272__$1.last_fragment,other50273.last_fragment)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this50272__$1.__extmap,other50273.__extmap)));
}));
...
var G__50283 = reitit.frontend.match_by_path(self__.router,path);
var G__50284 = this$__$1;
return (self__.on_navigate.cljs$core$IFn$_invoke$arity$2 ? self__.on_navigate.cljs$core$IFn$_invoke$arity$2(G__50283,G__50284) : self__.on_navigate.call(null,G__50283,G__50284));
}));
...
(reitit.frontend.history.FragmentHistory.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__50270){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__50288 = cljs.core.keyword_identical_QMARK_;
var expr__50289 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__50292 = new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908);
var G__50293 = expr__50289;
return (pred__50288.cljs$core$IFn$_invoke$arity$2 ? pred__50288.cljs$core$IFn$_invoke$arity$2(G__50292,G__50293) : pred__50288.call(null,G__50292,G__50293));
})())){
return (new reitit.frontend.history.FragmentHistory(G__50270,self__.router,self__.popstate_listener,self__.hashchange_listener,self__.last_fragment,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__50294 = new cljs.core.Keyword(null,"router","router",1091916230);
var G__50295 = expr__50289;
return (pred__50288.cljs$core$IFn$_invoke$arity$2 ? pred__50288.cljs$core$IFn$_invoke$arity$2(G__50294,G__50295) : pred__50288.call(null,G__50294,G__50295));
})())){
return (new reitit.frontend.history.FragmentHistory(self__.on_navigate,G__50270,self__.popstate_listener,self__.hashchange_listener,self__.last_fragment,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__50298 = new cljs.core.Keyword(null,"popstate-listener","popstate-listener",806944472);
var G__50299 = expr__50289;
return (pred__50288.cljs$core$IFn$_invoke$arity$2 ? pred__50288.cljs$core$IFn$_invoke$arity$2(G__50298,G__50299) : pred__50288.call(null,G__50298,G__50299));
})())){
return (new reitit.frontend.history.FragmentHistory(self__.on_navigate,self__.router,G__50270,self__.hashchange_listener,self__.last_fragment,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__50300 = new cljs.core.Keyword(null,"hashchange-listener","hashchange-listener",-1234988801);
var G__50301 = expr__50289;
return (pred__50288.cljs$core$IFn$_invoke$arity$2 ? pred__50288.cljs$core$IFn$_invoke$arity$2(G__50300,G__50301) : pred__50288.call(null,G__50300,G__50301));
})())){
return (new reitit.frontend.history.FragmentHistory(self__.on_navigate,self__.router,self__.popstate_listener,G__50270,self__.last_fragment,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__50302 = new cljs.core.Keyword(null,"last-fragment","last-fragment",-919830173);
var G__50303 = expr__50289;
return (pred__50288.cljs$core$IFn$_invoke$arity$2 ? pred__50288.cljs$core$IFn$_invoke$arity$2(G__50302,G__50303) : pred__50288.call(null,G__50302,G__50303));
})())){
return (new reitit.frontend.history.FragmentHistory(self__.on_navigate,self__.router,self__.popstate_listener,self__.hashchange_listener,G__50270,self__.__meta,self__.__extmap,null));
} else {
return (new reitit.frontend.history.FragmentHistory(self__.on_navigate,self__.router,self__.popstate_listener,self__.hashchange_listener,self__.last_fragment,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__50270),null));
}
}
}
}
...
(reitit.frontend.history.FragmentHistory.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__50270){
var self__ = this;
var this__4438__auto____$1 = this;
return (new reitit.frontend.history.FragmentHistory(self__.on_navigate,self__.router,self__.popstate_listener,self__.hashchange_listener,self__.last_fragment,G__50270,self__.__extmap,self__.__hash));
}));
 ...
 */
reitit.frontend.history.map__GT_FragmentHistory = (function reitit$frontend$history$map__GT_FragmentHistory(G__50274){
var extmap__4478__auto__ = (function (){var G__50304 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__50274,new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"router","router",1091916230),new cljs.core.Keyword(null,"popstate-listener","popstate-listener",806944472),new cljs.core.Keyword(null,"hashchange-listener","hashchange-listener",-1234988801),new cljs.core.Keyword(null,"last-fragment","last-fragment",-919830173)], 0));
if(cljs.core.record_QMARK_(G__50274)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__50304);
} else {
return G__50304;
}
})();
return (new reitit.frontend.history.FragmentHistory(new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908).cljs$core$IFn$_invoke$arity$1(G__50274),new cljs.core.Keyword(null,"router","router",1091916230).cljs$core$IFn$_invoke$arity$1(G__50274),new cljs.core.Keyword(null,"popstate-listener","popstate-listener",806944472).cljs$core$IFn$_invoke$arity$1(G__50274),new cljs.core.Keyword(null,"hashchange-listener","hashchange-listener",-1234988801).cljs$core$IFn$_invoke$arity$1(G__50274),new cljs.core.Keyword(null,"last-fragment","last-fragment",-919830173).cljs$core$IFn$_invoke$arity$1(G__50274),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
