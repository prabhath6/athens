...
var open_QMARK_ = (function (){var G__60773 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"left-sidebar","left-sidebar",-1413634357)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__60773) : re_frame.core.subscribe.call(null,G__60773));
})();
...
var G__60774 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-left-sidebar","toggle-left-sidebar",-468830841)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__60774) : re_frame.core.dispatch.call(null,G__60774));
...
var G__60775 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-athena","toggle-athena",102452770)], null);
...
var G__60776 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-left-sidebar","toggle-left-sidebar",-468830841)], null);
...
var vec__60781 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__60779);
var _order = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60781,(0),null);
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60781,(1),null);
var uid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60781,(2),null);
cljs.core.chunk_append(b__60780,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li>a","li>a",-1587586072),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.left_sidebar.shortcut_style,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__60779,vec__60781,_order,title,uid,c__4580__auto__,size__4581__auto__,b__60780,s__60778__$2,temp__5735__auto__,sorted_shortcuts,open_QMARK_,shortcuts){
return (function (){
return athens.router.navigate_uid(uid);
});})(i__60779,vec__60781,_order,title,uid,c__4580__auto__,size__4581__auto__,b__60780,s__60778__$2,temp__5735__auto__,sorted_shortcuts,open_QMARK_,shortcuts))
], null)),title], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid], null)));

var G__60795 = (i__60779 + (1));
i__60779 = G__60795;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60780),athens$devcards$left_sidebar$left_sidebar_$_iter__60777(cljs.core.chunk_rest(s__60778__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60780),null);
}
} else {
var vec__60784 = cljs.core.first(s__60778__$2);
var _order = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60784,(0),null);
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60784,(1),null);
var uid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60784,(2),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li>a","li>a",-1587586072),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.left_sidebar.shortcut_style,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__60784,_order,title,uid,s__60778__$2,temp__5735__auto__,sorted_shortcuts,open_QMARK_,shortcuts){
return (function (){
return athens.router.navigate_uid(uid);
});})(vec__60784,_order,title,uid,s__60778__$2,temp__5735__auto__,sorted_shortcuts,open_QMARK_,shortcuts))
], null)),title], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid], null)),athens$devcards$left_sidebar$left_sidebar_$_iter__60777(cljs.core.rest(s__60778__$2)));
}
} else {
return null;
}
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.left_sidebar !== 'undefined') && (typeof athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60787 !== 'undefined')){
} else {
...
*/
athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60787 = (function (meta60788){
this.meta60788 = meta60788;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60787.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60789,meta60788__$1){
var self__ = this;
var _60789__$1 = this;
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60787(meta60788__$1));
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60787.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60789){
var self__ = this;
var _60789__$1 = this;
return self__.meta60788;
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60787.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60787.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
...
var G__60790 = athens.db.dsdb;
var G__60791 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword("page","sidebar","page/sidebar",32416927),n,new cljs.core.Keyword("node","title","node/title",628940777),["Page ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(n)].join(''),new cljs.core.Keyword("block","uid","block/uid",-1623585167),["uid",cljs.core.str.cljs$core$IFn$_invoke$arity$1(n)].join('')], null)], null);
return (posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2 ? posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2(G__60790,G__60791) : posh.reagent.transact_BANG_.call(null,G__60790,G__60791));
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60787.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta60788","meta60788",-1571360526,null)], null);
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60787.cljs$lang$type = true);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60787.cljs$lang$ctorStr = "athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60787");

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60787.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60787");
}));

/**
 * Positional factory function for athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60787.
 */
athens.devcards.left_sidebar.__GT_t_athens$devcards$left_sidebar60787 = (function athens$devcards$left_sidebar$__GT_t_athens$devcards$left_sidebar60787(meta60788){
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60787(meta60788));
});

}

return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60787(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.left_sidebar !== 'undefined') && (typeof athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60792 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60792 = (function (meta60793){
this.meta60793 = meta60793;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60792.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60794,meta60793__$1){
var self__ = this;
var _60794__$1 = this;
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60792(meta60793__$1));
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60792.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60794){
var self__ = this;
var _60794__$1 = this;
return self__.meta60793;
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60792.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60792.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
var this__38815__auto____$1 = this;
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60792.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta60793","meta60793",-1089301364,null)], null);
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60792.cljs$lang$type = true);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60792.cljs$lang$ctorStr = "athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60792");

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60792.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60792");
}));

/**
 * Positional factory function for athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60792.
 */
athens.devcards.left_sidebar.__GT_t_athens$devcards$left_sidebar60792 = (function athens$devcards$left_sidebar$__GT_t_athens$devcards$left_sidebar60792(meta60793){
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60792(meta60793));
});

}

return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60792(null));
})()
