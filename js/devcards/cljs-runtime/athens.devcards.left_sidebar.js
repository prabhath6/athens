...
var G__60114 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-athena","toggle-athena",102452770)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__60114) : re_frame.core.dispatch.call(null,G__60114));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60118),athens$devcards$left_sidebar$left_sidebar_$_iter__60115(cljs.core.chunk_rest(s__60116__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60118),null);
}
} else {
var vec__60122 = cljs.core.first(s__60116__$2);
var _order = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60122,(0),null);
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60122,(1),null);
var uid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60122,(2),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li>a","li>a",-1587586072),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.left_sidebar.shortcut_style,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__60122,_order,title,uid,s__60116__$2,temp__5735__auto__,sorted_shortcuts,open_QMARK_,shortcuts){
return (function (){
return athens.router.navigate_uid(uid);
});})(vec__60122,_order,title,uid,s__60116__$2,temp__5735__auto__,sorted_shortcuts,open_QMARK_,shortcuts))
], null)),title], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid], null)),athens$devcards$left_sidebar$left_sidebar_$_iter__60115(cljs.core.rest(s__60116__$2)));
}
} else {
return null;
}
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.left_sidebar !== 'undefined') && (typeof athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60125 !== 'undefined')){
} else {
...
*/
athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60125 = (function (meta60126){
this.meta60126 = meta60126;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60125.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60127,meta60126__$1){
var self__ = this;
var _60127__$1 = this;
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60125(meta60126__$1));
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60125.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60127){
var self__ = this;
var _60127__$1 = this;
return self__.meta60126;
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60125.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60125.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
...
return (posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2 ? posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2(G__60128,G__60129) : posh.reagent.transact_BANG_.call(null,G__60128,G__60129));
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60125.getBasis = (function (){
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60125.cljs$lang$type = true);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60125.cljs$lang$ctorStr = "athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60125");

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60125.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60125");
}));

/**
 * Positional factory function for athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60125.
 */
athens.devcards.left_sidebar.__GT_t_athens$devcards$left_sidebar60125 = (function athens$devcards$left_sidebar$__GT_t_athens$devcards$left_sidebar60125(meta60126){
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60125(meta60126));
});

}

return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60125(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.left_sidebar !== 'undefined') && (typeof athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60130 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60130 = (function (meta60131){
this.meta60131 = meta60131;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60130.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60132,meta60131__$1){
var self__ = this;
var _60132__$1 = this;
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60130(meta60131__$1));
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60130.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60132){
var self__ = this;
var _60132__$1 = this;
return self__.meta60131;
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60130.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60130.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
var this__38815__auto____$1 = this;
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60130.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta60131","meta60131",-575486180,null)], null);
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60130.cljs$lang$type = true);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60130.cljs$lang$ctorStr = "athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60130");

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60130.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60130");
}));

/**
 * Positional factory function for athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60130.
 */
athens.devcards.left_sidebar.__GT_t_athens$devcards$left_sidebar60130 = (function athens$devcards$left_sidebar$__GT_t_athens$devcards$left_sidebar60130(meta60131){
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60130(meta60131));
});

}

return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60130(null));
})()
