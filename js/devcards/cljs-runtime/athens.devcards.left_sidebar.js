...
var G__60125 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-athena","toggle-athena",102452770)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__60125) : re_frame.core.dispatch.call(null,G__60125));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60129),athens$devcards$left_sidebar$left_sidebar_$_iter__60126(cljs.core.chunk_rest(s__60127__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60129),null);
}
} else {
var vec__60133 = cljs.core.first(s__60127__$2);
var _order = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60133,(0),null);
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60133,(1),null);
var uid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60133,(2),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li>a","li>a",-1587586072),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.left_sidebar.shortcut_style,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__60133,_order,title,uid,s__60127__$2,temp__5735__auto__,sorted_shortcuts,open_QMARK_,shortcuts){
return (function (){
return athens.router.navigate_uid(uid);
});})(vec__60133,_order,title,uid,s__60127__$2,temp__5735__auto__,sorted_shortcuts,open_QMARK_,shortcuts))
], null)),title], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid], null)),athens$devcards$left_sidebar$left_sidebar_$_iter__60126(cljs.core.rest(s__60127__$2)));
}
} else {
return null;
}
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.left_sidebar !== 'undefined') && (typeof athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60136 !== 'undefined')){
} else {
...
*/
athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60136 = (function (meta60137){
this.meta60137 = meta60137;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60136.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60138,meta60137__$1){
var self__ = this;
var _60138__$1 = this;
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60136(meta60137__$1));
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60136.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60138){
var self__ = this;
var _60138__$1 = this;
return self__.meta60137;
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60136.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60136.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
...
var G__60139 = athens.db.dsdb;
var G__60140 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword("page","sidebar","page/sidebar",32416927),n,new cljs.core.Keyword("node","title","node/title",628940777),["Page ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(n)].join(''),new cljs.core.Keyword("block","uid","block/uid",-1623585167),["uid",cljs.core.str.cljs$core$IFn$_invoke$arity$1(n)].join('')], null)], null);
return (posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2 ? posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2(G__60139,G__60140) : posh.reagent.transact_BANG_.call(null,G__60139,G__60140));
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60136.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta60137","meta60137",560886001,null)], null);
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60136.cljs$lang$type = true);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60136.cljs$lang$ctorStr = "athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60136");

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60136.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60136");
}));

/**
 * Positional factory function for athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60136.
 */
athens.devcards.left_sidebar.__GT_t_athens$devcards$left_sidebar60136 = (function athens$devcards$left_sidebar$__GT_t_athens$devcards$left_sidebar60136(meta60137){
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60136(meta60137));
});

}

return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60136(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.left_sidebar !== 'undefined') && (typeof athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60141 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60141 = (function (meta60142){
this.meta60142 = meta60142;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60141.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60143,meta60142__$1){
var self__ = this;
var _60143__$1 = this;
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60141(meta60142__$1));
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60141.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60143){
var self__ = this;
var _60143__$1 = this;
return self__.meta60142;
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60141.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60141.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
var this__38815__auto____$1 = this;
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60141.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta60142","meta60142",421603310,null)], null);
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60141.cljs$lang$type = true);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60141.cljs$lang$ctorStr = "athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60141");

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60141.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60141");
}));

/**
 * Positional factory function for athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60141.
 */
athens.devcards.left_sidebar.__GT_t_athens$devcards$left_sidebar60141 = (function athens$devcards$left_sidebar$__GT_t_athens$devcards$left_sidebar60141(meta60142){
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60141(meta60142));
});

}

return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60141(null));
})()
