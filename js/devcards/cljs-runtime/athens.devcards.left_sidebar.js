...
var open_QMARK_ = (function (){var G__60783 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"left-sidebar","left-sidebar",-1413634357)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__60783) : re_frame.core.subscribe.call(null,G__60783));
})();
...
var G__60784 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-left-sidebar","toggle-left-sidebar",-468830841)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__60784) : re_frame.core.dispatch.call(null,G__60784));
...
var G__60785 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-athena","toggle-athena",102452770)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__60785) : re_frame.core.dispatch.call(null,G__60785));
...
var G__60786 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-left-sidebar","toggle-left-sidebar",-468830841)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__60786) : re_frame.core.dispatch.call(null,G__60786));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60790),athens$devcards$left_sidebar$left_sidebar_$_iter__60787(cljs.core.chunk_rest(s__60788__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60790),null);
}
} else {
var vec__60794 = cljs.core.first(s__60788__$2);
var _order = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60794,(0),null);
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60794,(1),null);
var uid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60794,(2),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li>a","li>a",-1587586072),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.left_sidebar.shortcut_style,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__60794,_order,title,uid,s__60788__$2,temp__5735__auto__,sorted_shortcuts,open_QMARK_,shortcuts){
return (function (){
return athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$1(uid);
});})(vec__60794,_order,title,uid,s__60788__$2,temp__5735__auto__,sorted_shortcuts,open_QMARK_,shortcuts))
], null)),title], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid], null)),athens$devcards$left_sidebar$left_sidebar_$_iter__60787(cljs.core.rest(s__60788__$2)));
}
} else {
return null;
}
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.left_sidebar !== 'undefined') && (typeof athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60797 !== 'undefined')){
} else {
...
*/
athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60797 = (function (meta60798){
this.meta60798 = meta60798;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60797.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60799,meta60798__$1){
var self__ = this;
var _60799__$1 = this;
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60797(meta60798__$1));
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60797.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60799){
var self__ = this;
var _60799__$1 = this;
return self__.meta60798;
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60797.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60797.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
...
var G__60800 = athens.db.dsdb;
var G__60801 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword("page","sidebar","page/sidebar",32416927),n,new cljs.core.Keyword("node","title","node/title",628940777),["Page ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(n)].join(''),new cljs.core.Keyword("block","uid","block/uid",-1623585167),["uid",cljs.core.str.cljs$core$IFn$_invoke$arity$1(n)].join('')], null)], null);
return (posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2 ? posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2(G__60800,G__60801) : posh.reagent.transact_BANG_.call(null,G__60800,G__60801));
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60797.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta60798","meta60798",-915926536,null)], null);
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60797.cljs$lang$type = true);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60797.cljs$lang$ctorStr = "athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60797");

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60797.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60797");
}));

/**
 * Positional factory function for athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60797.
 */
athens.devcards.left_sidebar.__GT_t_athens$devcards$left_sidebar60797 = (function athens$devcards$left_sidebar$__GT_t_athens$devcards$left_sidebar60797(meta60798){
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60797(meta60798));
});

}

return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60797(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.left_sidebar !== 'undefined') && (typeof athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60802 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60802 = (function (meta60803){
this.meta60803 = meta60803;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60802.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60804,meta60803__$1){
var self__ = this;
var _60804__$1 = this;
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60802(meta60803__$1));
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60802.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60804){
var self__ = this;
var _60804__$1 = this;
return self__.meta60803;
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60802.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60802.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60802.getBasis = (function (){
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60802.cljs$lang$type = true);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60802.cljs$lang$ctorStr = "athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60802");

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60802.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60802");
}));

/**
 * Positional factory function for athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60802.
 */
athens.devcards.left_sidebar.__GT_t_athens$devcards$left_sidebar60802 = (function athens$devcards$left_sidebar$__GT_t_athens$devcards$left_sidebar60802(meta60803){
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60802(meta60803));
});

}

return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60802(null));
})()
