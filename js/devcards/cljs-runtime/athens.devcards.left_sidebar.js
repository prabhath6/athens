...
var G__60763 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-athena","toggle-athena",102452770)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__60763) : re_frame.core.dispatch.call(null,G__60763));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60767),athens$devcards$left_sidebar$left_sidebar_$_iter__60764(cljs.core.chunk_rest(s__60765__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60767),null);
}
} else {
var vec__60771 = cljs.core.first(s__60765__$2);
var _order = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60771,(0),null);
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60771,(1),null);
var uid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60771,(2),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li>a","li>a",-1587586072),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.left_sidebar.shortcut_style,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__60771,_order,title,uid,s__60765__$2,temp__5735__auto__,sorted_shortcuts,open_QMARK_,shortcuts){
return (function (){
return athens.router.navigate_uid(uid);
});})(vec__60771,_order,title,uid,s__60765__$2,temp__5735__auto__,sorted_shortcuts,open_QMARK_,shortcuts))
], null)),title], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid], null)),athens$devcards$left_sidebar$left_sidebar_$_iter__60764(cljs.core.rest(s__60765__$2)));
}
} else {
return null;
}
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.left_sidebar !== 'undefined') && (typeof athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60774 !== 'undefined')){
} else {
...
*/
athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60774 = (function (meta60775){
this.meta60775 = meta60775;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60774.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60776,meta60775__$1){
var self__ = this;
var _60776__$1 = this;
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60774(meta60775__$1));
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60774.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60776){
var self__ = this;
var _60776__$1 = this;
return self__.meta60775;
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60774.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60774.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
...
var G__60777 = athens.db.dsdb;
var G__60778 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword("page","sidebar","page/sidebar",32416927),n,new cljs.core.Keyword("node","title","node/title",628940777),["Page ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(n)].join(''),new cljs.core.Keyword("block","uid","block/uid",-1623585167),["uid",cljs.core.str.cljs$core$IFn$_invoke$arity$1(n)].join('')], null)], null);
return (posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2 ? posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2(G__60777,G__60778) : posh.reagent.transact_BANG_.call(null,G__60777,G__60778));
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60774.getBasis = (function (){
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60774.cljs$lang$type = true);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60774.cljs$lang$ctorStr = "athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60774");

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60774.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60774");
}));

/**
 * Positional factory function for athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60774.
 */
athens.devcards.left_sidebar.__GT_t_athens$devcards$left_sidebar60774 = (function athens$devcards$left_sidebar$__GT_t_athens$devcards$left_sidebar60774(meta60775){
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60774(meta60775));
});

}

return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60774(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.left_sidebar !== 'undefined') && (typeof athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60779 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60779 = (function (meta60780){
this.meta60780 = meta60780;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60779.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60781,meta60780__$1){
var self__ = this;
var _60781__$1 = this;
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60779(meta60780__$1));
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60779.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60781){
var self__ = this;
var _60781__$1 = this;
return self__.meta60780;
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60779.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60779.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
var this__38815__auto____$1 = this;
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60779.getBasis = (function (){
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60779.cljs$lang$type = true);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60779.cljs$lang$ctorStr = "athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60779");

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60779.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60779");
}));

/**
 * Positional factory function for athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60779.
 */
athens.devcards.left_sidebar.__GT_t_athens$devcards$left_sidebar60779 = (function athens$devcards$left_sidebar$__GT_t_athens$devcards$left_sidebar60779(meta60780){
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60779(meta60780));
});

}

return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60779(null));
})()
