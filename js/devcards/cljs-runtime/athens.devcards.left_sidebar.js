...
var G__53046 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-athena","toggle-athena",102452770)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__53046) : re_frame.core.dispatch.call(null,G__53046));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__53050),athens$devcards$left_sidebar$left_sidebar_$_iter__53047(cljs.core.chunk_rest(s__53048__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__53050),null);
}
} else {
var vec__53054 = cljs.core.first(s__53048__$2);
var _order = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53054,(0),null);
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53054,(1),null);
var uid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53054,(2),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li>a","li>a",-1587586072),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.left_sidebar.shortcut_style,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__53054,_order,title,uid,s__53048__$2,temp__5735__auto__,sorted_shortcuts,open_QMARK_,shortcuts){
return (function (){
return athens.router.navigate_page(uid);
});})(vec__53054,_order,title,uid,s__53048__$2,temp__5735__auto__,sorted_shortcuts,open_QMARK_,shortcuts))
], null)),title], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid], null)),athens$devcards$left_sidebar$left_sidebar_$_iter__53047(cljs.core.rest(s__53048__$2)));
}
} else {
return null;
}
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.left_sidebar !== 'undefined') && (typeof athens.devcards.left_sidebar.t_athens$devcards$left_sidebar53057 !== 'undefined')){
} else {
...
*/
athens.devcards.left_sidebar.t_athens$devcards$left_sidebar53057 = (function (meta53058){
this.meta53058 = meta53058;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar53057.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_53059,meta53058__$1){
var self__ = this;
var _53059__$1 = this;
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar53057(meta53058__$1));
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar53057.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_53059){
var self__ = this;
var _53059__$1 = this;
return self__.meta53058;
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar53057.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar53057.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__48148__auto__,devcard_opts__48149__auto__){
var self__ = this;
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar53057.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta53058","meta53058",1890362990,null)], null);
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar53057.cljs$lang$type = true);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar53057.cljs$lang$ctorStr = "athens.devcards.left-sidebar/t_athens$devcards$left_sidebar53057");

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar53057.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.left-sidebar/t_athens$devcards$left_sidebar53057");
}));

/**
 * Positional factory function for athens.devcards.left-sidebar/t_athens$devcards$left_sidebar53057.
 */
athens.devcards.left_sidebar.__GT_t_athens$devcards$left_sidebar53057 = (function athens$devcards$left_sidebar$__GT_t_athens$devcards$left_sidebar53057(meta53058){
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar53057(meta53058));
});

}

return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar53057(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.left_sidebar !== 'undefined') && (typeof athens.devcards.left_sidebar.t_athens$devcards$left_sidebar53060 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.left_sidebar.t_athens$devcards$left_sidebar53060 = (function (meta53061){
this.meta53061 = meta53061;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar53060.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_53062,meta53061__$1){
var self__ = this;
var _53062__$1 = this;
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar53060(meta53061__$1));
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar53060.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_53062){
var self__ = this;
var _53062__$1 = this;
return self__.meta53061;
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar53060.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar53060.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__48148__auto__,devcard_opts__48149__auto__){
var self__ = this;
var this__48148__auto____$1 = this;
...
var G__53063 = athens.db.dsdb;
var G__53064 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword("page","sidebar","page/sidebar",32416927),n,new cljs.core.Keyword("node","title","node/title",628940777),["Page ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(n)].join(''),new cljs.core.Keyword("block","uid","block/uid",-1623585167),["uid",cljs.core.str.cljs$core$IFn$_invoke$arity$1(n)].join('')], null)], null);
return (posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2 ? posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2(G__53063,G__53064) : posh.reagent.transact_BANG_.call(null,G__53063,G__53064));
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar53060.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta53061","meta53061",544535494,null)], null);
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar53060.cljs$lang$type = true);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar53060.cljs$lang$ctorStr = "athens.devcards.left-sidebar/t_athens$devcards$left_sidebar53060");

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar53060.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.left-sidebar/t_athens$devcards$left_sidebar53060");
}));

/**
 * Positional factory function for athens.devcards.left-sidebar/t_athens$devcards$left_sidebar53060.
 */
athens.devcards.left_sidebar.__GT_t_athens$devcards$left_sidebar53060 = (function athens$devcards$left_sidebar$__GT_t_athens$devcards$left_sidebar53060(meta53061){
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar53060(meta53061));
});

}

return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar53060(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.left_sidebar !== 'undefined') && (typeof athens.devcards.left_sidebar.t_athens$devcards$left_sidebar53065 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.left_sidebar.t_athens$devcards$left_sidebar53065 = (function (meta53066){
this.meta53066 = meta53066;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar53065.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_53067,meta53066__$1){
var self__ = this;
var _53067__$1 = this;
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar53065(meta53066__$1));
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar53065.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_53067){
var self__ = this;
var _53067__$1 = this;
return self__.meta53066;
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar53065.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar53065.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__48148__auto__,devcard_opts__48149__auto__){
var self__ = this;
var this__48148__auto____$1 = this;
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar53065.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta53066","meta53066",-26727205,null)], null);
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar53065.cljs$lang$type = true);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar53065.cljs$lang$ctorStr = "athens.devcards.left-sidebar/t_athens$devcards$left_sidebar53065");

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar53065.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.left-sidebar/t_athens$devcards$left_sidebar53065");
}));

/**
 * Positional factory function for athens.devcards.left-sidebar/t_athens$devcards$left_sidebar53065.
 */
athens.devcards.left_sidebar.__GT_t_athens$devcards$left_sidebar53065 = (function athens$devcards$left_sidebar$__GT_t_athens$devcards$left_sidebar53065(meta53066){
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar53065(meta53066));
});

}

return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar53065(null));
})()
