...
var G__60116 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-athena","toggle-athena",102452770)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__60116) : re_frame.core.dispatch.call(null,G__60116));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60120),athens$devcards$left_sidebar$left_sidebar_$_iter__60117(cljs.core.chunk_rest(s__60118__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60120),null);
}
} else {
var vec__60124 = cljs.core.first(s__60118__$2);
var _order = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60124,(0),null);
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60124,(1),null);
var uid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60124,(2),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li>a","li>a",-1587586072),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.left_sidebar.shortcut_style,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__60124,_order,title,uid,s__60118__$2,temp__5735__auto__,sorted_shortcuts,open_QMARK_,shortcuts){
return (function (){
return athens.router.navigate_uid(uid);
});})(vec__60124,_order,title,uid,s__60118__$2,temp__5735__auto__,sorted_shortcuts,open_QMARK_,shortcuts))
], null)),title], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid], null)),athens$devcards$left_sidebar$left_sidebar_$_iter__60117(cljs.core.rest(s__60118__$2)));
}
} else {
return null;
}
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.left_sidebar !== 'undefined') && (typeof athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60127 !== 'undefined')){
} else {
...
*/
athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60127 = (function (meta60128){
this.meta60128 = meta60128;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60127.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60129,meta60128__$1){
var self__ = this;
var _60129__$1 = this;
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60127(meta60128__$1));
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60127.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60129){
var self__ = this;
var _60129__$1 = this;
return self__.meta60128;
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60127.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60127.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
...
var G__60130 = athens.db.dsdb;
var G__60131 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword("page","sidebar","page/sidebar",32416927),n,new cljs.core.Keyword("node","title","node/title",628940777),["Page ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(n)].join(''),new cljs.core.Keyword("block","uid","block/uid",-1623585167),["uid",cljs.core.str.cljs$core$IFn$_invoke$arity$1(n)].join('')], null)], null);
return (posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2 ? posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2(G__60130,G__60131) : posh.reagent.transact_BANG_.call(null,G__60130,G__60131));
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60127.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta60128","meta60128",-628609741,null)], null);
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60127.cljs$lang$type = true);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60127.cljs$lang$ctorStr = "athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60127");

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60127.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60127");
}));

/**
 * Positional factory function for athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60127.
 */
athens.devcards.left_sidebar.__GT_t_athens$devcards$left_sidebar60127 = (function athens$devcards$left_sidebar$__GT_t_athens$devcards$left_sidebar60127(meta60128){
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60127(meta60128));
});

}

return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60127(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.left_sidebar !== 'undefined') && (typeof athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60132 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60132 = (function (meta60133){
this.meta60133 = meta60133;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60132.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60134,meta60133__$1){
var self__ = this;
var _60134__$1 = this;
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60132(meta60133__$1));
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60132.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60134){
var self__ = this;
var _60134__$1 = this;
return self__.meta60133;
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60132.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60132.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
var this__38815__auto____$1 = this;
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60132.getBasis = (function (){
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60132.cljs$lang$type = true);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60132.cljs$lang$ctorStr = "athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60132");

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60132.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60132");
}));

/**
 * Positional factory function for athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60132.
 */
athens.devcards.left_sidebar.__GT_t_athens$devcards$left_sidebar60132 = (function athens$devcards$left_sidebar$__GT_t_athens$devcards$left_sidebar60132(meta60133){
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60132(meta60133));
});

}

return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60132(null));
})()
