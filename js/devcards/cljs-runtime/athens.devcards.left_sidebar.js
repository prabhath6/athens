...
var open_QMARK_ = (function (){var G__60774 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"left-sidebar","left-sidebar",-1413634357)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__60774) : re_frame.core.subscribe.call(null,G__60774));
})();
...
var G__60775 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-left-sidebar","toggle-left-sidebar",-468830841)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__60775) : re_frame.core.dispatch.call(null,G__60775));
...
var G__60776 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-athena","toggle-athena",102452770)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__60776) : re_frame.core.dispatch.call(null,G__60776));
...
var G__60777 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-left-sidebar","toggle-left-sidebar",-468830841)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__60777) : re_frame.core.dispatch.call(null,G__60777));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60781),athens$devcards$left_sidebar$left_sidebar_$_iter__60778(cljs.core.chunk_rest(s__60779__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60781),null);
}
} else {
var vec__60785 = cljs.core.first(s__60779__$2);
var _order = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60785,(0),null);
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60785,(1),null);
var uid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60785,(2),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li>a","li>a",-1587586072),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.left_sidebar.shortcut_style,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__60785,_order,title,uid,s__60779__$2,temp__5735__auto__,sorted_shortcuts,open_QMARK_,shortcuts){
return (function (){
return athens.router.navigate_uid(uid);
});})(vec__60785,_order,title,uid,s__60779__$2,temp__5735__auto__,sorted_shortcuts,open_QMARK_,shortcuts))
], null)),title], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid], null)),athens$devcards$left_sidebar$left_sidebar_$_iter__60778(cljs.core.rest(s__60779__$2)));
}
} else {
return null;
}
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.left_sidebar !== 'undefined') && (typeof athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60788 !== 'undefined')){
} else {
...
*/
athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60788 = (function (meta60789){
this.meta60789 = meta60789;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60788.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60790,meta60789__$1){
var self__ = this;
var _60790__$1 = this;
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60788(meta60789__$1));
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60788.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60790){
var self__ = this;
var _60790__$1 = this;
return self__.meta60789;
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60788.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60788.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
...
var G__60792 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword("page","sidebar","page/sidebar",32416927),n,new cljs.core.Keyword("node","title","node/title",628940777),["Page ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(n)].join(''),new cljs.core.Keyword("block","uid","block/uid",-1623585167),["uid",cljs.core.str.cljs$core$IFn$_invoke$arity$1(n)].join('')], null)], null);
return (posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2 ? posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2(G__60791,G__60792) : posh.reagent.transact_BANG_.call(null,G__60791,G__60792));
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60788.getBasis = (function (){
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60788.cljs$lang$type = true);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60788.cljs$lang$ctorStr = "athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60788");

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60788.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60788");
}));

/**
 * Positional factory function for athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60788.
 */
athens.devcards.left_sidebar.__GT_t_athens$devcards$left_sidebar60788 = (function athens$devcards$left_sidebar$__GT_t_athens$devcards$left_sidebar60788(meta60789){
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60788(meta60789));
});

}

return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60788(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.left_sidebar !== 'undefined') && (typeof athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60793 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60793 = (function (meta60794){
this.meta60794 = meta60794;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60793.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60795,meta60794__$1){
var self__ = this;
var _60795__$1 = this;
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60793(meta60794__$1));
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60793.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60795){
var self__ = this;
var _60795__$1 = this;
return self__.meta60794;
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60793.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60793.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60793.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta60794","meta60794",-1559114917,null)], null);
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60793.cljs$lang$type = true);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60793.cljs$lang$ctorStr = "athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60793");

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60793.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60793");
}));

/**
 * Positional factory function for athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60793.
 */
athens.devcards.left_sidebar.__GT_t_athens$devcards$left_sidebar60793 = (function athens$devcards$left_sidebar$__GT_t_athens$devcards$left_sidebar60793(meta60794){
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60793(meta60794));
});

}

return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60793(null));
})()
