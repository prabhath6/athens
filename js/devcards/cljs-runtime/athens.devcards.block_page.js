...
athens.devcards.block_page.block_page_el = (function athens$devcards$block_page$block_page_el(p__57943,parents,editing_uid){
...
var string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57944__$1,new cljs.core.Keyword("block","string","block/string",-2066596447));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57944__$1,new cljs.core.Keyword("block","children","block/children",-1040716209));
var uid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57944__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"color","color",1011675173),"gray"], null)], null),cljs.core.interpose.cljs$core$IFn$_invoke$arity$2(" > ",(function (){var iter__4582__auto__ = (function athens$devcards$block_page$block_page_el_$_iter__57946(s__57947){
return (new cljs.core.LazySeq(null,(function (){
var s__57947__$1 = s__57947;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__57947__$1);
if(temp__5735__auto__){
var s__57947__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__57947__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__57947__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__57949 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__57948 = (0);
while(true){
if((i__57948 < size__4581__auto__)){
var p = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__57948);
cljs.core.chunk_append(b__57949,(function (){var map__57950 = p;
...
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57950__$1,new cljs.core.Keyword("node","title","node/title",628940777));
var uid__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57950__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
var string__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57950__$1,new cljs.core.Keyword("block","string","block/string",-2066596447));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),uid__$1,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"cursor","cursor",1011937484),"pointer"], null),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__57948,map__57950,map__57950__$1,title,uid__$1,string__$1,p,c__4580__auto__,size__4581__auto__,b__57949,s__57947__$2,temp__5735__auto__,map__57944,map__57944__$1,string,children,uid){
return (function (){
return athens.router.navigate_uid(uid__$1);
});})(i__57948,map__57950,map__57950__$1,title,uid__$1,string__$1,p,c__4580__auto__,size__4581__auto__,b__57949,s__57947__$2,temp__5735__auto__,map__57944,map__57944__$1,string,children,uid))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__57949),athens$devcards$block_page$block_page_el_$_iter__57946(cljs.core.chunk_rest(s__57947__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__57949),null);
}
} else {
var p = cljs.core.first(s__57947__$2);
return cljs.core.cons((function (){var map__57952 = p;
...
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57952__$1,new cljs.core.Keyword("node","title","node/title",628940777));
var uid__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57952__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
var string__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57952__$1,new cljs.core.Keyword("block","string","block/string",-2066596447));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),uid__$1,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"cursor","cursor",1011937484),"pointer"], null),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (map__57952,map__57952__$1,title,uid__$1,string__$1,p,s__57947__$2,temp__5735__auto__,map__57944,map__57944__$1,string,children,uid){
return (function (){
return athens.router.navigate_uid(uid__$1);
});})(map__57952,map__57952__$1,title,uid__$1,string__$1,p,s__57947__$2,temp__5735__auto__,map__57944,map__57944__$1,string,children,uid))
], null),(function (){var or__4185__auto__ = string__$1;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
...
})(),athens$devcards$block_page$block_page_el_$_iter__57946(cljs.core.rest(s__57947__$2)));
}
} else {
return null;
}
...
var G__57954 = athens.db.dsdb;
var G__57955 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","add","db/add",235286841),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),uid], null),new cljs.core.Keyword("block","string","block/string",-2066596447),e.target.value], null)], null);
return (posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2 ? posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2(G__57954,G__57955) : posh.reagent.transact_BANG_.call(null,G__57954,G__57955));
})], null)], null)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h1","h1",-1896887462),["\u2022 ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(string)].join('')], null))], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),(function (){var iter__4582__auto__ = (function athens$devcards$block_page$block_page_el_$_iter__57956(s__57957){
return (new cljs.core.LazySeq(null,(function (){
var s__57957__$1 = s__57957;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__57957__$1);
if(temp__5735__auto__){
var s__57957__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__57957__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__57957__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__57959 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__57958 = (0);
while(true){
if((i__57958 < size__4581__auto__)){
var child = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__57958);
cljs.core.chunk_append(b__57959,(function (){var map__57960 = child;
var map__57960__$1 = (((((!((map__57960 == null))))?(((((map__57960.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__57960.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__57960):map__57960);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57960__$1,new cljs.core.Keyword("db","id","db/id",-1388397098));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__57959),athens$devcards$block_page$block_page_el_$_iter__57956(cljs.core.chunk_rest(s__57957__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__57959),null);
}
} else {
var child = cljs.core.first(s__57957__$2);
return cljs.core.cons((function (){var map__57962 = child;
var map__57962__$1 = (((((!((map__57962 == null))))?(((((map__57962.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__57962.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__57962):map__57962);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57962__$1,new cljs.core.Keyword("db","id","db/id",-1388397098));
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.blocks.block_el,child], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null));
})(),athens$devcards$block_page$block_page_el_$_iter__57956(cljs.core.rest(s__57957__$2)));
}
} else {
return null;
}
...
var editing_uid = cljs.core.deref((function (){var G__57964 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"editing-uid","editing-uid",1372614377)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__57964) : re_frame.core.subscribe.call(null,G__57964));
})());
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.block_page !== 'undefined') && (typeof athens.devcards.block_page.t_athens$devcards$block_page57965 !== 'undefined')){
} else {
...
*/
athens.devcards.block_page.t_athens$devcards$block_page57965 = (function (meta57966){
this.meta57966 = meta57966;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.block_page.t_athens$devcards$block_page57965.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_57967,meta57966__$1){
var self__ = this;
var _57967__$1 = this;
return (new athens.devcards.block_page.t_athens$devcards$block_page57965(meta57966__$1));
}));

(athens.devcards.block_page.t_athens$devcards$block_page57965.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_57967){
var self__ = this;
var _57967__$1 = this;
return self__.meta57966;
}));

(athens.devcards.block_page.t_athens$devcards$block_page57965.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.block_page.t_athens$devcards$block_page57965.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
...
(athens.devcards.block_page.t_athens$devcards$block_page57965.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta57966","meta57966",1374979236,null)], null);
}));

(athens.devcards.block_page.t_athens$devcards$block_page57965.cljs$lang$type = true);

(athens.devcards.block_page.t_athens$devcards$block_page57965.cljs$lang$ctorStr = "athens.devcards.block-page/t_athens$devcards$block_page57965");

(athens.devcards.block_page.t_athens$devcards$block_page57965.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.block-page/t_athens$devcards$block_page57965");
}));

/**
 * Positional factory function for athens.devcards.block-page/t_athens$devcards$block_page57965.
 */
athens.devcards.block_page.__GT_t_athens$devcards$block_page57965 = (function athens$devcards$block_page$__GT_t_athens$devcards$block_page57965(meta57966){
return (new athens.devcards.block_page.t_athens$devcards$block_page57965(meta57966));
});

}

return (new athens.devcards.block_page.t_athens$devcards$block_page57965(null));
})()
