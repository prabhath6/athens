...
var G__57947 = athens.db.dsdb;
var G__57948 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","add","db/add",235286841),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),uid], null),new cljs.core.Keyword("block","string","block/string",-2066596447),e.target.value], null)], null);
return (posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2 ? posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2(G__57947,G__57948) : posh.reagent.transact_BANG_.call(null,G__57947,G__57948));
})], null)], null)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h1","h1",-1896887462),["\u2022 ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(string)].join('')], null))], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),(function (){var iter__4582__auto__ = (function athens$devcards$block_page$block_page_el_$_iter__57949(s__57950){
return (new cljs.core.LazySeq(null,(function (){
...
var child = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__57951);
cljs.core.chunk_append(b__57952,(function (){var map__57953 = child;
...
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57953__$1,new cljs.core.Keyword("db","id","db/id",-1388397098));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__57952),athens$devcards$block_page$block_page_el_$_iter__57949(cljs.core.chunk_rest(s__57950__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__57952),null);
}
} else {
var child = cljs.core.first(s__57950__$2);
return cljs.core.cons((function (){var map__57955 = child;
...
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.blocks.block_el,child], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null));
})(),athens$devcards$block_page$block_page_el_$_iter__57949(cljs.core.rest(s__57950__$2)));
}
} else {
return null;
}
...
var editing_uid = cljs.core.deref((function (){var G__57957 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"editing-uid","editing-uid",1372614377)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__57957) : re_frame.core.subscribe.call(null,G__57957));
})());
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.block_page !== 'undefined') && (typeof athens.devcards.block_page.t_athens$devcards$block_page57958 !== 'undefined')){
} else {
...
*/
athens.devcards.block_page.t_athens$devcards$block_page57958 = (function (meta57959){
this.meta57959 = meta57959;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.block_page.t_athens$devcards$block_page57958.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_57960,meta57959__$1){
var self__ = this;
var _57960__$1 = this;
return (new athens.devcards.block_page.t_athens$devcards$block_page57958(meta57959__$1));
}));

(athens.devcards.block_page.t_athens$devcards$block_page57958.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_57960){
var self__ = this;
var _57960__$1 = this;
return self__.meta57959;
}));

(athens.devcards.block_page.t_athens$devcards$block_page57958.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.block_page.t_athens$devcards$block_page57958.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
...
(athens.devcards.block_page.t_athens$devcards$block_page57958.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta57959","meta57959",-1223356212,null)], null);
}));

(athens.devcards.block_page.t_athens$devcards$block_page57958.cljs$lang$type = true);

(athens.devcards.block_page.t_athens$devcards$block_page57958.cljs$lang$ctorStr = "athens.devcards.block-page/t_athens$devcards$block_page57958");

(athens.devcards.block_page.t_athens$devcards$block_page57958.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.block-page/t_athens$devcards$block_page57958");
}));

/**
 * Positional factory function for athens.devcards.block-page/t_athens$devcards$block_page57958.
 */
athens.devcards.block_page.__GT_t_athens$devcards$block_page57958 = (function athens$devcards$block_page$__GT_t_athens$devcards$block_page57958(meta57959){
return (new athens.devcards.block_page.t_athens$devcards$block_page57958(meta57959));
});

}

return (new athens.devcards.block_page.t_athens$devcards$block_page57958(null));
})()
