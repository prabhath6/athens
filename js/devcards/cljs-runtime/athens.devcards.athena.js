...
var G__31721 = cljs.core.first(new cljs.core.Keyword("block","_children","block/_children",1128070632).cljs$core$IFn$_invoke$arity$1(b));
b = G__31721;
continue;
}
break;
...
var G__31555 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"pages","pages",-285406513),athens.devcards.athena.search_in_block_title(query)], null);
if(cljs.core.truth_(cljs.core.count(query))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__31555,new cljs.core.Keyword(null,"blocks","blocks",-610462153),athens.devcards.athena.search_in_block_content(query));
} else {
return G__31555;
}
}
...
var G__31556 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-athena","toggle-athena",102452770)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__31556) : re_frame.core.dispatch.call(null,G__31556));
} else {
...
var G__31557 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-athena","toggle-athena",102452770)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__31557) : re_frame.core.dispatch.call(null,G__31557));
...
var vec__31558 = cljs.core.deref(_STAR_match);
var query = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31558,(0),null);
var map__31561 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31558,(1),null);
var map__31561__$1 = (((((!((map__31561 == null))))?(((((map__31561.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__31561.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__31561):map__31561);
var result = map__31561__$1;
var pages = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31561__$1,new cljs.core.Keyword(null,"pages","pages",-285406513));
var blocks = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31561__$1,new cljs.core.Keyword(null,"blocks","blocks",-610462153));
if(cljs.core.truth_(result)){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.devcards.athena.results_list_style),cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4582__auto__ = (function athens$devcards$athena$athena_el_$_iter__31563(s__31564){
return (new cljs.core.LazySeq(null,(function (){
var s__31564__$1 = s__31564;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__31564__$1);
if(temp__5735__auto__){
var s__31564__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__31564__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__31564__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__31566 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__31565 = (0);
while(true){
if((i__31565 < size__4581__auto__)){
var vec__31567 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__31565);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31567,(0),null);
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31567,(1),null);
cljs.core.chunk_append(b__31566,(function (){var parent = new cljs.core.Keyword("block","parent","block/parent",-918309064).cljs$core$IFn$_invoke$arity$1(x);
...
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.athena.result_style,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),i,new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__31565,parent,page_title,block_uid,block_string,vec__31567,i,x,c__4580__auto__,size__4581__auto__,b__31566,s__31564__$2,temp__5735__auto__,vec__31558,query,map__31561,map__31561__$1,result,pages,blocks){
return (function (){
return athens.router.navigate_uid(block_uid);
});})(i__31565,parent,page_title,block_uid,block_string,vec__31567,i,x,c__4580__auto__,size__4581__auto__,b__31566,s__31564__$2,temp__5735__auto__,vec__31558,query,map__31561,map__31561__$1,result,pages,blocks))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__31566),athens$devcards$athena$athena_el_$_iter__31563(cljs.core.chunk_rest(s__31564__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__31566),null);
}
} else {
var vec__31570 = cljs.core.first(s__31564__$2);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31570,(0),null);
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31570,(1),null);
...
var block_string = new cljs.core.Keyword("block","string","block/string",-2066596447).cljs$core$IFn$_invoke$arity$1(x);
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.athena.result_style,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),i,new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (parent,page_title,block_uid,block_string,vec__31570,i,x,s__31564__$2,temp__5735__auto__,vec__31558,query,map__31561,map__31561__$1,result,pages,blocks){
return (function (){
return athens.router.navigate_uid(block_uid);
});})(parent,page_title,block_uid,block_string,vec__31570,i,x,s__31564__$2,temp__5735__auto__,vec__31558,query,map__31561,map__31561__$1,result,pages,blocks))
], null)),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h4.title","h4.title",-103059385),stylefy.core.use_sub_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.athena.result_style,new cljs.core.Keyword(null,"title","title",636505583)),athens.devcards.athena.highlight_match(query,page_title)], null),(cljs.core.truth_(block_string)?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.preview","span.preview",391484430),stylefy.core.use_sub_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.athena.result_style,new cljs.core.Keyword(null,"preview","preview",451279890)),athens.devcards.athena.highlight_match(query,block_string)], null):null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.link-leader","span.link-leader",-227077341),stylefy.core.use_sub_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.athena.result_style,new cljs.core.Keyword(null,"link-leader","link-leader",-1261639700)),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$material_ui$icons$index.ArrowForward], null)], null)], null);
})(),athens$devcards$athena$athena_el_$_iter__31563(cljs.core.rest(s__31564__$2)));
}
} else {
return null;
}
...
var athena_QMARK_ = cljs.core.deref((function (){var G__31576 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"athena","athena",-1523991628)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__31576) : re_frame.core.subscribe.call(null,G__31576));
})());
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.athena !== 'undefined') && (typeof athens.devcards.athena.t_athens$devcards$athena31578 !== 'undefined')){
} else {
...
*/
athens.devcards.athena.t_athens$devcards$athena31578 = (function (meta31579){
this.meta31579 = meta31579;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.athena.t_athens$devcards$athena31578.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_31580,meta31579__$1){
var self__ = this;
var _31580__$1 = this;
return (new athens.devcards.athena.t_athens$devcards$athena31578(meta31579__$1));
}));

(athens.devcards.athena.t_athens$devcards$athena31578.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_31580){
var self__ = this;
var _31580__$1 = this;
return self__.meta31579;
}));

(athens.devcards.athena.t_athens$devcards$athena31578.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.athena.t_athens$devcards$athena31578.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__26592__auto__,devcard_opts__26593__auto__){
var self__ = this;
...
(athens.devcards.athena.t_athens$devcards$athena31578.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta31579","meta31579",1370404953,null)], null);
}));

(athens.devcards.athena.t_athens$devcards$athena31578.cljs$lang$type = true);

(athens.devcards.athena.t_athens$devcards$athena31578.cljs$lang$ctorStr = "athens.devcards.athena/t_athens$devcards$athena31578");

(athens.devcards.athena.t_athens$devcards$athena31578.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.athena/t_athens$devcards$athena31578");
}));

/**
 * Positional factory function for athens.devcards.athena/t_athens$devcards$athena31578.
 */
athens.devcards.athena.__GT_t_athens$devcards$athena31578 = (function athens$devcards$athena$__GT_t_athens$devcards$athena31578(meta31579){
return (new athens.devcards.athena.t_athens$devcards$athena31578(meta31579));
});

}

return (new athens.devcards.athena.t_athens$devcards$athena31578(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.athena !== 'undefined') && (typeof athens.devcards.athena.t_athens$devcards$athena31588 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.athena.t_athens$devcards$athena31588 = (function (meta31589){
this.meta31589 = meta31589;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.athena.t_athens$devcards$athena31588.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_31590,meta31589__$1){
var self__ = this;
var _31590__$1 = this;
return (new athens.devcards.athena.t_athens$devcards$athena31588(meta31589__$1));
}));

(athens.devcards.athena.t_athens$devcards$athena31588.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_31590){
var self__ = this;
var _31590__$1 = this;
return self__.meta31589;
}));

(athens.devcards.athena.t_athens$devcards$athena31588.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.athena.t_athens$devcards$athena31588.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__26592__auto__,devcard_opts__26593__auto__){
var self__ = this;
var this__26592__auto____$1 = this;
...
(athens.devcards.athena.t_athens$devcards$athena31588.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta31589","meta31589",1041673662,null)], null);
}));

(athens.devcards.athena.t_athens$devcards$athena31588.cljs$lang$type = true);

(athens.devcards.athena.t_athens$devcards$athena31588.cljs$lang$ctorStr = "athens.devcards.athena/t_athens$devcards$athena31588");

(athens.devcards.athena.t_athens$devcards$athena31588.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.athena/t_athens$devcards$athena31588");
}));

/**
 * Positional factory function for athens.devcards.athena/t_athens$devcards$athena31588.
 */
athens.devcards.athena.__GT_t_athens$devcards$athena31588 = (function athens$devcards$athena$__GT_t_athens$devcards$athena31588(meta31589){
return (new athens.devcards.athena.t_athens$devcards$athena31588(meta31589));
});

}

return (new athens.devcards.athena.t_athens$devcards$athena31588(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.athena !== 'undefined') && (typeof athens.devcards.athena.t_athens$devcards$athena31591 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.athena.t_athens$devcards$athena31591 = (function (meta31592){
this.meta31592 = meta31592;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.athena.t_athens$devcards$athena31591.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_31593,meta31592__$1){
var self__ = this;
var _31593__$1 = this;
return (new athens.devcards.athena.t_athens$devcards$athena31591(meta31592__$1));
}));

(athens.devcards.athena.t_athens$devcards$athena31591.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_31593){
var self__ = this;
var _31593__$1 = this;
return self__.meta31592;
}));

(athens.devcards.athena.t_athens$devcards$athena31591.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.athena.t_athens$devcards$athena31591.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__26592__auto__,devcard_opts__26593__auto__){
var self__ = this;
var this__26592__auto____$1 = this;
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(devcard_opts__26593__auto__,new cljs.core.Keyword(null,"main-obj","main-obj",-1544409742),(function (){var v__26611__auto__ = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"<>","<>",1280186386),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.athena.athena_prompt_el], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.athena.athena_component], null)], null);
if(cljs.core.fn_QMARK_(v__26611__auto__)){
return (function (data_atom__26612__auto__,owner__26613__auto__){
return reagent.core.as_element(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [v__26611__auto__,data_atom__26612__auto__,owner__26613__auto__], null));
});
...
(athens.devcards.athena.t_athens$devcards$athena31591.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta31592","meta31592",-1953600029,null)], null);
}));

(athens.devcards.athena.t_athens$devcards$athena31591.cljs$lang$type = true);

(athens.devcards.athena.t_athens$devcards$athena31591.cljs$lang$ctorStr = "athens.devcards.athena/t_athens$devcards$athena31591");

(athens.devcards.athena.t_athens$devcards$athena31591.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.athena/t_athens$devcards$athena31591");
}));

/**
 * Positional factory function for athens.devcards.athena/t_athens$devcards$athena31591.
 */
athens.devcards.athena.__GT_t_athens$devcards$athena31591 = (function athens$devcards$athena$__GT_t_athens$devcards$athena31591(meta31592){
return (new athens.devcards.athena.t_athens$devcards$athena31591(meta31592));
});

}

return (new athens.devcards.athena.t_athens$devcards$athena31591(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
