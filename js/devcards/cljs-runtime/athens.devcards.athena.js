...
var G__55714 = cljs.core.first(new cljs.core.Keyword("block","_children","block/_children",1128070632).cljs$core$IFn$_invoke$arity$1(b));
b = G__55714;
continue;
}
break;
...
var G__55686 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"pages","pages",-285406513),athens.devcards.athena.search_in_block_title(query)], null);
if(cljs.core.truth_(cljs.core.count(query))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__55686,new cljs.core.Keyword(null,"blocks","blocks",-610462153),athens.devcards.athena.search_in_block_content(query));
} else {
return G__55686;
}
}
...
var G__55687 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-athena","toggle-athena",102452770)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__55687) : re_frame.core.dispatch.call(null,G__55687));
} else {
...
var G__55688 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-athena","toggle-athena",102452770)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__55688) : re_frame.core.dispatch.call(null,G__55688));
...
var vec__55689 = cljs.core.deref(_STAR_match);
var query = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55689,(0),null);
var map__55692 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55689,(1),null);
var map__55692__$1 = (((((!((map__55692 == null))))?(((((map__55692.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__55692.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__55692):map__55692);
var result = map__55692__$1;
var pages = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55692__$1,new cljs.core.Keyword(null,"pages","pages",-285406513));
var blocks = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55692__$1,new cljs.core.Keyword(null,"blocks","blocks",-610462153));
if(cljs.core.truth_(result)){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.devcards.athena.results_list_style),cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4582__auto__ = (function athens$devcards$athena$athena_el_$_iter__55694(s__55695){
return (new cljs.core.LazySeq(null,(function (){
var s__55695__$1 = s__55695;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__55695__$1);
if(temp__5735__auto__){
var s__55695__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__55695__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__55695__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__55697 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__55696 = (0);
while(true){
if((i__55696 < size__4581__auto__)){
var vec__55698 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__55696);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55698,(0),null);
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55698,(1),null);
cljs.core.chunk_append(b__55697,(function (){var parent = new cljs.core.Keyword("block","parent","block/parent",-918309064).cljs$core$IFn$_invoke$arity$1(x);
...
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.athena.result_style,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),i,new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__55696,parent,page_title,block_uid,block_string,vec__55698,i,x,c__4580__auto__,size__4581__auto__,b__55697,s__55695__$2,temp__5735__auto__,vec__55689,query,map__55692,map__55692__$1,result,pages,blocks){
return (function (){
return athens.router.navigate_uid(block_uid);
});})(i__55696,parent,page_title,block_uid,block_string,vec__55698,i,x,c__4580__auto__,size__4581__auto__,b__55697,s__55695__$2,temp__5735__auto__,vec__55689,query,map__55692,map__55692__$1,result,pages,blocks))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__55697),athens$devcards$athena$athena_el_$_iter__55694(cljs.core.chunk_rest(s__55695__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__55697),null);
}
} else {
var vec__55701 = cljs.core.first(s__55695__$2);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55701,(0),null);
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55701,(1),null);
...
var block_string = new cljs.core.Keyword("block","string","block/string",-2066596447).cljs$core$IFn$_invoke$arity$1(x);
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.athena.result_style,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),i,new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (parent,page_title,block_uid,block_string,vec__55701,i,x,s__55695__$2,temp__5735__auto__,vec__55689,query,map__55692,map__55692__$1,result,pages,blocks){
return (function (){
return athens.router.navigate_uid(block_uid);
});})(parent,page_title,block_uid,block_string,vec__55701,i,x,s__55695__$2,temp__5735__auto__,vec__55689,query,map__55692,map__55692__$1,result,pages,blocks))
], null)),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h4.title","h4.title",-103059385),stylefy.core.use_sub_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.athena.result_style,new cljs.core.Keyword(null,"title","title",636505583)),athens.devcards.athena.highlight_match(query,page_title)], null),(cljs.core.truth_(block_string)?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.preview","span.preview",391484430),stylefy.core.use_sub_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.athena.result_style,new cljs.core.Keyword(null,"preview","preview",451279890)),athens.devcards.athena.highlight_match(query,block_string)], null):null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.link-leader","span.link-leader",-227077341),stylefy.core.use_sub_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.athena.result_style,new cljs.core.Keyword(null,"link-leader","link-leader",-1261639700)),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$material_ui$icons$index.ArrowForward], null)], null)], null);
})(),athens$devcards$athena$athena_el_$_iter__55694(cljs.core.rest(s__55695__$2)));
}
} else {
return null;
}
...
var athena_QMARK_ = cljs.core.deref((function (){var G__55704 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"athena","athena",-1523991628)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__55704) : re_frame.core.subscribe.call(null,G__55704));
})());
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.athena !== 'undefined') && (typeof athens.devcards.athena.t_athens$devcards$athena55705 !== 'undefined')){
} else {
...
*/
athens.devcards.athena.t_athens$devcards$athena55705 = (function (meta55706){
this.meta55706 = meta55706;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.athena.t_athens$devcards$athena55705.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_55707,meta55706__$1){
var self__ = this;
var _55707__$1 = this;
return (new athens.devcards.athena.t_athens$devcards$athena55705(meta55706__$1));
}));

(athens.devcards.athena.t_athens$devcards$athena55705.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_55707){
var self__ = this;
var _55707__$1 = this;
return self__.meta55706;
}));

(athens.devcards.athena.t_athens$devcards$athena55705.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.athena.t_athens$devcards$athena55705.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
...
(athens.devcards.athena.t_athens$devcards$athena55705.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta55706","meta55706",-227127505,null)], null);
}));

(athens.devcards.athena.t_athens$devcards$athena55705.cljs$lang$type = true);

(athens.devcards.athena.t_athens$devcards$athena55705.cljs$lang$ctorStr = "athens.devcards.athena/t_athens$devcards$athena55705");

(athens.devcards.athena.t_athens$devcards$athena55705.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.athena/t_athens$devcards$athena55705");
}));

/**
 * Positional factory function for athens.devcards.athena/t_athens$devcards$athena55705.
 */
athens.devcards.athena.__GT_t_athens$devcards$athena55705 = (function athens$devcards$athena$__GT_t_athens$devcards$athena55705(meta55706){
return (new athens.devcards.athena.t_athens$devcards$athena55705(meta55706));
});

}

return (new athens.devcards.athena.t_athens$devcards$athena55705(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.athena !== 'undefined') && (typeof athens.devcards.athena.t_athens$devcards$athena55708 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.athena.t_athens$devcards$athena55708 = (function (meta55709){
this.meta55709 = meta55709;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.athena.t_athens$devcards$athena55708.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_55710,meta55709__$1){
var self__ = this;
var _55710__$1 = this;
return (new athens.devcards.athena.t_athens$devcards$athena55708(meta55709__$1));
}));

(athens.devcards.athena.t_athens$devcards$athena55708.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_55710){
var self__ = this;
var _55710__$1 = this;
return self__.meta55709;
}));

(athens.devcards.athena.t_athens$devcards$athena55708.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.athena.t_athens$devcards$athena55708.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
var this__38815__auto____$1 = this;
...
(athens.devcards.athena.t_athens$devcards$athena55708.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta55709","meta55709",1899437628,null)], null);
}));

(athens.devcards.athena.t_athens$devcards$athena55708.cljs$lang$type = true);

(athens.devcards.athena.t_athens$devcards$athena55708.cljs$lang$ctorStr = "athens.devcards.athena/t_athens$devcards$athena55708");

(athens.devcards.athena.t_athens$devcards$athena55708.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.athena/t_athens$devcards$athena55708");
}));

/**
 * Positional factory function for athens.devcards.athena/t_athens$devcards$athena55708.
 */
athens.devcards.athena.__GT_t_athens$devcards$athena55708 = (function athens$devcards$athena$__GT_t_athens$devcards$athena55708(meta55709){
return (new athens.devcards.athena.t_athens$devcards$athena55708(meta55709));
});

}

return (new athens.devcards.athena.t_athens$devcards$athena55708(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.athena !== 'undefined') && (typeof athens.devcards.athena.t_athens$devcards$athena55711 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.athena.t_athens$devcards$athena55711 = (function (meta55712){
this.meta55712 = meta55712;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.athena.t_athens$devcards$athena55711.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_55713,meta55712__$1){
var self__ = this;
var _55713__$1 = this;
return (new athens.devcards.athena.t_athens$devcards$athena55711(meta55712__$1));
}));

(athens.devcards.athena.t_athens$devcards$athena55711.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_55713){
var self__ = this;
var _55713__$1 = this;
return self__.meta55712;
}));

(athens.devcards.athena.t_athens$devcards$athena55711.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.athena.t_athens$devcards$athena55711.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
var this__38815__auto____$1 = this;
...
(athens.devcards.athena.t_athens$devcards$athena55711.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta55712","meta55712",-1631342522,null)], null);
}));

(athens.devcards.athena.t_athens$devcards$athena55711.cljs$lang$type = true);

(athens.devcards.athena.t_athens$devcards$athena55711.cljs$lang$ctorStr = "athens.devcards.athena/t_athens$devcards$athena55711");

(athens.devcards.athena.t_athens$devcards$athena55711.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.athena/t_athens$devcards$athena55711");
}));

/**
 * Positional factory function for athens.devcards.athena/t_athens$devcards$athena55711.
 */
athens.devcards.athena.__GT_t_athens$devcards$athena55711 = (function athens$devcards$athena$__GT_t_athens$devcards$athena55711(meta55712){
return (new athens.devcards.athena.t_athens$devcards$athena55711(meta55712));
});

}

return (new athens.devcards.athena.t_athens$devcards$athena55711(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
