...
var G__55738 = cljs.core.first(new cljs.core.Keyword("block","_children","block/_children",1128070632).cljs$core$IFn$_invoke$arity$1(b));
b = G__55738;
continue;
}
break;
...
var G__55710 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"pages","pages",-285406513),athens.devcards.athena.search_in_block_title(query)], null);
if(cljs.core.truth_(cljs.core.count(query))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__55710,new cljs.core.Keyword(null,"blocks","blocks",-610462153),athens.devcards.athena.search_in_block_content(query));
} else {
return G__55710;
}
}
...
var G__55711 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-athena","toggle-athena",102452770)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__55711) : re_frame.core.dispatch.call(null,G__55711));
} else {
...
var G__55712 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-athena","toggle-athena",102452770)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__55712) : re_frame.core.dispatch.call(null,G__55712));
...
var vec__55713 = cljs.core.deref(_STAR_match);
var query = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55713,(0),null);
var map__55716 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55713,(1),null);
...
var result = map__55716__$1;
var pages = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55716__$1,new cljs.core.Keyword(null,"pages","pages",-285406513));
var blocks = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55716__$1,new cljs.core.Keyword(null,"blocks","blocks",-610462153));
if(cljs.core.truth_(result)){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.devcards.athena.results_list_style),cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4582__auto__ = (function athens$devcards$athena$athena_el_$_iter__55718(s__55719){
return (new cljs.core.LazySeq(null,(function (){
var s__55719__$1 = s__55719;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__55719__$1);
if(temp__5735__auto__){
var s__55719__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__55719__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__55719__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__55721 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__55720 = (0);
while(true){
if((i__55720 < size__4581__auto__)){
var vec__55722 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__55720);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55722,(0),null);
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55722,(1),null);
cljs.core.chunk_append(b__55721,(function (){var parent = new cljs.core.Keyword("block","parent","block/parent",-918309064).cljs$core$IFn$_invoke$arity$1(x);
...
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.athena.result_style,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),i,new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__55720,parent,page_title,block_uid,block_string,vec__55722,i,x,c__4580__auto__,size__4581__auto__,b__55721,s__55719__$2,temp__5735__auto__,vec__55713,query,map__55716,map__55716__$1,result,pages,blocks){
return (function (){
return athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$1(block_uid);
});})(i__55720,parent,page_title,block_uid,block_string,vec__55722,i,x,c__4580__auto__,size__4581__auto__,b__55721,s__55719__$2,temp__5735__auto__,vec__55713,query,map__55716,map__55716__$1,result,pages,blocks))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__55721),athens$devcards$athena$athena_el_$_iter__55718(cljs.core.chunk_rest(s__55719__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__55721),null);
}
} else {
var vec__55725 = cljs.core.first(s__55719__$2);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55725,(0),null);
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55725,(1),null);
...
var block_string = new cljs.core.Keyword("block","string","block/string",-2066596447).cljs$core$IFn$_invoke$arity$1(x);
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.athena.result_style,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),i,new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (parent,page_title,block_uid,block_string,vec__55725,i,x,s__55719__$2,temp__5735__auto__,vec__55713,query,map__55716,map__55716__$1,result,pages,blocks){
return (function (){
return athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$1(block_uid);
});})(parent,page_title,block_uid,block_string,vec__55725,i,x,s__55719__$2,temp__5735__auto__,vec__55713,query,map__55716,map__55716__$1,result,pages,blocks))
], null)),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h4.title","h4.title",-103059385),stylefy.core.use_sub_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.athena.result_style,new cljs.core.Keyword(null,"title","title",636505583)),athens.devcards.athena.highlight_match(query,page_title)], null),(cljs.core.truth_(block_string)?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.preview","span.preview",391484430),stylefy.core.use_sub_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.athena.result_style,new cljs.core.Keyword(null,"preview","preview",451279890)),athens.devcards.athena.highlight_match(query,block_string)], null):null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.link-leader","span.link-leader",-227077341),stylefy.core.use_sub_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.athena.result_style,new cljs.core.Keyword(null,"link-leader","link-leader",-1261639700)),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$material_ui$icons$index.ArrowForward], null)], null)], null);
})(),athens$devcards$athena$athena_el_$_iter__55718(cljs.core.rest(s__55719__$2)));
}
} else {
return null;
}
...
var athena_QMARK_ = cljs.core.deref((function (){var G__55728 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"athena","athena",-1523991628)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__55728) : re_frame.core.subscribe.call(null,G__55728));
})());
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.athena !== 'undefined') && (typeof athens.devcards.athena.t_athens$devcards$athena55729 !== 'undefined')){
} else {
...
*/
athens.devcards.athena.t_athens$devcards$athena55729 = (function (meta55730){
this.meta55730 = meta55730;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.athena.t_athens$devcards$athena55729.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_55731,meta55730__$1){
var self__ = this;
var _55731__$1 = this;
return (new athens.devcards.athena.t_athens$devcards$athena55729(meta55730__$1));
}));

(athens.devcards.athena.t_athens$devcards$athena55729.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_55731){
var self__ = this;
var _55731__$1 = this;
return self__.meta55730;
}));

(athens.devcards.athena.t_athens$devcards$athena55729.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.athena.t_athens$devcards$athena55729.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
...
(athens.devcards.athena.t_athens$devcards$athena55729.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta55730","meta55730",-1706875529,null)], null);
}));

(athens.devcards.athena.t_athens$devcards$athena55729.cljs$lang$type = true);

(athens.devcards.athena.t_athens$devcards$athena55729.cljs$lang$ctorStr = "athens.devcards.athena/t_athens$devcards$athena55729");

(athens.devcards.athena.t_athens$devcards$athena55729.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.athena/t_athens$devcards$athena55729");
}));

/**
 * Positional factory function for athens.devcards.athena/t_athens$devcards$athena55729.
 */
athens.devcards.athena.__GT_t_athens$devcards$athena55729 = (function athens$devcards$athena$__GT_t_athens$devcards$athena55729(meta55730){
return (new athens.devcards.athena.t_athens$devcards$athena55729(meta55730));
});

}

return (new athens.devcards.athena.t_athens$devcards$athena55729(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.athena !== 'undefined') && (typeof athens.devcards.athena.t_athens$devcards$athena55732 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.athena.t_athens$devcards$athena55732 = (function (meta55733){
this.meta55733 = meta55733;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.athena.t_athens$devcards$athena55732.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_55734,meta55733__$1){
var self__ = this;
var _55734__$1 = this;
return (new athens.devcards.athena.t_athens$devcards$athena55732(meta55733__$1));
}));

(athens.devcards.athena.t_athens$devcards$athena55732.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_55734){
var self__ = this;
var _55734__$1 = this;
return self__.meta55733;
}));

(athens.devcards.athena.t_athens$devcards$athena55732.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.athena.t_athens$devcards$athena55732.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.athena.t_athens$devcards$athena55732.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta55733","meta55733",242241737,null)], null);
}));

(athens.devcards.athena.t_athens$devcards$athena55732.cljs$lang$type = true);

(athens.devcards.athena.t_athens$devcards$athena55732.cljs$lang$ctorStr = "athens.devcards.athena/t_athens$devcards$athena55732");

(athens.devcards.athena.t_athens$devcards$athena55732.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.athena/t_athens$devcards$athena55732");
}));

/**
 * Positional factory function for athens.devcards.athena/t_athens$devcards$athena55732.
 */
athens.devcards.athena.__GT_t_athens$devcards$athena55732 = (function athens$devcards$athena$__GT_t_athens$devcards$athena55732(meta55733){
return (new athens.devcards.athena.t_athens$devcards$athena55732(meta55733));
});

}

return (new athens.devcards.athena.t_athens$devcards$athena55732(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.athena !== 'undefined') && (typeof athens.devcards.athena.t_athens$devcards$athena55735 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.athena.t_athens$devcards$athena55735 = (function (meta55736){
this.meta55736 = meta55736;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.athena.t_athens$devcards$athena55735.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_55737,meta55736__$1){
var self__ = this;
var _55737__$1 = this;
return (new athens.devcards.athena.t_athens$devcards$athena55735(meta55736__$1));
}));

(athens.devcards.athena.t_athens$devcards$athena55735.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_55737){
var self__ = this;
var _55737__$1 = this;
return self__.meta55736;
}));

(athens.devcards.athena.t_athens$devcards$athena55735.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.athena.t_athens$devcards$athena55735.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.athena.t_athens$devcards$athena55735.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta55736","meta55736",312812341,null)], null);
}));

(athens.devcards.athena.t_athens$devcards$athena55735.cljs$lang$type = true);

(athens.devcards.athena.t_athens$devcards$athena55735.cljs$lang$ctorStr = "athens.devcards.athena/t_athens$devcards$athena55735");

(athens.devcards.athena.t_athens$devcards$athena55735.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.athena/t_athens$devcards$athena55735");
}));

/**
 * Positional factory function for athens.devcards.athena/t_athens$devcards$athena55735.
 */
athens.devcards.athena.__GT_t_athens$devcards$athena55735 = (function athens$devcards$athena$__GT_t_athens$devcards$athena55735(meta55736){
return (new athens.devcards.athena.t_athens$devcards$athena55735(meta55736));
});

}

return (new athens.devcards.athena.t_athens$devcards$athena55735(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
