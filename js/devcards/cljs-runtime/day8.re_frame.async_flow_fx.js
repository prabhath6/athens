 ...
 */
day8.re_frame.async_flow_fx.dissoc_in = (function day8$re_frame$async_flow_fx$dissoc_in(m,p__61028){
var vec__61029 = p__61028;
var seq__61030 = cljs.core.seq(vec__61029);
var first__61031 = cljs.core.first(seq__61030);
var seq__61030__$1 = cljs.core.next(seq__61030);
var k = first__61031;
var ks = seq__61030__$1;
var keys = vec__61029;
if(ks){
...
var G__61033 = new cljs.core.Keyword(null,"events","events",1792552201).cljs$core$IFn$_invoke$arity$1(task);
var G__61034 = now_seen_events;
var fexpr__61032 = new cljs.core.Keyword(null,"when","when",-576417306).cljs$core$IFn$_invoke$arity$1(task);
return (fexpr__61032.cljs$core$IFn$_invoke$arity$2 ? fexpr__61032.cljs$core$IFn$_invoke$arity$2(G__61033,G__61034) : fexpr__61032.call(null,G__61033,G__61034));
...
var G__61035 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__61036 = "async-flow: got bad value for :when - ";
var G__61037 = when_kw;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__61035,G__61036,G__61037) : re_frame.core.console.call(null,G__61035,G__61036,G__61037));
}
});
/**
...
return cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (index,p__61038){
...
var rule = map__61039__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61039__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var when = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61039__$1,new cljs.core.Keyword(null,"when","when",-576417306));
var events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61039__$1,new cljs.core.Keyword(null,"events","events",1792552201));
var dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61039__$1,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61039__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61039__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var halt_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61039__$1,new cljs.core.Keyword(null,"halt?","halt?",-1110658247));
...
var G__61041 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__61042 = "async-flow: rule can only specify one of :dispatch, :dispatch-n and :dispatch-fn. Got more than one: ";
var G__61043 = rule;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__61041,G__61042,G__61043) : re_frame.core.console.call(null,G__61041,G__61042,G__61043));
} else {
var G__61044 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__4185__auto__ = id;
...
var G__61044__$1 = (cljs.core.truth_(dispatch_fn)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61044,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614),dispatch_fn):G__61044);
if(cljs.core.not(dispatch_fn)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61044__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236),(cljs.core.truth_(dispatch_n)?dispatch_n:(cljs.core.truth_(dispatch)?(new cljs.core.List(null,dispatch,null,(1),null)):cljs.core.List.EMPTY
)));
} else {
return G__61044__$1;
}
...
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61045__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61045__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
...
var G__61047 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__61048 = "async-flow: dispatch-fn must return a seq of events ";
var G__61049 = rule;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__61047,G__61048,G__61049) : re_frame.core.console.call(null,G__61047,G__61048,G__61049));
}
} else {
 ...
 */
day8.re_frame.async_flow_fx.make_flow_event_handler = (function day8$re_frame$async_flow_fx$make_flow_event_handler(p__61050){
...
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61051__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var db_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61051__$1,new cljs.core.Keyword(null,"db-path","db-path",-68094099));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61051__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var first_dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61051__$1,new cljs.core.Keyword(null,"first-dispatch","first-dispatch",128561923));
...
return (function day8$re_frame$async_flow_fx$make_flow_event_handler_$_async_flow_event_handler(p__61053,p__61054){
var map__61055 = p__61053;
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61055__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__61056 = p__61054;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61056,(0),null);
var event_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61056,(1),null);
var event_v = vec__61056;
var pred__61060 = cljs.core._EQ_;
var expr__61061 = event_type;
if(cljs.core.truth_((function (){var G__61063 = new cljs.core.Keyword(null,"setup","setup",1987730512);
var G__61064 = expr__61061;
return (pred__61060.cljs$core$IFn$_invoke$arity$2 ? pred__61060.cljs$core$IFn$_invoke$arity$2(G__61063,G__61064) : pred__61060.call(null,G__61063,G__61064));
})())){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"db","db",993250759),(function (){var G__61065 = db;
var G__61066 = cljs.core.PersistentHashSet.EMPTY;
var G__61067 = cljs.core.PersistentHashSet.EMPTY;
return (set_state.cljs$core$IFn$_invoke$arity$3 ? set_state.cljs$core$IFn$_invoke$arity$3(G__61065,G__61066,G__61067) : set_state.call(null,G__61065,G__61066,G__61067));
...
var vec__61068 = event_v;
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61068,(0),null);
var forwarded_event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61068,(1),null);
var map__61071 = (get_state.cljs$core$IFn$_invoke$arity$1 ? get_state.cljs$core$IFn$_invoke$arity$1(db) : get_state.call(null,db));
...
var seen_events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61071__$1,new cljs.core.Keyword(null,"seen-events","seen-events",1607648392));
var rules_fired = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61071__$1,new cljs.core.Keyword(null,"rules-fired","rules-fired",-1669838140));
...
var vec__61073 = day8.re_frame.async_flow_fx.ensure_has_id(flow);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61073,(0),null);
var flow_SINGLEQUOTE_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61073,(1),null);
...
var G__61076 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [id,new cljs.core.Keyword(null,"setup","setup",1987730512)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__61076) : re_frame.core.dispatch.call(null,G__61076));
});
var G__61077_61079 = new cljs.core.Keyword(null,"async-flow","async-flow",1464712702);
var G__61078_61080 = day8.re_frame.async_flow_fx.flow__GT_handler;
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__61077_61079,G__61078_61080) : re_frame.core.reg_fx.call(null,G__61077_61079,G__61078_61080));
