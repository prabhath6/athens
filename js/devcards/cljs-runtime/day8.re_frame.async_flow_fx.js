 ...
 */
day8.re_frame.async_flow_fx.dissoc_in = (function day8$re_frame$async_flow_fx$dissoc_in(m,p__60296){
var vec__60297 = p__60296;
var seq__60298 = cljs.core.seq(vec__60297);
var first__60299 = cljs.core.first(seq__60298);
var seq__60298__$1 = cljs.core.next(seq__60298);
var k = first__60299;
var ks = seq__60298__$1;
var keys = vec__60297;
if(ks){
...
var G__60301 = new cljs.core.Keyword(null,"events","events",1792552201).cljs$core$IFn$_invoke$arity$1(task);
var G__60302 = now_seen_events;
var fexpr__60300 = new cljs.core.Keyword(null,"when","when",-576417306).cljs$core$IFn$_invoke$arity$1(task);
return (fexpr__60300.cljs$core$IFn$_invoke$arity$2 ? fexpr__60300.cljs$core$IFn$_invoke$arity$2(G__60301,G__60302) : fexpr__60300.call(null,G__60301,G__60302));
...
var G__60303 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__60304 = "async-flow: got bad value for :when - ";
var G__60305 = when_kw;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__60303,G__60304,G__60305) : re_frame.core.console.call(null,G__60303,G__60304,G__60305));
}
});
/**
...
return cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (index,p__60306){
...
var rule = map__60307__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60307__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var when = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60307__$1,new cljs.core.Keyword(null,"when","when",-576417306));
var events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60307__$1,new cljs.core.Keyword(null,"events","events",1792552201));
var dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60307__$1,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60307__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60307__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var halt_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60307__$1,new cljs.core.Keyword(null,"halt?","halt?",-1110658247));
...
var G__60309 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__60310 = "async-flow: rule can only specify one of :dispatch, :dispatch-n and :dispatch-fn. Got more than one: ";
var G__60311 = rule;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__60309,G__60310,G__60311) : re_frame.core.console.call(null,G__60309,G__60310,G__60311));
} else {
var G__60312 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__4185__auto__ = id;
...
var G__60312__$1 = (cljs.core.truth_(dispatch_fn)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__60312,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614),dispatch_fn):G__60312);
if(cljs.core.not(dispatch_fn)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__60312__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236),(cljs.core.truth_(dispatch_n)?dispatch_n:(cljs.core.truth_(dispatch)?(new cljs.core.List(null,dispatch,null,(1),null)):cljs.core.List.EMPTY
)));
} else {
return G__60312__$1;
}
...
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60313__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60313__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
...
var G__60315 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__60316 = "async-flow: dispatch-fn must return a seq of events ";
var G__60317 = rule;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__60315,G__60316,G__60317) : re_frame.core.console.call(null,G__60315,G__60316,G__60317));
}
} else {
 ...
 */
day8.re_frame.async_flow_fx.make_flow_event_handler = (function day8$re_frame$async_flow_fx$make_flow_event_handler(p__60318){
...
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60319__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var db_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60319__$1,new cljs.core.Keyword(null,"db-path","db-path",-68094099));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60319__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var first_dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60319__$1,new cljs.core.Keyword(null,"first-dispatch","first-dispatch",128561923));
...
return (function day8$re_frame$async_flow_fx$make_flow_event_handler_$_async_flow_event_handler(p__60321,p__60322){
var map__60323 = p__60321;
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60323__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__60324 = p__60322;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60324,(0),null);
var event_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60324,(1),null);
var event_v = vec__60324;
var pred__60328 = cljs.core._EQ_;
var expr__60329 = event_type;
if(cljs.core.truth_((function (){var G__60331 = new cljs.core.Keyword(null,"setup","setup",1987730512);
var G__60332 = expr__60329;
return (pred__60328.cljs$core$IFn$_invoke$arity$2 ? pred__60328.cljs$core$IFn$_invoke$arity$2(G__60331,G__60332) : pred__60328.call(null,G__60331,G__60332));
})())){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"db","db",993250759),(function (){var G__60333 = db;
var G__60334 = cljs.core.PersistentHashSet.EMPTY;
var G__60335 = cljs.core.PersistentHashSet.EMPTY;
return (set_state.cljs$core$IFn$_invoke$arity$3 ? set_state.cljs$core$IFn$_invoke$arity$3(G__60333,G__60334,G__60335) : set_state.call(null,G__60333,G__60334,G__60335));
...
var vec__60336 = event_v;
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60336,(0),null);
var forwarded_event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60336,(1),null);
var map__60339 = (get_state.cljs$core$IFn$_invoke$arity$1 ? get_state.cljs$core$IFn$_invoke$arity$1(db) : get_state.call(null,db));
...
var seen_events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60339__$1,new cljs.core.Keyword(null,"seen-events","seen-events",1607648392));
var rules_fired = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60339__$1,new cljs.core.Keyword(null,"rules-fired","rules-fired",-1669838140));
...
var vec__60341 = day8.re_frame.async_flow_fx.ensure_has_id(flow);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60341,(0),null);
var flow_SINGLEQUOTE_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60341,(1),null);
...
var G__60344 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [id,new cljs.core.Keyword(null,"setup","setup",1987730512)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__60344) : re_frame.core.dispatch.call(null,G__60344));
});
var G__60345_60347 = new cljs.core.Keyword(null,"async-flow","async-flow",1464712702);
var G__60346_60348 = day8.re_frame.async_flow_fx.flow__GT_handler;
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__60345_60347,G__60346_60348) : re_frame.core.reg_fx.call(null,G__60345_60347,G__60346_60348));
