...
var vec__47294 = cljs.core.rest(expr);
var seq__47295 = cljs.core.seq(vec__47294);
var first__47296 = cljs.core.first(seq__47295);
var seq__47295__$1 = cljs.core.next(seq__47295);
var vec__47297 = first__47296;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47297,(0),null);
var form = seq__47295__$1;
...
var G__47300 = x;
var G__47300__$1 = (((G__47300 == null))?null:spec_tools.impl.polish(G__47300));
var G__47300__$2 = (((G__47300__$1 == null))?null:cljs.core.name(G__47300__$1));
if((G__47300__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__47300__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__47301 = x;
var G__47301__$1 = (((G__47301 == null))?null:cljs.core.name(G__47301));
if((G__47301__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__47301__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__47302){
...
var data = map__47303__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47303__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47303__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47303__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47303__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__47305){
...
var data = map__47306__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47306__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47306__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__47308 = data;
var G__47308__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__47308,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__47308);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__47308__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__47308__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__47312 = form;
var G__47312__$1 = (((G__47312 == null))?null:cljs.core.rest(G__47312));
if((G__47312__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__47312__$1);
}
})();
var G__47313 = m;
var G__47313__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__47313,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__47309_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__47309_SHARP_)));
})):G__47313);
var G__47313__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__47313__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__47310_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__47310_SHARP_)));
})):G__47313__$1);
var G__47313__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__47313__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__47311_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__47311_SHARP_));
})):G__47313__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__47313__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__47314 = (function (){var G__47315 = form;
var G__47315__$1 = (((G__47315 == null))?null:cljs.core.rest(G__47315));
if((G__47315__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__47315__$1);
}
})();
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47314__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47314__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47314__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47314__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__47317 = (((kw instanceof cljs.core.Symbol))?cljs.core.namespace(kw):false);
switch (G__47317) {
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__47318 = form;
var G__47318__$1 = (((G__47318 == null))?null:cljs.core.seq(G__47318));
var G__47318__$2 = (((G__47318__$1 == null))?null:cljs.core.first(G__47318__$1));
if((G__47318__$2 == null)){
return null;
} else {
var fexpr__47319 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__47319.cljs$core$IFn$_invoke$arity$1 ? fexpr__47319.cljs$core$IFn$_invoke$arity$1(G__47318__$2) : fexpr__47319.call(null,G__47318__$2));
}
})():null));
});
/**
...
var len__4789__auto___47340 = arguments.length;
var i__4790__auto___47341 = (0);
while(true){
if((i__4790__auto___47341 < len__4789__auto___47340)){
args__4795__auto__.push((arguments[i__4790__auto___47341]));

var G__47342 = (i__4790__auto___47341 + (1));
i__4790__auto___47341 = G__47342;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq47320){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq47320));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__47321){
var vec__47322 = p__47321;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47322,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47322,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__47327){
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47328__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47328__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47328__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47328__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__47325_SHARP_){
return cljs.core.map_QMARK_(p1__47325_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__47326_SHARP_){
return cljs.core.contains_QMARK_(p1__47326_SHARP_,x);
});
}),req_keys));
