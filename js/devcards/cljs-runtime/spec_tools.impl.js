...
var vec__47307 = cljs.core.rest(expr);
var seq__47308 = cljs.core.seq(vec__47307);
var first__47309 = cljs.core.first(seq__47308);
var seq__47308__$1 = cljs.core.next(seq__47308);
var vec__47310 = first__47309;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47310,(0),null);
var form = seq__47308__$1;
...
var G__47313 = x;
var G__47313__$1 = (((G__47313 == null))?null:spec_tools.impl.polish(G__47313));
var G__47313__$2 = (((G__47313__$1 == null))?null:cljs.core.name(G__47313__$1));
if((G__47313__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__47313__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__47314 = x;
var G__47314__$1 = (((G__47314 == null))?null:cljs.core.name(G__47314));
if((G__47314__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__47314__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__47315){
var map__47316 = p__47315;
var map__47316__$1 = (((((!((map__47316 == null))))?(((((map__47316.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__47316.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__47316):map__47316);
var data = map__47316__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47316__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47316__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47316__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47316__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__47318){
...
var data = map__47319__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47319__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47319__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__47321 = data;
var G__47321__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__47321,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__47321);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__47321__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__47321__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__47325 = form;
var G__47325__$1 = (((G__47325 == null))?null:cljs.core.rest(G__47325));
if((G__47325__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__47325__$1);
}
})();
var G__47326 = m;
var G__47326__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__47326,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__47322_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__47322_SHARP_)));
})):G__47326);
var G__47326__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__47326__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__47323_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__47323_SHARP_)));
})):G__47326__$1);
var G__47326__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__47326__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__47324_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__47324_SHARP_));
})):G__47326__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__47326__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__47327 = (function (){var G__47328 = form;
var G__47328__$1 = (((G__47328 == null))?null:cljs.core.rest(G__47328));
if((G__47328__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__47328__$1);
}
})();
...
var G__47330 = (((kw instanceof cljs.core.Symbol))?cljs.core.namespace(kw):false);
switch (G__47330) {
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__47331 = form;
var G__47331__$1 = (((G__47331 == null))?null:cljs.core.seq(G__47331));
var G__47331__$2 = (((G__47331__$1 == null))?null:cljs.core.first(G__47331__$1));
if((G__47331__$2 == null)){
return null;
} else {
var fexpr__47332 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__47332.cljs$core$IFn$_invoke$arity$1 ? fexpr__47332.cljs$core$IFn$_invoke$arity$1(G__47331__$2) : fexpr__47332.call(null,G__47331__$2));
}
})():null));
});
/**
...
var len__4789__auto___47349 = arguments.length;
var i__4790__auto___47350 = (0);
while(true){
if((i__4790__auto___47350 < len__4789__auto___47349)){
args__4795__auto__.push((arguments[i__4790__auto___47350]));

var G__47353 = (i__4790__auto___47350 + (1));
i__4790__auto___47350 = G__47353;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq47333){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq47333));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__47334){
var vec__47335 = p__47334;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47335,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47335,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__47340){
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47341__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47341__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47341__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47341__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__47338_SHARP_){
return cljs.core.map_QMARK_(p1__47338_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__47339_SHARP_){
return cljs.core.contains_QMARK_(p1__47339_SHARP_,x);
});
}),req_keys));
