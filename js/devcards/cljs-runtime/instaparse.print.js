...
if(cljs.core.truth_(((cljs.core.not(hidden_QMARK_))?(function (){var G__41943 = (function (){var G__41944 = new cljs.core.Keyword(null,"tag","tag",-1290361223);
return (parser.cljs$core$IFn$_invoke$arity$1 ? parser.cljs$core$IFn$_invoke$arity$1(G__41944) : parser.call(null,G__41944));
})();
return (tag_set.cljs$core$IFn$_invoke$arity$1 ? tag_set.cljs$core$IFn$_invoke$arity$1(G__41943) : tag_set.call(null,G__41943));
})():false))){
...
instaparse.print.char_range__GT_str = (function instaparse$print$char_range__GT_str(p__41947){
...
var lo = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41948__$1,new cljs.core.Keyword(null,"lo","lo",-931799889));
var hi = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41948__$1,new cljs.core.Keyword(null,"hi","hi",-1821422114));
...
(instaparse.print.combinators__GT_str.cljs$core$IFn$_invoke$arity$2 = (function (p__41959,hidden_QMARK_){
var map__41960 = p__41959;
var map__41960__$1 = (((((!((map__41960 == null))))?(((((map__41960.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__41960.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__41960):map__41960);
var p = map__41960__$1;
var parser = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41960__$1,new cljs.core.Keyword(null,"parser","parser",-1543495310));
var parser1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41960__$1,new cljs.core.Keyword(null,"parser1","parser1",-439601422));
var parser2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41960__$1,new cljs.core.Keyword(null,"parser2","parser2",1013754688));
var parsers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41960__$1,new cljs.core.Keyword(null,"parsers","parsers",-804353827));
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41960__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
...
var _STAR_print_newline_STAR__orig_val__41966_42013 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__41967_42014 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__41968_42015 = true;
var _STAR_print_fn_STAR__temp_val__41969_42016 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__41968_42015);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__41969_42016);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__41967_42014);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__41966_42013);
}
...
case "string-ci":
var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__41970_42017 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__41971_42018 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__41972_42019 = true;
var _STAR_print_fn_STAR__temp_val__41973_42020 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__41972_42019);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__41973_42020);

try{cljs.core.pr.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"string","string",-1989541586).cljs$core$IFn$_invoke$arity$1(p)], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__41971_42018);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__41970_42017);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__41962__$1)].join('')));
 ...
 */
instaparse.print.Parser__GT_str = (function instaparse$print$Parser__GT_str(p__41974){
...
var grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41975__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41975__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.cons(instaparse.print.rule__GT_str(start,(grammar.cljs$core$IFn$_invoke$arity$1 ? grammar.cljs$core$IFn$_invoke$arity$1(start) : grammar.call(null,start))),(function (){var iter__4582__auto__ = (function instaparse$print$Parser__GT_str_$_iter__41977(s__41978){
return (new cljs.core.LazySeq(null,(function (){
var s__41978__$1 = s__41978;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__41978__$1);
if(temp__5735__auto__){
var s__41978__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__41978__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__41978__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__41980 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__41979 = (0);
while(true){
if((i__41979 < size__4581__auto__)){
var vec__41981 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__41979);
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41981,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41981,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
cljs.core.chunk_append(b__41980,instaparse.print.rule__GT_str(non_terminal,parser));

var G__42050 = (i__41979 + (1));
i__41979 = G__42050;
continue;
} else {
var G__42051 = (i__41979 + (1));
i__41979 = G__42051;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__41980),instaparse$print$Parser__GT_str_$_iter__41977(cljs.core.chunk_rest(s__41978__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__41980),null);
}
} else {
var vec__41984 = cljs.core.first(s__41978__$2);
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41984,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41984,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
return cljs.core.cons(instaparse.print.rule__GT_str(non_terminal,parser),instaparse$print$Parser__GT_str_$_iter__41977(cljs.core.rest(s__41978__$2)));
} else {
var G__42056 = cljs.core.rest(s__41978__$2);
s__41978__$1 = G__42056;
continue;
}
}
} else {
