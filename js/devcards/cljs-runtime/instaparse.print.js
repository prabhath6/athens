...
if(cljs.core.truth_(((cljs.core.not(hidden_QMARK_))?(function (){var G__55857 = (function (){var G__55858 = new cljs.core.Keyword(null,"tag","tag",-1290361223);
return (parser.cljs$core$IFn$_invoke$arity$1 ? parser.cljs$core$IFn$_invoke$arity$1(G__55858) : parser.call(null,G__55858));
})();
return (tag_set.cljs$core$IFn$_invoke$arity$1 ? tag_set.cljs$core$IFn$_invoke$arity$1(G__55857) : tag_set.call(null,G__55857));
})():false))){
...
instaparse.print.char_range__GT_str = (function instaparse$print$char_range__GT_str(p__55860){
...
var lo = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55861__$1,new cljs.core.Keyword(null,"lo","lo",-931799889));
var hi = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55861__$1,new cljs.core.Keyword(null,"hi","hi",-1821422114));
...
(instaparse.print.combinators__GT_str.cljs$core$IFn$_invoke$arity$2 = (function (p__55865,hidden_QMARK_){
...
var p = map__55866__$1;
var parser = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55866__$1,new cljs.core.Keyword(null,"parser","parser",-1543495310));
var parser1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55866__$1,new cljs.core.Keyword(null,"parser1","parser1",-439601422));
var parser2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55866__$1,new cljs.core.Keyword(null,"parser2","parser2",1013754688));
var parsers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55866__$1,new cljs.core.Keyword(null,"parsers","parsers",-804353827));
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55866__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
...
var _STAR_print_newline_STAR__orig_val__55869_55893 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__55870_55894 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__55871_55895 = true;
var _STAR_print_fn_STAR__temp_val__55872_55896 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__55871_55895);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__55872_55896);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__55870_55894);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__55869_55893);
}
...
case "string-ci":
var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__55873_55897 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__55874_55898 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__55875_55899 = true;
var _STAR_print_fn_STAR__temp_val__55876_55900 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__55875_55899);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__55876_55900);

try{cljs.core.pr.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"string","string",-1989541586).cljs$core$IFn$_invoke$arity$1(p)], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__55874_55898);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__55873_55897);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
 ...
 */
instaparse.print.Parser__GT_str = (function instaparse$print$Parser__GT_str(p__55877){
...
var grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55878__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55878__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.cons(instaparse.print.rule__GT_str(start,(grammar.cljs$core$IFn$_invoke$arity$1 ? grammar.cljs$core$IFn$_invoke$arity$1(start) : grammar.call(null,start))),(function (){var iter__4582__auto__ = (function instaparse$print$Parser__GT_str_$_iter__55880(s__55881){
return (new cljs.core.LazySeq(null,(function (){
var s__55881__$1 = s__55881;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__55881__$1);
if(temp__5735__auto__){
var s__55881__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__55881__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__55881__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__55883 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__55882 = (0);
while(true){
if((i__55882 < size__4581__auto__)){
var vec__55884 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__55882);
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55884,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55884,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
cljs.core.chunk_append(b__55883,instaparse.print.rule__GT_str(non_terminal,parser));

var G__55901 = (i__55882 + (1));
i__55882 = G__55901;
continue;
} else {
var G__55902 = (i__55882 + (1));
i__55882 = G__55902;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__55883),instaparse$print$Parser__GT_str_$_iter__55880(cljs.core.chunk_rest(s__55881__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__55883),null);
}
} else {
var vec__55887 = cljs.core.first(s__55881__$2);
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55887,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55887,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
return cljs.core.cons(instaparse.print.rule__GT_str(non_terminal,parser),instaparse$print$Parser__GT_str_$_iter__55880(cljs.core.rest(s__55881__$2)));
} else {
var G__55903 = cljs.core.rest(s__55881__$2);
s__55881__$1 = G__55903;
continue;
}
}
} else {
