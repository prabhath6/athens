...
if(cljs.core.truth_(((cljs.core.not(hidden_QMARK_))?(function (){var G__55768 = (function (){var G__55769 = new cljs.core.Keyword(null,"tag","tag",-1290361223);
return (parser.cljs$core$IFn$_invoke$arity$1 ? parser.cljs$core$IFn$_invoke$arity$1(G__55769) : parser.call(null,G__55769));
})();
return (tag_set.cljs$core$IFn$_invoke$arity$1 ? tag_set.cljs$core$IFn$_invoke$arity$1(G__55768) : tag_set.call(null,G__55768));
})():false))){
...
instaparse.print.char_range__GT_str = (function instaparse$print$char_range__GT_str(p__55771){
...
var lo = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55772__$1,new cljs.core.Keyword(null,"lo","lo",-931799889));
var hi = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55772__$1,new cljs.core.Keyword(null,"hi","hi",-1821422114));
...
(instaparse.print.combinators__GT_str.cljs$core$IFn$_invoke$arity$2 = (function (p__55776,hidden_QMARK_){
...
var p = map__55777__$1;
var parser = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55777__$1,new cljs.core.Keyword(null,"parser","parser",-1543495310));
var parser1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55777__$1,new cljs.core.Keyword(null,"parser1","parser1",-439601422));
var parser2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55777__$1,new cljs.core.Keyword(null,"parser2","parser2",1013754688));
var parsers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55777__$1,new cljs.core.Keyword(null,"parsers","parsers",-804353827));
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55777__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
...
var _STAR_print_newline_STAR__orig_val__55780_55807 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__55781_55808 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__55782_55809 = true;
var _STAR_print_fn_STAR__temp_val__55783_55810 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__55782_55809);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__55783_55810);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__55781_55808);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__55780_55807);
}
...
case "string-ci":
var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__55784_55815 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__55785_55816 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__55786_55817 = true;
var _STAR_print_fn_STAR__temp_val__55787_55818 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__55786_55817);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__55787_55818);

try{cljs.core.pr.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"string","string",-1989541586).cljs$core$IFn$_invoke$arity$1(p)], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__55785_55816);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__55784_55815);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__55779__$1)].join('')));
 ...
 */
instaparse.print.Parser__GT_str = (function instaparse$print$Parser__GT_str(p__55788){
var map__55789 = p__55788;
...
var grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55789__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55789__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.cons(instaparse.print.rule__GT_str(start,(grammar.cljs$core$IFn$_invoke$arity$1 ? grammar.cljs$core$IFn$_invoke$arity$1(start) : grammar.call(null,start))),(function (){var iter__4582__auto__ = (function instaparse$print$Parser__GT_str_$_iter__55791(s__55792){
return (new cljs.core.LazySeq(null,(function (){
var s__55792__$1 = s__55792;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__55792__$1);
if(temp__5735__auto__){
var s__55792__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__55792__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__55792__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__55794 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__55793 = (0);
while(true){
if((i__55793 < size__4581__auto__)){
var vec__55795 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__55793);
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55795,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55795,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
cljs.core.chunk_append(b__55794,instaparse.print.rule__GT_str(non_terminal,parser));

var G__55823 = (i__55793 + (1));
i__55793 = G__55823;
continue;
} else {
var G__55824 = (i__55793 + (1));
i__55793 = G__55824;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__55794),instaparse$print$Parser__GT_str_$_iter__55791(cljs.core.chunk_rest(s__55792__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__55794),null);
}
} else {
var vec__55798 = cljs.core.first(s__55792__$2);
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55798,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55798,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
return cljs.core.cons(instaparse.print.rule__GT_str(non_terminal,parser),instaparse$print$Parser__GT_str_$_iter__55791(cljs.core.rest(s__55792__$2)));
} else {
var G__55831 = cljs.core.rest(s__55792__$2);
s__55792__$1 = G__55831;
continue;
}
}
} else {
