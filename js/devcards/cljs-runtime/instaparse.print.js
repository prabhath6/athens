...
if(cljs.core.truth_(((cljs.core.not(hidden_QMARK_))?(function (){var G__50934 = (function (){var G__50935 = new cljs.core.Keyword(null,"tag","tag",-1290361223);
return (parser.cljs$core$IFn$_invoke$arity$1 ? parser.cljs$core$IFn$_invoke$arity$1(G__50935) : parser.call(null,G__50935));
})();
return (tag_set.cljs$core$IFn$_invoke$arity$1 ? tag_set.cljs$core$IFn$_invoke$arity$1(G__50934) : tag_set.call(null,G__50934));
})():false))){
...
instaparse.print.char_range__GT_str = (function instaparse$print$char_range__GT_str(p__50937){
var map__50938 = p__50937;
var map__50938__$1 = (((((!((map__50938 == null))))?(((((map__50938.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__50938.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__50938):map__50938);
var lo = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50938__$1,new cljs.core.Keyword(null,"lo","lo",-931799889));
var hi = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50938__$1,new cljs.core.Keyword(null,"hi","hi",-1821422114));
...
(instaparse.print.combinators__GT_str.cljs$core$IFn$_invoke$arity$2 = (function (p__50942,hidden_QMARK_){
...
var p = map__50943__$1;
var parser = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50943__$1,new cljs.core.Keyword(null,"parser","parser",-1543495310));
var parser1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50943__$1,new cljs.core.Keyword(null,"parser1","parser1",-439601422));
var parser2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50943__$1,new cljs.core.Keyword(null,"parser2","parser2",1013754688));
var parsers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50943__$1,new cljs.core.Keyword(null,"parsers","parsers",-804353827));
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50943__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
...
var _STAR_print_newline_STAR__orig_val__50949_51032 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__50950_51033 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__50951_51034 = true;
var _STAR_print_fn_STAR__temp_val__50952_51035 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__50951_51034);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__50952_51035);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__50950_51033);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__50949_51032);
}
...
case "string-ci":
var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__50955_51040 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__50956_51041 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__50957_51042 = true;
var _STAR_print_fn_STAR__temp_val__50958_51043 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__50957_51042);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__50958_51043);

try{cljs.core.pr.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"string","string",-1989541586).cljs$core$IFn$_invoke$arity$1(p)], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__50956_51041);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__50955_51040);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
 ...
 */
instaparse.print.Parser__GT_str = (function instaparse$print$Parser__GT_str(p__50962){
...
var grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50963__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50963__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.cons(instaparse.print.rule__GT_str(start,(grammar.cljs$core$IFn$_invoke$arity$1 ? grammar.cljs$core$IFn$_invoke$arity$1(start) : grammar.call(null,start))),(function (){var iter__4582__auto__ = (function instaparse$print$Parser__GT_str_$_iter__50965(s__50966){
return (new cljs.core.LazySeq(null,(function (){
var s__50966__$1 = s__50966;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__50966__$1);
if(temp__5735__auto__){
var s__50966__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__50966__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__50966__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__50968 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__50967 = (0);
while(true){
if((i__50967 < size__4581__auto__)){
var vec__50969 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__50967);
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50969,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50969,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
cljs.core.chunk_append(b__50968,instaparse.print.rule__GT_str(non_terminal,parser));

var G__51065 = (i__50967 + (1));
i__50967 = G__51065;
continue;
} else {
var G__51066 = (i__50967 + (1));
i__50967 = G__51066;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__50968),instaparse$print$Parser__GT_str_$_iter__50965(cljs.core.chunk_rest(s__50966__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__50968),null);
}
} else {
var vec__50972 = cljs.core.first(s__50966__$2);
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50972,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50972,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
return cljs.core.cons(instaparse.print.rule__GT_str(non_terminal,parser),instaparse$print$Parser__GT_str_$_iter__50965(cljs.core.rest(s__50966__$2)));
} else {
var G__51070 = cljs.core.rest(s__50966__$2);
s__50966__$1 = G__51070;
continue;
}
}
} else {
