...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__34461,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__34461;
}
});
...
var len__4789__auto___34544 = arguments.length;
var i__4790__auto___34545 = (0);
while(true){
if((i__4790__auto___34545 < len__4789__auto___34544)){
args__4795__auto__.push((arguments[i__4790__auto___34545]));

var G__34553 = (i__4790__auto___34545 + (1));
i__4790__auto___34545 = G__34553;
continue;
} else {
}
break;
...
var vec__34488 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__34493 = cljs.core.ffirst(matches);
var fexpr__34492 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__34492.cljs$core$IFn$_invoke$arity$1 ? fexpr__34492.cljs$core$IFn$_invoke$arity$1(G__34493) : fexpr__34492.call(null,G__34493));
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__34486_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__34486_SHARP_))){
return p1__34486_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__34487_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__34487_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__34519){
...
var tag = first__34522;
var content = seq__34521__$1;
...
var vec__34524 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34524,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34524,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34524,(2),null);
