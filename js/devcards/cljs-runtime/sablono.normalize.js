...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__34535){
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__34545_SHARP_){
return (((p1__34545_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__34545_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__34553,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__34553;
}
});
...
var len__4789__auto___34641 = arguments.length;
var i__4790__auto___34642 = (0);
while(true){
if((i__4790__auto___34642 < len__4789__auto___34641)){
args__4795__auto__.push((arguments[i__4790__auto___34642]));

var G__34643 = (i__4790__auto___34642 + (1));
i__4790__auto___34642 = G__34643;
continue;
} else {
}
break;
...
var G__34589 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__34589,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__34589;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq34558){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq34558));
}));
...
var vec__34601 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__34607 = cljs.core.ffirst(matches);
var fexpr__34606 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__34606.cljs$core$IFn$_invoke$arity$1 ? fexpr__34606.cljs$core$IFn$_invoke$arity$1(G__34607) : fexpr__34606.call(null,G__34607));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34601,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34601,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__34598_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__34598_SHARP_))){
return p1__34598_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__34599_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__34599_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__34622){
...
var tag = first__34626;
var content = seq__34625__$1;
...
var vec__34629 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34629,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34629,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34629,(2),null);
