...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__34461_SHARP_){
return (((p1__34461_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__34461_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__34469,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__34469;
}
});
...
var len__4789__auto___34558 = arguments.length;
var i__4790__auto___34559 = (0);
while(true){
if((i__4790__auto___34559 < len__4789__auto___34558)){
args__4795__auto__.push((arguments[i__4790__auto___34559]));

var G__34560 = (i__4790__auto___34559 + (1));
i__4790__auto___34559 = G__34560;
continue;
} else {
}
break;
...
var vec__34495 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__34500 = cljs.core.ffirst(matches);
var fexpr__34499 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__34499.cljs$core$IFn$_invoke$arity$1 ? fexpr__34499.cljs$core$IFn$_invoke$arity$1(G__34500) : fexpr__34499.call(null,G__34500));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34495,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34495,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__34492_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__34492_SHARP_))){
return p1__34492_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__34493_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__34493_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__34524){
...
var tag = first__34527;
var content = seq__34526__$1;
...
var vec__34531 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34531,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34531,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34531,(2),null);
