...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__34425){
var vec__34426 = p__34425;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34426,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34426,(1),null);
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__34432_SHARP_){
return (((p1__34432_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__34432_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__34438,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__34438;
}
});
...
var G__34504 = (i__4790__auto___34503 + (1));
i__4790__auto___34503 = G__34504;
continue;
} else {
}
break;
...
var G__34446 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__34446,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__34446;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq34441){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq34441));
}));
...
var vec__34454 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__34458 = cljs.core.ffirst(matches);
var fexpr__34457 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__34457.cljs$core$IFn$_invoke$arity$1 ? fexpr__34457.cljs$core$IFn$_invoke$arity$1(G__34458) : fexpr__34457.call(null,G__34458));
...
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34454,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__34451_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__34451_SHARP_))){
return p1__34451_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__34452_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__34452_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__34472){
var vec__34473 = p__34472;
var seq__34474 = cljs.core.seq(vec__34473);
var first__34475 = cljs.core.first(seq__34474);
var seq__34474__$1 = cljs.core.next(seq__34474);
var tag = first__34475;
var content = seq__34474__$1;
...
var vec__34478 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34478,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34478,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34478,(2),null);
