...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__34463){
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__34485_SHARP_){
return (((p1__34485_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__34485_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__34496,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__34496;
}
});
...
var len__4789__auto___34622 = arguments.length;
var i__4790__auto___34623 = (0);
while(true){
if((i__4790__auto___34623 < len__4789__auto___34622)){
args__4795__auto__.push((arguments[i__4790__auto___34623]));

var G__34624 = (i__4790__auto___34623 + (1));
i__4790__auto___34623 = G__34624;
continue;
} else {
}
break;
...
var G__34510 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__34510,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__34510;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq34508){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq34508));
}));
...
var vec__34522 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__34527 = cljs.core.ffirst(matches);
var fexpr__34526 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__34526.cljs$core$IFn$_invoke$arity$1 ? fexpr__34526.cljs$core$IFn$_invoke$arity$1(G__34527) : fexpr__34526.call(null,G__34527));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34522,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34522,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__34519_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__34519_SHARP_))){
return p1__34519_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__34520_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__34520_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__34561){
var vec__34563 = p__34561;
var seq__34564 = cljs.core.seq(vec__34563);
var first__34565 = cljs.core.first(seq__34564);
var seq__34564__$1 = cljs.core.next(seq__34564);
var tag = first__34565;
var content = seq__34564__$1;
...
var vec__34568 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34568,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34568,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34568,(2),null);
