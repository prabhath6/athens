...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__34438){
var vec__34440 = p__34438;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34440,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34440,(1),null);
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__34447_SHARP_){
return (((p1__34447_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__34447_SHARP_ === 'string'));
}),class$)))){
...
while(true){
if((i__4790__auto___34534 < len__4789__auto___34532)){
args__4795__auto__.push((arguments[i__4790__auto___34534]));

var G__34536 = (i__4790__auto___34534 + (1));
i__4790__auto___34534 = G__34536;
continue;
} else {
}
break;
...
var G__34462 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__34462,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__34462;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq34460){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq34460));
}));
...
var vec__34473 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__34477 = cljs.core.ffirst(matches);
var fexpr__34476 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34473,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34473,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__34467_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__34467_SHARP_))){
return p1__34467_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__34468_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__34468_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__34501){
var vec__34503 = p__34501;
...
var tag = first__34505;
var content = seq__34504__$1;
...
var vec__34508 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34508,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34508,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34508,(2),null);
