...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__34437){
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__34441_SHARP_){
return (((p1__34441_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__34441_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__34453,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__34453;
}
});
...
var G__34538 = (i__4790__auto___34536 + (1));
i__4790__auto___34536 = G__34538;
continue;
} else {
}
break;
...
var G__34460 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__34460,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__34460;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq34457){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq34457));
}));
...
var vec__34481 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__34485 = cljs.core.ffirst(matches);
var fexpr__34484 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__34484.cljs$core$IFn$_invoke$arity$1 ? fexpr__34484.cljs$core$IFn$_invoke$arity$1(G__34485) : fexpr__34484.call(null,G__34485));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34481,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34481,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__34469_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__34469_SHARP_))){
return p1__34469_SHARP_;
} else {
return null;
}
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__34511){
var vec__34512 = p__34511;
var seq__34513 = cljs.core.seq(vec__34512);
var first__34514 = cljs.core.first(seq__34513);
var seq__34513__$1 = cljs.core.next(seq__34513);
var tag = first__34514;
var content = seq__34513__$1;
...
var vec__34516 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34516,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34516,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34516,(2),null);
