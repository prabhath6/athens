...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__37106){
var vec__37107 = p__37106;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37107,(0),null);
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__37110_SHARP_){
return (((p1__37110_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__37110_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__37114,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__37114;
}
});
...
var len__4789__auto___37144 = arguments.length;
var i__4790__auto___37145 = (0);
while(true){
if((i__4790__auto___37145 < len__4789__auto___37144)){
args__4795__auto__.push((arguments[i__4790__auto___37145]));

var G__37146 = (i__4790__auto___37145 + (1));
i__4790__auto___37145 = G__37146;
continue;
} else {
}
break;
...
var G__37119 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37119,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__37119;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq37115){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq37115));
}));
...
var vec__37122 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__37126 = cljs.core.ffirst(matches);
var fexpr__37125 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__37125.cljs$core$IFn$_invoke$arity$1 ? fexpr__37125.cljs$core$IFn$_invoke$arity$1(G__37126) : fexpr__37125.call(null,G__37126));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37122,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37122,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__37120_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__37120_SHARP_))){
return p1__37120_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__37121_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__37121_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__37132){
...
var tag = first__37135;
var content = seq__37134__$1;
...
var vec__37136 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37136,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37136,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37136,(2),null);
