...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__39095){
var vec__39096 = p__39095;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39096,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39096,(1),null);
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__39101_SHARP_){
return (((p1__39101_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__39101_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__39106,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__39106;
}
});
...
var len__4789__auto___39137 = arguments.length;
var i__4790__auto___39138 = (0);
while(true){
if((i__4790__auto___39138 < len__4789__auto___39137)){
args__4795__auto__.push((arguments[i__4790__auto___39138]));

var G__39139 = (i__4790__auto___39138 + (1));
i__4790__auto___39138 = G__39139;
continue;
} else {
}
break;
...
var G__39111 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39111,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__39111;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq39109){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq39109));
}));
...
var vec__39114 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__39118 = cljs.core.ffirst(matches);
var fexpr__39117 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__39117.cljs$core$IFn$_invoke$arity$1 ? fexpr__39117.cljs$core$IFn$_invoke$arity$1(G__39118) : fexpr__39117.call(null,G__39118));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39114,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39114,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__39112_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__39112_SHARP_))){
return p1__39112_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__39113_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__39113_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__39125){
var vec__39127 = p__39125;
var seq__39128 = cljs.core.seq(vec__39127);
var first__39129 = cljs.core.first(seq__39128);
var seq__39128__$1 = cljs.core.next(seq__39128);
var tag = first__39129;
var content = seq__39128__$1;
...
var vec__39131 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39131,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39131,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39131,(2),null);
