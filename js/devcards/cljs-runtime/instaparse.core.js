...
if(cljs.core.truth_((function (){var fexpr__57475 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__57475.cljs$core$IFn$_invoke$arity$1 ? fexpr__57475.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57475.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__57477 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__57477.cljs$core$IFn$_invoke$arity$1 ? fexpr__57477.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57477.call(null,type));
})())){
} else {
...
var G__57478 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__57478)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__57478)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__57478)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__57478)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57478)].join('')));
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57485){
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57488 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__57488) : instaparse.reduction.node_builders.call(null,G__57488));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq57481){
var G__57482 = cljs.core.first(seq57481);
var seq57481__$1 = cljs.core.next(seq57481);
var G__57483 = cljs.core.first(seq57481__$1);
var seq57481__$2 = cljs.core.next(seq57481__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57482,G__57483,seq57481__$2);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___57577 = arguments.length;
var i__4790__auto___57578 = (0);
while(true){
if((i__4790__auto___57578 < len__4789__auto___57577)){
args__4795__auto__.push((arguments[i__4790__auto___57578]));

var G__57580 = (i__4790__auto___57578 + (1));
i__4790__auto___57578 = G__57580;
continue;
} else {
}
break;
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57507){
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57511 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq57498){
var G__57499 = cljs.core.first(seq57498);
var seq57498__$1 = cljs.core.next(seq57498);
var G__57500 = cljs.core.first(seq57498__$1);
var seq57498__$2 = cljs.core.next(seq57498__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57499,G__57500,seq57498__$2);
}));
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k57518,else__4442__auto__){
var self__ = this;
var this__4441__auto____$1 = this;
var G__57528 = k57518;
var G__57528__$1 = (((G__57528 instanceof cljs.core.Keyword))?G__57528.fqn:null);
switch (G__57528__$1) {
case "grammar":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k57518,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__57532){
var vec__57533 = p__57532;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57533,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57533,(1),null);
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this57519,other57520){
var self__ = this;
var this57519__$1 = this;
return (((!((other57520 == null)))) && ((this57519__$1.constructor === other57520.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57519__$1.grammar,other57520.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57519__$1.start_production,other57520.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57519__$1.output_format,other57520.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57519__$1.__extmap,other57520.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__57517){
var self__ = this;
...
return (new instaparse.core.Parser(G__57517,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
...
return (new instaparse.core.Parser(self__.grammar,G__57517,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
...
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__57517,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__57517),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__57517){
var self__ = this;
var this__4438__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__57517,self__.__extmap,self__.__hash));
}));
...
(instaparse.core.Parser.prototype.apply = (function (self__,args57525){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args57525)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__57521){
var extmap__4478__auto__ = (function (){var G__57555 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__57521,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
...
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__57521),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__57521),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__57521),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var args__4795__auto__ = [];
var len__4789__auto___57678 = arguments.length;
var i__4790__auto___57682 = (0);
while(true){
if((i__4790__auto___57682 < len__4789__auto___57678)){
args__4795__auto__.push((arguments[i__4790__auto___57682]));

var G__57683 = (i__4790__auto___57682 + (1));
i__4790__auto___57682 = G__57683;
continue;
} else {
}
break;
