...
if(cljs.core.truth_((function (){var fexpr__57504 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__57504.cljs$core$IFn$_invoke$arity$1 ? fexpr__57504.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57504.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__57505 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__57505.cljs$core$IFn$_invoke$arity$1 ? fexpr__57505.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57505.call(null,type));
})())){
} else {
...
var G__57511 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__57511)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__57511)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__57511)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__57511)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57511)].join('')));
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57520){
var map__57522 = p__57520;
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57530 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__57530) : instaparse.reduction.node_builders.call(null,G__57530));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq57514){
var G__57515 = cljs.core.first(seq57514);
var seq57514__$1 = cljs.core.next(seq57514);
var G__57516 = cljs.core.first(seq57514__$1);
var seq57514__$2 = cljs.core.next(seq57514__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57515,G__57516,seq57514__$2);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___57580 = arguments.length;
var i__4790__auto___57581 = (0);
while(true){
if((i__4790__auto___57581 < len__4789__auto___57580)){
args__4795__auto__.push((arguments[i__4790__auto___57581]));

var G__57582 = (i__4790__auto___57581 + (1));
i__4790__auto___57581 = G__57582;
continue;
} else {
}
break;
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57538){
var map__57539 = p__57538;
var map__57539__$1 = (((((!((map__57539 == null))))?(((((map__57539.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__57539.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__57539):map__57539);
var options = map__57539__$1;
if(cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, [null,null,new cljs.core.Keyword(null,"tags","tags",1771418977),null,new cljs.core.Keyword(null,"content","content",15833224),null,new cljs.core.Keyword(null,"all","all",892129742),null], null), null),cljs.core.get.cljs$core$IFn$_invoke$arity$2(options,new cljs.core.Keyword(null,"unhide","unhide",-413983695)))){
} else {
throw (new Error("Assert failed: (contains? #{nil :tags :content :all} (get options :unhide))"));
}
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57541 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__57541) : instaparse.reduction.node_builders.call(null,G__57541));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq57535){
var G__57536 = cljs.core.first(seq57535);
var seq57535__$1 = cljs.core.next(seq57535);
var G__57537 = cljs.core.first(seq57535__$1);
var seq57535__$2 = cljs.core.next(seq57535__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57536,G__57537,seq57535__$2);
}));
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k57543,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k57543,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__57549){
var vec__57550 = p__57549;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57550,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57550,(1),null);
...
var h__4297__auto____$1 = (function (){var fexpr__57553 = (function (coll__4436__auto__){
return (-360509877 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__57553(this__4435__auto____$1);
})();
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this57544,other57545){
var self__ = this;
var this57544__$1 = this;
return (((!((other57545 == null)))) && ((this57544__$1.constructor === other57545.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57544__$1.grammar,other57545.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57544__$1.start_production,other57545.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57544__$1.output_format,other57545.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57544__$1.__extmap,other57545.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__57542){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__57554 = cljs.core.keyword_identical_QMARK_;
var expr__57555 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__57557 = new cljs.core.Keyword(null,"grammar","grammar",1881328267);
var G__57558 = expr__57555;
return (pred__57554.cljs$core$IFn$_invoke$arity$2 ? pred__57554.cljs$core$IFn$_invoke$arity$2(G__57557,G__57558) : pred__57554.call(null,G__57557,G__57558));
})())){
return (new instaparse.core.Parser(G__57542,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__57559 = new cljs.core.Keyword(null,"start-production","start-production",687546537);
var G__57560 = expr__57555;
return (pred__57554.cljs$core$IFn$_invoke$arity$2 ? pred__57554.cljs$core$IFn$_invoke$arity$2(G__57559,G__57560) : pred__57554.call(null,G__57559,G__57560));
})())){
return (new instaparse.core.Parser(self__.grammar,G__57542,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__57561 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676);
var G__57562 = expr__57555;
return (pred__57554.cljs$core$IFn$_invoke$arity$2 ? pred__57554.cljs$core$IFn$_invoke$arity$2(G__57561,G__57562) : pred__57554.call(null,G__57561,G__57562));
})())){
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__57542,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__57542),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__57542){
var self__ = this;
var this__4438__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__57542,self__.__extmap,self__.__hash));
}));
...
var self__ = this;
var self__ = this;
var G__57563 = (arguments.length - (1));
switch (G__57563) {
case (1):
...
(instaparse.core.Parser.prototype.apply = (function (self__,args57547){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args57547)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__57546){
var extmap__4478__auto__ = (function (){var G__57564 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__57546,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__57546)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__57564);
} else {
return G__57564;
}
})();
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__57546),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__57546),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__57546),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var G__57642 = (i__4790__auto___57640 + (1));
i__4790__auto___57640 = G__57642;
continue;
} else {
}
break;
...
(instaparse.core.parser.cljs$core$IFn$_invoke$arity$variadic = (function (grammar_specification,p__57567){
var map__57568 = p__57567;
var map__57568__$1 = (((((!((map__57568 == null))))?(((((map__57568.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__57568.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__57568):map__57568);
var options = map__57568__$1;
...
var _STAR_case_insensitive_literals_STAR__orig_val__57570 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__57571 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(options,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__57571);

try{var G__57572 = input_format;
var G__57572__$1 = (((G__57572 instanceof cljs.core.Keyword))?G__57572.fqn:null);
switch (G__57572__$1) {
case "abnf":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57572__$1)].join('')));

}
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__57570);
}});
...
var map__57573 = temp__5733__auto__;
...
var ws_grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57573__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var ws_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57573__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
...
/** @this {Function} */
(instaparse.core.parser.cljs$lang$applyTo = (function (seq57565){
var G__57566 = cljs.core.first(seq57565);
var seq57565__$1 = cljs.core.next(seq57565);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57566,seq57565__$1);
}));
