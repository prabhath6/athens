...
if(cljs.core.truth_((function (){var fexpr__57604 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__57604.cljs$core$IFn$_invoke$arity$1 ? fexpr__57604.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57604.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__57605 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__57605.cljs$core$IFn$_invoke$arity$1 ? fexpr__57605.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57605.call(null,type));
})())){
} else {
...
var G__57606 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__57606)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__57606)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__57606)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__57606)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57606)].join('')));
...
var len__4789__auto___57654 = arguments.length;
var i__4790__auto___57655 = (0);
while(true){
if((i__4790__auto___57655 < len__4789__auto___57654)){
args__4795__auto__.push((arguments[i__4790__auto___57655]));

var G__57656 = (i__4790__auto___57655 + (1));
i__4790__auto___57655 = G__57656;
continue;
} else {
}
break;
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57610){
var map__57611 = p__57610;
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57613 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__57613) : instaparse.reduction.node_builders.call(null,G__57613));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq57607){
var G__57608 = cljs.core.first(seq57607);
var seq57607__$1 = cljs.core.next(seq57607);
var G__57609 = cljs.core.first(seq57607__$1);
var seq57607__$2 = cljs.core.next(seq57607__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57608,G__57609,seq57607__$2);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___57657 = arguments.length;
var i__4790__auto___57658 = (0);
while(true){
if((i__4790__auto___57658 < len__4789__auto___57657)){
args__4795__auto__.push((arguments[i__4790__auto___57658]));

var G__57659 = (i__4790__auto___57658 + (1));
i__4790__auto___57658 = G__57659;
continue;
} else {
}
break;
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57617){
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57620 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__57620) : instaparse.reduction.node_builders.call(null,G__57620));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq57614){
var G__57615 = cljs.core.first(seq57614);
var seq57614__$1 = cljs.core.next(seq57614);
var G__57616 = cljs.core.first(seq57614__$1);
var seq57614__$2 = cljs.core.next(seq57614__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57615,G__57616,seq57614__$2);
}));
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k57622,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k57622,else__4442__auto__);
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this57623,other57624){
var self__ = this;
var this57623__$1 = this;
return (((!((other57624 == null)))) && ((this57623__$1.constructor === other57624.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57623__$1.grammar,other57624.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57623__$1.start_production,other57624.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57623__$1.output_format,other57624.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57623__$1.__extmap,other57624.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__57621){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__57633 = cljs.core.keyword_identical_QMARK_;
var expr__57634 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__57636 = new cljs.core.Keyword(null,"grammar","grammar",1881328267);
...
return (new instaparse.core.Parser(G__57621,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__57638 = new cljs.core.Keyword(null,"start-production","start-production",687546537);
...
return (new instaparse.core.Parser(self__.grammar,G__57621,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__57640 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676);
...
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__57621,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__57621),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__57621){
var self__ = this;
var this__4438__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__57621,self__.__extmap,self__.__hash));
}));
...
var self__ = this;
var self__ = this;
var G__57642 = (arguments.length - (1));
switch (G__57642) {
case (1):
...
(instaparse.core.Parser.prototype.apply = (function (self__,args57626){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args57626)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__57625){
var extmap__4478__auto__ = (function (){var G__57643 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__57625,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__57625)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__57643);
} else {
return G__57643;
}
})();
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__57625),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__57625),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__57625),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var args__4795__auto__ = [];
var len__4789__auto___57698 = arguments.length;
var i__4790__auto___57699 = (0);
while(true){
if((i__4790__auto___57699 < len__4789__auto___57698)){
args__4795__auto__.push((arguments[i__4790__auto___57699]));

var G__57700 = (i__4790__auto___57699 + (1));
i__4790__auto___57699 = G__57700;
continue;
} else {
}
break;
...
(instaparse.core.parser.cljs$core$IFn$_invoke$arity$variadic = (function (grammar_specification,p__57646){
...
var _STAR_case_insensitive_literals_STAR__orig_val__57649 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__57650 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(options,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__57650);

try{var G__57651 = input_format;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57651__$1)].join('')));

}
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__57649);
}});
...
var map__57652 = temp__5733__auto__;
var map__57652__$1 = (((((!((map__57652 == null))))?(((((map__57652.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__57652.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__57652):map__57652);
var ws_grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57652__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var ws_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57652__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
...
/** @this {Function} */
(instaparse.core.parser.cljs$lang$applyTo = (function (seq57644){
var G__57645 = cljs.core.first(seq57644);
var seq57644__$1 = cljs.core.next(seq57644);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57645,seq57644__$1);
}));
