...
if(cljs.core.truth_((function (){var fexpr__57457 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__57457.cljs$core$IFn$_invoke$arity$1 ? fexpr__57457.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57457.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__57458 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__57458.cljs$core$IFn$_invoke$arity$1 ? fexpr__57458.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57458.call(null,type));
})())){
} else {
...
var G__57459 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__57459)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__57459)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__57459)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__57459)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57459)].join('')));
...
var G__57559 = (i__4790__auto___57557 + (1));
i__4790__auto___57557 = G__57559;
continue;
} else {
}
break;
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57463){
var map__57464 = p__57463;
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57466 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__57466) : instaparse.reduction.node_builders.call(null,G__57466));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq57460){
var G__57461 = cljs.core.first(seq57460);
var seq57460__$1 = cljs.core.next(seq57460);
var G__57462 = cljs.core.first(seq57460__$1);
var seq57460__$2 = cljs.core.next(seq57460__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57461,G__57462,seq57460__$2);
}));
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57473){
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57477 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__57477) : instaparse.reduction.node_builders.call(null,G__57477));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq57470){
var G__57471 = cljs.core.first(seq57470);
var seq57470__$1 = cljs.core.next(seq57470);
var G__57472 = cljs.core.first(seq57470__$1);
var seq57470__$2 = cljs.core.next(seq57470__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57471,G__57472,seq57470__$2);
}));
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k57481,else__4442__auto__){
var self__ = this;
var this__4441__auto____$1 = this;
var G__57487 = k57481;
var G__57487__$1 = (((G__57487 instanceof cljs.core.Keyword))?G__57487.fqn:null);
switch (G__57487__$1) {
case "grammar":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k57481,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__57488){
var vec__57489 = p__57488;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57489,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57489,(1),null);
...
var h__4297__auto____$1 = (function (){var fexpr__57502 = (function (coll__4436__auto__){
return (-360509877 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__57502(this__4435__auto____$1);
})();
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this57482,other57483){
var self__ = this;
var this57482__$1 = this;
return (((!((other57483 == null)))) && ((this57482__$1.constructor === other57483.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57482__$1.grammar,other57483.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57482__$1.start_production,other57483.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57482__$1.output_format,other57483.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57482__$1.__extmap,other57483.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__57480){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__57509 = cljs.core.keyword_identical_QMARK_;
var expr__57510 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__57512 = new cljs.core.Keyword(null,"grammar","grammar",1881328267);
var G__57513 = expr__57510;
return (pred__57509.cljs$core$IFn$_invoke$arity$2 ? pred__57509.cljs$core$IFn$_invoke$arity$2(G__57512,G__57513) : pred__57509.call(null,G__57512,G__57513));
})())){
return (new instaparse.core.Parser(G__57480,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__57515 = new cljs.core.Keyword(null,"start-production","start-production",687546537);
var G__57516 = expr__57510;
return (pred__57509.cljs$core$IFn$_invoke$arity$2 ? pred__57509.cljs$core$IFn$_invoke$arity$2(G__57515,G__57516) : pred__57509.call(null,G__57515,G__57516));
})())){
return (new instaparse.core.Parser(self__.grammar,G__57480,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__57517 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676);
var G__57518 = expr__57510;
return (pred__57509.cljs$core$IFn$_invoke$arity$2 ? pred__57509.cljs$core$IFn$_invoke$arity$2(G__57517,G__57518) : pred__57509.call(null,G__57517,G__57518));
})())){
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__57480,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__57480),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__57480){
var self__ = this;
var this__4438__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__57480,self__.__extmap,self__.__hash));
}));
...
var self__ = this;
var self__ = this;
var G__57524 = (arguments.length - (1));
switch (G__57524) {
case (1):
...
(instaparse.core.Parser.prototype.apply = (function (self__,args57485){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args57485)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__57484){
var extmap__4478__auto__ = (function (){var G__57540 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__57484,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__57484)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__57540);
} else {
return G__57540;
}
})();
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__57484),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__57484),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__57484),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var args__4795__auto__ = [];
var len__4789__auto___57666 = arguments.length;
var i__4790__auto___57667 = (0);
while(true){
if((i__4790__auto___57667 < len__4789__auto___57666)){
args__4795__auto__.push((arguments[i__4790__auto___57667]));

var G__57671 = (i__4790__auto___57667 + (1));
i__4790__auto___57667 = G__57671;
continue;
} else {
}
break;
