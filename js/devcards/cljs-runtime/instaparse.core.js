...
if(cljs.core.truth_((function (){var fexpr__57472 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__57472.cljs$core$IFn$_invoke$arity$1 ? fexpr__57472.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57472.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__57473 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__57473.cljs$core$IFn$_invoke$arity$1 ? fexpr__57473.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57473.call(null,type));
})())){
} else {
...
var G__57474 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__57474)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__57474)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__57474)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__57474)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57474)].join('')));
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57478){
var map__57479 = p__57478;
var map__57479__$1 = (((((!((map__57479 == null))))?(((((map__57479.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__57479.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__57479):map__57479);
var options = map__57479__$1;
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57484 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__57484) : instaparse.reduction.node_builders.call(null,G__57484));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq57475){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57476,G__57477,seq57475__$2);
}));
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57491){
var map__57492 = p__57491;
var map__57492__$1 = (((((!((map__57492 == null))))?(((((map__57492.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__57492.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__57492):map__57492);
var options = map__57492__$1;
if(cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, [null,null,new cljs.core.Keyword(null,"tags","tags",1771418977),null,new cljs.core.Keyword(null,"content","content",15833224),null,new cljs.core.Keyword(null,"all","all",892129742),null], null), null),cljs.core.get.cljs$core$IFn$_invoke$arity$2(options,new cljs.core.Keyword(null,"unhide","unhide",-413983695)))){
} else {
throw (new Error("Assert failed: (contains? #{nil :tags :content :all} (get options :unhide))"));
}
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57495 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__57495) : instaparse.reduction.node_builders.call(null,G__57495));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq57486){
var G__57487 = cljs.core.first(seq57486);
var seq57486__$1 = cljs.core.next(seq57486);
var G__57488 = cljs.core.first(seq57486__$1);
var seq57486__$2 = cljs.core.next(seq57486__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57487,G__57488,seq57486__$2);
}));
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k57498,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k57498,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__57516){
var vec__57518 = p__57516;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57518,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57518,(1),null);
...
var h__4297__auto____$1 = (function (){var fexpr__57528 = (function (coll__4436__auto__){
return (-360509877 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__57528(this__4435__auto____$1);
})();
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this57499,other57500){
var self__ = this;
var this57499__$1 = this;
return (((!((other57500 == null)))) && ((this57499__$1.constructor === other57500.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57499__$1.grammar,other57500.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57499__$1.start_production,other57500.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57499__$1.output_format,other57500.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57499__$1.__extmap,other57500.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__57497){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__57537 = cljs.core.keyword_identical_QMARK_;
var expr__57538 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__57540 = new cljs.core.Keyword(null,"grammar","grammar",1881328267);
var G__57541 = expr__57538;
return (pred__57537.cljs$core$IFn$_invoke$arity$2 ? pred__57537.cljs$core$IFn$_invoke$arity$2(G__57540,G__57541) : pred__57537.call(null,G__57540,G__57541));
})())){
return (new instaparse.core.Parser(G__57497,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__57542 = new cljs.core.Keyword(null,"start-production","start-production",687546537);
var G__57543 = expr__57538;
return (pred__57537.cljs$core$IFn$_invoke$arity$2 ? pred__57537.cljs$core$IFn$_invoke$arity$2(G__57542,G__57543) : pred__57537.call(null,G__57542,G__57543));
})())){
return (new instaparse.core.Parser(self__.grammar,G__57497,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__57544 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676);
var G__57545 = expr__57538;
return (pred__57537.cljs$core$IFn$_invoke$arity$2 ? pred__57537.cljs$core$IFn$_invoke$arity$2(G__57544,G__57545) : pred__57537.call(null,G__57544,G__57545));
})())){
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__57497,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__57497),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__57497){
var self__ = this;
var this__4438__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__57497,self__.__extmap,self__.__hash));
}));
...
var self__ = this;
var self__ = this;
var G__57550 = (arguments.length - (1));
switch (G__57550) {
case (1):
...
(instaparse.core.Parser.prototype.apply = (function (self__,args57505){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args57505)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__57501){
var extmap__4478__auto__ = (function (){var G__57555 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__57501,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
...
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__57501),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__57501),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__57501),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var args__4795__auto__ = [];
var len__4789__auto___57685 = arguments.length;
var i__4790__auto___57686 = (0);
while(true){
if((i__4790__auto___57686 < len__4789__auto___57685)){
args__4795__auto__.push((arguments[i__4790__auto___57686]));

var G__57687 = (i__4790__auto___57686 + (1));
i__4790__auto___57686 = G__57687;
continue;
} else {
}
break;
