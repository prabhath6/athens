...
if(cljs.core.truth_((function (){var fexpr__57464 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
...
if(cljs.core.truth_((function (){var fexpr__57467 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__57467.cljs$core$IFn$_invoke$arity$1 ? fexpr__57467.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57467.call(null,type));
})())){
} else {
...
var G__57476 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__57476)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__57476)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__57476)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__57476)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57476)].join('')));
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57487){
var map__57489 = p__57487;
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57497 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__57497) : instaparse.reduction.node_builders.call(null,G__57497));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq57483){
var G__57484 = cljs.core.first(seq57483);
var seq57483__$1 = cljs.core.next(seq57483);
var G__57485 = cljs.core.first(seq57483__$1);
var seq57483__$2 = cljs.core.next(seq57483__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57484,G__57485,seq57483__$2);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___57559 = arguments.length;
var i__4790__auto___57560 = (0);
while(true){
if((i__4790__auto___57560 < len__4789__auto___57559)){
args__4795__auto__.push((arguments[i__4790__auto___57560]));

var G__57561 = (i__4790__auto___57560 + (1));
i__4790__auto___57560 = G__57561;
continue;
} else {
}
break;
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57510){
var map__57511 = p__57510;
var map__57511__$1 = (((((!((map__57511 == null))))?(((((map__57511.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__57511.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__57511):map__57511);
var options = map__57511__$1;
if(cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, [null,null,new cljs.core.Keyword(null,"tags","tags",1771418977),null,new cljs.core.Keyword(null,"content","content",15833224),null,new cljs.core.Keyword(null,"all","all",892129742),null], null), null),cljs.core.get.cljs$core$IFn$_invoke$arity$2(options,new cljs.core.Keyword(null,"unhide","unhide",-413983695)))){
} else {
throw (new Error("Assert failed: (contains? #{nil :tags :content :all} (get options :unhide))"));
}
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq57507){
var G__57508 = cljs.core.first(seq57507);
var seq57507__$1 = cljs.core.next(seq57507);
var G__57509 = cljs.core.first(seq57507__$1);
var seq57507__$2 = cljs.core.next(seq57507__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57508,G__57509,seq57507__$2);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___57624 = arguments.length;
var i__4790__auto___57625 = (0);
while(true){
if((i__4790__auto___57625 < len__4789__auto___57624)){
args__4795__auto__.push((arguments[i__4790__auto___57625]));

var G__57626 = (i__4790__auto___57625 + (1));
i__4790__auto___57625 = G__57626;
continue;
} else {
}
break;
