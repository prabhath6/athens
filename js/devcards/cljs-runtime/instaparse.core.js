...
if(cljs.core.truth_((function (){var fexpr__57462 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__57462.cljs$core$IFn$_invoke$arity$1 ? fexpr__57462.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57462.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__57463 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__57463.cljs$core$IFn$_invoke$arity$1 ? fexpr__57463.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57463.call(null,type));
})())){
} else {
...
var G__57464 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__57464)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__57464)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__57464)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__57464)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57464)].join('')));
...
var G__57560 = (i__4790__auto___57557 + (1));
i__4790__auto___57557 = G__57560;
continue;
} else {
}
break;
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57471){
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57475 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__57475) : instaparse.reduction.node_builders.call(null,G__57475));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq57468){
var G__57469 = cljs.core.first(seq57468);
var seq57468__$1 = cljs.core.next(seq57468);
var G__57470 = cljs.core.first(seq57468__$1);
var seq57468__$2 = cljs.core.next(seq57468__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57469,G__57470,seq57468__$2);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___57570 = arguments.length;
var i__4790__auto___57571 = (0);
while(true){
if((i__4790__auto___57571 < len__4789__auto___57570)){
args__4795__auto__.push((arguments[i__4790__auto___57571]));

var G__57573 = (i__4790__auto___57571 + (1));
i__4790__auto___57571 = G__57573;
continue;
} else {
}
break;
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57482){
var map__57483 = p__57482;
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57485 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__57485) : instaparse.reduction.node_builders.call(null,G__57485));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq57478){
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k57490,else__4442__auto__){
var self__ = this;
var this__4441__auto____$1 = this;
var G__57505 = k57490;
var G__57505__$1 = (((G__57505 instanceof cljs.core.Keyword))?G__57505.fqn:null);
switch (G__57505__$1) {
case "grammar":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k57490,else__4442__auto__);
...
var h__4297__auto____$1 = (function (){var fexpr__57518 = (function (coll__4436__auto__){
return (-360509877 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__57518(this__4435__auto____$1);
})();
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this57491,other57492){
var self__ = this;
var this57491__$1 = this;
return (((!((other57492 == null)))) && ((this57491__$1.constructor === other57492.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57491__$1.grammar,other57492.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57491__$1.start_production,other57492.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57491__$1.output_format,other57492.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57491__$1.__extmap,other57492.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__57489){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__57527 = cljs.core.keyword_identical_QMARK_;
var expr__57528 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__57530 = new cljs.core.Keyword(null,"grammar","grammar",1881328267);
var G__57531 = expr__57528;
return (pred__57527.cljs$core$IFn$_invoke$arity$2 ? pred__57527.cljs$core$IFn$_invoke$arity$2(G__57530,G__57531) : pred__57527.call(null,G__57530,G__57531));
})())){
return (new instaparse.core.Parser(G__57489,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__57532 = new cljs.core.Keyword(null,"start-production","start-production",687546537);
var G__57533 = expr__57528;
return (pred__57527.cljs$core$IFn$_invoke$arity$2 ? pred__57527.cljs$core$IFn$_invoke$arity$2(G__57532,G__57533) : pred__57527.call(null,G__57532,G__57533));
})())){
return (new instaparse.core.Parser(self__.grammar,G__57489,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__57534 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676);
var G__57535 = expr__57528;
return (pred__57527.cljs$core$IFn$_invoke$arity$2 ? pred__57527.cljs$core$IFn$_invoke$arity$2(G__57534,G__57535) : pred__57527.call(null,G__57534,G__57535));
})())){
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__57489,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__57489),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__57489){
var self__ = this;
var this__4438__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__57489,self__.__extmap,self__.__hash));
}));
...
var self__ = this;
var self__ = this;
var G__57540 = (arguments.length - (1));
switch (G__57540) {
case (1):
...
(instaparse.core.Parser.prototype.apply = (function (self__,args57498){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args57498)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__57494){
var extmap__4478__auto__ = (function (){var G__57545 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__57494,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__57494)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__57545);
} else {
return G__57545;
}
})();
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__57494),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__57494),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__57494),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
