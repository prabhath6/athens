...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__58193_SHARP_){
return (sci.impl.analyzer.analyze.cljs$core$IFn$_invoke$arity$2 ? sci.impl.analyzer.analyze.cljs$core$IFn$_invoke$arity$2(ctx,p1__58193_SHARP_) : sci.impl.analyzer.analyze.call(null,ctx,p1__58193_SHARP_));
}),children);
});
...
var G__58450 = cljs.core.next(params__$1);
var G__58451 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new_params,cljs.core.first(params__$1));
var G__58452 = lets;
params__$1 = G__58450;
new_params = G__58451;
lets = G__58452;
...
var G__58453 = cljs.core.next(params__$1);
var G__58454 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new_params,gparam);
var G__58455 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(lets,cljs.core.first(params__$1)),gparam);
params__$1 = G__58453;
new_params = G__58454;
lets = G__58455;
continue;
...
sci.impl.analyzer.expand_fn_args_PLUS_body = (function sci$impl$analyzer$expand_fn_args_PLUS_body(p__58203,fn_name,p__58204,macro_QMARK_){
var map__58205 = p__58203;
...
var ctx = map__58205__$1;
var fn_expr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58205__$1,new cljs.core.Keyword(null,"fn-expr","fn-expr",-933027985));
var vec__58206 = p__58204;
var seq__58207 = cljs.core.seq(vec__58206);
var first__58208 = cljs.core.first(seq__58207);
var seq__58207__$1 = cljs.core.next(seq__58207);
var binding_vector = first__58208;
var body_exprs = seq__58207__$1;
...
var fixed_args = cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__58201_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"&","&",-2144855648,null),p1__58201_SHARP_);
}),binding_vector__$1);
var fixed_arity = cljs.core.count(fixed_args);
var var_arg_name = cljs.core.second(cljs.core.drop_while.cljs$core$IFn$_invoke$arity$2((function (p1__58202_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"&","&",-2144855648,null),p1__58202_SHARP_);
}),binding_vector__$1));
...
sci.impl.analyzer.expand_fn = (function sci$impl$analyzer$expand_fn(ctx,p__58219,macro_QMARK_){
...
var analyzed_bodies = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__58223,body__$2){
...
var acc = map__58224__$1;
var max_fixed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58224__$1,new cljs.core.Keyword(null,"max-fixed","max-fixed",166770124));
var min_varargs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58224__$1,new cljs.core.Keyword(null,"min-varargs","min-varargs",1999010596));
...
var vec__58229 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__58233,p__58234){
var vec__58235 = p__58233;
...
var vec__58238 = p__58234;
var binding_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58238,(0),null);
var binding_value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58238,(1),null);
...
var ctx__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58229,(0),null);
var new_let_bindings = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58229,(1),null);
 ...
 */
sci.impl.analyzer.expand_let = (function sci$impl$analyzer$expand_let(ctx,p__58243){
var vec__58244 = p__58243;
var seq__58245 = cljs.core.seq(vec__58244);
var first__58246 = cljs.core.first(seq__58245);
var seq__58245__$1 = cljs.core.next(seq__58245);
var _let = first__58246;
var first__58246__$1 = cljs.core.first(seq__58245__$1);
var seq__58245__$2 = cljs.core.next(seq__58245__$1);
var let_bindings = first__58246__$1;
var exprs = seq__58245__$2;
...
var vec__58283 = ((cljs.core.every_QMARK_(cljs.core.symbol_QMARK_,arg_names))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [bv,arg_names], null):(function (){var syms = cljs.core.repeatedly.cljs$core$IFn$_invoke$arity$2(cljs.core.count(arg_names),(function (){
...
var bv__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58283,(0),null);
var syms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58283,(1),null);
...
return sci.impl.utils.mark_eval_call((new cljs.core.List(null,new cljs.core.Symbol(null,"lazy-seq","lazy-seq",489632906,null),(new cljs.core.List(null,(function (){var G__58292 = ctx;
var G__58293 = (new cljs.core.List(null,new cljs.core.Symbol(null,"fn","fn",465265323,null),(new cljs.core.List(null,cljs.core.PersistentVector.EMPTY,(new cljs.core.List(null,cljs.core.cons(new cljs.core.Symbol(null,"do","do",1686842252,null),body),null,(1),null)),(2),null)),(3),null));
...
sci.impl.analyzer.expand_if = (function sci$impl$analyzer$expand_if(ctx,p__58294){
...
var _if = first__58297;
var exprs = seq__58296__$1;
var expr = vec__58295;
var G__58298 = cljs.core.count(exprs);
switch (G__58298) {
case (0):
case (1):
...
var G__58499 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (cases__$1,ret_map,vec__58306,seq__58307,first__58308,seq__58307__$1,k,first__58308__$1,seq__58307__$2,v__$1,cases__$2,v,clauses,match_clauses,result_clauses,default$,cases,assoc_new){
...
sci.impl.analyzer.expand_try = (function sci$impl$analyzer$expand_try(ctx,p__58315){
...
var _try = first__58318;
var body = seq__58317__$1;
var vec__58319 = (function (){var exprs = cljs.core.seq(body);
...
var G__58509 = exprs__$1;
var G__58510 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(body_exprs,expr);
var G__58511 = catch_exprs;
var G__58512 = finally_expr;
exprs = G__58509;
body_exprs = G__58510;
catch_exprs = G__58511;
finally_expr = G__58512;
continue;
...
var body_exprs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58319,(0),null);
var catches = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58319,(1),null);
var finally$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58319,(2),null);
...
var fq_class_name_58516 = cljs.core.symbol.cljs$core$IFn$_invoke$arity$1(spec);
if(cljs.core.truth_(sci.impl.interop.resolve_class(ctx,fq_class_name_58516))){
} else {
sci.impl.utils.throw_error_with_location.cljs$core$IFn$_invoke$arity$2(["Unable to resolve classname: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(fq_class_name_58516)].join(''),expr);
}

var last_dot_58517 = clojure.string.last_index_of.cljs$core$IFn$_invoke$arity$2(spec,".");
var class_name_58518 = cljs.core.subs.cljs$core$IFn$_invoke$arity$3(spec,(last_dot_58517 + (1)),cljs.core.count(spec));
var cnn_58519 = sci.impl.vars.current_ns_name();
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(env,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"namespaces","namespaces",-1444157469),cnn_58519,new cljs.core.Keyword(null,"imports","imports",-1249933394),cljs.core.symbol.cljs$core$IFn$_invoke$arity$1(class_name_58518)], null),fq_class_name_58516);


var G__58522 = seq__58345;
var G__58523 = chunk__58346;
var G__58524 = count__58347;
var G__58525 = (i__58348 + (1));
seq__58345 = G__58522;
chunk__58346 = G__58523;
count__58347 = G__58524;
i__58348 = G__58525;
continue;
} else {
...
var G__58527 = cljs.core.chunk_rest(seq__58345__$1);
var G__58528 = c__4609__auto__;
var G__58529 = cljs.core.count(c__4609__auto__);
var G__58530 = (0);
seq__58345 = G__58527;
chunk__58346 = G__58528;
count__58347 = G__58529;
i__58348 = G__58530;
continue;
} else {
...
var G__58535 = cljs.core.next(seq__58345__$1);
var G__58536 = null;
var G__58537 = (0);
var G__58538 = (0);
seq__58345 = G__58535;
chunk__58346 = G__58536;
count__58347 = G__58537;
i__58348 = G__58538;
continue;
}
} else {
...
sci.impl.analyzer.expand_dot = (function sci$impl$analyzer$expand_dot(ctx,p__58353){
 ...
 * Expands (.foo x)
 */
sci.impl.analyzer.expand_dot_STAR_ = (function sci$impl$analyzer$expand_dot_STAR_(ctx,p__58364){
...
sci.impl.analyzer.expand_new = (function sci$impl$analyzer$expand_new(ctx,p__58370){
...
sci.impl.analyzer.expand_constructor = (function sci$impl$analyzer$expand_constructor(ctx,p__58378){
...
sci.impl.analyzer.analyze_ns_form = (function sci$impl$analyzer$analyze_ns_form(ctx,p__58383){
...
var vec__58388 = (function (){var fexpr = cljs.core.first(exprs);
...
var docstring = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58388,(0),null);
var exprs__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58388,(1),null);
var vec__58391 = (function (){var m = cljs.core.first(exprs__$1);
if(cljs.core.map_QMARK_(m)){
...
var attr_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58391,(0),null);
var exprs__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58391,(1),null);
