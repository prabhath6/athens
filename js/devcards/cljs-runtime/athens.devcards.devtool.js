...
return cljs.core.with_meta(cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx], null),(function (){var iter__4582__auto__ = (function athens$devcards$devtool$maps_viewer_$_iter__60666(s__60667){
return (new cljs.core.LazySeq(null,(function (){
...
var h = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__60668);
cljs.core.chunk_append(b__60669,cljs.core.get.cljs$core$IFn$_invoke$arity$2(m,h));

var G__60735 = (i__60668 + (1));
i__60668 = G__60735;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60669),athens$devcards$devtool$maps_viewer_$_iter__60666(cljs.core.chunk_rest(s__60667__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60669),null);
}
} else {
var h = cljs.core.first(s__60667__$2);
return cljs.core.cons(cljs.core.get.cljs$core$IFn$_invoke$arity$2(m,h),athens$devcards$devtool$maps_viewer_$_iter__60666(cljs.core.rest(s__60667__$2)));
}
} else {
return null;
}
...
cljs.core.with_meta(cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx], null),(function (){var iter__4582__auto__ = (function athens$devcards$devtool$tuples_viewer_$_iter__60670(s__60671){
return (new cljs.core.LazySeq(null,(function (){
...
cljs.core.chunk_append(b__60673,cljs.core.get.cljs$core$IFn$_invoke$arity$2(coll,i));

var G__60736 = (i__60672 + (1));
i__60672 = G__60736;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60673),athens$devcards$devtool$tuples_viewer_$_iter__60670(cljs.core.chunk_rest(s__60671__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60673),null);
}
} else {
var i = cljs.core.first(s__60671__$2);
return cljs.core.cons(cljs.core.get.cljs$core$IFn$_invoke$arity$2(coll,i),athens$devcards$devtool$tuples_viewer_$_iter__60670(cljs.core.rest(s__60671__$2)));
}
} else {
return null;
}
