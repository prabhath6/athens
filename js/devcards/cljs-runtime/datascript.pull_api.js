...
var map__27648 = rec;
var map__27648__$1 = (((((!((map__27648 == null))))?(((((map__27648.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__27648.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__27648):map__27648);
var depth = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27648__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27648__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__27667 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__27667__$1 = (((G__27667 == null))?null:cljs.core.persistent_BANG_(G__27667));
if((G__27667__$1 == null)){
return null;
} else {
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__27667__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__27677){
var vec__27678 = p__27677;
var seq__27679 = cljs.core.seq(vec__27678);
var first__27680 = cljs.core.first(seq__27679);
var seq__27679__$1 = cljs.core.next(seq__27679);
var frame = first__27680;
var frames = seq__27679__$1;
...
var results = (function (){var G__27692 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq(kvps)){
return cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(G__27692,kvps);
} else {
return G__27692;
}
})();
...
var map__27720 = parent;
var map__27720__$1 = (((((!((map__27720 == null))))?(((((map__27720.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__27720.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__27720):map__27720);
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27720__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27720__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_28019 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_28019,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__27755){
...
var parent = first__27758;
var frames = seq__27757__$1;
...
var found = cljs.core.not_empty((function (){var G__27760 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.take.cljs$core$IFn$_invoke$arity$1(limit),G__27760);
} else {
return G__27760;
}
})());
...
var as_value = (function (){var G__27775 = datom_val;
if(ref_QMARK_){
return cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__27746_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__27746_SHARP_]);
}),G__27775);
} else {
return G__27775;
}
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,cljs.core.update.cljs$core$IFn$_invoke$arity$5(parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,(function (){var G__27778 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(as_value),found);
if(single_QMARK_){
return cljs.core.first(G__27778);
} else {
return G__27778;
}
})()));
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,(function (){var G__27781 = parent;
if(cljs.core.contains_QMARK_(opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__27781,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__27781;
}
})());
...
var vec__27789 = spec;
var attr_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27789,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27789,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p__27799){
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__27817){
var vec__27820 = p__27817;
var seq__27821 = cljs.core.seq(vec__27820);
var first__27822 = cljs.core.first(seq__27821);
var seq__27821__$1 = cljs.core.next(seq__27821);
var frame = first__27822;
var frames = seq__27821__$1;
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__27834){
var vec__27835 = p__27834;
var seq__27836 = cljs.core.seq(vec__27835);
var first__27837 = cljs.core.first(seq__27836);
var seq__27836__$1 = cljs.core.next(seq__27836);
var frame = first__27837;
var frames = seq__27836__$1;
...
var vec__27844 = cljs.core.first(datoms_by_attr);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27844,(0),null);
var datoms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27844,(1),null);
...
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27864__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27864__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__27871 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__27871,attr,eid);
} else {
return G__27871;
}
})();
...
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27881__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27881__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__27892){
while(true){
var vec__27894 = p__27892;
var seq__27895 = cljs.core.seq(vec__27894);
var first__27896 = cljs.core.first(seq__27895);
var seq__27895__$1 = cljs.core.next(seq__27895);
var frame = first__27896;
var frames = seq__27895__$1;
var temp__5733__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5733__auto__){
var eids = temp__5733__auto__;
...
var G__28102 = db;
var G__28103 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__28102;
p__27892 = G__28103;
continue;
}
...
while(true){
var G__27908 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__27908__$1 = (((G__27908 instanceof cljs.core.Keyword))?G__27908.fqn:null);
switch (G__27908__$1) {
case "expand":
var G__28107 = db;
var G__28108 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__28107;
frames = G__28108;
continue;
...
case "expand-rev":
var G__28110 = db;
var G__28111 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__28110;
frames = G__28111;
continue;
...
case "pattern":
var G__28112 = db;
var G__28113 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__28112;
frames = G__28113;
continue;
...
case "recursion":
var G__28114 = db;
var G__28115 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__28114;
frames = G__28115;
continue;
...
break;
case "done":
var vec__27911 = frames;
var seq__27912 = cljs.core.seq(vec__27911);
var first__27913 = cljs.core.first(seq__27912);
var seq__27912__$1 = cljs.core.next(seq__27912);
var f = first__27913;
var remaining = seq__27912__$1;
var result = (function (){var G__27914 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__27914);
} else {
return G__27914;
}
})();
...
var G__28118 = db;
var G__28119 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__27922 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__27922,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__27922;
}
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__27908__$1)].join('')));
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__27930_SHARP_){
return datascript.db.entid_strict(db,p1__27930_SHARP_);
})),eids);
