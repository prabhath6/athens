...
var G__26290 = db;
var G__26291 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__26290;
p__26254 = G__26291;
continue;
}
...
while(true){
var G__26258 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__26258__$1 = (((G__26258 instanceof cljs.core.Keyword))?G__26258.fqn:null);
switch (G__26258__$1) {
case "expand":
var G__26293 = db;
var G__26294 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__26293;
frames = G__26294;
continue;
...
case "expand-rev":
var G__26295 = db;
var G__26296 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__26295;
frames = G__26296;
continue;
...
case "pattern":
var G__26297 = db;
var G__26298 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__26297;
frames = G__26298;
continue;
...
case "recursion":
var G__26299 = db;
var G__26300 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__26299;
frames = G__26300;
continue;
...
break;
case "done":
var vec__26259 = frames;
var seq__26260 = cljs.core.seq(vec__26259);
var first__26261 = cljs.core.first(seq__26260);
var seq__26260__$1 = cljs.core.next(seq__26260);
var f = first__26261;
var remaining = seq__26260__$1;
var result = (function (){var G__26262 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__26262);
} else {
return G__26262;
}
})();
...
var G__26306 = db;
var G__26307 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__26263 = cljs.core.first(remaining);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26258__$1)].join('')));
