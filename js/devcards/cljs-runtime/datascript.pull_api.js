...
var map__53975 = rec;
var map__53975__$1 = (((((!((map__53975 == null))))?(((((map__53975.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__53975.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__53975):map__53975);
var depth = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53975__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53975__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__53977 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__53977__$1 = (((G__53977 == null))?null:cljs.core.persistent_BANG_(G__53977));
if((G__53977__$1 == null)){
return null;
} else {
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__53977__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__53978){
var vec__53979 = p__53978;
var seq__53980 = cljs.core.seq(vec__53979);
var first__53981 = cljs.core.first(seq__53980);
var seq__53980__$1 = cljs.core.next(seq__53980);
var frame = first__53981;
var frames = seq__53980__$1;
...
var results = (function (){var G__53985 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq(kvps)){
return cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(G__53985,kvps);
} else {
return G__53985;
}
})();
...
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53994__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53994__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_54067 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_54067,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__53997){
var vec__53998 = p__53997;
var seq__53999 = cljs.core.seq(vec__53998);
var first__54000 = cljs.core.first(seq__53999);
var seq__53999__$1 = cljs.core.next(seq__53999);
var parent = first__54000;
var frames = seq__53999__$1;
...
var found = cljs.core.not_empty((function (){var G__54001 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.take.cljs$core$IFn$_invoke$arity$1(limit),G__54001);
} else {
return G__54001;
}
})());
...
var as_value = (function (){var G__54002 = datom_val;
if(ref_QMARK_){
return cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__53996_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__53996_SHARP_]);
}),G__54002);
} else {
return G__54002;
}
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,cljs.core.update.cljs$core$IFn$_invoke$arity$5(parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,(function (){var G__54003 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(as_value),found);
if(single_QMARK_){
return cljs.core.first(G__54003);
} else {
return G__54003;
}
})()));
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,(function (){var G__54004 = parent;
if(cljs.core.contains_QMARK_(opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__54004,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__54004;
}
})());
...
var vec__54005 = spec;
var attr_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54005,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54005,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p__54010){
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__54015){
var vec__54016 = p__54015;
var seq__54017 = cljs.core.seq(vec__54016);
var first__54018 = cljs.core.first(seq__54017);
var seq__54017__$1 = cljs.core.next(seq__54017);
var frame = first__54018;
var frames = seq__54017__$1;
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__54021){
...
var frame = first__54024;
var frames = seq__54023__$1;
...
var vec__54025 = cljs.core.first(datoms_by_attr);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54025,(0),null);
var datoms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54025,(1),null);
...
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54028__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__54031 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__54031,attr,eid);
} else {
return G__54031;
}
})();
...
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54039__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54039__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__54042){
while(true){
var vec__54043 = p__54042;
var seq__54044 = cljs.core.seq(vec__54043);
var first__54045 = cljs.core.first(seq__54044);
var seq__54044__$1 = cljs.core.next(seq__54044);
var frame = first__54045;
var frames = seq__54044__$1;
var temp__5733__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5733__auto__){
var eids = temp__5733__auto__;
...
var G__54091 = db;
var G__54092 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__54091;
p__54042 = G__54092;
continue;
}
...
while(true){
var G__54046 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__54046__$1 = (((G__54046 instanceof cljs.core.Keyword))?G__54046.fqn:null);
switch (G__54046__$1) {
case "expand":
var G__54094 = db;
var G__54095 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__54094;
frames = G__54095;
continue;
...
case "expand-rev":
var G__54096 = db;
var G__54097 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__54096;
frames = G__54097;
continue;
...
case "pattern":
var G__54098 = db;
var G__54099 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__54098;
frames = G__54099;
continue;
...
case "recursion":
var G__54100 = db;
var G__54101 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__54100;
frames = G__54101;
continue;
...
break;
case "done":
var vec__54047 = frames;
var seq__54048 = cljs.core.seq(vec__54047);
var first__54049 = cljs.core.first(seq__54048);
var seq__54048__$1 = cljs.core.next(seq__54048);
var f = first__54049;
var remaining = seq__54048__$1;
var result = (function (){var G__54050 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__54050);
} else {
return G__54050;
}
})();
...
var G__54102 = db;
var G__54103 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__54051 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__54051,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__54051;
}
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__54046__$1)].join('')));
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__54052_SHARP_){
return datascript.db.entid_strict(db,p1__54052_SHARP_);
})),eids);
