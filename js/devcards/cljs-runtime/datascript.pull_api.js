...
var depth = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26212__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26212__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__26214 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__26214__$1 = (((G__26214 == null))?null:cljs.core.persistent_BANG_(G__26214));
if((G__26214__$1 == null)){
return null;
} else {
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__26214__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__26215){
...
var frame = first__26218;
var frames = seq__26217__$1;
...
var results = (function (){var G__26219 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq(kvps)){
return cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(G__26219,kvps);
} else {
return G__26219;
}
})();
...
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26220__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26220__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_26269 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_26269,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__26223){
var vec__26224 = p__26223;
var seq__26225 = cljs.core.seq(vec__26224);
var first__26226 = cljs.core.first(seq__26225);
var seq__26225__$1 = cljs.core.next(seq__26225);
var parent = first__26226;
var frames = seq__26225__$1;
...
var found = cljs.core.not_empty((function (){var G__26227 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.take.cljs$core$IFn$_invoke$arity$1(limit),G__26227);
} else {
return G__26227;
}
})());
...
var as_value = (function (){var G__26228 = datom_val;
if(ref_QMARK_){
return cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__26222_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__26222_SHARP_]);
}),G__26228);
} else {
return G__26228;
}
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,cljs.core.update.cljs$core$IFn$_invoke$arity$5(parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,(function (){var G__26229 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(as_value),found);
if(single_QMARK_){
return cljs.core.first(G__26229);
} else {
return G__26229;
}
})()));
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,(function (){var G__26230 = parent;
if(cljs.core.contains_QMARK_(opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__26230,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__26230;
}
})());
...
var vec__26231 = spec;
var attr_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26231,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26231,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p__26234){
var vec__26235 = p__26234;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26235,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26235,(1),null);
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__26238){
var vec__26239 = p__26238;
var seq__26240 = cljs.core.seq(vec__26239);
var first__26241 = cljs.core.first(seq__26240);
var seq__26240__$1 = cljs.core.next(seq__26240);
var frame = first__26241;
var frames = seq__26240__$1;
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__26242){
var vec__26243 = p__26242;
var seq__26244 = cljs.core.seq(vec__26243);
var first__26245 = cljs.core.first(seq__26244);
var seq__26244__$1 = cljs.core.next(seq__26244);
var frame = first__26245;
var frames = seq__26244__$1;
...
var vec__26246 = cljs.core.first(datoms_by_attr);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26246,(0),null);
var datoms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26246,(1),null);
...
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26249__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26249__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__26251 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__26251,attr,eid);
} else {
return G__26251;
}
})();
...
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26252__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26252__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__26254){
while(true){
...
var frame = first__26257;
var frames = seq__26256__$1;
var temp__5733__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5733__auto__){
var eids = temp__5733__auto__;
...
var G__26304 = db;
var G__26305 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__26304;
p__26254 = G__26305;
continue;
}
...
while(true){
var G__26262 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__26262__$1 = (((G__26262 instanceof cljs.core.Keyword))?G__26262.fqn:null);
switch (G__26262__$1) {
case "expand":
var G__26314 = db;
var G__26315 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__26314;
frames = G__26315;
continue;
...
case "expand-rev":
var G__26319 = db;
var G__26320 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__26319;
frames = G__26320;
continue;
...
case "pattern":
var G__26321 = db;
var G__26322 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__26321;
frames = G__26322;
continue;
...
case "recursion":
var G__26323 = db;
var G__26324 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__26323;
frames = G__26324;
continue;
...
break;
case "done":
var vec__26263 = frames;
var seq__26264 = cljs.core.seq(vec__26263);
var first__26265 = cljs.core.first(seq__26264);
var seq__26264__$1 = cljs.core.next(seq__26264);
var f = first__26265;
var remaining = seq__26264__$1;
var result = (function (){var G__26266 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__26266);
} else {
return G__26266;
}
})();
...
var G__26328 = db;
var G__26329 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__26267 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__26267,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__26267;
}
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26262__$1)].join('')));
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__26268_SHARP_){
return datascript.db.entid_strict(db,p1__26268_SHARP_);
})),eids);
