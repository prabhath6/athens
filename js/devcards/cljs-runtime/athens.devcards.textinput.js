...
athens.devcards.textinput.textinput = (function athens$devcards$textinput$textinput(p__60663){
var map__60664 = p__60663;
...
var autoFocus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60664__$1,new cljs.core.Keyword(null,"autoFocus","autoFocus",-552622425));
var defaultValue = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60664__$1,new cljs.core.Keyword(null,"defaultValue","defaultValue",-586131910));
var placeholder = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60664__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60664__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60664__$1,new cljs.core.Keyword(null,"value","value",305978217));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60664__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var icon = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60664__$1,new cljs.core.Keyword(null,"icon","icon",1679606541));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.textinput !== 'undefined') && (typeof athens.devcards.textinput.t_athens$devcards$textinput60674 !== 'undefined')){
} else {
...
*/
athens.devcards.textinput.t_athens$devcards$textinput60674 = (function (meta60675){
this.meta60675 = meta60675;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.textinput.t_athens$devcards$textinput60674.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60676,meta60675__$1){
var self__ = this;
var _60676__$1 = this;
return (new athens.devcards.textinput.t_athens$devcards$textinput60674(meta60675__$1));
}));

(athens.devcards.textinput.t_athens$devcards$textinput60674.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60676){
var self__ = this;
var _60676__$1 = this;
return self__.meta60675;
}));

(athens.devcards.textinput.t_athens$devcards$textinput60674.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.textinput.t_athens$devcards$textinput60674.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
...
(athens.devcards.textinput.t_athens$devcards$textinput60674.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta60675","meta60675",172816345,null)], null);
}));

(athens.devcards.textinput.t_athens$devcards$textinput60674.cljs$lang$type = true);

(athens.devcards.textinput.t_athens$devcards$textinput60674.cljs$lang$ctorStr = "athens.devcards.textinput/t_athens$devcards$textinput60674");

(athens.devcards.textinput.t_athens$devcards$textinput60674.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.textinput/t_athens$devcards$textinput60674");
}));

/**
 * Positional factory function for athens.devcards.textinput/t_athens$devcards$textinput60674.
 */
athens.devcards.textinput.__GT_t_athens$devcards$textinput60674 = (function athens$devcards$textinput$__GT_t_athens$devcards$textinput60674(meta60675){
return (new athens.devcards.textinput.t_athens$devcards$textinput60674(meta60675));
});

}

return (new athens.devcards.textinput.t_athens$devcards$textinput60674(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.textinput !== 'undefined') && (typeof athens.devcards.textinput.t_athens$devcards$textinput60677 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.textinput.t_athens$devcards$textinput60677 = (function (meta60678){
this.meta60678 = meta60678;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.textinput.t_athens$devcards$textinput60677.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60679,meta60678__$1){
var self__ = this;
var _60679__$1 = this;
return (new athens.devcards.textinput.t_athens$devcards$textinput60677(meta60678__$1));
}));

(athens.devcards.textinput.t_athens$devcards$textinput60677.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60679){
var self__ = this;
var _60679__$1 = this;
return self__.meta60678;
}));

(athens.devcards.textinput.t_athens$devcards$textinput60677.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.textinput.t_athens$devcards$textinput60677.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
var this__38815__auto____$1 = this;
...
(athens.devcards.textinput.t_athens$devcards$textinput60677.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta60678","meta60678",731407627,null)], null);
}));

(athens.devcards.textinput.t_athens$devcards$textinput60677.cljs$lang$type = true);

(athens.devcards.textinput.t_athens$devcards$textinput60677.cljs$lang$ctorStr = "athens.devcards.textinput/t_athens$devcards$textinput60677");

(athens.devcards.textinput.t_athens$devcards$textinput60677.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.textinput/t_athens$devcards$textinput60677");
}));

/**
 * Positional factory function for athens.devcards.textinput/t_athens$devcards$textinput60677.
 */
athens.devcards.textinput.__GT_t_athens$devcards$textinput60677 = (function athens$devcards$textinput$__GT_t_athens$devcards$textinput60677(meta60678){
return (new athens.devcards.textinput.t_athens$devcards$textinput60677(meta60678));
});

}

return (new athens.devcards.textinput.t_athens$devcards$textinput60677(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
