...
athens.devcards.textinput.textinput = (function athens$devcards$textinput$textinput(p__60122){
...
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60123__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var autoFocus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60123__$1,new cljs.core.Keyword(null,"autoFocus","autoFocus",-552622425));
var defaultValue = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60123__$1,new cljs.core.Keyword(null,"defaultValue","defaultValue",-586131910));
var placeholder = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60123__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60123__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60123__$1,new cljs.core.Keyword(null,"value","value",305978217));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60123__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var icon = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60123__$1,new cljs.core.Keyword(null,"icon","icon",1679606541));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.textinput !== 'undefined') && (typeof athens.devcards.textinput.t_athens$devcards$textinput60125 !== 'undefined')){
} else {
...
*/
athens.devcards.textinput.t_athens$devcards$textinput60125 = (function (meta60126){
this.meta60126 = meta60126;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.textinput.t_athens$devcards$textinput60125.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60127,meta60126__$1){
var self__ = this;
var _60127__$1 = this;
return (new athens.devcards.textinput.t_athens$devcards$textinput60125(meta60126__$1));
}));

(athens.devcards.textinput.t_athens$devcards$textinput60125.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60127){
var self__ = this;
var _60127__$1 = this;
return self__.meta60126;
}));

(athens.devcards.textinput.t_athens$devcards$textinput60125.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.textinput.t_athens$devcards$textinput60125.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
...
(athens.devcards.textinput.t_athens$devcards$textinput60125.getBasis = (function (){
...
(athens.devcards.textinput.t_athens$devcards$textinput60125.cljs$lang$type = true);

(athens.devcards.textinput.t_athens$devcards$textinput60125.cljs$lang$ctorStr = "athens.devcards.textinput/t_athens$devcards$textinput60125");

(athens.devcards.textinput.t_athens$devcards$textinput60125.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.textinput/t_athens$devcards$textinput60125");
}));

/**
 * Positional factory function for athens.devcards.textinput/t_athens$devcards$textinput60125.
 */
athens.devcards.textinput.__GT_t_athens$devcards$textinput60125 = (function athens$devcards$textinput$__GT_t_athens$devcards$textinput60125(meta60126){
return (new athens.devcards.textinput.t_athens$devcards$textinput60125(meta60126));
});

}

return (new athens.devcards.textinput.t_athens$devcards$textinput60125(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.textinput !== 'undefined') && (typeof athens.devcards.textinput.t_athens$devcards$textinput60128 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.textinput.t_athens$devcards$textinput60128 = (function (meta60129){
this.meta60129 = meta60129;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.textinput.t_athens$devcards$textinput60128.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60130,meta60129__$1){
var self__ = this;
var _60130__$1 = this;
return (new athens.devcards.textinput.t_athens$devcards$textinput60128(meta60129__$1));
}));

(athens.devcards.textinput.t_athens$devcards$textinput60128.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60130){
var self__ = this;
var _60130__$1 = this;
return self__.meta60129;
}));

(athens.devcards.textinput.t_athens$devcards$textinput60128.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.textinput.t_athens$devcards$textinput60128.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.textinput.t_athens$devcards$textinput60128.getBasis = (function (){
...
(athens.devcards.textinput.t_athens$devcards$textinput60128.cljs$lang$type = true);

(athens.devcards.textinput.t_athens$devcards$textinput60128.cljs$lang$ctorStr = "athens.devcards.textinput/t_athens$devcards$textinput60128");

(athens.devcards.textinput.t_athens$devcards$textinput60128.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.textinput/t_athens$devcards$textinput60128");
}));

/**
 * Positional factory function for athens.devcards.textinput/t_athens$devcards$textinput60128.
 */
athens.devcards.textinput.__GT_t_athens$devcards$textinput60128 = (function athens$devcards$textinput$__GT_t_athens$devcards$textinput60128(meta60129){
return (new athens.devcards.textinput.t_athens$devcards$textinput60128(meta60129));
});

}

return (new athens.devcards.textinput.t_athens$devcards$textinput60128(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
