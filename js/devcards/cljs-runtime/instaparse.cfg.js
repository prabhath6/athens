...
var G__56892 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__56892)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__56892)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__56892)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56892)].join('')));
...
var G__56939 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__56940 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__56939;
v = G__56940;
continue;
} else {
var G__56941 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__56942 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__56941;
v = G__56942;
continue;
}
...
break;
case "\"":
var G__56944 = cljs.core.next(sq);
var G__56945 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__56944;
v = G__56945;
continue;
...
break;
default:
var G__56946 = cljs.core.next(sq);
var G__56947 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__56946;
v = G__56947;
continue;
...
while(true){
var G__56905 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__56905__$1 = (((G__56905 instanceof cljs.core.Keyword))?G__56905.fqn:null);
switch (G__56905__$1) {
case "rule":
var vec__56906 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56906,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56906,(1),null);
...
break;
case "paren":
var G__56950 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__56950;
continue;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56905__$1)].join('')));
...
while(true){
var G__56917 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
...
case "neg":
case "rep":
var G__56952 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__56952;
continue;
...
var valid_nts_56953 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__56918_56954 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__56919_56955 = null;
var count__56920_56956 = (0);
var i__56921_56957 = (0);
while(true){
if((i__56921_56957 < count__56920_56956)){
var nt_56958 = chunk__56919_56955.cljs$core$IIndexed$_nth$arity$2(null,i__56921_56957);
if(cljs.core.truth_((valid_nts_56953.cljs$core$IFn$_invoke$arity$1 ? valid_nts_56953.cljs$core$IFn$_invoke$arity$1(nt_56958) : valid_nts_56953.call(null,nt_56958)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_56958),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__56959 = seq__56918_56954;
var G__56960 = chunk__56919_56955;
var G__56961 = count__56920_56956;
var G__56962 = (i__56921_56957 + (1));
seq__56918_56954 = G__56959;
chunk__56919_56955 = G__56960;
count__56920_56956 = G__56961;
i__56921_56957 = G__56962;
continue;
} else {
var temp__5735__auto___56963 = cljs.core.seq(seq__56918_56954);
if(temp__5735__auto___56963){
var seq__56918_56964__$1 = temp__5735__auto___56963;
if(cljs.core.chunked_seq_QMARK_(seq__56918_56964__$1)){
var c__4609__auto___56965 = cljs.core.chunk_first(seq__56918_56964__$1);
var G__56966 = cljs.core.chunk_rest(seq__56918_56964__$1);
var G__56967 = c__4609__auto___56965;
var G__56968 = cljs.core.count(c__4609__auto___56965);
var G__56969 = (0);
seq__56918_56954 = G__56966;
chunk__56919_56955 = G__56967;
count__56920_56956 = G__56968;
i__56921_56957 = G__56969;
continue;
} else {
var nt_56970 = cljs.core.first(seq__56918_56964__$1);
if(cljs.core.truth_((valid_nts_56953.cljs$core$IFn$_invoke$arity$1 ? valid_nts_56953.cljs$core$IFn$_invoke$arity$1(nt_56970) : valid_nts_56953.call(null,nt_56970)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_56970),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__56971 = cljs.core.next(seq__56918_56964__$1);
var G__56972 = null;
var G__56973 = (0);
var G__56974 = (0);
seq__56918_56954 = G__56971;
chunk__56919_56955 = G__56972;
count__56920_56956 = G__56973;
i__56921_56957 = G__56974;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__56922_56975 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__56923_56976 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__56924_56977 = true;
var _STAR_print_fn_STAR__temp_val__56925_56978 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__56924_56977);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__56925_56978);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__56923_56976);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__56922_56975);
}
...
var len__4789__auto___56979 = arguments.length;
var i__4790__auto___56980 = (0);
while(true){
if((i__4790__auto___56980 < len__4789__auto___56979)){
args__4795__auto__.push((arguments[i__4790__auto___56980]));

var G__56981 = (i__4790__auto___56980 + (1));
i__4790__auto___56980 = G__56981;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__56928){
...
var opts = map__56929__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__56931 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__56932 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__56932);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__56933_56982 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__56934_56983 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__56935_56984 = true;
var _STAR_print_fn_STAR__temp_val__56936_56985 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__56935_56984);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__56936_56985);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__56934_56983);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__56933_56982);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__56931);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq56926){
var G__56927 = cljs.core.first(seq56926);
var seq56926__$1 = cljs.core.next(seq56926);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56927,seq56926__$1);
}));
