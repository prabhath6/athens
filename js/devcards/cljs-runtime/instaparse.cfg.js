...
var G__56897 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__56897)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__56897)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__56897)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56897)].join('')));
...
var G__56943 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__56944 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__56943;
v = G__56944;
continue;
} else {
var G__56945 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__56946 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__56945;
v = G__56946;
continue;
}
...
break;
case "\"":
var G__56947 = cljs.core.next(sq);
var G__56948 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__56947;
v = G__56948;
continue;
...
break;
default:
var G__56949 = cljs.core.next(sq);
var G__56950 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__56949;
v = G__56950;
continue;
...
while(true){
var G__56906 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__56906__$1 = (((G__56906 instanceof cljs.core.Keyword))?G__56906.fqn:null);
switch (G__56906__$1) {
case "rule":
var vec__56907 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56907,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56907,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__56910 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__56910) : instaparse.cfg.content.call(null,G__56910));
...
break;
case "paren":
var G__56954 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__56954;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__56911 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__56911) : instaparse.cfg.build_rule.call(null,G__56911));
})());
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__56912 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__56912) : instaparse.cfg.build_rule.call(null,G__56912));
})());

break;
case "star":
return instaparse.combinators_source.star((function (){var G__56913 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__56913) : instaparse.cfg.build_rule.call(null,G__56913));
})());

break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__56914 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__56914) : instaparse.cfg.build_rule.call(null,G__56914));
})());

break;
case "look":
return instaparse.combinators_source.look((function (){var G__56915 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__56915) : instaparse.cfg.build_rule.call(null,G__56915));
})());

break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__56916 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__56916) : instaparse.cfg.build_rule.call(null,G__56916));
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56906__$1)].join('')));
...
while(true){
var G__56921 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
var G__56921__$1 = (((G__56921 instanceof cljs.core.Keyword))?G__56921.fqn:null);
switch (G__56921__$1) {
case "nt":
...
case "neg":
case "rep":
var G__56957 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__56957;
continue;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56921__$1)].join('')));
...
var valid_nts_56958 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__56922_56959 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__56923_56960 = null;
var count__56924_56961 = (0);
var i__56925_56962 = (0);
while(true){
if((i__56925_56962 < count__56924_56961)){
var nt_56963 = chunk__56923_56960.cljs$core$IIndexed$_nth$arity$2(null,i__56925_56962);
if(cljs.core.truth_((valid_nts_56958.cljs$core$IFn$_invoke$arity$1 ? valid_nts_56958.cljs$core$IFn$_invoke$arity$1(nt_56963) : valid_nts_56958.call(null,nt_56963)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_56963),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__56964 = seq__56922_56959;
var G__56965 = chunk__56923_56960;
var G__56966 = count__56924_56961;
var G__56967 = (i__56925_56962 + (1));
seq__56922_56959 = G__56964;
chunk__56923_56960 = G__56965;
count__56924_56961 = G__56966;
i__56925_56962 = G__56967;
continue;
} else {
var temp__5735__auto___56968 = cljs.core.seq(seq__56922_56959);
if(temp__5735__auto___56968){
var seq__56922_56969__$1 = temp__5735__auto___56968;
if(cljs.core.chunked_seq_QMARK_(seq__56922_56969__$1)){
var c__4609__auto___56970 = cljs.core.chunk_first(seq__56922_56969__$1);
var G__56971 = cljs.core.chunk_rest(seq__56922_56969__$1);
var G__56972 = c__4609__auto___56970;
var G__56973 = cljs.core.count(c__4609__auto___56970);
var G__56974 = (0);
seq__56922_56959 = G__56971;
chunk__56923_56960 = G__56972;
count__56924_56961 = G__56973;
i__56925_56962 = G__56974;
continue;
} else {
var nt_56975 = cljs.core.first(seq__56922_56969__$1);
if(cljs.core.truth_((valid_nts_56958.cljs$core$IFn$_invoke$arity$1 ? valid_nts_56958.cljs$core$IFn$_invoke$arity$1(nt_56975) : valid_nts_56958.call(null,nt_56975)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_56975),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__56976 = cljs.core.next(seq__56922_56969__$1);
var G__56977 = null;
var G__56978 = (0);
var G__56979 = (0);
seq__56922_56959 = G__56976;
chunk__56923_56960 = G__56977;
count__56924_56961 = G__56978;
i__56925_56962 = G__56979;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__56927_56980 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__56928_56981 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__56929_56982 = true;
var _STAR_print_fn_STAR__temp_val__56930_56983 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__56929_56982);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__56930_56983);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__56928_56981);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__56927_56980);
}
...
var len__4789__auto___56984 = arguments.length;
var i__4790__auto___56985 = (0);
while(true){
if((i__4790__auto___56985 < len__4789__auto___56984)){
args__4795__auto__.push((arguments[i__4790__auto___56985]));

var G__56986 = (i__4790__auto___56985 + (1));
i__4790__auto___56985 = G__56986;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__56933){
var map__56934 = p__56933;
...
var opts = map__56934__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__56936 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__56937 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__56937);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__56938_56987 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__56939_56988 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__56940_56989 = true;
var _STAR_print_fn_STAR__temp_val__56941_56990 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__56940_56989);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__56941_56990);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__56939_56988);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__56938_56987);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__56936);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq56931){
var G__56932 = cljs.core.first(seq56931);
var seq56931__$1 = cljs.core.next(seq56931);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56932,seq56931__$1);
}));
