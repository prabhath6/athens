...
var G__56953 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__56954 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__56953;
v = G__56954;
continue;
} else {
var G__56955 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__56956 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__56955;
v = G__56956;
continue;
}
...
break;
case "\"":
var G__56957 = cljs.core.next(sq);
var G__56958 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__56957;
v = G__56958;
continue;
...
break;
default:
var G__56959 = cljs.core.next(sq);
var G__56960 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__56959;
v = G__56960;
continue;
...
break;
case "paren":
var G__56963 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__56963;
continue;
...
break;
case "star":
return instaparse.combinators_source.star((function (){var G__56923 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__56923) : instaparse.cfg.build_rule.call(null,G__56923));
})());

break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__56924 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__56924) : instaparse.cfg.build_rule.call(null,G__56924));
})());

break;
case "look":
return instaparse.combinators_source.look((function (){var G__56925 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__56925) : instaparse.cfg.build_rule.call(null,G__56925));
})());

break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__56926 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
while(true){
var G__56927 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
var G__56927__$1 = (((G__56927 instanceof cljs.core.Keyword))?G__56927.fqn:null);
switch (G__56927__$1) {
case "nt":
...
case "neg":
case "rep":
var G__56966 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__56966;
continue;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56927__$1)].join('')));
...
var valid_nts_56967 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__56932_56968 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__56933_56969 = null;
var count__56934_56970 = (0);
var i__56935_56971 = (0);
while(true){
if((i__56935_56971 < count__56934_56970)){
var nt_56972 = chunk__56933_56969.cljs$core$IIndexed$_nth$arity$2(null,i__56935_56971);
if(cljs.core.truth_((valid_nts_56967.cljs$core$IFn$_invoke$arity$1 ? valid_nts_56967.cljs$core$IFn$_invoke$arity$1(nt_56972) : valid_nts_56967.call(null,nt_56972)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_56972),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__56974 = seq__56932_56968;
var G__56975 = chunk__56933_56969;
var G__56976 = count__56934_56970;
var G__56977 = (i__56935_56971 + (1));
seq__56932_56968 = G__56974;
chunk__56933_56969 = G__56975;
count__56934_56970 = G__56976;
i__56935_56971 = G__56977;
continue;
} else {
var temp__5735__auto___56978 = cljs.core.seq(seq__56932_56968);
if(temp__5735__auto___56978){
var seq__56932_56979__$1 = temp__5735__auto___56978;
if(cljs.core.chunked_seq_QMARK_(seq__56932_56979__$1)){
var c__4609__auto___56980 = cljs.core.chunk_first(seq__56932_56979__$1);
var G__56981 = cljs.core.chunk_rest(seq__56932_56979__$1);
var G__56982 = c__4609__auto___56980;
var G__56983 = cljs.core.count(c__4609__auto___56980);
var G__56984 = (0);
seq__56932_56968 = G__56981;
chunk__56933_56969 = G__56982;
count__56934_56970 = G__56983;
i__56935_56971 = G__56984;
continue;
} else {
var nt_56985 = cljs.core.first(seq__56932_56979__$1);
if(cljs.core.truth_((valid_nts_56967.cljs$core$IFn$_invoke$arity$1 ? valid_nts_56967.cljs$core$IFn$_invoke$arity$1(nt_56985) : valid_nts_56967.call(null,nt_56985)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_56985),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__56986 = cljs.core.next(seq__56932_56979__$1);
var G__56987 = null;
var G__56988 = (0);
var G__56989 = (0);
seq__56932_56968 = G__56986;
chunk__56933_56969 = G__56987;
count__56934_56970 = G__56988;
i__56935_56971 = G__56989;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__56936_56990 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__56937_56991 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__56938_56992 = true;
var _STAR_print_fn_STAR__temp_val__56939_56993 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__56938_56992);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__56939_56993);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__56937_56991);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__56936_56990);
}
...
var len__4789__auto___56994 = arguments.length;
var i__4790__auto___56995 = (0);
while(true){
if((i__4790__auto___56995 < len__4789__auto___56994)){
args__4795__auto__.push((arguments[i__4790__auto___56995]));

var G__56996 = (i__4790__auto___56995 + (1));
i__4790__auto___56995 = G__56996;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__56943){
...
var opts = map__56944__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__56946 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__56947 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__56947);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__56948_56997 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__56949_56998 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__56950_56999 = true;
var _STAR_print_fn_STAR__temp_val__56951_57000 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__56950_56999);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__56951_57000);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__56949_56998);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__56948_56997);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__56946);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq56941){
var G__56942 = cljs.core.first(seq56941);
var seq56941__$1 = cljs.core.next(seq56941);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56942,seq56941__$1);
}));
