...
var G__56916 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__56916)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__56916)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__56916)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56916)].join('')));
...
var G__56963 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__56964 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__56963;
v = G__56964;
continue;
} else {
var G__56965 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__56966 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__56965;
v = G__56966;
continue;
}
...
break;
case "\"":
var G__56967 = cljs.core.next(sq);
var G__56968 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__56967;
v = G__56968;
continue;
...
break;
default:
var G__56970 = cljs.core.next(sq);
var G__56971 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__56970;
v = G__56971;
continue;
...
while(true){
var G__56929 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__56929__$1 = (((G__56929 instanceof cljs.core.Keyword))?G__56929.fqn:null);
switch (G__56929__$1) {
case "rule":
var vec__56930 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56930,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56930,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__56933 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__56933) : instaparse.cfg.content.call(null,G__56933));
...
break;
case "paren":
var G__56974 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__56974;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__56934 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__56934) : instaparse.cfg.build_rule.call(null,G__56934));
})());
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__56936 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__56936) : instaparse.cfg.build_rule.call(null,G__56936));
})());

break;
case "star":
return instaparse.combinators_source.star((function (){var G__56937 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__56937) : instaparse.cfg.build_rule.call(null,G__56937));
})());

break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__56938 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__56938) : instaparse.cfg.build_rule.call(null,G__56938));
})());

break;
case "look":
return instaparse.combinators_source.look((function (){var G__56939 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__56939) : instaparse.cfg.build_rule.call(null,G__56939));
})());

break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__56940 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__56940) : instaparse.cfg.build_rule.call(null,G__56940));
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56929__$1)].join('')));
...
while(true){
var G__56941 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
var G__56941__$1 = (((G__56941 instanceof cljs.core.Keyword))?G__56941.fqn:null);
switch (G__56941__$1) {
case "nt":
...
case "neg":
case "rep":
var G__56976 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__56976;
continue;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56941__$1)].join('')));
...
var valid_nts_56977 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__56942_56978 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__56943_56979 = null;
var count__56944_56980 = (0);
var i__56945_56981 = (0);
while(true){
if((i__56945_56981 < count__56944_56980)){
var nt_56982 = chunk__56943_56979.cljs$core$IIndexed$_nth$arity$2(null,i__56945_56981);
if(cljs.core.truth_((valid_nts_56977.cljs$core$IFn$_invoke$arity$1 ? valid_nts_56977.cljs$core$IFn$_invoke$arity$1(nt_56982) : valid_nts_56977.call(null,nt_56982)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_56982),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__56983 = seq__56942_56978;
var G__56984 = chunk__56943_56979;
var G__56985 = count__56944_56980;
var G__56986 = (i__56945_56981 + (1));
seq__56942_56978 = G__56983;
chunk__56943_56979 = G__56984;
count__56944_56980 = G__56985;
i__56945_56981 = G__56986;
continue;
} else {
var temp__5735__auto___56987 = cljs.core.seq(seq__56942_56978);
if(temp__5735__auto___56987){
var seq__56942_56988__$1 = temp__5735__auto___56987;
if(cljs.core.chunked_seq_QMARK_(seq__56942_56988__$1)){
var c__4609__auto___56989 = cljs.core.chunk_first(seq__56942_56988__$1);
var G__56990 = cljs.core.chunk_rest(seq__56942_56988__$1);
var G__56991 = c__4609__auto___56989;
var G__56992 = cljs.core.count(c__4609__auto___56989);
var G__56993 = (0);
seq__56942_56978 = G__56990;
chunk__56943_56979 = G__56991;
count__56944_56980 = G__56992;
i__56945_56981 = G__56993;
continue;
} else {
var nt_56994 = cljs.core.first(seq__56942_56988__$1);
if(cljs.core.truth_((valid_nts_56977.cljs$core$IFn$_invoke$arity$1 ? valid_nts_56977.cljs$core$IFn$_invoke$arity$1(nt_56994) : valid_nts_56977.call(null,nt_56994)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_56994),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__56995 = cljs.core.next(seq__56942_56988__$1);
var G__56996 = null;
var G__56997 = (0);
var G__56998 = (0);
seq__56942_56978 = G__56995;
chunk__56943_56979 = G__56996;
count__56944_56980 = G__56997;
i__56945_56981 = G__56998;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__56946_56999 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__56947_57000 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__56948_57001 = true;
var _STAR_print_fn_STAR__temp_val__56949_57002 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__56948_57001);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__56949_57002);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__56947_57000);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__56946_56999);
}
...
var len__4789__auto___57003 = arguments.length;
var i__4790__auto___57004 = (0);
while(true){
if((i__4790__auto___57004 < len__4789__auto___57003)){
args__4795__auto__.push((arguments[i__4790__auto___57004]));

var G__57005 = (i__4790__auto___57004 + (1));
i__4790__auto___57004 = G__57005;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__56952){
...
var opts = map__56953__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__56955 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__56956 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__56956);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__56957_57006 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__56958_57007 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__56959_57008 = true;
var _STAR_print_fn_STAR__temp_val__56960_57009 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__56959_57008);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__56960_57009);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__56958_57007);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__56957_57006);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__56955);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq56950){
var G__56951 = cljs.core.first(seq56950);
var seq56950__$1 = cljs.core.next(seq56950);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56951,seq56950__$1);
}));
