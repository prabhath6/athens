...
var G__43117 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__43117)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__43117)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__43117)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__43117)].join('')));
...
var G__43260 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__43261 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__43260;
v = G__43261;
continue;
} else {
var G__43262 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__43263 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__43262;
v = G__43263;
continue;
}
...
break;
case "\"":
var G__43264 = cljs.core.next(sq);
var G__43265 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__43264;
v = G__43265;
continue;
...
break;
default:
var G__43292 = cljs.core.next(sq);
var G__43293 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__43292;
v = G__43293;
continue;
...
var read_string_STAR__43301 = cljs.core.deref(new cljs.core.Var(function(){return cljs.tools.reader.read_string_STAR_;},new cljs.core.Symbol("cljs.tools.reader","read-string*","cljs.tools.reader/read-string*",1492661621,null),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"private","private",-558947994),new cljs.core.Keyword(null,"ns","ns",441598760),new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword(null,"file","file",-1269645878),new cljs.core.Keyword(null,"end-column","end-column",1425389514),new cljs.core.Keyword(null,"column","column",2078222095),new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"end-line","end-line",1837326455),new cljs.core.Keyword(null,"arglists","arglists",1661989754),new cljs.core.Keyword(null,"doc","doc",1913296891),new cljs.core.Keyword(null,"test","test",577538877)],[true,new cljs.core.Symbol(null,"cljs.tools.reader","cljs.tools.reader",-831293977,null),new cljs.core.Symbol(null,"read-string*","read-string*",1046768315,null),"cljs/tools/reader.cljs",(20),(1),(305),(305),cljs.core.list(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"reader","reader",1810192380,null),new cljs.core.Symbol(null,"_","_",-1201019570,null),new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"pending-forms","pending-forms",-1225172071,null)], null)),null,(cljs.core.truth_(cljs.tools.reader.read_string_STAR_)?cljs.tools.reader.read_string_STAR_.cljs$lang$test:null)])));
instaparse.cfg.safe_read_string = (function instaparse$cfg$safe_read_string(s){
var G__43123 = cljs.tools.reader.reader_types.string_push_back_reader.cljs$core$IFn$_invoke$arity$1(s);
var G__43124 = null;
var G__43125 = null;
var G__43126 = null;
return (read_string_STAR__43301.cljs$core$IFn$_invoke$arity$4 ? read_string_STAR__43301.cljs$core$IFn$_invoke$arity$4(G__43123,G__43124,G__43125,G__43126) : read_string_STAR__43301.call(null,G__43123,G__43124,G__43125,G__43126));
});
/**
...
while(true){
var G__43128 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__43128__$1 = (((G__43128 instanceof cljs.core.Keyword))?G__43128.fqn:null);
switch (G__43128__$1) {
case "rule":
var vec__43129 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43129,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43129,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__43132 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__43132) : instaparse.cfg.content.call(null,G__43132));
...
break;
case "paren":
var G__43314 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__43314;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__43133 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__43133) : instaparse.cfg.build_rule.call(null,G__43133));
})());
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__43134 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__43134) : instaparse.cfg.build_rule.call(null,G__43134));
})());

break;
case "star":
return instaparse.combinators_source.star((function (){var G__43135 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__43135) : instaparse.cfg.build_rule.call(null,G__43135));
})());

break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__43136 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__43136) : instaparse.cfg.build_rule.call(null,G__43136));
})());

break;
case "look":
return instaparse.combinators_source.look((function (){var G__43137 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__43137) : instaparse.cfg.build_rule.call(null,G__43137));
})());

break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__43138 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__43138) : instaparse.cfg.build_rule.call(null,G__43138));
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__43128__$1)].join('')));
...
while(true){
var G__43139 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
...
case "neg":
case "rep":
var G__43332 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__43332;
continue;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__43139__$1)].join('')));
...
var valid_nts_43333 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__43140_43334 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__43141_43335 = null;
var count__43142_43336 = (0);
var i__43143_43337 = (0);
while(true){
if((i__43143_43337 < count__43142_43336)){
var nt_43339 = chunk__43141_43335.cljs$core$IIndexed$_nth$arity$2(null,i__43143_43337);
if(cljs.core.truth_((valid_nts_43333.cljs$core$IFn$_invoke$arity$1 ? valid_nts_43333.cljs$core$IFn$_invoke$arity$1(nt_43339) : valid_nts_43333.call(null,nt_43339)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_43339),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__43340 = seq__43140_43334;
var G__43341 = chunk__43141_43335;
var G__43342 = count__43142_43336;
var G__43343 = (i__43143_43337 + (1));
seq__43140_43334 = G__43340;
chunk__43141_43335 = G__43341;
count__43142_43336 = G__43342;
i__43143_43337 = G__43343;
continue;
} else {
var temp__5735__auto___43344 = cljs.core.seq(seq__43140_43334);
if(temp__5735__auto___43344){
var seq__43140_43345__$1 = temp__5735__auto___43344;
if(cljs.core.chunked_seq_QMARK_(seq__43140_43345__$1)){
var c__4609__auto___43346 = cljs.core.chunk_first(seq__43140_43345__$1);
var G__43347 = cljs.core.chunk_rest(seq__43140_43345__$1);
var G__43348 = c__4609__auto___43346;
var G__43349 = cljs.core.count(c__4609__auto___43346);
var G__43350 = (0);
seq__43140_43334 = G__43347;
chunk__43141_43335 = G__43348;
count__43142_43336 = G__43349;
i__43143_43337 = G__43350;
continue;
} else {
var nt_43351 = cljs.core.first(seq__43140_43345__$1);
if(cljs.core.truth_((valid_nts_43333.cljs$core$IFn$_invoke$arity$1 ? valid_nts_43333.cljs$core$IFn$_invoke$arity$1(nt_43351) : valid_nts_43333.call(null,nt_43351)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_43351),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__43354 = cljs.core.next(seq__43140_43345__$1);
var G__43355 = null;
var G__43356 = (0);
var G__43357 = (0);
seq__43140_43334 = G__43354;
chunk__43141_43335 = G__43355;
count__43142_43336 = G__43356;
i__43143_43337 = G__43357;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__43148_43358 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__43149_43359 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__43150_43360 = true;
var _STAR_print_fn_STAR__temp_val__43151_43361 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__43150_43360);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__43151_43361);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__43149_43359);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__43148_43358);
}
...
var len__4789__auto___43364 = arguments.length;
var i__4790__auto___43365 = (0);
while(true){
if((i__4790__auto___43365 < len__4789__auto___43364)){
args__4795__auto__.push((arguments[i__4790__auto___43365]));

var G__43366 = (i__4790__auto___43365 + (1));
i__4790__auto___43365 = G__43366;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__43155){
var map__43156 = p__43155;
var map__43156__$1 = (((((!((map__43156 == null))))?(((((map__43156.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__43156.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__43156):map__43156);
var opts = map__43156__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__43158 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__43159 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__43159);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__43160_43369 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__43161_43370 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__43162_43371 = true;
var _STAR_print_fn_STAR__temp_val__43163_43372 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__43162_43371);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__43163_43372);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__43161_43370);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__43160_43369);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__43158);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq43153){
var G__43154 = cljs.core.first(seq43153);
var seq43153__$1 = cljs.core.next(seq43153);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43154,seq43153__$1);
}));
