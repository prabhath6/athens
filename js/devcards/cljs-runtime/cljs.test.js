...
var G__38509 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq38513){
var G__38514 = cljs.core.first(seq38513);
var seq38513__$1 = cljs.core.next(seq38513);
var G__38515 = cljs.core.first(seq38513__$1);
var seq38513__$2 = cljs.core.next(seq38513__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38514,G__38515,seq38513__$2);
}));
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38528__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38528__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38528__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38526_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(p1__38526_SHARP_));
...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expected:",(function (){var G__38539 = new cljs.core.Keyword(null,"expected","expected",1583670997).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__38539) : formatter_fn.call(null,G__38539));
})()], 0));

return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["  actual:",(function (){var G__38540 = new cljs.core.Keyword(null,"actual","actual",107306363).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__38540) : formatter_fn.call(null,G__38540));
})()], 0));
});
...
var output_dir = "out";
var output_dir__$1 = (function (){var G__38573 = output_dir;
if((!(clojure.string.ends_with_QMARK_(output_dir,"/")))){
return [G__38573,"/"].join('');
} else {
return G__38573;
}
})();
...
var temp__5733__auto__ = ((typeof exception.stack === 'string')?(function (){var G__38579 = exception.stack;
var G__38579__$1 = (((G__38579 == null))?null:clojure.string.split_lines(G__38579));
var G__38579__$2 = (((G__38579__$1 == null))?null:cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__38579__$1,depth));
if((G__38579__$2 == null)){
return null;
} else {
return clojure.string.trim(G__38579__$2);
}
})():false);
if(cljs.core.truth_(temp__5733__auto__)){
var stack_element = temp__5733__auto__;
var fname = cljs.test.js_filename(stack_element);
var vec__38584 = cljs.test.js_line_and_column(stack_element);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38584,(0),null);
var column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38584,(1),null);
var vec__38587 = cljs.test.mapped_line_and_column(fname,line,column);
var fname__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38587,(0),null);
var line__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38587,(1),null);
var column__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38587,(2),null);
...
var m__$1 = (function (){var G__38593 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__38608 = (function (){var d = (new cljs.core.Delay(((function (fns,obj,f,xs__6292__auto__,temp__5735__auto__){
return (function (){
var G__38624 = cljs.core.rest(fns);
return (cljs.test.run_block.cljs$core$IFn$_invoke$arity$1 ? cljs.test.run_block.cljs$core$IFn$_invoke$arity$1(G__38624) : cljs.test.run_block.call(null,G__38624));
...
return (obj.cljs$core$IFn$_invoke$arity$1 ? obj.cljs$core$IFn$_invoke$arity$1(G__38608) : obj.call(null,G__38608));
} else {
var G__38677 = (function (){var G__38625 = cljs.core.rest(fns);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(obj,G__38625);
} else {
return G__38625;
}
})();
...
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4(G__38627,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e38630){var e = e38630;
var G__38631 = e;
var G__38631__$1 = (((G__38631 instanceof cljs.core.Keyword))?G__38631.fqn:null);
switch (G__38631__$1) {
...
var temp__5735__auto___38689 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(v));
if(cljs.core.truth_(temp__5735__auto___38689)){
var t_38690 = temp__5735__auto___38689;
var G__38662_38691 = ((function (seq__38656,chunk__38657,count__38658,i__38659,t_38690,temp__5735__auto___38689,v,each_fixture_fn,G__38653,G__38653__$1,env,once_fixtures,each_fixtures,vec__38650,ns,vars__$1){
return (function (){
return cljs.test.run_block(cljs.test.test_var_block_STAR_(v,cljs.test.disable_async(t_38690)));
});})(seq__38656,chunk__38657,count__38658,i__38659,t_38690,temp__5735__auto___38689,v,each_fixture_fn,G__38653,G__38653__$1,env,once_fixtures,each_fixtures,vec__38650,ns,vars__$1))
;
(each_fixture_fn.cljs$core$IFn$_invoke$arity$1 ? each_fixture_fn.cljs$core$IFn$_invoke$arity$1(G__38662_38691) : each_fixture_fn.call(null,G__38662_38691));
} else {
}


var G__38693 = seq__38656;
var G__38694 = chunk__38657;
var G__38695 = count__38658;
var G__38696 = (i__38659 + (1));
seq__38656 = G__38693;
chunk__38657 = G__38694;
count__38658 = G__38695;
i__38659 = G__38696;
continue;
} else {
...
var G__38699 = cljs.core.chunk_rest(seq__38656__$1);
var G__38700 = c__4609__auto__;
var G__38701 = cljs.core.count(c__4609__auto__);
var G__38702 = (0);
seq__38656 = G__38699;
chunk__38657 = G__38700;
count__38658 = G__38701;
i__38659 = G__38702;
continue;
} else {
var v = cljs.core.first(seq__38656__$1);
var temp__5735__auto___38703__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(v));
if(cljs.core.truth_(temp__5735__auto___38703__$1)){
var t_38704 = temp__5735__auto___38703__$1;
var G__38663_38705 = ((function (seq__38656,chunk__38657,count__38658,i__38659,t_38704,temp__5735__auto___38703__$1,v,seq__38656__$1,temp__5735__auto__,each_fixture_fn,G__38653,G__38653__$1,env,once_fixtures,each_fixtures,vec__38650,ns,vars__$1){
return (function (){
return cljs.test.run_block(cljs.test.test_var_block_STAR_(v,cljs.test.disable_async(t_38704)));
});})(seq__38656,chunk__38657,count__38658,i__38659,t_38704,temp__5735__auto___38703__$1,v,seq__38656__$1,temp__5735__auto__,each_fixture_fn,G__38653,G__38653__$1,env,once_fixtures,each_fixtures,vec__38650,ns,vars__$1))
;
(each_fixture_fn.cljs$core$IFn$_invoke$arity$1 ? each_fixture_fn.cljs$core$IFn$_invoke$arity$1(G__38663_38705) : each_fixture_fn.call(null,G__38663_38705));
} else {
}


var G__38708 = cljs.core.next(seq__38656__$1);
var G__38709 = null;
var G__38710 = (0);
var G__38711 = (0);
seq__38656 = G__38708;
chunk__38657 = G__38709;
count__38658 = G__38710;
i__38659 = G__38711;
continue;
}
} else {
