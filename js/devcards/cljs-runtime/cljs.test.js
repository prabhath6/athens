...
var G__38452 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(G__38452,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint], 0));
} else {
return G__38452;
}
}));
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq38478){
var G__38479 = cljs.core.first(seq38478);
var seq38478__$1 = cljs.core.next(seq38478);
var G__38480 = cljs.core.first(seq38478__$1);
var seq38478__$2 = cljs.core.next(seq38478__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38479,G__38480,seq38478__$2);
}));
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38511__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38511__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38511__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38510_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(p1__38510_SHARP_));
...
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__38521 = cljs.core.get_global_hierarchy;
return (fexpr__38521.cljs$core$IFn$_invoke$arity$0 ? fexpr__38521.cljs$core$IFn$_invoke$arity$0() : fexpr__38521.call(null));
})());
...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expected:",(function (){var G__38528 = new cljs.core.Keyword(null,"expected","expected",1583670997).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__38528) : formatter_fn.call(null,G__38528));
})()], 0));

return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["  actual:",(function (){var G__38529 = new cljs.core.Keyword(null,"actual","actual",107306363).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__38529) : formatter_fn.call(null,G__38529));
})()], 0));
});
...
var output_dir = "out";
var output_dir__$1 = (function (){var G__38547 = output_dir;
if((!(clojure.string.ends_with_QMARK_(output_dir,"/")))){
return [G__38547,"/"].join('');
} else {
return G__38547;
}
})();
...
var temp__5733__auto__ = ((typeof exception.stack === 'string')?(function (){var G__38576 = exception.stack;
var G__38576__$1 = (((G__38576 == null))?null:clojure.string.split_lines(G__38576));
var G__38576__$2 = (((G__38576__$1 == null))?null:cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__38576__$1,depth));
if((G__38576__$2 == null)){
return null;
} else {
return clojure.string.trim(G__38576__$2);
}
})():false);
if(cljs.core.truth_(temp__5733__auto__)){
var stack_element = temp__5733__auto__;
var fname = cljs.test.js_filename(stack_element);
var vec__38579 = cljs.test.js_line_and_column(stack_element);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38579,(0),null);
var column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38579,(1),null);
var vec__38582 = cljs.test.mapped_line_and_column(fname,line,column);
var fname__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38582,(0),null);
var line__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38582,(1),null);
var column__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38582,(2),null);
...
var m__$1 = (function (){var G__38587 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__38597 = (function (){var d = (new cljs.core.Delay(((function (fns,obj,f,xs__6292__auto__,temp__5735__auto__){
return (function (){
var G__38598 = cljs.core.rest(fns);
return (cljs.test.run_block.cljs$core$IFn$_invoke$arity$1 ? cljs.test.run_block.cljs$core$IFn$_invoke$arity$1(G__38598) : cljs.test.run_block.call(null,G__38598));
...
return (obj.cljs$core$IFn$_invoke$arity$1 ? obj.cljs$core$IFn$_invoke$arity$1(G__38597) : obj.call(null,G__38597));
} else {
var G__38677 = (function (){var G__38599 = cljs.core.rest(fns);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(obj,G__38599);
} else {
return G__38599;
}
})();
...
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4(G__38625,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e38628){var e = e38628;
var G__38629 = e;
var G__38629__$1 = (((G__38629 instanceof cljs.core.Keyword))?G__38629.fqn:null);
switch (G__38629__$1) {
...
return (function (g){
var G__38641 = (function (){
return (f2.cljs$core$IFn$_invoke$arity$1 ? f2.cljs$core$IFn$_invoke$arity$1(g) : f2.call(null,g));
});
return (f1.cljs$core$IFn$_invoke$arity$1 ? f1.cljs$core$IFn$_invoke$arity$1(G__38641) : f1.call(null,G__38641));
});
});
/**
...
var temp__5735__auto___38681 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(v));
if(cljs.core.truth_(temp__5735__auto___38681)){
var t_38682 = temp__5735__auto___38681;
var G__38662_38683 = ((function (seq__38656,chunk__38657,count__38658,i__38659,t_38682,temp__5735__auto___38681,v,each_fixture_fn,G__38653,G__38653__$1,env,once_fixtures,each_fixtures,vec__38650,ns,vars__$1){
return (function (){
return cljs.test.run_block(cljs.test.test_var_block_STAR_(v,cljs.test.disable_async(t_38682)));
});})(seq__38656,chunk__38657,count__38658,i__38659,t_38682,temp__5735__auto___38681,v,each_fixture_fn,G__38653,G__38653__$1,env,once_fixtures,each_fixtures,vec__38650,ns,vars__$1))
;
(each_fixture_fn.cljs$core$IFn$_invoke$arity$1 ? each_fixture_fn.cljs$core$IFn$_invoke$arity$1(G__38662_38683) : each_fixture_fn.call(null,G__38662_38683));
} else {
}


var G__38684 = seq__38656;
var G__38685 = chunk__38657;
var G__38686 = count__38658;
var G__38687 = (i__38659 + (1));
seq__38656 = G__38684;
chunk__38657 = G__38685;
count__38658 = G__38686;
i__38659 = G__38687;
continue;
} else {
...
var G__38688 = cljs.core.chunk_rest(seq__38656__$1);
var G__38689 = c__4609__auto__;
var G__38690 = cljs.core.count(c__4609__auto__);
var G__38691 = (0);
seq__38656 = G__38688;
chunk__38657 = G__38689;
count__38658 = G__38690;
i__38659 = G__38691;
continue;
} else {
var v = cljs.core.first(seq__38656__$1);
var temp__5735__auto___38692__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(v));
if(cljs.core.truth_(temp__5735__auto___38692__$1)){
var t_38693 = temp__5735__auto___38692__$1;
var G__38663_38694 = ((function (seq__38656,chunk__38657,count__38658,i__38659,t_38693,temp__5735__auto___38692__$1,v,seq__38656__$1,temp__5735__auto__,each_fixture_fn,G__38653,G__38653__$1,env,once_fixtures,each_fixtures,vec__38650,ns,vars__$1){
return (function (){
return cljs.test.run_block(cljs.test.test_var_block_STAR_(v,cljs.test.disable_async(t_38693)));
});})(seq__38656,chunk__38657,count__38658,i__38659,t_38693,temp__5735__auto___38692__$1,v,seq__38656__$1,temp__5735__auto__,each_fixture_fn,G__38653,G__38653__$1,env,once_fixtures,each_fixtures,vec__38650,ns,vars__$1))
;
(each_fixture_fn.cljs$core$IFn$_invoke$arity$1 ? each_fixture_fn.cljs$core$IFn$_invoke$arity$1(G__38663_38694) : each_fixture_fn.call(null,G__38663_38694));
} else {
}


var G__38696 = cljs.core.next(seq__38656__$1);
var G__38697 = null;
var G__38698 = (0);
var G__38699 = (0);
seq__38656 = G__38696;
chunk__38657 = G__38697;
count__38658 = G__38698;
i__38659 = G__38699;
continue;
}
} else {
