...
var G__38514 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(G__38514,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint], 0));
} else {
return G__38514;
}
}));
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq38519){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38520,G__38521,seq38519__$2);
}));
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38538__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38538__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38538__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38535_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(p1__38535_SHARP_));
...
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__38544 = cljs.core.get_global_hierarchy;
...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expected:",(function (){var G__38571 = new cljs.core.Keyword(null,"expected","expected",1583670997).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__38571) : formatter_fn.call(null,G__38571));
})()], 0));

return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["  actual:",(function (){var G__38572 = new cljs.core.Keyword(null,"actual","actual",107306363).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__38572) : formatter_fn.call(null,G__38572));
})()], 0));
});
...
var output_dir = "out";
var output_dir__$1 = (function (){var G__38586 = output_dir;
if((!(clojure.string.ends_with_QMARK_(output_dir,"/")))){
return [G__38586,"/"].join('');
} else {
return G__38586;
}
})();
...
var temp__5733__auto__ = ((typeof exception.stack === 'string')?(function (){var G__38615 = exception.stack;
var G__38615__$1 = (((G__38615 == null))?null:clojure.string.split_lines(G__38615));
var G__38615__$2 = (((G__38615__$1 == null))?null:cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__38615__$1,depth));
if((G__38615__$2 == null)){
return null;
} else {
return clojure.string.trim(G__38615__$2);
}
})():false);
if(cljs.core.truth_(temp__5733__auto__)){
var stack_element = temp__5733__auto__;
var fname = cljs.test.js_filename(stack_element);
var vec__38618 = cljs.test.js_line_and_column(stack_element);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38618,(0),null);
var column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38618,(1),null);
var vec__38621 = cljs.test.mapped_line_and_column(fname,line,column);
var fname__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38621,(0),null);
var line__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38621,(1),null);
var column__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38621,(2),null);
...
var m__$1 = (function (){var G__38626 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__38626__$1 = (((G__38626 instanceof cljs.core.Keyword))?G__38626.fqn:null);
switch (G__38626__$1) {
case "fail":
...
var G__38687 = (function (){var G__38638 = cljs.core.rest(fns);
...
var temp__5735__auto___38701 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(v));
if(cljs.core.truth_(temp__5735__auto___38701)){
var t_38702 = temp__5735__auto___38701;
var G__38665_38703 = ((function (seq__38659,chunk__38660,count__38661,i__38662,t_38702,temp__5735__auto___38701,v,each_fixture_fn,G__38656,G__38656__$1,env,once_fixtures,each_fixtures,vec__38653,ns,vars__$1){
return (function (){
return cljs.test.run_block(cljs.test.test_var_block_STAR_(v,cljs.test.disable_async(t_38702)));
});})(seq__38659,chunk__38660,count__38661,i__38662,t_38702,temp__5735__auto___38701,v,each_fixture_fn,G__38656,G__38656__$1,env,once_fixtures,each_fixtures,vec__38653,ns,vars__$1))
;
(each_fixture_fn.cljs$core$IFn$_invoke$arity$1 ? each_fixture_fn.cljs$core$IFn$_invoke$arity$1(G__38665_38703) : each_fixture_fn.call(null,G__38665_38703));
} else {
}


var G__38705 = seq__38659;
var G__38706 = chunk__38660;
var G__38707 = count__38661;
var G__38708 = (i__38662 + (1));
seq__38659 = G__38705;
chunk__38660 = G__38706;
count__38661 = G__38707;
i__38662 = G__38708;
continue;
} else {
...
var G__38710 = cljs.core.chunk_rest(seq__38659__$1);
var G__38711 = c__4609__auto__;
var G__38712 = cljs.core.count(c__4609__auto__);
var G__38713 = (0);
seq__38659 = G__38710;
chunk__38660 = G__38711;
count__38661 = G__38712;
i__38662 = G__38713;
continue;
} else {
var v = cljs.core.first(seq__38659__$1);
var temp__5735__auto___38714__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(v));
if(cljs.core.truth_(temp__5735__auto___38714__$1)){
var t_38715 = temp__5735__auto___38714__$1;
var G__38666_38716 = ((function (seq__38659,chunk__38660,count__38661,i__38662,t_38715,temp__5735__auto___38714__$1,v,seq__38659__$1,temp__5735__auto__,each_fixture_fn,G__38656,G__38656__$1,env,once_fixtures,each_fixtures,vec__38653,ns,vars__$1){
return (function (){
return cljs.test.run_block(cljs.test.test_var_block_STAR_(v,cljs.test.disable_async(t_38715)));
});})(seq__38659,chunk__38660,count__38661,i__38662,t_38715,temp__5735__auto___38714__$1,v,seq__38659__$1,temp__5735__auto__,each_fixture_fn,G__38656,G__38656__$1,env,once_fixtures,each_fixtures,vec__38653,ns,vars__$1))
;
(each_fixture_fn.cljs$core$IFn$_invoke$arity$1 ? each_fixture_fn.cljs$core$IFn$_invoke$arity$1(G__38666_38716) : each_fixture_fn.call(null,G__38666_38716));
} else {
}


var G__38717 = cljs.core.next(seq__38659__$1);
var G__38718 = null;
var G__38719 = (0);
var G__38720 = (0);
seq__38659 = G__38717;
chunk__38660 = G__38718;
count__38661 = G__38719;
i__38662 = G__38720;
continue;
}
} else {
