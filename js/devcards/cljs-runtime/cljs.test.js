...
var G__38505 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
...
var len__4789__auto___38669 = arguments.length;
var i__4790__auto___38670 = (0);
while(true){
if((i__4790__auto___38670 < len__4789__auto___38669)){
args__4795__auto__.push((arguments[i__4790__auto___38670]));

var G__38671 = (i__4790__auto___38670 + (1));
i__4790__auto___38670 = G__38671;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq38511){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38512,G__38513,seq38511__$2);
}));
...
var map__38526 = m;
var map__38526__$1 = (((((!((map__38526 == null))))?(((((map__38526.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__38526.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__38526):map__38526);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38526__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38526__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38526__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38524_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(p1__38524_SHARP_));
...
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__38538 = cljs.core.get_global_hierarchy;
return (fexpr__38538.cljs$core$IFn$_invoke$arity$0 ? fexpr__38538.cljs$core$IFn$_invoke$arity$0() : fexpr__38538.call(null));
})());
...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expected:",(function (){var G__38542 = new cljs.core.Keyword(null,"expected","expected",1583670997).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__38542) : formatter_fn.call(null,G__38542));
})()], 0));

return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["  actual:",(function (){var G__38543 = new cljs.core.Keyword(null,"actual","actual",107306363).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__38543) : formatter_fn.call(null,G__38543));
})()], 0));
});
...
var output_dir = "out";
var output_dir__$1 = (function (){var G__38576 = output_dir;
if((!(clojure.string.ends_with_QMARK_(output_dir,"/")))){
return [G__38576,"/"].join('');
} else {
return G__38576;
}
})();
...
var temp__5733__auto__ = ((typeof exception.stack === 'string')?(function (){var G__38588 = exception.stack;
var G__38588__$1 = (((G__38588 == null))?null:clojure.string.split_lines(G__38588));
var G__38588__$2 = (((G__38588__$1 == null))?null:cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__38588__$1,depth));
if((G__38588__$2 == null)){
return null;
} else {
return clojure.string.trim(G__38588__$2);
}
})():false);
if(cljs.core.truth_(temp__5733__auto__)){
var stack_element = temp__5733__auto__;
var fname = cljs.test.js_filename(stack_element);
var vec__38589 = cljs.test.js_line_and_column(stack_element);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38589,(0),null);
var column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38589,(1),null);
var vec__38592 = cljs.test.mapped_line_and_column(fname,line,column);
var fname__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38592,(0),null);
var line__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38592,(1),null);
var column__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38592,(2),null);
...
var G__38625 = (function (){var d = (new cljs.core.Delay(((function (fns,obj,f,xs__6292__auto__,temp__5735__auto__){
return (function (){
var G__38627 = cljs.core.rest(fns);
return (cljs.test.run_block.cljs$core$IFn$_invoke$arity$1 ? cljs.test.run_block.cljs$core$IFn$_invoke$arity$1(G__38627) : cljs.test.run_block.call(null,G__38627));
...
return (obj.cljs$core$IFn$_invoke$arity$1 ? obj.cljs$core$IFn$_invoke$arity$1(G__38625) : obj.call(null,G__38625));
} else {
var G__38678 = (function (){var G__38629 = cljs.core.rest(fns);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(obj,G__38629);
} else {
return G__38629;
}
})();
...
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4(G__38634,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e38639){var e = e38639;
var G__38640 = e;
var G__38640__$1 = (((G__38640 instanceof cljs.core.Keyword))?G__38640.fqn:null);
switch (G__38640__$1) {
...
return (f1.cljs$core$IFn$_invoke$arity$1 ? f1.cljs$core$IFn$_invoke$arity$1(G__38642) : f1.call(null,G__38642));
});
});
/**
...
var vec__38643 = fixtures_types();
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38643,(0),null);
var types = vec__38643;
...
var G__38647 = type;
var G__38648 = new cljs.core.Keyword(null,"async","async",1050769601);
var fexpr__38646 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword(null,"async","async",1050769601),new cljs.core.Keyword(null,"fn","fn",-1175266204),new cljs.core.Keyword(null,"sync","sync",-624148946),new cljs.core.Keyword("cljs.analyzer","analyzed","cljs.analyzer/analyzed",-735094162),true], null);
return (fexpr__38646.cljs$core$IFn$_invoke$arity$2 ? fexpr__38646.cljs$core$IFn$_invoke$arity$2(G__38647,G__38648) : fexpr__38646.call(null,G__38647,G__38648));
});
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__38649){
var vec__38650 = p__38649;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38650,(0),null);
var vars__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38650,(1),null);
return (function (){
return cljs.test.block((function (){var env = cljs.test.get_current_env();
var once_fixtures = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(env,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"once-fixtures","once-fixtures",1253947167),ns], null));
var each_fixtures = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(env,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"each-fixtures","each-fixtures",802243977),ns], null));
var G__38653 = cljs.test.execution_strategy(once_fixtures,each_fixtures);
...
var G__38655 = (function (){
var seq__38656 = cljs.core.seq(vars__$1);
var chunk__38657 = null;
var count__38658 = (0);
var i__38659 = (0);
while(true){
if((i__38659 < count__38658)){
var v = chunk__38657.cljs$core$IIndexed$_nth$arity$2(null,i__38659);
var temp__5735__auto___38696 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(v));
if(cljs.core.truth_(temp__5735__auto___38696)){
var t_38697 = temp__5735__auto___38696;
var G__38665_38698 = ((function (seq__38656,chunk__38657,count__38658,i__38659,t_38697,temp__5735__auto___38696,v,each_fixture_fn,G__38653,G__38653__$1,env,once_fixtures,each_fixtures,vec__38650,ns,vars__$1){
return (function (){
return cljs.test.run_block(cljs.test.test_var_block_STAR_(v,cljs.test.disable_async(t_38697)));
});})(seq__38656,chunk__38657,count__38658,i__38659,t_38697,temp__5735__auto___38696,v,each_fixture_fn,G__38653,G__38653__$1,env,once_fixtures,each_fixtures,vec__38650,ns,vars__$1))
;
(each_fixture_fn.cljs$core$IFn$_invoke$arity$1 ? each_fixture_fn.cljs$core$IFn$_invoke$arity$1(G__38665_38698) : each_fixture_fn.call(null,G__38665_38698));
} else {
}


var G__38701 = seq__38656;
var G__38702 = chunk__38657;
var G__38703 = count__38658;
var G__38704 = (i__38659 + (1));
seq__38656 = G__38701;
chunk__38657 = G__38702;
count__38658 = G__38703;
i__38659 = G__38704;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__38656);
if(temp__5735__auto__){
var seq__38656__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__38656__$1)){
var c__4609__auto__ = cljs.core.chunk_first(seq__38656__$1);
var G__38705 = cljs.core.chunk_rest(seq__38656__$1);
var G__38706 = c__4609__auto__;
var G__38707 = cljs.core.count(c__4609__auto__);
var G__38708 = (0);
seq__38656 = G__38705;
chunk__38657 = G__38706;
count__38658 = G__38707;
i__38659 = G__38708;
continue;
} else {
var v = cljs.core.first(seq__38656__$1);
var temp__5735__auto___38709__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(v));
if(cljs.core.truth_(temp__5735__auto___38709__$1)){
var t_38710 = temp__5735__auto___38709__$1;
var G__38666_38711 = ((function (seq__38656,chunk__38657,count__38658,i__38659,t_38710,temp__5735__auto___38709__$1,v,seq__38656__$1,temp__5735__auto__,each_fixture_fn,G__38653,G__38653__$1,env,once_fixtures,each_fixtures,vec__38650,ns,vars__$1){
return (function (){
return cljs.test.run_block(cljs.test.test_var_block_STAR_(v,cljs.test.disable_async(t_38710)));
});})(seq__38656,chunk__38657,count__38658,i__38659,t_38710,temp__5735__auto___38709__$1,v,seq__38656__$1,temp__5735__auto__,each_fixture_fn,G__38653,G__38653__$1,env,once_fixtures,each_fixtures,vec__38650,ns,vars__$1))
;
(each_fixture_fn.cljs$core$IFn$_invoke$arity$1 ? each_fixture_fn.cljs$core$IFn$_invoke$arity$1(G__38666_38711) : each_fixture_fn.call(null,G__38666_38711));
} else {
}


var G__38714 = cljs.core.next(seq__38656__$1);
var G__38715 = null;
var G__38716 = (0);
var G__38717 = (0);
seq__38656 = G__38714;
chunk__38657 = G__38715;
count__38658 = G__38716;
i__38659 = G__38717;
continue;
}
} else {
...
var fexpr__38654 = cljs.test.join_fixtures(once_fixtures);
return (fexpr__38654.cljs$core$IFn$_invoke$arity$1 ? fexpr__38654.cljs$core$IFn$_invoke$arity$1(G__38655) : fexpr__38654.call(null,G__38655));
})], null);

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__38653__$1)].join('')));
...
var G__38667 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"end-test-vars","end-test-vars",-1394419713),new cljs.core.Keyword(null,"vars","vars",-2046957217),vars], null);
return (cljs.test.report.cljs$core$IFn$_invoke$arity$1 ? cljs.test.report.cljs$core$IFn$_invoke$arity$1(G__38667) : cljs.test.report.call(null,G__38667));
})], null)));
});
/**
