...
var vec__32094 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(name_str__$1,/-/);
var seq__32095 = cljs.core.seq(vec__32094);
var first__32096 = cljs.core.first(seq__32095);
var seq__32095__$1 = cljs.core.next(seq__32095);
var start = first__32096;
var parts = seq__32095__$1;
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.str,start,cljs.core.map.cljs$core$IFn$_invoke$arity$2(reagent.impl.util.capitalize,parts));
}
});
...
var self__ = this;
var self__ = this;
var G__32104 = (arguments.length - (1));
switch (G__32104) {
case (0):
...
(reagent.impl.util.PartialFn.prototype.apply = (function (self__,args32103){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args32103)));
}));
