...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__52630){
var vec__52631 = p__52630;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52631,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52631,(1),null);
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__52637_SHARP_){
return (((p1__52637_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__52637_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__52638,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__52638;
}
});
...
var len__4789__auto___52668 = arguments.length;
var i__4790__auto___52669 = (0);
while(true){
if((i__4790__auto___52669 < len__4789__auto___52668)){
args__4795__auto__.push((arguments[i__4790__auto___52669]));

var G__52670 = (i__4790__auto___52669 + (1));
i__4790__auto___52669 = G__52670;
continue;
} else {
}
break;
...
var G__52640 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52640,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__52640;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq52639){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq52639));
}));
...
var vec__52643 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__52647 = cljs.core.ffirst(matches);
var fexpr__52646 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__52646.cljs$core$IFn$_invoke$arity$1 ? fexpr__52646.cljs$core$IFn$_invoke$arity$1(G__52647) : fexpr__52646.call(null,G__52647));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52643,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52643,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__52641_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__52641_SHARP_))){
return p1__52641_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__52642_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__52642_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__52661){
var vec__52662 = p__52661;
var seq__52663 = cljs.core.seq(vec__52662);
var first__52664 = cljs.core.first(seq__52663);
var seq__52663__$1 = cljs.core.next(seq__52663);
var tag = first__52664;
var content = seq__52663__$1;
...
var vec__52665 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52665,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52665,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52665,(2),null);
