...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__48490){
var vec__48491 = p__48490;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48491,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48491,(1),null);
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__48494_SHARP_){
return (((p1__48494_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__48494_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__48498,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__48498;
}
});
...
var len__4789__auto___48525 = arguments.length;
var i__4790__auto___48526 = (0);
while(true){
if((i__4790__auto___48526 < len__4789__auto___48525)){
args__4795__auto__.push((arguments[i__4790__auto___48526]));

var G__48527 = (i__4790__auto___48526 + (1));
i__4790__auto___48526 = G__48527;
continue;
} else {
}
break;
...
var G__48509 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__48509,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__48509;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq48505){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq48505));
}));
...
var vec__48512 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__48516 = cljs.core.ffirst(matches);
var fexpr__48515 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__48515.cljs$core$IFn$_invoke$arity$1 ? fexpr__48515.cljs$core$IFn$_invoke$arity$1(G__48516) : fexpr__48515.call(null,G__48516));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48512,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48512,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__48510_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__48510_SHARP_))){
return p1__48510_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__48511_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__48511_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__48518){
var vec__48519 = p__48518;
var seq__48520 = cljs.core.seq(vec__48519);
var first__48521 = cljs.core.first(seq__48520);
var seq__48520__$1 = cljs.core.next(seq__48520);
var tag = first__48521;
var content = seq__48520__$1;
...
var vec__48522 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48522,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48522,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48522,(2),null);
