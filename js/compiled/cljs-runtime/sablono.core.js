...
var iter__4582__auto__ = (function sablono$core$update_arglists_$_iter__50378(s__50379){
...
var c__4580__auto__ = cljs.core.chunk_first(s__50379__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__50381 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__50380 = (0);
while(true){
if((i__50380 < size__4581__auto__)){
var args = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__50380);
cljs.core.chunk_append(b__50381,cljs.core.vec(cljs.core.cons(new cljs.core.Symbol(null,"attr-map?","attr-map?",116307443,null),args)));

var G__50562 = (i__50380 + (1));
i__50380 = G__50562;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__50381),sablono$core$update_arglists_$_iter__50378(cljs.core.chunk_rest(s__50379__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__50381),null);
}
} else {
var args = cljs.core.first(s__50379__$2);
return cljs.core.cons(cljs.core.vec(cljs.core.cons(new cljs.core.Symbol(null,"attr-map?","attr-map?",116307443,null),args)),sablono$core$update_arglists_$_iter__50378(cljs.core.rest(s__50379__$2)));
}
} else {
return null;
}
...
/** @this {Function} */
(sablono.core.include_css.cljs$lang$applyTo = (function (seq50385){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq50385));
}));
...
var G__50411 = goog.dom.getDocument().body;
var G__50412 = (function (){var G__50413 = "script";
var G__50414 = ({"src": src});
return goog.dom.createDom(G__50413,G__50414);
})();
return goog.dom.appendChild(G__50411,G__50412);
});
/**
 ...
 */
sablono.core.link_to50417 = (function sablono$core$link_to50417(var_args){
var args__4795__auto__ = [];
...
return sablono.core.link_to50417.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__4796__auto__);
});

(sablono.core.link_to50417.cljs$core$IFn$_invoke$arity$variadic = (function (url,content){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a","a",-2123407586),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"href","href",-793805698),sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([url], 0))], null),content], null);
}));

(sablono.core.link_to50417.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(sablono.core.link_to50417.cljs$lang$applyTo = (function (seq50419){
...
sablono.core.link_to = sablono.core.wrap_attrs(sablono.core.link_to50417);
/**
...
/** @this {Function} */
(sablono.core.mail_to50428.cljs$lang$applyTo = (function (seq50429){
var G__50430 = cljs.core.first(seq50429);
var seq50429__$1 = cljs.core.next(seq50429);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50430,seq50429__$1);
}));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ol","ol",932524051),(function (){var iter__4582__auto__ = (function sablono$core$ordered_list50451_$_iter__50454(s__50455){
return (new cljs.core.LazySeq(null,(function (){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__50457),sablono$core$ordered_list50451_$_iter__50454(cljs.core.chunk_rest(s__50455__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__50457),null);
}
} else {
var x = cljs.core.first(s__50455__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),x], null),sablono$core$ordered_list50451_$_iter__50454(cljs.core.rest(s__50455__$2)));
}
} else {
return null;
}
