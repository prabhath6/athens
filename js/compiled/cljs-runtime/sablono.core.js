...
var iter__4582__auto__ = (function sablono$core$iter__50390(s__50391){
return (new cljs.core.LazySeq(null,(function (){
var s__50391__$1 = s__50391;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__50391__$1);
if(temp__5735__auto__){
var s__50391__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__50391__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__50391__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__50393 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__50392 = (0);
while(true){
if((i__50392 < size__4581__auto__)){
var style = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__50392);
cljs.core.chunk_append(b__50393,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"link","link",-1769163468),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),"text/css",new cljs.core.Keyword(null,"href","href",-793805698),sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([style], 0)),new cljs.core.Keyword(null,"rel","rel",1378823488),"stylesheet"], null)], null));

var G__50566 = (i__50392 + (1));
i__50392 = G__50566;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__50393),sablono$core$iter__50390(cljs.core.chunk_rest(s__50391__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__50393),null);
}
} else {
var style = cljs.core.first(s__50391__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"link","link",-1769163468),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),"text/css",new cljs.core.Keyword(null,"href","href",-793805698),sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([style], 0)),new cljs.core.Keyword(null,"rel","rel",1378823488),"stylesheet"], null)], null),sablono$core$iter__50390(cljs.core.rest(s__50391__$2)));
}
} else {
return null;
}
...
var G__50400 = goog.dom.getDocument().body;
var G__50401 = (function (){var G__50402 = "script";
var G__50403 = ({"src": src});
return goog.dom.createDom(G__50402,G__50403);
})();
return goog.dom.appendChild(G__50400,G__50401);
});
/**
 ...
 */
sablono.core.mail_to50420 = (function sablono$core$mail_to50420(var_args){
var args__4795__auto__ = [];
...
var argseq__4796__auto__ = ((((1) < args__4795__auto__.length))?(new cljs.core.IndexedSeq(args__4795__auto__.slice((1)),(0),null)):null);
return sablono.core.mail_to50420.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__4796__auto__);
});

(sablono.core.mail_to50420.cljs$core$IFn$_invoke$arity$variadic = (function (e_mail,p__50423){
var vec__50424 = p__50423;
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50424,(0),null);
...
(sablono.core.mail_to50420.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(sablono.core.mail_to50420.cljs$lang$applyTo = (function (seq50421){
var G__50422 = cljs.core.first(seq50421);
var seq50421__$1 = cljs.core.next(seq50421);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50422,seq50421__$1);
}));


sablono.core.mail_to = sablono.core.wrap_attrs(sablono.core.mail_to50420);
/**
 * Wrap a collection in an unordered list.
 */
sablono.core.unordered_list50428 = (function sablono$core$unordered_list50428(coll){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ul","ul",-1349521403),(function (){var iter__4582__auto__ = (function sablono$core$unordered_list50428_$_iter__50430(s__50431){
return (new cljs.core.LazySeq(null,(function (){
...
var c__4580__auto__ = cljs.core.chunk_first(s__50431__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__50433 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__50432 = (0);
while(true){
if((i__50432 < size__4581__auto__)){
var x = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__50432);
cljs.core.chunk_append(b__50433,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),x], null));

var G__50575 = (i__50432 + (1));
i__50432 = G__50575;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__50433),sablono$core$unordered_list50428_$_iter__50430(cljs.core.chunk_rest(s__50431__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__50433),null);
}
} else {
var x = cljs.core.first(s__50431__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),x], null),sablono$core$unordered_list50428_$_iter__50430(cljs.core.rest(s__50431__$2)));
}
} else {
return null;
}
...
sablono.core.unordered_list = sablono.core.wrap_attrs(sablono.core.unordered_list50428);
/**
 * Wrap a collection in an ordered list.
 */
sablono.core.ordered_list50441 = (function sablono$core$ordered_list50441(coll){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ol","ol",932524051),(function (){var iter__4582__auto__ = (function sablono$core$ordered_list50441_$_iter__50444(s__50445){
return (new cljs.core.LazySeq(null,(function (){
var s__50445__$1 = s__50445;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__50445__$1);
if(temp__5735__auto__){
var s__50445__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__50445__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__50445__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__50447 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__50446 = (0);
while(true){
if((i__50446 < size__4581__auto__)){
var x = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__50446);
cljs.core.chunk_append(b__50447,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),x], null));

var G__50577 = (i__50446 + (1));
i__50446 = G__50577;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__50447),sablono$core$ordered_list50441_$_iter__50444(cljs.core.chunk_rest(s__50445__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__50447),null);
}
} else {
var x = cljs.core.first(s__50445__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),x], null),sablono$core$ordered_list50441_$_iter__50444(cljs.core.rest(s__50445__$2)));
}
} else {
return null;
}
...
sablono.core.ordered_list = sablono.core.wrap_attrs(sablono.core.ordered_list50441);
/**
 * Create an image element.
 */
sablono.core.image50450 = (function sablono$core$image50450(var_args){
var G__50452 = arguments.length;
switch (G__50452) {
case 1:
return sablono.core.image50450.cljs$core$IFn$_invoke$arity$1((arguments[(0)]));

break;
case 2:
return sablono.core.image50450.cljs$core$IFn$_invoke$arity$2((arguments[(0)]),(arguments[(1)]));
...
(sablono.core.image50450.cljs$core$IFn$_invoke$arity$1 = (function (src){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"img","img",1442687358),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"src","src",-1651076051),sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([src], 0))], null)], null);
}));

(sablono.core.image50450.cljs$core$IFn$_invoke$arity$2 = (function (src,alt){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"img","img",1442687358),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"src","src",-1651076051),sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([src], 0)),new cljs.core.Keyword(null,"alt","alt",-3214426),alt], null)], null);
}));

(sablono.core.image50450.cljs$lang$maxFixedArity = 2);


sablono.core.image = sablono.core.wrap_attrs(sablono.core.image50450);
sablono.core._STAR_group_STAR_ = cljs.core.PersistentVector.EMPTY;
/**
 * Create a field name from the supplied argument the current field group.
 */
sablono.core.make_name = (function sablono$core$make_name(name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$2((function (p1__50459_SHARP_,p2__50460_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50459_SHARP_),"[",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p2__50460_SHARP_),"]"].join('');
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$2((function (p1__50461_SHARP_,p2__50462_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50461_SHARP_),"-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p2__50462_SHARP_)].join('');
}),cljs.core.conj.cljs$core$IFn$_invoke$arity$2(sablono.core._STAR_group_STAR_,sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([name], 0))));
});
/**
