...
var map__75735 = spec_tools.impl.parse_keys(spec_tools.impl.extract_form(spec));
var map__75735__$1 = (((((!((map__75735 == null))))?(((((map__75735.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__75735.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__75735):map__75735);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75735__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75735__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75735__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75735__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var map__75749 = spec_tools.parse.parse_spec(form);
var map__75749__$1 = (((((!((map__75749 == null))))?(((((map__75749.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__75749.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__75749):map__75749);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75749__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var G__75754 = type;
var G__75754__$1 = (((G__75754 instanceof cljs.core.Keyword))?G__75754.fqn:null);
switch (G__75754__$1) {
case "map":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__75754__$1)].join('')));
...
var vec__75765 = spec_tools.impl.strip_fn_if_needed(spec);
var ___$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75765,(0),null);
var minimum = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75765,(1),null);
var maximum = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75765,(2),null);
var ___$4 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75765,(3),null);
...
var vec__75773 = spec_tools.impl.extract_form(spec);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75773,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75773,(1),null);
...
var extra_info = (function (){var G__75776 = cljs.core.select_keys(data,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"description","description",-1428560544)], null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__75776,new cljs.core.Keyword(null,"title","title",636505583),spec_tools.impl.qualified_name(name));
} else {
return G__75776;
}
})();
