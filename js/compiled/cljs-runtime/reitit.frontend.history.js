...
(reitit.frontend.history.FragmentHistory.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k57962,else__4442__auto__){
var self__ = this;
var this__4441__auto____$1 = this;
var G__57966 = k57962;
var G__57966__$1 = (((G__57966 instanceof cljs.core.Keyword))?G__57966.fqn:null);
switch (G__57966__$1) {
case "on-navigate":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k57962,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__57967){
var vec__57968 = p__57967;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57968,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57968,(1),null);
...
(reitit.frontend.history.FragmentHistory.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__57961){
var self__ = this;
var G__57961__$1 = this;
return (new cljs.core.RecordIter((0),G__57961__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908),new cljs.core.Keyword(null,"router","router",1091916230),new cljs.core.Keyword(null,"popstate-listener","popstate-listener",806944472),new cljs.core.Keyword(null,"hashchange-listener","hashchange-listener",-1234988801),new cljs.core.Keyword(null,"last-fragment","last-fragment",-919830173)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var h__4297__auto____$1 = (function (){var fexpr__57972 = (function (coll__4436__auto__){
return (354327177 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__57972(this__4435__auto____$1);
})();
...
(reitit.frontend.history.FragmentHistory.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this57963,other57964){
var self__ = this;
var this57963__$1 = this;
return (((!((other57964 == null)))) && ((this57963__$1.constructor === other57964.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57963__$1.on_navigate,other57964.on_navigate)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57963__$1.router,other57964.router)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57963__$1.popstate_listener,other57964.popstate_listener)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57963__$1.hashchange_listener,other57964.hashchange_listener)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57963__$1.last_fragment,other57964.last_fragment)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57963__$1.__extmap,other57964.__extmap)));
}));
...
var G__57973 = reitit.frontend.match_by_path(self__.router,path);
var G__57974 = this$__$1;
return (self__.on_navigate.cljs$core$IFn$_invoke$arity$2 ? self__.on_navigate.cljs$core$IFn$_invoke$arity$2(G__57973,G__57974) : self__.on_navigate.call(null,G__57973,G__57974));
}));
...
(reitit.frontend.history.FragmentHistory.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__57961){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__57976 = cljs.core.keyword_identical_QMARK_;
var expr__57977 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__57979 = new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908);
var G__57980 = expr__57977;
return (pred__57976.cljs$core$IFn$_invoke$arity$2 ? pred__57976.cljs$core$IFn$_invoke$arity$2(G__57979,G__57980) : pred__57976.call(null,G__57979,G__57980));
})())){
return (new reitit.frontend.history.FragmentHistory(G__57961,self__.router,self__.popstate_listener,self__.hashchange_listener,self__.last_fragment,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__57981 = new cljs.core.Keyword(null,"router","router",1091916230);
var G__57982 = expr__57977;
return (pred__57976.cljs$core$IFn$_invoke$arity$2 ? pred__57976.cljs$core$IFn$_invoke$arity$2(G__57981,G__57982) : pred__57976.call(null,G__57981,G__57982));
})())){
return (new reitit.frontend.history.FragmentHistory(self__.on_navigate,G__57961,self__.popstate_listener,self__.hashchange_listener,self__.last_fragment,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__57983 = new cljs.core.Keyword(null,"popstate-listener","popstate-listener",806944472);
var G__57984 = expr__57977;
return (pred__57976.cljs$core$IFn$_invoke$arity$2 ? pred__57976.cljs$core$IFn$_invoke$arity$2(G__57983,G__57984) : pred__57976.call(null,G__57983,G__57984));
})())){
return (new reitit.frontend.history.FragmentHistory(self__.on_navigate,self__.router,G__57961,self__.hashchange_listener,self__.last_fragment,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__57985 = new cljs.core.Keyword(null,"hashchange-listener","hashchange-listener",-1234988801);
var G__57986 = expr__57977;
return (pred__57976.cljs$core$IFn$_invoke$arity$2 ? pred__57976.cljs$core$IFn$_invoke$arity$2(G__57985,G__57986) : pred__57976.call(null,G__57985,G__57986));
})())){
return (new reitit.frontend.history.FragmentHistory(self__.on_navigate,self__.router,self__.popstate_listener,G__57961,self__.last_fragment,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__57987 = new cljs.core.Keyword(null,"last-fragment","last-fragment",-919830173);
var G__57988 = expr__57977;
return (pred__57976.cljs$core$IFn$_invoke$arity$2 ? pred__57976.cljs$core$IFn$_invoke$arity$2(G__57987,G__57988) : pred__57976.call(null,G__57987,G__57988));
})())){
return (new reitit.frontend.history.FragmentHistory(self__.on_navigate,self__.router,self__.popstate_listener,self__.hashchange_listener,G__57961,self__.__meta,self__.__extmap,null));
} else {
return (new reitit.frontend.history.FragmentHistory(self__.on_navigate,self__.router,self__.popstate_listener,self__.hashchange_listener,self__.last_fragment,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__57961),null));
}
}
}
}
...
(reitit.frontend.history.FragmentHistory.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__57961){
var self__ = this;
var this__4438__auto____$1 = this;
return (new reitit.frontend.history.FragmentHistory(self__.on_navigate,self__.router,self__.popstate_listener,self__.hashchange_listener,self__.last_fragment,G__57961,self__.__extmap,self__.__hash));
}));
 ...
 */
reitit.frontend.history.map__GT_FragmentHistory = (function reitit$frontend$history$map__GT_FragmentHistory(G__57965){
var extmap__4478__auto__ = (function (){var G__57989 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__57965,new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"router","router",1091916230),new cljs.core.Keyword(null,"popstate-listener","popstate-listener",806944472),new cljs.core.Keyword(null,"hashchange-listener","hashchange-listener",-1234988801),new cljs.core.Keyword(null,"last-fragment","last-fragment",-919830173)], 0));
if(cljs.core.record_QMARK_(G__57965)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__57989);
} else {
return G__57989;
}
})();
return (new reitit.frontend.history.FragmentHistory(new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908).cljs$core$IFn$_invoke$arity$1(G__57965),new cljs.core.Keyword(null,"router","router",1091916230).cljs$core$IFn$_invoke$arity$1(G__57965),new cljs.core.Keyword(null,"popstate-listener","popstate-listener",806944472).cljs$core$IFn$_invoke$arity$1(G__57965),new cljs.core.Keyword(null,"hashchange-listener","hashchange-listener",-1234988801).cljs$core$IFn$_invoke$arity$1(G__57965),new cljs.core.Keyword(null,"last-fragment","last-fragment",-919830173).cljs$core$IFn$_invoke$arity$1(G__57965),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
