...
var G__63573 = new cljs.core.Keyword(null,"reduction-type","reduction-type",-488293450).cljs$core$IFn$_invoke$arity$1(f);
var G__63573__$1 = (((G__63573 instanceof cljs.core.Keyword))?G__63573.fqn:null);
switch (G__63573__$1) {
case "raw":
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$reduction$iter__63576(s__63577){
...
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63580,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63580,(1),null);
cljs.core.chunk_append(b__63579,(cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)));

var G__63588 = (i__63578 + (1));
i__63578 = G__63588;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__63579),instaparse$reduction$iter__63576(cljs.core.chunk_rest(s__63577__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__63579),null);
}
} else {
var vec__63583 = cljs.core.first(s__63577__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63583,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63583,(1),null);
return cljs.core.cons((cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)),instaparse$reduction$iter__63576(cljs.core.rest(s__63577__$2)));
}
} else {
return null;
}
