...
var G__52002_52030 = new cljs.core.Keyword(null,"forward-events","forward-events",1216790539);
var G__52003_52031 = (function (){var process_one_entry = (function (p__52004){
var map__52005 = p__52004;
var map__52005__$1 = (((((!((map__52005 == null))))?(((((map__52005.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__52005.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__52005):map__52005);
var m = map__52005__$1;
var unregister = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52005__$1,new cljs.core.Keyword(null,"unregister","unregister",2105339971));
var register = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52005__$1,new cljs.core.Keyword(null,"register","register",1968522516));
var events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52005__$1,new cljs.core.Keyword(null,"events","events",1792552201));
var dispatch_to = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52005__$1,new cljs.core.Keyword(null,"dispatch-to","dispatch-to",-354764401));
...
var G__52019 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(dispatch_to,event_v);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__52019) : re_frame.core.dispatch.call(null,G__52019));
} else {
return null;
}
});
...
var G__52022 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__52023 = ":forward-events expected a map or a list of maps, but got: ";
var G__52024 = val;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__52022,G__52023,G__52024) : re_frame.core.console.call(null,G__52022,G__52023,G__52024));

}
}
});
})();
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__52002_52030,G__52003_52031) : re_frame.core.reg_fx.call(null,G__52002_52030,G__52003_52031));
