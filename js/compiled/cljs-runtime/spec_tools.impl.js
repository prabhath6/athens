...
var vec__76049 = cljs.core.rest(expr);
var seq__76050 = cljs.core.seq(vec__76049);
var first__76051 = cljs.core.first(seq__76050);
var seq__76050__$1 = cljs.core.next(seq__76050);
var vec__76052 = first__76051;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76052,(0),null);
var form = seq__76050__$1;
...
var G__76055 = x;
var G__76055__$1 = (((G__76055 == null))?null:spec_tools.impl.polish(G__76055));
var G__76055__$2 = (((G__76055__$1 == null))?null:cljs.core.name(G__76055__$1));
if((G__76055__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__76055__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__76056 = x;
var G__76056__$1 = (((G__76056 == null))?null:cljs.core.name(G__76056));
if((G__76056__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__76056__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__76057){
...
var data = map__76058__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76058__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76058__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76058__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76058__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__76060){
var map__76061 = p__76060;
var map__76061__$1 = (((((!((map__76061 == null))))?(((((map__76061.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__76061.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__76061):map__76061);
var data = map__76061__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76061__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76061__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__76063 = data;
var G__76063__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__76063,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__76063);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__76063__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__76063__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__76067 = form;
var G__76067__$1 = (((G__76067 == null))?null:cljs.core.rest(G__76067));
if((G__76067__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__76067__$1);
}
})();
var G__76068 = m;
var G__76068__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__76068,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__76064_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__76064_SHARP_)));
})):G__76068);
var G__76068__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__76068__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__76065_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__76065_SHARP_)));
})):G__76068__$1);
var G__76068__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__76068__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__76066_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__76066_SHARP_));
})):G__76068__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__76068__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__76069 = (function (){var G__76070 = form;
var G__76070__$1 = (((G__76070 == null))?null:cljs.core.rest(G__76070));
if((G__76070__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__76070__$1);
}
})();
var map__76069__$1 = (((((!((map__76069 == null))))?(((((map__76069.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__76069.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__76069):map__76069);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76069__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76069__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76069__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76069__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__76072 = (((kw instanceof cljs.core.Symbol))?cljs.core.namespace(kw):false);
switch (G__76072) {
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__76073 = form;
var G__76073__$1 = (((G__76073 == null))?null:cljs.core.seq(G__76073));
var G__76073__$2 = (((G__76073__$1 == null))?null:cljs.core.first(G__76073__$1));
if((G__76073__$2 == null)){
return null;
} else {
var fexpr__76074 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__76074.cljs$core$IFn$_invoke$arity$1 ? fexpr__76074.cljs$core$IFn$_invoke$arity$1(G__76073__$2) : fexpr__76074.call(null,G__76073__$2));
}
})():null));
});
/**
...
var len__4789__auto___76114 = arguments.length;
var i__4790__auto___76115 = (0);
while(true){
if((i__4790__auto___76115 < len__4789__auto___76114)){
args__4795__auto__.push((arguments[i__4790__auto___76115]));

var G__76116 = (i__4790__auto___76115 + (1));
i__4790__auto___76115 = G__76116;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq76075){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq76075));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__76076){
var vec__76077 = p__76076;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76077,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76077,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__76090){
var map__76091 = p__76090;
var map__76091__$1 = (((((!((map__76091 == null))))?(((((map__76091.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__76091.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__76091):map__76091);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76091__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76091__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76091__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76091__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__76088_SHARP_){
return cljs.core.map_QMARK_(p1__76088_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__76089_SHARP_){
return cljs.core.contains_QMARK_(p1__76089_SHARP_,x);
});
}),req_keys));
