...
var vec__55010 = cljs.core.rest(expr);
var seq__55011 = cljs.core.seq(vec__55010);
var first__55012 = cljs.core.first(seq__55011);
var seq__55011__$1 = cljs.core.next(seq__55011);
var vec__55013 = first__55012;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55013,(0),null);
var form = seq__55011__$1;
...
var G__55016 = x;
var G__55016__$1 = (((G__55016 == null))?null:spec_tools.impl.polish(G__55016));
var G__55016__$2 = (((G__55016__$1 == null))?null:cljs.core.name(G__55016__$1));
if((G__55016__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__55016__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__55017 = x;
var G__55017__$1 = (((G__55017 == null))?null:cljs.core.name(G__55017));
if((G__55017__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__55017__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__55018){
...
var data = map__55019__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55019__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55019__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55019__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55019__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__55021){
var map__55022 = p__55021;
var map__55022__$1 = (((((!((map__55022 == null))))?(((((map__55022.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__55022.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__55022):map__55022);
var data = map__55022__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55022__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55022__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__55024 = data;
var G__55024__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__55024,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__55024);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__55024__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__55024__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__55028 = form;
var G__55028__$1 = (((G__55028 == null))?null:cljs.core.rest(G__55028));
if((G__55028__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__55028__$1);
}
})();
var G__55029 = m;
var G__55029__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__55029,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__55025_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__55025_SHARP_)));
})):G__55029);
var G__55029__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__55029__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__55026_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__55026_SHARP_)));
})):G__55029__$1);
var G__55029__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__55029__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__55027_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__55027_SHARP_));
})):G__55029__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__55029__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__55030 = (function (){var G__55031 = form;
var G__55031__$1 = (((G__55031 == null))?null:cljs.core.rest(G__55031));
if((G__55031__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__55031__$1);
}
})();
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55030__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55030__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55030__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55030__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__55033 = (((kw instanceof cljs.core.Symbol))?cljs.core.namespace(kw):false);
switch (G__55033) {
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__55034 = form;
var G__55034__$1 = (((G__55034 == null))?null:cljs.core.seq(G__55034));
var G__55034__$2 = (((G__55034__$1 == null))?null:cljs.core.first(G__55034__$1));
if((G__55034__$2 == null)){
return null;
} else {
var fexpr__55035 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__55035.cljs$core$IFn$_invoke$arity$1 ? fexpr__55035.cljs$core$IFn$_invoke$arity$1(G__55034__$2) : fexpr__55035.call(null,G__55034__$2));
}
})():null));
});
/**
...
var len__4789__auto___55056 = arguments.length;
var i__4790__auto___55057 = (0);
while(true){
if((i__4790__auto___55057 < len__4789__auto___55056)){
args__4795__auto__.push((arguments[i__4790__auto___55057]));

var G__55058 = (i__4790__auto___55057 + (1));
i__4790__auto___55057 = G__55058;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq55036){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq55036));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__55037){
var vec__55038 = p__55037;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55038,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55038,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__55043){
var map__55044 = p__55043;
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55044__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55044__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55044__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55044__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__55041_SHARP_){
return cljs.core.map_QMARK_(p1__55041_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__55042_SHARP_){
return cljs.core.contains_QMARK_(p1__55042_SHARP_,x);
});
}),req_keys));
