...
var G__57945_57970 = new cljs.core.Keyword(null,"current-route","current-route",2067529448);
var G__57946_57971 = (function (db){
return new cljs.core.Keyword(null,"current-route","current-route",2067529448).cljs$core$IFn$_invoke$arity$1(db);
});
(re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$2(G__57945_57970,G__57946_57971) : re_frame.core.reg_sub.call(null,G__57945_57970,G__57946_57971));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"navigate","navigate",657596805),(function (_,p__57947){
...
var ___$1 = first__57950;
var route = seq__57949__$1;
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"navigate!","navigate!",79998348),route], null);
}));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"navigated","navigated",540897836),(function (p__57951,p__57952){
var map__57953 = p__57951;
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57953__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__57954 = p__57952;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57954,(0),null);
var new_match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57954,(1),null);
...
var node = (function (){var G__57958 = athens.db.dsdb;
var G__57959 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__57960 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"path-params","path-params",-48130597).cljs$core$IFn$_invoke$arity$1(new_match))], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__57958,G__57959,G__57960) : posh.reagent.pull.call(null,G__57958,G__57959,G__57960));
})();
...
var G__57962_57973 = new cljs.core.Keyword(null,"navigate!","navigate!",79998348);
var G__57963_57974 = ((day8.re_frame.tracing.is_trace_enabled_QMARK_())?(function (route){
...
return result__54397__auto__;
}catch (e57964){var e = e57964;
throw e;
}}):(function (route){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(reitit.frontend.easy.push_state,route);
}));
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__57962_57973,G__57963_57974) : re_frame.core.reg_fx.call(null,G__57962_57973,G__57963_57974));
...
var G__57966 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigated","navigated",540897836),new_match], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__57966) : re_frame.core.dispatch.call(null,G__57966));
} else {
return null;
}
});
athens.router.navigate = (function athens$router$navigate(page){
var G__57968 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigate","navigate",657596805),page], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__57968) : re_frame.core.dispatch.call(null,G__57968));
});
athens.router.navigate_uid = (function athens$router$navigate_uid(uid){
var G__57969 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigate","navigate",657596805),new cljs.core.Keyword(null,"page","page",849072397),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),uid], null)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__57969) : re_frame.core.dispatch.call(null,G__57969));
});
