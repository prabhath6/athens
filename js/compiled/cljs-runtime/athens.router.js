...
var G__53501_53535 = new cljs.core.Keyword(null,"current-route","current-route",2067529448);
var G__53502_53536 = (function (db){
return new cljs.core.Keyword(null,"current-route","current-route",2067529448).cljs$core$IFn$_invoke$arity$1(db);
});
(re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$2(G__53501_53535,G__53502_53536) : re_frame.core.reg_sub.call(null,G__53501_53535,G__53502_53536));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"navigate","navigate",657596805),(function (_,p__53503){
var vec__53504 = p__53503;
var seq__53505 = cljs.core.seq(vec__53504);
var first__53506 = cljs.core.first(seq__53505);
var seq__53505__$1 = cljs.core.next(seq__53505);
var ___$1 = first__53506;
var route = seq__53505__$1;
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"navigate!","navigate!",79998348),route], null);
}));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"navigated","navigated",540897836),(function (p__53507,p__53508){
var map__53509 = p__53507;
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53509__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__53511 = p__53508;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53511,(0),null);
var new_match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53511,(1),null);
...
var node = (function (){var G__53515 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"node","node",581201198),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"path-params","path-params",-48130597).cljs$core$IFn$_invoke$arity$1(new_match))], null)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__53515) : re_frame.core.subscribe.call(null,G__53515));
})();
...
var G__53516_53549 = new cljs.core.Keyword(null,"navigate!","navigate!",79998348);
var G__53517_53550 = ((day8.re_frame.tracing.is_trace_enabled_QMARK_())?(function (route){
...
return result__47115__auto__;
}catch (e53522){var e = e53522;
throw e;
}}):(function (route){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(reitit.frontend.easy.push_state,route);
}));
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__53516_53549,G__53517_53550) : re_frame.core.reg_fx.call(null,G__53516_53549,G__53517_53550));
...
var G__53523 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigated","navigated",540897836),new_match], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__53523) : re_frame.core.dispatch.call(null,G__53523));
} else {
return null;
}
});
athens.router.navigate = (function athens$router$navigate(page){
var G__53524 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigate","navigate",657596805),page], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__53524) : re_frame.core.dispatch.call(null,G__53524));
});
athens.router.navigate_page = (function athens$router$navigate_page(uid){
var G__53525 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigate","navigate",657596805),new cljs.core.Keyword(null,"page","page",849072397),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),uid], null)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__53525) : re_frame.core.dispatch.call(null,G__53525));
});
athens.router.toggle_open = (function athens$router$toggle_open(dbid,open){
var G__53528 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","toggle-open","block/toggle-open",2080151710),dbid,open], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__53528) : re_frame.core.dispatch.call(null,G__53528));
});
