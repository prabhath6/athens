...
var G__58018_58040 = new cljs.core.Keyword(null,"current-route","current-route",2067529448);
var G__58019_58041 = (function (db){
return new cljs.core.Keyword(null,"current-route","current-route",2067529448).cljs$core$IFn$_invoke$arity$1(db);
});
(re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$2(G__58018_58040,G__58019_58041) : re_frame.core.reg_sub.call(null,G__58018_58040,G__58019_58041));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"navigate","navigate",657596805),(function (_,p__58020){
var vec__58021 = p__58020;
var seq__58022 = cljs.core.seq(vec__58021);
var first__58023 = cljs.core.first(seq__58022);
var seq__58022__$1 = cljs.core.next(seq__58022);
var ___$1 = first__58023;
var route = seq__58022__$1;
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"navigate!","navigate!",79998348),route], null);
}));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"navigated","navigated",540897836),(function (p__58024,p__58025){
var map__58026 = p__58024;
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58026__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__58027 = p__58025;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58027,(0),null);
var new_match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58027,(1),null);
...
var node = (function (){var G__58031 = athens.db.dsdb;
var G__58032 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__58033 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"path-params","path-params",-48130597).cljs$core$IFn$_invoke$arity$1(new_match))], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__58031,G__58032,G__58033) : posh.reagent.pull.call(null,G__58031,G__58032,G__58033));
})();
...
var G__58034_58043 = new cljs.core.Keyword(null,"navigate!","navigate!",79998348);
var G__58035_58044 = ((day8.re_frame.tracing.is_trace_enabled_QMARK_())?(function (route){
...
return result__54397__auto__;
}catch (e58036){var e = e58036;
throw e;
}}):(function (route){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(reitit.frontend.easy.push_state,route);
}));
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__58034_58043,G__58035_58044) : re_frame.core.reg_fx.call(null,G__58034_58043,G__58035_58044));
...
var G__58037 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigated","navigated",540897836),new_match], null);
...
var G__58038 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigate","navigate",657596805),page], null);
...
var G__58039 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigate","navigate",657596805),new cljs.core.Keyword(null,"page","page",849072397),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),uid], null)], null);
