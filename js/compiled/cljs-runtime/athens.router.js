...
var G__58044_58066 = new cljs.core.Keyword(null,"current-route","current-route",2067529448);
var G__58045_58067 = (function (db){
return new cljs.core.Keyword(null,"current-route","current-route",2067529448).cljs$core$IFn$_invoke$arity$1(db);
});
(re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$2(G__58044_58066,G__58045_58067) : re_frame.core.reg_sub.call(null,G__58044_58066,G__58045_58067));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"navigate","navigate",657596805),(function (_,p__58046){
var vec__58047 = p__58046;
var seq__58048 = cljs.core.seq(vec__58047);
var first__58049 = cljs.core.first(seq__58048);
var seq__58048__$1 = cljs.core.next(seq__58048);
var ___$1 = first__58049;
var route = seq__58048__$1;
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"navigate!","navigate!",79998348),route], null);
}));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"navigated","navigated",540897836),(function (p__58050,p__58051){
var map__58052 = p__58050;
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58052__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__58053 = p__58051;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58053,(0),null);
var new_match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58053,(1),null);
...
var node = (function (){var G__58057 = athens.db.dsdb;
var G__58058 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__58059 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"path-params","path-params",-48130597).cljs$core$IFn$_invoke$arity$1(new_match))], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__58057,G__58058,G__58059) : posh.reagent.pull.call(null,G__58057,G__58058,G__58059));
})();
...
var G__58060_58068 = new cljs.core.Keyword(null,"navigate!","navigate!",79998348);
var G__58061_58069 = ((day8.re_frame.tracing.is_trace_enabled_QMARK_())?(function (route){
...
return result__54392__auto__;
}catch (e58062){var e = e58062;
throw e;
}}):(function (route){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(reitit.frontend.easy.push_state,route);
}));
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__58060_58068,G__58061_58069) : re_frame.core.reg_fx.call(null,G__58060_58068,G__58061_58069));
...
var G__58063 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigated","navigated",540897836),new_match], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__58063) : re_frame.core.dispatch.call(null,G__58063));
} else {
return null;
}
});
athens.router.navigate = (function athens$router$navigate(page){
var G__58064 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigate","navigate",657596805),page], null);
...
var G__58065 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigate","navigate",657596805),new cljs.core.Keyword(null,"page","page",849072397),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),uid], null)], null);
