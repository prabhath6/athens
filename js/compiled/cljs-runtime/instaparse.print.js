...
if(cljs.core.truth_(((cljs.core.not(hidden_QMARK_))?(function (){var G__63499 = (function (){var G__63500 = new cljs.core.Keyword(null,"tag","tag",-1290361223);
return (parser.cljs$core$IFn$_invoke$arity$1 ? parser.cljs$core$IFn$_invoke$arity$1(G__63500) : parser.call(null,G__63500));
})();
return (tag_set.cljs$core$IFn$_invoke$arity$1 ? tag_set.cljs$core$IFn$_invoke$arity$1(G__63499) : tag_set.call(null,G__63499));
})():false))){
...
instaparse.print.char_range__GT_str = (function instaparse$print$char_range__GT_str(p__63502){
var map__63503 = p__63502;
var map__63503__$1 = (((((!((map__63503 == null))))?(((((map__63503.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__63503.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__63503):map__63503);
var lo = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63503__$1,new cljs.core.Keyword(null,"lo","lo",-931799889));
var hi = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63503__$1,new cljs.core.Keyword(null,"hi","hi",-1821422114));
...
(instaparse.print.combinators__GT_str.cljs$core$IFn$_invoke$arity$2 = (function (p__63507,hidden_QMARK_){
...
var p = map__63508__$1;
var parser = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63508__$1,new cljs.core.Keyword(null,"parser","parser",-1543495310));
var parser1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63508__$1,new cljs.core.Keyword(null,"parser1","parser1",-439601422));
var parser2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63508__$1,new cljs.core.Keyword(null,"parser2","parser2",1013754688));
var parsers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63508__$1,new cljs.core.Keyword(null,"parsers","parsers",-804353827));
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63508__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
...
var G__63510 = tag;
var G__63510__$1 = (((G__63510 instanceof cljs.core.Keyword))?G__63510.fqn:null);
switch (G__63510__$1) {
case "epsilon":
return "\u03B5";
...
var _STAR_print_newline_STAR__orig_val__63511_63535 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__63512_63536 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__63513_63537 = true;
var _STAR_print_fn_STAR__temp_val__63514_63538 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__63513_63537);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__63514_63538);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__63512_63536);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__63511_63535);
}
...
case "string-ci":
var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__63515_63539 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__63516_63540 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__63517_63541 = true;
var _STAR_print_fn_STAR__temp_val__63518_63542 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__63517_63541);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__63518_63542);

try{cljs.core.pr.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"string","string",-1989541586).cljs$core$IFn$_invoke$arity$1(p)], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__63516_63540);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__63515_63539);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__63510__$1)].join('')));
 ...
 */
instaparse.print.Parser__GT_str = (function instaparse$print$Parser__GT_str(p__63519){
...
var grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63520__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63520__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.cons(instaparse.print.rule__GT_str(start,(grammar.cljs$core$IFn$_invoke$arity$1 ? grammar.cljs$core$IFn$_invoke$arity$1(start) : grammar.call(null,start))),(function (){var iter__4582__auto__ = (function instaparse$print$Parser__GT_str_$_iter__63522(s__63523){
return (new cljs.core.LazySeq(null,(function (){
var s__63523__$1 = s__63523;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__63523__$1);
if(temp__5735__auto__){
var s__63523__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__63523__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__63523__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__63525 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__63524 = (0);
while(true){
if((i__63524 < size__4581__auto__)){
var vec__63526 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__63524);
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63526,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63526,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
cljs.core.chunk_append(b__63525,instaparse.print.rule__GT_str(non_terminal,parser));

var G__63550 = (i__63524 + (1));
i__63524 = G__63550;
continue;
} else {
var G__63551 = (i__63524 + (1));
i__63524 = G__63551;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__63525),instaparse$print$Parser__GT_str_$_iter__63522(cljs.core.chunk_rest(s__63523__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__63525),null);
}
} else {
var vec__63529 = cljs.core.first(s__63523__$2);
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63529,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63529,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
return cljs.core.cons(instaparse.print.rule__GT_str(non_terminal,parser),instaparse$print$Parser__GT_str_$_iter__63522(cljs.core.rest(s__63523__$2)));
} else {
var G__63556 = cljs.core.rest(s__63523__$2);
s__63523__$1 = G__63556;
continue;
}
}
} else {
