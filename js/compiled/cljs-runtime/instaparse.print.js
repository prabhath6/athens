...
if(cljs.core.truth_(((cljs.core.not(hidden_QMARK_))?(function (){var G__63464 = (function (){var G__63465 = new cljs.core.Keyword(null,"tag","tag",-1290361223);
return (parser.cljs$core$IFn$_invoke$arity$1 ? parser.cljs$core$IFn$_invoke$arity$1(G__63465) : parser.call(null,G__63465));
})();
return (tag_set.cljs$core$IFn$_invoke$arity$1 ? tag_set.cljs$core$IFn$_invoke$arity$1(G__63464) : tag_set.call(null,G__63464));
})():false))){
...
instaparse.print.char_range__GT_str = (function instaparse$print$char_range__GT_str(p__63470){
...
var lo = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63471__$1,new cljs.core.Keyword(null,"lo","lo",-931799889));
var hi = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63471__$1,new cljs.core.Keyword(null,"hi","hi",-1821422114));
...
(instaparse.print.combinators__GT_str.cljs$core$IFn$_invoke$arity$2 = (function (p__63475,hidden_QMARK_){
var map__63476 = p__63475;
var map__63476__$1 = (((((!((map__63476 == null))))?(((((map__63476.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__63476.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__63476):map__63476);
var p = map__63476__$1;
var parser = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63476__$1,new cljs.core.Keyword(null,"parser","parser",-1543495310));
var parser1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63476__$1,new cljs.core.Keyword(null,"parser1","parser1",-439601422));
var parser2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63476__$1,new cljs.core.Keyword(null,"parser2","parser2",1013754688));
var parsers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63476__$1,new cljs.core.Keyword(null,"parsers","parsers",-804353827));
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63476__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
...
var G__63478 = tag;
var G__63478__$1 = (((G__63478 instanceof cljs.core.Keyword))?G__63478.fqn:null);
switch (G__63478__$1) {
case "epsilon":
return "\u03B5";
...
var _STAR_print_newline_STAR__orig_val__63479_63510 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__63480_63511 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__63481_63512 = true;
var _STAR_print_fn_STAR__temp_val__63482_63513 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__63481_63512);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__63482_63513);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__63480_63511);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__63479_63510);
}
...
case "string-ci":
var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__63483_63514 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__63484_63515 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__63485_63516 = true;
var _STAR_print_fn_STAR__temp_val__63486_63517 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__63485_63516);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__63486_63517);

try{cljs.core.pr.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"string","string",-1989541586).cljs$core$IFn$_invoke$arity$1(p)], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__63484_63515);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__63483_63514);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__63478__$1)].join('')));
 ...
 */
instaparse.print.Parser__GT_str = (function instaparse$print$Parser__GT_str(p__63487){
var map__63488 = p__63487;
...
var grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63488__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63488__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.cons(instaparse.print.rule__GT_str(start,(grammar.cljs$core$IFn$_invoke$arity$1 ? grammar.cljs$core$IFn$_invoke$arity$1(start) : grammar.call(null,start))),(function (){var iter__4582__auto__ = (function instaparse$print$Parser__GT_str_$_iter__63491(s__63492){
...
var vec__63497 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__63493);
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63497,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63497,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
cljs.core.chunk_append(b__63494,instaparse.print.rule__GT_str(non_terminal,parser));

var G__63519 = (i__63493 + (1));
i__63493 = G__63519;
continue;
} else {
var G__63520 = (i__63493 + (1));
i__63493 = G__63520;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__63494),instaparse$print$Parser__GT_str_$_iter__63491(cljs.core.chunk_rest(s__63492__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__63494),null);
}
} else {
var vec__63500 = cljs.core.first(s__63492__$2);
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63500,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63500,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
return cljs.core.cons(instaparse.print.rule__GT_str(non_terminal,parser),instaparse$print$Parser__GT_str_$_iter__63491(cljs.core.rest(s__63492__$2)));
} else {
var G__63521 = cljs.core.rest(s__63492__$2);
s__63492__$1 = G__63521;
continue;
}
}
} else {
