...
if(cljs.core.truth_(((cljs.core.not(hidden_QMARK_))?(function (){var G__63412 = (function (){var G__63413 = new cljs.core.Keyword(null,"tag","tag",-1290361223);
return (parser.cljs$core$IFn$_invoke$arity$1 ? parser.cljs$core$IFn$_invoke$arity$1(G__63413) : parser.call(null,G__63413));
})();
return (tag_set.cljs$core$IFn$_invoke$arity$1 ? tag_set.cljs$core$IFn$_invoke$arity$1(G__63412) : tag_set.call(null,G__63412));
})():false))){
...
instaparse.print.char_range__GT_str = (function instaparse$print$char_range__GT_str(p__63415){
var map__63416 = p__63415;
var map__63416__$1 = (((((!((map__63416 == null))))?(((((map__63416.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__63416.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__63416):map__63416);
var lo = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63416__$1,new cljs.core.Keyword(null,"lo","lo",-931799889));
var hi = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63416__$1,new cljs.core.Keyword(null,"hi","hi",-1821422114));
...
(instaparse.print.combinators__GT_str.cljs$core$IFn$_invoke$arity$2 = (function (p__63420,hidden_QMARK_){
...
var p = map__63421__$1;
var parser = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63421__$1,new cljs.core.Keyword(null,"parser","parser",-1543495310));
var parser1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63421__$1,new cljs.core.Keyword(null,"parser1","parser1",-439601422));
var parser2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63421__$1,new cljs.core.Keyword(null,"parser2","parser2",1013754688));
var parsers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63421__$1,new cljs.core.Keyword(null,"parsers","parsers",-804353827));
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63421__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
...
var G__63423 = tag;
var G__63423__$1 = (((G__63423 instanceof cljs.core.Keyword))?G__63423.fqn:null);
switch (G__63423__$1) {
case "epsilon":
return "\u03B5";
...
var _STAR_print_newline_STAR__orig_val__63424_63459 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__63425_63460 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__63426_63461 = true;
var _STAR_print_fn_STAR__temp_val__63427_63462 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__63426_63461);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__63427_63462);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__63425_63460);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__63424_63459);
}
...
case "string-ci":
var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__63428_63463 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__63429_63464 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__63430_63465 = true;
var _STAR_print_fn_STAR__temp_val__63431_63466 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__63430_63465);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__63431_63466);

try{cljs.core.pr.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"string","string",-1989541586).cljs$core$IFn$_invoke$arity$1(p)], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__63429_63464);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__63428_63463);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__63423__$1)].join('')));
 ...
 */
instaparse.print.Parser__GT_str = (function instaparse$print$Parser__GT_str(p__63438){
...
var grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63439__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63439__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.cons(instaparse.print.rule__GT_str(start,(grammar.cljs$core$IFn$_invoke$arity$1 ? grammar.cljs$core$IFn$_invoke$arity$1(start) : grammar.call(null,start))),(function (){var iter__4582__auto__ = (function instaparse$print$Parser__GT_str_$_iter__63443(s__63444){
return (new cljs.core.LazySeq(null,(function (){
var s__63444__$1 = s__63444;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__63444__$1);
if(temp__5735__auto__){
var s__63444__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__63444__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__63444__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__63446 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__63445 = (0);
while(true){
if((i__63445 < size__4581__auto__)){
var vec__63449 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__63445);
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63449,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63449,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
cljs.core.chunk_append(b__63446,instaparse.print.rule__GT_str(non_terminal,parser));

var G__63474 = (i__63445 + (1));
i__63445 = G__63474;
continue;
} else {
var G__63475 = (i__63445 + (1));
i__63445 = G__63475;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__63446),instaparse$print$Parser__GT_str_$_iter__63443(cljs.core.chunk_rest(s__63444__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__63446),null);
}
} else {
var vec__63453 = cljs.core.first(s__63444__$2);
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63453,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63453,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
return cljs.core.cons(instaparse.print.rule__GT_str(non_terminal,parser),instaparse$print$Parser__GT_str_$_iter__63443(cljs.core.rest(s__63444__$2)));
} else {
var G__63476 = cljs.core.rest(s__63444__$2);
s__63444__$1 = G__63476;
continue;
}
}
} else {
