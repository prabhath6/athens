...
if(cljs.core.truth_(((cljs.core.not(hidden_QMARK_))?(function (){var G__63347 = (function (){var G__63348 = new cljs.core.Keyword(null,"tag","tag",-1290361223);
return (parser.cljs$core$IFn$_invoke$arity$1 ? parser.cljs$core$IFn$_invoke$arity$1(G__63348) : parser.call(null,G__63348));
})();
return (tag_set.cljs$core$IFn$_invoke$arity$1 ? tag_set.cljs$core$IFn$_invoke$arity$1(G__63347) : tag_set.call(null,G__63347));
})():false))){
...
instaparse.print.char_range__GT_str = (function instaparse$print$char_range__GT_str(p__63353){
...
var lo = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63354__$1,new cljs.core.Keyword(null,"lo","lo",-931799889));
var hi = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63354__$1,new cljs.core.Keyword(null,"hi","hi",-1821422114));
...
(instaparse.print.combinators__GT_str.cljs$core$IFn$_invoke$arity$2 = (function (p__63358,hidden_QMARK_){
...
var p = map__63359__$1;
var parser = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63359__$1,new cljs.core.Keyword(null,"parser","parser",-1543495310));
var parser1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63359__$1,new cljs.core.Keyword(null,"parser1","parser1",-439601422));
var parser2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63359__$1,new cljs.core.Keyword(null,"parser2","parser2",1013754688));
var parsers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63359__$1,new cljs.core.Keyword(null,"parsers","parsers",-804353827));
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63359__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
...
var G__63361 = tag;
var G__63361__$1 = (((G__63361 instanceof cljs.core.Keyword))?G__63361.fqn:null);
switch (G__63361__$1) {
case "epsilon":
return "\u03B5";
...
var _STAR_print_newline_STAR__orig_val__63362_63393 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__63363_63394 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__63364_63395 = true;
var _STAR_print_fn_STAR__temp_val__63365_63396 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__63364_63395);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__63365_63396);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__63363_63394);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__63362_63393);
}
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__63361__$1)].join('')));
 ...
 */
instaparse.print.Parser__GT_str = (function instaparse$print$Parser__GT_str(p__63371){
var map__63372 = p__63371;
var map__63372__$1 = (((((!((map__63372 == null))))?(((((map__63372.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__63372.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__63372):map__63372);
var grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63372__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63372__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.cons(instaparse.print.rule__GT_str(start,(grammar.cljs$core$IFn$_invoke$arity$1 ? grammar.cljs$core$IFn$_invoke$arity$1(start) : grammar.call(null,start))),(function (){var iter__4582__auto__ = (function instaparse$print$Parser__GT_str_$_iter__63376(s__63377){
return (new cljs.core.LazySeq(null,(function (){
var s__63377__$1 = s__63377;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__63377__$1);
if(temp__5735__auto__){
var s__63377__$2 = temp__5735__auto__;
...
var vec__63380 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__63378);
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63380,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63380,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
cljs.core.chunk_append(b__63379,instaparse.print.rule__GT_str(non_terminal,parser));

var G__63402 = (i__63378 + (1));
i__63378 = G__63402;
continue;
} else {
var G__63403 = (i__63378 + (1));
i__63378 = G__63403;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__63379),instaparse$print$Parser__GT_str_$_iter__63376(cljs.core.chunk_rest(s__63377__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__63379),null);
}
} else {
var vec__63383 = cljs.core.first(s__63377__$2);
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63383,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63383,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
return cljs.core.cons(instaparse.print.rule__GT_str(non_terminal,parser),instaparse$print$Parser__GT_str_$_iter__63376(cljs.core.rest(s__63377__$2)));
} else {
var G__63404 = cljs.core.rest(s__63377__$2);
s__63377__$1 = G__63404;
continue;
}
}
} else {
