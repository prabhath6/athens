...
if(cljs.core.truth_(((cljs.core.not(hidden_QMARK_))?(function (){var G__73335 = (function (){var G__73336 = new cljs.core.Keyword(null,"tag","tag",-1290361223);
return (parser.cljs$core$IFn$_invoke$arity$1 ? parser.cljs$core$IFn$_invoke$arity$1(G__73336) : parser.call(null,G__73336));
})();
return (tag_set.cljs$core$IFn$_invoke$arity$1 ? tag_set.cljs$core$IFn$_invoke$arity$1(G__73335) : tag_set.call(null,G__73335));
})():false))){
...
instaparse.print.char_range__GT_str = (function instaparse$print$char_range__GT_str(p__73340){
var map__73341 = p__73340;
var map__73341__$1 = (((((!((map__73341 == null))))?(((((map__73341.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__73341.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__73341):map__73341);
var lo = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73341__$1,new cljs.core.Keyword(null,"lo","lo",-931799889));
var hi = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73341__$1,new cljs.core.Keyword(null,"hi","hi",-1821422114));
...
(instaparse.print.combinators__GT_str.cljs$core$IFn$_invoke$arity$2 = (function (p__73362,hidden_QMARK_){
var map__73363 = p__73362;
var map__73363__$1 = (((((!((map__73363 == null))))?(((((map__73363.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__73363.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__73363):map__73363);
var p = map__73363__$1;
var parser = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73363__$1,new cljs.core.Keyword(null,"parser","parser",-1543495310));
var parser1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73363__$1,new cljs.core.Keyword(null,"parser1","parser1",-439601422));
var parser2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73363__$1,new cljs.core.Keyword(null,"parser2","parser2",1013754688));
var parsers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73363__$1,new cljs.core.Keyword(null,"parsers","parsers",-804353827));
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73363__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
...
var _STAR_print_newline_STAR__orig_val__73366_73420 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__73367_73421 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__73368_73422 = true;
var _STAR_print_fn_STAR__temp_val__73369_73423 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__73368_73422);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__73369_73423);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__73367_73421);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__73366_73420);
}
...
case "string-ci":
var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__73370_73427 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__73371_73428 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__73372_73429 = true;
var _STAR_print_fn_STAR__temp_val__73373_73430 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__73372_73429);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__73373_73430);

try{cljs.core.pr.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"string","string",-1989541586).cljs$core$IFn$_invoke$arity$1(p)], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__73371_73428);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__73370_73427);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__73365__$1)].join('')));
 ...
 */
instaparse.print.Parser__GT_str = (function instaparse$print$Parser__GT_str(p__73376){
var map__73377 = p__73376;
var map__73377__$1 = (((((!((map__73377 == null))))?(((((map__73377.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__73377.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__73377):map__73377);
var grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73377__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73377__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.cons(instaparse.print.rule__GT_str(start,(grammar.cljs$core$IFn$_invoke$arity$1 ? grammar.cljs$core$IFn$_invoke$arity$1(start) : grammar.call(null,start))),(function (){var iter__4582__auto__ = (function instaparse$print$Parser__GT_str_$_iter__73379(s__73380){
return (new cljs.core.LazySeq(null,(function (){
var s__73380__$1 = s__73380;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__73380__$1);
if(temp__5735__auto__){
var s__73380__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__73380__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__73380__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__73382 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__73381 = (0);
while(true){
if((i__73381 < size__4581__auto__)){
var vec__73383 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__73381);
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73383,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73383,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
cljs.core.chunk_append(b__73382,instaparse.print.rule__GT_str(non_terminal,parser));

var G__73448 = (i__73381 + (1));
i__73381 = G__73448;
continue;
} else {
var G__73449 = (i__73381 + (1));
i__73381 = G__73449;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__73382),instaparse$print$Parser__GT_str_$_iter__73379(cljs.core.chunk_rest(s__73380__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__73382),null);
}
} else {
var vec__73386 = cljs.core.first(s__73380__$2);
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73386,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73386,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
return cljs.core.cons(instaparse.print.rule__GT_str(non_terminal,parser),instaparse$print$Parser__GT_str_$_iter__73379(cljs.core.rest(s__73380__$2)));
} else {
var G__73450 = cljs.core.rest(s__73380__$2);
s__73380__$1 = G__73450;
continue;
}
}
} else {
