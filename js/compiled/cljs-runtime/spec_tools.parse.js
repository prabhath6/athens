...
var fexpr__55046 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__55046.cljs$core$IFn$_invoke$arity$1 ? fexpr__55046.cljs$core$IFn$_invoke$arity$1(type) : fexpr__55046.call(null,type));
});
...
var G__55074 = cljs.spec.alpha.form(cljs.spec.alpha.get_spec(x));
x = G__55074;
continue;
} else {
if((x instanceof cljs.core.Symbol)){
var G__55047 = spec_tools.impl.normalize_symbol(x);
var G__55048 = null;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__55047,G__55048) : spec_tools.parse.parse_form.call(null,G__55047,G__55048));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__55049 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__55050 = x;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__55049,G__55050) : spec_tools.parse.parse_form.call(null,G__55049,G__55050));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__55075 = cljs.spec.alpha.form(x);
x = G__55075;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__55051 = (spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1 ? spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x) : spec_tools.form.resolve_form.call(null,x));
var G__55052 = null;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__55051,G__55052) : spec_tools.parse.parse_form.call(null,G__55051,G__55052));
} else {
...
var G__55053 = parse_data;
var G__55053__$1 = (((G__55053 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__55053));
var G__55053__$2 = (((G__55053__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__55053__$1));
var G__55053__$3 = (((G__55053__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__55053__$2));
var G__55053__$4 = (((G__55053__$3 == null))?null:cljs.core.seq(G__55053__$3));
if((G__55053__$4 == null)){
return null;
} else {
return cljs.core.set(G__55053__$4);
}
}
});
...
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.parse","default","spec-tools.parse/default",-1184283850)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__55055 = cljs.core.get_global_hierarchy;
return (fexpr__55055.cljs$core$IFn$_invoke$arity$0 ? fexpr__55055.cljs$core$IFn$_invoke$arity$0() : fexpr__55055.call(null));
})());
...
var map__55059 = spec_tools.impl.parse_keys(form);
var map__55059__$1 = (((((!((map__55059 == null))))?(((((map__55059.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__55059.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__55059):map__55059);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55059__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55059__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55059__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55059__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55059__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__55061 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__55061__$1 = (cljs.core.truth_((function (){var or__4185__auto__ = req;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__55061,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__55061);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__55061__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__55061__$1;
}
}));
...
var map__55062 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
...
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55062__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__55064 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__55064__$1 = (((((!((map__55064 == null))))?(((((map__55064.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__55064.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__55064):map__55064);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55064__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__55066){
var vec__55067 = p__55066;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55067,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55067,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55067,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__55070){
var vec__55071 = p__55070;
var seq__55072 = cljs.core.seq(vec__55071);
var first__55073 = cljs.core.first(seq__55072);
var seq__55072__$1 = cljs.core.next(seq__55072);
var ___$1 = first__55073;
var values = seq__55072__$1;
