...
var fexpr__54929 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__54929.cljs$core$IFn$_invoke$arity$1 ? fexpr__54929.cljs$core$IFn$_invoke$arity$1(type) : fexpr__54929.call(null,type));
});
...
var G__54962 = cljs.spec.alpha.form(cljs.spec.alpha.get_spec(x));
x = G__54962;
continue;
} else {
if((x instanceof cljs.core.Symbol)){
var G__54930 = spec_tools.impl.normalize_symbol(x);
var G__54931 = null;
...
var G__54932 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__54933 = x;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__54932,G__54933) : spec_tools.parse.parse_form.call(null,G__54932,G__54933));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__54964 = cljs.spec.alpha.form(x);
x = G__54964;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__54934 = (spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1 ? spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x) : spec_tools.form.resolve_form.call(null,x));
var G__54935 = null;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__54934,G__54935) : spec_tools.parse.parse_form.call(null,G__54934,G__54935));
} else {
...
var G__54936 = parse_data;
var G__54936__$1 = (((G__54936 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__54936));
var G__54936__$2 = (((G__54936__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__54936__$1));
var G__54936__$3 = (((G__54936__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__54936__$2));
var G__54936__$4 = (((G__54936__$3 == null))?null:cljs.core.seq(G__54936__$3));
if((G__54936__$4 == null)){
return null;
} else {
return cljs.core.set(G__54936__$4);
}
}
});
...
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.parse","default","spec-tools.parse/default",-1184283850)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__54938 = cljs.core.get_global_hierarchy;
return (fexpr__54938.cljs$core$IFn$_invoke$arity$0 ? fexpr__54938.cljs$core$IFn$_invoke$arity$0() : fexpr__54938.call(null));
})());
...
var map__54942 = spec_tools.impl.parse_keys(form);
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54942__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54942__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54942__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54942__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54942__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__54944 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__54944__$1 = (cljs.core.truth_((function (){var or__4185__auto__ = req;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__54944,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__54944);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__54944__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__54944__$1;
}
}));
...
var map__54945 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
...
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54945__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__54947 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
...
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54947__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__54949){
var vec__54950 = p__54949;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54950,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54950,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54950,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__54953){
var vec__54954 = p__54953;
var seq__54955 = cljs.core.seq(vec__54954);
var first__54956 = cljs.core.first(seq__54955);
var seq__54955__$1 = cljs.core.next(seq__54955);
var ___$1 = first__54956;
var values = seq__54955__$1;
