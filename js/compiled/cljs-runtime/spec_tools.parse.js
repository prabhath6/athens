...
var fexpr__75283 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__75283.cljs$core$IFn$_invoke$arity$1 ? fexpr__75283.cljs$core$IFn$_invoke$arity$1(type) : fexpr__75283.call(null,type));
});
...
var G__75311 = cljs.spec.alpha.form(cljs.spec.alpha.get_spec(x));
x = G__75311;
continue;
} else {
if((x instanceof cljs.core.Symbol)){
var G__75284 = spec_tools.impl.normalize_symbol(x);
var G__75285 = null;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__75284,G__75285) : spec_tools.parse.parse_form.call(null,G__75284,G__75285));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__75286 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__75287 = x;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__75286,G__75287) : spec_tools.parse.parse_form.call(null,G__75286,G__75287));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__75312 = cljs.spec.alpha.form(x);
x = G__75312;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__75288 = (spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1 ? spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x) : spec_tools.form.resolve_form.call(null,x));
var G__75289 = null;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__75288,G__75289) : spec_tools.parse.parse_form.call(null,G__75288,G__75289));
} else {
...
var G__75290 = parse_data;
var G__75290__$1 = (((G__75290 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__75290));
var G__75290__$2 = (((G__75290__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__75290__$1));
var G__75290__$3 = (((G__75290__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__75290__$2));
var G__75290__$4 = (((G__75290__$3 == null))?null:cljs.core.seq(G__75290__$3));
if((G__75290__$4 == null)){
return null;
} else {
return cljs.core.set(G__75290__$4);
}
}
});
...
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.parse","default","spec-tools.parse/default",-1184283850)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__75291 = cljs.core.get_global_hierarchy;
return (fexpr__75291.cljs$core$IFn$_invoke$arity$0 ? fexpr__75291.cljs$core$IFn$_invoke$arity$0() : fexpr__75291.call(null));
})());
...
var map__75296 = spec_tools.impl.parse_keys(form);
var map__75296__$1 = (((((!((map__75296 == null))))?(((((map__75296.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__75296.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__75296):map__75296);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75296__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75296__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75296__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75296__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75296__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__75298 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__75298__$1 = (cljs.core.truth_((function (){var or__4185__auto__ = req;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__75298,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__75298);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__75298__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__75298__$1;
}
}));
...
var map__75299 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__75299__$1 = (((((!((map__75299 == null))))?(((((map__75299.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__75299.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__75299):map__75299);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75299__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__75301 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__75301__$1 = (((((!((map__75301 == null))))?(((((map__75301.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__75301.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__75301):map__75301);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75301__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__75303){
var vec__75304 = p__75303;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75304,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75304,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75304,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__75307){
var vec__75308 = p__75307;
var seq__75309 = cljs.core.seq(vec__75308);
var first__75310 = cljs.core.first(seq__75309);
var seq__75309__$1 = cljs.core.next(seq__75309);
var ___$1 = first__75310;
var values = seq__75309__$1;
