...
var fexpr__54937 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__54937.cljs$core$IFn$_invoke$arity$1 ? fexpr__54937.cljs$core$IFn$_invoke$arity$1(type) : fexpr__54937.call(null,type));
});
...
var G__54965 = cljs.spec.alpha.form(cljs.spec.alpha.get_spec(x));
x = G__54965;
continue;
} else {
if((x instanceof cljs.core.Symbol)){
var G__54938 = spec_tools.impl.normalize_symbol(x);
var G__54939 = null;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__54938,G__54939) : spec_tools.parse.parse_form.call(null,G__54938,G__54939));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__54940 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__54941 = x;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__54940,G__54941) : spec_tools.parse.parse_form.call(null,G__54940,G__54941));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__54966 = cljs.spec.alpha.form(x);
x = G__54966;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__54942 = (spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1 ? spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x) : spec_tools.form.resolve_form.call(null,x));
var G__54943 = null;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__54942,G__54943) : spec_tools.parse.parse_form.call(null,G__54942,G__54943));
} else {
...
var G__54944 = parse_data;
var G__54944__$1 = (((G__54944 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__54944));
var G__54944__$2 = (((G__54944__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__54944__$1));
var G__54944__$3 = (((G__54944__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__54944__$2));
var G__54944__$4 = (((G__54944__$3 == null))?null:cljs.core.seq(G__54944__$3));
if((G__54944__$4 == null)){
return null;
} else {
return cljs.core.set(G__54944__$4);
}
}
});
...
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.parse","default","spec-tools.parse/default",-1184283850)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__54945 = cljs.core.get_global_hierarchy;
return (fexpr__54945.cljs$core$IFn$_invoke$arity$0 ? fexpr__54945.cljs$core$IFn$_invoke$arity$0() : fexpr__54945.call(null));
})());
...
var map__54950 = spec_tools.impl.parse_keys(form);
var map__54950__$1 = (((((!((map__54950 == null))))?(((((map__54950.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__54950.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__54950):map__54950);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54950__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54950__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54950__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54950__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54950__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__54952 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__54952__$1 = (cljs.core.truth_((function (){var or__4185__auto__ = req;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__54952,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__54952);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__54952__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__54952__$1;
}
}));
...
var map__54953 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
...
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54953__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__54955 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__54955__$1 = (((((!((map__54955 == null))))?(((((map__54955.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__54955.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__54955):map__54955);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54955__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__54957){
var vec__54958 = p__54957;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54958,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54958,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54958,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__54961){
...
var ___$1 = first__54964;
var values = seq__54963__$1;
