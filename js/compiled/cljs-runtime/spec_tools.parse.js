...
var fexpr__54949 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__54949.cljs$core$IFn$_invoke$arity$1 ? fexpr__54949.cljs$core$IFn$_invoke$arity$1(type) : fexpr__54949.call(null,type));
});
...
var G__54977 = cljs.spec.alpha.form(cljs.spec.alpha.get_spec(x));
x = G__54977;
continue;
} else {
if((x instanceof cljs.core.Symbol)){
var G__54950 = spec_tools.impl.normalize_symbol(x);
var G__54951 = null;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__54950,G__54951) : spec_tools.parse.parse_form.call(null,G__54950,G__54951));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__54952 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__54953 = x;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__54952,G__54953) : spec_tools.parse.parse_form.call(null,G__54952,G__54953));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__54978 = cljs.spec.alpha.form(x);
x = G__54978;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__54954 = (spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1 ? spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x) : spec_tools.form.resolve_form.call(null,x));
var G__54955 = null;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__54954,G__54955) : spec_tools.parse.parse_form.call(null,G__54954,G__54955));
} else {
...
var G__54956 = parse_data;
var G__54956__$1 = (((G__54956 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__54956));
var G__54956__$2 = (((G__54956__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__54956__$1));
var G__54956__$3 = (((G__54956__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__54956__$2));
var G__54956__$4 = (((G__54956__$3 == null))?null:cljs.core.seq(G__54956__$3));
if((G__54956__$4 == null)){
return null;
} else {
return cljs.core.set(G__54956__$4);
}
}
});
...
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.parse","default","spec-tools.parse/default",-1184283850)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__54957 = cljs.core.get_global_hierarchy;
return (fexpr__54957.cljs$core$IFn$_invoke$arity$0 ? fexpr__54957.cljs$core$IFn$_invoke$arity$0() : fexpr__54957.call(null));
})());
...
var map__54962 = spec_tools.impl.parse_keys(form);
var map__54962__$1 = (((((!((map__54962 == null))))?(((((map__54962.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__54962.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__54962):map__54962);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54962__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54962__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54962__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54962__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54962__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__54964 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__54964__$1 = (cljs.core.truth_((function (){var or__4185__auto__ = req;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__54964,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__54964);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__54964__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__54964__$1;
}
}));
...
var map__54965 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
...
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54965__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__54967 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__54967__$1 = (((((!((map__54967 == null))))?(((((map__54967.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__54967.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__54967):map__54967);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54967__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__54969){
var vec__54970 = p__54969;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54970,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54970,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54970,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__54973){
var vec__54974 = p__54973;
var seq__54975 = cljs.core.seq(vec__54974);
var first__54976 = cljs.core.first(seq__54975);
var seq__54975__$1 = cljs.core.next(seq__54975);
var ___$1 = first__54976;
var values = seq__54975__$1;
