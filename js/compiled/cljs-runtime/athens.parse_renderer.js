...
var G__65597 = new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"block","block",664686210),(function() { 
var G__65627__delegate = function (contents){
...
var G__65627 = function (var_args){
var contents = null;
if (arguments.length > 0) {
var G__65628__i = 0, G__65628__a = new Array(arguments.length -  0);
while (G__65628__i < G__65628__a.length) {G__65628__a[G__65628__i] = arguments[G__65628__i + 0]; ++G__65628__i;}
  contents = new cljs.core.IndexedSeq(G__65628__a,0,null);
} 
return G__65627__delegate.call(this,contents);};
G__65627.cljs$lang$maxFixedArity = 0;
G__65627.cljs$lang$applyTo = (function (arglist__65629){
var contents = cljs.core.seq(arglist__65629);
return G__65627__delegate(contents);
});
G__65627.cljs$core$IFn$_invoke$arity$variadic = G__65627__delegate;
return G__65627;
})()
,new cljs.core.Keyword(null,"page-link","page-link",-169621200),(function (title){
var node = (function (){var G__65599 = athens.db.dsdb;
var G__65600 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__65601 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),title], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__65599,G__65600,G__65601) : posh.reagent.pull.call(null,G__65599,G__65600,G__65601));
})();
...
var block = (function (){var G__65602 = athens.db.dsdb;
var G__65603 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__65604 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),uid], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__65602,G__65603,G__65604) : posh.reagent.pull.call(null,G__65602,G__65603,G__65604));
})();
...
})], null),(function (){var G__65605 = new cljs.core.Keyword("block","string","block/string",-2066596447).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(block));
return (athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$1 ? athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$1(G__65605) : athens.parse_renderer.parse_and_render.call(null,G__65605));
})()], null)], null);
}),new cljs.core.Keyword(null,"hashtag","hashtag",-529028899),(function (tag_name){
var node = (function (){var G__65606 = athens.db.dsdb;
var G__65607 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__65608 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),tag_name], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__65606,G__65607,G__65608) : posh.reagent.pull.call(null,G__65606,G__65607,G__65608));
})();
...
}),new cljs.core.Keyword(null,"url-image","url-image",535142411),(function (p__65609){
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65610__$1,new cljs.core.Keyword(null,"url","url",276297046));
var alt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65610__$1,new cljs.core.Keyword(null,"alt","alt",-3214426));
...
}),new cljs.core.Keyword(null,"url-link","url-link",1615670141),(function (p__65612,text){
var map__65613 = p__65612;
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65613__$1,new cljs.core.Keyword(null,"url","url",276297046));
...
var G__65598 = tree;
return (instaparse.core.transform.cljs$core$IFn$_invoke$arity$2 ? instaparse.core.transform.cljs$core$IFn$_invoke$arity$2(G__65597,G__65598) : instaparse.core.transform.call(null,G__65597,G__65598));
});
/**
