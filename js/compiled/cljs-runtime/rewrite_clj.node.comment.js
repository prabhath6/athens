...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k29835,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k29835,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__29840){
var vec__29841 = p__29840;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29841,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29841,(1),null);
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__29834){
var self__ = this;
var G__29834__$1 = this;
return (new cljs.core.RecordIter((0),G__29834__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"s","s",1705939918)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var h__4297__auto____$1 = (function (){var fexpr__29844 = (function (coll__4436__auto__){
return (495469178 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__29844(this__4435__auto____$1);
})();
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this29836,other29837){
var self__ = this;
var this29836__$1 = this;
return (((!((other29837 == null)))) && ((this29836__$1.constructor === other29837.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29836__$1.s,other29837.s)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29836__$1.__extmap,other29837.__extmap)));
}));
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__29834){
var self__ = this;
...
return (new rewrite_clj.node.comment.CommentNode(G__29834,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.comment.CommentNode(self__.s,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__29834),null));
}
}));
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__29834){
var self__ = this;
var this__4438__auto____$1 = this;
return (new rewrite_clj.node.comment.CommentNode(self__.s,G__29834,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.comment.map__GT_CommentNode = (function rewrite_clj$node$comment$map__GT_CommentNode(G__29838){
var extmap__4478__auto__ = (function (){var G__29850 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__29838,new cljs.core.Keyword(null,"s","s",1705939918));
if(cljs.core.record_QMARK_(G__29838)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__29850);
} else {
return G__29850;
}
})();
return (new rewrite_clj.node.comment.CommentNode(new cljs.core.Keyword(null,"s","s",1705939918).cljs$core$IFn$_invoke$arity$1(G__29838),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
