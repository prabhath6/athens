...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__30407,k,f){
var vec__30408 = p__30407;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30408,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30408,(1),null);
var loc = vec__30408;
...
var G__30437 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__30437;
continue;
}
break;
...
var G__30438 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__30438;
continue;
} else {
return zloc__$1;
...
var G__30441 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__30441;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__30413){
...
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30417__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__30414;
if(cljs.core.seq(l)){
...
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30424__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__30421;
if(cljs.core.seq(r)){
...
var vec__30427 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30427,(0),null);
var map__30430 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30427,(1),null);
var map__30430__$1 = (((((!((map__30430 == null))))?(((((map__30430.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__30430.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__30430):map__30430);
var path = map__30430__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30430__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30430__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30430__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30430__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
