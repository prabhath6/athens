...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__30409,k,f){
var vec__30410 = p__30409;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30410,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30410,(1),null);
var loc = vec__30410;
...
var G__30440 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__30440;
continue;
}
break;
...
var G__30443 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__30443;
continue;
} else {
return zloc__$1;
...
var G__30444 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__30444;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__30415){
...
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30419__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__30416;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__30423){
var vec__30424 = p__30423;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30424,(0),null);
var map__30428 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30424,(1),null);
...
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30428__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__30424;
if(cljs.core.seq(r)){
...
var vec__30432 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30432,(0),null);
var map__30435 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30432,(1),null);
...
var path = map__30435__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30435__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30435__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30435__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30435__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
