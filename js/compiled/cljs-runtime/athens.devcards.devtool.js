...
var pred__68098 = cljs.core._EQ_;
var expr__68099 = k;
if(cljs.core.truth_((function (){var G__68101 = new cljs.core.Keyword("db","id","db/id",-1388397098);
var G__68102 = expr__68099;
return (pred__68098.cljs$core$IFn$_invoke$arity$2 ? pred__68098.cljs$core$IFn$_invoke$arity$2(G__68101,G__68102) : pred__68098.call(null,G__68101,G__68102));
})())){
var G__68103 = cljs.core.deref(athens.db.dsdb);
var G__68104 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null),new cljs.core.Keyword("block","_children","block/_children",1128070632)], null);
var G__68105 = v;
return (datascript.core.pull.cljs$core$IFn$_invoke$arity$3 ? datascript.core.pull.cljs$core$IFn$_invoke$arity$3(G__68103,G__68104,G__68105) : datascript.core.pull.call(null,G__68103,G__68104,G__68105));
} else {
return v;
}
});
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"overflow-x","overflow-x",-26547754),"auto",new cljs.core.Keyword(null,"height","height",1025178622),"100%"], null)),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"table","table",-564943036),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"thead","thead",-291875296),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tr","tr",-1424774646),(function (){var iter__4582__auto__ = (function athens$devcards$devtool$data_table_$_iter__68106(s__68107){
return (new cljs.core.LazySeq(null,(function (){
var s__68107__$1 = s__68107;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__68107__$1);
if(temp__5735__auto__){
var s__68107__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__68107__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__68107__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__68109 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__68108 = (0);
while(true){
if((i__68108 < size__4581__auto__)){
var h = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__68108);
cljs.core.chunk_append(b__68109,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"th","th",-545608566),h], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),h], null)));

var G__68175 = (i__68108 + (1));
i__68108 = G__68175;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__68109),athens$devcards$devtool$data_table_$_iter__68106(cljs.core.chunk_rest(s__68107__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__68109),null);
}
} else {
var h = cljs.core.first(s__68107__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"th","th",-545608566),h], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),h], null)),athens$devcards$devtool$data_table_$_iter__68106(cljs.core.rest(s__68107__$2)));
}
} else {
return null;
}
...
})()], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tbody","tbody",-80678300),cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4582__auto__ = (function athens$devcards$devtool$data_table_$_iter__68110(s__68111){
return (new cljs.core.LazySeq(null,(function (){
var s__68111__$1 = s__68111;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__68111__$1);
if(temp__5735__auto__){
var s__68111__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__68111__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__68111__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__68113 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__68112 = (0);
while(true){
if((i__68112 < size__4581__auto__)){
var row = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__68112);
cljs.core.chunk_append(b__68113,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tr","tr",-1424774646),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"cursor","cursor",1011937484),"pointer",new cljs.core.Keyword("stylefy.core","mode","stylefy.core/mode",-1757530234),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"hover","hover",-341141711),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"background-color","background-color",570434026),"#EFEDEB"], null)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__68112,row,c__4580__auto__,size__4581__auto__,b__68113,s__68111__$2,temp__5735__auto__,limit){
return (function (){
var G__68114 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(row),new cljs.core.Keyword(null,"row-value","row-value",-1067843622).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(row))], null);
return (add_nav_BANG_.cljs$core$IFn$_invoke$arity$1 ? add_nav_BANG_.cljs$core$IFn$_invoke$arity$1(G__68114) : add_nav_BANG_.call(null,G__68114));
});})(i__68112,row,c__4580__auto__,size__4581__auto__,b__68113,s__68111__$2,temp__5735__auto__,limit))
], null)),(function (){var iter__4582__auto__ = ((function (i__68112,row,c__4580__auto__,size__4581__auto__,b__68113,s__68111__$2,temp__5735__auto__,limit){
return (function athens$devcards$devtool$data_table_$_iter__68110_$_iter__68115(s__68116){
return (new cljs.core.LazySeq(null,((function (i__68112,row,c__4580__auto__,size__4581__auto__,b__68113,s__68111__$2,temp__5735__auto__,limit){
return (function (){
var s__68116__$1 = s__68116;
while(true){
var temp__5735__auto____$1 = cljs.core.seq(s__68116__$1);
if(temp__5735__auto____$1){
var s__68116__$2 = temp__5735__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__68116__$2)){
var c__4580__auto____$1 = cljs.core.chunk_first(s__68116__$2);
var size__4581__auto____$1 = cljs.core.count(c__4580__auto____$1);
var b__68118 = cljs.core.chunk_buffer(size__4581__auto____$1);
if((function (){var i__68117 = (0);
while(true){
if((i__68117 < size__4581__auto____$1)){
var i = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto____$1,i__68117);
cljs.core.chunk_append(b__68118,(function (){var cell = cljs.core.get.cljs$core$IFn$_invoke$arity$2(row,i);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__68118),athens$devcards$devtool$data_table_$_iter__68110_$_iter__68115(cljs.core.chunk_rest(s__68116__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__68118),null);
}
} else {
var i = cljs.core.first(s__68116__$2);
return cljs.core.cons((function (){var cell = cljs.core.get.cljs$core$IFn$_invoke$arity$2(row,i);
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),(((cell == null))?"":cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cell], 0)))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(row),cljs.core.str.cljs$core$IFn$_invoke$arity$1(i),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cell)].join('')], null));
})(),athens$devcards$devtool$data_table_$_iter__68110_$_iter__68115(cljs.core.rest(s__68116__$2)));
}
} else {
return null;
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__68113),athens$devcards$devtool$data_table_$_iter__68110(cljs.core.chunk_rest(s__68111__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__68113),null);
}
} else {
var row = cljs.core.first(s__68111__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tr","tr",-1424774646),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"cursor","cursor",1011937484),"pointer",new cljs.core.Keyword("stylefy.core","mode","stylefy.core/mode",-1757530234),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"hover","hover",-341141711),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"background-color","background-color",570434026),"#EFEDEB"], null)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (row,s__68111__$2,temp__5735__auto__,limit){
return (function (){
var G__68119 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(row),new cljs.core.Keyword(null,"row-value","row-value",-1067843622).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(row))], null);
return (add_nav_BANG_.cljs$core$IFn$_invoke$arity$1 ? add_nav_BANG_.cljs$core$IFn$_invoke$arity$1(G__68119) : add_nav_BANG_.call(null,G__68119));
});})(row,s__68111__$2,temp__5735__auto__,limit))
], null)),(function (){var iter__4582__auto__ = ((function (row,s__68111__$2,temp__5735__auto__,limit){
return (function athens$devcards$devtool$data_table_$_iter__68110_$_iter__68120(s__68121){
return (new cljs.core.LazySeq(null,(function (){
var s__68121__$1 = s__68121;
while(true){
var temp__5735__auto____$1 = cljs.core.seq(s__68121__$1);
if(temp__5735__auto____$1){
var s__68121__$2 = temp__5735__auto____$1;
...
var i = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__68122);
cljs.core.chunk_append(b__68123,(function (){var cell = cljs.core.get.cljs$core$IFn$_invoke$arity$2(row,i);
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),(((cell == null))?"":cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cell], 0)))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(row),cljs.core.str.cljs$core$IFn$_invoke$arity$1(i),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cell)].join('')], null));
})());

var G__68178 = (i__68122 + (1));
i__68122 = G__68178;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__68123),athens$devcards$devtool$data_table_$_iter__68110_$_iter__68120(cljs.core.chunk_rest(s__68121__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__68123),null);
}
} else {
var i = cljs.core.first(s__68121__$2);
return cljs.core.cons((function (){var cell = cljs.core.get.cljs$core$IFn$_invoke$arity$2(row,i);
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),(((cell == null))?"":cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cell], 0)))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(row),cljs.core.str.cljs$core$IFn$_invoke$arity$1(i),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cell)].join('')], null));
})(),athens$devcards$devtool$data_table_$_iter__68110_$_iter__68120(cljs.core.rest(s__68121__$2)));
}
} else {
return null;
}
...
;
return iter__4582__auto__(cljs.core.range.cljs$core$IFn$_invoke$arity$1(cljs.core.count(row)));
})()], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),row], null)),athens$devcards$devtool$data_table_$_iter__68110(cljs.core.rest(s__68111__$2)));
}
} else {
return null;
}
...
var _STAR_print_newline_STAR__orig_val__68124_68179 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__68125_68180 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__68126_68181 = true;
var _STAR_print_fn_STAR__temp_val__68127_68182 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__68126_68181);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__68127_68182);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(data);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__68125_68180);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__68124_68179);
}
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.devtool.data_table,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["key","value"], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__68128){
var vec__68129 = p__68128;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68129,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68129,(1),null);
...
return cljs.core.with_meta(cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx], null),(function (){var iter__4582__auto__ = (function athens$devcards$devtool$maps_viewer_$_iter__68132(s__68133){
return (new cljs.core.LazySeq(null,(function (){
var s__68133__$1 = s__68133;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__68133__$1);
if(temp__5735__auto__){
var s__68133__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__68133__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__68133__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__68135 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__68134 = (0);
while(true){
if((i__68134 < size__4581__auto__)){
var h = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__68134);
cljs.core.chunk_append(b__68135,cljs.core.get.cljs$core$IFn$_invoke$arity$2(m,h));

var G__68183 = (i__68134 + (1));
i__68134 = G__68183;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__68135),athens$devcards$devtool$maps_viewer_$_iter__68132(cljs.core.chunk_rest(s__68133__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__68135),null);
}
} else {
var h = cljs.core.first(s__68133__$2);
return cljs.core.cons(cljs.core.get.cljs$core$IFn$_invoke$arity$2(m,h),athens$devcards$devtool$maps_viewer_$_iter__68132(cljs.core.rest(s__68133__$2)));
}
} else {
return null;
}
...
cljs.core.with_meta(cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx], null),(function (){var iter__4582__auto__ = (function athens$devcards$devtool$tuples_viewer_$_iter__68136(s__68137){
return (new cljs.core.LazySeq(null,(function (){
var s__68137__$1 = s__68137;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__68137__$1);
if(temp__5735__auto__){
var s__68137__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__68137__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__68137__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__68139 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__68138 = (0);
while(true){
if((i__68138 < size__4581__auto__)){
var i = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__68138);
cljs.core.chunk_append(b__68139,cljs.core.get.cljs$core$IFn$_invoke$arity$2(coll,i));

var G__68184 = (i__68138 + (1));
i__68138 = G__68184;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__68139),athens$devcards$devtool$tuples_viewer_$_iter__68136(cljs.core.chunk_rest(s__68137__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__68139),null);
}
} else {
var i = cljs.core.first(s__68137__$2);
return cljs.core.cons(cljs.core.get.cljs$core$IFn$_invoke$arity$2(coll,i),athens$devcards$devtool$tuples_viewer_$_iter__68136(cljs.core.rest(s__68137__$2)));
}
} else {
return null;
}
...
return cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2((function (p1__68140_SHARP_){
return athens.devcards.devtool.viewer_preference.indexOf(p1__68140_SHARP_);
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("athens.viewer","id","athens.viewer/id",1343226473),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p__68141){
var map__68142 = p__68141;
var map__68142__$1 = (((((!((map__68142 == null))))?(((((map__68142.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__68142.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__68142):map__68142);
var pred = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68142__$1,new cljs.core.Keyword("athens.viewer","pred","athens.viewer/pred",-951267918));
...
var add_nav_BANG_ = (function (p1__68144_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$variadic(state,cljs.core.update,new cljs.core.Keyword(null,"navs","navs",-1350609868),cljs.core.conj,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([p1__68144_SHARP_], 0));
});
var navved_data = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (d,p__68145){
var vec__68146 = p__68145;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68146,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68146,(1),null);
...
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"display","display",242065432),"flex",new cljs.core.Keyword(null,"flex-direction","flex-direction",364609438),"row",new cljs.core.Keyword(null,"flex-wrap","flex-wrap",455413707),"no-wrap",new cljs.core.Keyword(null,"justify-content","justify-content",-1990475787),"space-between"], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"display","display",242065432),"flex",new cljs.core.Keyword(null,"flex-direction","flex-direction",364609438),"column",new cljs.core.Keyword(null,"flex-wrap","flex-wrap",455413707),"no-wrap"], null)], null),cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4582__auto__ = (function athens$devcards$devtool$data_browser_$_iter__68149(s__68150){
return (new cljs.core.LazySeq(null,(function (){
var s__68150__$1 = s__68150;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__68150__$1);
if(temp__5735__auto__){
var s__68150__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__68150__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__68150__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__68152 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__68151 = (0);
while(true){
if((i__68151 < size__4581__auto__)){
var i = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__68151);
cljs.core.chunk_append(b__68152,(function (){var nav = cljs.core.get.cljs$core$IFn$_invoke$arity$2(navs,i);
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a","a",-2123407586),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"cursor","cursor",1011937484),"pointer",new cljs.core.Keyword("stylefy.core","mode","stylefy.core/mode",-1757530234),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"hover","hover",-341141711),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"background-color","background-color",570434026),"#EFEDEB"], null)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__68151,nav,i,c__4580__auto__,size__4581__auto__,b__68152,s__68150__$2,temp__5735__auto__,navs,add_nav_BANG_,navved_data,datafied_data,applicable_vs,viewer_name,viewer,state){
return (function (){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,((function (i__68151,nav,i,c__4580__auto__,size__4581__auto__,b__68152,s__68150__$2,temp__5735__auto__,navs,add_nav_BANG_,navved_data,datafied_data,applicable_vs,viewer_name,viewer,state){
return (function (s){
...
});})(i__68151,nav,i,c__4580__auto__,size__4581__auto__,b__68152,s__68150__$2,temp__5735__auto__,navs,add_nav_BANG_,navved_data,datafied_data,applicable_vs,viewer_name,viewer,state))
);
});})(i__68151,nav,i,c__4580__auto__,size__4581__auto__,b__68152,s__68150__$2,temp__5735__auto__,navs,add_nav_BANG_,navved_data,datafied_data,applicable_vs,viewer_name,viewer,state))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__68152),athens$devcards$devtool$data_browser_$_iter__68149(cljs.core.chunk_rest(s__68150__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__68152),null);
}
} else {
var i = cljs.core.first(s__68150__$2);
return cljs.core.cons((function (){var nav = cljs.core.get.cljs$core$IFn$_invoke$arity$2(navs,i);
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a","a",-2123407586),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"cursor","cursor",1011937484),"pointer",new cljs.core.Keyword("stylefy.core","mode","stylefy.core/mode",-1757530234),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"hover","hover",-341141711),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"background-color","background-color",570434026),"#EFEDEB"], null)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (nav,i,s__68150__$2,temp__5735__auto__,navs,add_nav_BANG_,navved_data,datafied_data,applicable_vs,viewer_name,viewer,state){
return (function (){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,(function (s){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.update.cljs$core$IFn$_invoke$arity$5(s,new cljs.core.Keyword(null,"navs","navs",-1350609868),cljs.core.subvec,(0),i),new cljs.core.Keyword(null,"viewer","viewer",-783949853));
}));
});})(nav,i,s__68150__$2,temp__5735__auto__,navs,add_nav_BANG_,navved_data,datafied_data,applicable_vs,viewer_name,viewer,state))
], null)),["<< ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.first(nav))].join('')], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),i], null));
})(),athens$devcards$devtool$data_browser_$_iter__68149(cljs.core.rest(s__68150__$2)));
}
} else {
return null;
}
...
})())], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"display","display",242065432),"flex",new cljs.core.Keyword(null,"flex-direction","flex-direction",364609438),"row"], null)),"View as: ",(function (){var iter__4582__auto__ = (function athens$devcards$devtool$data_browser_$_iter__68153(s__68154){
return (new cljs.core.LazySeq(null,(function (){
var s__68154__$1 = s__68154;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__68154__$1);
if(temp__5735__auto__){
var s__68154__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__68154__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__68154__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__68156 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__68155 = (0);
while(true){
if((i__68155 < size__4581__auto__)){
var v = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__68155);
cljs.core.chunk_append(b__68156,(function (){var click_fn = ((function (i__68155,v,c__4580__auto__,size__4581__auto__,b__68156,s__68154__$2,temp__5735__auto__,navs,add_nav_BANG_,navved_data,datafied_data,applicable_vs,viewer_name,viewer,state){
return (function (){
...
});})(i__68155,v,c__4580__auto__,size__4581__auto__,b__68156,s__68154__$2,temp__5735__auto__,navs,add_nav_BANG_,navved_data,datafied_data,applicable_vs,viewer_name,viewer,state))
;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__68156),athens$devcards$devtool$data_browser_$_iter__68153(cljs.core.chunk_rest(s__68154__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__68156),null);
}
} else {
var v = cljs.core.first(s__68154__$2);
return cljs.core.cons((function (){var click_fn = ((function (v,s__68154__$2,temp__5735__auto__,navs,add_nav_BANG_,navved_data,datafied_data,applicable_vs,viewer_name,viewer,state){
return (function (){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(state,cljs.core.assoc,new cljs.core.Keyword(null,"viewer","viewer",-783949853),v);
});})(v,s__68154__$2,temp__5735__auto__,navs,add_nav_BANG_,navved_data,datafied_data,applicable_vs,viewer_name,viewer,state))
;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(v,viewer_name)){
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.buttons.button_primary,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"on-click-fn","on-click-fn",739785852),click_fn,new cljs.core.Keyword(null,"label","label",1718410804),cljs.core.name(v)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),v], null));
} else {
...
})(),athens$devcards$devtool$data_browser_$_iter__68153(cljs.core.rest(s__68154__$2)));
}
} else {
return null;
}
...
athens.devcards.devtool.eval_with_sci = (function athens$devcards$devtool$eval_with_sci(p__68157){
var map__68158 = p__68157;
var map__68158__$1 = (((((!((map__68158 == null))))?(((((map__68158.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__68158.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__68158):map__68158);
var state = map__68158__$1;
var eval_str = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68158__$1,new cljs.core.Keyword(null,"eval-str","eval-str",752008756));
...
var vec__68160 = (function (){try{return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [true,sci.core.eval_string.cljs$core$IFn$_invoke$arity$2(eval_str,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"bindings","bindings",1271397192),bindings], null))], null);
...
var ok_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68160,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68160,(1),null);
...
athens.devcards.devtool.query_component = (function athens$devcards$devtool$query_component(p__68164){
var map__68165 = p__68164;
var map__68165__$1 = (((((!((map__68165 == null))))?(((((map__68165.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__68165.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__68165):map__68165);
var eval_str = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68165__$1,new cljs.core.Keyword(null,"eval-str","eval-str",752008756));
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68165__$1,new cljs.core.Keyword(null,"result","result",1415092211));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68165__$1,new cljs.core.Keyword(null,"error","error",-978969032));
...
athens.devcards.devtool.txes_component = (function athens$devcards$devtool$txes_component(p__68167){
...
var tx_reports = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68168__$1,new cljs.core.Keyword(null,"tx-reports","tx-reports",1504634514));
...
var G__68170 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-devtool","toggle-devtool",-1568832653)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__68170) : re_frame.core.dispatch.call(null,G__68170));
...
var map__68171 = cljs.core.deref(state);
...
var active_panel = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68171__$1,new cljs.core.Keyword(null,"active-panel","active-panel",-1802545994));
...
}),new cljs.core.Keyword(null,"label","label",1718410804),"Transactions"], null)], null)], null),(function (){var G__68173 = active_panel;
var G__68173__$1 = (((G__68173 instanceof cljs.core.Keyword))?G__68173.fqn:null);
switch (G__68173__$1) {
case "query":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__68173__$1)].join('')));
...
var devtool_QMARK_ = cljs.core.deref((function (){var G__68174 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"devtool","devtool",1338288336)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__68174) : re_frame.core.subscribe.call(null,G__68174));
})());
