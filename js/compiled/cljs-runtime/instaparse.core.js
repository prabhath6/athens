...
if(cljs.core.truth_((function (){var fexpr__65083 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__65083.cljs$core$IFn$_invoke$arity$1 ? fexpr__65083.cljs$core$IFn$_invoke$arity$1(type) : fexpr__65083.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__65084 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__65084.cljs$core$IFn$_invoke$arity$1 ? fexpr__65084.cljs$core$IFn$_invoke$arity$1(type) : fexpr__65084.call(null,type));
})())){
} else {
...
var G__65088 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__65088)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__65088)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__65088)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__65088)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__65088)].join('')));
...
var len__4789__auto___65173 = arguments.length;
var i__4790__auto___65174 = (0);
while(true){
if((i__4790__auto___65174 < len__4789__auto___65173)){
args__4795__auto__.push((arguments[i__4790__auto___65174]));

var G__65175 = (i__4790__auto___65174 + (1));
i__4790__auto___65174 = G__65175;
continue;
} else {
}
break;
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__65093){
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__65102 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__65102) : instaparse.reduction.node_builders.call(null,G__65102));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq65089){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65090,G__65091,seq65089__$2);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___65182 = arguments.length;
var i__4790__auto___65183 = (0);
while(true){
if((i__4790__auto___65183 < len__4789__auto___65182)){
args__4795__auto__.push((arguments[i__4790__auto___65183]));

var G__65184 = (i__4790__auto___65183 + (1));
i__4790__auto___65183 = G__65184;
continue;
} else {
}
break;
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__65115){
var map__65117 = p__65115;
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__65123 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__65123) : instaparse.reduction.node_builders.call(null,G__65123));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq65112){
...
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65113,G__65114,seq65112__$2);
}));
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__65147){
var vec__65148 = p__65147;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65148,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65148,(1),null);
...
var h__4297__auto____$1 = (function (){var fexpr__65151 = (function (coll__4436__auto__){
return (-360509877 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__65151(this__4435__auto____$1);
})();
...
var expr__65153 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__65155 = new cljs.core.Keyword(null,"grammar","grammar",1881328267);
var G__65156 = expr__65153;
return (pred__65152.cljs$core$IFn$_invoke$arity$2 ? pred__65152.cljs$core$IFn$_invoke$arity$2(G__65155,G__65156) : pred__65152.call(null,G__65155,G__65156));
})())){
...
if(cljs.core.truth_((function (){var G__65157 = new cljs.core.Keyword(null,"start-production","start-production",687546537);
var G__65158 = expr__65153;
return (pred__65152.cljs$core$IFn$_invoke$arity$2 ? pred__65152.cljs$core$IFn$_invoke$arity$2(G__65157,G__65158) : pred__65152.call(null,G__65157,G__65158));
})())){
return (new instaparse.core.Parser(self__.grammar,G__65132,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__65159 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676);
var G__65160 = expr__65153;
return (pred__65152.cljs$core$IFn$_invoke$arity$2 ? pred__65152.cljs$core$IFn$_invoke$arity$2(G__65159,G__65160) : pred__65152.call(null,G__65159,G__65160));
})())){
...
var self__ = this;
var self__ = this;
var G__65161 = (arguments.length - (1));
switch (G__65161) {
case (1):
...
(instaparse.core.Parser.prototype.apply = (function (self__,args65141){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args65141)));
}));
...
var extmap__4478__auto__ = (function (){var G__65162 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__65136,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__65136)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__65162);
} else {
return G__65162;
}
})();
...
var i__4790__auto___65278 = (0);
while(true){
if((i__4790__auto___65278 < len__4789__auto___65274)){
args__4795__auto__.push((arguments[i__4790__auto___65278]));

var G__65279 = (i__4790__auto___65278 + (1));
i__4790__auto___65278 = G__65279;
continue;
} else {
}
break;
...
(instaparse.core.parser.cljs$core$IFn$_invoke$arity$variadic = (function (grammar_specification,p__65165){
...
var _STAR_case_insensitive_literals_STAR__orig_val__65168 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__65169 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(options,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__65169);

try{var G__65170 = input_format;
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__65168);
}});
...
var map__65171 = temp__5733__auto__;
var map__65171__$1 = (((((!((map__65171 == null))))?(((((map__65171.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__65171.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__65171):map__65171);
var ws_grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65171__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var ws_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65171__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
...
/** @this {Function} */
(instaparse.core.parser.cljs$lang$applyTo = (function (seq65163){
var G__65164 = cljs.core.first(seq65163);
var seq65163__$1 = cljs.core.next(seq65163);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65164,seq65163__$1);
}));
