...
if(cljs.core.truth_((function (){var fexpr__65074 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__65074.cljs$core$IFn$_invoke$arity$1 ? fexpr__65074.cljs$core$IFn$_invoke$arity$1(type) : fexpr__65074.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__65075 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__65075.cljs$core$IFn$_invoke$arity$1 ? fexpr__65075.cljs$core$IFn$_invoke$arity$1(type) : fexpr__65075.call(null,type));
})())){
} else {
...
var G__65080 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__65080)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__65080)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__65080)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__65080)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__65080)].join('')));
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__65096){
var map__65097 = p__65096;
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__65100 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__65100) : instaparse.reduction.node_builders.call(null,G__65100));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq65090){
var G__65091 = cljs.core.first(seq65090);
var seq65090__$1 = cljs.core.next(seq65090);
var G__65092 = cljs.core.first(seq65090__$1);
var seq65090__$2 = cljs.core.next(seq65090__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65091,G__65092,seq65090__$2);
}));
...
var G__65174 = (i__4790__auto___65171 + (1));
i__4790__auto___65171 = G__65174;
continue;
} else {
}
break;
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__65116){
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__65119 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__65119) : instaparse.reduction.node_builders.call(null,G__65119));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq65108){
var G__65109 = cljs.core.first(seq65108);
var seq65108__$1 = cljs.core.next(seq65108);
var G__65110 = cljs.core.first(seq65108__$1);
var seq65108__$2 = cljs.core.next(seq65108__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65109,G__65110,seq65108__$2);
}));
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k65125,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k65125,else__4442__auto__);
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this65126,other65127){
var self__ = this;
var this65126__$1 = this;
return (((!((other65127 == null)))) && ((this65126__$1.constructor === other65127.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65126__$1.grammar,other65127.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65126__$1.start_production,other65127.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65126__$1.output_format,other65127.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65126__$1.__extmap,other65127.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__65124){
var self__ = this;
...
return (new instaparse.core.Parser(G__65124,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
...
return (new instaparse.core.Parser(self__.grammar,G__65124,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
...
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__65124,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__65124),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__65124){
var self__ = this;
var this__4438__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__65124,self__.__extmap,self__.__hash));
}));
