...
if(cljs.core.truth_((function (){var fexpr__65189 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__65189.cljs$core$IFn$_invoke$arity$1 ? fexpr__65189.cljs$core$IFn$_invoke$arity$1(type) : fexpr__65189.call(null,type));
})())){
} else {
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__65190)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__65190)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__65190)){
...
var G__65286 = (i__4790__auto___65283 + (1));
i__4790__auto___65283 = G__65286;
continue;
} else {
}
break;
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__65197){
var map__65198 = p__65197;
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__65201 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__65201) : instaparse.reduction.node_builders.call(null,G__65201));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq65193){
var G__65195 = cljs.core.first(seq65193);
var seq65193__$1 = cljs.core.next(seq65193);
var G__65196 = cljs.core.first(seq65193__$1);
var seq65193__$2 = cljs.core.next(seq65193__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65195,G__65196,seq65193__$2);
}));
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__65208){
var map__65209 = p__65208;
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__65211 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__65211) : instaparse.reduction.node_builders.call(null,G__65211));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq65202){
var G__65203 = cljs.core.first(seq65202);
var seq65202__$1 = cljs.core.next(seq65202);
var G__65204 = cljs.core.first(seq65202__$1);
var seq65202__$2 = cljs.core.next(seq65202__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65203,G__65204,seq65202__$2);
}));
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k65213,else__4442__auto__){
var self__ = this;
var this__4441__auto____$1 = this;
var G__65222 = k65213;
var G__65222__$1 = (((G__65222 instanceof cljs.core.Keyword))?G__65222.fqn:null);
switch (G__65222__$1) {
case "grammar":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k65213,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__65228){
var vec__65230 = p__65228;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65230,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65230,(1),null);
...
var h__4297__auto____$1 = (function (){var fexpr__65240 = (function (coll__4436__auto__){
return (-360509877 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__65240(this__4435__auto____$1);
})();
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this65214,other65215){
var self__ = this;
var this65214__$1 = this;
return (((!((other65215 == null)))) && ((this65214__$1.constructor === other65215.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65214__$1.grammar,other65215.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65214__$1.start_production,other65215.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65214__$1.output_format,other65215.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65214__$1.__extmap,other65215.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__65212){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__65246 = cljs.core.keyword_identical_QMARK_;
var expr__65247 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__65250 = new cljs.core.Keyword(null,"grammar","grammar",1881328267);
var G__65251 = expr__65247;
return (pred__65246.cljs$core$IFn$_invoke$arity$2 ? pred__65246.cljs$core$IFn$_invoke$arity$2(G__65250,G__65251) : pred__65246.call(null,G__65250,G__65251));
})())){
return (new instaparse.core.Parser(G__65212,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__65253 = new cljs.core.Keyword(null,"start-production","start-production",687546537);
var G__65254 = expr__65247;
return (pred__65246.cljs$core$IFn$_invoke$arity$2 ? pred__65246.cljs$core$IFn$_invoke$arity$2(G__65253,G__65254) : pred__65246.call(null,G__65253,G__65254));
})())){
return (new instaparse.core.Parser(self__.grammar,G__65212,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__65255 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676);
var G__65256 = expr__65247;
return (pred__65246.cljs$core$IFn$_invoke$arity$2 ? pred__65246.cljs$core$IFn$_invoke$arity$2(G__65255,G__65256) : pred__65246.call(null,G__65255,G__65256));
})())){
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__65212,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__65212),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__65212){
var self__ = this;
var this__4438__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__65212,self__.__extmap,self__.__hash));
}));
...
var self__ = this;
var self__ = this;
var G__65262 = (arguments.length - (1));
switch (G__65262) {
case (1):
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__65216){
var extmap__4478__auto__ = (function (){var G__65271 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__65216,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__65216)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__65271);
} else {
return G__65271;
}
})();
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__65216),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__65216),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__65216),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var args__4795__auto__ = [];
var len__4789__auto___65378 = arguments.length;
var i__4790__auto___65379 = (0);
while(true){
if((i__4790__auto___65379 < len__4789__auto___65378)){
args__4795__auto__.push((arguments[i__4790__auto___65379]));

var G__65381 = (i__4790__auto___65379 + (1));
i__4790__auto___65379 = G__65381;
continue;
} else {
}
break;
