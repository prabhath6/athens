...
if(cljs.core.truth_((function (){var fexpr__65070 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__65070.cljs$core$IFn$_invoke$arity$1 ? fexpr__65070.cljs$core$IFn$_invoke$arity$1(type) : fexpr__65070.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__65071 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__65071.cljs$core$IFn$_invoke$arity$1 ? fexpr__65071.cljs$core$IFn$_invoke$arity$1(type) : fexpr__65071.call(null,type));
})())){
} else {
...
var G__65073 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__65073)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__65073)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__65073)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__65073)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__65073)].join('')));
...
var len__4789__auto___65162 = arguments.length;
var i__4790__auto___65164 = (0);
while(true){
if((i__4790__auto___65164 < len__4789__auto___65162)){
args__4795__auto__.push((arguments[i__4790__auto___65164]));

var G__65165 = (i__4790__auto___65164 + (1));
i__4790__auto___65164 = G__65165;
continue;
} else {
}
break;
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__65080){
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__65083 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__65083) : instaparse.reduction.node_builders.call(null,G__65083));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq65074){
var G__65075 = cljs.core.first(seq65074);
var seq65074__$1 = cljs.core.next(seq65074);
var G__65076 = cljs.core.first(seq65074__$1);
var seq65074__$2 = cljs.core.next(seq65074__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65075,G__65076,seq65074__$2);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___65172 = arguments.length;
var i__4790__auto___65173 = (0);
while(true){
if((i__4790__auto___65173 < len__4789__auto___65172)){
args__4795__auto__.push((arguments[i__4790__auto___65173]));

var G__65174 = (i__4790__auto___65173 + (1));
i__4790__auto___65173 = G__65174;
continue;
} else {
}
break;
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__65095){
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__65105 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__65105) : instaparse.reduction.node_builders.call(null,G__65105));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq65087){
...
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65088,G__65089,seq65087__$2);
}));
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k65109,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k65109,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__65127){
var vec__65128 = p__65127;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65128,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65128,(1),null);
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this65110,other65111){
var self__ = this;
var this65110__$1 = this;
return (((!((other65111 == null)))) && ((this65110__$1.constructor === other65111.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65110__$1.grammar,other65111.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65110__$1.start_production,other65111.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65110__$1.output_format,other65111.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65110__$1.__extmap,other65111.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__65108){
var self__ = this;
...
return (new instaparse.core.Parser(G__65108,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
...
return (new instaparse.core.Parser(self__.grammar,G__65108,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
...
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__65108,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__65108),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__65108){
var self__ = this;
var this__4438__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__65108,self__.__extmap,self__.__hash));
}));
...
(instaparse.core.Parser.prototype.apply = (function (self__,args65118){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args65118)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__65116){
var extmap__4478__auto__ = (function (){var G__65150 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__65116,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__65116)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__65150);
} else {
return G__65150;
}
})();
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__65116),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__65116),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__65116),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var args__4795__auto__ = [];
var len__4789__auto___65258 = arguments.length;
var i__4790__auto___65259 = (0);
while(true){
if((i__4790__auto___65259 < len__4789__auto___65258)){
args__4795__auto__.push((arguments[i__4790__auto___65259]));

var G__65260 = (i__4790__auto___65259 + (1));
i__4790__auto___65259 = G__65260;
continue;
} else {
}
break;
