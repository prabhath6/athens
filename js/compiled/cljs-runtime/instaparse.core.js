...
if(cljs.core.truth_((function (){var fexpr__65079 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__65079.cljs$core$IFn$_invoke$arity$1 ? fexpr__65079.cljs$core$IFn$_invoke$arity$1(type) : fexpr__65079.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__65080 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__65080.cljs$core$IFn$_invoke$arity$1 ? fexpr__65080.cljs$core$IFn$_invoke$arity$1(type) : fexpr__65080.call(null,type));
})())){
} else {
...
var G__65081 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__65081)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__65081)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__65081)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__65081)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__65081)].join('')));
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__65085){
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__65088 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__65088) : instaparse.reduction.node_builders.call(null,G__65088));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq65082){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65083,G__65084,seq65082__$2);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___65184 = arguments.length;
var i__4790__auto___65185 = (0);
while(true){
if((i__4790__auto___65185 < len__4789__auto___65184)){
args__4795__auto__.push((arguments[i__4790__auto___65185]));

var G__65186 = (i__4790__auto___65185 + (1));
i__4790__auto___65185 = G__65186;
continue;
} else {
}
break;
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__65092){
var map__65093 = p__65092;
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__65095 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__65095) : instaparse.reduction.node_builders.call(null,G__65095));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq65089){
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k65100,else__4442__auto__){
var self__ = this;
var this__4441__auto____$1 = this;
var G__65106 = k65100;
var G__65106__$1 = (((G__65106 instanceof cljs.core.Keyword))?G__65106.fqn:null);
switch (G__65106__$1) {
case "grammar":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k65100,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__65109){
var vec__65110 = p__65109;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65110,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65110,(1),null);
...
var h__4297__auto____$1 = (function (){var fexpr__65114 = (function (coll__4436__auto__){
return (-360509877 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__65114(this__4435__auto____$1);
})();
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this65101,other65102){
var self__ = this;
var this65101__$1 = this;
return (((!((other65102 == null)))) && ((this65101__$1.constructor === other65102.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65101__$1.grammar,other65102.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65101__$1.start_production,other65102.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65101__$1.output_format,other65102.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65101__$1.__extmap,other65102.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__65099){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__65129 = cljs.core.keyword_identical_QMARK_;
var expr__65130 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__65133 = new cljs.core.Keyword(null,"grammar","grammar",1881328267);
var G__65134 = expr__65130;
return (pred__65129.cljs$core$IFn$_invoke$arity$2 ? pred__65129.cljs$core$IFn$_invoke$arity$2(G__65133,G__65134) : pred__65129.call(null,G__65133,G__65134));
})())){
return (new instaparse.core.Parser(G__65099,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__65135 = new cljs.core.Keyword(null,"start-production","start-production",687546537);
var G__65136 = expr__65130;
return (pred__65129.cljs$core$IFn$_invoke$arity$2 ? pred__65129.cljs$core$IFn$_invoke$arity$2(G__65135,G__65136) : pred__65129.call(null,G__65135,G__65136));
})())){
return (new instaparse.core.Parser(self__.grammar,G__65099,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__65138 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676);
var G__65139 = expr__65130;
return (pred__65129.cljs$core$IFn$_invoke$arity$2 ? pred__65129.cljs$core$IFn$_invoke$arity$2(G__65138,G__65139) : pred__65129.call(null,G__65138,G__65139));
})())){
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__65099,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__65099),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__65099){
var self__ = this;
var this__4438__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__65099,self__.__extmap,self__.__hash));
}));
...
var self__ = this;
var self__ = this;
var G__65144 = (arguments.length - (1));
switch (G__65144) {
case (1):
...
(instaparse.core.Parser.prototype.apply = (function (self__,args65105){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args65105)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__65104){
var extmap__4478__auto__ = (function (){var G__65162 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__65104,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
...
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__65104),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__65104),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__65104),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
