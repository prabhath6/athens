...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__58637 = goog.object.get(JSJodaLocale,"Locale");
if((G__58637 == null)){
return null;
} else {
return goog.object.get(G__58637,"US");
}
}catch (e58636){if((e58636 instanceof Error)){
var e = e58636;
return null;
} else {
throw e58636;
