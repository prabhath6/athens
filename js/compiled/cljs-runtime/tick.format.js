...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__58526 = goog.object.get(JSJodaLocale,"Locale");
if((G__58526 == null)){
return null;
} else {
return goog.object.get(G__58526,"US");
}
}catch (e58525){if((e58525 instanceof Error)){
var e = e58525;
return null;
} else {
throw e58525;
