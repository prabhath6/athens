...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__58536 = goog.object.get(JSJodaLocale,"Locale");
if((G__58536 == null)){
return null;
} else {
return goog.object.get(G__58536,"US");
}
}catch (e58535){if((e58535 instanceof Error)){
var e = e58535;
return null;
} else {
throw e58535;
