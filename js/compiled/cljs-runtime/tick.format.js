...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__80169 = goog.object.get(JSJodaLocale,"Locale");
if((G__80169 == null)){
return null;
} else {
return goog.object.get(G__80169,"US");
}
}catch (e80168){if((e80168 instanceof Error)){
var e = e80168;
return null;
} else {
throw e80168;
