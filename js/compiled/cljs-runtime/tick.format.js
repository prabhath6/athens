...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__58696 = goog.object.get(JSJodaLocale,"Locale");
if((G__58696 == null)){
return null;
} else {
return goog.object.get(G__58696,"US");
}
