...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__58676 = goog.object.get(JSJodaLocale,"Locale");
if((G__58676 == null)){
return null;
} else {
return goog.object.get(G__58676,"US");
}
}catch (e58675){if((e58675 instanceof Error)){
var e = e58675;
return null;
} else {
throw e58675;
