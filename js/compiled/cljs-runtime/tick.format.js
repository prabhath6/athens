...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__58575 = goog.object.get(JSJodaLocale,"Locale");
if((G__58575 == null)){
return null;
} else {
return goog.object.get(G__58575,"US");
}
}catch (e58571){if((e58571 instanceof Error)){
var e = e58571;
return null;
} else {
throw e58571;
