...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__58560 = goog.object.get(JSJodaLocale,"Locale");
if((G__58560 == null)){
return null;
} else {
return goog.object.get(G__58560,"US");
}
}catch (e58557){if((e58557 instanceof Error)){
var e = e58557;
return null;
} else {
throw e58557;
