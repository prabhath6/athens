...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__58557 = goog.object.get(JSJodaLocale,"Locale");
if((G__58557 == null)){
return null;
} else {
return goog.object.get(G__58557,"US");
}
}catch (e58554){if((e58554 instanceof Error)){
var e = e58554;
return null;
} else {
throw e58554;
