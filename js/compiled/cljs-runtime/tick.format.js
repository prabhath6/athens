...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__58652 = goog.object.get(JSJodaLocale,"Locale");
if((G__58652 == null)){
return null;
} else {
return goog.object.get(G__58652,"US");
}
}catch (e58651){if((e58651 instanceof Error)){
var e = e58651;
return null;
} else {
throw e58651;
