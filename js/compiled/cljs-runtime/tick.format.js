...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__58623 = goog.object.get(JSJodaLocale,"Locale");
if((G__58623 == null)){
return null;
} else {
return goog.object.get(G__58623,"US");
}
}catch (e58620){if((e58620 instanceof Error)){
var e = e58620;
return null;
} else {
throw e58620;
