...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__58635 = goog.object.get(JSJodaLocale,"Locale");
if((G__58635 == null)){
return null;
} else {
return goog.object.get(G__58635,"US");
}
}catch (e58634){if((e58634 instanceof Error)){
var e = e58634;
return null;
} else {
throw e58634;
