...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__58629 = goog.object.get(JSJodaLocale,"Locale");
if((G__58629 == null)){
return null;
} else {
return goog.object.get(G__58629,"US");
}
}catch (e58628){if((e58628 instanceof Error)){
var e = e58628;
return null;
} else {
throw e58628;
