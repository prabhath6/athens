...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__58640 = goog.object.get(JSJodaLocale,"Locale");
if((G__58640 == null)){
return null;
} else {
return goog.object.get(G__58640,"US");
}
}catch (e58639){if((e58639 instanceof Error)){
var e = e58639;
return null;
} else {
throw e58639;
