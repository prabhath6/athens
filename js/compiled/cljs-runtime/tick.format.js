...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__58669 = goog.object.get(JSJodaLocale,"Locale");
if((G__58669 == null)){
return null;
} else {
return goog.object.get(G__58669,"US");
}
