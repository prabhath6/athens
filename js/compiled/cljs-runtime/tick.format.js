...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__58672 = goog.object.get(JSJodaLocale,"Locale");
if((G__58672 == null)){
return null;
} else {
return goog.object.get(G__58672,"US");
}
}catch (e58668){if((e58668 instanceof Error)){
var e = e58668;
return null;
} else {
throw e58668;
