...
var vec__86622 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86622,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86622,(1),null);
...
var vec__86629 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86629,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86629,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__86636 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86636,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86636,(1),null);
...
var G__86755 = cljs.core.next(parses__$1);
parses__$1 = G__86755;
continue;
}
...
var G__86655 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__86656 = G__86655;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86656,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86656,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86656,(2),null);
var selection = vec__86656;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__86655__$1 = G__86655;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__86662 = G__86655__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86662,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86662,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86662,(2),null);
var selection__$1 = vec__86662;
...
var G__86757 = cljs.core.long$(end__$1);
var G__86758 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__86759 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__86757;
parses__$1 = G__86758;
G__86655__$1 = G__86759;
continue;
...
var G__86670 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__86671 = G__86670;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86671,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86671,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86671,(2),null);
var selection = vec__86671;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__86670__$1 = G__86670;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__86677 = G__86670__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86677,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86677,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86677,(2),null);
var selection__$1 = vec__86677;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__86761 = cljs.core.long$(end__$1);
var G__86762 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__86763 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__86761;
parses__$1 = G__86762;
G__86670__$1 = G__86763;
continue;
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__86692 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__86695 = G__86692;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86695,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86695,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86695,(2),null);
var selection = vec__86695;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__86692__$1 = G__86692;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__86702 = G__86692__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86702,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86702,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86702,(2),null);
var selection__$1 = vec__86702;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__86765 = cljs.core.long$(end__$1);
var G__86766 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__86767 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__86765;
parses__$1 = G__86766;
G__86692__$1 = G__86767;
continue;
...
if(cljs.core.truth_((function (){var fexpr__86737 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__86737.cljs$core$IFn$_invoke$arity$1 ? fexpr__86737.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__86737.call(null,output_format));
})())){
} else {
...
var G__86745 = output_format;
var G__86745__$1 = (((G__86745 instanceof cljs.core.Keyword))?G__86745.fqn:null);
switch (G__86745__$1) {
case "enlive":
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4174__auto__ = (function (){var G__86753 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__86752 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__86752.cljs$core$IFn$_invoke$arity$1 ? fexpr__86752.cljs$core$IFn$_invoke$arity$1(G__86753) : fexpr__86752.call(null,G__86753));
})();
