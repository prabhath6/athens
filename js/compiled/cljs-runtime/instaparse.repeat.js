...
var vec__64900 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64900,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64900,(1),null);
...
var vec__64903 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64903,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64903,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__64906 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64906,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64906,(1),null);
...
var G__64967 = cljs.core.next(parses__$1);
parses__$1 = G__64967;
continue;
}
...
var G__64914 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__64915 = G__64914;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64915,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64915,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64915,(2),null);
var selection = vec__64915;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__64914__$1 = G__64914;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__64921 = G__64914__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64921,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64921,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64921,(2),null);
var selection__$1 = vec__64921;
...
var G__64969 = cljs.core.long$(end__$1);
var G__64970 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__64971 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__64969;
parses__$1 = G__64970;
G__64914__$1 = G__64971;
continue;
...
var G__64929 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__64930 = G__64929;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64930,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64930,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64930,(2),null);
var selection = vec__64930;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__64929__$1 = G__64929;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__64936 = G__64929__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64936,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64936,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64936,(2),null);
var selection__$1 = vec__64936;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__64944 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__64945 = G__64944;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64945,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64945,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64945,(2),null);
var selection = vec__64945;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__64944__$1 = G__64944;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__64951 = G__64944__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64951,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64951,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64951,(2),null);
var selection__$1 = vec__64951;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
if(cljs.core.truth_((function (){var fexpr__64956 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__64956.cljs$core$IFn$_invoke$arity$1 ? fexpr__64956.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__64956.call(null,output_format));
})())){
} else {
...
var G__64957 = output_format;
var G__64957__$1 = (((G__64957 instanceof cljs.core.Keyword))?G__64957.fqn:null);
switch (G__64957__$1) {
case "enlive":
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4174__auto__ = (function (){var G__64965 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__64964 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__64964.cljs$core$IFn$_invoke$arity$1 ? fexpr__64964.cljs$core$IFn$_invoke$arity$1(G__64965) : fexpr__64964.call(null,G__64965));
})();
