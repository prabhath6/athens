...
var arg = cljs.core.seq(arglist__53770);
...
var G__53771 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__53771;
continue;
} else {
...
var G__53772 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__53772;
continue;
} else {
var G__53773 = clojure.zip.next(loc);
loc = G__53773;
continue;
