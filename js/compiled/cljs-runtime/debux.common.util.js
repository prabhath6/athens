...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__53682_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__53682_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__53681_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__53681_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__53683_SHARP_){
return (((p1__53683_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__53683_SHARP_) == null)));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__53687_SHARP_){
if((p1__53687_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__53687_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var _STAR_print_newline_STAR__orig_val__53702_53741 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__53703_53742 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__53704_53743 = true;
var _STAR_print_fn_STAR__temp_val__53705_53744 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__53704_53743);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__53705_53744);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__53703_53742);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__53702_53741);
}
...
if(typeof f === 'number'){
var G__53745 = cljs.core.next(opts__$1);
var G__53746 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__53745;
acc = G__53746;
continue;
} else {
if(typeof f === 'string'){
var G__53747 = cljs.core.next(opts__$1);
var G__53748 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__53747;
acc = G__53748;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__53749 = cljs.core.nnext(opts__$1);
var G__53750 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__53749;
acc = G__53750;
continue;
} else {
...
var G__53752 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__53751;
acc = G__53752;
continue;
} else {
...
var G__53754 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__53753;
acc = G__53754;
continue;
} else {
...
var G__53756 = cljs.core.nnext(opts__$1);
var G__53757 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__53756;
acc = G__53757;
continue;
} else {
...
var G__53759 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__53758;
acc = G__53759;
continue;
} else {
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__53719 = quoted_form;
var G__53720 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__53719,G__53720) : debux.common.util.remove_d.call(null,G__53719,G__53720));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__53721 = quoted_form;
var G__53722 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__53721,G__53722) : debux.common.util.remove_d.call(null,G__53721,G__53722));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__53761__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__53723 = quoted_form;
var G__53724 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__53723,G__53724) : debux.common.util.remove_d.call(null,G__53723,G__53724));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
while (G__53762__i < G__53762__a.length) {G__53762__a[G__53762__i] = arguments[G__53762__i + 0]; ++G__53762__i;}
  arg = new cljs.core.IndexedSeq(G__53762__a,0,null);
} 
return G__53761__delegate.call(this,arg);};
G__53761.cljs$lang$maxFixedArity = 0;
G__53761.cljs$lang$applyTo = (function (arglist__53763){
var arg = cljs.core.seq(arglist__53763);
return G__53761__delegate(arg);
});
...
var G__53768 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__53768;
continue;
} else {
...
var G__53769 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__53769;
continue;
} else {
var G__53770 = clojure.zip.next(loc);
loc = G__53770;
continue;
