...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__75636_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__75636_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__75635_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__75635_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__75637_SHARP_){
return (((p1__75637_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__75637_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__75640,mapping){
var map__75641 = p__75640;
var map__75641__$1 = (((((!((map__75641 == null))))?(((((map__75641.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__75641.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__75641):map__75641);
var state = map__75641__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75641__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75641__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75641__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__75638_SHARP_){
if((p1__75638_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__75638_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__75822 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__75824 = clojure.zip.next(loc);
loc = G__75824;
continue;
}
}
...
var len__4789__auto___75843 = arguments.length;
var i__4790__auto___75844 = (0);
while(true){
if((i__4790__auto___75844 < len__4789__auto___75843)){
args__4795__auto__.push((arguments[i__4790__auto___75844]));

var G__75847 = (i__4790__auto___75844 + (1));
i__4790__auto___75844 = G__75847;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__75688){
var vec__75690 = p__75688;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75690,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq75681){
var G__75682 = cljs.core.first(seq75681);
var seq75681__$1 = cljs.core.next(seq75681);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__75682,seq75681__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__75698_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__75698_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__75705_75853 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__75706_75854 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__75707_75855 = true;
var _STAR_print_fn_STAR__temp_val__75708_75856 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__75707_75855);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__75708_75856);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__75706_75854);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__75705_75853);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__75702_SHARP_){
return debux.common.util.prepend_bars(p1__75702_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__75861 = cljs.core.next(opts__$1);
var G__75862 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__75861;
acc = G__75862;
continue;
} else {
if(typeof f === 'string'){
var G__75863 = cljs.core.next(opts__$1);
var G__75864 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__75863;
acc = G__75864;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__75866 = cljs.core.nnext(opts__$1);
var G__75867 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__75866;
acc = G__75867;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__75868 = cljs.core.next(opts__$1);
var G__75869 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__75868;
acc = G__75869;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__75726 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__75726.cljs$core$IFn$_invoke$arity$1 ? fexpr__75726.cljs$core$IFn$_invoke$arity$1(f) : fexpr__75726.call(null,f));
})())){
var G__75873 = cljs.core.next(opts__$1);
var G__75874 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__75873;
acc = G__75874;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__75735 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__75735.cljs$core$IFn$_invoke$arity$1 ? fexpr__75735.cljs$core$IFn$_invoke$arity$1(f) : fexpr__75735.call(null,f));
})())){
var G__75876 = cljs.core.nnext(opts__$1);
var G__75877 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__75876;
acc = G__75877;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__75878 = cljs.core.next(opts__$1);
var G__75879 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__75878;
acc = G__75879;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__75739){
var vec__75742 = p__75739;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75742,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75742,(1),null);
...
var G__75753 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__75752 = (function (){var fexpr__75754 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten);
return (fexpr__75754.cljs$core$IFn$_invoke$arity$1 ? fexpr__75754.cljs$core$IFn$_invoke$arity$1(form) : fexpr__75754.call(null,form));
})();
return (fexpr__75752.cljs$core$IFn$_invoke$arity$1 ? fexpr__75752.cljs$core$IFn$_invoke$arity$1(G__75753) : fexpr__75752.call(null,G__75753));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__75763 = quoted_form;
var G__75764 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__75763,G__75764) : debux.common.util.remove_d.call(null,G__75763,G__75764));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__75769 = quoted_form;
var G__75770 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__75769,G__75770) : debux.common.util.remove_d.call(null,G__75769,G__75770));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__75896__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__75776 = quoted_form;
var G__75777 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__75776,G__75777) : debux.common.util.remove_d.call(null,G__75776,G__75777));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
var G__75901__i = 0, G__75901__a = new Array(arguments.length -  0);
while (G__75901__i < G__75901__a.length) {G__75901__a[G__75901__i] = arguments[G__75901__i + 0]; ++G__75901__i;}
  arg = new cljs.core.IndexedSeq(G__75901__a,0,null);
} 
return G__75896__delegate.call(this,arg);};
G__75896.cljs$lang$maxFixedArity = 0;
G__75896.cljs$lang$applyTo = (function (arglist__75904){
var arg = cljs.core.seq(arglist__75904);
return G__75896__delegate(arg);
});
...
var G__75911 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__75911;
continue;
} else {
...
var G__75912 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__75912;
continue;
} else {
var G__75915 = clojure.zip.next(loc);
loc = G__75915;
continue;
