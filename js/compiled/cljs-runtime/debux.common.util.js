...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__53686_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__53686_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__53685_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__53685_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__53687_SHARP_){
return (((p1__53687_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__53687_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__53690,mapping){
...
var state = map__53691__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53691__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53691__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53691__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__53688_SHARP_){
if((p1__53688_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__53688_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__53734 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__53735 = clojure.zip.next(loc);
loc = G__53735;
continue;
}
}
...
var len__4789__auto___53740 = arguments.length;
var i__4790__auto___53741 = (0);
while(true){
if((i__4790__auto___53741 < len__4789__auto___53740)){
args__4795__auto__.push((arguments[i__4790__auto___53741]));

var G__53742 = (i__4790__auto___53741 + (1));
i__4790__auto___53741 = G__53742;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__53696){
var vec__53697 = p__53696;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53697,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq53694){
var G__53695 = cljs.core.first(seq53694);
var seq53694__$1 = cljs.core.next(seq53694);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__53695,seq53694__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__53700_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__53700_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__53702_53743 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__53703_53744 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__53704_53745 = true;
var _STAR_print_fn_STAR__temp_val__53705_53746 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__53704_53745);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__53705_53746);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__53703_53744);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__53702_53743);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__53701_SHARP_){
return debux.common.util.prepend_bars(p1__53701_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__53751 = cljs.core.next(opts__$1);
var G__53752 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__53751;
acc = G__53752;
continue;
} else {
if(typeof f === 'string'){
var G__53753 = cljs.core.next(opts__$1);
var G__53754 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__53753;
acc = G__53754;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__53755 = cljs.core.nnext(opts__$1);
var G__53756 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__53755;
acc = G__53756;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__53757 = cljs.core.next(opts__$1);
var G__53758 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__53757;
acc = G__53758;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__53708 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__53708.cljs$core$IFn$_invoke$arity$1 ? fexpr__53708.cljs$core$IFn$_invoke$arity$1(f) : fexpr__53708.call(null,f));
})())){
var G__53759 = cljs.core.next(opts__$1);
var G__53760 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__53759;
acc = G__53760;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__53709 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__53709.cljs$core$IFn$_invoke$arity$1 ? fexpr__53709.cljs$core$IFn$_invoke$arity$1(f) : fexpr__53709.call(null,f));
})())){
var G__53761 = cljs.core.nnext(opts__$1);
var G__53762 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__53761;
acc = G__53762;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__53763 = cljs.core.next(opts__$1);
var G__53764 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__53763;
acc = G__53764;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__53710){
var vec__53711 = p__53710;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53711,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53711,(1),null);
...
var G__53716 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__53715 = (function (){var fexpr__53718 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten);
return (fexpr__53718.cljs$core$IFn$_invoke$arity$1 ? fexpr__53718.cljs$core$IFn$_invoke$arity$1(form) : fexpr__53718.call(null,form));
})();
return (fexpr__53715.cljs$core$IFn$_invoke$arity$1 ? fexpr__53715.cljs$core$IFn$_invoke$arity$1(G__53716) : fexpr__53715.call(null,G__53716));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__53727 = quoted_form;
var G__53728 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__53727,G__53728) : debux.common.util.remove_d.call(null,G__53727,G__53728));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__53729 = quoted_form;
var G__53730 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__53729,G__53730) : debux.common.util.remove_d.call(null,G__53729,G__53730));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__53765__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__53731 = quoted_form;
var G__53732 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__53731,G__53732) : debux.common.util.remove_d.call(null,G__53731,G__53732));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));

return result;
};
var G__53765 = function (var_args){
var arg = null;
...
while (G__53768__i < G__53768__a.length) {G__53768__a[G__53768__i] = arguments[G__53768__i + 0]; ++G__53768__i;}
  arg = new cljs.core.IndexedSeq(G__53768__a,0,null);
} 
return G__53765__delegate.call(this,arg);};
G__53765.cljs$lang$maxFixedArity = 0;
G__53765.cljs$lang$applyTo = (function (arglist__53769){
var arg = cljs.core.seq(arglist__53769);
return G__53765__delegate(arg);
});
G__53765.cljs$core$IFn$_invoke$arity$variadic = G__53765__delegate;
return G__53765;
})()
;
});
...
var G__53770 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__53770;
continue;
} else {
...
var G__53771 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__53771;
continue;
} else {
var G__53772 = clojure.zip.next(loc);
loc = G__53772;
continue;
