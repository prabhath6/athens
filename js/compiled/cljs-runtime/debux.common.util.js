...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__53674_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__53674_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__53673_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__53673_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__53679_SHARP_){
return (((p1__53679_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__53679_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__53692,mapping){
...
var state = map__53693__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53693__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53693__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53693__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
var G__53733 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__53734 = clojure.zip.next(loc);
loc = G__53734;
continue;
}
}
...
var len__4789__auto___53737 = arguments.length;
var i__4790__auto___53738 = (0);
while(true){
if((i__4790__auto___53738 < len__4789__auto___53737)){
args__4795__auto__.push((arguments[i__4790__auto___53738]));

var G__53739 = (i__4790__auto___53738 + (1));
i__4790__auto___53738 = G__53739;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__53698){
var vec__53699 = p__53698;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53699,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq53696){
var G__53697 = cljs.core.first(seq53696);
var seq53696__$1 = cljs.core.next(seq53696);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__53697,seq53696__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__53702_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__53702_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__53705_53740 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__53706_53741 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__53707_53742 = true;
var _STAR_print_fn_STAR__temp_val__53708_53743 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__53707_53742);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__53708_53743);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__53706_53741);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__53705_53740);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__53703_SHARP_){
return debux.common.util.prepend_bars(p1__53703_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__53744 = cljs.core.next(opts__$1);
var G__53745 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__53744;
acc = G__53745;
continue;
} else {
if(typeof f === 'string'){
var G__53746 = cljs.core.next(opts__$1);
var G__53747 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__53746;
acc = G__53747;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__53748 = cljs.core.nnext(opts__$1);
var G__53749 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__53748;
acc = G__53749;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__53750 = cljs.core.next(opts__$1);
var G__53751 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__53750;
acc = G__53751;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__53711 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__53711.cljs$core$IFn$_invoke$arity$1 ? fexpr__53711.cljs$core$IFn$_invoke$arity$1(f) : fexpr__53711.call(null,f));
})())){
var G__53752 = cljs.core.next(opts__$1);
var G__53753 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__53752;
acc = G__53753;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__53712 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__53712.cljs$core$IFn$_invoke$arity$1 ? fexpr__53712.cljs$core$IFn$_invoke$arity$1(f) : fexpr__53712.call(null,f));
})())){
var G__53754 = cljs.core.nnext(opts__$1);
var G__53755 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__53754;
acc = G__53755;
continue;
} else {
...
var G__53757 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__53756;
acc = G__53757;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__53716){
var vec__53717 = p__53716;
...
return (function() { 
var G__53758__delegate = function (arg){
...
while (G__53759__i < G__53759__a.length) {G__53759__a[G__53759__i] = arguments[G__53759__i + 0]; ++G__53759__i;}
  arg = new cljs.core.IndexedSeq(G__53759__a,0,null);
} 
return G__53758__delegate.call(this,arg);};
G__53758.cljs$lang$maxFixedArity = 0;
G__53758.cljs$lang$applyTo = (function (arglist__53760){
var arg = cljs.core.seq(arglist__53760);
return G__53758__delegate(arg);
});
...
var G__53761 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__53761;
continue;
} else {
...
var G__53762 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__53762;
continue;
} else {
var G__53763 = clojure.zip.next(loc);
loc = G__53763;
continue;
