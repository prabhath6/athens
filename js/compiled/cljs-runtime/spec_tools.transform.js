...
if((x instanceof cljs.core.Keyword)){
var G__55076 = spec;
var G__55077 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__55076,G__55077) : f.call(null,G__55076,G__55077));
} else {
if(typeof x === 'string'){
...
if((x instanceof cljs.core.Keyword)){
var G__55078 = spec;
var G__55079 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__55078,G__55079) : f.call(null,G__55078,G__55079));
} else {
return x;
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__55085,x){
var map__55086 = p__55085;
var map__55086__$1 = (((((!((map__55086 == null))))?(((((map__55086.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__55086.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__55086):map__55086);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55086__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__55088,x){
...
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55089__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__55091,x){
var map__55092 = p__55091;
var map__55092__$1 = (((((!((map__55092 == null))))?(((((map__55092.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__55092.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__55092):map__55092);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55092__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
