...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__20394 = file;
if(cljs.stacktrace.starts_with_QMARK_(file,"(")){
return clojure.string.replace(G__20394,"(","");
} else {
return G__20394;
}
})(),cljs.stacktrace.parse_int((function (){var G__20395 = line;
if(cljs.stacktrace.ends_with_QMARK_(line,")")){
return clojure.string.replace(G__20395,")","");
} else {
return G__20395;
}
})()),cljs.stacktrace.parse_int((function (){var G__20396 = column;
if(cljs.stacktrace.ends_with_QMARK_(column,")")){
return clojure.string.replace(G__20396,")","");
} else {
return G__20396;
}
})())], null);
...
var vec__20409 = ((((1) === cljs.core.count(xs)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.first(xs)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(xs),cljs.core.last(xs)], null));
...
}),cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__20419_SHARP_){
return (!(cljs.stacktrace.starts_with_QMARK_(p1__20419_SHARP_,"    at eval")));
...
var vec__20424 = (cljs.core.truth_(cljs.core.re_find(/@/,st_el))?clojure.string.split.cljs$core$IFn$_invoke$arity$2(st_el,/@/):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,st_el], null));
var function$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20424,(0),null);
var flc = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20424,(1),null);
var vec__20427 = cljs.stacktrace.parse_file_line_column(flc);
var file = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20427,(0),null);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20427,(1),null);
var column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20427,(2),null);
if(cljs.core.truth_((function (){var and__4174__auto__ = file;
if(cljs.core.truth_(and__4174__auto__)){
var and__4174__auto____$1 = function$;
if(cljs.core.truth_(and__4174__auto____$1)){
...
return cljs.core.vec(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__20434_SHARP_){
return cljs.stacktrace.safari_st_el__GT_frame(repl_env,p1__20434_SHARP_,opts);
}),cljs.core.remove.cljs$core$IFn$_invoke$arity$2(clojure.string.blank_QMARK_,cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__20433_SHARP_){
return (!(cljs.stacktrace.starts_with_QMARK_(p1__20433_SHARP_,"eval code")));
}),cljs.core.drop_while.cljs$core$IFn$_invoke$arity$2((function (p1__20432_SHARP_){
return cljs.stacktrace.starts_with_QMARK_(p1__20432_SHARP_,"Error");
}),clojure.string.split_lines(st)))))));
}));
...
return cljs.core.vec(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__20447_SHARP_){
return cljs.stacktrace.firefox_st_el__GT_frame(repl_env,p1__20447_SHARP_,opts);
}),cljs.core.remove.cljs$core$IFn$_invoke$arity$2(clojure.string.blank_QMARK_,cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__20446_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(p1__20446_SHARP_.indexOf("> eval"),(-1));
}),cljs.core.drop_while.cljs$core$IFn$_invoke$arity$2((function (p1__20445_SHARP_){
return cljs.stacktrace.starts_with_QMARK_(p1__20445_SHARP_,"Error");
}),clojure.string.split_lines(st)))))));
}));
cljs.stacktrace.parse_stacktrace.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"rhino","rhino",1962118035),(function (repl_env,st,err,p__20449){
...
var opts = map__20450__$1;
var output_dir = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20450__$1,new cljs.core.Keyword(null,"output-dir","output-dir",-290956991));
var process_frame = (function cljs$stacktrace$process_frame(frame_str){
if(((clojure.string.blank_QMARK_(frame_str)) || (((-1) === frame_str.indexOf("\tat"))))){
return null;
} else {
var vec__20463 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(frame_str,/:/);
var file_side = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20463,(0),null);
var line_fn_side = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20463,(1),null);
var file = clojure.string.replace(file_side,/\s+at\s+/,"");
var vec__20466 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(line_fn_side,/\s+/);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20466,(0),null);
var function$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20466,(1),null);
...
cljs.stacktrace.parse_stacktrace.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"nashorn","nashorn",988299963),(function (repl_env,st,err,p__20473){
...
var vec__20486 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(frame_str__$1,/\s+/);
var function$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20486,(0),null);
var file_and_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20486,(1),null);
var vec__20489 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(file_and_line,/:/);
var file_part = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20489,(0),null);
var line_part = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20489,(1),null);
...
cljs.stacktrace.parse_stacktrace.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"graaljs","graaljs",1880468686),(function (repl_env,st,err,p__20493){
...
var vec__20507 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(frame_str,/\(/);
var function$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20507,(0),null);
var file_and_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20507,(1),null);
var vec__20510 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(file_and_line,/:/);
var file_part = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20510,(0),null);
var line_part = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20510,(1),null);
...
var opts = map__20525__$1;
var output_dir = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20525__$1,new cljs.core.Keyword(null,"output-dir","output-dir",-290956991));
...
var function$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20544,(0),null);
var file_AMPERSAND_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20544,(1),null);
var vec__20547 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(file_AMPERSAND_line,/:/);
var file_part = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20547,(0),null);
var line_part = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20547,(1),null);
var col_part = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20547,(2),null);
return new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"file","file",-1269645878),(cljs.core.truth_(function$)?(function (){var G__20551 = file_part;
if(cljs.core.truth_(output_dir)){
return clojure.string.replace(G__20551,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(output_dir),"/"].join(''),"");
} else {
return G__20551;
}
...
return cljs.core.last((function (){var or__4185__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(columns,cljs.core.last(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__20556_SHARP_){
return (p1__20556_SHARP_ <= (column__$1 - (1)));
...
return cljs.core.vec(cljs.core.map.cljs$core$IFn$_invoke$arity$3((function (p1__20557_SHARP_,p2__20558_SHARP_){
return (p1__20557_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__20557_SHARP_.cljs$core$IFn$_invoke$arity$1(p2__20558_SHARP_) : p1__20557_SHARP_.call(null,p2__20558_SHARP_));
...
var mapped_frames = cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.memoize((function (p1__20577_SHARP_){
return cljs.stacktrace.mapped_frame(p1__20577_SHARP_,sms,opts);
})),stacktrace);
return cljs.core.vec(cljs.core.map.cljs$core$IFn$_invoke$arity$3(call_merge,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__20579_SHARP_){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(p1__20579_SHARP_,new cljs.core.Keyword(null,"call","call",-519999866));
...
var _STAR_print_newline_STAR__orig_val__20594_20708 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__20595_20709 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__20596_20710 = true;
var _STAR_print_fn_STAR__temp_val__20597_20711 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__20596_20710);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__20597_20711);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__20595_20709);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__20594_20708);
}
