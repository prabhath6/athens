...
return cljs.core.vec(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__20392_SHARP_){
return cljs.stacktrace.chrome_st_el__GT_frame(repl_env,p1__20392_SHARP_,opts);
}),cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__20391_SHARP_){
return (!(cljs.stacktrace.starts_with_QMARK_(p1__20391_SHARP_,"    at eval")));
}),cljs.core.drop_while.cljs$core$IFn$_invoke$arity$2((function (p1__20390_SHARP_){
return cljs.stacktrace.starts_with_QMARK_(p1__20390_SHARP_,"Error");
...
var vec__20407 = (cljs.core.truth_(cljs.core.re_find(/@/,st_el))?clojure.string.split.cljs$core$IFn$_invoke$arity$2(st_el,/@/):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,st_el], null));
var function$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20407,(0),null);
var flc = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20407,(1),null);
var vec__20410 = cljs.stacktrace.parse_file_line_column(flc);
var file = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20410,(0),null);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20410,(1),null);
var column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20410,(2),null);
if(cljs.core.truth_((function (){var and__4174__auto__ = file;
if(cljs.core.truth_(and__4174__auto__)){
var and__4174__auto____$1 = function$;
if(cljs.core.truth_(and__4174__auto____$1)){
...
return cljs.core.vec(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__20417_SHARP_){
return cljs.stacktrace.firefox_st_el__GT_frame(repl_env,p1__20417_SHARP_,opts);
}),cljs.core.remove.cljs$core$IFn$_invoke$arity$2(clojure.string.blank_QMARK_,cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__20416_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(p1__20416_SHARP_.indexOf("> eval"),(-1));
}),cljs.core.drop_while.cljs$core$IFn$_invoke$arity$2((function (p1__20415_SHARP_){
return cljs.stacktrace.starts_with_QMARK_(p1__20415_SHARP_,"Error");
}),clojure.string.split_lines(st)))))));
}));
...
cljs.stacktrace.parse_stacktrace.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"nashorn","nashorn",988299963),(function (repl_env,st,err,p__20439){
...
var vec__20454 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(frame_str__$1,/\s+/);
var function$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20454,(0),null);
var file_and_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20454,(1),null);
var vec__20457 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(file_and_line,/:/);
var file_part = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20457,(0),null);
var line_part = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20457,(1),null);
...
cljs.stacktrace.parse_stacktrace.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"graaljs","graaljs",1880468686),(function (repl_env,st,err,p__20461){
...
var vec__20475 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(frame_str,/\(/);
var function$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20475,(0),null);
var file_and_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20475,(1),null);
var vec__20478 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(file_and_line,/:/);
var file_part = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20478,(0),null);
var line_part = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20478,(1),null);
...
var vec__20521 = ((no_source_file_QMARK_)?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [line,column,null], null):cljs.stacktrace.mapped_line_column_call(sms,file,line,column));
var line_SINGLEQUOTE_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20521,(0),null);
var column_SINGLEQUOTE_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20521,(1),null);
var call = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20521,(2),null);
...
var _STAR_print_newline_STAR__orig_val__20544_20653 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__20545_20654 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__20546_20655 = true;
var _STAR_print_fn_STAR__temp_val__20547_20656 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__20546_20655);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__20547_20656);
...
var map__20568_20663 = chunk__20551_20660.cljs$core$IIndexed$_nth$arity$2(null,i__20553_20662);
var map__20568_20664__$1 = (((((!((map__20568_20663 == null))))?(((((map__20568_20663.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20568_20663.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__20568_20663):map__20568_20663);
var function_20665 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20568_20664__$1,new cljs.core.Keyword(null,"function","function",-2127255473));
var file_20666 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20568_20664__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line_20667 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20568_20664__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column_20668 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20568_20664__$1,new cljs.core.Keyword(null,"column","column",2078222095));
...
var map__20577_20681 = cljs.core.first(seq__20550_20675__$1);
var map__20577_20682__$1 = (((((!((map__20577_20681 == null))))?(((((map__20577_20681.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20577_20681.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__20577_20681):map__20577_20681);
var function_20683 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20577_20682__$1,new cljs.core.Keyword(null,"function","function",-2127255473));
var file_20684 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20577_20682__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line_20685 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20577_20682__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column_20686 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20577_20682__$1,new cljs.core.Keyword(null,"column","column",2078222095));
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\t",[(cljs.core.truth_(function_20683)?[cljs.core.str.cljs$core$IFn$_invoke$arity$1(function_20683)," "].join(''):null),"(",cljs.core.str.cljs$core$IFn$_invoke$arity$1(file_20684),(cljs.core.truth_(line_20685)?[":",cljs.core.str.cljs$core$IFn$_invoke$arity$1(line_20685)].join(''):null),(cljs.core.truth_(column_20686)?[":",cljs.core.str.cljs$core$IFn$_invoke$arity$1(column_20686)].join(''):null),")"].join('')], 0));
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__20545_20654);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__20544_20653);
}
