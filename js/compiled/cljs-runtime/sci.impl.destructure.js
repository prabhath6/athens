...
var G__65822 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__65823 = n;
var G__65824 = cljs.core.nnext(bs);
var G__65825 = true;
ret = G__65822;
n = G__65823;
bs = G__65824;
seen_rest_QMARK_ = G__65825;
continue;
} else {
...
});})(G__65818,gmap,defaults,pvec,bents))
;
return fexpr__65817(G__65818);
})();
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__65807_SHARP_){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__65807_SHARP_);
}
})(),cljs.core.name(p1__65807_SHARP_));
}));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(mkn,"syms")){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__65808_SHARP_){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__65808_SHARP_);
}
})(),cljs.core.name(p1__65808_SHARP_));
}));
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__65809_SHARP_,p2__65810_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__65809_SHARP_,p2__65810_SHARP_,(function (){var fexpr__65819 = cljs.core.val(entry);
return (fexpr__65819.cljs$core$IFn$_invoke$arity$1 ? fexpr__65819.cljs$core$IFn$_invoke$arity$1(p2__65810_SHARP_) : fexpr__65819.call(null,p2__65810_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__65820 = cljs.core.key(entry);
return (fexpr__65820.cljs$core$IFn$_invoke$arity$1 ? fexpr__65820.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__65820.call(null,bes));
})());
...
var G__65830 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__65831 = cljs.core.next(bes);
ret = G__65830;
bes = G__65831;
continue;
} else {
...
var temp__5733__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__65811_SHARP_){
return (cljs.core.first(p1__65811_SHARP_) instanceof cljs.core.Keyword);
}),bents));
