...
var G__65783 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__65784 = n;
var G__65785 = cljs.core.nnext(bs);
var G__65786 = true;
ret = G__65783;
n = G__65784;
bs = G__65785;
seen_rest_QMARK_ = G__65786;
continue;
} else {
...
});})(G__65779,gmap,defaults,pvec,bents))
;
return fexpr__65778(G__65779);
})();
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__65759_SHARP_){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__65759_SHARP_);
}
})(),cljs.core.name(p1__65759_SHARP_));
}));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(mkn,"syms")){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__65760_SHARP_){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__65760_SHARP_);
}
})(),cljs.core.name(p1__65760_SHARP_));
}));
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__65761_SHARP_,p2__65762_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__65761_SHARP_,p2__65762_SHARP_,(function (){var fexpr__65780 = cljs.core.val(entry);
return (fexpr__65780.cljs$core$IFn$_invoke$arity$1 ? fexpr__65780.cljs$core$IFn$_invoke$arity$1(p2__65762_SHARP_) : fexpr__65780.call(null,p2__65762_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__65781 = cljs.core.key(entry);
return (fexpr__65781.cljs$core$IFn$_invoke$arity$1 ? fexpr__65781.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__65781.call(null,bes));
})());
...
var G__65791 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__65792 = cljs.core.next(bes);
ret = G__65791;
bes = G__65792;
continue;
} else {
...
var temp__5733__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__65763_SHARP_){
return (cljs.core.first(p1__65763_SHARP_) instanceof cljs.core.Keyword);
}),bents));
