...
var G__65787 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__65788 = n;
var G__65789 = cljs.core.nnext(bs);
var G__65790 = true;
ret = G__65787;
n = G__65788;
bs = G__65789;
...
});})(G__65782,gmap,defaults,pvec,bents))
;
return fexpr__65781(G__65782);
})();
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__65771_SHARP_){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__65771_SHARP_);
}
})(),cljs.core.name(p1__65771_SHARP_));
}));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(mkn,"syms")){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__65772_SHARP_){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__65772_SHARP_);
}
})(),cljs.core.name(p1__65772_SHARP_));
}));
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__65773_SHARP_,p2__65774_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__65773_SHARP_,p2__65774_SHARP_,(function (){var fexpr__65783 = cljs.core.val(entry);
return (fexpr__65783.cljs$core$IFn$_invoke$arity$1 ? fexpr__65783.cljs$core$IFn$_invoke$arity$1(p2__65774_SHARP_) : fexpr__65783.call(null,p2__65774_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__65784 = cljs.core.key(entry);
return (fexpr__65784.cljs$core$IFn$_invoke$arity$1 ? fexpr__65784.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__65784.call(null,bes));
})());
...
var G__65803 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__65804 = cljs.core.next(bes);
ret = G__65803;
bes = G__65804;
continue;
} else {
...
var temp__5733__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__65775_SHARP_){
return (cljs.core.first(p1__65775_SHARP_) instanceof cljs.core.Keyword);
}),bents));
