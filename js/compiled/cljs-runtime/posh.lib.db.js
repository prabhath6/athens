...
var G__46896 = cljs.core.cons(pdb,path);
var G__46897 = posh.lib.db.get_parent_db(pdb);
path = G__46896;
pdb = G__46897;
continue;
} else {
...
var fexpr__46871 = new cljs.core.Keyword(null,"db","db",993250759).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__46871.cljs$core$IFn$_invoke$arity$1 ? fexpr__46871.cljs$core$IFn$_invoke$arity$1(conn) : fexpr__46871.call(null,conn));
}
})();
var db__$2 = (cljs.core.truth_(since)?(function (){var fexpr__46872 = new cljs.core.Keyword(null,"since","since",315379842).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__46872.cljs$core$IFn$_invoke$arity$2 ? fexpr__46872.cljs$core$IFn$_invoke$arity$2(db__$1,since) : fexpr__46872.call(null,db__$1,since));
})():db__$1);
var db__$3 = (cljs.core.truth_(as_of)?(function (){var fexpr__46873 = new cljs.core.Keyword(null,"as-of","as-of",-1841962382).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__46873.cljs$core$IFn$_invoke$arity$2 ? fexpr__46873.cljs$core$IFn$_invoke$arity$2(db__$2,as_of) : fexpr__46873.call(null,db__$2,as_of));
})():db__$2);
var db__$4 = (cljs.core.truth_(with$)?new cljs.core.Keyword(null,"db-after","db-after",-571884666).cljs$core$IFn$_invoke$arity$1((function (){var fexpr__46874 = new cljs.core.Keyword(null,"with","with",-1536296876).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__46874.cljs$core$IFn$_invoke$arity$2 ? fexpr__46874.cljs$core$IFn$_invoke$arity$2(db__$3,with$) : fexpr__46874.call(null,db__$3,with$));
})()):db__$3);
...
posh.lib.db.poshdb__GT_db = (function posh$lib$db$poshdb__GT_db(p__46880,poshdb){
...
var posh_tree = map__46881__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46881__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var cache = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46881__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(poshdb),new cljs.core.Keyword(null,"db","db",993250759))){
