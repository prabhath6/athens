...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__66166,fn_name,macro_QMARK_,with_meta_QMARK_){
...
var _m = map__66167__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66167__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66167__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66167__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66167__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__66184 = cljs.core.next(args__$1);
var G__66185 = cljs.core.next(params__$1);
var G__66186 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__66184;
params__$1 = G__66185;
ret = G__66186;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__66169 = ctx__$1;
var G__66170 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__66169,G__66170) : interpret.call(null,G__66169,G__66170));
...
var vec__66171 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66171,(0),null);
var vec__66174 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66171,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66174,(0),null);
var G__66187 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__66187;
continue;
} else {
var G__66188 = recur_val;
args = G__66188;
continue;
}
} else {
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__66190){
...
var map__66177 = cljs.core.meta(f);
var map__66177__$1 = (((((!((map__66177 == null))))?(((((map__66177.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__66177.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__66177):map__66177);
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66177__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66177__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__66181){
...
var f = map__66182__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66182__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66182__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var G__66191__delegate = function (args){
...
while (G__66192__i < G__66192__a.length) {G__66192__a[G__66192__i] = arguments[G__66192__i + 0]; ++G__66192__i;}
  args = new cljs.core.IndexedSeq(G__66192__a,0,null);
} 
return G__66191__delegate.call(this,args);};
G__66191.cljs$lang$maxFixedArity = 0;
G__66191.cljs$lang$applyTo = (function (arglist__66193){
var args = cljs.core.seq(arglist__66193);
return G__66191__delegate(args);
});
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__66179_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__66179_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__66194__delegate = function (args){
...
while (G__66195__i < G__66195__a.length) {G__66195__a[G__66195__i] = arguments[G__66195__i + 0]; ++G__66195__i;}
  args = new cljs.core.IndexedSeq(G__66195__a,0,null);
} 
return G__66194__delegate.call(this,args);};
G__66194.cljs$lang$maxFixedArity = 0;
G__66194.cljs$lang$applyTo = (function (arglist__66196){
var args = cljs.core.seq(arglist__66196);
return G__66194__delegate(args);
});
...
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__66180_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__66180_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
