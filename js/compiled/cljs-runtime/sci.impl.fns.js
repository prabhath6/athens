...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__65903,fn_name,macro_QMARK_,with_meta_QMARK_){
var map__65905 = p__65903;
...
var _m = map__65905__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65905__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65905__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65905__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65905__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__65935 = cljs.core.next(args__$1);
var G__65936 = cljs.core.next(params__$1);
var G__65937 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__65935;
params__$1 = G__65936;
ret = G__65937;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__65908 = ctx__$1;
var G__65909 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__65908,G__65909) : interpret.call(null,G__65908,G__65909));
...
var vec__65910 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65910,(0),null);
var vec__65913 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65910,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65913,(0),null);
var G__65942 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__65942;
continue;
} else {
var G__65943 = recur_val;
args = G__65943;
continue;
}
} else {
...
var G__65944__i = 0, G__65944__a = new Array(arguments.length -  0);
while (G__65944__i < G__65944__a.length) {G__65944__a[G__65944__i] = arguments[G__65944__i + 0]; ++G__65944__i;}
  args = new cljs.core.IndexedSeq(G__65944__a,0,null);
} 
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__65945){
var args = cljs.core.seq(arglist__65945);
...
var map__65917 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65917__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65917__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__65923){
...
var f = map__65924__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65924__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65924__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var G__65954__delegate = function (args){
...
while (G__65961__i < G__65961__a.length) {G__65961__a[G__65961__i] = arguments[G__65961__i + 0]; ++G__65961__i;}
  args = new cljs.core.IndexedSeq(G__65961__a,0,null);
} 
return G__65954__delegate.call(this,args);};
G__65954.cljs$lang$maxFixedArity = 0;
G__65954.cljs$lang$applyTo = (function (arglist__65962){
var args = cljs.core.seq(arglist__65962);
return G__65954__delegate(args);
});
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__65919_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__65919_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
...
var args = null;
if (arguments.length > 0) {
var G__65968__i = 0, G__65968__a = new Array(arguments.length -  0);
while (G__65968__i < G__65968__a.length) {G__65968__a[G__65968__i] = arguments[G__65968__i + 0]; ++G__65968__i;}
  args = new cljs.core.IndexedSeq(G__65968__a,0,null);
} 
return G__65963__delegate.call(this,args);};
G__65963.cljs$lang$maxFixedArity = 0;
G__65963.cljs$lang$applyTo = (function (arglist__65969){
var args = cljs.core.seq(arglist__65969);
...
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__65920_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__65920_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
