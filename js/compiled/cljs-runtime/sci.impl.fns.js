...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__65894,fn_name,macro_QMARK_,with_meta_QMARK_){
...
var _m = map__65895__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65895__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65895__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65895__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65895__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__65949 = cljs.core.next(args__$1);
var G__65950 = cljs.core.next(params__$1);
var G__65951 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__65949;
params__$1 = G__65950;
ret = G__65951;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__65899 = ctx__$1;
var G__65900 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__65899,G__65900) : interpret.call(null,G__65899,G__65900));
...
var vec__65901 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65901,(0),null);
var vec__65904 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65901,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65904,(0),null);
var G__65959 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__65959;
continue;
} else {
var G__65960 = recur_val;
args = G__65960;
continue;
}
} else {
...
while (G__65983__i < G__65983__a.length) {G__65983__a[G__65983__i] = arguments[G__65983__i + 0]; ++G__65983__i;}
  args = new cljs.core.IndexedSeq(G__65983__a,0,null);
} 
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__65984){
var args = cljs.core.seq(arglist__65984);
...
var map__65907 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65907__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65907__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__65918){
var map__65919 = p__65918;
...
var f = map__65919__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65919__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65919__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var G__65990__delegate = function (args){
...
while (G__65992__i < G__65992__a.length) {G__65992__a[G__65992__i] = arguments[G__65992__i + 0]; ++G__65992__i;}
  args = new cljs.core.IndexedSeq(G__65992__a,0,null);
} 
return G__65990__delegate.call(this,args);};
G__65990.cljs$lang$maxFixedArity = 0;
G__65990.cljs$lang$applyTo = (function (arglist__65996){
var args = cljs.core.seq(arglist__65996);
return G__65990__delegate(args);
});
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__65916_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__65916_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__65998__delegate = function (args){
...
var args = null;
if (arguments.length > 0) {
var G__66023__i = 0, G__66023__a = new Array(arguments.length -  0);
while (G__66023__i < G__66023__a.length) {G__66023__a[G__66023__i] = arguments[G__66023__i + 0]; ++G__66023__i;}
  args = new cljs.core.IndexedSeq(G__66023__a,0,null);
} 
return G__65998__delegate.call(this,args);};
G__65998.cljs$lang$maxFixedArity = 0;
G__65998.cljs$lang$applyTo = (function (arglist__66026){
var args = cljs.core.seq(arglist__66026);
return G__65998__delegate(args);
});
...
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__65917_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__65917_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
