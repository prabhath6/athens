...
var o41017 = temp__5733__auto__;
var temp__5733__auto____$1 = (o41017["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o41018 = temp__5733__auto____$1;
return (o41018["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__40276__auto__ = f;
return (o__40276__auto__["toString"]).call(o__40276__auto__);
} else {
return "";
}
}catch (e41021){var _ = e41021;
return "";
}});
...
try{var o__40276__auto___41338 = t;
(o__40276__auto___41338["cljs$lang$ctorPrWriter"]).call(o__40276__auto___41338,t,writer);
}catch (e41023){var __41339 = e41023;
}
...
var char_code = (function (){var o__40276__auto__ = (new String(char$));
return (o__40276__auto__["charCodeAt"]).call(o__40276__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__40276__auto__ = String;
return (o__40276__auto__["fromCharCode"]).call(o__40276__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__41024 = num_code;
switch (G__41024) {
case (1):
return (185);
...
var o__40276__auto__ = String;
return (o__40276__auto__["fromCharCode"]).call(o__40276__auto__,superscript_code);
});
/**
...
}catch (e41033){var _e__40299__auto__ = e41033;
return false;
}})())){
...
var vec__41034 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41034,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o41038 = temp__5733__auto__;
var temp__5733__auto____$1 = (o41038["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o41039 = temp__5733__auto____$1;
return (o41039["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4789__auto___41364 = arguments.length;
var i__4790__auto___41365 = (0);
while(true){
if((i__4790__auto___41365 < len__4789__auto___41364)){
args__4795__auto__.push((arguments[i__4790__auto___41365]));

var G__41366 = (i__4790__auto___41365 + (1));
i__4790__auto___41365 = G__41366;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__41047){
var vec__41048 = p__41047;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41048,(0),null);
...
var G__41367 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__41368 = cljs.core.butlast(remaining_tokens);
name_tokens = G__41367;
remaining_tokens = G__41368;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq41041){
...
var vec__41060 = cljs.core.split_with((function (p1__41059_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__41059_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41060,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41060,(1),null);
...
var vec__41066 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41066,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41066,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__41373 = cljs.core.rest(remaining_tokens);
var G__41374 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__41373;
name_tokens = G__41374;
continue;
} else {
...
var vec__41090 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41090,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41090,(1),null);
var vec__41093 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41093,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41093,(1),null);
var vec__41098 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41098,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41098,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41098,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41098,(3),null);
...
var vec__41109 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41109,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41109,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41109,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41109,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41109,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41109,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__41116 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41116,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41116,(1),null);
var vec__41119 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41119,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41119,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__41123 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__41123) : devtools.munging.parse_fn_info_deep.call(null,G__41123));
})()));
}
} else {
return fn_info;
...
var G__41395 = (arity + (1));
var G__41396 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__41134){
var vec__41135 = p__41134;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41135,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41135,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41144_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__41144_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41145_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__41145_SHARP_);
}),sorted_infos);
...
var args__4795__auto__ = [];
var len__4789__auto___41414 = arguments.length;
var i__4790__auto___41415 = (0);
while(true){
if((i__4790__auto___41415 < len__4789__auto___41414)){
args__4795__auto__.push((arguments[i__4790__auto___41415]));

var G__41417 = (i__4790__auto___41415 + (1));
i__4790__auto___41415 = G__41417;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__41157){
var vec__41158 = p__41157;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41158,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq41146){
var G__41147 = cljs.core.first(seq41146);
var seq41146__$1 = cljs.core.next(seq41146);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41147,seq41146__$1);
}));
...
var G__41173 = arg;
var G__41173__$1 = (((G__41173 instanceof cljs.core.Keyword))?G__41173.fqn:null);
switch (G__41173__$1) {
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41197__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41197__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41197__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41197__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__41198 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41198,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41198,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41198,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41198,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41198,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41198,(5),null);
...
var o__40276__auto__ = f;
return (o__40276__auto__["getBasis"]).call(o__40276__auto__);
});
/**
...
}catch (e41244){var _e__40299__auto__ = e41244;
...
var G__41430 = (obj[cljs.core.first(path)]);
var G__41431 = cljs.core.rest(path);
obj = G__41430;
path = G__41431;
continue;
} else {
...
var _STAR_ = (function (accum,p__41285){
var vec__41287 = p__41285;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41287,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41287,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__41300){
var vec__41301 = p__41300;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41301,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41301,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41301,(2),null);
...
var post_process = (function (p__41321){
var vec__41325 = p__41321;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41325,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41325,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41309_SHARP_){
return (obj[cljs.core.first(p1__41309_SHARP_)]);
}),sorted_matches);
