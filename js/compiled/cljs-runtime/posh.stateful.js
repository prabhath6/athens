...
var len__4789__auto___70982 = arguments.length;
var i__4790__auto___70983 = (0);
while(true){
if((i__4790__auto___70983 < len__4789__auto___70982)){
args__4795__auto__.push((arguments[i__4790__auto___70983]));

var G__70984 = (i__4790__auto___70983 + (1));
i__4790__auto___70983 = G__70984;
continue;
} else {
}
break;
...
/** @this {Function} */
(posh.stateful.add_q.cljs$lang$applyTo = (function (seq70971){
var G__70972 = cljs.core.first(seq70971);
var seq70971__$1 = cljs.core.next(seq70971);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__70972,seq70971__$1);
}));

posh.stateful.add_filter_tx = (function posh$stateful$add_filter_tx(poshdb,tx_patterns){
var posh_atom = posh.stateful.get_posh_atom(poshdb);
return cljs.core.with_meta(new cljs.core.Keyword(null,"return","return",-1891502105).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(posh_atom,(function (p1__70973_SHARP_){
return posh.core.add_filter_tx(p1__70973_SHARP_,poshdb,tx_patterns);
...
var posh_atom = posh.stateful.get_posh_atom(poshdb);
return cljs.core.with_meta(new cljs.core.Keyword(null,"return","return",-1891502105).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(posh_atom,(function (p1__70974_SHARP_){
return posh.core.add_filter_pull(p1__70974_SHARP_,poshdb,pull_pattern,eid);
}))),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"posh","posh",-1205664462),posh_atom], null));
});
posh.stateful.add_filter_q = (function posh$stateful$add_filter_q(var_args){
var args__4795__auto__ = [];
var len__4789__auto___70985 = arguments.length;
var i__4790__auto___70986 = (0);
while(true){
if((i__4790__auto___70986 < len__4789__auto___70985)){
args__4795__auto__.push((arguments[i__4790__auto___70986]));

var G__70987 = (i__4790__auto___70986 + (1));
i__4790__auto___70986 = G__70987;
continue;
} else {
}
break;
...
var posh_atom = cljs.core.first(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2(posh.stateful.get_posh_atom,args)));
return cljs.core.with_meta(new cljs.core.Keyword(null,"return","return",-1891502105).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(posh_atom,(function (p1__70975_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$4(posh.core.add_filter_q,p1__70975_SHARP_,query,args);
}))),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"posh","posh",-1205664462),posh_atom], null));
}));
...
/** @this {Function} */
(posh.stateful.add_filter_q.cljs$lang$applyTo = (function (seq70976){
var G__70977 = cljs.core.first(seq70976);
var seq70976__$1 = cljs.core.next(seq70976);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__70977,seq70976__$1);
}));
