...
var len__4789__auto___68578 = arguments.length;
var i__4790__auto___68579 = (0);
while(true){
if((i__4790__auto___68579 < len__4789__auto___68578)){
args__4795__auto__.push((arguments[i__4790__auto___68579]));

var G__68580 = (i__4790__auto___68579 + (1));
i__4790__auto___68579 = G__68580;
continue;
} else {
}
break;
...
/** @this {Function} */
(posh.stateful.add_q.cljs$lang$applyTo = (function (seq68551){
var G__68552 = cljs.core.first(seq68551);
var seq68551__$1 = cljs.core.next(seq68551);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__68552,seq68551__$1);
}));

posh.stateful.add_filter_tx = (function posh$stateful$add_filter_tx(poshdb,tx_patterns){
var posh_atom = posh.stateful.get_posh_atom(poshdb);
return cljs.core.with_meta(new cljs.core.Keyword(null,"return","return",-1891502105).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(posh_atom,(function (p1__68554_SHARP_){
return posh.core.add_filter_tx(p1__68554_SHARP_,poshdb,tx_patterns);
...
var posh_atom = posh.stateful.get_posh_atom(poshdb);
return cljs.core.with_meta(new cljs.core.Keyword(null,"return","return",-1891502105).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(posh_atom,(function (p1__68556_SHARP_){
return posh.core.add_filter_pull(p1__68556_SHARP_,poshdb,pull_pattern,eid);
}))),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"posh","posh",-1205664462),posh_atom], null));
});
...
var G__68587 = (i__4790__auto___68585 + (1));
i__4790__auto___68585 = G__68587;
continue;
} else {
}
break;
...
var posh_atom = cljs.core.first(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2(posh.stateful.get_posh_atom,args)));
return cljs.core.with_meta(new cljs.core.Keyword(null,"return","return",-1891502105).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(posh_atom,(function (p1__68557_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$4(posh.core.add_filter_q,p1__68557_SHARP_,query,args);
}))),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"posh","posh",-1205664462),posh_atom], null));
}));
...
/** @this {Function} */
(posh.stateful.add_filter_q.cljs$lang$applyTo = (function (seq68558){
var G__68559 = cljs.core.first(seq68558);
var seq68558__$1 = cljs.core.next(seq68558);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__68559,seq68558__$1);
}));
