...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k29944,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k29944,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__29950){
var vec__29951 = p__29950;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29951,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29951,(1),null);
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__29943){
var self__ = this;
var G__29943__$1 = this;
return (new cljs.core.RecordIter((0),G__29943__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var h__4297__auto____$1 = (function (){var fexpr__29955 = (function (coll__4436__auto__){
return (-1883175395 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__29955(this__4435__auto____$1);
})();
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this29945,other29946){
var self__ = this;
var this29945__$1 = this;
return (((!((other29946 == null)))) && ((this29945__$1.constructor === other29946.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29945__$1.children,other29946.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29945__$1.__extmap,other29946.__extmap)));
}));
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__29943){
var self__ = this;
...
return (new rewrite_clj.node.uneval.UnevalNode(G__29943,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.uneval.UnevalNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__29943),null));
}
}));
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__29943){
var self__ = this;
var this__4438__auto____$1 = this;
return (new rewrite_clj.node.uneval.UnevalNode(self__.children,G__29943,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.uneval.map__GT_UnevalNode = (function rewrite_clj$node$uneval$map__GT_UnevalNode(G__29947){
var extmap__4478__auto__ = (function (){var G__29961 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__29947,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__29947)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__29961);
} else {
return G__29961;
}
})();
return (new rewrite_clj.node.uneval.UnevalNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__29947),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
