...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(G__50767,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint], 0));
} else {
return G__50767;
}
}));
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq50772){
var G__50773 = cljs.core.first(seq50772);
var seq50772__$1 = cljs.core.next(seq50772);
var G__50774 = cljs.core.first(seq50772__$1);
var seq50772__$2 = cljs.core.next(seq50772__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50773,G__50774,seq50772__$2);
}));
...
var map__50784 = m;
var map__50784__$1 = (((((!((map__50784 == null))))?(((((map__50784.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__50784.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__50784):map__50784);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50784__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50784__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50784__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50782_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(p1__50782_SHARP_));
...
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__50798 = cljs.core.get_global_hierarchy;
return (fexpr__50798.cljs$core$IFn$_invoke$arity$0 ? fexpr__50798.cljs$core$IFn$_invoke$arity$0() : fexpr__50798.call(null));
})());
...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expected:",(function (){var G__50801 = new cljs.core.Keyword(null,"expected","expected",1583670997).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__50801) : formatter_fn.call(null,G__50801));
})()], 0));

return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["  actual:",(function (){var G__50809 = new cljs.core.Keyword(null,"actual","actual",107306363).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__50809) : formatter_fn.call(null,G__50809));
})()], 0));
});
...
var output_dir = "out";
var output_dir__$1 = (function (){var G__50830 = output_dir;
if((!(clojure.string.ends_with_QMARK_(output_dir,"/")))){
return [G__50830,"/"].join('');
} else {
return G__50830;
}
})();
...
var temp__5733__auto__ = ((typeof exception.stack === 'string')?(function (){var G__50843 = exception.stack;
var G__50843__$1 = (((G__50843 == null))?null:clojure.string.split_lines(G__50843));
var G__50843__$2 = (((G__50843__$1 == null))?null:cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__50843__$1,depth));
if((G__50843__$2 == null)){
return null;
} else {
return clojure.string.trim(G__50843__$2);
}
})():false);
if(cljs.core.truth_(temp__5733__auto__)){
var stack_element = temp__5733__auto__;
var fname = cljs.test.js_filename(stack_element);
var vec__50845 = cljs.test.js_line_and_column(stack_element);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50845,(0),null);
var column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50845,(1),null);
var vec__50848 = cljs.test.mapped_line_and_column(fname,line,column);
var fname__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50848,(0),null);
var line__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50848,(1),null);
var column__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50848,(2),null);
...
var m__$1 = (function (){var G__50851 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__50880 = (function (){var d = (new cljs.core.Delay(((function (fns,obj,f,xs__6292__auto__,temp__5735__auto__){
return (function (){
var G__50881 = cljs.core.rest(fns);
return (cljs.test.run_block.cljs$core$IFn$_invoke$arity$1 ? cljs.test.run_block.cljs$core$IFn$_invoke$arity$1(G__50881) : cljs.test.run_block.call(null,G__50881));
...
return (obj.cljs$core$IFn$_invoke$arity$1 ? obj.cljs$core$IFn$_invoke$arity$1(G__50880) : obj.call(null,G__50880));
} else {
var G__50953 = (function (){var G__50884 = cljs.core.rest(fns);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(obj,G__50884);
} else {
return G__50884;
}
})();
...
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4(G__50887,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__50899 = fixtures_types();
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50899,(0),null);
var types = vec__50899;
...
var G__50903 = type;
var G__50904 = new cljs.core.Keyword(null,"async","async",1050769601);
var fexpr__50902 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword(null,"async","async",1050769601),new cljs.core.Keyword(null,"fn","fn",-1175266204),new cljs.core.Keyword(null,"sync","sync",-624148946),new cljs.core.Keyword("cljs.analyzer","analyzed","cljs.analyzer/analyzed",-735094162),true], null);
return (fexpr__50902.cljs$core$IFn$_invoke$arity$2 ? fexpr__50902.cljs$core$IFn$_invoke$arity$2(G__50903,G__50904) : fexpr__50902.call(null,G__50903,G__50904));
});
...
var temp__5735__auto___50965 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(v));
if(cljs.core.truth_(temp__5735__auto___50965)){
var t_50966 = temp__5735__auto___50965;
var G__50921_50967 = ((function (seq__50915,chunk__50916,count__50917,i__50918,t_50966,temp__5735__auto___50965,v,each_fixture_fn,G__50912,G__50912__$1,env,once_fixtures,each_fixtures,vec__50909,ns,vars__$1){
return (function (){
return cljs.test.run_block(cljs.test.test_var_block_STAR_(v,cljs.test.disable_async(t_50966)));
});})(seq__50915,chunk__50916,count__50917,i__50918,t_50966,temp__5735__auto___50965,v,each_fixture_fn,G__50912,G__50912__$1,env,once_fixtures,each_fixtures,vec__50909,ns,vars__$1))
;
(each_fixture_fn.cljs$core$IFn$_invoke$arity$1 ? each_fixture_fn.cljs$core$IFn$_invoke$arity$1(G__50921_50967) : each_fixture_fn.call(null,G__50921_50967));
} else {
}


var G__50968 = seq__50915;
var G__50969 = chunk__50916;
var G__50970 = count__50917;
var G__50971 = (i__50918 + (1));
seq__50915 = G__50968;
...
var G__50972 = cljs.core.chunk_rest(seq__50915__$1);
var G__50973 = c__4609__auto__;
var G__50974 = cljs.core.count(c__4609__auto__);
var G__50975 = (0);
seq__50915 = G__50972;
chunk__50916 = G__50973;
count__50917 = G__50974;
i__50918 = G__50975;
continue;
} else {
var v = cljs.core.first(seq__50915__$1);
var temp__5735__auto___50976__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(v));
if(cljs.core.truth_(temp__5735__auto___50976__$1)){
var t_50977 = temp__5735__auto___50976__$1;
var G__50922_50978 = ((function (seq__50915,chunk__50916,count__50917,i__50918,t_50977,temp__5735__auto___50976__$1,v,seq__50915__$1,temp__5735__auto__,each_fixture_fn,G__50912,G__50912__$1,env,once_fixtures,each_fixtures,vec__50909,ns,vars__$1){
return (function (){
return cljs.test.run_block(cljs.test.test_var_block_STAR_(v,cljs.test.disable_async(t_50977)));
});})(seq__50915,chunk__50916,count__50917,i__50918,t_50977,temp__5735__auto___50976__$1,v,seq__50915__$1,temp__5735__auto__,each_fixture_fn,G__50912,G__50912__$1,env,once_fixtures,each_fixtures,vec__50909,ns,vars__$1))
;
...
var G__50981 = cljs.core.next(seq__50915__$1);
var G__50982 = null;
var G__50983 = (0);
var G__50984 = (0);
seq__50915 = G__50981;
chunk__50916 = G__50982;
count__50917 = G__50983;
i__50918 = G__50984;
continue;
}
} else {
