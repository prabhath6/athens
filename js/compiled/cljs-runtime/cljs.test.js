...
var G__50793 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(G__50793,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint], 0));
} else {
return G__50793;
}
}));
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq50820){
var G__50821 = cljs.core.first(seq50820);
var seq50820__$1 = cljs.core.next(seq50820);
var G__50822 = cljs.core.first(seq50820__$1);
var seq50820__$2 = cljs.core.next(seq50820__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50821,G__50822,seq50820__$2);
}));
...
var map__50829 = m;
var map__50829__$1 = (((((!((map__50829 == null))))?(((((map__50829.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__50829.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__50829):map__50829);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50829__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50829__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50829__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50827_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(p1__50827_SHARP_));
...
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__50839 = cljs.core.get_global_hierarchy;
return (fexpr__50839.cljs$core$IFn$_invoke$arity$0 ? fexpr__50839.cljs$core$IFn$_invoke$arity$0() : fexpr__50839.call(null));
})());
...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expected:",(function (){var G__50866 = new cljs.core.Keyword(null,"expected","expected",1583670997).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__50866) : formatter_fn.call(null,G__50866));
})()], 0));

return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["  actual:",(function (){var G__50868 = new cljs.core.Keyword(null,"actual","actual",107306363).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__50868) : formatter_fn.call(null,G__50868));
})()], 0));
});
...
var output_dir = "out";
var output_dir__$1 = (function (){var G__50877 = output_dir;
if((!(clojure.string.ends_with_QMARK_(output_dir,"/")))){
return [G__50877,"/"].join('');
} else {
return G__50877;
}
})();
...
var temp__5733__auto__ = ((typeof exception.stack === 'string')?(function (){var G__50883 = exception.stack;
var G__50883__$1 = (((G__50883 == null))?null:clojure.string.split_lines(G__50883));
var G__50883__$2 = (((G__50883__$1 == null))?null:cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__50883__$1,depth));
if((G__50883__$2 == null)){
return null;
} else {
return clojure.string.trim(G__50883__$2);
}
})():false);
if(cljs.core.truth_(temp__5733__auto__)){
var stack_element = temp__5733__auto__;
var fname = cljs.test.js_filename(stack_element);
var vec__50884 = cljs.test.js_line_and_column(stack_element);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50884,(0),null);
var column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50884,(1),null);
var vec__50887 = cljs.test.mapped_line_and_column(fname,line,column);
var fname__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50887,(0),null);
var line__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50887,(1),null);
var column__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50887,(2),null);
...
var m__$1 = (function (){var G__50890 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__50935 = (function (){var G__50894 = cljs.core.rest(fns);
...
var temp__5735__auto___50954 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(v));
if(cljs.core.truth_(temp__5735__auto___50954)){
var t_50955 = temp__5735__auto___50954;
var G__50921_50956 = ((function (seq__50915,chunk__50916,count__50917,i__50918,t_50955,temp__5735__auto___50954,v,each_fixture_fn,G__50912,G__50912__$1,env,once_fixtures,each_fixtures,vec__50909,ns,vars__$1){
return (function (){
return cljs.test.run_block(cljs.test.test_var_block_STAR_(v,cljs.test.disable_async(t_50955)));
});})(seq__50915,chunk__50916,count__50917,i__50918,t_50955,temp__5735__auto___50954,v,each_fixture_fn,G__50912,G__50912__$1,env,once_fixtures,each_fixtures,vec__50909,ns,vars__$1))
;
(each_fixture_fn.cljs$core$IFn$_invoke$arity$1 ? each_fixture_fn.cljs$core$IFn$_invoke$arity$1(G__50921_50956) : each_fixture_fn.call(null,G__50921_50956));
} else {
}


var G__50959 = seq__50915;
var G__50960 = chunk__50916;
var G__50961 = count__50917;
var G__50962 = (i__50918 + (1));
seq__50915 = G__50959;
chunk__50916 = G__50960;
count__50917 = G__50961;
i__50918 = G__50962;
continue;
} else {
...
var G__50963 = cljs.core.chunk_rest(seq__50915__$1);
var G__50964 = c__4609__auto__;
var G__50965 = cljs.core.count(c__4609__auto__);
var G__50966 = (0);
seq__50915 = G__50963;
chunk__50916 = G__50964;
count__50917 = G__50965;
i__50918 = G__50966;
continue;
} else {
var v = cljs.core.first(seq__50915__$1);
var temp__5735__auto___50967__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(v));
if(cljs.core.truth_(temp__5735__auto___50967__$1)){
var t_50968 = temp__5735__auto___50967__$1;
var G__50922_50969 = ((function (seq__50915,chunk__50916,count__50917,i__50918,t_50968,temp__5735__auto___50967__$1,v,seq__50915__$1,temp__5735__auto__,each_fixture_fn,G__50912,G__50912__$1,env,once_fixtures,each_fixtures,vec__50909,ns,vars__$1){
return (function (){
return cljs.test.run_block(cljs.test.test_var_block_STAR_(v,cljs.test.disable_async(t_50968)));
});})(seq__50915,chunk__50916,count__50917,i__50918,t_50968,temp__5735__auto___50967__$1,v,seq__50915__$1,temp__5735__auto__,each_fixture_fn,G__50912,G__50912__$1,env,once_fixtures,each_fixtures,vec__50909,ns,vars__$1))
;
(each_fixture_fn.cljs$core$IFn$_invoke$arity$1 ? each_fixture_fn.cljs$core$IFn$_invoke$arity$1(G__50922_50969) : each_fixture_fn.call(null,G__50922_50969));
} else {
}


var G__50970 = cljs.core.next(seq__50915__$1);
var G__50971 = null;
var G__50972 = (0);
var G__50973 = (0);
seq__50915 = G__50970;
chunk__50916 = G__50971;
count__50917 = G__50972;
i__50918 = G__50973;
continue;
}
} else {
