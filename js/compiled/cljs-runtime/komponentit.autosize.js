...
komponentit.autosize.apply_box_sizing = (function komponentit$autosize$apply_box_sizing(value,p__65630){
var map__65631 = p__65630;
var map__65631__$1 = (((((!((map__65631 == null))))?(((((map__65631.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__65631.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__65631):map__65631);
var box_sizing = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65631__$1,new cljs.core.Keyword(null,"box-sizing","box-sizing",-1956090239));
var border_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65631__$1,new cljs.core.Keyword(null,"border-size","border-size",991975640));
var padding_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65631__$1,new cljs.core.Keyword(null,"padding-size","padding-size",-733651675));
var G__65633 = box_sizing;
switch (G__65633) {
case "border-box":
...
var G__65634 = document.createElement("div");
document.body.appendChild(G__65634);

return G__65634;
}),null));
}
komponentit.autosize.node_width = (function komponentit$autosize$node_width(value,placeholder,placeholder_is_min_width_QMARK_,p__65635){
...
var styles = map__65636__$1;
var sizer_style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65636__$1,new cljs.core.Keyword(null,"sizer-style","sizer-style",-1176226328));
 ...
 */
komponentit.autosize.input = (function komponentit$autosize$input(p__65638){
var map__65639 = p__65638;
...
var placeholder = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65639__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
var placeholder_is_min_width_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65639__$1,new cljs.core.Keyword(null,"placeholder-is-min-width?","placeholder-is-min-width?",-1743052093));
...
}),new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),(function (this$,p__65641){
var vec__65642 = p__65641;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65642,(0),null);
var prev_props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65642,(1),null);
...
}),new cljs.core.Keyword(null,"reagent-render","reagent-render",-985383853),(function (p__65645){
var map__65646 = p__65645;
var map__65646__$1 = (((((!((map__65646 == null))))?(((((map__65646.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__65646.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__65646):map__65646);
...
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65646__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65646__$1,new cljs.core.Keyword(null,"value","value",305978217));
var placeholder__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65646__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
...
var G__65648 = document.createElement("div");
document.body.appendChild(G__65648);

return G__65648;
}),null));
}
komponentit.autosize.node_height = (function komponentit$autosize$node_height(value,min_rows,max_rows,p__65649){
...
var styles = map__65650__$1;
var box_sizing = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65650__$1,new cljs.core.Keyword(null,"box-sizing","box-sizing",-1956090239));
var border_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65650__$1,new cljs.core.Keyword(null,"border-size","border-size",991975640));
var padding_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65650__$1,new cljs.core.Keyword(null,"padding-size","padding-size",-733651675));
var sizer_style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65650__$1,new cljs.core.Keyword(null,"sizer-style","sizer-style",-1176226328));
 ...
 *   component, for easier styling.
 */
komponentit.autosize.textarea = (function komponentit$autosize$textarea(p__65652){
var map__65653 = p__65652;
var map__65653__$1 = (((((!((map__65653 == null))))?(((((map__65653.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__65653.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__65653):map__65653);
var min_rows = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65653__$1,new cljs.core.Keyword(null,"min-rows","min-rows",1428640765));
var max_rows = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65653__$1,new cljs.core.Keyword(null,"max-rows","max-rows",-2131113613));
var state = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(null);
...
}),new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),(function (this$,p__65655){
var vec__65656 = p__65655;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65656,(0),null);
var prev_props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65656,(1),null);
if(((cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(reagent.core.props(this$)),new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(prev_props))) || (cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(reagent.core.props(this$)),new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(prev_props))))){
return cljs.core.reset_BANG_(state,komponentit.autosize.textarea_node_styles(reagent.dom.dom_node(this$)));
} else {
return null;
}
}),new cljs.core.Keyword(null,"reagent-render","reagent-render",-985383853),(function (p__65659){
var map__65660 = p__65659;
...
var props = map__65660__$1;
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65660__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65660__$1,new cljs.core.Keyword(null,"value","value",305978217));
var min_rows__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65660__$1,new cljs.core.Keyword(null,"min-rows","min-rows",1428640765));
var max_rows__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65660__$1,new cljs.core.Keyword(null,"max-rows","max-rows",-2131113613));
