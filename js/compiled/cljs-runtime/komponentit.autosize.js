...
komponentit.autosize.apply_box_sizing = (function komponentit$autosize$apply_box_sizing(value,p__53262){
var map__53263 = p__53262;
...
var box_sizing = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53263__$1,new cljs.core.Keyword(null,"box-sizing","box-sizing",-1956090239));
var border_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53263__$1,new cljs.core.Keyword(null,"border-size","border-size",991975640));
var padding_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53263__$1,new cljs.core.Keyword(null,"padding-size","padding-size",-733651675));
var G__53265 = box_sizing;
switch (G__53265) {
case "border-box":
...
var G__53281 = document.createElement("div");
document.body.appendChild(G__53281);

return G__53281;
}),null));
}
komponentit.autosize.node_width = (function komponentit$autosize$node_width(value,placeholder,placeholder_is_min_width_QMARK_,p__53285){
...
var styles = map__53286__$1;
var sizer_style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53286__$1,new cljs.core.Keyword(null,"sizer-style","sizer-style",-1176226328));
 ...
 */
komponentit.autosize.input = (function komponentit$autosize$input(p__53290){
...
var placeholder = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53291__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
var placeholder_is_min_width_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53291__$1,new cljs.core.Keyword(null,"placeholder-is-min-width?","placeholder-is-min-width?",-1743052093));
...
}),new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),(function (this$,p__53293){
var vec__53294 = p__53293;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53294,(0),null);
var prev_props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53294,(1),null);
...
}),new cljs.core.Keyword(null,"reagent-render","reagent-render",-985383853),(function (p__53297){
...
var props = map__53298__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53298__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53298__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53298__$1,new cljs.core.Keyword(null,"value","value",305978217));
var placeholder__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53298__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
...
var G__53306 = document.createElement("div");
document.body.appendChild(G__53306);

return G__53306;
}),null));
}
komponentit.autosize.node_height = (function komponentit$autosize$node_height(value,min_rows,max_rows,p__53313){
var map__53314 = p__53313;
var map__53314__$1 = (((((!((map__53314 == null))))?(((((map__53314.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__53314.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__53314):map__53314);
var styles = map__53314__$1;
var box_sizing = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53314__$1,new cljs.core.Keyword(null,"box-sizing","box-sizing",-1956090239));
var border_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53314__$1,new cljs.core.Keyword(null,"border-size","border-size",991975640));
var padding_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53314__$1,new cljs.core.Keyword(null,"padding-size","padding-size",-733651675));
var sizer_style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53314__$1,new cljs.core.Keyword(null,"sizer-style","sizer-style",-1176226328));
 ...
 *   component, for easier styling.
 */
komponentit.autosize.textarea = (function komponentit$autosize$textarea(p__53334){
var map__53337 = p__53334;
...
var min_rows = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53337__$1,new cljs.core.Keyword(null,"min-rows","min-rows",1428640765));
var max_rows = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53337__$1,new cljs.core.Keyword(null,"max-rows","max-rows",-2131113613));
var state = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(null);
...
}),new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),(function (this$,p__53343){
var vec__53346 = p__53343;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53346,(0),null);
var prev_props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53346,(1),null);
if(((cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(reagent.core.props(this$)),new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(prev_props))) || (cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(reagent.core.props(this$)),new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(prev_props))))){
return cljs.core.reset_BANG_(state,komponentit.autosize.textarea_node_styles(reagent.dom.dom_node(this$)));
} else {
return null;
}
}),new cljs.core.Keyword(null,"reagent-render","reagent-render",-985383853),(function (p__53353){
var map__53354 = p__53353;
var map__53354__$1 = (((((!((map__53354 == null))))?(((((map__53354.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__53354.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__53354):map__53354);
var props = map__53354__$1;
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53354__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53354__$1,new cljs.core.Keyword(null,"value","value",305978217));
var min_rows__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53354__$1,new cljs.core.Keyword(null,"min-rows","min-rows",1428640765));
var max_rows__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53354__$1,new cljs.core.Keyword(null,"max-rows","max-rows",-2131113613));
