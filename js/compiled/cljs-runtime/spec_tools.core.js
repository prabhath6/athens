...
var G__55862 = cljs.spec.alpha.get_spec(x);
x = G__55862;
continue;
} else {
...
var G__55867 = cljs.spec.alpha.get_spec(new cljs.core.Keyword(null,"spec","spec",347520401).cljs$core$IFn$_invoke$arity$1(x));
x = G__55867;
continue;
} else {
...
if((x instanceof cljs.core.Keyword)){
var G__55903 = cljs.spec.alpha.get_spec(x);
x = G__55903;
continue;
} else {
