...
var G__55974 = cljs.spec.alpha.get_spec(x);
x = G__55974;
continue;
} else {
...
var G__55975 = cljs.spec.alpha.get_spec(new cljs.core.Keyword(null,"spec","spec",347520401).cljs$core$IFn$_invoke$arity$1(x));
x = G__55975;
continue;
} else {
...
if((x instanceof cljs.core.Keyword)){
var G__56019 = cljs.spec.alpha.get_spec(x);
x = G__56019;
continue;
} else {
