...
var G__55858 = cljs.spec.alpha.get_spec(x);
x = G__55858;
continue;
} else {
...
var G__55863 = cljs.spec.alpha.get_spec(new cljs.core.Keyword(null,"spec","spec",347520401).cljs$core$IFn$_invoke$arity$1(x));
x = G__55863;
continue;
} else {
...
if((x instanceof cljs.core.Keyword)){
var G__55908 = cljs.spec.alpha.get_spec(x);
x = G__55908;
continue;
} else {
