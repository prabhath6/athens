...
var G__55965 = cljs.spec.alpha.get_spec(x);
x = G__55965;
continue;
} else {
...
var G__55972 = cljs.spec.alpha.get_spec(new cljs.core.Keyword(null,"spec","spec",347520401).cljs$core$IFn$_invoke$arity$1(x));
x = G__55972;
continue;
} else {
...
if((x instanceof cljs.core.Keyword)){
var G__56014 = cljs.spec.alpha.get_spec(x);
x = G__56014;
continue;
} else {
