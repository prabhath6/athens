...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__23818_SHARP_){
return (!((cljs.core.meta(p1__23818_SHARP_) == null)));
})))){
...
}catch (e23829){var _e__20784__auto__ = e23829;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
}catch (e23831){var _e__20784__auto__ = e23831;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__23836 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__23837 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__23837);

try{var map__23841 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23841__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__23836);
}});
...
var temp__5733__auto___23885 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___23885)){
var managed_print_level_23886 = temp__5733__auto___23885;
var _STAR_print_level_STAR__orig_val__23847_23891 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__23848_23892 = managed_print_level_23886;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__23848_23892);
...
job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__23847_23891);
}} else {
job_fn();
}
