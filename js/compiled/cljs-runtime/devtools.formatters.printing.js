...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq23806){
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__23820_SHARP_){
return (!((cljs.core.meta(p1__23820_SHARP_) == null)));
})))){
...
var map__23825 = opts;
var map__23825__$1 = (((((!((map__23825 == null))))?(((((map__23825.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__23825.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__23825):map__23825);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23825__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e23829){var _e__20736__auto__ = e23829;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
}catch (e23833){var _e__20736__auto__ = e23833;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__23839 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__23840 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__23840);

try{var map__23842 = opts;
var map__23842__$1 = (((((!((map__23842 == null))))?(((((map__23842.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__23842.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__23842):map__23842);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23842__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__23839);
}});
...
var temp__5733__auto___23889 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___23889)){
var managed_print_level_23892 = temp__5733__auto___23889;
var _STAR_print_level_STAR__orig_val__23847_23893 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__23848_23894 = managed_print_level_23892;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__23848_23894);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__23844_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__23844_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__23847_23893);
}} else {
job_fn();
}
