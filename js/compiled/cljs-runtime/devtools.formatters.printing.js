...
var len__4789__auto___23846 = arguments.length;
var i__4790__auto___23847 = (0);
while(true){
if((i__4790__auto___23847 < len__4789__auto___23846)){
args__4795__auto__.push((arguments[i__4790__auto___23847]));

var G__23849 = (i__4790__auto___23847 + (1));
i__4790__auto___23847 = G__23849;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq23796){
var G__23797 = cljs.core.first(seq23796);
var seq23796__$1 = cljs.core.next(seq23796);
var G__23798 = cljs.core.first(seq23796__$1);
var seq23796__$2 = cljs.core.next(seq23796__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23797,G__23798,seq23796__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__23809_SHARP_){
return (!((cljs.core.meta(p1__23809_SHARP_) == null)));
})))){
...
}catch (e23823){var _e__20773__auto__ = e23823;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
}catch (e23827){var _e__20773__auto__ = e23827;
return false;
}}
})())){
...
try{var map__23832 = opts;
var map__23832__$1 = (((((!((map__23832 == null))))?(((((map__23832.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__23832.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__23832):map__23832);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23832__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
var temp__5733__auto___23872 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___23872)){
var managed_print_level_23878 = temp__5733__auto___23872;
var _STAR_print_level_STAR__orig_val__23838_23880 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__23839_23881 = managed_print_level_23878;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__23839_23881);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__23835_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__23835_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__23838_23880);
}} else {
job_fn();
}
