...
}catch (e23848){var _e__20566__auto__ = e23848;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
}catch (e23850){var _e__20566__auto__ = e23850;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__23853 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__23854 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__23854);

try{var map__23855 = opts;
var map__23855__$1 = (((((!((map__23855 == null))))?(((((map__23855.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__23855.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__23855):map__23855);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23855__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__23853);
}});
...
var temp__5733__auto___23934 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___23934)){
var managed_print_level_23935 = temp__5733__auto___23934;
var _STAR_print_level_STAR__orig_val__23863_23936 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__23864_23937 = managed_print_level_23935;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__23864_23937);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__23859_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__23859_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__23863_23936);
}} else {
job_fn();
}
