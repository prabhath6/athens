...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq23795){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23796,G__23797,seq23795__$2);
}));
...
}catch (e23821){var _e__20869__auto__ = e23821;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
var _STAR_current_state_STAR__orig_val__23827 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__23828 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__23828);

try{var map__23829 = opts;
var map__23829__$1 = (((((!((map__23829 == null))))?(((((map__23829.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__23829.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__23829):map__23829);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23829__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__23827);
}});
...
var temp__5733__auto___23853 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___23853)){
var managed_print_level_23854 = temp__5733__auto___23853;
var _STAR_print_level_STAR__orig_val__23834_23855 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__23835_23856 = managed_print_level_23854;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__23835_23856);
...
job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__23834_23855);
}} else {
job_fn();
}
