...
if((i < len)){
var k = (ks[i]);
var G__46381 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__46382 = (i + (1));
m = G__46381;
i = G__46382;
continue;
...
var temp__5737__auto__ = p.argv;
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__46269 = p.children;
return module$node_modules$react$index.Children.toArray(G__46269);
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__46272 = c;
var G__46272__$1 = (((G__46272 == null))?null:G__46272.prototype);
if((G__46272__$1 == null)){
return null;
} else {
return G__46272__$1.reagentRender;
}
})() == null)))));
});
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__46274 = c;
var G__46274__$1 = (((G__46274 == null))?null:G__46274.prototype);
if((G__46274__$1 == null)){
return null;
} else {
return G__46274__$1.render;
}
})() == null)))));
});
...
var G__46286 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__46286) : day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.component.as_element.call(null,G__46286));
};
...
var _STAR_current_component_STAR__orig_val__46287 = day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__46288 = c;
(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__46288);
...
}finally {(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__46287);
}});
...
var G__46289 = key;
var G__46289__$1 = (((G__46289 instanceof cljs.core.Keyword))?G__46289.fqn:null);
switch (G__46289__$1) {
...
var c = this;
var G__46325_46412 = goog.object.get(c,"cljsRatom");
if((G__46325_46412 == null)){
} else {
day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.dispose_BANG_(G__46325_46412);
}
...
var renders_46415 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_46416 = cljs.core.first(cljs.core.vals(renders_46415));
...
if((cljs.core.count(renders_46415) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_46415))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_46416)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_46416], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__46334 = o;
var G__46335_46423 = G__46334;
var G__46336_46424 = cljs.core.name(k);
var G__46337_46425 = v;
goog.object.set(G__46335_46423,G__46336_46424,G__46337_46425);
...
var G__46338_46431 = cmp.prototype;
var G__46339_46432 = module$node_modules$react$index.Component.prototype;
var G__46340_46433 = methods$;
goog.object.extend(G__46338_46431,G__46339_46432,G__46340_46433);
...
var name = (function (){var G__46341 = fiber;
var G__46341__$1 = (((G__46341 == null))?null:G__46341.type);
if((G__46341__$1 == null)){
return null;
} else {
return G__46341__$1.displayName;
}
})();
var parent = (function (){var G__46343 = fiber;
if((G__46343 == null)){
return null;
} else {
return G__46343.return;
}
})();
var path = (function (){var G__46345 = parent;
var G__46345__$1 = (((G__46345 == null))?null:(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__46345) : day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.component.fiber_component_path.call(null,G__46345)));
if((G__46345__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__46345__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4185__auto__ = (function (){var G__46347 = c;
if((G__46347 == null)){
return null;
} else {
return goog.object.get(G__46347,"_reactInternalFiber");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__46349._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4185__auto__ = (function (){var G__46352 = c;
if((G__46352 == null)){
return null;
} else {
return goog.object.get(G__46352,"_reactInternalInstance");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var or__4185__auto____$1 = (function (){var G__46354 = c;
if((G__46354 == null)){
return null;
} else {
return G__46354._reactInternalInstance;
}
})();
if(cljs.core.truth_(or__4185__auto____$1)){
return or__4185__auto____$1;
...
var elem = (function (){var or__4185__auto__ = (function (){var G__46360 = instance;
if((G__46360 == null)){
return null;
} else {
return goog.object.get(G__46360,"_currentElement");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var G__46361 = instance;
if((G__46361 == null)){
return null;
} else {
return G__46361._currentElement;
}
}
})();
var name = (function (){var G__46362 = elem;
var G__46362__$1 = (((G__46362 == null))?null:G__46362.type);
if((G__46362__$1 == null)){
return null;
} else {
return G__46362__$1.displayName;
}
})();
var owner = (function (){var or__4185__auto__ = (function (){var G__46364 = elem;
if((G__46364 == null)){
return null;
} else {
return goog.object.get(G__46364,"_owner");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__46365._owner;
}
}
})();
var path = (function (){var G__46366 = owner;
var G__46366__$1 = (((G__46366 == null))?null:(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__46366) : day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.component.component_path.call(null,G__46366)));
if((G__46366__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__46366__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__46367 = c;
var G__46367__$1 = (((G__46367 == null))?null:G__46367.constructor);
if((G__46367__$1 == null)){
return null;
} else {
return day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.util.fun_name(G__46367__$1);
}
}
})();
