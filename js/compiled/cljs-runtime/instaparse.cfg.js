...
var G__86598 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__86598)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__86598)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__86598)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__86598)].join('')));
...
var G__86683 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__86684 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__86683;
v = G__86684;
continue;
} else {
var G__86685 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__86686 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__86685;
v = G__86686;
continue;
}
...
break;
case "\"":
var G__86687 = cljs.core.next(sq);
var G__86688 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__86687;
v = G__86688;
continue;
...
break;
default:
var G__86693 = cljs.core.next(sq);
var G__86694 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__86693;
v = G__86694;
continue;
...
while(true){
var G__86608 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__86608__$1 = (((G__86608 instanceof cljs.core.Keyword))?G__86608.fqn:null);
switch (G__86608__$1) {
case "rule":
var vec__86609 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86609,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86609,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__86612 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__86612) : instaparse.cfg.content.call(null,G__86612));
...
break;
case "paren":
var G__86708 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__86708;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__86613 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__86613) : instaparse.cfg.build_rule.call(null,G__86613));
})());
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__86614 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__86614) : instaparse.cfg.build_rule.call(null,G__86614));
})());

break;
case "star":
return instaparse.combinators_source.star((function (){var G__86615 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__86615) : instaparse.cfg.build_rule.call(null,G__86615));
})());

break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__86616 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__86616) : instaparse.cfg.build_rule.call(null,G__86616));
})());

break;
case "look":
return instaparse.combinators_source.look((function (){var G__86617 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__86617) : instaparse.cfg.build_rule.call(null,G__86617));
})());

break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__86618 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__86618) : instaparse.cfg.build_rule.call(null,G__86618));
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__86608__$1)].join('')));
...
while(true){
var G__86620 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
var G__86620__$1 = (((G__86620 instanceof cljs.core.Keyword))?G__86620.fqn:null);
switch (G__86620__$1) {
case "nt":
...
case "neg":
case "rep":
var G__86710 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__86710;
continue;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__86620__$1)].join('')));
...
var valid_nts_86711 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__86625_86712 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__86626_86713 = null;
var count__86627_86714 = (0);
var i__86628_86715 = (0);
while(true){
if((i__86628_86715 < count__86627_86714)){
var nt_86716 = chunk__86626_86713.cljs$core$IIndexed$_nth$arity$2(null,i__86628_86715);
if(cljs.core.truth_((valid_nts_86711.cljs$core$IFn$_invoke$arity$1 ? valid_nts_86711.cljs$core$IFn$_invoke$arity$1(nt_86716) : valid_nts_86711.call(null,nt_86716)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_86716),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__86717 = seq__86625_86712;
var G__86718 = chunk__86626_86713;
var G__86719 = count__86627_86714;
var G__86720 = (i__86628_86715 + (1));
seq__86625_86712 = G__86717;
chunk__86626_86713 = G__86718;
count__86627_86714 = G__86719;
i__86628_86715 = G__86720;
continue;
} else {
var temp__5735__auto___86721 = cljs.core.seq(seq__86625_86712);
if(temp__5735__auto___86721){
var seq__86625_86722__$1 = temp__5735__auto___86721;
if(cljs.core.chunked_seq_QMARK_(seq__86625_86722__$1)){
var c__4609__auto___86723 = cljs.core.chunk_first(seq__86625_86722__$1);
var G__86724 = cljs.core.chunk_rest(seq__86625_86722__$1);
var G__86725 = c__4609__auto___86723;
var G__86726 = cljs.core.count(c__4609__auto___86723);
var G__86727 = (0);
seq__86625_86712 = G__86724;
chunk__86626_86713 = G__86725;
count__86627_86714 = G__86726;
i__86628_86715 = G__86727;
continue;
} else {
var nt_86728 = cljs.core.first(seq__86625_86722__$1);
if(cljs.core.truth_((valid_nts_86711.cljs$core$IFn$_invoke$arity$1 ? valid_nts_86711.cljs$core$IFn$_invoke$arity$1(nt_86728) : valid_nts_86711.call(null,nt_86728)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_86728),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__86729 = cljs.core.next(seq__86625_86722__$1);
var G__86730 = null;
var G__86731 = (0);
var G__86732 = (0);
seq__86625_86712 = G__86729;
chunk__86626_86713 = G__86730;
count__86627_86714 = G__86731;
i__86628_86715 = G__86732;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__86632_86733 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__86633_86734 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__86634_86735 = true;
var _STAR_print_fn_STAR__temp_val__86635_86736 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__86634_86735);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__86635_86736);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__86633_86734);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__86632_86733);
}
...
var len__4789__auto___86738 = arguments.length;
var i__4790__auto___86739 = (0);
while(true){
if((i__4790__auto___86739 < len__4789__auto___86738)){
args__4795__auto__.push((arguments[i__4790__auto___86739]));

var G__86740 = (i__4790__auto___86739 + (1));
i__4790__auto___86739 = G__86740;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__86642){
var map__86643 = p__86642;
var map__86643__$1 = (((((!((map__86643 == null))))?(((((map__86643.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__86643.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__86643):map__86643);
var opts = map__86643__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__86646 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__86647 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__86647);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__86648_86741 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__86649_86742 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__86650_86743 = true;
var _STAR_print_fn_STAR__temp_val__86651_86744 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__86650_86743);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__86651_86744);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__86649_86742);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__86648_86741);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__86646);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq86639){
var G__86640 = cljs.core.first(seq86639);
var seq86639__$1 = cljs.core.next(seq86639);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__86640,seq86639__$1);
}));
