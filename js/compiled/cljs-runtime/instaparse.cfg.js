...
var G__64506 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__64506)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__64506)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__64506)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__64506)].join('')));
...
var G__64554 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__64555 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__64554;
v = G__64555;
continue;
} else {
var G__64556 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__64557 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__64556;
v = G__64557;
continue;
}
...
break;
case "\"":
var G__64558 = cljs.core.next(sq);
var G__64559 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__64558;
v = G__64559;
continue;
...
break;
default:
var G__64560 = cljs.core.next(sq);
var G__64561 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__64560;
v = G__64561;
continue;
...
while(true){
var G__64519 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__64519__$1 = (((G__64519 instanceof cljs.core.Keyword))?G__64519.fqn:null);
switch (G__64519__$1) {
case "rule":
var vec__64520 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64520,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64520,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__64523 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__64523) : instaparse.cfg.content.call(null,G__64523));
...
break;
case "paren":
var G__64564 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__64564;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__64524 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64524) : instaparse.cfg.build_rule.call(null,G__64524));
})());
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__64526 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64526) : instaparse.cfg.build_rule.call(null,G__64526));
})());

break;
case "star":
return instaparse.combinators_source.star((function (){var G__64527 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64527) : instaparse.cfg.build_rule.call(null,G__64527));
})());

break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__64528 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64528) : instaparse.cfg.build_rule.call(null,G__64528));
})());

break;
case "look":
return instaparse.combinators_source.look((function (){var G__64529 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64529) : instaparse.cfg.build_rule.call(null,G__64529));
})());

break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__64530 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64530) : instaparse.cfg.build_rule.call(null,G__64530));
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__64519__$1)].join('')));
...
while(true){
var G__64531 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
var G__64531__$1 = (((G__64531 instanceof cljs.core.Keyword))?G__64531.fqn:null);
switch (G__64531__$1) {
case "nt":
...
case "neg":
case "rep":
var G__64566 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__64566;
continue;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__64531__$1)].join('')));
...
var valid_nts_64567 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__64532_64568 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__64533_64569 = null;
var count__64534_64570 = (0);
var i__64535_64571 = (0);
while(true){
if((i__64535_64571 < count__64534_64570)){
var nt_64572 = chunk__64533_64569.cljs$core$IIndexed$_nth$arity$2(null,i__64535_64571);
if(cljs.core.truth_((valid_nts_64567.cljs$core$IFn$_invoke$arity$1 ? valid_nts_64567.cljs$core$IFn$_invoke$arity$1(nt_64572) : valid_nts_64567.call(null,nt_64572)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_64572),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__64573 = seq__64532_64568;
var G__64574 = chunk__64533_64569;
var G__64575 = count__64534_64570;
var G__64576 = (i__64535_64571 + (1));
seq__64532_64568 = G__64573;
chunk__64533_64569 = G__64574;
count__64534_64570 = G__64575;
i__64535_64571 = G__64576;
continue;
} else {
var temp__5735__auto___64577 = cljs.core.seq(seq__64532_64568);
if(temp__5735__auto___64577){
var seq__64532_64578__$1 = temp__5735__auto___64577;
if(cljs.core.chunked_seq_QMARK_(seq__64532_64578__$1)){
var c__4609__auto___64579 = cljs.core.chunk_first(seq__64532_64578__$1);
var G__64580 = cljs.core.chunk_rest(seq__64532_64578__$1);
var G__64581 = c__4609__auto___64579;
var G__64582 = cljs.core.count(c__4609__auto___64579);
var G__64583 = (0);
seq__64532_64568 = G__64580;
chunk__64533_64569 = G__64581;
count__64534_64570 = G__64582;
i__64535_64571 = G__64583;
continue;
} else {
var nt_64584 = cljs.core.first(seq__64532_64578__$1);
if(cljs.core.truth_((valid_nts_64567.cljs$core$IFn$_invoke$arity$1 ? valid_nts_64567.cljs$core$IFn$_invoke$arity$1(nt_64584) : valid_nts_64567.call(null,nt_64584)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_64584),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__64585 = cljs.core.next(seq__64532_64578__$1);
var G__64586 = null;
var G__64587 = (0);
var G__64588 = (0);
seq__64532_64568 = G__64585;
chunk__64533_64569 = G__64586;
count__64534_64570 = G__64587;
i__64535_64571 = G__64588;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__64536_64598 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__64537_64599 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__64538_64600 = true;
var _STAR_print_fn_STAR__temp_val__64539_64601 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__64538_64600);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__64539_64601);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__64537_64599);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__64536_64598);
}
...
var len__4789__auto___64622 = arguments.length;
var i__4790__auto___64627 = (0);
while(true){
if((i__4790__auto___64627 < len__4789__auto___64622)){
args__4795__auto__.push((arguments[i__4790__auto___64627]));

var G__64628 = (i__4790__auto___64627 + (1));
i__4790__auto___64627 = G__64628;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__64542){
var map__64543 = p__64542;
var map__64543__$1 = (((((!((map__64543 == null))))?(((((map__64543.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__64543.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__64543):map__64543);
var opts = map__64543__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__64545 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__64546 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__64546);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__64547_64650 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__64548_64651 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__64549_64652 = true;
var _STAR_print_fn_STAR__temp_val__64550_64653 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__64549_64652);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__64550_64653);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__64548_64651);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__64547_64650);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__64545);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq64540){
var G__64541 = cljs.core.first(seq64540);
var seq64540__$1 = cljs.core.next(seq64540);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__64541,seq64540__$1);
}));
