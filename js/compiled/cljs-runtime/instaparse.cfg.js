...
var G__64579 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__64579)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__64579)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__64579)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__64579)].join('')));
...
var G__64627 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__64628 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__64627;
v = G__64628;
continue;
} else {
var G__64629 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__64630 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__64629;
v = G__64630;
continue;
}
...
break;
case "\"":
var G__64631 = cljs.core.next(sq);
var G__64632 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__64631;
v = G__64632;
continue;
...
break;
default:
var G__64633 = cljs.core.next(sq);
var G__64634 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__64633;
v = G__64634;
continue;
...
while(true){
var G__64592 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__64592__$1 = (((G__64592 instanceof cljs.core.Keyword))?G__64592.fqn:null);
switch (G__64592__$1) {
case "rule":
var vec__64594 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64594,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64594,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__64597 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__64597) : instaparse.cfg.content.call(null,G__64597));
...
break;
case "paren":
var G__64637 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__64637;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__64598 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64598) : instaparse.cfg.build_rule.call(null,G__64598));
})());
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__64599 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64599) : instaparse.cfg.build_rule.call(null,G__64599));
})());

break;
case "star":
return instaparse.combinators_source.star((function (){var G__64600 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64600) : instaparse.cfg.build_rule.call(null,G__64600));
})());

break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__64601 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64601) : instaparse.cfg.build_rule.call(null,G__64601));
})());

break;
case "look":
return instaparse.combinators_source.look((function (){var G__64602 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64602) : instaparse.cfg.build_rule.call(null,G__64602));
})());

break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__64603 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64603) : instaparse.cfg.build_rule.call(null,G__64603));
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__64592__$1)].join('')));
...
while(true){
var G__64604 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
var G__64604__$1 = (((G__64604 instanceof cljs.core.Keyword))?G__64604.fqn:null);
switch (G__64604__$1) {
case "nt":
...
case "neg":
case "rep":
var G__64639 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__64639;
continue;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__64604__$1)].join('')));
...
var valid_nts_64640 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__64605_64641 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__64606_64642 = null;
var count__64607_64643 = (0);
var i__64608_64644 = (0);
while(true){
if((i__64608_64644 < count__64607_64643)){
var nt_64645 = chunk__64606_64642.cljs$core$IIndexed$_nth$arity$2(null,i__64608_64644);
if(cljs.core.truth_((valid_nts_64640.cljs$core$IFn$_invoke$arity$1 ? valid_nts_64640.cljs$core$IFn$_invoke$arity$1(nt_64645) : valid_nts_64640.call(null,nt_64645)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_64645),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__64646 = seq__64605_64641;
var G__64647 = chunk__64606_64642;
var G__64648 = count__64607_64643;
var G__64649 = (i__64608_64644 + (1));
seq__64605_64641 = G__64646;
chunk__64606_64642 = G__64647;
count__64607_64643 = G__64648;
i__64608_64644 = G__64649;
continue;
} else {
var temp__5735__auto___64650 = cljs.core.seq(seq__64605_64641);
if(temp__5735__auto___64650){
var seq__64605_64651__$1 = temp__5735__auto___64650;
if(cljs.core.chunked_seq_QMARK_(seq__64605_64651__$1)){
var c__4609__auto___64652 = cljs.core.chunk_first(seq__64605_64651__$1);
var G__64653 = cljs.core.chunk_rest(seq__64605_64651__$1);
var G__64654 = c__4609__auto___64652;
var G__64655 = cljs.core.count(c__4609__auto___64652);
var G__64656 = (0);
seq__64605_64641 = G__64653;
chunk__64606_64642 = G__64654;
count__64607_64643 = G__64655;
i__64608_64644 = G__64656;
continue;
} else {
var nt_64657 = cljs.core.first(seq__64605_64651__$1);
if(cljs.core.truth_((valid_nts_64640.cljs$core$IFn$_invoke$arity$1 ? valid_nts_64640.cljs$core$IFn$_invoke$arity$1(nt_64657) : valid_nts_64640.call(null,nt_64657)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_64657),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__64658 = cljs.core.next(seq__64605_64651__$1);
var G__64659 = null;
var G__64660 = (0);
var G__64661 = (0);
seq__64605_64641 = G__64658;
chunk__64606_64642 = G__64659;
count__64607_64643 = G__64660;
i__64608_64644 = G__64661;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__64609_64662 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__64610_64663 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__64611_64664 = true;
var _STAR_print_fn_STAR__temp_val__64612_64665 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__64611_64664);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__64612_64665);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__64610_64663);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__64609_64662);
}
...
var len__4789__auto___64666 = arguments.length;
var i__4790__auto___64667 = (0);
while(true){
if((i__4790__auto___64667 < len__4789__auto___64666)){
args__4795__auto__.push((arguments[i__4790__auto___64667]));

var G__64668 = (i__4790__auto___64667 + (1));
i__4790__auto___64667 = G__64668;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__64615){
var map__64616 = p__64615;
var map__64616__$1 = (((((!((map__64616 == null))))?(((((map__64616.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__64616.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__64616):map__64616);
var opts = map__64616__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__64618 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__64619 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__64619);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__64620_64685 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__64621_64686 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__64622_64687 = true;
var _STAR_print_fn_STAR__temp_val__64623_64688 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__64622_64687);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__64623_64688);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__64621_64686);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__64620_64685);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__64618);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq64613){
