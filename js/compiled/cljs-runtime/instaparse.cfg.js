...
var G__64623 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__64623)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__64623)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__64623)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__64623)].join('')));
...
var G__64670 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__64671 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__64670;
v = G__64671;
continue;
} else {
var G__64672 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__64673 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__64672;
v = G__64673;
continue;
}
...
break;
case "\"":
var G__64674 = cljs.core.next(sq);
var G__64675 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__64674;
v = G__64675;
continue;
...
break;
default:
var G__64676 = cljs.core.next(sq);
var G__64677 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__64676;
v = G__64677;
continue;
...
while(true){
var G__64632 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__64632__$1 = (((G__64632 instanceof cljs.core.Keyword))?G__64632.fqn:null);
switch (G__64632__$1) {
case "rule":
var vec__64633 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64633,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64633,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__64640 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__64640) : instaparse.cfg.content.call(null,G__64640));
...
break;
case "paren":
var G__64681 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__64681;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__64641 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64641) : instaparse.cfg.build_rule.call(null,G__64641));
})());
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__64642 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64642) : instaparse.cfg.build_rule.call(null,G__64642));
})());

break;
case "star":
return instaparse.combinators_source.star((function (){var G__64643 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64643) : instaparse.cfg.build_rule.call(null,G__64643));
})());

break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__64644 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64644) : instaparse.cfg.build_rule.call(null,G__64644));
})());

break;
case "look":
return instaparse.combinators_source.look((function (){var G__64645 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64645) : instaparse.cfg.build_rule.call(null,G__64645));
})());

break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__64646 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64646) : instaparse.cfg.build_rule.call(null,G__64646));
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__64632__$1)].join('')));
...
while(true){
var G__64648 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
...
case "neg":
case "rep":
var G__64683 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__64683;
continue;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__64648__$1)].join('')));
...
var valid_nts_64684 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__64649_64685 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__64650_64686 = null;
var count__64651_64687 = (0);
var i__64652_64688 = (0);
while(true){
if((i__64652_64688 < count__64651_64687)){
var nt_64689 = chunk__64650_64686.cljs$core$IIndexed$_nth$arity$2(null,i__64652_64688);
if(cljs.core.truth_((valid_nts_64684.cljs$core$IFn$_invoke$arity$1 ? valid_nts_64684.cljs$core$IFn$_invoke$arity$1(nt_64689) : valid_nts_64684.call(null,nt_64689)))){
} else {
...
var G__64690 = seq__64649_64685;
var G__64691 = chunk__64650_64686;
var G__64692 = count__64651_64687;
var G__64693 = (i__64652_64688 + (1));
seq__64649_64685 = G__64690;
chunk__64650_64686 = G__64691;
count__64651_64687 = G__64692;
i__64652_64688 = G__64693;
continue;
} else {
var temp__5735__auto___64694 = cljs.core.seq(seq__64649_64685);
if(temp__5735__auto___64694){
var seq__64649_64695__$1 = temp__5735__auto___64694;
if(cljs.core.chunked_seq_QMARK_(seq__64649_64695__$1)){
var c__4609__auto___64696 = cljs.core.chunk_first(seq__64649_64695__$1);
var G__64697 = cljs.core.chunk_rest(seq__64649_64695__$1);
var G__64698 = c__4609__auto___64696;
var G__64699 = cljs.core.count(c__4609__auto___64696);
var G__64700 = (0);
seq__64649_64685 = G__64697;
chunk__64650_64686 = G__64698;
count__64651_64687 = G__64699;
i__64652_64688 = G__64700;
continue;
} else {
var nt_64701 = cljs.core.first(seq__64649_64695__$1);
if(cljs.core.truth_((valid_nts_64684.cljs$core$IFn$_invoke$arity$1 ? valid_nts_64684.cljs$core$IFn$_invoke$arity$1(nt_64701) : valid_nts_64684.call(null,nt_64701)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_64701),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__64702 = cljs.core.next(seq__64649_64695__$1);
var G__64703 = null;
var G__64704 = (0);
var G__64705 = (0);
seq__64649_64685 = G__64702;
chunk__64650_64686 = G__64703;
count__64651_64687 = G__64704;
i__64652_64688 = G__64705;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__64653_64706 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__64654_64707 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__64655_64708 = true;
var _STAR_print_fn_STAR__temp_val__64656_64709 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__64655_64708);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__64656_64709);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__64654_64707);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__64653_64706);
}
...
var len__4789__auto___64710 = arguments.length;
var i__4790__auto___64711 = (0);
while(true){
if((i__4790__auto___64711 < len__4789__auto___64710)){
args__4795__auto__.push((arguments[i__4790__auto___64711]));

var G__64712 = (i__4790__auto___64711 + (1));
i__4790__auto___64711 = G__64712;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__64659){
var map__64660 = p__64659;
var map__64660__$1 = (((((!((map__64660 == null))))?(((((map__64660.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__64660.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__64660):map__64660);
var opts = map__64660__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__64662 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__64663 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__64663);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__64664_64713 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__64665_64714 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__64666_64715 = true;
var _STAR_print_fn_STAR__temp_val__64667_64716 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__64666_64715);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__64667_64716);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__64665_64714);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__64664_64713);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__64662);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq64657){
var G__64658 = cljs.core.first(seq64657);
var seq64657__$1 = cljs.core.next(seq64657);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__64658,seq64657__$1);
}));
