...
var G__64514 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__64514)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__64514)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__64514)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__64514)].join('')));
...
var G__64562 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__64563 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__64562;
v = G__64563;
continue;
} else {
var G__64564 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__64565 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__64564;
v = G__64565;
continue;
}
...
break;
case "\"":
var G__64566 = cljs.core.next(sq);
var G__64567 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__64566;
v = G__64567;
continue;
...
break;
default:
var G__64568 = cljs.core.next(sq);
var G__64569 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__64568;
v = G__64569;
continue;
...
while(true){
var G__64523 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__64523__$1 = (((G__64523 instanceof cljs.core.Keyword))?G__64523.fqn:null);
switch (G__64523__$1) {
case "rule":
var vec__64524 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64524,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64524,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__64531 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__64531) : instaparse.cfg.content.call(null,G__64531));
...
break;
case "paren":
var G__64572 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__64572;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__64532 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64532) : instaparse.cfg.build_rule.call(null,G__64532));
})());
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__64533 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64533) : instaparse.cfg.build_rule.call(null,G__64533));
})());

break;
case "star":
return instaparse.combinators_source.star((function (){var G__64534 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64534) : instaparse.cfg.build_rule.call(null,G__64534));
})());

break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__64535 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64535) : instaparse.cfg.build_rule.call(null,G__64535));
})());

break;
case "look":
return instaparse.combinators_source.look((function (){var G__64537 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64537) : instaparse.cfg.build_rule.call(null,G__64537));
})());

break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__64538 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64538) : instaparse.cfg.build_rule.call(null,G__64538));
})());
...
while(true){
var G__64539 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
...
case "neg":
case "rep":
var G__64574 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__64574;
continue;
...
var valid_nts_64575 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__64540_64576 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__64541_64577 = null;
var count__64542_64578 = (0);
var i__64543_64579 = (0);
while(true){
if((i__64543_64579 < count__64542_64578)){
var nt_64580 = chunk__64541_64577.cljs$core$IIndexed$_nth$arity$2(null,i__64543_64579);
if(cljs.core.truth_((valid_nts_64575.cljs$core$IFn$_invoke$arity$1 ? valid_nts_64575.cljs$core$IFn$_invoke$arity$1(nt_64580) : valid_nts_64575.call(null,nt_64580)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_64580),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__64581 = seq__64540_64576;
var G__64582 = chunk__64541_64577;
var G__64583 = count__64542_64578;
var G__64584 = (i__64543_64579 + (1));
seq__64540_64576 = G__64581;
chunk__64541_64577 = G__64582;
count__64542_64578 = G__64583;
i__64543_64579 = G__64584;
continue;
} else {
var temp__5735__auto___64585 = cljs.core.seq(seq__64540_64576);
if(temp__5735__auto___64585){
var seq__64540_64586__$1 = temp__5735__auto___64585;
if(cljs.core.chunked_seq_QMARK_(seq__64540_64586__$1)){
var c__4609__auto___64587 = cljs.core.chunk_first(seq__64540_64586__$1);
var G__64588 = cljs.core.chunk_rest(seq__64540_64586__$1);
var G__64589 = c__4609__auto___64587;
var G__64590 = cljs.core.count(c__4609__auto___64587);
var G__64591 = (0);
seq__64540_64576 = G__64588;
chunk__64541_64577 = G__64589;
count__64542_64578 = G__64590;
i__64543_64579 = G__64591;
continue;
} else {
var nt_64592 = cljs.core.first(seq__64540_64586__$1);
if(cljs.core.truth_((valid_nts_64575.cljs$core$IFn$_invoke$arity$1 ? valid_nts_64575.cljs$core$IFn$_invoke$arity$1(nt_64592) : valid_nts_64575.call(null,nt_64592)))){
} else {
...
var G__64593 = cljs.core.next(seq__64540_64586__$1);
var G__64594 = null;
var G__64595 = (0);
var G__64596 = (0);
seq__64540_64576 = G__64593;
chunk__64541_64577 = G__64594;
count__64542_64578 = G__64595;
i__64543_64579 = G__64596;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__64544_64597 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__64545_64598 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__64546_64599 = true;
var _STAR_print_fn_STAR__temp_val__64547_64600 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__64546_64599);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__64547_64600);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__64545_64598);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__64544_64597);
}
...
var len__4789__auto___64601 = arguments.length;
var i__4790__auto___64602 = (0);
while(true){
if((i__4790__auto___64602 < len__4789__auto___64601)){
args__4795__auto__.push((arguments[i__4790__auto___64602]));

var G__64603 = (i__4790__auto___64602 + (1));
i__4790__auto___64602 = G__64603;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__64550){
var map__64551 = p__64550;
var map__64551__$1 = (((((!((map__64551 == null))))?(((((map__64551.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__64551.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__64551):map__64551);
var opts = map__64551__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__64553 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__64554 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__64554);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__64555_64604 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__64556_64605 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__64557_64606 = true;
var _STAR_print_fn_STAR__temp_val__64558_64607 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__64557_64606);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__64558_64607);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__64556_64605);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__64555_64604);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__64553);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq64548){
var G__64549 = cljs.core.first(seq64548);
var seq64548__$1 = cljs.core.next(seq64548);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__64549,seq64548__$1);
}));
