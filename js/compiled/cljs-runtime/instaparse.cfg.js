...
var G__64503 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__64503)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__64503)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__64503)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__64503)].join('')));
...
var G__64550 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__64551 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__64550;
v = G__64551;
continue;
} else {
var G__64552 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__64553 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__64552;
v = G__64553;
continue;
}
...
break;
case "\"":
var G__64554 = cljs.core.next(sq);
var G__64555 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__64554;
v = G__64555;
continue;
...
break;
default:
var G__64556 = cljs.core.next(sq);
var G__64557 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__64556;
v = G__64557;
continue;
...
while(true){
var G__64516 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__64516__$1 = (((G__64516 instanceof cljs.core.Keyword))?G__64516.fqn:null);
switch (G__64516__$1) {
case "rule":
var vec__64517 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64517,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64517,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__64520 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__64520) : instaparse.cfg.content.call(null,G__64520));
...
break;
case "paren":
var G__64560 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__64560;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__64521 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64521) : instaparse.cfg.build_rule.call(null,G__64521));
})());
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__64522 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64522) : instaparse.cfg.build_rule.call(null,G__64522));
})());

break;
case "star":
return instaparse.combinators_source.star((function (){var G__64523 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64523) : instaparse.cfg.build_rule.call(null,G__64523));
})());

break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__64524 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "look":
return instaparse.combinators_source.look((function (){var G__64525 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__64526 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__64516__$1)].join('')));
...
while(true){
var G__64527 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
...
case "neg":
case "rep":
var G__64562 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__64562;
continue;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__64527__$1)].join('')));
...
var valid_nts_64563 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__64528_64564 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__64529_64565 = null;
var count__64530_64566 = (0);
var i__64531_64567 = (0);
while(true){
if((i__64531_64567 < count__64530_64566)){
var nt_64568 = chunk__64529_64565.cljs$core$IIndexed$_nth$arity$2(null,i__64531_64567);
if(cljs.core.truth_((valid_nts_64563.cljs$core$IFn$_invoke$arity$1 ? valid_nts_64563.cljs$core$IFn$_invoke$arity$1(nt_64568) : valid_nts_64563.call(null,nt_64568)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_64568),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__64569 = seq__64528_64564;
var G__64570 = chunk__64529_64565;
var G__64571 = count__64530_64566;
var G__64572 = (i__64531_64567 + (1));
seq__64528_64564 = G__64569;
chunk__64529_64565 = G__64570;
count__64530_64566 = G__64571;
i__64531_64567 = G__64572;
continue;
} else {
var temp__5735__auto___64573 = cljs.core.seq(seq__64528_64564);
if(temp__5735__auto___64573){
var seq__64528_64574__$1 = temp__5735__auto___64573;
if(cljs.core.chunked_seq_QMARK_(seq__64528_64574__$1)){
var c__4609__auto___64575 = cljs.core.chunk_first(seq__64528_64574__$1);
var G__64576 = cljs.core.chunk_rest(seq__64528_64574__$1);
var G__64577 = c__4609__auto___64575;
var G__64578 = cljs.core.count(c__4609__auto___64575);
var G__64579 = (0);
seq__64528_64564 = G__64576;
chunk__64529_64565 = G__64577;
count__64530_64566 = G__64578;
i__64531_64567 = G__64579;
continue;
} else {
var nt_64580 = cljs.core.first(seq__64528_64574__$1);
if(cljs.core.truth_((valid_nts_64563.cljs$core$IFn$_invoke$arity$1 ? valid_nts_64563.cljs$core$IFn$_invoke$arity$1(nt_64580) : valid_nts_64563.call(null,nt_64580)))){
} else {
...
var G__64581 = cljs.core.next(seq__64528_64574__$1);
var G__64582 = null;
var G__64583 = (0);
var G__64584 = (0);
seq__64528_64564 = G__64581;
chunk__64529_64565 = G__64582;
count__64530_64566 = G__64583;
i__64531_64567 = G__64584;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__64532_64585 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__64533_64586 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__64534_64587 = true;
var _STAR_print_fn_STAR__temp_val__64535_64588 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__64534_64587);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__64535_64588);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__64533_64586);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__64532_64585);
}
...
var len__4789__auto___64589 = arguments.length;
var i__4790__auto___64590 = (0);
while(true){
if((i__4790__auto___64590 < len__4789__auto___64589)){
args__4795__auto__.push((arguments[i__4790__auto___64590]));

var G__64591 = (i__4790__auto___64590 + (1));
i__4790__auto___64590 = G__64591;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__64538){
var map__64539 = p__64538;
...
var opts = map__64539__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__64541 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__64542 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__64542);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__64543_64597 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__64544_64598 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__64545_64599 = true;
var _STAR_print_fn_STAR__temp_val__64546_64600 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__64545_64599);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__64546_64600);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__64544_64598);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__64543_64597);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__64541);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq64536){
