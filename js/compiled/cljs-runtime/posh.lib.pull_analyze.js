...
var G__45284 = db;
var G__45285 = posh.lib.pull_analyze.insert_dbid(pull_pattern);
var G__45286 = eid;
return (pull_fn.cljs$core$IFn$_invoke$arity$3 ? pull_fn.cljs$core$IFn$_invoke$arity$3(G__45284,G__45285,G__45286) : pull_fn.call(null,G__45284,G__45285,G__45286));
});
...
var G__45301 = schema;
var G__45302 = new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(p1__45290_SHARP_);
var G__45303 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([((r_QMARK_)?cljs.core.PersistentArrayMap.createAsIfByAssoc([k__$1,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("db","id","db/id",-1388397098),entity_id], null)]):null),p1__45290_SHARP_], 0));
...
var G__45315 = cljs.core.first(x);
var fexpr__45314 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol(null,"limit","limit",284709164,null),null,"limit",null], null), null);
return (fexpr__45314.cljs$core$IFn$_invoke$arity$1 ? fexpr__45314.cljs$core$IFn$_invoke$arity$1(G__45315) : fexpr__45314.call(null,G__45315));
} else {
return false;
}
});
...
var entity_keys = cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__45317_SHARP_){
return ((cljs.core.map_QMARK_(p1__45317_SHARP_)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("db","id","db/id",-1388397098),p1__45317_SHARP_)));
}),pull_pattern);
var val_keys = cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__45318_SHARP_){
return ((posh.lib.pull_analyze.reverse_lookup_QMARK_(p1__45318_SHARP_)) || (posh.lib.pull_analyze.ref_QMARK_(schema,p1__45318_SHARP_)));
}),entity_keys);
...
})())?cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__45320_SHARP_){
return (posh.lib.pull_analyze.tx_pattern_for_pull.cljs$core$IFn$_invoke$arity$4 ? posh.lib.pull_analyze.tx_pattern_for_pull.cljs$core$IFn$_invoke$arity$4(schema,ref_pull,p1__45320_SHARP_,refs_only_QMARK_) : posh.lib.pull_analyze.tx_pattern_for_pull.call(null,schema,ref_pull,p1__45320_SHARP_,refs_only_QMARK_));
...
var map__45366__$1 = (((((!((map__45366 == null))))?(((((map__45366.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__45366.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__45366):map__45366);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45366__$1,new cljs.core.Keyword(null,"db","db",993250759));
var db_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45366__$1,new cljs.core.Keyword(null,"db-id","db-id",747248515));
var schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45366__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
...
var affected_datoms = posh.lib.pull_analyze.pull_affected_datoms(new cljs.core.Keyword(null,"pull","pull",-860544805).cljs$core$IFn$_invoke$arity$1(dcfg),db,pull_pattern,(function (){var fexpr__45378 = new cljs.core.Keyword(null,"entid","entid",1720688982).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__45378.cljs$core$IFn$_invoke$arity$2 ? fexpr__45378.cljs$core$IFn$_invoke$arity$2(db,ent_id) : fexpr__45378.call(null,db,ent_id));
})());
...
var schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45392__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
var db_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45392__$1,new cljs.core.Keyword(null,"db-id","db-id",747248515));
...
var fexpr__45402 = new cljs.core.Keyword(null,"entid","entid",1720688982).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__45402.cljs$core$IFn$_invoke$arity$2 ? fexpr__45402.cljs$core$IFn$_invoke$arity$2(db,p1__45384_SHARP_) : fexpr__45402.call(null,db,p1__45384_SHARP_));
}),ent_ids);
