 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.compression.token_fn = (function day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$compression$token_fn(p__25751){
var vec__25752 = p__25751;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25752,(0),null);
var re = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25752,(1),null);
return (function (s){
...
var len__4789__auto___25770 = arguments.length;
var i__4790__auto___25771 = (0);
while(true){
if((i__4790__auto___25771 < len__4789__auto___25770)){
args__4795__auto__.push((arguments[i__4790__auto___25771]));

var G__25772 = (i__4790__auto___25771 + (1));
i__4790__auto___25771 = G__25772;
continue;
} else {
}
break;
...
return (function (s){
return cljs.core.some((function (p1__25755_SHARP_){
return (p1__25755_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__25755_SHARP_.cljs$core$IFn$_invoke$arity$1(s) : p1__25755_SHARP_.call(null,s));
}),fs);
});
}));
...
/** @this {Function} */
(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.compression.tokenizer.cljs$lang$applyTo = (function (seq25756){
...
var map__25761 = temp__5733__auto__;
var map__25761__$1 = (((((!((map__25761 == null))))?(((((map__25761.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__25761.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__25761):map__25761);
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25761__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25761__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25761__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__25773 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s1,size);
var G__25774 = [s2,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__25769 = tag;
var G__25769__$1 = (((G__25769 instanceof cljs.core.Keyword))?G__25769.fqn:null);
switch (G__25769__$1) {
case "string":
return chunk;
