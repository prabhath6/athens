 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.compression.token_fn = (function day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$compression$token_fn(p__25752){
var vec__25753 = p__25752;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25753,(0),null);
var re = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25753,(1),null);
return (function (s){
...
var len__4789__auto___25772 = arguments.length;
var i__4790__auto___25773 = (0);
while(true){
if((i__4790__auto___25773 < len__4789__auto___25772)){
args__4795__auto__.push((arguments[i__4790__auto___25773]));

var G__25774 = (i__4790__auto___25773 + (1));
i__4790__auto___25773 = G__25774;
continue;
} else {
}
break;
...
return (function (s){
return cljs.core.some((function (p1__25757_SHARP_){
return (p1__25757_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__25757_SHARP_.cljs$core$IFn$_invoke$arity$1(s) : p1__25757_SHARP_.call(null,s));
}),fs);
});
}));
...
/** @this {Function} */
(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.compression.tokenizer.cljs$lang$applyTo = (function (seq25760){
...
var map__25767 = temp__5733__auto__;
...
var chunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25767__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25767__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__25787 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s1,size);
var G__25788 = [s2,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__25770 = tag;
