...
shadow.remote.runtime.cljs.browser.abort_BANG_ = (function shadow$remote$runtime$cljs$browser$abort_BANG_(p__68045,action,ex){
...
var callback = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68046__$1,new cljs.core.Keyword(null,"callback","callback",-705136228));
var G__68048 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(state,new cljs.core.Keyword(null,"failed","failed",-1397425762),true,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"completed","completed",-486056503),false,new cljs.core.Keyword(null,"ex","ex",-1413771341),ex,new cljs.core.Keyword(null,"ex-action","ex-action",672251553),action], 0));
return (callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(G__68048) : callback.call(null,G__68048));
});
shadow.remote.runtime.cljs.browser.interpret_action = (function shadow$remote$runtime$cljs$browser$interpret_action(p__68049,p__68050){
var map__68051 = p__68049;
...
var state = map__68051__$1;
var runtime = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68051__$1,new cljs.core.Keyword(null,"runtime","runtime",-1331573996));
...
var action = map__68052__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68052__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var G__68055 = type;
var G__68055__$1 = (((G__68055 instanceof cljs.core.Keyword))?G__68055.fqn:null);
switch (G__68055__$1) {
case "repl/invoke":
var map__68056 = action;
...
var js = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68056__$1,new cljs.core.Keyword(null,"js","js",1768080579));
try{var res = runtime.eval_js(js);
var G__68059 = cljs.core.update.cljs$core$IFn$_invoke$arity$4(state,new cljs.core.Keyword(null,"eval-results","eval-results",553789722),cljs.core.conj,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"value","value",305978217),res,new cljs.core.Keyword(null,"action","action",-811238024),action], null));
return (shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1 ? shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1(G__68059) : shadow.remote.runtime.cljs.browser.interpret_actions.call(null,G__68059));
}catch (e68058){var ex = e68058;
return shadow.remote.runtime.cljs.browser.abort_BANG_(state,action,ex);
}
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__68055__$1)].join('')));

}
});
shadow.remote.runtime.cljs.browser.interpret_actions = (function shadow$remote$runtime$cljs$browser$interpret_actions(p__68060){
var map__68061 = p__68060;
...
var state = map__68061__$1;
var actions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68061__$1,new cljs.core.Keyword(null,"actions","actions",-812656882));
if(cljs.core.empty_QMARK_(actions)){
var fexpr__68063 = new cljs.core.Keyword(null,"callback","callback",-705136228).cljs$core$IFn$_invoke$arity$1(state);
return (fexpr__68063.cljs$core$IFn$_invoke$arity$1 ? fexpr__68063.cljs$core$IFn$_invoke$arity$1(state) : fexpr__68063.call(null,state));
} else {
var map__68064 = cljs.core.first(actions);
...
var action = map__68064__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68064__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
var self__ = this;
var this$ = this;
var G__68071 = [shadow.cljs.devtools.client.env.get_url_base(),"/worker/compile/",shadow.cljs.devtools.client.env.build_id,"/",shadow.cljs.devtools.client.env.proc_id,"/browser"].join('');
var G__68072 = (function (res){
var req = this;
var map__68076 = shadow.remote.runtime.cljs.browser.transit_read(req.getResponseText());
...
var result = map__68076__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68076__$1,new cljs.core.Keyword(null,"type","type",1174270348));
if((!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("repl","actions","repl/actions",-809718877),type)))){
var G__68078 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"failed","failed",-1397425762),true,new cljs.core.Keyword(null,"result","result",1415092211),result], null);
return (callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(G__68078) : callback.call(null,G__68078));
} else {
...
var G__68073 = "POST";
var G__68074 = shadow.remote.runtime.cljs.browser.transit_str(msg);
var G__68075 = ({"content-type": "application/transit+json; charset=utf-8"});
return goog.net.XhrIo.send(G__68071,G__68072,G__68073,G__68074,G__68075);
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k68067,else__4442__auto__){
var self__ = this;
var this__4441__auto____$1 = this;
var G__68079 = k68067;
var G__68079__$1 = (((G__68079 instanceof cljs.core.Keyword))?G__68079.fqn:null);
switch (G__68079__$1) {
case "ws":
return self__.ws;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k68067,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__68080){
var vec__68081 = p__68080;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68081,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68081,(1),null);
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__68066){
var self__ = this;
var G__68066__$1 = this;
return (new cljs.core.RecordIter((0),G__68066__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ws","ws",86841443),new cljs.core.Keyword(null,"state-ref","state-ref",2127874952)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var h__4297__auto____$1 = (function (){var fexpr__68084 = (function (coll__4436__auto__){
return (725844968 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__68084(this__4435__auto____$1);
})();
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this68068,other68069){
var self__ = this;
var this68068__$1 = this;
return (((!((other68069 == null)))) && ((this68068__$1.constructor === other68069.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this68068__$1.ws,other68069.ws)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this68068__$1.state_ref,other68069.state_ref)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this68068__$1.__extmap,other68069.__extmap)));
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__68066){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__68085 = cljs.core.keyword_identical_QMARK_;
var expr__68086 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__68088 = new cljs.core.Keyword(null,"ws","ws",86841443);
var G__68089 = expr__68086;
return (pred__68085.cljs$core$IFn$_invoke$arity$2 ? pred__68085.cljs$core$IFn$_invoke$arity$2(G__68088,G__68089) : pred__68085.call(null,G__68088,G__68089));
})())){
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(G__68066,self__.state_ref,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__68090 = new cljs.core.Keyword(null,"state-ref","state-ref",2127874952);
var G__68091 = expr__68086;
return (pred__68085.cljs$core$IFn$_invoke$arity$2 ? pred__68085.cljs$core$IFn$_invoke$arity$2(G__68090,G__68091) : pred__68085.call(null,G__68090,G__68091));
})())){
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,G__68066,self__.__meta,self__.__extmap,null));
} else {
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__68066),null));
}
}
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__68066){
var self__ = this;
var this__4438__auto____$1 = this;
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,G__68066,self__.__extmap,self__.__hash));
}));
 ...
 */
shadow.remote.runtime.cljs.browser.map__GT_BrowserRuntime = (function shadow$remote$runtime$cljs$browser$map__GT_BrowserRuntime(G__68070){
var extmap__4478__auto__ = (function (){var G__68092 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__68070,new cljs.core.Keyword(null,"ws","ws",86841443),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"state-ref","state-ref",2127874952)], 0));
if(cljs.core.record_QMARK_(G__68070)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__68092);
} else {
return G__68092;
}
})();
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(new cljs.core.Keyword(null,"ws","ws",86841443).cljs$core$IFn$_invoke$arity$1(G__68070),new cljs.core.Keyword(null,"state-ref","state-ref",2127874952).cljs$core$IFn$_invoke$arity$1(G__68070),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var runtime = (function (){var G__68093 = (new shadow.remote.runtime.cljs.browser.BrowserRuntime(socket,state_ref,null,null,null));
shadow.remote.runtime.shared.add_defaults(G__68093);
...
var map__68094 = temp__5737__auto__;
...
var stop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68094__$1,new cljs.core.Keyword(null,"stop","stop",-2140911342));
