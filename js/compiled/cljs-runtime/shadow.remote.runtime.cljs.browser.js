...
shadow.remote.runtime.cljs.browser.abort_BANG_ = (function shadow$remote$runtime$cljs$browser$abort_BANG_(p__68033,action,ex){
var map__68034 = p__68033;
...
var state = map__68034__$1;
var callback = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68034__$1,new cljs.core.Keyword(null,"callback","callback",-705136228));
var G__68036 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(state,new cljs.core.Keyword(null,"failed","failed",-1397425762),true,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"completed","completed",-486056503),false,new cljs.core.Keyword(null,"ex","ex",-1413771341),ex,new cljs.core.Keyword(null,"ex-action","ex-action",672251553),action], 0));
return (callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(G__68036) : callback.call(null,G__68036));
});
shadow.remote.runtime.cljs.browser.interpret_action = (function shadow$remote$runtime$cljs$browser$interpret_action(p__68037,p__68038){
...
var action = map__68040__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68040__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var G__68043 = type;
var G__68043__$1 = (((G__68043 instanceof cljs.core.Keyword))?G__68043.fqn:null);
switch (G__68043__$1) {
case "repl/invoke":
var map__68044 = action;
...
var js = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68044__$1,new cljs.core.Keyword(null,"js","js",1768080579));
try{var res = runtime.eval_js(js);
var G__68047 = cljs.core.update.cljs$core$IFn$_invoke$arity$4(state,new cljs.core.Keyword(null,"eval-results","eval-results",553789722),cljs.core.conj,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"value","value",305978217),res,new cljs.core.Keyword(null,"action","action",-811238024),action], null));
return (shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1 ? shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1(G__68047) : shadow.remote.runtime.cljs.browser.interpret_actions.call(null,G__68047));
}catch (e68046){var ex = e68046;
return shadow.remote.runtime.cljs.browser.abort_BANG_(state,action,ex);
}
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__68043__$1)].join('')));

}
});
shadow.remote.runtime.cljs.browser.interpret_actions = (function shadow$remote$runtime$cljs$browser$interpret_actions(p__68048){
...
var actions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68049__$1,new cljs.core.Keyword(null,"actions","actions",-812656882));
if(cljs.core.empty_QMARK_(actions)){
var fexpr__68051 = new cljs.core.Keyword(null,"callback","callback",-705136228).cljs$core$IFn$_invoke$arity$1(state);
return (fexpr__68051.cljs$core$IFn$_invoke$arity$1 ? fexpr__68051.cljs$core$IFn$_invoke$arity$1(state) : fexpr__68051.call(null,state));
} else {
var map__68052 = cljs.core.first(actions);
...
var self__ = this;
var this$ = this;
var G__68059 = [shadow.cljs.devtools.client.env.get_url_base(),"/worker/compile/",shadow.cljs.devtools.client.env.build_id,"/",shadow.cljs.devtools.client.env.proc_id,"/browser"].join('');
var G__68060 = (function (res){
var req = this;
var map__68064 = shadow.remote.runtime.cljs.browser.transit_read(req.getResponseText());
...
var G__68066 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"failed","failed",-1397425762),true,new cljs.core.Keyword(null,"result","result",1415092211),result], null);
return (callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(G__68066) : callback.call(null,G__68066));
} else {
...
var G__68061 = "POST";
var G__68062 = shadow.remote.runtime.cljs.browser.transit_str(msg);
var G__68063 = ({"content-type": "application/transit+json; charset=utf-8"});
return goog.net.XhrIo.send(G__68059,G__68060,G__68061,G__68062,G__68063);
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k68055,else__4442__auto__){
var self__ = this;
var this__4441__auto____$1 = this;
var G__68067 = k68055;
var G__68067__$1 = (((G__68067 instanceof cljs.core.Keyword))?G__68067.fqn:null);
switch (G__68067__$1) {
case "ws":
return self__.ws;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k68055,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__68068){
var vec__68069 = p__68068;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68069,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68069,(1),null);
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__68054){
var self__ = this;
var G__68054__$1 = this;
return (new cljs.core.RecordIter((0),G__68054__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ws","ws",86841443),new cljs.core.Keyword(null,"state-ref","state-ref",2127874952)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var h__4297__auto____$1 = (function (){var fexpr__68072 = (function (coll__4436__auto__){
return (725844968 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__68072(this__4435__auto____$1);
})();
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this68056,other68057){
var self__ = this;
var this68056__$1 = this;
return (((!((other68057 == null)))) && ((this68056__$1.constructor === other68057.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this68056__$1.ws,other68057.ws)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this68056__$1.state_ref,other68057.state_ref)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this68056__$1.__extmap,other68057.__extmap)));
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__68054){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__68073 = cljs.core.keyword_identical_QMARK_;
var expr__68074 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__68076 = new cljs.core.Keyword(null,"ws","ws",86841443);
var G__68077 = expr__68074;
return (pred__68073.cljs$core$IFn$_invoke$arity$2 ? pred__68073.cljs$core$IFn$_invoke$arity$2(G__68076,G__68077) : pred__68073.call(null,G__68076,G__68077));
})())){
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(G__68054,self__.state_ref,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__68078 = new cljs.core.Keyword(null,"state-ref","state-ref",2127874952);
var G__68079 = expr__68074;
return (pred__68073.cljs$core$IFn$_invoke$arity$2 ? pred__68073.cljs$core$IFn$_invoke$arity$2(G__68078,G__68079) : pred__68073.call(null,G__68078,G__68079));
})())){
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,G__68054,self__.__meta,self__.__extmap,null));
} else {
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__68054),null));
}
}
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__68054){
var self__ = this;
var this__4438__auto____$1 = this;
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,G__68054,self__.__extmap,self__.__hash));
}));
 ...
 */
shadow.remote.runtime.cljs.browser.map__GT_BrowserRuntime = (function shadow$remote$runtime$cljs$browser$map__GT_BrowserRuntime(G__68058){
var extmap__4478__auto__ = (function (){var G__68080 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__68058,new cljs.core.Keyword(null,"ws","ws",86841443),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"state-ref","state-ref",2127874952)], 0));
if(cljs.core.record_QMARK_(G__68058)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__68080);
} else {
return G__68080;
}
})();
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(new cljs.core.Keyword(null,"ws","ws",86841443).cljs$core$IFn$_invoke$arity$1(G__68058),new cljs.core.Keyword(null,"state-ref","state-ref",2127874952).cljs$core$IFn$_invoke$arity$1(G__68058),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var runtime = (function (){var G__68081 = (new shadow.remote.runtime.cljs.browser.BrowserRuntime(socket,state_ref,null,null,null));
shadow.remote.runtime.shared.add_defaults(G__68081);
...
var map__68082 = temp__5737__auto__;
...
var stop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68082__$1,new cljs.core.Keyword(null,"stop","stop",-2140911342));
