...
}catch (e50568){if((e50568 instanceof Error)){
var e = e50568;
return devcards.util.edn_renderer.clearfix_separator_STAR_;
} else {
throw e50568;
...
devcards.util.edn_renderer.html_keyval = (function devcards$util$edn_renderer$html_keyval(p__50571){
var vec__50572 = p__50571;
...
var _STAR_key_counter_STAR__orig_val__50579 = devcards.util.edn_renderer._STAR_key_counter_STAR_;
var _STAR_key_counter_STAR__temp_val__50580 = cljs.core.atom.cljs$core$IFn$_invoke$arity$1((0));
(devcards.util.edn_renderer._STAR_key_counter_STAR_ = _STAR_key_counter_STAR__temp_val__50580);
...
}finally {(devcards.util.edn_renderer._STAR_key_counter_STAR_ = _STAR_key_counter_STAR__orig_val__50579);
}});
