...
var G__65574 = athens.db.dsdb;
var G__65575 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","add","db/add",235286841),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),uid], null),new cljs.core.Keyword("block","string","block/string",-2066596447),e.target.value], null)], null);
return (posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2 ? posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2(G__65574,G__65575) : posh.reagent.transact_BANG_.call(null,G__65574,G__65575));
})], null)], null)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h1","h1",-1896887462),["\u2022 ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(string)].join('')], null))], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),(function (){var iter__4582__auto__ = (function athens$devcards$block_page$block_page_el_$_iter__65576(s__65577){
return (new cljs.core.LazySeq(null,(function (){
var s__65577__$1 = s__65577;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__65577__$1);
if(temp__5735__auto__){
var s__65577__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__65577__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__65577__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__65579 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__65578 = (0);
while(true){
if((i__65578 < size__4581__auto__)){
var child = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__65578);
cljs.core.chunk_append(b__65579,(function (){var map__65580 = child;
var map__65580__$1 = (((((!((map__65580 == null))))?(((((map__65580.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__65580.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__65580):map__65580);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65580__$1,new cljs.core.Keyword("db","id","db/id",-1388397098));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__65579),athens$devcards$block_page$block_page_el_$_iter__65576(cljs.core.chunk_rest(s__65577__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__65579),null);
}
} else {
var child = cljs.core.first(s__65577__$2);
return cljs.core.cons((function (){var map__65582 = child;
...
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.blocks.block_el,child], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null));
})(),athens$devcards$block_page$block_page_el_$_iter__65576(cljs.core.rest(s__65577__$2)));
}
} else {
return null;
}
...
var editing_uid = cljs.core.deref((function (){var G__65584 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"editing-uid","editing-uid",1372614377)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__65584) : re_frame.core.subscribe.call(null,G__65584));
})());
