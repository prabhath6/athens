...
var G__65558 = athens.db.dsdb;
var G__65559 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","add","db/add",235286841),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),uid], null),new cljs.core.Keyword("block","string","block/string",-2066596447),e.target.value], null)], null);
return (posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2 ? posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2(G__65558,G__65559) : posh.reagent.transact_BANG_.call(null,G__65558,G__65559));
})], null)], null)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h1","h1",-1896887462),["\u2022 ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(string)].join('')], null))], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),(function (){var iter__4582__auto__ = (function athens$devcards$block_page$block_page_el_$_iter__65560(s__65561){
return (new cljs.core.LazySeq(null,(function (){
var s__65561__$1 = s__65561;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__65561__$1);
if(temp__5735__auto__){
var s__65561__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__65561__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__65561__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__65563 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__65562 = (0);
while(true){
if((i__65562 < size__4581__auto__)){
var child = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__65562);
cljs.core.chunk_append(b__65563,(function (){var map__65564 = child;
...
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65564__$1,new cljs.core.Keyword("db","id","db/id",-1388397098));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__65563),athens$devcards$block_page$block_page_el_$_iter__65560(cljs.core.chunk_rest(s__65561__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__65563),null);
}
} else {
var child = cljs.core.first(s__65561__$2);
return cljs.core.cons((function (){var map__65566 = child;
var map__65566__$1 = (((((!((map__65566 == null))))?(((((map__65566.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__65566.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__65566):map__65566);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65566__$1,new cljs.core.Keyword("db","id","db/id",-1388397098));
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.blocks.block_el,child], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null));
})(),athens$devcards$block_page$block_page_el_$_iter__65560(cljs.core.rest(s__65561__$2)));
}
} else {
return null;
}
...
var editing_uid = cljs.core.deref((function (){var G__65568 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"editing-uid","editing-uid",1372614377)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__65568) : re_frame.core.subscribe.call(null,G__65568));
})());
