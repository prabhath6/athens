...
var string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53647__$1,new cljs.core.Keyword("block","string","block/string",-2066596447));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53647__$1,new cljs.core.Keyword("block","children","block/children",-1040716209));
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"color","color",1011675173),"gray"], null)], null),cljs.core.interpose.cljs$core$IFn$_invoke$arity$2(" > ",(function (){var iter__4582__auto__ = (function athens$devcards$block_page$block_page_el_$_iter__53649(s__53650){
return (new cljs.core.LazySeq(null,(function (){
var s__53650__$1 = s__53650;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__53650__$1);
if(temp__5735__auto__){
var s__53650__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__53650__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__53650__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__53652 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__53651 = (0);
while(true){
if((i__53651 < size__4581__auto__)){
var p = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__53651);
cljs.core.chunk_append(b__53652,(function (){var map__53653 = p;
var map__53653__$1 = (((((!((map__53653 == null))))?(((((map__53653.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__53653.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__53653):map__53653);
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53653__$1,new cljs.core.Keyword("node","title","node/title",628940777));
var uid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53653__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
var string__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53653__$1,new cljs.core.Keyword("block","string","block/string",-2066596447));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),uid,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"cursor","cursor",1011937484),"pointer"], null),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__53651,map__53653,map__53653__$1,title,uid,string__$1,p,c__4580__auto__,size__4581__auto__,b__53652,s__53650__$2,temp__5735__auto__,map__53647,map__53647__$1,string,children){
return (function (){
return athens.router.navigate_page(uid);
});})(i__53651,map__53653,map__53653__$1,title,uid,string__$1,p,c__4580__auto__,size__4581__auto__,b__53652,s__53650__$2,temp__5735__auto__,map__53647,map__53647__$1,string,children))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__53652),athens$devcards$block_page$block_page_el_$_iter__53649(cljs.core.chunk_rest(s__53650__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__53652),null);
}
} else {
var p = cljs.core.first(s__53650__$2);
return cljs.core.cons((function (){var map__53655 = p;
...
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53655__$1,new cljs.core.Keyword("node","title","node/title",628940777));
var uid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53655__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
var string__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53655__$1,new cljs.core.Keyword("block","string","block/string",-2066596447));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),uid,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"cursor","cursor",1011937484),"pointer"], null),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (map__53655,map__53655__$1,title,uid,string__$1,p,s__53650__$2,temp__5735__auto__,map__53647,map__53647__$1,string,children){
return (function (){
return athens.router.navigate_page(uid);
});})(map__53655,map__53655__$1,title,uid,string__$1,p,s__53650__$2,temp__5735__auto__,map__53647,map__53647__$1,string,children))
], null),(function (){var or__4185__auto__ = string__$1;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
...
})(),athens$devcards$block_page$block_page_el_$_iter__53649(cljs.core.rest(s__53650__$2)));
}
} else {
return null;
}
...
})())], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h1","h1",-1896887462),["\u2022 ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(string)].join('')], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),(function (){var iter__4582__auto__ = (function athens$devcards$block_page$block_page_el_$_iter__53659(s__53660){
return (new cljs.core.LazySeq(null,(function (){
...
var child = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__53661);
cljs.core.chunk_append(b__53662,(function (){var map__53663 = child;
...
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53663__$1,new cljs.core.Keyword("db","id","db/id",-1388397098));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__53662),athens$devcards$block_page$block_page_el_$_iter__53659(cljs.core.chunk_rest(s__53660__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__53662),null);
}
} else {
var child = cljs.core.first(s__53660__$2);
return cljs.core.cons((function (){var map__53665 = child;
var map__53665__$1 = (((((!((map__53665 == null))))?(((((map__53665.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__53665.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__53665):map__53665);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53665__$1,new cljs.core.Keyword("db","id","db/id",-1388397098));
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.blocks.block_el,child], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null));
})(),athens$devcards$block_page$block_page_el_$_iter__53659(cljs.core.rest(s__53660__$2)));
}
} else {
return null;
}
