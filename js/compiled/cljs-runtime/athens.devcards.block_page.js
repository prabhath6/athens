...
athens.devcards.block_page.block_page_el = (function athens$devcards$block_page$block_page_el(p__65617,parents,editing_uid){
var map__65618 = p__65617;
var map__65618__$1 = (((((!((map__65618 == null))))?(((((map__65618.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__65618.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__65618):map__65618);
var string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65618__$1,new cljs.core.Keyword("block","string","block/string",-2066596447));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65618__$1,new cljs.core.Keyword("block","children","block/children",-1040716209));
var uid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65618__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"color","color",1011675173),"gray"], null)], null),cljs.core.interpose.cljs$core$IFn$_invoke$arity$2(" > ",(function (){var iter__4582__auto__ = (function athens$devcards$block_page$block_page_el_$_iter__65620(s__65621){
return (new cljs.core.LazySeq(null,(function (){
var s__65621__$1 = s__65621;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__65621__$1);
if(temp__5735__auto__){
var s__65621__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__65621__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__65621__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__65623 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__65622 = (0);
while(true){
if((i__65622 < size__4581__auto__)){
var p = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__65622);
cljs.core.chunk_append(b__65623,(function (){var map__65624 = p;
var map__65624__$1 = (((((!((map__65624 == null))))?(((((map__65624.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__65624.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__65624):map__65624);
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65624__$1,new cljs.core.Keyword("node","title","node/title",628940777));
var uid__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65624__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
var string__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65624__$1,new cljs.core.Keyword("block","string","block/string",-2066596447));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),uid__$1,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"cursor","cursor",1011937484),"pointer"], null),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__65622,map__65624,map__65624__$1,title,uid__$1,string__$1,p,c__4580__auto__,size__4581__auto__,b__65623,s__65621__$2,temp__5735__auto__,map__65618,map__65618__$1,string,children,uid){
return (function (){
return athens.router.navigate_uid(uid__$1);
});})(i__65622,map__65624,map__65624__$1,title,uid__$1,string__$1,p,c__4580__auto__,size__4581__auto__,b__65623,s__65621__$2,temp__5735__auto__,map__65618,map__65618__$1,string,children,uid))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__65623),athens$devcards$block_page$block_page_el_$_iter__65620(cljs.core.chunk_rest(s__65621__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__65623),null);
}
} else {
var p = cljs.core.first(s__65621__$2);
return cljs.core.cons((function (){var map__65626 = p;
...
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65626__$1,new cljs.core.Keyword("node","title","node/title",628940777));
var uid__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65626__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
var string__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65626__$1,new cljs.core.Keyword("block","string","block/string",-2066596447));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),uid__$1,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"cursor","cursor",1011937484),"pointer"], null),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (map__65626,map__65626__$1,title,uid__$1,string__$1,p,s__65621__$2,temp__5735__auto__,map__65618,map__65618__$1,string,children,uid){
return (function (){
return athens.router.navigate_uid(uid__$1);
});})(map__65626,map__65626__$1,title,uid__$1,string__$1,p,s__65621__$2,temp__5735__auto__,map__65618,map__65618__$1,string,children,uid))
], null),(function (){var or__4185__auto__ = string__$1;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
...
})(),athens$devcards$block_page$block_page_el_$_iter__65620(cljs.core.rest(s__65621__$2)));
}
} else {
return null;
}
...
var G__65629 = athens.db.dsdb;
var G__65630 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","add","db/add",235286841),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),uid], null),new cljs.core.Keyword("block","string","block/string",-2066596447),e.target.value], null)], null);
return (posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2 ? posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2(G__65629,G__65630) : posh.reagent.transact_BANG_.call(null,G__65629,G__65630));
})], null)], null)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h1","h1",-1896887462),["\u2022 ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(string)].join('')], null))], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),(function (){var iter__4582__auto__ = (function athens$devcards$block_page$block_page_el_$_iter__65631(s__65632){
return (new cljs.core.LazySeq(null,(function (){
...
var c__4580__auto__ = cljs.core.chunk_first(s__65632__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__65634 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__65633 = (0);
while(true){
if((i__65633 < size__4581__auto__)){
var child = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__65633);
cljs.core.chunk_append(b__65634,(function (){var map__65635 = child;
...
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65635__$1,new cljs.core.Keyword("db","id","db/id",-1388397098));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__65634),athens$devcards$block_page$block_page_el_$_iter__65631(cljs.core.chunk_rest(s__65632__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__65634),null);
}
} else {
var child = cljs.core.first(s__65632__$2);
return cljs.core.cons((function (){var map__65637 = child;
var map__65637__$1 = (((((!((map__65637 == null))))?(((((map__65637.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__65637.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__65637):map__65637);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65637__$1,new cljs.core.Keyword("db","id","db/id",-1388397098));
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.blocks.block_el,child], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null));
})(),athens$devcards$block_page$block_page_el_$_iter__65631(cljs.core.rest(s__65632__$2)));
}
} else {
return null;
}
...
var editing_uid = cljs.core.deref((function (){var G__65639 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"editing-uid","editing-uid",1372614377)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__65639) : re_frame.core.subscribe.call(null,G__65639));
})());
