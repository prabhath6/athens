...
var G__53076_53103 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"init-rfdb","init-rfdb",-460710127)], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__53076_53103) : re_frame.core.dispatch.call(null,G__53076_53103));
...
var G__53077 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-athena","toggle-athena",102452770)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__53077) : re_frame.core.dispatch.call(null,G__53077));
...
var G__53104 = cljs.core.first(new cljs.core.Keyword("block","_children","block/_children",1128070632).cljs$core$IFn$_invoke$arity$1(b));
b = G__53104;
continue;
}
break;
...
var athena_QMARK_ = (function (){var G__53085 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"athena","athena",-1523991628)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__53085) : re_frame.core.subscribe.call(null,G__53085));
})();
...
var G__53086 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"pages","pages",-285406513),athens.devcards.athena.search_in_block_title(db,query)], null);
if(cljs.core.truth_(cljs.core.count(query))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__53086,new cljs.core.Keyword(null,"blocks","blocks",-610462153),athens.devcards.athena.search_in_block_content(db,query));
} else {
return G__53086;
}
}
...
var vec__53088 = cljs.core.deref(_STAR_match);
var query = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53088,(0),null);
var map__53091 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53088,(1),null);
...
var result = map__53091__$1;
var pages = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53091__$1,new cljs.core.Keyword(null,"pages","pages",-285406513));
var blocks = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53091__$1,new cljs.core.Keyword(null,"blocks","blocks",-610462153));
if(cljs.core.truth_(result)){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.devcards.athena.results_list_style),(function (){var iter__4582__auto__ = (function athens$devcards$athena$athena_$_iter__53093(s__53094){
return (new cljs.core.LazySeq(null,(function (){
var s__53094__$1 = s__53094;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__53094__$1);
if(temp__5735__auto__){
var s__53094__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__53094__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__53094__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__53096 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__53095 = (0);
while(true){
if((i__53095 < size__4581__auto__)){
var vec__53097 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__53095);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53097,(0),null);
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53097,(1),null);
cljs.core.chunk_append(b__53096,(function (){var parent = new cljs.core.Keyword("block","parent","block/parent",-918309064).cljs$core$IFn$_invoke$arity$1(x);
...
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.athena.result_style,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),i,new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__53095,parent,page_title,block_uid,block_string,vec__53097,i,x,c__4580__auto__,size__4581__auto__,b__53096,s__53094__$2,temp__5735__auto__,vec__53088,query,map__53091,map__53091__$1,result,pages,blocks,_STAR_cache,_STAR_match,db,athena_QMARK_,handler){
return (function (){
return athens.router.navigate_page(block_uid);
});})(i__53095,parent,page_title,block_uid,block_string,vec__53097,i,x,c__4580__auto__,size__4581__auto__,b__53096,s__53094__$2,temp__5735__auto__,vec__53088,query,map__53091,map__53091__$1,result,pages,blocks,_STAR_cache,_STAR_match,db,athena_QMARK_,handler))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__53096),athens$devcards$athena$athena_$_iter__53093(cljs.core.chunk_rest(s__53094__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__53096),null);
}
} else {
var vec__53100 = cljs.core.first(s__53094__$2);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53100,(0),null);
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53100,(1),null);
...
var block_string = new cljs.core.Keyword("block","string","block/string",-2066596447).cljs$core$IFn$_invoke$arity$1(x);
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.athena.result_style,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),i,new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (parent,page_title,block_uid,block_string,vec__53100,i,x,s__53094__$2,temp__5735__auto__,vec__53088,query,map__53091,map__53091__$1,result,pages,blocks,_STAR_cache,_STAR_match,db,athena_QMARK_,handler){
return (function (){
return athens.router.navigate_page(block_uid);
});})(parent,page_title,block_uid,block_string,vec__53100,i,x,s__53094__$2,temp__5735__auto__,vec__53088,query,map__53091,map__53091__$1,result,pages,blocks,_STAR_cache,_STAR_match,db,athena_QMARK_,handler))
], null)),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h4.title","h4.title",-103059385),stylefy.core.use_sub_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.athena.result_style,new cljs.core.Keyword(null,"title","title",636505583)),athens.devcards.athena.highlight_match(query,page_title)], null),(cljs.core.truth_(block_string)?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.preview","span.preview",391484430),stylefy.core.use_sub_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.athena.result_style,new cljs.core.Keyword(null,"preview","preview",451279890)),athens.devcards.athena.highlight_match(query,block_string)], null):null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.link-leader","span.link-leader",-227077341),stylefy.core.use_sub_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.athena.result_style,new cljs.core.Keyword(null,"link-leader","link-leader",-1261639700)),"->"], null)], null);
})(),athens$devcards$athena$athena_$_iter__53093(cljs.core.rest(s__53094__$2)));
}
} else {
return null;
}
