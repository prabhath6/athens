...
var G__52214_52249 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"init-rfdb","init-rfdb",-460710127)], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__52214_52249) : re_frame.core.dispatch.call(null,G__52214_52249));
...
var G__52223 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-athena","toggle-athena",102452770)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__52223) : re_frame.core.dispatch.call(null,G__52223));
...
var G__52225 = db;
var G__52226 = athens.devcards.athena.re_case_insensitive(query);
return (datascript.core.q.cljs$core$IFn$_invoke$arity$3 ? datascript.core.q.cljs$core$IFn$_invoke$arity$3(G__52224,G__52225,G__52226) : datascript.core.q.call(null,G__52224,G__52225,G__52226));
});
...
var G__52250 = cljs.core.first(new cljs.core.Keyword("block","_children","block/_children",1128070632).cljs$core$IFn$_invoke$arity$1(b));
b = G__52250;
continue;
}
break;
...
var athena_QMARK_ = (function (){var G__52231 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"athena","athena",-1523991628)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__52231) : re_frame.core.subscribe.call(null,G__52231));
})();
...
var G__52232 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"pages","pages",-285406513),athens.devcards.athena.search_in_block_title(db,query)], null);
if(cljs.core.truth_(cljs.core.count(query))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52232,new cljs.core.Keyword(null,"blocks","blocks",-610462153),athens.devcards.athena.search_in_block_content(db,query));
} else {
return G__52232;
}
}
...
var vec__52233 = cljs.core.deref(_STAR_match);
var query = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52233,(0),null);
var map__52236 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52233,(1),null);
...
var result = map__52236__$1;
var pages = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52236__$1,new cljs.core.Keyword(null,"pages","pages",-285406513));
var blocks = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52236__$1,new cljs.core.Keyword(null,"blocks","blocks",-610462153));
if(cljs.core.truth_(result)){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.devcards.athena.results_list_style),(function (){var iter__4582__auto__ = (function athens$devcards$athena$athena_$_iter__52238(s__52239){
return (new cljs.core.LazySeq(null,(function (){
var s__52239__$1 = s__52239;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__52239__$1);
if(temp__5735__auto__){
var s__52239__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__52239__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__52239__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__52241 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__52240 = (0);
while(true){
if((i__52240 < size__4581__auto__)){
var vec__52242 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__52240);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52242,(0),null);
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52242,(1),null);
cljs.core.chunk_append(b__52241,(function (){var parent = new cljs.core.Keyword("block","parent","block/parent",-918309064).cljs$core$IFn$_invoke$arity$1(x);
...
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.athena.result_style,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),i,new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__52240,parent,page_title,block_uid,block_string,vec__52242,i,x,c__4580__auto__,size__4581__auto__,b__52241,s__52239__$2,temp__5735__auto__,vec__52233,query,map__52236,map__52236__$1,result,pages,blocks,_STAR_cache,_STAR_match,db,athena_QMARK_,handler){
return (function (){
return athens.router.navigate_page(block_uid);
});})(i__52240,parent,page_title,block_uid,block_string,vec__52242,i,x,c__4580__auto__,size__4581__auto__,b__52241,s__52239__$2,temp__5735__auto__,vec__52233,query,map__52236,map__52236__$1,result,pages,blocks,_STAR_cache,_STAR_match,db,athena_QMARK_,handler))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__52241),athens$devcards$athena$athena_$_iter__52238(cljs.core.chunk_rest(s__52239__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__52241),null);
}
} else {
var vec__52246 = cljs.core.first(s__52239__$2);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52246,(0),null);
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52246,(1),null);
...
var block_string = new cljs.core.Keyword("block","string","block/string",-2066596447).cljs$core$IFn$_invoke$arity$1(x);
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.athena.result_style,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),i,new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (parent,page_title,block_uid,block_string,vec__52246,i,x,s__52239__$2,temp__5735__auto__,vec__52233,query,map__52236,map__52236__$1,result,pages,blocks,_STAR_cache,_STAR_match,db,athena_QMARK_,handler){
return (function (){
return athens.router.navigate_page(block_uid);
});})(parent,page_title,block_uid,block_string,vec__52246,i,x,s__52239__$2,temp__5735__auto__,vec__52233,query,map__52236,map__52236__$1,result,pages,blocks,_STAR_cache,_STAR_match,db,athena_QMARK_,handler))
], null)),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h4.title","h4.title",-103059385),stylefy.core.use_sub_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.athena.result_style,new cljs.core.Keyword(null,"title","title",636505583)),athens.devcards.athena.highlight_match(query,page_title)], null),(cljs.core.truth_(block_string)?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.preview","span.preview",391484430),stylefy.core.use_sub_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.athena.result_style,new cljs.core.Keyword(null,"preview","preview",451279890)),athens.devcards.athena.highlight_match(query,block_string)], null):null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.link-leader","span.link-leader",-227077341),stylefy.core.use_sub_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.athena.result_style,new cljs.core.Keyword(null,"link-leader","link-leader",-1261639700)),"->"], null)], null);
})(),athens$devcards$athena$athena_$_iter__52238(cljs.core.rest(s__52239__$2)));
}
} else {
return null;
}
