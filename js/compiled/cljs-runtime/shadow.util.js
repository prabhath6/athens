...
var len__4789__auto___57638 = arguments.length;
var i__4790__auto___57639 = (0);
while(true){
if((i__4790__auto___57639 < len__4789__auto___57638)){
args__4795__auto__.push((arguments[i__4790__auto___57639]));

var G__57640 = (i__4790__auto___57639 + (1));
i__4790__auto___57639 = G__57640;
continue;
} else {
}
break;
...
/** @this {Function} */
(shadow.util.go_BANG_.cljs$lang$applyTo = (function (seq57586){
...
args_arr__4810__auto__.push((arguments[i__4790__auto___57643]));

var G__57645 = (i__4790__auto___57643 + (1));
i__4790__auto___57643 = G__57645;
continue;
} else {
}
break;
...
/** @this {Function} */
(shadow.util.log.cljs$lang$applyTo = (function (seq57594){
var G__57595 = cljs.core.first(seq57594);
var seq57594__$1 = cljs.core.next(seq57594);
var G__57596 = cljs.core.first(seq57594__$1);
var seq57594__$2 = cljs.core.next(seq57594__$1);
var G__57597 = cljs.core.first(seq57594__$2);
var seq57594__$3 = cljs.core.next(seq57594__$2);
var G__57598 = cljs.core.first(seq57594__$3);
var seq57594__$4 = cljs.core.next(seq57594__$3);
var G__57599 = cljs.core.first(seq57594__$4);
var seq57594__$5 = cljs.core.next(seq57594__$4);
var G__57601 = cljs.core.first(seq57594__$5);
var seq57594__$6 = cljs.core.next(seq57594__$5);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57595,G__57596,G__57597,G__57598,G__57599,G__57601,seq57594__$6);
}));

(shadow.util.log.cljs$lang$maxFixedArity = (6));

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__57622){
var vec__57624 = p__57622;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57624,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57624,(1),null);
