...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__52562_SHARP_){
return (((beginning <= new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__52562_SHARP_))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__52562_SHARP_) <= ending)));
}));
});
...
var G__52575 = new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(trace);
...
return ((cljs.core.not_any_QMARK_((function (p1__52591_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("sub","dispose","sub/dispose",365440536),p1__52591_SHARP_);
...
return cljs.core.assoc_in(state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"operation","operation",-1267664310).cljs$core$IFn$_invoke$arity$1(trace),new cljs.core.Keyword(null,"layer","layer",-1601820589)], null),(cljs.core.truth_(cljs.core.some((function (p1__52612_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(app_db_id,p1__52612_SHARP_);
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (me__$1){
if(cljs.core.truth_(new cljs.core.Keyword(null,"disposed?","disposed?",1178302522).cljs$core$IFn$_invoke$arity$1(cljs.core.val(me__$1)))){
return null;
} else {
return me__$1;
}
})),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__52613){
var vec__52614 = p__52613;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52614,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52614,(1),null);
...
var new_state = (function (){var G__52617 = new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(trace);
var G__52617__$1 = (((G__52617 instanceof cljs.core.Keyword))?G__52617.fqn:null);
switch (G__52617__$1) {
case "sub/create":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__52617__$1)].join('')));
...
var second_pass = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (all_state,p__52620){
var vec__52621 = p__52620;
var sub_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52621,(0),null);
var sub_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52621,(1),null);
