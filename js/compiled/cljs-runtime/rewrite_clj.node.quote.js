...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k29882,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k29882,else__4442__auto__);
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__29881){
var self__ = this;
var G__29881__$1 = this;
return (new cljs.core.RecordIter((0),G__29881__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this29883,other29884){
var self__ = this;
var this29883__$1 = this;
return (((!((other29884 == null)))) && ((this29883__$1.constructor === other29884.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29883__$1.tag,other29884.tag)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29883__$1.prefix,other29884.prefix)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29883__$1.sym,other29884.sym)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29883__$1.children,other29884.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29883__$1.__extmap,other29884.__extmap)));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__29881){
var self__ = this;
...
return (new rewrite_clj.node.quote.QuoteNode(G__29881,self__.prefix,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
...
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,G__29881,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
...
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,G__29881,self__.children,self__.__meta,self__.__extmap,null));
} else {
...
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,G__29881,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__29881),null));
}
}
}
}
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__29881){
var self__ = this;
var this__4438__auto____$1 = this;
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,G__29881,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.quote.map__GT_QuoteNode = (function rewrite_clj$node$quote$map__GT_QuoteNode(G__29885){
var extmap__4478__auto__ = (function (){var G__29918 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__29885,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
...
return (new rewrite_clj.node.quote.QuoteNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__29885),new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__29885),new cljs.core.Keyword(null,"sym","sym",-1444860305).cljs$core$IFn$_invoke$arity$1(G__29885),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__29885),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
