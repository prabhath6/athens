...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k29877,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k29877,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__29887){
var vec__29888 = p__29887;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29888,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29888,(1),null);
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__29876){
var self__ = this;
var G__29876__$1 = this;
return (new cljs.core.RecordIter((0),G__29876__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var h__4297__auto____$1 = (function (){var fexpr__29898 = (function (coll__4436__auto__){
return (1712251858 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__29898(this__4435__auto____$1);
})();
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this29878,other29879){
var self__ = this;
var this29878__$1 = this;
return (((!((other29879 == null)))) && ((this29878__$1.constructor === other29879.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29878__$1.tag,other29879.tag)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29878__$1.prefix,other29879.prefix)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29878__$1.sym,other29879.sym)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29878__$1.children,other29879.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29878__$1.__extmap,other29879.__extmap)));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__29876){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__29906 = cljs.core.keyword_identical_QMARK_;
var expr__29907 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__29909 = new cljs.core.Keyword(null,"tag","tag",-1290361223);
...
return (new rewrite_clj.node.quote.QuoteNode(G__29876,self__.prefix,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__29912 = new cljs.core.Keyword(null,"prefix","prefix",-265908465);
var G__29913 = expr__29907;
return (pred__29906.cljs$core$IFn$_invoke$arity$2 ? pred__29906.cljs$core$IFn$_invoke$arity$2(G__29912,G__29913) : pred__29906.call(null,G__29912,G__29913));
})())){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,G__29876,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__29914 = new cljs.core.Keyword(null,"sym","sym",-1444860305);
var G__29915 = expr__29907;
return (pred__29906.cljs$core$IFn$_invoke$arity$2 ? pred__29906.cljs$core$IFn$_invoke$arity$2(G__29914,G__29915) : pred__29906.call(null,G__29914,G__29915));
})())){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,G__29876,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__29916 = new cljs.core.Keyword(null,"children","children",-940561982);
var G__29917 = expr__29907;
return (pred__29906.cljs$core$IFn$_invoke$arity$2 ? pred__29906.cljs$core$IFn$_invoke$arity$2(G__29916,G__29917) : pred__29906.call(null,G__29916,G__29917));
})())){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,G__29876,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__29876),null));
}
}
}
}
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__29876){
var self__ = this;
var this__4438__auto____$1 = this;
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,G__29876,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.quote.map__GT_QuoteNode = (function rewrite_clj$node$quote$map__GT_QuoteNode(G__29884){
var extmap__4478__auto__ = (function (){var G__29918 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__29884,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__29884)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__29918);
} else {
return G__29918;
}
})();
return (new rewrite_clj.node.quote.QuoteNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__29884),new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__29884),new cljs.core.Keyword(null,"sym","sym",-1444860305).cljs$core$IFn$_invoke$arity$1(G__29884),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__29884),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var G__29928 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__29928;
continue;
}
break;
...
var G__29930 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__29930;
continue;
}
break;
...
var G__29932 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__29932;
continue;
}
break;
...
var G__29936 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__29936;
continue;
}
break;
