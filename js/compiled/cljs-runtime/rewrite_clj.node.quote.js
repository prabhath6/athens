...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k29875,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k29875,else__4442__auto__);
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__29874){
var self__ = this;
var G__29874__$1 = this;
return (new cljs.core.RecordIter((0),G__29874__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this29876,other29877){
var self__ = this;
var this29876__$1 = this;
return (((!((other29877 == null)))) && ((this29876__$1.constructor === other29877.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29876__$1.tag,other29877.tag)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29876__$1.prefix,other29877.prefix)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29876__$1.sym,other29877.sym)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29876__$1.children,other29877.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29876__$1.__extmap,other29877.__extmap)));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__29874){
var self__ = this;
...
return (new rewrite_clj.node.quote.QuoteNode(G__29874,self__.prefix,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
...
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,G__29874,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
...
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,G__29874,self__.children,self__.__meta,self__.__extmap,null));
} else {
...
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,G__29874,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__29874),null));
}
}
}
}
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__29874){
var self__ = this;
var this__4438__auto____$1 = this;
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,G__29874,self__.__extmap,self__.__hash));
}));
