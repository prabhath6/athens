...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k29896,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k29896,else__4442__auto__);
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__29895){
var self__ = this;
var G__29895__$1 = this;
return (new cljs.core.RecordIter((0),G__29895__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this29897,other29898){
var self__ = this;
var this29897__$1 = this;
return (((!((other29898 == null)))) && ((this29897__$1.constructor === other29898.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29897__$1.tag,other29898.tag)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29897__$1.prefix,other29898.prefix)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29897__$1.sym,other29898.sym)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29897__$1.children,other29898.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29897__$1.__extmap,other29898.__extmap)));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__29895){
var self__ = this;
...
return (new rewrite_clj.node.quote.QuoteNode(G__29895,self__.prefix,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
...
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,G__29895,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
...
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,G__29895,self__.children,self__.__meta,self__.__extmap,null));
} else {
...
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,G__29895,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__29895),null));
}
}
}
}
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__29895){
var self__ = this;
var this__4438__auto____$1 = this;
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,G__29895,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.quote.map__GT_QuoteNode = (function rewrite_clj$node$quote$map__GT_QuoteNode(G__29899){
var extmap__4478__auto__ = (function (){var G__29921 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__29899,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__29899)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__29921);
} else {
return G__29921;
}
})();
return (new rewrite_clj.node.quote.QuoteNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__29899),new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__29899),new cljs.core.Keyword(null,"sym","sym",-1444860305).cljs$core$IFn$_invoke$arity$1(G__29899),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__29899),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var G__29937 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__29937;
continue;
}
break;
