...
(garden.color.rgba.cljs$core$IFn$_invoke$arity$1 = (function (p__35301){
var vec__35303 = p__35301;
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35303,(0),null);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35303,(1),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35303,(2),null);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35303,(3),null);
if(garden.util.between_QMARK_(a,(0),(1))){
var G__35307 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(garden.color.rgb.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [r,g,b], null)),new cljs.core.Keyword(null,"alpha","alpha",-1574982441),a);
return (garden.color.as_color.cljs$core$IFn$_invoke$arity$1 ? garden.color.as_color.cljs$core$IFn$_invoke$arity$1(G__35307) : garden.color.as_color.call(null,G__35307));
} else {
...
(garden.color.hsl.cljs$core$IFn$_invoke$arity$1 = (function (p__35316){
var vec__35319 = p__35316;
var h = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35319,(0),null);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35319,(1),null);
var l = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35319,(2),null);
var vec__35323 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__35310_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(p1__35310_SHARP_,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222),p1__35310_SHARP_);
}),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [h,s,l], null));
var h__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35323,(0),null);
var s__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35323,(1),null);
var l__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35323,(2),null);
if(((garden.util.between_QMARK_(s__$1,(0),(100))) && (garden.util.between_QMARK_(l__$1,(0),(100))))){
var G__35328 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"hue","hue",-508078848),cljs.core.mod(h__$1,(360)),new cljs.core.Keyword(null,"saturation","saturation",-14247929),s__$1,new cljs.core.Keyword(null,"lightness","lightness",-2040901930),l__$1], null);
return (garden.color.as_color.cljs$core$IFn$_invoke$arity$1 ? garden.color.as_color.cljs$core$IFn$_invoke$arity$1(G__35328) : garden.color.as_color.call(null,G__35328));
} else {
...
(garden.color.hsla.cljs$core$IFn$_invoke$arity$1 = (function (p__35345){
var vec__35349 = p__35345;
var h = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35349,(0),null);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35349,(1),null);
var l = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35349,(2),null);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35349,(3),null);
if(garden.util.between_QMARK_(a,(0),(1))){
var G__35355 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(garden.color.hsl.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [h,s,l], null)),new cljs.core.Keyword(null,"alpha","alpha",-1574982441),a);
return (garden.color.as_color.cljs$core$IFn$_invoke$arity$1 ? garden.color.as_color.cljs$core$IFn$_invoke$arity$1(G__35355) : garden.color.as_color.call(null,G__35355));
} else {
throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2("Alpha value must be between 0 and 1",cljs.core.PersistentArrayMap.EMPTY);
}
}));
...
var vec__35393 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__35385_SHARP_){
return (p1__35385_SHARP_ / (255));
 ...
 */
garden.color.hsl__GT_rgb = (function garden$color$hsl__GT_rgb(p__35400){
...
var color = map__35401__$1;
var hue = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35401__$1,new cljs.core.Keyword(null,"hue","hue",-508078848));
var saturation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35401__$1,new cljs.core.Keyword(null,"saturation","saturation",-14247929));
var lightness = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35401__$1,new cljs.core.Keyword(null,"lightness","lightness",-2040901930));
...
var m1 = (((2) * l) - m2);
var vec__35404 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__35399_SHARP_){
return ((0.5 + (p1__35399_SHARP_ * (255))) | (0));
...
})(),(garden.color.hue__GT_rgb.cljs$core$IFn$_invoke$arity$3 ? garden.color.hue__GT_rgb.cljs$core$IFn$_invoke$arity$3(m1,m2,h) : garden.color.hue__GT_rgb.call(null,m1,m2,h)),(function (){var G__35410 = m1;
var G__35411 = m2;
var G__35412 = (h - (1.0 / (3)));
return (garden.color.hue__GT_rgb.cljs$core$IFn$_invoke$arity$3 ? garden.color.hue__GT_rgb.cljs$core$IFn$_invoke$arity$3(G__35410,G__35411,G__35412) : garden.color.hue__GT_rgb.call(null,G__35410,G__35411,G__35412));
})()], null));
...
var G__35426 = cljs.core.merge_with.cljs$core$IFn$_invoke$arity$variadic(o,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([a__$1,b__$1], 0));
...
var G__35620__delegate = function (a,b,more){
...
var G__35620 = function (a,b,var_args){
var more = null;
if (arguments.length > 2) {
var G__35621__i = 0, G__35621__a = new Array(arguments.length -  2);
while (G__35621__i < G__35621__a.length) {G__35621__a[G__35621__i] = arguments[G__35621__i + 2]; ++G__35621__i;}
  more = new cljs.core.IndexedSeq(G__35621__a,0,null);
} 
return G__35620__delegate.call(this,a,b,more);};
G__35620.cljs$lang$maxFixedArity = 2;
G__35620.cljs$lang$applyTo = (function (arglist__35622){
var a = cljs.core.first(arglist__35622);
arglist__35622 = cljs.core.next(arglist__35622);
var b = cljs.core.first(arglist__35622);
var more = cljs.core.rest(arglist__35622);
return G__35620__delegate(a,b,more);
});
...
var G__35623 = null;
if (arguments.length > 2) {
var G__35624__i = 0, G__35624__a = new Array(arguments.length -  2);
while (G__35624__i < G__35624__a.length) {G__35624__a[G__35624__i] = arguments[G__35624__i + 2]; ++G__35624__i;}
G__35623 = new cljs.core.IndexedSeq(G__35624__a,0,null);
}
return garden$color$make_color_operation_$_color_op__3.cljs$core$IFn$_invoke$arity$variadic(a,b, G__35623);
}
...
return garden.color.update_hsla_field(color,new cljs.core.Keyword(null,"hue","hue",-508078848),cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__35431_SHARP_){
return cljs.core.mod(p1__35431_SHARP_,(360));
...
var G__35451 = cljs.core.merge_with.cljs$core$IFn$_invoke$arity$variadic(cljs.core._,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"red","red",-969428204),(255),new cljs.core.Keyword(null,"green","green",-945526839),(255),new cljs.core.Keyword(null,"blue","blue",-622100620),(255)], null),garden.color.as_rgb(color)], 0));
return (garden.color.as_color.cljs$core$IFn$_invoke$arity$1 ? garden.color.as_color.cljs$core$IFn$_invoke$arity$1(G__35451) : garden.color.as_color.call(null,G__35451));
});
/**
...
var G__35462 = cljs.core.merge_with.cljs$core$IFn$_invoke$arity$variadic(garden.util.average,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c1,c2], 0));
return (garden.color.as_color.cljs$core$IFn$_invoke$arity$1 ? garden.color.as_color.cljs$core$IFn$_invoke$arity$1(G__35462) : garden.color.as_color.call(null,G__35462));
}));
...
/** @this {Function} */
(garden.color.mix.cljs$lang$applyTo = (function (seq35454){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__35455,G__35456,seq35454__$2);
}));
...
/** @this {Function} */
(garden.color.hue_rotations.cljs$lang$applyTo = (function (seq35474){
...
var iter__4582__auto__ = (function garden$color$iter__35502(s__35503){
return (new cljs.core.LazySeq(null,(function (){
var s__35503__$1 = s__35503;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__35503__$1);
if(temp__5735__auto__){
var s__35503__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__35503__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__35503__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__35505 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__35504 = (0);
while(true){
if((i__35504 < size__4581__auto__)){
var i = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__35504);
cljs.core.chunk_append(b__35505,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(c,new cljs.core.Keyword(null,"lightness","lightness",-2040901930),(i * step)));

var G__35642 = (i__35504 + (1));
i__35504 = G__35642;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__35505),garden$color$iter__35502(cljs.core.chunk_rest(s__35503__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__35505),null);
}
} else {
var i = cljs.core.first(s__35503__$2);
return cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(c,new cljs.core.Keyword(null,"lightness","lightness",-2040901930),(i * step)),garden$color$iter__35502(cljs.core.rest(s__35503__$2)));
}
} else {
return null;
}
...
var G__35542 = (p1__35538_SHARP_ * ((1) + (p2__35539_SHARP_ / (100))));
return (garden.color.zero_to_one_clip.cljs$core$IFn$_invoke$arity$1 ? garden.color.zero_to_one_clip.cljs$core$IFn$_invoke$arity$1(G__35542) : garden.color.zero_to_one_clip.call(null,G__35542));
}),amount);
});
...
var vec__35557 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__35556_SHARP_){
return (p1__35556_SHARP_ / (100));
}),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [((100) - weight),weight], null));
var weight_1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35557,(0),null);
var weight_2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35557,(1),null);
var vec__35560 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2(garden.color.hex__GT_long,garden.color.as_hex),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [color_1,color_2], null));
var long_1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35560,(0),null);
var long_2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35560,(1),null);
