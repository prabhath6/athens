...
return [(function (){var pred__27367 = cljs.core.instance_QMARK_;
var expr__27368 = reactive_val;
if(cljs.core.truth_((pred__27367.cljs$core$IFn$_invoke$arity$2 ? pred__27367.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.RAtom,expr__27368) : pred__27367.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.RAtom,expr__27368)))){
return "ra";
} else {
if(cljs.core.truth_((pred__27367.cljs$core$IFn$_invoke$arity$2 ? pred__27367.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.RCursor,expr__27368) : pred__27367.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.RCursor,expr__27368)))){
return "rc";
} else {
if(cljs.core.truth_((pred__27367.cljs$core$IFn$_invoke$arity$2 ? pred__27367.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.Reaction,expr__27368) : pred__27367.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.Reaction,expr__27368)))){
return "rx";
} else {
if(cljs.core.truth_((pred__27367.cljs$core$IFn$_invoke$arity$2 ? pred__27367.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.Track,expr__27368) : pred__27367.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.Track,expr__27368)))){
return "tr";
} else {
return "other";
}
