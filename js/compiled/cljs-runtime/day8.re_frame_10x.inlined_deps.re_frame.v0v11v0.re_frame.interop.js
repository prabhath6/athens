...
return [(function (){var pred__27362 = cljs.core.instance_QMARK_;
var expr__27363 = reactive_val;
if(cljs.core.truth_((pred__27362.cljs$core$IFn$_invoke$arity$2 ? pred__27362.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.RAtom,expr__27363) : pred__27362.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.RAtom,expr__27363)))){
return "ra";
} else {
if(cljs.core.truth_((pred__27362.cljs$core$IFn$_invoke$arity$2 ? pred__27362.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.RCursor,expr__27363) : pred__27362.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.RCursor,expr__27363)))){
return "rc";
} else {
if(cljs.core.truth_((pred__27362.cljs$core$IFn$_invoke$arity$2 ? pred__27362.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.Reaction,expr__27363) : pred__27362.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.Reaction,expr__27363)))){
return "rx";
} else {
if(cljs.core.truth_((pred__27362.cljs$core$IFn$_invoke$arity$2 ? pred__27362.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.Track,expr__27363) : pred__27362.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.Track,expr__27363)))){
return "tr";
} else {
return "other";
}
