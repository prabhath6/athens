...
var G__46863 = cljs.core.rest(eav);
var G__46864 = (n - (1));
var G__46865 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(neweav,cljs.core.first(eav));
var G__46866 = vars;
return (posh.lib.q_analyze.normalize_eav_helper.cljs$core$IFn$_invoke$arity$4 ? posh.lib.q_analyze.normalize_eav_helper.cljs$core$IFn$_invoke$arity$4(G__46863,G__46864,G__46865,G__46866) : posh.lib.q_analyze.normalize_eav_helper.call(null,G__46863,G__46864,G__46865,G__46866));
} else {
...
var G__46869 = cljs.core.rest(eav);
var G__46870 = (n - (1));
var G__46871 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(neweav,var$);
var G__46872 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(vars,var$);
return (posh.lib.q_analyze.normalize_eav_helper.cljs$core$IFn$_invoke$arity$4 ? posh.lib.q_analyze.normalize_eav_helper.cljs$core$IFn$_invoke$arity$4(G__46869,G__46870,G__46871,G__46872) : posh.lib.q_analyze.normalize_eav_helper.call(null,G__46869,G__46870,G__46871,G__46872));
}
}
});
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(where),cljs.core.second(where)], null),(function (){var G__46881 = cljs.core.vec(cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),where));
return (posh.lib.q_analyze.normalize_all_eavs.cljs$core$IFn$_invoke$arity$1 ? posh.lib.q_analyze.normalize_all_eavs.cljs$core$IFn$_invoke$arity$1(G__46881) : posh.lib.q_analyze.normalize_all_eavs.call(null,G__46881));
})());
} else {
return cljs.core.cons(cljs.core.first(where),(function (){var G__46882 = cljs.core.vec(cljs.core.rest(where));
return (posh.lib.q_analyze.normalize_all_eavs.cljs$core$IFn$_invoke$arity$1 ? posh.lib.q_analyze.normalize_all_eavs.cljs$core$IFn$_invoke$arity$1(G__46882) : posh.lib.q_analyze.normalize_all_eavs.call(null,G__46882));
})());
}
} else {
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2((function (){var G__46885 = cljs.core.vec(cljs.core.rest(where));
...
})(),(function (){var G__46886 = cljs.core.vec(cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),item));
return (posh.lib.q_analyze.get_eavs.cljs$core$IFn$_invoke$arity$1 ? posh.lib.q_analyze.get_eavs.cljs$core$IFn$_invoke$arity$1(G__46886) : posh.lib.q_analyze.get_eavs.call(null,G__46886));
})());
} else {
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2((function (){var G__46887 = cljs.core.vec(cljs.core.rest(where));
return (posh.lib.q_analyze.get_eavs.cljs$core$IFn$_invoke$arity$1 ? posh.lib.q_analyze.get_eavs.cljs$core$IFn$_invoke$arity$1(G__46887) : posh.lib.q_analyze.get_eavs.call(null,G__46887));
})(),(function (){var G__46888 = cljs.core.vec(cljs.core.rest(item));
return (posh.lib.q_analyze.get_eavs.cljs$core$IFn$_invoke$arity$1 ? posh.lib.q_analyze.get_eavs.cljs$core$IFn$_invoke$arity$1(G__46888) : posh.lib.q_analyze.get_eavs.call(null,G__46888));
})());
}
} else {
if(posh.lib.q_analyze.eav_QMARK_(item)){
return cljs.core.cons(item,(function (){var G__46889 = cljs.core.rest(where);
return (posh.lib.q_analyze.get_eavs.cljs$core$IFn$_invoke$arity$1 ? posh.lib.q_analyze.get_eavs.cljs$core$IFn$_invoke$arity$1(G__46889) : posh.lib.q_analyze.get_eavs.call(null,G__46889));
})());
} else {
if(((cljs.core.vector_QMARK_(item)) && (cljs.core.seq_QMARK_(cljs.core.first(item))))){
var ocr_46890 = cljs.core.vec(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.vec(cljs.core.first(item))], null),cljs.core.rest(item)));
try{if(((cljs.core.vector_QMARK_(ocr_46890)) && ((cljs.core.count(ocr_46890) === 2)))){
try{var ocr_46890_0__46893 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(ocr_46890,(0));
if(((cljs.core.vector_QMARK_(ocr_46890_0__46893)) && ((cljs.core.count(ocr_46890_0__46893) === 5)))){
try{var ocr_46890_0__46893_0__46895 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(ocr_46890_0__46893,(0));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(ocr_46890_0__46893_0__46895,new cljs.core.Symbol(null,"get-else","get-else",1312024065,null))){
var db = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(ocr_46890_0__46893,(1));
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(ocr_46890_0__46893,(2));
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(ocr_46890_0__46893,(3));
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(ocr_46890,(1));
...
var G__47325 = var$;
var G__47326 = dbvarmap;
var G__47327 = cljs.core.rest(dbeavs);
var$ = G__47325;
dbvarmap = G__47326;
dbeavs = G__47327;
continue;
...
var G__47331 = (n + (1));
var G__47332 = cljs.core.rest(xs__$1);
n = G__47331;
xs__$1 = G__47332;
continue;
...
var G__47344 = cljs.core.first(remaining);
var G__47345 = cljs.core.rest(remaining);
clause = G__47344;
remaining = G__47345;
continue;
} else {
