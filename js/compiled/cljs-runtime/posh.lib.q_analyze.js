...
var G__46856 = cljs.core.rest(eav);
var G__46857 = (n - (1));
var G__46858 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(neweav,var$);
var G__46859 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(vars,var$);
return (posh.lib.q_analyze.normalize_eav_helper.cljs$core$IFn$_invoke$arity$4 ? posh.lib.q_analyze.normalize_eav_helper.cljs$core$IFn$_invoke$arity$4(G__46856,G__46857,G__46858,G__46859) : posh.lib.q_analyze.normalize_eav_helper.call(null,G__46856,G__46857,G__46858,G__46859));
}
}
});
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(where),cljs.core.second(where)], null),(function (){var G__46863 = cljs.core.vec(cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),where));
return (posh.lib.q_analyze.normalize_all_eavs.cljs$core$IFn$_invoke$arity$1 ? posh.lib.q_analyze.normalize_all_eavs.cljs$core$IFn$_invoke$arity$1(G__46863) : posh.lib.q_analyze.normalize_all_eavs.call(null,G__46863));
})());
} else {
return cljs.core.cons(cljs.core.first(where),(function (){var G__46866 = cljs.core.vec(cljs.core.rest(where));
return (posh.lib.q_analyze.normalize_all_eavs.cljs$core$IFn$_invoke$arity$1 ? posh.lib.q_analyze.normalize_all_eavs.cljs$core$IFn$_invoke$arity$1(G__46866) : posh.lib.q_analyze.normalize_all_eavs.call(null,G__46866));
})());
}
} else {
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2((function (){var G__46875 = cljs.core.vec(cljs.core.rest(where));
...
})(),(function (){var G__46876 = cljs.core.vec(cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),item));
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2((function (){var G__46880 = cljs.core.vec(cljs.core.rest(where));
return (posh.lib.q_analyze.get_eavs.cljs$core$IFn$_invoke$arity$1 ? posh.lib.q_analyze.get_eavs.cljs$core$IFn$_invoke$arity$1(G__46880) : posh.lib.q_analyze.get_eavs.call(null,G__46880));
})(),(function (){var G__46883 = cljs.core.vec(cljs.core.rest(item));
...
return cljs.core.cons(item,(function (){var G__46884 = cljs.core.rest(where);
