...
if((c === "\n")){
var G__49718 = escape_QMARK_;
var G__49719 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__49718;
lines = G__49719;
continue;
} else {
buf.append(c);

var G__49720 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__49721 = lines;
escape_QMARK_ = G__49720;
lines = G__49721;
continue;
...
var G__49715 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__49715) : rewrite_clj.node.string_node.call(null,G__49715));
});
...
var G__49716 = cljs.core.re_pattern(regex);
var G__49717 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__49716,G__49717) : rewrite_clj.node.token_node.call(null,G__49716,G__49717));
});
