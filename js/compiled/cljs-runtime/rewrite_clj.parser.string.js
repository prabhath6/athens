...
if((c === "\n")){
var G__30235 = escape_QMARK_;
var G__30236 = rewrite_clj.parser.string.flush_into(lines,buf);
...
var G__30237 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__30238 = lines;
escape_QMARK_ = G__30237;
lines = G__30238;
continue;
...
var G__30230 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__30230) : rewrite_clj.node.string_node.call(null,G__30230));
});
...
var G__30233 = cljs.core.re_pattern(regex);
var G__30234 = ["#\"",regex,"\""].join('');
