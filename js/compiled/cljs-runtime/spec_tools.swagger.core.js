...
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.swagger.core","default","spec-tools.swagger.core/default",1361779456)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__75801 = cljs.core.get_global_hierarchy;
return (fexpr__75801.cljs$core$IFn$_invoke$arity$0 ? fexpr__75801.cljs$core$IFn$_invoke$arity$0() : fexpr__75801.call(null));
})());
...
spec_tools.swagger.core.accept_spec.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),(function (_,___$1,children,p__75804){
var map__75805 = p__75804;
var map__75805__$1 = (((((!((map__75805 == null))))?(((((map__75805.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__75805.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__75805):map__75805);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75805__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75805__$1,new cljs.core.Keyword(null,"in","in",-1531184865));
...
var vec__75807 = spec_tools.impl.extract_form(spec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75807,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75807,(1),null);
...
var method_cache__4674__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4675__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__75813 = cljs.core.get_global_hierarchy;
return (fexpr__75813.cljs$core$IFn$_invoke$arity$0 ? fexpr__75813.cljs$core$IFn$_invoke$arity$0() : fexpr__75813.call(null));
})());
...
var map__75814 = spec_tools.swagger.core.transform.cljs$core$IFn$_invoke$arity$2(spec,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),in$,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"parameter","parameter",1978789597)], null));
...
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75814__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75814__$1,new cljs.core.Keyword(null,"required","required",1807647006));
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__75816){
var vec__75817 = p__75816;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75817,(0),null);
var map__75820 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75817,(1),null);
var map__75820__$1 = (((((!((map__75820 == null))))?(((((map__75820.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__75820.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__75820):map__75820);
var schema = map__75820__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75820__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
var method_cache__4674__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4675__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__75822 = cljs.core.get_global_hierarchy;
return (fexpr__75822.cljs$core$IFn$_invoke$arity$0 ? fexpr__75822.cljs$core$IFn$_invoke$arity$0() : fexpr__75822.call(null));
})());
...
})(),(function (){var iter__4582__auto__ = (function spec_tools$swagger$core$iter__75823(s__75824){
return (new cljs.core.LazySeq(null,(function (){
var s__75824__$1 = s__75824;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__75824__$1);
if(temp__5735__auto__){
var s__75824__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__75824__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__75824__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__75826 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__75825 = (0);
while(true){
if((i__75825 < size__4581__auto__)){
var vec__75827 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__75825);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75827,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75827,(1),null);
cljs.core.chunk_append(b__75826,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [status,(function (){var $ = response;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__75826),spec_tools$swagger$core$iter__75823(cljs.core.chunk_rest(s__75824__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__75826),null);
}
} else {
var vec__75830 = cljs.core.first(s__75824__$2);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75830,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75830,(1),null);
...
var $__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1($))?cljs.core.update.cljs$core$IFn$_invoke$arity$4($,new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.swagger.core.transform,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"schema","schema",-1582001791)], null)):$);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3($__$1,new cljs.core.Keyword(null,"description","description",-1428560544),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,""));
})()], null),spec_tools$swagger$core$iter__75823(cljs.core.rest(s__75824__$2)));
}
} else {
return null;
}
...
var new$ = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__75833){
var vec__75834 = p__75833;
var in$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75834,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75834,(1),null);
...
var merged = cljs.core.vec(cljs.core.reverse(cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__75837,p){
var vec__75838 = p__75837;
var ps = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75838,(0),null);
var cache = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75838,(1),null);
var acc__$1 = vec__75838;
