...
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.swagger.core","default","spec-tools.swagger.core/default",1361779456)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__56231 = cljs.core.get_global_hierarchy;
return (fexpr__56231.cljs$core$IFn$_invoke$arity$0 ? fexpr__56231.cljs$core$IFn$_invoke$arity$0() : fexpr__56231.call(null));
})());
...
spec_tools.swagger.core.accept_spec.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),(function (_,___$1,children,p__56232){
var map__56233 = p__56232;
var map__56233__$1 = (((((!((map__56233 == null))))?(((((map__56233.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__56233.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__56233):map__56233);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56233__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56233__$1,new cljs.core.Keyword(null,"in","in",-1531184865));
...
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56235,(1),null);
...
var method_cache__4674__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4675__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__56240 = cljs.core.get_global_hierarchy;
return (fexpr__56240.cljs$core$IFn$_invoke$arity$0 ? fexpr__56240.cljs$core$IFn$_invoke$arity$0() : fexpr__56240.call(null));
})());
...
var map__56241 = spec_tools.swagger.core.transform.cljs$core$IFn$_invoke$arity$2(spec,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),in$,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"parameter","parameter",1978789597)], null));
...
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56241__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56241__$1,new cljs.core.Keyword(null,"required","required",1807647006));
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__56243){
var vec__56244 = p__56243;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56244,(0),null);
var map__56247 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56244,(1),null);
...
var schema = map__56247__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56247__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
var method_cache__4674__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4675__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__56250 = cljs.core.get_global_hierarchy;
return (fexpr__56250.cljs$core$IFn$_invoke$arity$0 ? fexpr__56250.cljs$core$IFn$_invoke$arity$0() : fexpr__56250.call(null));
})());
...
})(),(function (){var iter__4582__auto__ = (function spec_tools$swagger$core$iter__56251(s__56252){
return (new cljs.core.LazySeq(null,(function (){
var s__56252__$1 = s__56252;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__56252__$1);
if(temp__5735__auto__){
var s__56252__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__56252__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__56252__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__56254 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__56253 = (0);
while(true){
if((i__56253 < size__4581__auto__)){
var vec__56255 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__56253);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56255,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56255,(1),null);
cljs.core.chunk_append(b__56254,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [status,(function (){var $ = response;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__56254),spec_tools$swagger$core$iter__56251(cljs.core.chunk_rest(s__56252__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__56254),null);
}
} else {
var vec__56258 = cljs.core.first(s__56252__$2);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56258,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56258,(1),null);
...
var $__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1($))?cljs.core.update.cljs$core$IFn$_invoke$arity$4($,new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.swagger.core.transform,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"schema","schema",-1582001791)], null)):$);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3($__$1,new cljs.core.Keyword(null,"description","description",-1428560544),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,""));
})()], null),spec_tools$swagger$core$iter__56251(cljs.core.rest(s__56252__$2)));
}
} else {
return null;
}
...
var new$ = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__56261){
var vec__56262 = p__56261;
var in$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56262,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56262,(1),null);
...
var merged = cljs.core.vec(cljs.core.reverse(cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__56265,p){
var vec__56266 = p__56265;
var ps = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56266,(0),null);
var cache = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56266,(1),null);
var acc__$1 = vec__56266;
