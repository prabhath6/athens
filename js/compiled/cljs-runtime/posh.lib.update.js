...
posh.lib.update.update_pull = (function posh$lib$update$update_pull(p__45784,storage_key){
var map__45785 = p__45784;
var map__45785__$1 = (((((!((map__45785 == null))))?(((((map__45785.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__45785.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__45785):map__45785);
var posh_tree = map__45785__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45785__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45785__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));
var vec__45789 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45789,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45789,(1),null);
var pull_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45789,(2),null);
var eid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45789,(3),null);
...
posh.lib.update.update_filter_pull = (function posh$lib$update$update_filter_pull(p__45792,storage_key){
var map__45793 = p__45792;
var map__45793__$1 = (((((!((map__45793 == null))))?(((((map__45793.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__45793.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__45793):map__45793);
var posh_tree = map__45793__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45793__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45793__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));
var vec__45795 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45795,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45795,(1),null);
var pull_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45795,(2),null);
var eid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45795,(3),null);
...
posh.lib.update.update_pull_many = (function posh$lib$update$update_pull_many(p__45798,storage_key){
...
var posh_tree = map__45799__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45799__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45799__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));
var vec__45801 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45801,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45801,(1),null);
var pull_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45801,(2),null);
var eids = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45801,(3),null);
...
posh.lib.update.update_q_with_dbvarmap = (function posh$lib$update$update_q_with_dbvarmap(p__45804,storage_key){
var map__45805 = p__45804;
var map__45805__$1 = (((((!((map__45805 == null))))?(((((map__45805.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__45805.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__45805):map__45805);
var posh_tree = map__45805__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45805__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45805__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));

var vec__45807 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45807,(0),null);
var query = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45807,(1),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45807,(2),null);
...
var poshdbmap = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.merge,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__45810){
var vec__45811 = p__45810;
var db_sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45811,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45811,(1),null);
return cljs.core.PersistentArrayMap.createAsIfByAssoc([db_sym,posh.lib.db.poshdb__GT_analyze_db(posh_tree,poshdb)]);
}),dbvarmap));
var fixed_args = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__45814){
var vec__45815 = p__45814;
var sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45815,(0),null);
var arg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45815,(1),null);
...
var G__45818 = cljs.core.first(storage_key);
var G__45818__$1 = (((G__45818 instanceof cljs.core.Keyword))?G__45818.fqn:null);
switch (G__45818__$1) {
case "pull":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__45818__$1)].join('')));
