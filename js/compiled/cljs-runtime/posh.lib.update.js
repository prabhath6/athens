...
posh.lib.update.update_pull = (function posh$lib$update$update_pull(p__70676,storage_key){
var map__70677 = p__70676;
var map__70677__$1 = (((((!((map__70677 == null))))?(((((map__70677.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__70677.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__70677):map__70677);
var posh_tree = map__70677__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70677__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70677__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));
var vec__70679 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70679,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70679,(1),null);
var pull_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70679,(2),null);
var eid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70679,(3),null);
...
posh.lib.update.update_filter_pull = (function posh$lib$update$update_filter_pull(p__70682,storage_key){
var map__70683 = p__70682;
...
var posh_tree = map__70683__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70683__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70683__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));
var vec__70685 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70685,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70685,(1),null);
var pull_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70685,(2),null);
var eid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70685,(3),null);
...
posh.lib.update.update_pull_many = (function posh$lib$update$update_pull_many(p__70723,storage_key){
...
var posh_tree = map__70724__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70724__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70724__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));
var vec__70726 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70726,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70726,(1),null);
var pull_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70726,(2),null);
var eids = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70726,(3),null);
...
posh.lib.update.update_q_with_dbvarmap = (function posh$lib$update$update_q_with_dbvarmap(p__70729,storage_key){
var map__70730 = p__70729;
var map__70730__$1 = (((((!((map__70730 == null))))?(((((map__70730.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__70730.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__70730):map__70730);
var posh_tree = map__70730__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70730__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70730__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));

var vec__70736 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70736,(0),null);
var query = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70736,(1),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70736,(2),null);
...
var poshdbmap = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.merge,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__70778){
var vec__70779 = p__70778;
var db_sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70779,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70779,(1),null);
return cljs.core.PersistentArrayMap.createAsIfByAssoc([db_sym,posh.lib.db.poshdb__GT_analyze_db(posh_tree,poshdb)]);
}),dbvarmap));
var fixed_args = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__70782){
var vec__70783 = p__70782;
var sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70783,(0),null);
var arg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70783,(1),null);
...
var G__70790 = cljs.core.first(storage_key);
var G__70790__$1 = (((G__70790 instanceof cljs.core.Keyword))?G__70790.fqn:null);
switch (G__70790__$1) {
case "pull":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__70790__$1)].join('')));
