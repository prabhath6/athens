...
posh.lib.update.update_pull = (function posh$lib$update$update_pull(p__68388,storage_key){
...
var posh_tree = map__68389__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68389__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68389__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));
var vec__68391 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68391,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68391,(1),null);
var pull_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68391,(2),null);
var eid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68391,(3),null);
...
posh.lib.update.update_filter_pull = (function posh$lib$update$update_filter_pull(p__68394,storage_key){
var map__68395 = p__68394;
var map__68395__$1 = (((((!((map__68395 == null))))?(((((map__68395.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__68395.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__68395):map__68395);
var posh_tree = map__68395__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68395__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68395__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));
var vec__68397 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68397,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68397,(1),null);
var pull_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68397,(2),null);
var eid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68397,(3),null);
...
posh.lib.update.update_pull_many = (function posh$lib$update$update_pull_many(p__68400,storage_key){
...
var posh_tree = map__68401__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68401__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68401__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));
var vec__68403 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68403,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68403,(1),null);
var pull_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68403,(2),null);
var eids = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68403,(3),null);
...
posh.lib.update.update_q_with_dbvarmap = (function posh$lib$update$update_q_with_dbvarmap(p__68406,storage_key){
var map__68407 = p__68406;
...
var posh_tree = map__68407__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68407__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68407__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));

var vec__68410 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68410,(0),null);
var query = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68410,(1),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68410,(2),null);
...
var poshdbmap = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.merge,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__68413){
var vec__68414 = p__68413;
var db_sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68414,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68414,(1),null);
return cljs.core.PersistentArrayMap.createAsIfByAssoc([db_sym,posh.lib.db.poshdb__GT_analyze_db(posh_tree,poshdb)]);
}),dbvarmap));
var fixed_args = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__68417){
var vec__68418 = p__68417;
var sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68418,(0),null);
var arg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68418,(1),null);
...
var G__68422 = cljs.core.first(storage_key);
var G__68422__$1 = (((G__68422 instanceof cljs.core.Keyword))?G__68422.fqn:null);
switch (G__68422__$1) {
case "pull":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__68422__$1)].join('')));
