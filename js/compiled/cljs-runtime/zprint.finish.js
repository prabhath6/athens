...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__57862_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__57862_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__57862_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__57864){
var vec__57865 = p__57864;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57865,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57865,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__57868,s,color,element,idx){
var map__57876 = p__57868;
var map__57876__$1 = (((((!((map__57876 == null))))?(((((map__57876.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__57876.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__57876):map__57876);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57876__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57876__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57876__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__57880 = (function (){var or__4185__auto__ = color;
...
var fexpr__57879 = (function (){var G__57881 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
:(cljs.core.truth_((function (){var and__4174__auto__ = focus;
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__57881) : style_map.call(null,G__57881));
})();
return (fexpr__57879.cljs$core$IFn$_invoke$arity$1 ? fexpr__57879.cljs$core$IFn$_invoke$arity$1(G__57880) : fexpr__57879.call(null,G__57880));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__57882){
var vec__57883 = p__57882;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57883,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57883,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57883,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__57886){
var vec__57887 = p__57886;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57887,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57887,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57887,(2),null);
...
if(doing_nil_QMARK_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),(function (){var or__4185__auto__ = last_elide;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
...
var G__57956 = cljs.core.next(ssv);
var G__57957 = (this_ssv == null);
var G__57958 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__57959 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__57956;
doing_nil_QMARK_ = G__57957;
last_elide = G__57958;
out = G__57959;
continue;
}
...
var vec__57894 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57894,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57894,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57894,(2),null);
...
var G__57960 = cljs.core.next(remaining_cvec);
var G__57961 = new_idx;
var G__57962 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__57960;
idx = G__57961;
out = G__57962;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__57903,cursor_vec){
var vec__57904 = p__57903;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57904,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57904,(1),null);
var focus_vec = vec__57904;
...
var vec__57911 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57911,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57911,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__57914){
var vec__57915 = p__57914;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57915,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57915,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__57921,existing_count){
var vec__57922 = p__57921;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57922,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57922,(1),null);
...
var cursor__$1 = (function (){var x__4276__auto__ = zprint.finish.floor((0),(len - (1)));
var y__4277__auto__ = cursor;
return ((x__4276__auto__ < y__4277__auto__) ? x__4276__auto__ : y__4277__auto__);
})();
return cljs.core.filterv((function (p1__57918_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__57918_SHARP_))));
...
var vec__57931 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57931,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57931,(1),null);
var cvec_element = vec__57931;
if((cvec_element == null)){
var G__57975 = cljs.core.next(cvec_nl);
var G__57976 = (idx + (1));
var G__57977 = start;
var G__57978 = out;
cvec_nl = G__57975;
...
var G__57979 = cljs.core.next(cvec_nl);
var G__57980 = (idx + (1));
var G__57981 = idx;
var G__57982 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__57979;
idx = G__57980;
start = G__57981;
out = G__57982;
...
var G__57983 = cljs.core.next(cvec_nl);
var G__57984 = (idx + (1));
var G__57985 = (idx + (1));
var G__57986 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__57983;
idx = G__57984;
start = G__57985;
out = G__57986;
...
var G__57988 = cljs.core.next(cvec_nl);
var G__57989 = (idx + (1));
var G__57990 = idx;
var G__57991 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__57988;
idx = G__57989;
start = G__57990;
out = G__57991;
...
var G__57992 = cljs.core.next(cvec_nl);
var G__57993 = (idx + (1));
var G__57994 = start;
var G__57995 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__57992;
idx = G__57993;
start = G__57994;
out = G__57995;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__57936_SHARP_,p2__57935_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__57935_SHARP_)){
return cljs.core.reduced(p1__57936_SHARP_);
} else {
return (p1__57936_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__57937,p__57938){
var vec__57939 = p__57937;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57939,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57939,(1),null);
var vec__57942 = p__57938;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57942,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57942,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__57946,cvec,focus_vec){
...
var options = map__57947__$1;
var map__57948 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57947__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57948__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57948__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57948__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
if(cljs.core.truth_((function (){var or__4185__auto__ = lines;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var or__4185__auto____$1 = paths;
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57945_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__57945_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
