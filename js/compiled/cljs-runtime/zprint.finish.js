...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__28603_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__28603_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__28603_SHARP_);
} else {
...
var G__28685 = cljs.core.next(ssv);
var G__28686 = (this_ssv == null);
var G__28687 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__28688 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__28685;
doing_nil_QMARK_ = G__28686;
last_elide = G__28687;
out = G__28688;
continue;
}
...
var G__28690 = cljs.core.next(remaining_cvec);
var G__28691 = new_idx;
var G__28692 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__28690;
idx = G__28691;
out = G__28692;
continue;
}
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__28648,existing_count){
var vec__28649 = p__28648;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28649,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28649,(1),null);
...
var vec__28657 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28657,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28657,(1),null);
var cvec_element = vec__28657;
if((cvec_element == null)){
var G__28705 = cljs.core.next(cvec_nl);
var G__28706 = (idx + (1));
var G__28707 = start;
var G__28708 = out;
cvec_nl = G__28705;
...
var G__28711 = (idx + (1));
var G__28712 = idx;
var G__28713 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__28710;
idx = G__28711;
start = G__28712;
out = G__28713;
...
var G__28714 = cljs.core.next(cvec_nl);
var G__28715 = (idx + (1));
var G__28716 = (idx + (1));
var G__28717 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__28714;
idx = G__28715;
start = G__28716;
out = G__28717;
...
var G__28718 = cljs.core.next(cvec_nl);
var G__28719 = (idx + (1));
var G__28720 = idx;
var G__28721 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__28718;
idx = G__28719;
start = G__28720;
out = G__28721;
...
var G__28722 = cljs.core.next(cvec_nl);
var G__28723 = (idx + (1));
var G__28724 = start;
var G__28725 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__28722;
idx = G__28723;
start = G__28724;
out = G__28725;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__28664_SHARP_,p2__28663_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__28663_SHARP_)){
return cljs.core.reduced(p1__28664_SHARP_);
} else {
return (p1__28664_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__28666,p__28667){
var vec__28668 = p__28666;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28668,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28668,(1),null);
var vec__28671 = p__28667;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28671,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28671,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__28676,cvec,focus_vec){
var map__28677 = p__28676;
var map__28677__$1 = (((((!((map__28677 == null))))?(((((map__28677.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__28677.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__28677):map__28677);
var options = map__28677__$1;
var map__28678 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28677__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28678__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28678__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28678__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28674_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__28674_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
