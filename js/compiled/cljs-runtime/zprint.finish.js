...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__48392_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__48392_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__48392_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__48394){
var vec__48395 = p__48394;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48395,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48395,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__48402,s,color,element,idx){
...
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48403__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48403__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48403__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__48409 = (function (){var or__4185__auto__ = color;
...
var fexpr__48408 = (function (){var G__48412 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__48412) : style_map.call(null,G__48412));
})();
return (fexpr__48408.cljs$core$IFn$_invoke$arity$1 ? fexpr__48408.cljs$core$IFn$_invoke$arity$1(G__48409) : fexpr__48408.call(null,G__48409));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__48414){
var vec__48417 = p__48414;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48417,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48417,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48417,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__48428){
var vec__48430 = p__48428;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48430,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48430,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48430,(2),null);
...
var G__48565 = cljs.core.next(ssv);
var G__48566 = (this_ssv == null);
var G__48567 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__48568 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__48565;
doing_nil_QMARK_ = G__48566;
last_elide = G__48567;
out = G__48568;
continue;
}
...
var vec__48453 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48453,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48453,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48453,(2),null);
...
var G__48570 = cljs.core.next(remaining_cvec);
var G__48571 = new_idx;
var G__48572 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__48570;
idx = G__48571;
out = G__48572;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__48479,cursor_vec){
var vec__48480 = p__48479;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48480,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48480,(1),null);
var focus_vec = vec__48480;
...
var vec__48483 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48483,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48483,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__48487){
var vec__48488 = p__48487;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48488,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48488,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__48500,existing_count){
var vec__48501 = p__48500;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48501,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48501,(1),null);
...
return cljs.core.filterv((function (p1__48491_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__48491_SHARP_))));
...
var vec__48511 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48511,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48511,(1),null);
var cvec_element = vec__48511;
if((cvec_element == null)){
var G__48601 = cljs.core.next(cvec_nl);
var G__48602 = (idx + (1));
var G__48603 = start;
var G__48604 = out;
cvec_nl = G__48601;
...
var G__48605 = cljs.core.next(cvec_nl);
var G__48606 = (idx + (1));
var G__48607 = idx;
var G__48608 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__48605;
idx = G__48606;
start = G__48607;
out = G__48608;
...
var G__48610 = cljs.core.next(cvec_nl);
var G__48611 = (idx + (1));
var G__48612 = (idx + (1));
var G__48613 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__48610;
idx = G__48611;
start = G__48612;
out = G__48613;
...
var G__48614 = cljs.core.next(cvec_nl);
var G__48615 = (idx + (1));
var G__48616 = idx;
var G__48617 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__48614;
idx = G__48615;
start = G__48616;
out = G__48617;
...
var G__48622 = cljs.core.next(cvec_nl);
var G__48623 = (idx + (1));
var G__48624 = start;
var G__48625 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__48622;
idx = G__48623;
start = G__48624;
out = G__48625;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__48531_SHARP_,p2__48530_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__48530_SHARP_)){
return cljs.core.reduced(p1__48531_SHARP_);
} else {
return (p1__48531_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__48532,p__48533){
var vec__48534 = p__48532;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48534,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48534,(1),null);
var vec__48537 = p__48533;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48537,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48537,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__48550,cvec,focus_vec){
...
var options = map__48551__$1;
var map__48552 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48551__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48552__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48552__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48552__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__48549_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__48549_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
