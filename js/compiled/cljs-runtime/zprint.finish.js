...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__28599_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__28599_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__28599_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__28604){
var vec__28605 = p__28604;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28605,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28605,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__28608,s,color,element,idx){
...
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28609__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28609__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28609__$1,new cljs.core.Keyword(null,"select","select",1147833503));
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__28615){
var vec__28616 = p__28615;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28616,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28616,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28616,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__28619){
var vec__28620 = p__28619;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28620,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28620,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28620,(2),null);
...
var G__28682 = cljs.core.next(ssv);
var G__28683 = (this_ssv == null);
var G__28684 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__28685 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__28682;
doing_nil_QMARK_ = G__28683;
last_elide = G__28684;
out = G__28685;
continue;
}
...
var vec__28626 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28626,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28626,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28626,(2),null);
...
var G__28687 = cljs.core.next(remaining_cvec);
var G__28688 = new_idx;
var G__28689 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__28687;
idx = G__28688;
out = G__28689;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__28633,cursor_vec){
var vec__28634 = p__28633;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28634,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28634,(1),null);
var focus_vec = vec__28634;
...
var vec__28637 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28637,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28637,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__28640){
var vec__28641 = p__28640;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28641,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28641,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__28647,existing_count){
var vec__28648 = p__28647;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28648,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28648,(1),null);
...
return cljs.core.filterv((function (p1__28644_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__28644_SHARP_))));
...
var vec__28654 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28654,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28654,(1),null);
var cvec_element = vec__28654;
if((cvec_element == null)){
var G__28702 = cljs.core.next(cvec_nl);
var G__28703 = (idx + (1));
var G__28704 = start;
var G__28705 = out;
cvec_nl = G__28702;
...
var G__28706 = cljs.core.next(cvec_nl);
var G__28707 = (idx + (1));
var G__28708 = idx;
var G__28709 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__28706;
idx = G__28707;
start = G__28708;
out = G__28709;
...
var G__28710 = cljs.core.next(cvec_nl);
var G__28711 = (idx + (1));
var G__28712 = (idx + (1));
var G__28713 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__28710;
idx = G__28711;
start = G__28712;
out = G__28713;
...
var G__28715 = cljs.core.next(cvec_nl);
var G__28716 = (idx + (1));
var G__28717 = idx;
var G__28718 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__28715;
idx = G__28716;
start = G__28717;
out = G__28718;
...
var G__28719 = cljs.core.next(cvec_nl);
var G__28720 = (idx + (1));
var G__28721 = start;
var G__28722 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__28719;
idx = G__28720;
start = G__28721;
out = G__28722;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__28658_SHARP_,p2__28657_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__28657_SHARP_)){
return cljs.core.reduced(p1__28658_SHARP_);
} else {
return (p1__28658_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__28660,p__28661){
var vec__28662 = p__28660;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28662,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28662,(1),null);
var vec__28665 = p__28661;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28665,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28665,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__28670,cvec,focus_vec){
var map__28671 = p__28670;
var map__28671__$1 = (((((!((map__28671 == null))))?(((((map__28671.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__28671.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__28671):map__28671);
var options = map__28671__$1;
var map__28672 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28671__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__28672__$1 = (((((!((map__28672 == null))))?(((((map__28672.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__28672.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__28672):map__28672);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28672__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28672__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28672__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28669_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__28669_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
