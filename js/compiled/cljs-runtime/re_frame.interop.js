...
return [(function (){var pred__32563 = cljs.core.instance_QMARK_;
var expr__32564 = reactive_val;
if(cljs.core.truth_((pred__32563.cljs$core$IFn$_invoke$arity$2 ? pred__32563.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__32564) : pred__32563.call(null,reagent.ratom.RAtom,expr__32564)))){
return "ra";
} else {
if(cljs.core.truth_((pred__32563.cljs$core$IFn$_invoke$arity$2 ? pred__32563.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__32564) : pred__32563.call(null,reagent.ratom.RCursor,expr__32564)))){
return "rc";
} else {
if(cljs.core.truth_((pred__32563.cljs$core$IFn$_invoke$arity$2 ? pred__32563.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__32564) : pred__32563.call(null,reagent.ratom.Reaction,expr__32564)))){
return "rx";
} else {
if(cljs.core.truth_((pred__32563.cljs$core$IFn$_invoke$arity$2 ? pred__32563.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__32564) : pred__32563.call(null,reagent.ratom.Track,expr__32564)))){
return "tr";
} else {
return "other";
}
