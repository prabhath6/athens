...
return [(function (){var pred__61763 = cljs.core.instance_QMARK_;
var expr__61764 = reactive_val;
if(cljs.core.truth_((pred__61763.cljs$core$IFn$_invoke$arity$2 ? pred__61763.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__61764) : pred__61763.call(null,reagent.ratom.RAtom,expr__61764)))){
return "ra";
} else {
if(cljs.core.truth_((pred__61763.cljs$core$IFn$_invoke$arity$2 ? pred__61763.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__61764) : pred__61763.call(null,reagent.ratom.RCursor,expr__61764)))){
return "rc";
} else {
if(cljs.core.truth_((pred__61763.cljs$core$IFn$_invoke$arity$2 ? pred__61763.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__61764) : pred__61763.call(null,reagent.ratom.Reaction,expr__61764)))){
return "rx";
} else {
if(cljs.core.truth_((pred__61763.cljs$core$IFn$_invoke$arity$2 ? pred__61763.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__61764) : pred__61763.call(null,reagent.ratom.Track,expr__61764)))){
return "tr";
} else {
return "other";
}
