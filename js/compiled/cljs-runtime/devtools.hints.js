...
var G__20639 = cljs.core.PersistentArrayMap.EMPTY;
var G__20640 = native_stack_trace;
var G__20641 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__20642 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__20639,G__20640,G__20641,G__20642) : cljs.stacktrace.parse_stacktrace.call(null,G__20639,G__20640,G__20641,G__20642));
});
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20644__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20644__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20644__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e20643){var _e = e20643;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___20666 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20666)){
var seen_errors_20668 = temp__5733__auto___20666;
if(cljs.core.truth_(seen_errors_20668.has(self))){
} else {
seen_errors_20668.add(self);

var temp__5735__auto___20670 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20670)){
var sense_20671 = temp__5735__auto___20670;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20671)].join(''));
} else {
}
}
} else {
