...
var G__20745 = cljs.core.PersistentArrayMap.EMPTY;
var G__20746 = native_stack_trace;
var G__20747 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__20748 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__20745,G__20746,G__20747,G__20748) : cljs.stacktrace.parse_stacktrace.call(null,G__20745,G__20746,G__20747,G__20748));
});
...
var map__20750 = top_item;
var map__20750__$1 = (((((!((map__20750 == null))))?(((((map__20750.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20750.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__20750):map__20750);
...
}catch (e20749){var _e = e20749;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___20780 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20780)){
var seen_errors_20781 = temp__5733__auto___20780;
if(cljs.core.truth_(seen_errors_20781.has(self))){
} else {
seen_errors_20781.add(self);

var temp__5735__auto___20782 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20782)){
var sense_20783 = temp__5735__auto___20782;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20783)].join(''));
} else {
}
}
} else {
