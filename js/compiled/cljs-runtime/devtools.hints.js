...
var G__20792 = cljs.core.PersistentArrayMap.EMPTY;
var G__20793 = native_stack_trace;
var G__20794 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__20795 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__20792,G__20793,G__20794,G__20795) : cljs.stacktrace.parse_stacktrace.call(null,G__20792,G__20793,G__20794,G__20795));
});
...
var map__20808 = top_item;
var map__20808__$1 = (((((!((map__20808 == null))))?(((((map__20808.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20808.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__20808):map__20808);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20808__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20808__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20808__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e20804){var _e = e20804;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___20823 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20823)){
var seen_errors_20824 = temp__5733__auto___20823;
if(cljs.core.truth_(seen_errors_20824.has(self))){
} else {
seen_errors_20824.add(self);

var temp__5735__auto___20826 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20826)){
var sense_20827 = temp__5735__auto___20826;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20827)].join(''));
} else {
}
}
} else {
