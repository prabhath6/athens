...
var G__59936 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__59936;
continue;
} else {
var G__59937 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__59937;
continue;
}
} else {
var G__59938 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__59938;
continue;
}
}
...
var G__59929 = zloc;
var G__59930 = (function (){var G__59931 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__59932 = zloc;
var G__59932__$1 = (((G__59932 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__59932) : rewrite_clj.zip.node.call(null,G__59932)));
if((G__59932__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__59932__$1) : zprint.zutil.edn_STAR_.call(null,G__59932__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__59931) : rewrite_clj.zip.root.call(null,G__59931));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__59929,G__59930) : rewrite_clj.zip.replace.call(null,G__59929,G__59930));
});
/**
...
var G__59939 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__59939;
continue;
}
break;
...
var G__59940 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__59941 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__59940;
out = G__59941;
continue;
} else {
...
var G__59942 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__59943 = cljs.core.next(new_loc);
var G__59944 = replaced_loc;
nloc = G__59942;
new_loc = G__59943;
last_loc = G__59944;
continue;
...
return zprint.rewrite.sort_val((function (){var G__59934 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__59934) : rewrite_clj.zip.down.call(null,G__59934));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__59935_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__59935_SHARP_) : rewrite_clj.zip.tag.call(null,p1__59935_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__59935_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__59935_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
