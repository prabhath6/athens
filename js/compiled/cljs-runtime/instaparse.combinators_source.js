...
args__4795__auto__.push((arguments[i__4790__auto___63542]));
...
/** @this {Function} */
(instaparse.combinators_source.alt.cljs$lang$applyTo = (function (seq63484){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq63484));
}));
...
var len__4789__auto___63552 = arguments.length;
var i__4790__auto___63553 = (0);
while(true){
if((i__4790__auto___63553 < len__4789__auto___63552)){
args_arr__4810__auto__.push((arguments[i__4790__auto___63553]));

var G__63555 = (i__4790__auto___63553 + (1));
i__4790__auto___63553 = G__63555;
continue;
} else {
}
break;
...
/** @this {Function} */
(instaparse.combinators_source.ord.cljs$lang$applyTo = (function (seq63486){
var G__63487 = cljs.core.first(seq63486);
var seq63486__$1 = cljs.core.next(seq63486);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__63487,seq63486__$1);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___63556 = arguments.length;
var i__4790__auto___63557 = (0);
while(true){
if((i__4790__auto___63557 < len__4789__auto___63556)){
args__4795__auto__.push((arguments[i__4790__auto___63557]));

var G__63558 = (i__4790__auto___63557 + (1));
i__4790__auto___63557 = G__63558;
continue;
} else {
}
break;
...
/** @this {Function} */
(instaparse.combinators_source.cat.cljs$lang$applyTo = (function (seq63489){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq63489));
}));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(parser__$1,new cljs.core.Keyword(null,"parser","parser",-1543495310),(function (){var G__63492 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.combinators_source.unhide_content.cljs$core$IFn$_invoke$arity$1 ? instaparse.combinators_source.unhide_content.cljs$core$IFn$_invoke$arity$1(G__63492) : instaparse.combinators_source.unhide_content.call(null,G__63492));
})());
} else {
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(parser__$1,new cljs.core.Keyword(null,"parser1","parser1",-439601422),(function (){var G__63493 = new cljs.core.Keyword(null,"parser1","parser1",-439601422).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.combinators_source.unhide_content.cljs$core$IFn$_invoke$arity$1 ? instaparse.combinators_source.unhide_content.cljs$core$IFn$_invoke$arity$1(G__63493) : instaparse.combinators_source.unhide_content.call(null,G__63493));
})(),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"parser2","parser2",1013754688),(function (){var G__63494 = new cljs.core.Keyword(null,"parser2","parser2",1013754688).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.combinators_source.unhide_content.cljs$core$IFn$_invoke$arity$1 ? instaparse.combinators_source.unhide_content.cljs$core$IFn$_invoke$arity$1(G__63494) : instaparse.combinators_source.unhide_content.call(null,G__63494));
})()], 0));
} else {
return parser__$1;
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$combinators_source$unhide_all_content_$_iter__63495(s__63496){
return (new cljs.core.LazySeq(null,(function (){
var s__63496__$1 = s__63496;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__63496__$1);
if(temp__5735__auto__){
var s__63496__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__63496__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__63496__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__63498 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__63497 = (0);
while(true){
if((i__63497 < size__4581__auto__)){
var vec__63499 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__63497);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63499,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63499,(1),null);
cljs.core.chunk_append(b__63498,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,instaparse.combinators_source.unhide_content(v)], null));

var G__63607 = (i__63497 + (1));
i__63497 = G__63607;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__63498),instaparse$combinators_source$unhide_all_content_$_iter__63495(cljs.core.chunk_rest(s__63496__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__63498),null);
}
} else {
var vec__63502 = cljs.core.first(s__63496__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63502,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63502,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,instaparse.combinators_source.unhide_content(v)], null),instaparse$combinators_source$unhide_all_content_$_iter__63495(cljs.core.rest(s__63496__$2)));
}
} else {
return null;
}
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$combinators_source$unhide_tags_$_iter__63505(s__63506){
return (new cljs.core.LazySeq(null,(function (){
var s__63506__$1 = s__63506;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__63506__$1);
if(temp__5735__auto__){
var s__63506__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__63506__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__63506__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__63508 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__63507 = (0);
while(true){
if((i__63507 < size__4581__auto__)){
var vec__63509 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__63507);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63509,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63509,(1),null);
cljs.core.chunk_append(b__63508,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null));

var G__63617 = (i__63507 + (1));
i__63507 = G__63617;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__63508),instaparse$combinators_source$unhide_tags_$_iter__63505(cljs.core.chunk_rest(s__63506__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__63508),null);
}
} else {
var vec__63512 = cljs.core.first(s__63506__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63512,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63512,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null),instaparse$combinators_source$unhide_tags_$_iter__63505(cljs.core.rest(s__63506__$2)));
}
} else {
return null;
}
...
if(cljs.core.truth_(temp__5733__auto__)){
var reduction = temp__5733__auto__;
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$combinators_source$unhide_all_$_iter__63515(s__63516){
return (new cljs.core.LazySeq(null,(function (){
...
cljs.core.chunk_append(b__63518,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(instaparse.combinators_source.unhide_content(v),new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null));

var G__63628 = (i__63517 + (1));
i__63517 = G__63628;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__63518),instaparse$combinators_source$unhide_all_$_iter__63515(cljs.core.chunk_rest(s__63516__$2)));
} else {
...
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(instaparse.combinators_source.unhide_content(v),new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null),instaparse$combinators_source$unhide_all_$_iter__63515(cljs.core.rest(s__63516__$2)));
}
} else {
return null;
}
...
var G__63526 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
var G__63526__$1 = (((G__63526 instanceof cljs.core.Keyword))?G__63526.fqn:null);
switch (G__63526__$1) {
case "nt":
case "epsilon":
return parser;
...
case "alt":
case "cat":
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(parser,new cljs.core.Keyword(null,"parsers","parsers",-804353827),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__63525_SHARP_){
return (instaparse.combinators_source.auto_whitespace_parser.cljs$core$IFn$_invoke$arity$2 ? instaparse.combinators_source.auto_whitespace_parser.cljs$core$IFn$_invoke$arity$2(p1__63525_SHARP_,ws_parser) : instaparse.combinators_source.auto_whitespace_parser.call(null,p1__63525_SHARP_,ws_parser));
}),new cljs.core.Keyword(null,"parsers","parsers",-804353827).cljs$core$IFn$_invoke$arity$1(parser)));

break;
case "ord":
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(parser,new cljs.core.Keyword(null,"parser1","parser1",-439601422),(function (){var G__63527 = new cljs.core.Keyword(null,"parser1","parser1",-439601422).cljs$core$IFn$_invoke$arity$1(parser);
var G__63528 = ws_parser;
return (instaparse.combinators_source.auto_whitespace_parser.cljs$core$IFn$_invoke$arity$2 ? instaparse.combinators_source.auto_whitespace_parser.cljs$core$IFn$_invoke$arity$2(G__63527,G__63528) : instaparse.combinators_source.auto_whitespace_parser.call(null,G__63527,G__63528));
})(),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"parser2","parser2",1013754688),(function (){var G__63529 = new cljs.core.Keyword(null,"parser2","parser2",1013754688).cljs$core$IFn$_invoke$arity$1(parser);
var G__63530 = ws_parser;
return (instaparse.combinators_source.auto_whitespace_parser.cljs$core$IFn$_invoke$arity$2 ? instaparse.combinators_source.auto_whitespace_parser.cljs$core$IFn$_invoke$arity$2(G__63529,G__63530) : instaparse.combinators_source.auto_whitespace_parser.call(null,G__63529,G__63530));
})()], 0));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__63526__$1)].join('')));
...
var modified_grammar = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$combinators_source$auto_whitespace_$_iter__63531(s__63532){
return (new cljs.core.LazySeq(null,(function (){
var s__63532__$1 = s__63532;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__63532__$1);
if(temp__5735__auto__){
var s__63532__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__63532__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__63532__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__63534 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__63533 = (0);
while(true){
if((i__63533 < size__4581__auto__)){
var vec__63535 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__63533);
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63535,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63535,(1),null);
cljs.core.chunk_append(b__63534,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [nt,instaparse.combinators_source.auto_whitespace_parser(parser,ws_parser)], null));

var G__63638 = (i__63533 + (1));
i__63533 = G__63638;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__63534),instaparse$combinators_source$auto_whitespace_$_iter__63531(cljs.core.chunk_rest(s__63532__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__63534),null);
}
} else {
var vec__63538 = cljs.core.first(s__63532__$2);
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63538,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63538,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [nt,instaparse.combinators_source.auto_whitespace_parser(parser,ws_parser)], null),instaparse$combinators_source$auto_whitespace_$_iter__63531(cljs.core.rest(s__63532__$2)));
}
} else {
return null;
}
