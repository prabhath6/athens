...
/** @this {Function} */
(instaparse.combinators_source.alt.cljs$lang$applyTo = (function (seq63583){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq63583));
}));
...
var len__4789__auto___63647 = arguments.length;
var i__4790__auto___63649 = (0);
while(true){
if((i__4790__auto___63649 < len__4789__auto___63647)){
args_arr__4810__auto__.push((arguments[i__4790__auto___63649]));

var G__63650 = (i__4790__auto___63649 + (1));
i__4790__auto___63649 = G__63650;
continue;
} else {
}
break;
...
/** @this {Function} */
(instaparse.combinators_source.ord.cljs$lang$applyTo = (function (seq63585){
var G__63586 = cljs.core.first(seq63585);
var seq63585__$1 = cljs.core.next(seq63585);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__63586,seq63585__$1);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___63655 = arguments.length;
var i__4790__auto___63656 = (0);
while(true){
if((i__4790__auto___63656 < len__4789__auto___63655)){
args__4795__auto__.push((arguments[i__4790__auto___63656]));

var G__63657 = (i__4790__auto___63656 + (1));
i__4790__auto___63656 = G__63657;
continue;
} else {
}
break;
...
/** @this {Function} */
(instaparse.combinators_source.cat.cljs$lang$applyTo = (function (seq63588){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq63588));
}));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(parser__$1,new cljs.core.Keyword(null,"parser","parser",-1543495310),(function (){var G__63591 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.combinators_source.unhide_content.cljs$core$IFn$_invoke$arity$1 ? instaparse.combinators_source.unhide_content.cljs$core$IFn$_invoke$arity$1(G__63591) : instaparse.combinators_source.unhide_content.call(null,G__63591));
})());
} else {
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(parser__$1,new cljs.core.Keyword(null,"parser1","parser1",-439601422),(function (){var G__63592 = new cljs.core.Keyword(null,"parser1","parser1",-439601422).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.combinators_source.unhide_content.cljs$core$IFn$_invoke$arity$1 ? instaparse.combinators_source.unhide_content.cljs$core$IFn$_invoke$arity$1(G__63592) : instaparse.combinators_source.unhide_content.call(null,G__63592));
})(),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"parser2","parser2",1013754688),(function (){var G__63593 = new cljs.core.Keyword(null,"parser2","parser2",1013754688).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.combinators_source.unhide_content.cljs$core$IFn$_invoke$arity$1 ? instaparse.combinators_source.unhide_content.cljs$core$IFn$_invoke$arity$1(G__63593) : instaparse.combinators_source.unhide_content.call(null,G__63593));
})()], 0));
} else {
return parser__$1;
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$combinators_source$unhide_all_content_$_iter__63594(s__63595){
return (new cljs.core.LazySeq(null,(function (){
var s__63595__$1 = s__63595;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__63595__$1);
if(temp__5735__auto__){
var s__63595__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__63595__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__63595__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__63597 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__63596 = (0);
while(true){
if((i__63596 < size__4581__auto__)){
var vec__63598 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__63596);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63598,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63598,(1),null);
cljs.core.chunk_append(b__63597,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,instaparse.combinators_source.unhide_content(v)], null));

var G__63686 = (i__63596 + (1));
i__63596 = G__63686;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__63597),instaparse$combinators_source$unhide_all_content_$_iter__63594(cljs.core.chunk_rest(s__63595__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__63597),null);
}
} else {
var vec__63601 = cljs.core.first(s__63595__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63601,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63601,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,instaparse.combinators_source.unhide_content(v)], null),instaparse$combinators_source$unhide_all_content_$_iter__63594(cljs.core.rest(s__63595__$2)));
}
} else {
return null;
}
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$combinators_source$unhide_tags_$_iter__63604(s__63605){
return (new cljs.core.LazySeq(null,(function (){
...
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63608,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63608,(1),null);
cljs.core.chunk_append(b__63607,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null));

var G__63707 = (i__63606 + (1));
i__63606 = G__63707;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__63607),instaparse$combinators_source$unhide_tags_$_iter__63604(cljs.core.chunk_rest(s__63605__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__63607),null);
}
} else {
var vec__63611 = cljs.core.first(s__63605__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63611,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63611,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null),instaparse$combinators_source$unhide_tags_$_iter__63604(cljs.core.rest(s__63605__$2)));
}
} else {
return null;
}
...
if(cljs.core.truth_(temp__5733__auto__)){
var reduction = temp__5733__auto__;
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$combinators_source$unhide_all_$_iter__63614(s__63615){
return (new cljs.core.LazySeq(null,(function (){
var s__63615__$1 = s__63615;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__63615__$1);
if(temp__5735__auto__){
var s__63615__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__63615__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__63615__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__63617 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__63616 = (0);
while(true){
if((i__63616 < size__4581__auto__)){
var vec__63618 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__63616);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63618,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63618,(1),null);
cljs.core.chunk_append(b__63617,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(instaparse.combinators_source.unhide_content(v),new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null));

var G__63717 = (i__63616 + (1));
i__63616 = G__63717;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__63617),instaparse$combinators_source$unhide_all_$_iter__63614(cljs.core.chunk_rest(s__63615__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__63617),null);
}
} else {
var vec__63621 = cljs.core.first(s__63615__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63621,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63621,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(instaparse.combinators_source.unhide_content(v),new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null),instaparse$combinators_source$unhide_all_$_iter__63614(cljs.core.rest(s__63615__$2)));
}
} else {
return null;
}
...
var G__63625 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
var G__63625__$1 = (((G__63625 instanceof cljs.core.Keyword))?G__63625.fqn:null);
switch (G__63625__$1) {
case "nt":
case "epsilon":
return parser;
...
case "alt":
case "cat":
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(parser,new cljs.core.Keyword(null,"parsers","parsers",-804353827),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__63624_SHARP_){
return (instaparse.combinators_source.auto_whitespace_parser.cljs$core$IFn$_invoke$arity$2 ? instaparse.combinators_source.auto_whitespace_parser.cljs$core$IFn$_invoke$arity$2(p1__63624_SHARP_,ws_parser) : instaparse.combinators_source.auto_whitespace_parser.call(null,p1__63624_SHARP_,ws_parser));
}),new cljs.core.Keyword(null,"parsers","parsers",-804353827).cljs$core$IFn$_invoke$arity$1(parser)));

break;
case "ord":
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(parser,new cljs.core.Keyword(null,"parser1","parser1",-439601422),(function (){var G__63626 = new cljs.core.Keyword(null,"parser1","parser1",-439601422).cljs$core$IFn$_invoke$arity$1(parser);
var G__63627 = ws_parser;
return (instaparse.combinators_source.auto_whitespace_parser.cljs$core$IFn$_invoke$arity$2 ? instaparse.combinators_source.auto_whitespace_parser.cljs$core$IFn$_invoke$arity$2(G__63626,G__63627) : instaparse.combinators_source.auto_whitespace_parser.call(null,G__63626,G__63627));
})(),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"parser2","parser2",1013754688),(function (){var G__63628 = new cljs.core.Keyword(null,"parser2","parser2",1013754688).cljs$core$IFn$_invoke$arity$1(parser);
var G__63629 = ws_parser;
return (instaparse.combinators_source.auto_whitespace_parser.cljs$core$IFn$_invoke$arity$2 ? instaparse.combinators_source.auto_whitespace_parser.cljs$core$IFn$_invoke$arity$2(G__63628,G__63629) : instaparse.combinators_source.auto_whitespace_parser.call(null,G__63628,G__63629));
})()], 0));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__63625__$1)].join('')));
...
var modified_grammar = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$combinators_source$auto_whitespace_$_iter__63630(s__63631){
return (new cljs.core.LazySeq(null,(function (){
var s__63631__$1 = s__63631;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__63631__$1);
if(temp__5735__auto__){
var s__63631__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__63631__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__63631__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__63633 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__63632 = (0);
while(true){
if((i__63632 < size__4581__auto__)){
var vec__63634 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__63632);
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63634,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63634,(1),null);
cljs.core.chunk_append(b__63633,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [nt,instaparse.combinators_source.auto_whitespace_parser(parser,ws_parser)], null));

var G__63730 = (i__63632 + (1));
i__63632 = G__63730;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__63633),instaparse$combinators_source$auto_whitespace_$_iter__63630(cljs.core.chunk_rest(s__63631__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__63633),null);
}
} else {
var vec__63637 = cljs.core.first(s__63631__$2);
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63637,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63637,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [nt,instaparse.combinators_source.auto_whitespace_parser(parser,ws_parser)], null),instaparse$combinators_source$auto_whitespace_$_iter__63630(cljs.core.rest(s__63631__$2)));
}
} else {
return null;
}
