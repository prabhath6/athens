...
sci.impl.for_macro.expand_for = (function sci$impl$for_macro$expand_for(_,p__65842){
var vec__65843 = p__65842;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65843,(0),null);
var seq_exprs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65843,(1),null);
var body_expr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65843,(2),null);
sci.impl.for_macro.assert_args(seq_exprs,body_expr);

var to_groups = (function (seq_exprs__$1){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (groups,p__65846){
...
var err = (function() { 
var G__65877__delegate = function (msg){
throw (new Error(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,msg)));
};
var G__65877 = function (var_args){
var msg = null;
if (arguments.length > 0) {
var G__65878__i = 0, G__65878__a = new Array(arguments.length -  0);
while (G__65878__i < G__65878__a.length) {G__65878__a[G__65878__i] = arguments[G__65878__i + 0]; ++G__65878__i;}
  msg = new cljs.core.IndexedSeq(G__65878__a,0,null);
} 
return G__65877__delegate.call(this,msg);};
G__65877.cljs$lang$maxFixedArity = 0;
G__65877.cljs$lang$applyTo = (function (arglist__65879){
var msg = cljs.core.seq(arglist__65879);
return G__65877__delegate(msg);
});
G__65877.cljs$core$IFn$_invoke$arity$variadic = G__65877__delegate;
return G__65877;
})()
;
var emit_bind = (function sci$impl$for_macro$expand_for_$_emit_bind(p__65850){
var vec__65851 = p__65850;
var seq__65852 = cljs.core.seq(vec__65851);
var first__65853 = cljs.core.first(seq__65852);
var seq__65852__$1 = cljs.core.next(seq__65852);
var vec__65854 = first__65853;
var seq__65855 = cljs.core.seq(vec__65854);
var first__65856 = cljs.core.first(seq__65855);
var seq__65855__$1 = cljs.core.next(seq__65855);
var bind = first__65856;
var first__65856__$1 = cljs.core.first(seq__65855__$1);
var seq__65855__$2 = cljs.core.next(seq__65855__$1);
var expr = first__65856__$1;
var mod_pairs = seq__65855__$2;
var vec__65857 = seq__65852__$1;
var vec__65860 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65857,(0),null);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65860,(0),null);
var next_expr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65860,(1),null);
var next_groups = vec__65857;
...
var do_mod = (function sci$impl$for_macro$expand_for_$_emit_bind_$_do_mod(p__65863){
var vec__65864 = p__65863;
var seq__65865 = cljs.core.seq(vec__65864);
var first__65866 = cljs.core.first(seq__65865);
var seq__65865__$1 = cljs.core.next(seq__65865);
var vec__65867 = first__65866;
...
if(next_groups){
return cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","let","cljs.core/let",-308701135,null),null,(1),null)),(new cljs.core.List(null,cljs.core.vec(cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol(null,"iterys__65837__auto__","iterys__65837__auto__",-620379479,null),null,(1),null)),(new cljs.core.List(null,sci$impl$for_macro$expand_for_$_emit_bind(next_groups),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__65838__auto__","fs__65838__auto__",1685080148,null),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","seq","cljs.core/seq",-1649497689,null),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol(null,"iterys__65837__auto__","iterys__65837__auto__",-620379479,null),null,(1),null)),(new cljs.core.List(null,next_expr,null,(1),null))))),null,(1),null))))),null,(1),null))], 0))))),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol(null,"if","if",1181717262,null),null,(1),null)),(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__65838__auto__","fs__65838__auto__",1685080148,null),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","concat","cljs.core/concat",-1133584918,null),null,(1),null)),(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__65838__auto__","fs__65838__auto__",1685080148,null),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,giter,null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","rest","cljs.core/rest",-285075455,null),null,(1),null)),(new cljs.core.List(null,gxs,null,(1),null))))),null,(1),null))))),null,(1),null))], 0)))),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,sci.impl.utils.allowed_recur,null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","rest","cljs.core/rest",-285075455,null),null,(1),null)),(new cljs.core.List(null,gxs,null,(1),null))))),null,(1),null))))),null,(1),null))], 0)))),null,(1),null))], 0))));
} else {
...
var do_cmod = (function sci$impl$for_macro$expand_for_$_emit_bind_$_do_cmod(p__65870){
var vec__65871 = p__65870;
var seq__65872 = cljs.core.seq(vec__65871);
var first__65873 = cljs.core.first(seq__65872);
var seq__65872__$1 = cljs.core.next(seq__65872);
var vec__65874 = first__65873;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65874,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65874,(1),null);
var pair = vec__65874;
var etc = seq__65872__$1;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(k,new cljs.core.Keyword(null,"let","let",-1282412701))){
