...
var syms = (function (){var iter__4582__auto__ = (function rewrite_clj$node$fn$fn_walk_$_iter__48932(s__48933){
return (new cljs.core.LazySeq(null,(function (){
var s__48933__$1 = s__48933;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__48933__$1);
if(temp__5735__auto__){
var s__48933__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__48933__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__48933__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__48935 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__48934 = (0);
while(true){
if((i__48934 < size__4581__auto__)){
var i = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__48934);
...
cljs.core.chunk_append(b__48935,cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')));

var G__49003 = (i__48934 + (1));
i__48934 = G__49003;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__48935),rewrite_clj$node$fn$fn_walk_$_iter__48932(cljs.core.chunk_rest(s__48933__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__48935),null);
}
} else {
var i = cljs.core.first(s__48933__$2);
var base = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(0)))?"rest__":["p",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i),"__"].join(''));
var s = cljs.core.name(cljs.core.gensym.cljs$core$IFn$_invoke$arity$1(base));
return cljs.core.cons(cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')),rewrite_clj$node$fn$fn_walk_$_iter__48932(cljs.core.rest(s__48933__$2)));
}
} else {
return null;
}
...
var body = clojure.walk.prewalk((function (p1__48927_SHARP_){
var or__4185__auto__ = rewrite_clj.node.fn.symbol__GT_gensym(syms,vararg_QMARK_,max_n,p1__48927_SHARP_);
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return p1__48927_SHARP_;
}
}),form);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k48944,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k48944,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__48950){
var vec__48954 = p__48950;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48954,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48954,(1),null);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__48943){
var self__ = this;
var G__48943__$1 = this;
return (new cljs.core.RecordIter((0),G__48943__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var h__4297__auto____$1 = (function (){var fexpr__48969 = (function (coll__4436__auto__){
return (-1740346885 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__48969(this__4435__auto____$1);
})();
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this48946,other48947){
var self__ = this;
var this48946__$1 = this;
return (((!((other48947 == null)))) && ((this48946__$1.constructor === other48947.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48946__$1.children,other48947.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48946__$1.__extmap,other48947.__extmap)));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__48943){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__48985 = cljs.core.keyword_identical_QMARK_;
var expr__48986 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__48988 = new cljs.core.Keyword(null,"children","children",-940561982);
var G__48989 = expr__48986;
return (pred__48985.cljs$core$IFn$_invoke$arity$2 ? pred__48985.cljs$core$IFn$_invoke$arity$2(G__48988,G__48989) : pred__48985.call(null,G__48988,G__48989));
})())){
return (new rewrite_clj.node.fn.FnNode(G__48943,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.fn.FnNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__48943),null));
}
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__48943){
var self__ = this;
var this__4438__auto____$1 = this;
return (new rewrite_clj.node.fn.FnNode(self__.children,G__48943,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.fn.map__GT_FnNode = (function rewrite_clj$node$fn$map__GT_FnNode(G__48948){
var extmap__4478__auto__ = (function (){var G__49000 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__48948,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__48948)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__49000);
} else {
return G__49000;
}
})();
return (new rewrite_clj.node.fn.FnNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__48948),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
