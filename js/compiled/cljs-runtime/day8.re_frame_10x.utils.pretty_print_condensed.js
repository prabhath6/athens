...
if((c > n)){
var G__50249 = cut_from;
var G__50249__$1 = (((G__50249 instanceof cljs.core.Keyword))?G__50249.fqn:null);
switch (G__50249__$1) {
case "start":
...
return [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(string,(0),(function (){var G__50252 = per_side_budget;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50249__$1)].join('')));
...
var G__50299 = clojure.string.replace(s,match,trunc_prefix);
var G__50300 = limit;
var G__50301 = match;
var G__50302 = trunc_prefix;
s = G__50299;
limit = G__50300;
match = G__50301;
trunc_prefix = G__50302;
continue;
}
}
break;
...
var prefix = (function (){var G__50255 = ((kw_QMARK_)?":":"");
if(cljs.core.truth_(the_ns)){
return [G__50255,"\u2026/"].join('');
} else {
return G__50255;
}
})();
...
var vec__50257 = day8.re_frame_10x.utils.pretty_print_condensed.edges(coll);
var left = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50257,(0),null);
var right = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50257,(1),null);
...
var or__4185__auto__ = (function (){var G__50266 = form.name;
if((G__50266 == null)){
return null;
} else {
return clojure.string.replace(G__50266,/(^.*\$)(.*)/,"$2");
}
})();
...
var G__50269 = obj;
var G__50270 = writer;
var G__50271 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(opts,new cljs.core.Keyword(null,"fallback-impl","fallback-impl",-1501286995),day8.re_frame_10x.utils.pretty_print_condensed.pr_writer_impl);
return (alt_impl.cljs$core$IFn$_invoke$arity$3 ? alt_impl.cljs$core$IFn$_invoke$arity$3(G__50269,G__50270,G__50271) : alt_impl.call(null,G__50269,G__50270,G__50271));
} else {
...
var seq__50273 = cljs.core.seq(cljs.core.next(objs));
var chunk__50274 = null;
var count__50275 = (0);
var i__50276 = (0);
while(true){
if((i__50276 < count__50275)){
var obj = chunk__50274.cljs$core$IIndexed$_nth$arity$2(null,i__50276);
cljs.core._write(writer," ");

day8.re_frame_10x.utils.pretty_print_condensed.pr_writer(obj,writer,opts);


var G__50313 = seq__50273;
var G__50314 = chunk__50274;
var G__50315 = count__50275;
var G__50316 = (i__50276 + (1));
seq__50273 = G__50313;
chunk__50274 = G__50314;
count__50275 = G__50315;
i__50276 = G__50316;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__50273);
if(temp__5735__auto__){
var seq__50273__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__50273__$1)){
var c__4609__auto__ = cljs.core.chunk_first(seq__50273__$1);
var G__50317 = cljs.core.chunk_rest(seq__50273__$1);
var G__50318 = c__4609__auto__;
var G__50319 = cljs.core.count(c__4609__auto__);
var G__50320 = (0);
seq__50273 = G__50317;
chunk__50274 = G__50318;
count__50275 = G__50319;
i__50276 = G__50320;
continue;
} else {
var obj = cljs.core.first(seq__50273__$1);
cljs.core._write(writer," ");

day8.re_frame_10x.utils.pretty_print_condensed.pr_writer(obj,writer,opts);


var G__50321 = cljs.core.next(seq__50273__$1);
var G__50322 = null;
var G__50323 = (0);
var G__50324 = (0);
seq__50273 = G__50321;
chunk__50274 = G__50322;
count__50275 = G__50323;
i__50276 = G__50324;
continue;
}
} else {
...
var len__4789__auto___50333 = arguments.length;
var i__4790__auto___50334 = (0);
while(true){
if((i__4790__auto___50334 < len__4789__auto___50333)){
args__4795__auto__.push((arguments[i__4790__auto___50334]));

var G__50335 = (i__4790__auto___50334 + (1));
i__4790__auto___50334 = G__50335;
continue;
} else {
}
break;
...
/** @this {Function} */
(day8.re_frame_10x.utils.pretty_print_condensed.pr_str_truncated.cljs$lang$applyTo = (function (seq50289){
var G__50290 = cljs.core.first(seq50289);
var seq50289__$1 = cljs.core.next(seq50289);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50290,seq50289__$1);
}));
