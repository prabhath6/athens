...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k48960,else__4442__auto__){
var self__ = this;
var this__4441__auto____$1 = this;
var G__48973 = k48960;
var G__48973__$1 = (((G__48973 instanceof cljs.core.Keyword))?G__48973.fqn:null);
switch (G__48973__$1) {
case "tag":
return self__.tag;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k48960,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__48978){
var vec__48979 = p__48978;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48979,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48979,(1),null);
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__48959){
var self__ = this;
var G__48959__$1 = this;
return (new cljs.core.RecordIter((0),G__48959__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var h__4297__auto____$1 = (function (){var fexpr__48990 = (function (coll__4436__auto__){
return (580297420 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__48990(this__4435__auto____$1);
})();
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this48961,other48962){
var self__ = this;
var this48961__$1 = this;
return (((!((other48962 == null)))) && ((this48961__$1.constructor === other48962.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48961__$1.tag,other48962.tag)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48961__$1.wrap_fn,other48962.wrap_fn)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48961__$1.wrap_length,other48962.wrap_length)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48961__$1.seq_fn,other48962.seq_fn)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48961__$1.children,other48962.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48961__$1.__extmap,other48962.__extmap)));
}));
...
var self__ = this;
var this$__$1 = this;
var G__49004 = rewrite_clj.node.protocols.sexprs(self__.children);
return (self__.seq_fn.cljs$core$IFn$_invoke$arity$1 ? self__.seq_fn.cljs$core$IFn$_invoke$arity$1(G__49004) : self__.seq_fn.call(null,G__49004));
}));
...
var self__ = this;
var this$__$1 = this;
var G__49006 = rewrite_clj.node.protocols.concat_strings(self__.children);
return (self__.wrap_fn.cljs$core$IFn$_invoke$arity$1 ? self__.wrap_fn.cljs$core$IFn$_invoke$arity$1(G__49006) : self__.wrap_fn.call(null,G__49006));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__48959){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__49015 = cljs.core.keyword_identical_QMARK_;
var expr__49016 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__49018 = new cljs.core.Keyword(null,"tag","tag",-1290361223);
...
return (new rewrite_clj.node.seq.SeqNode(G__48959,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__49020 = new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130);
...
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__48959,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__49022 = new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519);
...
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,G__48959,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__49024 = new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231);
...
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,G__48959,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__49026 = new cljs.core.Keyword(null,"children","children",-940561982);
...
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,G__48959,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__48959),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__48959){
var self__ = this;
var this__4438__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,G__48959,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__48968){
var extmap__4478__auto__ = (function (){var G__49034 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__48968,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__48968)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__49034);
} else {
return G__49034;
}
})();
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__48968),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130).cljs$core$IFn$_invoke$arity$1(G__48968),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__48968),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__48968),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__48968),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),rewrite_clj.node.seq.wrap_list,(2),(function (p1__49035_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__49035_SHARP_);
}),children);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),rewrite_clj.node.seq.wrap_map,(2),(function (p1__49042_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__49042_SHARP_);
}),children);
});
