...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k30094,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k30094,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__30103){
var vec__30104 = p__30103;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30104,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30104,(1),null);
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__30093){
var self__ = this;
var G__30093__$1 = this;
return (new cljs.core.RecordIter((0),G__30093__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var h__4297__auto____$1 = (function (){var fexpr__30107 = (function (coll__4436__auto__){
return (580297420 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__30107(this__4435__auto____$1);
})();
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this30095,other30096){
var self__ = this;
var this30095__$1 = this;
return (((!((other30096 == null)))) && ((this30095__$1.constructor === other30096.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this30095__$1.tag,other30096.tag)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this30095__$1.wrap_fn,other30096.wrap_fn)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this30095__$1.wrap_length,other30096.wrap_length)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this30095__$1.seq_fn,other30096.seq_fn)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this30095__$1.children,other30096.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this30095__$1.__extmap,other30096.__extmap)));
}));
...
var self__ = this;
var this$__$1 = this;
var G__30108 = rewrite_clj.node.protocols.sexprs(self__.children);
return (self__.seq_fn.cljs$core$IFn$_invoke$arity$1 ? self__.seq_fn.cljs$core$IFn$_invoke$arity$1(G__30108) : self__.seq_fn.call(null,G__30108));
}));
...
var self__ = this;
var this$__$1 = this;
var G__30109 = rewrite_clj.node.protocols.concat_strings(self__.children);
return (self__.wrap_fn.cljs$core$IFn$_invoke$arity$1 ? self__.wrap_fn.cljs$core$IFn$_invoke$arity$1(G__30109) : self__.wrap_fn.call(null,G__30109));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__30093){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__30111 = cljs.core.keyword_identical_QMARK_;
var expr__30112 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__30114 = new cljs.core.Keyword(null,"tag","tag",-1290361223);
var G__30115 = expr__30112;
return (pred__30111.cljs$core$IFn$_invoke$arity$2 ? pred__30111.cljs$core$IFn$_invoke$arity$2(G__30114,G__30115) : pred__30111.call(null,G__30114,G__30115));
})())){
return (new rewrite_clj.node.seq.SeqNode(G__30093,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__30116 = new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130);
var G__30117 = expr__30112;
return (pred__30111.cljs$core$IFn$_invoke$arity$2 ? pred__30111.cljs$core$IFn$_invoke$arity$2(G__30116,G__30117) : pred__30111.call(null,G__30116,G__30117));
})())){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__30093,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__30118 = new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519);
var G__30119 = expr__30112;
return (pred__30111.cljs$core$IFn$_invoke$arity$2 ? pred__30111.cljs$core$IFn$_invoke$arity$2(G__30118,G__30119) : pred__30111.call(null,G__30118,G__30119));
})())){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,G__30093,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__30120 = new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231);
var G__30121 = expr__30112;
return (pred__30111.cljs$core$IFn$_invoke$arity$2 ? pred__30111.cljs$core$IFn$_invoke$arity$2(G__30120,G__30121) : pred__30111.call(null,G__30120,G__30121));
})())){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,G__30093,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__30122 = new cljs.core.Keyword(null,"children","children",-940561982);
var G__30123 = expr__30112;
return (pred__30111.cljs$core$IFn$_invoke$arity$2 ? pred__30111.cljs$core$IFn$_invoke$arity$2(G__30122,G__30123) : pred__30111.call(null,G__30122,G__30123));
})())){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,G__30093,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__30093),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__30093){
var self__ = this;
var this__4438__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,G__30093,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__30097){
var extmap__4478__auto__ = (function (){var G__30124 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__30097,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
...
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__30097),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130).cljs$core$IFn$_invoke$arity$1(G__30097),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__30097),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__30097),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__30097),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),rewrite_clj.node.seq.wrap_list,(2),(function (p1__30125_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__30125_SHARP_);
}),children);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),rewrite_clj.node.seq.wrap_map,(2),(function (p1__30131_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__30131_SHARP_);
}),children);
});
