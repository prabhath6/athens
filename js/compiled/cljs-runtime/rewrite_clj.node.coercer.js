...
var G__49395_49431 = rewrite_clj.node.protocols.coerce;
var G__49396_49432 = "object";
var G__49397_49433 = (function (v){
return rewrite_clj.node.coercer.node_with_meta(rewrite_clj.node.token.token_node.cljs$core$IFn$_invoke$arity$1(v),v);
});
goog.object.set(G__49395_49431,G__49396_49432,G__49397_49433);
goog.object.set(rewrite_clj.node.protocols.NodeCoerceable,"number",true);

var G__49399_49438 = rewrite_clj.node.protocols.coerce;
var G__49400_49439 = "number";
var G__49401_49440 = (function (n){
return rewrite_clj.node.coercer.node_with_meta(rewrite_clj.node.token.token_node.cljs$core$IFn$_invoke$arity$1(n),n);
});
goog.object.set(G__49399_49438,G__49400_49439,G__49401_49440);
goog.object.set(rewrite_clj.node.protocols.NodeCoerceable,"string",true);

var G__49404_49441 = rewrite_clj.node.protocols.coerce;
var G__49405_49442 = "string";
var G__49406_49443 = (function (n){
return rewrite_clj.node.coercer.node_with_meta(rewrite_clj.node.stringz.string_node(n),n);
});
goog.object.set(G__49404_49441,G__49405_49442,G__49406_49443);
rewrite_clj.node.coercer.seq_node = (function rewrite_clj$node$coercer$seq_node(f,sq){
return rewrite_clj.node.coercer.node_with_meta((function (){var G__49407 = cljs.core.vec(rewrite_clj.node.whitespace.space_separated(cljs.core.map.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.coerce,sq)));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__49407) : f.call(null,G__49407));
})(),sq);
});
...
var comma_49456 = rewrite_clj.node.whitespace.whitespace_node(", ");
var space_49457 = rewrite_clj.node.whitespace.whitespace_node(" ");
rewrite_clj.node.coercer.map__GT_children = (function rewrite_clj$node$coercer$map__GT_children(m){
return cljs.core.vec(cljs.core.butlast(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__49408){
var vec__49409 = p__49408;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49409,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49409,(1),null);
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [rewrite_clj.node.protocols.coerce(k),space_49457,rewrite_clj.node.protocols.coerce(v),comma_49456], null);
