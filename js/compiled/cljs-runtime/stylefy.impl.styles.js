...
stylefy.impl.styles.create_style_BANG_ = (function stylefy$impl$styles$create_style_BANG_(p__40571,style_created_handler){
var map__40572 = p__40571;
var map__40572__$1 = (((((!((map__40572 == null))))?(((((map__40572.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__40572.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__40572):map__40572);
var style = map__40572__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40572__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40572__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var style_css = stylefy.impl.conversion.style__GT_css.cljs$core$IFn$_invoke$arity$1(style);
var G__40576_40665 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"css","css",1135045163),style_css,new cljs.core.Keyword(null,"hash","hash",-13781596),hash], null);
(style_created_handler.cljs$core$IFn$_invoke$arity$1 ? style_created_handler.cljs$core$IFn$_invoke$arity$1(G__40576_40665) : style_created_handler.call(null,G__40576_40665));
...
var G__40587_40666 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__40588_40667 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__40587_40666,G__40588_40667) : stylefy.impl.styles.create_style_BANG_.call(null,G__40587_40666,G__40588_40667));


var G__40670 = seq__40577;
var G__40671 = chunk__40578;
var G__40672 = count__40579;
var G__40673 = (i__40580 + (1));
seq__40577 = G__40670;
chunk__40578 = G__40671;
count__40579 = G__40672;
i__40580 = G__40673;
continue;
} else {
...
var G__40674 = cljs.core.chunk_rest(seq__40577__$1);
var G__40675 = c__4609__auto__;
var G__40676 = cljs.core.count(c__4609__auto__);
var G__40677 = (0);
seq__40577 = G__40674;
chunk__40578 = G__40675;
count__40579 = G__40676;
i__40580 = G__40677;
continue;
} else {
var sub_style = cljs.core.first(seq__40577__$1);
var G__40592_40679 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__40593_40680 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__40592_40679,G__40593_40680) : stylefy.impl.styles.create_style_BANG_.call(null,G__40592_40679,G__40593_40680));


var G__40681 = cljs.core.next(seq__40577__$1);
var G__40682 = null;
var G__40683 = (0);
var G__40684 = (0);
seq__40577 = G__40681;
chunk__40578 = G__40682;
count__40579 = G__40683;
i__40580 = G__40684;
continue;
}
} else {
...
if((((class$ == null)) || (typeof class$ === 'string') || ((class$ instanceof cljs.core.Keyword)) || (((cljs.core.vector_QMARK_(class$)) && (cljs.core.every_QMARK_((function (p1__40596_SHARP_){
return ((typeof p1__40596_SHARP_ === 'string') || ((p1__40596_SHARP_ instanceof cljs.core.Keyword)) || ((p1__40596_SHARP_ == null)));
}),class$)))))){
return null;
} else {
throw (new Error(["Assert failed: ",["Unsupported ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(origin)," type. It should be nil, keyword, string or vector of strings/keywords). Got: ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([class$], 0))].join(''),"\n","(or (nil? class) (string? class) (keyword? class) (and (vector? class) (every? (fn* [p1__40596#] (or (string? p1__40596#) (keyword? p1__40596#) (nil? p1__40596#))) class)))"].join('')));
}
});
/**
...
var len__4789__auto___40704 = arguments.length;
var i__4790__auto___40705 = (0);
while(true){
if((i__4790__auto___40705 < len__4789__auto___40704)){
args__4795__auto__.push((arguments[i__4790__auto___40705]));

var G__40707 = (i__4790__auto___40705 + (1));
i__4790__auto___40705 = G__40707;
continue;
} else {
}
break;
...
var resolved_sub_style = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__40633_SHARP_,p2__40634_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__40633_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432),p2__40634_SHARP_], null));
}),style,sub_styles);
if(cljs.core.truth_(resolved_sub_style)){
...
/** @this {Function} */
(stylefy.impl.styles.sub_style.cljs$lang$applyTo = (function (seq40635){
var G__40636 = cljs.core.first(seq40635);
var seq40635__$1 = cljs.core.next(seq40635);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40636,seq40635__$1);
}));
...
var styles_40716__$1 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,styles);
var seq__40643_40718 = cljs.core.seq(styles_40716__$1);
var chunk__40644_40719 = null;
var count__40645_40720 = (0);
var i__40646_40721 = (0);
while(true){
if((i__40646_40721 < count__40645_40720)){
var style_40722 = chunk__40644_40719.cljs$core$IIndexed$_nth$arity$2(null,i__40646_40721);
stylefy.impl.styles.use_style_BANG_(style_40722,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___40723 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_40722));
if(cljs.core.truth_(temp__5735__auto___40723)){
var sub_styles_40724 = temp__5735__auto___40723;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_40724,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__40726 = seq__40643_40718;
var G__40727 = chunk__40644_40719;
var G__40728 = count__40645_40720;
var G__40729 = (i__40646_40721 + (1));
seq__40643_40718 = G__40726;
chunk__40644_40719 = G__40727;
count__40645_40720 = G__40728;
i__40646_40721 = G__40729;
continue;
} else {
var temp__5735__auto___40730 = cljs.core.seq(seq__40643_40718);
if(temp__5735__auto___40730){
var seq__40643_40731__$1 = temp__5735__auto___40730;
if(cljs.core.chunked_seq_QMARK_(seq__40643_40731__$1)){
var c__4609__auto___40733 = cljs.core.chunk_first(seq__40643_40731__$1);
var G__40734 = cljs.core.chunk_rest(seq__40643_40731__$1);
var G__40735 = c__4609__auto___40733;
var G__40736 = cljs.core.count(c__4609__auto___40733);
var G__40737 = (0);
seq__40643_40718 = G__40734;
chunk__40644_40719 = G__40735;
count__40645_40720 = G__40736;
i__40646_40721 = G__40737;
continue;
} else {
var style_40739 = cljs.core.first(seq__40643_40731__$1);
stylefy.impl.styles.use_style_BANG_(style_40739,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___40740__$1 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_40739));
if(cljs.core.truth_(temp__5735__auto___40740__$1)){
var sub_styles_40741 = temp__5735__auto___40740__$1;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_40741,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__40743 = cljs.core.next(seq__40643_40731__$1);
var G__40744 = null;
var G__40745 = (0);
var G__40746 = (0);
seq__40643_40718 = G__40743;
chunk__40644_40719 = G__40744;
count__40645_40720 = G__40745;
i__40646_40721 = G__40746;
continue;
}
} else {
}
