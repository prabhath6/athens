...
stylefy.impl.styles.create_style_BANG_ = (function stylefy$impl$styles$create_style_BANG_(p__40548,style_created_handler){
...
var style = map__40549__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40549__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40549__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var style_css = stylefy.impl.conversion.style__GT_css.cljs$core$IFn$_invoke$arity$1(style);
var G__40554_40623 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"css","css",1135045163),style_css,new cljs.core.Keyword(null,"hash","hash",-13781596),hash], null);
(style_created_handler.cljs$core$IFn$_invoke$arity$1 ? style_created_handler.cljs$core$IFn$_invoke$arity$1(G__40554_40623) : style_created_handler.call(null,G__40554_40623));

var seq__40555 = cljs.core.seq(cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(props)));
var chunk__40556 = null;
var count__40557 = (0);
var i__40558 = (0);
while(true){
if((i__40558 < count__40557)){
var sub_style = chunk__40556.cljs$core$IIndexed$_nth$arity$2(null,i__40558);
var G__40568_40625 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__40569_40626 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__40568_40625,G__40569_40626) : stylefy.impl.styles.create_style_BANG_.call(null,G__40568_40625,G__40569_40626));


var G__40628 = seq__40555;
var G__40629 = chunk__40556;
var G__40630 = count__40557;
var G__40631 = (i__40558 + (1));
seq__40555 = G__40628;
chunk__40556 = G__40629;
count__40557 = G__40630;
i__40558 = G__40631;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__40555);
if(temp__5735__auto__){
var seq__40555__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__40555__$1)){
var c__4609__auto__ = cljs.core.chunk_first(seq__40555__$1);
var G__40632 = cljs.core.chunk_rest(seq__40555__$1);
var G__40633 = c__4609__auto__;
var G__40634 = cljs.core.count(c__4609__auto__);
var G__40635 = (0);
seq__40555 = G__40632;
chunk__40556 = G__40633;
count__40557 = G__40634;
i__40558 = G__40635;
continue;
} else {
var sub_style = cljs.core.first(seq__40555__$1);
var G__40571_40638 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__40572_40639 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__40571_40638,G__40572_40639) : stylefy.impl.styles.create_style_BANG_.call(null,G__40571_40638,G__40572_40639));


var G__40641 = cljs.core.next(seq__40555__$1);
var G__40642 = null;
var G__40643 = (0);
var G__40644 = (0);
seq__40555 = G__40641;
chunk__40556 = G__40642;
count__40557 = G__40643;
i__40558 = G__40644;
continue;
}
} else {
...
var len__4789__auto___40661 = arguments.length;
var i__4790__auto___40662 = (0);
while(true){
if((i__4790__auto___40662 < len__4789__auto___40661)){
args__4795__auto__.push((arguments[i__4790__auto___40662]));

var G__40663 = (i__4790__auto___40662 + (1));
i__4790__auto___40662 = G__40663;
continue;
} else {
}
break;
...
var resolved_sub_style = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__40583_SHARP_,p2__40584_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__40583_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432),p2__40584_SHARP_], null));
}),style,sub_styles);
if(cljs.core.truth_(resolved_sub_style)){
...
/** @this {Function} */
(stylefy.impl.styles.sub_style.cljs$lang$applyTo = (function (seq40585){
var G__40586 = cljs.core.first(seq40585);
var seq40585__$1 = cljs.core.next(seq40585);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40586,seq40585__$1);
}));

stylefy.impl.styles.prepare_styles = (function stylefy$impl$styles$prepare_styles(var_args){
var G__40593 = arguments.length;
switch (G__40593) {
case 1:
...
(stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2 = (function (styles,p__40596){
var map__40597 = p__40596;
var map__40597__$1 = (((((!((map__40597 == null))))?(((((map__40597.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__40597.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__40597):map__40597);
var options = map__40597__$1;
var request_dom_update_after_done_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40597__$1,new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510));
var styles_40668__$1 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,styles);
var seq__40599_40669 = cljs.core.seq(styles_40668__$1);
var chunk__40600_40670 = null;
var count__40601_40671 = (0);
var i__40602_40672 = (0);
while(true){
if((i__40602_40672 < count__40601_40671)){
var style_40673 = chunk__40600_40670.cljs$core$IIndexed$_nth$arity$2(null,i__40602_40672);
stylefy.impl.styles.use_style_BANG_(style_40673,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___40674 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_40673));
if(cljs.core.truth_(temp__5735__auto___40674)){
var sub_styles_40675 = temp__5735__auto___40674;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_40675,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__40676 = seq__40599_40669;
var G__40677 = chunk__40600_40670;
var G__40678 = count__40601_40671;
var G__40679 = (i__40602_40672 + (1));
seq__40599_40669 = G__40676;
chunk__40600_40670 = G__40677;
count__40601_40671 = G__40678;
i__40602_40672 = G__40679;
continue;
} else {
var temp__5735__auto___40680 = cljs.core.seq(seq__40599_40669);
if(temp__5735__auto___40680){
var seq__40599_40681__$1 = temp__5735__auto___40680;
if(cljs.core.chunked_seq_QMARK_(seq__40599_40681__$1)){
var c__4609__auto___40682 = cljs.core.chunk_first(seq__40599_40681__$1);
var G__40683 = cljs.core.chunk_rest(seq__40599_40681__$1);
var G__40684 = c__4609__auto___40682;
var G__40685 = cljs.core.count(c__4609__auto___40682);
var G__40686 = (0);
seq__40599_40669 = G__40683;
chunk__40600_40670 = G__40684;
count__40601_40671 = G__40685;
i__40602_40672 = G__40686;
continue;
} else {
var style_40687 = cljs.core.first(seq__40599_40681__$1);
stylefy.impl.styles.use_style_BANG_(style_40687,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___40688__$1 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_40687));
if(cljs.core.truth_(temp__5735__auto___40688__$1)){
var sub_styles_40689 = temp__5735__auto___40688__$1;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_40689,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__40690 = cljs.core.next(seq__40599_40681__$1);
var G__40691 = null;
var G__40692 = (0);
var G__40693 = (0);
seq__40599_40669 = G__40690;
chunk__40600_40670 = G__40691;
count__40601_40671 = G__40692;
i__40602_40672 = G__40693;
continue;
}
} else {
}
