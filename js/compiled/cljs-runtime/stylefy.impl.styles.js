...
var style = map__40579__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40579__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40579__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var style_css = stylefy.impl.conversion.style__GT_css.cljs$core$IFn$_invoke$arity$1(style);
var G__40582_40654 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"css","css",1135045163),style_css,new cljs.core.Keyword(null,"hash","hash",-13781596),hash], null);
(style_created_handler.cljs$core$IFn$_invoke$arity$1 ? style_created_handler.cljs$core$IFn$_invoke$arity$1(G__40582_40654) : style_created_handler.call(null,G__40582_40654));

var seq__40583 = cljs.core.seq(cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(props)));
var chunk__40584 = null;
var count__40585 = (0);
var i__40586 = (0);
while(true){
if((i__40586 < count__40585)){
var sub_style = chunk__40584.cljs$core$IIndexed$_nth$arity$2(null,i__40586);
var G__40594_40656 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__40595_40657 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__40594_40656,G__40595_40657) : stylefy.impl.styles.create_style_BANG_.call(null,G__40594_40656,G__40595_40657));


var G__40660 = seq__40583;
var G__40661 = chunk__40584;
var G__40662 = count__40585;
var G__40663 = (i__40586 + (1));
seq__40583 = G__40660;
chunk__40584 = G__40661;
count__40585 = G__40662;
i__40586 = G__40663;
continue;
} else {
...
var c__4609__auto__ = cljs.core.chunk_first(seq__40583__$1);
var G__40664 = cljs.core.chunk_rest(seq__40583__$1);
var G__40665 = c__4609__auto__;
var G__40666 = cljs.core.count(c__4609__auto__);
var G__40667 = (0);
seq__40583 = G__40664;
chunk__40584 = G__40665;
count__40585 = G__40666;
i__40586 = G__40667;
continue;
} else {
var sub_style = cljs.core.first(seq__40583__$1);
var G__40598_40670 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__40599_40671 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__40598_40670,G__40599_40671) : stylefy.impl.styles.create_style_BANG_.call(null,G__40598_40670,G__40599_40671));


var G__40672 = cljs.core.next(seq__40583__$1);
var G__40673 = null;
var G__40674 = (0);
var G__40675 = (0);
seq__40583 = G__40672;
chunk__40584 = G__40673;
count__40585 = G__40674;
i__40586 = G__40675;
continue;
}
} else {
...
if((((class$ == null)) || (typeof class$ === 'string') || ((class$ instanceof cljs.core.Keyword)) || (((cljs.core.vector_QMARK_(class$)) && (cljs.core.every_QMARK_((function (p1__40601_SHARP_){
return ((typeof p1__40601_SHARP_ === 'string') || ((p1__40601_SHARP_ instanceof cljs.core.Keyword)) || ((p1__40601_SHARP_ == null)));
}),class$)))))){
return null;
} else {
throw (new Error(["Assert failed: ",["Unsupported ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(origin)," type. It should be nil, keyword, string or vector of strings/keywords). Got: ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([class$], 0))].join(''),"\n","(or (nil? class) (string? class) (keyword? class) (and (vector? class) (every? (fn* [p1__40601#] (or (string? p1__40601#) (keyword? p1__40601#) (nil? p1__40601#))) class)))"].join('')));
}
});
/**
...
var styles_40708__$1 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,styles);
var seq__40643_40709 = cljs.core.seq(styles_40708__$1);
var chunk__40644_40710 = null;
var count__40645_40711 = (0);
var i__40646_40712 = (0);
while(true){
if((i__40646_40712 < count__40645_40711)){
var style_40713 = chunk__40644_40710.cljs$core$IIndexed$_nth$arity$2(null,i__40646_40712);
stylefy.impl.styles.use_style_BANG_(style_40713,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___40715 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_40713));
if(cljs.core.truth_(temp__5735__auto___40715)){
var sub_styles_40717 = temp__5735__auto___40715;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_40717,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__40719 = seq__40643_40709;
var G__40720 = chunk__40644_40710;
var G__40721 = count__40645_40711;
var G__40722 = (i__40646_40712 + (1));
seq__40643_40709 = G__40719;
chunk__40644_40710 = G__40720;
count__40645_40711 = G__40721;
i__40646_40712 = G__40722;
continue;
} else {
var temp__5735__auto___40724 = cljs.core.seq(seq__40643_40709);
if(temp__5735__auto___40724){
var seq__40643_40725__$1 = temp__5735__auto___40724;
if(cljs.core.chunked_seq_QMARK_(seq__40643_40725__$1)){
var c__4609__auto___40727 = cljs.core.chunk_first(seq__40643_40725__$1);
var G__40728 = cljs.core.chunk_rest(seq__40643_40725__$1);
var G__40729 = c__4609__auto___40727;
var G__40730 = cljs.core.count(c__4609__auto___40727);
var G__40731 = (0);
seq__40643_40709 = G__40728;
chunk__40644_40710 = G__40729;
count__40645_40711 = G__40730;
i__40646_40712 = G__40731;
continue;
} else {
var style_40732 = cljs.core.first(seq__40643_40725__$1);
stylefy.impl.styles.use_style_BANG_(style_40732,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___40734__$1 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_40732));
if(cljs.core.truth_(temp__5735__auto___40734__$1)){
var sub_styles_40735 = temp__5735__auto___40734__$1;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_40735,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__40737 = cljs.core.next(seq__40643_40725__$1);
var G__40738 = null;
var G__40739 = (0);
var G__40740 = (0);
seq__40643_40709 = G__40737;
chunk__40644_40710 = G__40738;
count__40645_40711 = G__40739;
i__40646_40712 = G__40740;
continue;
}
} else {
}
