...
stylefy.impl.styles.create_style_BANG_ = (function stylefy$impl$styles$create_style_BANG_(p__40583,style_created_handler){
var map__40584 = p__40583;
var map__40584__$1 = (((((!((map__40584 == null))))?(((((map__40584.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__40584.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__40584):map__40584);
var style = map__40584__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40584__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40584__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var style_css = stylefy.impl.conversion.style__GT_css.cljs$core$IFn$_invoke$arity$1(style);
var G__40587_40663 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"css","css",1135045163),style_css,new cljs.core.Keyword(null,"hash","hash",-13781596),hash], null);
(style_created_handler.cljs$core$IFn$_invoke$arity$1 ? style_created_handler.cljs$core$IFn$_invoke$arity$1(G__40587_40663) : style_created_handler.call(null,G__40587_40663));

var seq__40588 = cljs.core.seq(cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(props)));
var chunk__40589 = null;
var count__40590 = (0);
var i__40591 = (0);
while(true){
if((i__40591 < count__40590)){
var sub_style = chunk__40589.cljs$core$IIndexed$_nth$arity$2(null,i__40591);
var G__40601_40666 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__40602_40667 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__40601_40666,G__40602_40667) : stylefy.impl.styles.create_style_BANG_.call(null,G__40601_40666,G__40602_40667));


var G__40668 = seq__40588;
var G__40669 = chunk__40589;
var G__40670 = count__40590;
var G__40671 = (i__40591 + (1));
seq__40588 = G__40668;
chunk__40589 = G__40669;
count__40590 = G__40670;
i__40591 = G__40671;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__40588);
if(temp__5735__auto__){
var seq__40588__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__40588__$1)){
var c__4609__auto__ = cljs.core.chunk_first(seq__40588__$1);
var G__40673 = cljs.core.chunk_rest(seq__40588__$1);
var G__40674 = c__4609__auto__;
var G__40675 = cljs.core.count(c__4609__auto__);
var G__40676 = (0);
seq__40588 = G__40673;
chunk__40589 = G__40674;
count__40590 = G__40675;
i__40591 = G__40676;
continue;
} else {
var sub_style = cljs.core.first(seq__40588__$1);
var G__40605_40678 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__40606_40679 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__40605_40678,G__40606_40679) : stylefy.impl.styles.create_style_BANG_.call(null,G__40605_40678,G__40606_40679));


var G__40680 = cljs.core.next(seq__40588__$1);
var G__40681 = null;
var G__40682 = (0);
var G__40683 = (0);
seq__40588 = G__40680;
chunk__40589 = G__40681;
count__40590 = G__40682;
i__40591 = G__40683;
continue;
}
} else {
...
if((((class$ == null)) || (typeof class$ === 'string') || ((class$ instanceof cljs.core.Keyword)) || (((cljs.core.vector_QMARK_(class$)) && (cljs.core.every_QMARK_((function (p1__40610_SHARP_){
return ((typeof p1__40610_SHARP_ === 'string') || ((p1__40610_SHARP_ instanceof cljs.core.Keyword)) || ((p1__40610_SHARP_ == null)));
}),class$)))))){
return null;
} else {
throw (new Error(["Assert failed: ",["Unsupported ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(origin)," type. It should be nil, keyword, string or vector of strings/keywords). Got: ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([class$], 0))].join(''),"\n","(or (nil? class) (string? class) (keyword? class) (and (vector? class) (every? (fn* [p1__40610#] (or (string? p1__40610#) (keyword? p1__40610#) (nil? p1__40610#))) class)))"].join('')));
}
});
/**
...
var len__4789__auto___40707 = arguments.length;
var i__4790__auto___40708 = (0);
while(true){
if((i__4790__auto___40708 < len__4789__auto___40707)){
args__4795__auto__.push((arguments[i__4790__auto___40708]));

var G__40710 = (i__4790__auto___40708 + (1));
i__4790__auto___40708 = G__40710;
continue;
} else {
}
break;
...
var resolved_sub_style = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__40634_SHARP_,p2__40635_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__40634_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432),p2__40635_SHARP_], null));
}),style,sub_styles);
if(cljs.core.truth_(resolved_sub_style)){
...
/** @this {Function} */
(stylefy.impl.styles.sub_style.cljs$lang$applyTo = (function (seq40636){
var G__40637 = cljs.core.first(seq40636);
var seq40636__$1 = cljs.core.next(seq40636);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40637,seq40636__$1);
}));
...
(stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2 = (function (styles,p__40643){
var map__40644 = p__40643;
var map__40644__$1 = (((((!((map__40644 == null))))?(((((map__40644.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__40644.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__40644):map__40644);
var options = map__40644__$1;
var request_dom_update_after_done_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40644__$1,new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510));
var styles_40717__$1 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,styles);
var seq__40649_40718 = cljs.core.seq(styles_40717__$1);
var chunk__40650_40719 = null;
var count__40651_40720 = (0);
var i__40652_40721 = (0);
while(true){
if((i__40652_40721 < count__40651_40720)){
var style_40723 = chunk__40650_40719.cljs$core$IIndexed$_nth$arity$2(null,i__40652_40721);
stylefy.impl.styles.use_style_BANG_(style_40723,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___40724 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_40723));
if(cljs.core.truth_(temp__5735__auto___40724)){
var sub_styles_40726 = temp__5735__auto___40724;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_40726,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__40728 = seq__40649_40718;
var G__40729 = chunk__40650_40719;
var G__40730 = count__40651_40720;
var G__40731 = (i__40652_40721 + (1));
seq__40649_40718 = G__40728;
chunk__40650_40719 = G__40729;
count__40651_40720 = G__40730;
i__40652_40721 = G__40731;
continue;
} else {
var temp__5735__auto___40733 = cljs.core.seq(seq__40649_40718);
if(temp__5735__auto___40733){
var seq__40649_40734__$1 = temp__5735__auto___40733;
if(cljs.core.chunked_seq_QMARK_(seq__40649_40734__$1)){
var c__4609__auto___40735 = cljs.core.chunk_first(seq__40649_40734__$1);
var G__40736 = cljs.core.chunk_rest(seq__40649_40734__$1);
var G__40737 = c__4609__auto___40735;
var G__40738 = cljs.core.count(c__4609__auto___40735);
var G__40739 = (0);
seq__40649_40718 = G__40736;
chunk__40650_40719 = G__40737;
count__40651_40720 = G__40738;
i__40652_40721 = G__40739;
continue;
} else {
var style_40740 = cljs.core.first(seq__40649_40734__$1);
stylefy.impl.styles.use_style_BANG_(style_40740,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___40741__$1 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_40740));
if(cljs.core.truth_(temp__5735__auto___40741__$1)){
var sub_styles_40742 = temp__5735__auto___40741__$1;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_40742,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__40743 = cljs.core.next(seq__40649_40734__$1);
var G__40744 = null;
var G__40745 = (0);
var G__40746 = (0);
seq__40649_40718 = G__40743;
chunk__40650_40719 = G__40744;
count__40651_40720 = G__40745;
i__40652_40721 = G__40746;
continue;
}
} else {
}
