...
var G__40563_40647 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"css","css",1135045163),style_css,new cljs.core.Keyword(null,"hash","hash",-13781596),hash], null);
(style_created_handler.cljs$core$IFn$_invoke$arity$1 ? style_created_handler.cljs$core$IFn$_invoke$arity$1(G__40563_40647) : style_created_handler.call(null,G__40563_40647));
...
var G__40577_40650 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__40578_40652 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__40577_40650,G__40578_40652) : stylefy.impl.styles.create_style_BANG_.call(null,G__40577_40650,G__40578_40652));


var G__40653 = seq__40565;
var G__40654 = chunk__40566;
var G__40655 = count__40567;
var G__40656 = (i__40568 + (1));
seq__40565 = G__40653;
chunk__40566 = G__40654;
count__40567 = G__40655;
i__40568 = G__40656;
continue;
} else {
...
var G__40657 = cljs.core.chunk_rest(seq__40565__$1);
var G__40658 = c__4609__auto__;
var G__40659 = cljs.core.count(c__4609__auto__);
var G__40660 = (0);
seq__40565 = G__40657;
chunk__40566 = G__40658;
count__40567 = G__40659;
i__40568 = G__40660;
continue;
} else {
var sub_style = cljs.core.first(seq__40565__$1);
var G__40580_40663 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__40581_40664 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__40580_40663,G__40581_40664) : stylefy.impl.styles.create_style_BANG_.call(null,G__40580_40663,G__40581_40664));


var G__40666 = cljs.core.next(seq__40565__$1);
var G__40667 = null;
var G__40668 = (0);
var G__40669 = (0);
seq__40565 = G__40666;
chunk__40566 = G__40667;
count__40567 = G__40668;
i__40568 = G__40669;
continue;
}
} else {
...
if((((class$ == null)) || (typeof class$ === 'string') || ((class$ instanceof cljs.core.Keyword)) || (((cljs.core.vector_QMARK_(class$)) && (cljs.core.every_QMARK_((function (p1__40586_SHARP_){
return ((typeof p1__40586_SHARP_ === 'string') || ((p1__40586_SHARP_ instanceof cljs.core.Keyword)) || ((p1__40586_SHARP_ == null)));
}),class$)))))){
return null;
} else {
throw (new Error(["Assert failed: ",["Unsupported ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(origin)," type. It should be nil, keyword, string or vector of strings/keywords). Got: ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([class$], 0))].join(''),"\n","(or (nil? class) (string? class) (keyword? class) (and (vector? class) (every? (fn* [p1__40586#] (or (string? p1__40586#) (keyword? p1__40586#) (nil? p1__40586#))) class)))"].join('')));
}
});
/**
...
var resolved_sub_style = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__40610_SHARP_,p2__40611_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__40610_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432),p2__40611_SHARP_], null));
}),style,sub_styles);
if(cljs.core.truth_(resolved_sub_style)){
...
/** @this {Function} */
(stylefy.impl.styles.sub_style.cljs$lang$applyTo = (function (seq40613){
...
(stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2 = (function (styles,p__40624){
...
var options = map__40625__$1;
var request_dom_update_after_done_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40625__$1,new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510));
var styles_40680__$1 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,styles);
var seq__40631_40681 = cljs.core.seq(styles_40680__$1);
var chunk__40632_40682 = null;
var count__40633_40683 = (0);
var i__40634_40684 = (0);
while(true){
if((i__40634_40684 < count__40633_40683)){
var style_40685 = chunk__40632_40682.cljs$core$IIndexed$_nth$arity$2(null,i__40634_40684);
stylefy.impl.styles.use_style_BANG_(style_40685,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___40688 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_40685));
if(cljs.core.truth_(temp__5735__auto___40688)){
var sub_styles_40689 = temp__5735__auto___40688;
...
var G__40692 = seq__40631_40681;
var G__40693 = chunk__40632_40682;
var G__40694 = count__40633_40683;
var G__40695 = (i__40634_40684 + (1));
seq__40631_40681 = G__40692;
chunk__40632_40682 = G__40693;
count__40633_40683 = G__40694;
i__40634_40684 = G__40695;
continue;
} else {
var temp__5735__auto___40697 = cljs.core.seq(seq__40631_40681);
if(temp__5735__auto___40697){
var seq__40631_40699__$1 = temp__5735__auto___40697;
if(cljs.core.chunked_seq_QMARK_(seq__40631_40699__$1)){
var c__4609__auto___40700 = cljs.core.chunk_first(seq__40631_40699__$1);
var G__40701 = cljs.core.chunk_rest(seq__40631_40699__$1);
var G__40702 = c__4609__auto___40700;
var G__40703 = cljs.core.count(c__4609__auto___40700);
var G__40704 = (0);
seq__40631_40681 = G__40701;
chunk__40632_40682 = G__40702;
count__40633_40683 = G__40703;
i__40634_40684 = G__40704;
continue;
} else {
var style_40705 = cljs.core.first(seq__40631_40699__$1);
stylefy.impl.styles.use_style_BANG_(style_40705,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___40706__$1 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_40705));
if(cljs.core.truth_(temp__5735__auto___40706__$1)){
var sub_styles_40707 = temp__5735__auto___40706__$1;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_40707,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__40708 = cljs.core.next(seq__40631_40699__$1);
var G__40709 = null;
var G__40710 = (0);
var G__40711 = (0);
seq__40631_40681 = G__40708;
chunk__40632_40682 = G__40709;
count__40633_40683 = G__40710;
i__40634_40684 = G__40711;
continue;
}
} else {
}
