...
stylefy.impl.styles.create_style_BANG_ = (function stylefy$impl$styles$create_style_BANG_(p__40559,style_created_handler){
var map__40560 = p__40559;
var map__40560__$1 = (((((!((map__40560 == null))))?(((((map__40560.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__40560.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__40560):map__40560);
var style = map__40560__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40560__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40560__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var style_css = stylefy.impl.conversion.style__GT_css.cljs$core$IFn$_invoke$arity$1(style);
var G__40562_40647 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"css","css",1135045163),style_css,new cljs.core.Keyword(null,"hash","hash",-13781596),hash], null);
(style_created_handler.cljs$core$IFn$_invoke$arity$1 ? style_created_handler.cljs$core$IFn$_invoke$arity$1(G__40562_40647) : style_created_handler.call(null,G__40562_40647));

var seq__40563 = cljs.core.seq(cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(props)));
var chunk__40564 = null;
var count__40565 = (0);
var i__40566 = (0);
while(true){
if((i__40566 < count__40565)){
var sub_style = chunk__40564.cljs$core$IIndexed$_nth$arity$2(null,i__40566);
var G__40571_40648 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__40572_40649 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__40571_40648,G__40572_40649) : stylefy.impl.styles.create_style_BANG_.call(null,G__40571_40648,G__40572_40649));


var G__40650 = seq__40563;
var G__40651 = chunk__40564;
var G__40652 = count__40565;
var G__40653 = (i__40566 + (1));
seq__40563 = G__40650;
chunk__40564 = G__40651;
count__40565 = G__40652;
i__40566 = G__40653;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__40563);
if(temp__5735__auto__){
var seq__40563__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__40563__$1)){
var c__4609__auto__ = cljs.core.chunk_first(seq__40563__$1);
var G__40654 = cljs.core.chunk_rest(seq__40563__$1);
var G__40655 = c__4609__auto__;
var G__40656 = cljs.core.count(c__4609__auto__);
var G__40657 = (0);
seq__40563 = G__40654;
chunk__40564 = G__40655;
count__40565 = G__40656;
i__40566 = G__40657;
continue;
} else {
var sub_style = cljs.core.first(seq__40563__$1);
var G__40573_40658 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__40574_40659 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__40573_40658,G__40574_40659) : stylefy.impl.styles.create_style_BANG_.call(null,G__40573_40658,G__40574_40659));


var G__40660 = cljs.core.next(seq__40563__$1);
var G__40661 = null;
var G__40662 = (0);
var G__40663 = (0);
seq__40563 = G__40660;
chunk__40564 = G__40661;
count__40565 = G__40662;
i__40566 = G__40663;
continue;
}
} else {
...
if((((class$ == null)) || (typeof class$ === 'string') || ((class$ instanceof cljs.core.Keyword)) || (((cljs.core.vector_QMARK_(class$)) && (cljs.core.every_QMARK_((function (p1__40577_SHARP_){
return ((typeof p1__40577_SHARP_ === 'string') || ((p1__40577_SHARP_ instanceof cljs.core.Keyword)) || ((p1__40577_SHARP_ == null)));
}),class$)))))){
return null;
} else {
throw (new Error(["Assert failed: ",["Unsupported ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(origin)," type. It should be nil, keyword, string or vector of strings/keywords). Got: ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([class$], 0))].join(''),"\n","(or (nil? class) (string? class) (keyword? class) (and (vector? class) (every? (fn* [p1__40577#] (or (string? p1__40577#) (keyword? p1__40577#) (nil? p1__40577#))) class)))"].join('')));
}
});
/**
...
var len__4789__auto___40670 = arguments.length;
var i__4790__auto___40671 = (0);
while(true){
if((i__4790__auto___40671 < len__4789__auto___40670)){
args__4795__auto__.push((arguments[i__4790__auto___40671]));

var G__40672 = (i__4790__auto___40671 + (1));
i__4790__auto___40671 = G__40672;
continue;
} else {
}
break;
...
var resolved_sub_style = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__40601_SHARP_,p2__40602_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__40601_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432),p2__40602_SHARP_], null));
}),style,sub_styles);
if(cljs.core.truth_(resolved_sub_style)){
...
/** @this {Function} */
(stylefy.impl.styles.sub_style.cljs$lang$applyTo = (function (seq40603){
var G__40604 = cljs.core.first(seq40603);
var seq40603__$1 = cljs.core.next(seq40603);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40604,seq40603__$1);
}));
...
(stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2 = (function (styles,p__40616){
var map__40617 = p__40616;
var map__40617__$1 = (((((!((map__40617 == null))))?(((((map__40617.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__40617.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__40617):map__40617);
var options = map__40617__$1;
var request_dom_update_after_done_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40617__$1,new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510));
var styles_40674__$1 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,styles);
var seq__40620_40675 = cljs.core.seq(styles_40674__$1);
var chunk__40621_40676 = null;
var count__40622_40677 = (0);
var i__40623_40678 = (0);
while(true){
if((i__40623_40678 < count__40622_40677)){
var style_40679 = chunk__40621_40676.cljs$core$IIndexed$_nth$arity$2(null,i__40623_40678);
stylefy.impl.styles.use_style_BANG_(style_40679,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___40681 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_40679));
if(cljs.core.truth_(temp__5735__auto___40681)){
var sub_styles_40682 = temp__5735__auto___40681;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_40682,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__40684 = seq__40620_40675;
var G__40685 = chunk__40621_40676;
var G__40686 = count__40622_40677;
var G__40687 = (i__40623_40678 + (1));
seq__40620_40675 = G__40684;
chunk__40621_40676 = G__40685;
count__40622_40677 = G__40686;
i__40623_40678 = G__40687;
continue;
} else {
var temp__5735__auto___40689 = cljs.core.seq(seq__40620_40675);
if(temp__5735__auto___40689){
var seq__40620_40690__$1 = temp__5735__auto___40689;
if(cljs.core.chunked_seq_QMARK_(seq__40620_40690__$1)){
var c__4609__auto___40691 = cljs.core.chunk_first(seq__40620_40690__$1);
var G__40693 = cljs.core.chunk_rest(seq__40620_40690__$1);
var G__40694 = c__4609__auto___40691;
var G__40695 = cljs.core.count(c__4609__auto___40691);
var G__40696 = (0);
seq__40620_40675 = G__40693;
chunk__40621_40676 = G__40694;
count__40622_40677 = G__40695;
i__40623_40678 = G__40696;
continue;
} else {
var style_40697 = cljs.core.first(seq__40620_40690__$1);
stylefy.impl.styles.use_style_BANG_(style_40697,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___40698__$1 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_40697));
if(cljs.core.truth_(temp__5735__auto___40698__$1)){
var sub_styles_40700 = temp__5735__auto___40698__$1;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_40700,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__40702 = cljs.core.next(seq__40620_40690__$1);
var G__40703 = null;
var G__40704 = (0);
var G__40705 = (0);
seq__40620_40675 = G__40702;
chunk__40621_40676 = G__40703;
count__40622_40677 = G__40704;
i__40623_40678 = G__40705;
continue;
}
} else {
}
