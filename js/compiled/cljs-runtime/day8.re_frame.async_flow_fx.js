 ...
 */
day8.re_frame.async_flow_fx.dissoc_in = (function day8$re_frame$async_flow_fx$dissoc_in(m,p__52087){
...
var G__52095 = new cljs.core.Keyword(null,"events","events",1792552201).cljs$core$IFn$_invoke$arity$1(task);
var G__52096 = now_seen_events;
var fexpr__52094 = new cljs.core.Keyword(null,"when","when",-576417306).cljs$core$IFn$_invoke$arity$1(task);
return (fexpr__52094.cljs$core$IFn$_invoke$arity$2 ? fexpr__52094.cljs$core$IFn$_invoke$arity$2(G__52095,G__52096) : fexpr__52094.call(null,G__52095,G__52096));
...
var G__52097 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__52098 = "async-flow: got bad value for :when - ";
var G__52099 = when_kw;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__52097,G__52098,G__52099) : re_frame.core.console.call(null,G__52097,G__52098,G__52099));
}
});
/**
...
return cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (index,p__52100){
...
var G__52103 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__52104 = "async-flow: rule can only specify one of :dispatch, :dispatch-n and :dispatch-fn. Got more than one: ";
var G__52105 = rule;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__52103,G__52104,G__52105) : re_frame.core.console.call(null,G__52103,G__52104,G__52105));
} else {
...
var map__52113 = rule;
var map__52113__$1 = (((((!((map__52113 == null))))?(((((map__52113.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__52113.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__52113):map__52113);
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52113__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52113__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
...
var G__52118 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__52119 = "async-flow: dispatch-fn must return a seq of events ";
var G__52120 = rule;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__52118,G__52119,G__52120) : re_frame.core.console.call(null,G__52118,G__52119,G__52120));
}
} else {
 ...
 */
day8.re_frame.async_flow_fx.make_flow_event_handler = (function day8$re_frame$async_flow_fx$make_flow_event_handler(p__52123){
var map__52124 = p__52123;
...
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52124__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var db_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52124__$1,new cljs.core.Keyword(null,"db-path","db-path",-68094099));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52124__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var first_dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52124__$1,new cljs.core.Keyword(null,"first-dispatch","first-dispatch",128561923));
...
return (function day8$re_frame$async_flow_fx$make_flow_event_handler_$_async_flow_event_handler(p__52130,p__52131){
var map__52132 = p__52130;
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52132__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__52133 = p__52131;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52133,(0),null);
var event_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52133,(1),null);
var event_v = vec__52133;
var pred__52137 = cljs.core._EQ_;
var expr__52138 = event_type;
if(cljs.core.truth_((function (){var G__52140 = new cljs.core.Keyword(null,"setup","setup",1987730512);
var G__52141 = expr__52138;
return (pred__52137.cljs$core$IFn$_invoke$arity$2 ? pred__52137.cljs$core$IFn$_invoke$arity$2(G__52140,G__52141) : pred__52137.call(null,G__52140,G__52141));
})())){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"db","db",993250759),(function (){var G__52144 = db;
var G__52145 = cljs.core.PersistentHashSet.EMPTY;
var G__52146 = cljs.core.PersistentHashSet.EMPTY;
return (set_state.cljs$core$IFn$_invoke$arity$3 ? set_state.cljs$core$IFn$_invoke$arity$3(G__52144,G__52145,G__52146) : set_state.call(null,G__52144,G__52145,G__52146));
...
var vec__52148 = event_v;
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52148,(0),null);
var forwarded_event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52148,(1),null);
var map__52151 = (get_state.cljs$core$IFn$_invoke$arity$1 ? get_state.cljs$core$IFn$_invoke$arity$1(db) : get_state.call(null,db));
...
var seen_events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52151__$1,new cljs.core.Keyword(null,"seen-events","seen-events",1607648392));
var rules_fired = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52151__$1,new cljs.core.Keyword(null,"rules-fired","rules-fired",-1669838140));
...
var G__52162 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [id,new cljs.core.Keyword(null,"setup","setup",1987730512)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__52162) : re_frame.core.dispatch.call(null,G__52162));
});
var G__52163_52168 = new cljs.core.Keyword(null,"async-flow","async-flow",1464712702);
var G__52164_52169 = day8.re_frame.async_flow_fx.flow__GT_handler;
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__52163_52168,G__52164_52169) : re_frame.core.reg_fx.call(null,G__52163_52168,G__52164_52169));
