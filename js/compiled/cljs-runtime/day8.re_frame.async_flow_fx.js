 ...
 */
day8.re_frame.async_flow_fx.dissoc_in = (function day8$re_frame$async_flow_fx$dissoc_in(m,p__73309){
var vec__73313 = p__73309;
var seq__73314 = cljs.core.seq(vec__73313);
var first__73315 = cljs.core.first(seq__73314);
var seq__73314__$1 = cljs.core.next(seq__73314);
var k = first__73315;
var ks = seq__73314__$1;
var keys = vec__73313;
if(ks){
...
var G__73325 = new cljs.core.Keyword(null,"events","events",1792552201).cljs$core$IFn$_invoke$arity$1(task);
var G__73326 = now_seen_events;
var fexpr__73324 = new cljs.core.Keyword(null,"when","when",-576417306).cljs$core$IFn$_invoke$arity$1(task);
return (fexpr__73324.cljs$core$IFn$_invoke$arity$2 ? fexpr__73324.cljs$core$IFn$_invoke$arity$2(G__73325,G__73326) : fexpr__73324.call(null,G__73325,G__73326));
...
var G__73328 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__73329 = "async-flow: got bad value for :when - ";
var G__73330 = when_kw;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__73328,G__73329,G__73330) : re_frame.core.console.call(null,G__73328,G__73329,G__73330));
}
});
/**
...
return cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (index,p__73332){
var map__73333 = p__73332;
var map__73333__$1 = (((((!((map__73333 == null))))?(((((map__73333.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__73333.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__73333):map__73333);
var rule = map__73333__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73333__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var when = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73333__$1,new cljs.core.Keyword(null,"when","when",-576417306));
var events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73333__$1,new cljs.core.Keyword(null,"events","events",1792552201));
var dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73333__$1,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73333__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73333__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var halt_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73333__$1,new cljs.core.Keyword(null,"halt?","halt?",-1110658247));
...
var G__73335 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__73336 = "async-flow: rule can only specify one of :dispatch, :dispatch-n and :dispatch-fn. Got more than one: ";
var G__73337 = rule;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__73335,G__73336,G__73337) : re_frame.core.console.call(null,G__73335,G__73336,G__73337));
} else {
var G__73338 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__4185__auto__ = id;
...
var G__73338__$1 = (cljs.core.truth_(dispatch_fn)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__73338,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614),dispatch_fn):G__73338);
if(cljs.core.not(dispatch_fn)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__73338__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236),(cljs.core.truth_(dispatch_n)?dispatch_n:(cljs.core.truth_(dispatch)?(new cljs.core.List(null,dispatch,null,(1),null)):cljs.core.List.EMPTY
)));
} else {
return G__73338__$1;
}
...
var map__73345 = rule;
var map__73345__$1 = (((((!((map__73345 == null))))?(((((map__73345.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__73345.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__73345):map__73345);
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73345__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73345__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
...
var G__73350 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__73351 = "async-flow: dispatch-fn must return a seq of events ";
var G__73352 = rule;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__73350,G__73351,G__73352) : re_frame.core.console.call(null,G__73350,G__73351,G__73352));
}
} else {
 ...
 */
day8.re_frame.async_flow_fx.make_flow_event_handler = (function day8$re_frame$async_flow_fx$make_flow_event_handler(p__73353){
var map__73354 = p__73353;
var map__73354__$1 = (((((!((map__73354 == null))))?(((((map__73354.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__73354.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__73354):map__73354);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73354__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var db_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73354__$1,new cljs.core.Keyword(null,"db-path","db-path",-68094099));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73354__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var first_dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73354__$1,new cljs.core.Keyword(null,"first-dispatch","first-dispatch",128561923));
...
return (function day8$re_frame$async_flow_fx$make_flow_event_handler_$_async_flow_event_handler(p__73357,p__73358){
var map__73359 = p__73357;
var map__73359__$1 = (((((!((map__73359 == null))))?(((((map__73359.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__73359.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__73359):map__73359);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73359__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__73360 = p__73358;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73360,(0),null);
var event_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73360,(1),null);
var event_v = vec__73360;
var pred__73364 = cljs.core._EQ_;
var expr__73365 = event_type;
if(cljs.core.truth_((function (){var G__73369 = new cljs.core.Keyword(null,"setup","setup",1987730512);
var G__73370 = expr__73365;
return (pred__73364.cljs$core$IFn$_invoke$arity$2 ? pred__73364.cljs$core$IFn$_invoke$arity$2(G__73369,G__73370) : pred__73364.call(null,G__73369,G__73370));
})())){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"db","db",993250759),(function (){var G__73373 = db;
var G__73374 = cljs.core.PersistentHashSet.EMPTY;
var G__73375 = cljs.core.PersistentHashSet.EMPTY;
return (set_state.cljs$core$IFn$_invoke$arity$3 ? set_state.cljs$core$IFn$_invoke$arity$3(G__73373,G__73374,G__73375) : set_state.call(null,G__73373,G__73374,G__73375));
...
var vec__73380 = event_v;
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73380,(0),null);
var forwarded_event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73380,(1),null);
var map__73383 = (get_state.cljs$core$IFn$_invoke$arity$1 ? get_state.cljs$core$IFn$_invoke$arity$1(db) : get_state.call(null,db));
var map__73383__$1 = (((((!((map__73383 == null))))?(((((map__73383.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__73383.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__73383):map__73383);
var seen_events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73383__$1,new cljs.core.Keyword(null,"seen-events","seen-events",1607648392));
var rules_fired = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73383__$1,new cljs.core.Keyword(null,"rules-fired","rules-fired",-1669838140));
...
var vec__73390 = day8.re_frame.async_flow_fx.ensure_has_id(flow);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73390,(0),null);
var flow_SINGLEQUOTE_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73390,(1),null);
...
var G__73395 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [id,new cljs.core.Keyword(null,"setup","setup",1987730512)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__73395) : re_frame.core.dispatch.call(null,G__73395));
});
var G__73396_73407 = new cljs.core.Keyword(null,"async-flow","async-flow",1464712702);
var G__73397_73408 = day8.re_frame.async_flow_fx.flow__GT_handler;
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__73396_73407,G__73397_73408) : re_frame.core.reg_fx.call(null,G__73396_73407,G__73397_73408));
