 ...
 */
day8.re_frame.async_flow_fx.dissoc_in = (function day8$re_frame$async_flow_fx$dissoc_in(m,p__52066){
var vec__52070 = p__52066;
...
var G__52103 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__4185__auto__ = id;
...
var G__52103__$1 = (cljs.core.truth_(dispatch_fn)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52103,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614),dispatch_fn):G__52103);
if(cljs.core.not(dispatch_fn)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52103__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236),(cljs.core.truth_(dispatch_n)?dispatch_n:(cljs.core.truth_(dispatch)?(new cljs.core.List(null,dispatch,null,(1),null)):cljs.core.List.EMPTY
)));
} else {
return G__52103__$1;
}
...
var G__52109 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__52110 = "async-flow: dispatch-fn must return a seq of events ";
var G__52111 = rule;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__52109,G__52110,G__52111) : re_frame.core.console.call(null,G__52109,G__52110,G__52111));
}
} else {
 ...
 */
day8.re_frame.async_flow_fx.make_flow_event_handler = (function day8$re_frame$async_flow_fx$make_flow_event_handler(p__52115){
...
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52116__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var db_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52116__$1,new cljs.core.Keyword(null,"db-path","db-path",-68094099));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52116__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var first_dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52116__$1,new cljs.core.Keyword(null,"first-dispatch","first-dispatch",128561923));
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52123__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__52124 = p__52122;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52124,(0),null);
var event_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52124,(1),null);
var event_v = vec__52124;
var pred__52128 = cljs.core._EQ_;
var expr__52129 = event_type;
if(cljs.core.truth_((function (){var G__52133 = new cljs.core.Keyword(null,"setup","setup",1987730512);
var G__52134 = expr__52129;
return (pred__52128.cljs$core$IFn$_invoke$arity$2 ? pred__52128.cljs$core$IFn$_invoke$arity$2(G__52133,G__52134) : pred__52128.call(null,G__52133,G__52134));
})())){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"db","db",993250759),(function (){var G__52136 = db;
var G__52137 = cljs.core.PersistentHashSet.EMPTY;
var G__52138 = cljs.core.PersistentHashSet.EMPTY;
return (set_state.cljs$core$IFn$_invoke$arity$3 ? set_state.cljs$core$IFn$_invoke$arity$3(G__52136,G__52137,G__52138) : set_state.call(null,G__52136,G__52137,G__52138));
...
var vec__52139 = event_v;
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52139,(0),null);
var forwarded_event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52139,(1),null);
var map__52142 = (get_state.cljs$core$IFn$_invoke$arity$1 ? get_state.cljs$core$IFn$_invoke$arity$1(db) : get_state.call(null,db));
...
var seen_events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52142__$1,new cljs.core.Keyword(null,"seen-events","seen-events",1607648392));
var rules_fired = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52142__$1,new cljs.core.Keyword(null,"rules-fired","rules-fired",-1669838140));
...
var vec__52148 = day8.re_frame.async_flow_fx.ensure_has_id(flow);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52148,(0),null);
var flow_SINGLEQUOTE_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52148,(1),null);
...
var G__52152 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [id,new cljs.core.Keyword(null,"setup","setup",1987730512)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__52152) : re_frame.core.dispatch.call(null,G__52152));
});
var G__52154_52168 = new cljs.core.Keyword(null,"async-flow","async-flow",1464712702);
var G__52155_52169 = day8.re_frame.async_flow_fx.flow__GT_handler;
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__52154_52168,G__52155_52169) : re_frame.core.reg_fx.call(null,G__52154_52168,G__52155_52169));
