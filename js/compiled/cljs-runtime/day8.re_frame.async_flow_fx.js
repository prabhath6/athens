 ...
 */
day8.re_frame.async_flow_fx.dissoc_in = (function day8$re_frame$async_flow_fx$dissoc_in(m,p__72762){
var vec__72763 = p__72762;
var seq__72764 = cljs.core.seq(vec__72763);
var first__72765 = cljs.core.first(seq__72764);
var seq__72764__$1 = cljs.core.next(seq__72764);
var k = first__72765;
var ks = seq__72764__$1;
var keys = vec__72763;
if(ks){
...
var G__72781 = new cljs.core.Keyword(null,"events","events",1792552201).cljs$core$IFn$_invoke$arity$1(task);
var G__72782 = now_seen_events;
var fexpr__72780 = new cljs.core.Keyword(null,"when","when",-576417306).cljs$core$IFn$_invoke$arity$1(task);
return (fexpr__72780.cljs$core$IFn$_invoke$arity$2 ? fexpr__72780.cljs$core$IFn$_invoke$arity$2(G__72781,G__72782) : fexpr__72780.call(null,G__72781,G__72782));
...
var G__72784 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__72785 = "async-flow: got bad value for :when - ";
var G__72786 = when_kw;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__72784,G__72785,G__72786) : re_frame.core.console.call(null,G__72784,G__72785,G__72786));
}
});
/**
...
return cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (index,p__72789){
var map__72791 = p__72789;
...
var rule = map__72791__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72791__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var when = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72791__$1,new cljs.core.Keyword(null,"when","when",-576417306));
var events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72791__$1,new cljs.core.Keyword(null,"events","events",1792552201));
var dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72791__$1,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72791__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72791__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var halt_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72791__$1,new cljs.core.Keyword(null,"halt?","halt?",-1110658247));
...
var G__72794 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__72795 = "async-flow: rule can only specify one of :dispatch, :dispatch-n and :dispatch-fn. Got more than one: ";
var G__72796 = rule;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__72794,G__72795,G__72796) : re_frame.core.console.call(null,G__72794,G__72795,G__72796));
} else {
var G__72797 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__4185__auto__ = id;
...
var G__72797__$1 = (cljs.core.truth_(dispatch_fn)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__72797,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614),dispatch_fn):G__72797);
if(cljs.core.not(dispatch_fn)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__72797__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236),(cljs.core.truth_(dispatch_n)?dispatch_n:(cljs.core.truth_(dispatch)?(new cljs.core.List(null,dispatch,null,(1),null)):cljs.core.List.EMPTY
)));
} else {
return G__72797__$1;
}
...
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72808__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72808__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
...
var G__72810 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__72811 = "async-flow: dispatch-fn must return a seq of events ";
var G__72812 = rule;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__72810,G__72811,G__72812) : re_frame.core.console.call(null,G__72810,G__72811,G__72812));
}
} else {
 ...
 */
day8.re_frame.async_flow_fx.make_flow_event_handler = (function day8$re_frame$async_flow_fx$make_flow_event_handler(p__72815){
var map__72816 = p__72815;
var map__72816__$1 = (((((!((map__72816 == null))))?(((((map__72816.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__72816.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__72816):map__72816);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72816__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var db_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72816__$1,new cljs.core.Keyword(null,"db-path","db-path",-68094099));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72816__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var first_dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72816__$1,new cljs.core.Keyword(null,"first-dispatch","first-dispatch",128561923));
...
return (function day8$re_frame$async_flow_fx$make_flow_event_handler_$_async_flow_event_handler(p__72818,p__72819){
var map__72820 = p__72818;
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72820__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__72821 = p__72819;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72821,(0),null);
var event_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72821,(1),null);
var event_v = vec__72821;
var pred__72837 = cljs.core._EQ_;
var expr__72838 = event_type;
if(cljs.core.truth_((function (){var G__72840 = new cljs.core.Keyword(null,"setup","setup",1987730512);
var G__72841 = expr__72838;
return (pred__72837.cljs$core$IFn$_invoke$arity$2 ? pred__72837.cljs$core$IFn$_invoke$arity$2(G__72840,G__72841) : pred__72837.call(null,G__72840,G__72841));
})())){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"db","db",993250759),(function (){var G__72842 = db;
var G__72843 = cljs.core.PersistentHashSet.EMPTY;
var G__72844 = cljs.core.PersistentHashSet.EMPTY;
return (set_state.cljs$core$IFn$_invoke$arity$3 ? set_state.cljs$core$IFn$_invoke$arity$3(G__72842,G__72843,G__72844) : set_state.call(null,G__72842,G__72843,G__72844));
...
var vec__72847 = event_v;
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72847,(0),null);
var forwarded_event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72847,(1),null);
var map__72850 = (get_state.cljs$core$IFn$_invoke$arity$1 ? get_state.cljs$core$IFn$_invoke$arity$1(db) : get_state.call(null,db));
var map__72850__$1 = (((((!((map__72850 == null))))?(((((map__72850.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__72850.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__72850):map__72850);
var seen_events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72850__$1,new cljs.core.Keyword(null,"seen-events","seen-events",1607648392));
var rules_fired = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72850__$1,new cljs.core.Keyword(null,"rules-fired","rules-fired",-1669838140));
...
var vec__72864 = day8.re_frame.async_flow_fx.ensure_has_id(flow);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72864,(0),null);
var flow_SINGLEQUOTE_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72864,(1),null);
...
var G__72867 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [id,new cljs.core.Keyword(null,"setup","setup",1987730512)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__72867) : re_frame.core.dispatch.call(null,G__72867));
});
var G__72868_72908 = new cljs.core.Keyword(null,"async-flow","async-flow",1464712702);
var G__72869_72909 = day8.re_frame.async_flow_fx.flow__GT_handler;
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__72868_72908,G__72869_72909) : re_frame.core.reg_fx.call(null,G__72868_72908,G__72869_72909));
