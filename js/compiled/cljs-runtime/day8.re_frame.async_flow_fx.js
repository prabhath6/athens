...
var G__52104 = new cljs.core.Keyword(null,"events","events",1792552201).cljs$core$IFn$_invoke$arity$1(task);
var G__52105 = now_seen_events;
var fexpr__52103 = new cljs.core.Keyword(null,"when","when",-576417306).cljs$core$IFn$_invoke$arity$1(task);
return (fexpr__52103.cljs$core$IFn$_invoke$arity$2 ? fexpr__52103.cljs$core$IFn$_invoke$arity$2(G__52104,G__52105) : fexpr__52103.call(null,G__52104,G__52105));
...
var G__52108 = "async-flow: got bad value for :when - ";
var G__52109 = when_kw;
...
return cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (index,p__52113){
...
var rule = map__52114__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52114__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var when = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52114__$1,new cljs.core.Keyword(null,"when","when",-576417306));
var events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52114__$1,new cljs.core.Keyword(null,"events","events",1792552201));
var dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52114__$1,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009));
...
var halt_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52114__$1,new cljs.core.Keyword(null,"halt?","halt?",-1110658247));
...
var G__52117 = "async-flow: rule can only specify one of :dispatch, :dispatch-n and :dispatch-fn. Got more than one: ";
var G__52118 = rule;
...
var G__52119 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__4185__auto__ = id;
...
var G__52119__$1 = (cljs.core.truth_(dispatch_fn)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52119,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614),dispatch_fn):G__52119);
if(cljs.core.not(dispatch_fn)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52119__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236),(cljs.core.truth_(dispatch_n)?dispatch_n:(cljs.core.truth_(dispatch)?(new cljs.core.List(null,dispatch,null,(1),null)):cljs.core.List.EMPTY
)));
} else {
return G__52119__$1;
}
...
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52126__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52126__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
...
var G__52128 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__52129 = "async-flow: dispatch-fn must return a seq of events ";
var G__52130 = rule;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__52128,G__52129,G__52130) : re_frame.core.console.call(null,G__52128,G__52129,G__52130));
}
} else {
 ...
 */
day8.re_frame.async_flow_fx.make_flow_event_handler = (function day8$re_frame$async_flow_fx$make_flow_event_handler(p__52134){
...
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52135__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var db_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52135__$1,new cljs.core.Keyword(null,"db-path","db-path",-68094099));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52135__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var first_dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52135__$1,new cljs.core.Keyword(null,"first-dispatch","first-dispatch",128561923));
...
var pred__52150 = cljs.core._EQ_;
var expr__52151 = event_type;
if(cljs.core.truth_((function (){var G__52153 = new cljs.core.Keyword(null,"setup","setup",1987730512);
var G__52154 = expr__52151;
return (pred__52150.cljs$core$IFn$_invoke$arity$2 ? pred__52150.cljs$core$IFn$_invoke$arity$2(G__52153,G__52154) : pred__52150.call(null,G__52153,G__52154));
})())){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"db","db",993250759),(function (){var G__52155 = db;
var G__52156 = cljs.core.PersistentHashSet.EMPTY;
var G__52157 = cljs.core.PersistentHashSet.EMPTY;
return (set_state.cljs$core$IFn$_invoke$arity$3 ? set_state.cljs$core$IFn$_invoke$arity$3(G__52155,G__52156,G__52157) : set_state.call(null,G__52155,G__52156,G__52157));
