 ...
 */
day8.re_frame.async_flow_fx.dissoc_in = (function day8$re_frame$async_flow_fx$dissoc_in(m,p__52094){
var vec__52095 = p__52094;
...
var G__52104 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__52105 = "async-flow: got bad value for :when - ";
var G__52106 = when_kw;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__52104,G__52105,G__52106) : re_frame.core.console.call(null,G__52104,G__52105,G__52106));
}
});
/**
...
return cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (index,p__52107){
...
var rule = map__52108__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52108__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var when = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52108__$1,new cljs.core.Keyword(null,"when","when",-576417306));
var events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52108__$1,new cljs.core.Keyword(null,"events","events",1792552201));
var dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52108__$1,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52108__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52108__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var halt_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52108__$1,new cljs.core.Keyword(null,"halt?","halt?",-1110658247));
...
var G__52123 = "async-flow: dispatch-fn must return a seq of events ";
var G__52124 = rule;
 ...
 */
day8.re_frame.async_flow_fx.make_flow_event_handler = (function day8$re_frame$async_flow_fx$make_flow_event_handler(p__52128){
var map__52129 = p__52128;
...
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52129__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var db_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52129__$1,new cljs.core.Keyword(null,"db-path","db-path",-68094099));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52129__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var first_dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52129__$1,new cljs.core.Keyword(null,"first-dispatch","first-dispatch",128561923));
...
return (function day8$re_frame$async_flow_fx$make_flow_event_handler_$_async_flow_event_handler(p__52134,p__52135){
var map__52136 = p__52134;
var map__52136__$1 = (((((!((map__52136 == null))))?(((((map__52136.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__52136.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__52136):map__52136);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52136__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__52137 = p__52135;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52137,(0),null);
var event_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52137,(1),null);
var event_v = vec__52137;
var pred__52143 = cljs.core._EQ_;
var expr__52144 = event_type;
if(cljs.core.truth_((function (){var G__52147 = new cljs.core.Keyword(null,"setup","setup",1987730512);
var G__52148 = expr__52144;
return (pred__52143.cljs$core$IFn$_invoke$arity$2 ? pred__52143.cljs$core$IFn$_invoke$arity$2(G__52147,G__52148) : pred__52143.call(null,G__52147,G__52148));
})())){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"db","db",993250759),(function (){var G__52149 = db;
var G__52150 = cljs.core.PersistentHashSet.EMPTY;
var G__52151 = cljs.core.PersistentHashSet.EMPTY;
return (set_state.cljs$core$IFn$_invoke$arity$3 ? set_state.cljs$core$IFn$_invoke$arity$3(G__52149,G__52150,G__52151) : set_state.call(null,G__52149,G__52150,G__52151));
...
var vec__52152 = event_v;
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52152,(0),null);
var forwarded_event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52152,(1),null);
var map__52155 = (get_state.cljs$core$IFn$_invoke$arity$1 ? get_state.cljs$core$IFn$_invoke$arity$1(db) : get_state.call(null,db));
...
var seen_events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52155__$1,new cljs.core.Keyword(null,"seen-events","seen-events",1607648392));
var rules_fired = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52155__$1,new cljs.core.Keyword(null,"rules-fired","rules-fired",-1669838140));
...
var vec__52163 = day8.re_frame.async_flow_fx.ensure_has_id(flow);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52163,(0),null);
var flow_SINGLEQUOTE_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52163,(1),null);
...
var G__52166 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [id,new cljs.core.Keyword(null,"setup","setup",1987730512)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__52166) : re_frame.core.dispatch.call(null,G__52166));
});
var G__52167_52175 = new cljs.core.Keyword(null,"async-flow","async-flow",1464712702);
var G__52168_52176 = day8.re_frame.async_flow_fx.flow__GT_handler;
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__52167_52175,G__52168_52176) : re_frame.core.reg_fx.call(null,G__52167_52175,G__52168_52176));
