...
var map__68842 = rec;
var map__68842__$1 = (((((!((map__68842 == null))))?(((((map__68842.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__68842.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__68842):map__68842);
var depth = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68842__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68842__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__68849 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__68849__$1 = (((G__68849 == null))?null:cljs.core.persistent_BANG_(G__68849));
if((G__68849__$1 == null)){
return null;
} else {
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__68849__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__68850){
var vec__68851 = p__68850;
var seq__68852 = cljs.core.seq(vec__68851);
var first__68853 = cljs.core.first(seq__68852);
var seq__68852__$1 = cljs.core.next(seq__68852);
var frame = first__68853;
var frames = seq__68852__$1;
...
var results = (function (){var G__68854 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq(kvps)){
return cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(G__68854,kvps);
} else {
return G__68854;
}
})();
...
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68855__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68855__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_68928 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_68928,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__68858){
var vec__68859 = p__68858;
var seq__68860 = cljs.core.seq(vec__68859);
var first__68861 = cljs.core.first(seq__68860);
var seq__68860__$1 = cljs.core.next(seq__68860);
var parent = first__68861;
var frames = seq__68860__$1;
...
var found = cljs.core.not_empty((function (){var G__68862 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.take.cljs$core$IFn$_invoke$arity$1(limit),G__68862);
} else {
return G__68862;
}
})());
...
var as_value = (function (){var G__68863 = datom_val;
if(ref_QMARK_){
return cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__68857_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__68857_SHARP_]);
}),G__68863);
} else {
return G__68863;
}
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,cljs.core.update.cljs$core$IFn$_invoke$arity$5(parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,(function (){var G__68864 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(as_value),found);
if(single_QMARK_){
return cljs.core.first(G__68864);
} else {
return G__68864;
}
})()));
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,(function (){var G__68865 = parent;
if(cljs.core.contains_QMARK_(opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__68865,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__68865;
}
})());
...
var vec__68869 = spec;
var attr_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68869,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68869,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p__68872){
var vec__68873 = p__68872;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68873,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68873,(1),null);
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__68877){
var vec__68878 = p__68877;
var seq__68879 = cljs.core.seq(vec__68878);
var first__68880 = cljs.core.first(seq__68879);
var seq__68879__$1 = cljs.core.next(seq__68879);
var frame = first__68880;
var frames = seq__68879__$1;
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__68882){
var vec__68883 = p__68882;
var seq__68884 = cljs.core.seq(vec__68883);
var first__68885 = cljs.core.first(seq__68884);
var seq__68884__$1 = cljs.core.next(seq__68884);
var frame = first__68885;
var frames = seq__68884__$1;
...
var vec__68893 = cljs.core.first(datoms_by_attr);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68893,(0),null);
var datoms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68893,(1),null);
...
var map__68897 = frame;
var map__68897__$1 = (((((!((map__68897 == null))))?(((((map__68897.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__68897.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__68897):map__68897);
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68897__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68897__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__68899 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__68899,attr,eid);
} else {
return G__68899;
}
})();
...
var map__68900 = frame;
var map__68900__$1 = (((((!((map__68900 == null))))?(((((map__68900.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__68900.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__68900):map__68900);
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68900__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68900__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__68908){
while(true){
var vec__68909 = p__68908;
var seq__68910 = cljs.core.seq(vec__68909);
var first__68911 = cljs.core.first(seq__68910);
var seq__68910__$1 = cljs.core.next(seq__68910);
var frame = first__68911;
var frames = seq__68910__$1;
var temp__5733__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5733__auto__){
var eids = temp__5733__auto__;
...
var G__68958 = db;
var G__68959 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__68958;
p__68908 = G__68959;
continue;
}
...
while(true){
var G__68914 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__68914__$1 = (((G__68914 instanceof cljs.core.Keyword))?G__68914.fqn:null);
switch (G__68914__$1) {
case "expand":
var G__68961 = db;
var G__68962 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__68961;
frames = G__68962;
continue;
...
case "expand-rev":
var G__68963 = db;
var G__68964 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__68963;
frames = G__68964;
continue;
...
case "pattern":
var G__68965 = db;
var G__68966 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__68965;
frames = G__68966;
continue;
...
case "recursion":
var G__68967 = db;
var G__68968 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__68967;
frames = G__68968;
continue;
...
break;
case "done":
var vec__68915 = frames;
var seq__68916 = cljs.core.seq(vec__68915);
var first__68917 = cljs.core.first(seq__68916);
var seq__68916__$1 = cljs.core.next(seq__68916);
var f = first__68917;
var remaining = seq__68916__$1;
var result = (function (){var G__68918 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__68918);
} else {
return G__68918;
}
})();
...
var G__68972 = db;
var G__68973 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__68919 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__68919,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__68919;
}
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__68914__$1)].join('')));
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__68920_SHARP_){
return datascript.db.entid_strict(db,p1__68920_SHARP_);
})),eids);
