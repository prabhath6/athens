...
var pattern_42465 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_42465,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
...
case "expand":
var G__42476 = db;
var G__42477 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__42476;
frames = G__42477;
continue;
