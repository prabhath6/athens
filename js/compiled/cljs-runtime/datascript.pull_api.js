...
var G__42497 = db;
var G__42498 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__42497;
p__42453 = G__42498;
continue;
}
...
case "expand":
var G__42506 = db;
var G__42507 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__42506;
frames = G__42507;
continue;
...
case "expand-rev":
var G__42508 = db;
var G__42509 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__42508;
frames = G__42509;
continue;
...
case "pattern":
var G__42510 = db;
var G__42511 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__42510;
frames = G__42511;
continue;
...
case "recursion":
var G__42515 = db;
var G__42516 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__42515;
frames = G__42516;
continue;
...
var G__42524 = db;
var G__42525 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__42462 = cljs.core.first(remaining);
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__42464_SHARP_){
return datascript.db.entid_strict(db,p1__42464_SHARP_);
})),eids);
