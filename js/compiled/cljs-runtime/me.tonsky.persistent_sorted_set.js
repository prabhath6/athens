...
var G__41094 = (i__40995__auto___41091 + (1));
i__40995__auto___41091 = G__41094;
continue;
} else {
}
break;
...
var G__41099 = (i__40995__auto___41097 + (1));
i__40995__auto___41097 = G__41099;
continue;
} else {
}
break;
...
var l__40994__auto___41101 = (cut_to - splice_to);
var n__4666__auto___41102 = l__40994__auto___41101;
var i__40995__auto___41103 = (0);
while(true){
if((i__40995__auto___41103 < n__4666__auto___41102)){
(new_arr[(i__40995__auto___41103 + l1xs)] = (arr[(i__40995__auto___41103 + splice_to)]));

var G__41104 = (i__40995__auto___41103 + (1));
i__40995__auto___41103 = G__41104;
continue;
} else {
}
break;
...
if((a1_l <= r1_l)){
var l__40994__auto___41109 = (a1_l - (0));
var n__4666__auto___41110 = l__40994__auto___41109;
var i__40995__auto___41111 = (0);
while(true){
if((i__40995__auto___41111 < n__4666__auto___41110)){
...
while(true){
if((level > (0))){
var G__41169 = (level - me.tonsky.persistent_sorted_set.level_shift);
var G__41170 = (node.pointers[me.tonsky.persistent_sorted_set.path_get(path,level)]);
level = G__41169;
node = G__41170;
continue;
} else {
...
while(true){
if((level__$1 > (0))){
var G__41177 = (function (){var arr__41009__auto__ = node__$1.pointers;
return (arr__41009__auto__[(arr__41009__auto__.length - (1))]);
})();
var G__41178 = me.tonsky.persistent_sorted_set.path_set(path,level__$1,(node__$1.pointers.length - (1)));
var G__41179 = (level__$1 - me.tonsky.persistent_sorted_set.level_shift);
node__$1 = G__41177;
path = G__41178;
level__$1 = G__41179;
continue;
...
var G__41220 = (left__$1 + (1));
var G__41221 = keys__$1;
var G__41222 = (idx__$1 + (1));
var G__41223 = new_acc;
left__$1 = G__41220;
keys__$1 = G__41221;
idx__$1 = G__41222;
acc = G__41223;
...
var G__41224 = new_left;
var G__41225 = me.tonsky.persistent_sorted_set.keys_for(self__.set,new_left);
var G__41226 = me.tonsky.persistent_sorted_set.path_get(new_left,(0));
var G__41227 = new_acc;
left__$1 = G__41224;
keys__$1 = G__41225;
idx__$1 = G__41226;
acc = G__41227;
...
var G__41258 = (level__$1 - me.tonsky.persistent_sorted_set.level_shift);
var G__41259 = (res * me.tonsky.persistent_sorted_set.avg_len);
level__$1 = G__41258;
res = G__41259;
continue;
}
...
var G__41278 = (node.pointers[idx]);
var G__41279 = me.tonsky.persistent_sorted_set.path_set(path,level,idx);
var G__41280 = (level - me.tonsky.persistent_sorted_set.level_shift);
node = G__41278;
path = G__41279;
level = G__41280;
continue;
...
var pos_41295 = (0);
while(true){
var rest_41296 = (len - pos_41295);
if((rest_41296 <= max_len)){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_41295));
} else {
if((rest_41296 >= (chunk_len + min_len))){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_41295,(pos_41295 + chunk_len)));

var G__41299 = (pos_41295 + chunk_len);
pos_41295 = G__41299;
continue;
} else {
var piece_len_41300 = (rest_41296 >>> (1));
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_41295,(pos_41295 + piece_len_41300)));

var G__41301 = (pos_41295 + piece_len_41300);
pos_41295 = G__41301;
continue;
...
var G__41313 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,e);
var G__41314 = (i + (1));
var G__41315 = e;
acc = G__41313;
i = G__41314;
...
break;
default:
var G__41329 = me.tonsky.persistent_sorted_set.arr_map_inplace(((function (current_level,shift,G__41073,leaves){
...
var G__41330 = (shift + me.tonsky.persistent_sorted_set.level_shift);
current_level = G__41329;
shift = G__41330;
continue;
...
args_arr__4810__auto__.push((arguments[i__4790__auto___41334]));

var G__41336 = (i__4790__auto___41334 + (1));
i__4790__auto___41334 = G__41336;
continue;
} else {
}
break;
...
var G__41342 = (i__4790__auto___41340 + (1));
i__4790__auto___41340 = G__41342;
continue;
} else {
}
break;
