...
var G__41104 = (i__40995__auto___41101 + (1));
i__40995__auto___41101 = G__41104;
continue;
} else {
}
break;
...
while(true){
if((level > (0))){
var G__41163 = (level - me.tonsky.persistent_sorted_set.level_shift);
var G__41164 = (node.pointers[me.tonsky.persistent_sorted_set.path_get(path,level)]);
level = G__41163;
node = G__41164;
continue;
} else {
...
while(true){
if((level__$1 > (0))){
var G__41168 = (function (){var arr__41009__auto__ = node__$1.pointers;
return (arr__41009__auto__[(arr__41009__auto__.length - (1))]);
})();
var G__41169 = me.tonsky.persistent_sorted_set.path_set(path,level__$1,(node__$1.pointers.length - (1)));
var G__41170 = (level__$1 - me.tonsky.persistent_sorted_set.level_shift);
node__$1 = G__41168;
path = G__41169;
level__$1 = G__41170;
continue;
...
var G__41209 = (left__$1 + (1));
var G__41210 = keys__$1;
var G__41211 = (idx__$1 + (1));
var G__41212 = new_acc;
left__$1 = G__41209;
keys__$1 = G__41210;
idx__$1 = G__41211;
acc = G__41212;
...
var G__41215 = new_left;
var G__41216 = me.tonsky.persistent_sorted_set.keys_for(self__.set,new_left);
var G__41217 = me.tonsky.persistent_sorted_set.path_get(new_left,(0));
var G__41218 = new_acc;
left__$1 = G__41215;
keys__$1 = G__41216;
idx__$1 = G__41217;
acc = G__41218;
...
var G__41242 = (level__$1 - me.tonsky.persistent_sorted_set.level_shift);
var G__41243 = (res * me.tonsky.persistent_sorted_set.avg_len);
level__$1 = G__41242;
res = G__41243;
continue;
}
...
var G__41255 = (node.pointers[idx]);
var G__41256 = me.tonsky.persistent_sorted_set.path_set(path,level,idx);
var G__41257 = (level - me.tonsky.persistent_sorted_set.level_shift);
node = G__41255;
path = G__41256;
level = G__41257;
continue;
...
var G__41262 = (node.pointers[idx]);
var G__41263 = me.tonsky.persistent_sorted_set.path_set(path,level,idx);
var G__41264 = (level - me.tonsky.persistent_sorted_set.level_shift);
node = G__41262;
path = G__41263;
level = G__41264;
continue;
...
var pos_41281 = (0);
while(true){
var rest_41282 = (len - pos_41281);
if((rest_41282 <= max_len)){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_41281));
} else {
if((rest_41282 >= (chunk_len + min_len))){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_41281,(pos_41281 + chunk_len)));

var G__41288 = (pos_41281 + chunk_len);
pos_41281 = G__41288;
continue;
} else {
var piece_len_41291 = (rest_41282 >>> (1));
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_41281,(pos_41281 + piece_len_41291)));

var G__41293 = (pos_41281 + piece_len_41291);
pos_41281 = G__41293;
continue;
...
var G__41301 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,e);
var G__41302 = (i + (1));
var G__41303 = e;
acc = G__41301;
i = G__41302;
...
break;
default:
var G__41322 = me.tonsky.persistent_sorted_set.arr_map_inplace(((function (current_level,shift,G__41073,leaves){
...
var G__41323 = (shift + me.tonsky.persistent_sorted_set.level_shift);
current_level = G__41322;
shift = G__41323;
continue;
...
args_arr__4810__auto__.push((arguments[i__4790__auto___41328]));
...
default:
var args_arr__4810__auto__ = [];
var len__4789__auto___41332 = arguments.length;
var i__4790__auto___41334 = (0);
while(true){
if((i__4790__auto___41334 < len__4789__auto___41332)){
args_arr__4810__auto__.push((arguments[i__4790__auto___41334]));

var G__41337 = (i__4790__auto___41334 + (1));
i__4790__auto___41334 = G__41337;
continue;
} else {
}
break;
