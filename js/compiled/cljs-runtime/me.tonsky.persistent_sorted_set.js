...
var n__4666__auto___41096 = l__40994__auto___41093;
...
while(true){
if((level > (0))){
var G__41167 = (level - me.tonsky.persistent_sorted_set.level_shift);
var G__41168 = (node.pointers[me.tonsky.persistent_sorted_set.path_get(path,level)]);
level = G__41167;
node = G__41168;
continue;
} else {
...
while(true){
if((level__$1 > (0))){
var G__41174 = (function (){var arr__41009__auto__ = node__$1.pointers;
return (arr__41009__auto__[(arr__41009__auto__.length - (1))]);
})();
var G__41175 = me.tonsky.persistent_sorted_set.path_set(path,level__$1,(node__$1.pointers.length - (1)));
var G__41176 = (level__$1 - me.tonsky.persistent_sorted_set.level_shift);
node__$1 = G__41174;
path = G__41175;
level__$1 = G__41176;
continue;
...
var G__41260 = (level__$1 - me.tonsky.persistent_sorted_set.level_shift);
var G__41261 = (res * me.tonsky.persistent_sorted_set.avg_len);
level__$1 = G__41260;
res = G__41261;
continue;
}
...
var G__41280 = (node.pointers[idx]);
var G__41281 = me.tonsky.persistent_sorted_set.path_set(path,level,idx);
var G__41282 = (level - me.tonsky.persistent_sorted_set.level_shift);
node = G__41280;
path = G__41281;
level = G__41282;
continue;
