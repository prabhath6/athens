...
var vec__25488 = temp__5735__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25488,(0),null);
var magnitude = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25488,(1),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25488,(2),null);
...
var G__25675 = null;
if (arguments.length > 2) {
var G__25676__i = 0, G__25676__a = new Array(arguments.length -  2);
while (G__25676__i < G__25676__a.length) {G__25676__a[G__25676__i] = arguments[G__25676__i + 2]; ++G__25676__i;}
G__25675 = new cljs.core.IndexedSeq(G__25676__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__25675);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var map__25531 = (u.cljs$core$IFn$_invoke$arity$1 ? u.cljs$core$IFn$_invoke$arity$1(x) : u.call(null,x));
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25531__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
...
while (G__25687__i < G__25687__a.length) {G__25687__a[G__25687__i] = arguments[G__25687__i + 2]; ++G__25687__i;}
  more = new cljs.core.IndexedSeq(G__25687__a,0,null);
} 
...
arglist__25688 = cljs.core.next(arglist__25688);
var y = cljs.core.first(arglist__25688);
var more = cljs.core.rest(arglist__25688);
...
var G__25689 = null;
if (arguments.length > 2) {
var G__25690__i = 0, G__25690__a = new Array(arguments.length -  2);
while (G__25690__i < G__25690__a.length) {G__25690__a[G__25690__i] = arguments[G__25690__i + 2]; ++G__25690__i;}
G__25689 = new cljs.core.IndexedSeq(G__25690__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__25689);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var G__25696__delegate = function (x,y,more){
...
var G__25696 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
...
while (G__25699__i < G__25699__a.length) {G__25699__a[G__25699__i] = arguments[G__25699__i + 2]; ++G__25699__i;}
  more = new cljs.core.IndexedSeq(G__25699__a,0,null);
} 
return G__25696__delegate.call(this,x,y,more);};
G__25696.cljs$lang$maxFixedArity = 2;
G__25696.cljs$lang$applyTo = (function (arglist__25700){
var x = cljs.core.first(arglist__25700);
arglist__25700 = cljs.core.next(arglist__25700);
var y = cljs.core.first(arglist__25700);
var more = cljs.core.rest(arglist__25700);
return G__25696__delegate(x,y,more);
});
...
G__25702 = new cljs.core.IndexedSeq(G__25704__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__25702);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
