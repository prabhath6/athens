...
if((i < len)){
var k = (ks[i]);
var G__32359 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__32360 = (i + (1));
m = G__32359;
i = G__32360;
continue;
...
var temp__5737__auto__ = p.argv;
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__32275 = p.children;
return module$node_modules$react$index.Children.toArray(G__32275);
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__32277 = c;
var G__32277__$1 = (((G__32277 == null))?null:G__32277.prototype);
if((G__32277__$1 == null)){
return null;
} else {
return G__32277__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__32279 = c;
var G__32279__$1 = (((G__32279 == null))?null:G__32279.prototype);
if((G__32279__$1 == null)){
return null;
} else {
return G__32279__$1.render;
}
})() == null)))));
});
...
var G__32285 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__32285) : reagent.impl.component.as_element.call(null,G__32285));
};
...
while (G__32386__i < G__32386__a.length) {G__32386__a[G__32386__i] = arguments[G__32386__i + 0]; ++G__32386__i;}
  args = new cljs.core.IndexedSeq(G__32386__a,0,null);
} 
...
var _STAR_current_component_STAR__orig_val__32286 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__32287 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__32287);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__32286);
}});
...
var c = this;
var G__32299_32397 = goog.object.get(c,"cljsRatom");
if((G__32299_32397 == null)){
} else {
reagent.ratom.dispose_BANG_(G__32299_32397);
}
...
var renders_32398 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_32399 = cljs.core.first(cljs.core.vals(renders_32398));
...
if((cljs.core.count(renders_32398) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_32398))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_32399)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_32399], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__32300 = o;
var G__32301_32400 = G__32300;
var G__32302_32401 = cljs.core.name(k);
var G__32303_32402 = v;
goog.object.set(G__32301_32400,G__32302_32401,G__32303_32402);
...
var G__32304_32403 = cmp.prototype;
var G__32305_32404 = module$node_modules$react$index.Component.prototype;
var G__32306_32405 = methods$;
goog.object.extend(G__32304_32403,G__32305_32404,G__32306_32405);
...
var name = (function (){var G__32307 = fiber;
var G__32307__$1 = (((G__32307 == null))?null:G__32307.type);
if((G__32307__$1 == null)){
return null;
} else {
return G__32307__$1.displayName;
}
})();
var parent = (function (){var G__32308 = fiber;
if((G__32308 == null)){
return null;
} else {
return G__32308.return;
}
})();
var path = (function (){var G__32309 = parent;
var G__32309__$1 = (((G__32309 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__32309) : reagent.impl.component.fiber_component_path.call(null,G__32309)));
if((G__32309__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__32309__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4185__auto__ = (function (){var G__32311 = c;
if((G__32311 == null)){
return null;
} else {
return goog.object.get(G__32311,"_reactInternalFiber");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__32312._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4185__auto__ = (function (){var G__32314 = c;
if((G__32314 == null)){
return null;
} else {
return goog.object.get(G__32314,"_reactInternalInstance");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var or__4185__auto____$1 = (function (){var G__32316 = c;
if((G__32316 == null)){
return null;
} else {
return G__32316._reactInternalInstance;
}
})();
if(cljs.core.truth_(or__4185__auto____$1)){
return or__4185__auto____$1;
...
var elem = (function (){var or__4185__auto__ = (function (){var G__32322 = instance;
if((G__32322 == null)){
return null;
} else {
return goog.object.get(G__32322,"_currentElement");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var G__32323 = instance;
if((G__32323 == null)){
return null;
} else {
return G__32323._currentElement;
}
}
})();
var name = (function (){var G__32325 = elem;
var G__32325__$1 = (((G__32325 == null))?null:G__32325.type);
if((G__32325__$1 == null)){
return null;
} else {
return G__32325__$1.displayName;
}
})();
var owner = (function (){var or__4185__auto__ = (function (){var G__32332 = elem;
if((G__32332 == null)){
return null;
} else {
return goog.object.get(G__32332,"_owner");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__32335._owner;
}
}
})();
var path = (function (){var G__32340 = owner;
var G__32340__$1 = (((G__32340 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__32340) : reagent.impl.component.component_path.call(null,G__32340)));
if((G__32340__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__32340__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__32346 = c;
var G__32346__$1 = (((G__32346 == null))?null:G__32346.constructor);
if((G__32346__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__32346__$1);
}
}
})();
