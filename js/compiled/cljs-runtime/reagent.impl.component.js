...
if((i < len)){
var k = (ks[i]);
var G__51406 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__51407 = (i + (1));
m = G__51406;
i = G__51407;
continue;
...
var temp__5737__auto__ = p.argv;
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__51300 = p.children;
return module$node_modules$react$index.Children.toArray(G__51300);
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__51302 = c;
var G__51302__$1 = (((G__51302 == null))?null:G__51302.prototype);
if((G__51302__$1 == null)){
return null;
} else {
return G__51302__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__51306 = c;
var G__51306__$1 = (((G__51306 == null))?null:G__51306.prototype);
if((G__51306__$1 == null)){
return null;
} else {
return G__51306__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__51412__delegate = function (args){
var G__51324 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__51324) : reagent.impl.component.as_element.call(null,G__51324));
};
var G__51412 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__51413__i = 0, G__51413__a = new Array(arguments.length -  0);
while (G__51413__i < G__51413__a.length) {G__51413__a[G__51413__i] = arguments[G__51413__i + 0]; ++G__51413__i;}
  args = new cljs.core.IndexedSeq(G__51413__a,0,null);
} 
return G__51412__delegate.call(this,args);};
G__51412.cljs$lang$maxFixedArity = 0;
G__51412.cljs$lang$applyTo = (function (arglist__51414){
var args = cljs.core.seq(arglist__51414);
return G__51412__delegate(args);
});
G__51412.cljs$core$IFn$_invoke$arity$variadic = G__51412__delegate;
return G__51412;
})()
;})(c,f,_,res))
:res);
...
var _STAR_current_component_STAR__orig_val__51325 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__51326 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__51326);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__51325);
}});
...
var c = this;
var G__51341_51419 = goog.object.get(c,"cljsRatom");
if((G__51341_51419 == null)){
} else {
reagent.ratom.dispose_BANG_(G__51341_51419);
}
...
var renders_51421 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_51422 = cljs.core.first(cljs.core.vals(renders_51421));
...
if((cljs.core.count(renders_51421) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_51421))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_51422)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_51422], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__51352 = o;
var G__51353_51426 = G__51352;
var G__51354_51427 = cljs.core.name(k);
var G__51355_51428 = v;
goog.object.set(G__51353_51426,G__51354_51427,G__51355_51428);
...
var G__51365_51432 = cmp.prototype;
var G__51366_51433 = module$node_modules$react$index.Component.prototype;
var G__51367_51434 = methods$;
goog.object.extend(G__51365_51432,G__51366_51433,G__51367_51434);
...
var name = (function (){var G__51374 = fiber;
var G__51374__$1 = (((G__51374 == null))?null:G__51374.type);
if((G__51374__$1 == null)){
return null;
} else {
return G__51374__$1.displayName;
}
})();
var parent = (function (){var G__51375 = fiber;
if((G__51375 == null)){
return null;
} else {
return G__51375.return;
}
})();
var path = (function (){var G__51376 = parent;
var G__51376__$1 = (((G__51376 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__51376) : reagent.impl.component.fiber_component_path.call(null,G__51376)));
if((G__51376__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__51376__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4185__auto__ = (function (){var G__51379 = c;
if((G__51379 == null)){
return null;
} else {
return goog.object.get(G__51379,"_reactInternalFiber");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__51380._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4185__auto__ = (function (){var G__51383 = c;
if((G__51383 == null)){
return null;
} else {
return goog.object.get(G__51383,"_reactInternalInstance");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var or__4185__auto____$1 = (function (){var G__51386 = c;
if((G__51386 == null)){
return null;
} else {
return G__51386._reactInternalInstance;
}
})();
if(cljs.core.truth_(or__4185__auto____$1)){
return or__4185__auto____$1;
...
var elem = (function (){var or__4185__auto__ = (function (){var G__51391 = instance;
if((G__51391 == null)){
return null;
} else {
return goog.object.get(G__51391,"_currentElement");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var G__51393 = instance;
if((G__51393 == null)){
return null;
} else {
return G__51393._currentElement;
}
}
})();
var name = (function (){var G__51394 = elem;
var G__51394__$1 = (((G__51394 == null))?null:G__51394.type);
if((G__51394__$1 == null)){
return null;
} else {
return G__51394__$1.displayName;
}
})();
var owner = (function (){var or__4185__auto__ = (function (){var G__51396 = elem;
if((G__51396 == null)){
return null;
} else {
return goog.object.get(G__51396,"_owner");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__51397._owner;
}
}
})();
var path = (function (){var G__51398 = owner;
var G__51398__$1 = (((G__51398 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__51398) : reagent.impl.component.component_path.call(null,G__51398)));
if((G__51398__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__51398__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__51402 = c;
var G__51402__$1 = (((G__51402 == null))?null:G__51402.constructor);
if((G__51402__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__51402__$1);
}
}
})();
