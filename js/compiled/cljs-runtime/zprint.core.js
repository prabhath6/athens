...
var vec__51971 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__51974 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51974,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51974,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51971,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51971,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__51977){
var vec__51978 = p__51977;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51978,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51978,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51981,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51981,(1),null);
...
var vec__51985 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51985,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51985,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51985,(2),null);
var vec__51988 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51988,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51988,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51988,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__51997){
var vec__51998 = p__51997;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51998,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51998,(1),null);
...
var len__4789__auto___52072 = arguments.length;
var i__4790__auto___52073 = (0);
while(true){
if((i__4790__auto___52073 < len__4789__auto___52072)){
args__4795__auto__.push((arguments[i__4790__auto___52073]));

var G__52074 = (i__4790__auto___52073 + (1));
i__4790__auto___52073 = G__52074;
continue;
} else {
}
break;
...
var vec__52005 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52005,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52005,(1),null);
...
var G__52008 = zprint.core.parse_string_all_options(rest_options);
var G__52009 = zprint.core.zprint_str_internal;
var G__52010 = ":parse-string-all? call";
var G__52011 = (function (){var G__52012 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__52012) : zprint.zutil.edn_STAR_.call(null,G__52012));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__52008,G__52009,G__52010,G__52011) : zprint.core.process_multiple_forms.call(null,G__52008,G__52009,G__52010,G__52011));
} else {
throw (new Error(":parse-string-all? requires a string!"));
}
} else {
var actual_options = zprint.core.determine_options(rest_options);
var vec__52013 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52013,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52013,(1),null);
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq52001){
var G__52002 = cljs.core.first(seq52001);
var seq52001__$1 = cljs.core.next(seq52001);
var G__52003 = cljs.core.first(seq52001__$1);
var seq52001__$2 = cljs.core.next(seq52001__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52002,G__52003,seq52001__$2);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___52083 = arguments.length;
var i__4790__auto___52084 = (0);
while(true){
if((i__4790__auto___52084 < len__4789__auto___52083)){
args__4795__auto__.push((arguments[i__4790__auto___52084]));

var G__52085 = (i__4790__auto___52084 + (1));
i__4790__auto___52084 = G__52085;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq52018){
...
var args__4795__auto__ = [];
var len__4789__auto___52086 = arguments.length;
var i__4790__auto___52087 = (0);
while(true){
if((i__4790__auto___52087 < len__4789__auto___52086)){
args__4795__auto__.push((arguments[i__4790__auto___52087]));

var G__52088 = (i__4790__auto___52087 + (1));
i__4790__auto___52087 = G__52088;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint_str.cljs$lang$applyTo = (function (seq52020){
...
var args__4795__auto__ = [];
var len__4789__auto___52089 = arguments.length;
var i__4790__auto___52090 = (0);
while(true){
if((i__4790__auto___52090 < len__4789__auto___52089)){
args__4795__auto__.push((arguments[i__4790__auto___52090]));

var G__52091 = (i__4790__auto___52090 + (1));
i__4790__auto___52090 = G__52091;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq52022){
var G__52023 = cljs.core.first(seq52022);
var seq52022__$1 = cljs.core.next(seq52022);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52023,seq52022__$1);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___52093 = arguments.length;
var i__4790__auto___52094 = (0);
while(true){
if((i__4790__auto___52094 < len__4789__auto___52093)){
args__4795__auto__.push((arguments[i__4790__auto___52094]));

var G__52095 = (i__4790__auto___52094 + (1));
i__4790__auto___52094 = G__52095;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq52024){
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__52027,form){
var vec__52028 = p__52027;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52028,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52028,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52028,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52028,(3),null);
var comment_QMARK_ = zprint.zutil.zcomment_QMARK_(form);
var whitespace_form_QMARK_ = zprint.zutil.whitespace_QMARK_(form);
var vec__52031 = (cljs.core.truth_((function (){var and__4174__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4174__auto__)){
if((indent === (0))){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52031,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52031,(1),null);
...
var forms = (function (){var G__52036 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__52036) : zprint.zutil.edn_STAR_.call(null,G__52036));
})();
