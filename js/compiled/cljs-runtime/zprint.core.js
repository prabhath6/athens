...
var vec__31816 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__31819 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31819,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31819,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31816,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31816,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31829,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31829,(1),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__31848){
var vec__31849 = p__31848;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31849,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31849,(1),null);
...
var vec__31860 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31860,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31860,(1),null);
...
var G__31863 = zprint.core.parse_string_all_options(rest_options);
var G__31864 = zprint.core.zprint_str_internal;
var G__31865 = ":parse-string-all? call";
var G__31866 = (function (){var G__31867 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__31867) : zprint.zutil.edn_STAR_.call(null,G__31867));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__31863,G__31864,G__31865,G__31866) : zprint.core.process_multiple_forms.call(null,G__31863,G__31864,G__31865,G__31866));
} else {
throw (new Error(":parse-string-all? requires a string!"));
}
} else {
var actual_options = zprint.core.determine_options(rest_options);
var vec__31868 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31868,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31868,(1),null);
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq31852){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31853,G__31854,seq31852__$2);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___31920 = arguments.length;
var i__4790__auto___31921 = (0);
while(true){
if((i__4790__auto___31921 < len__4789__auto___31920)){
args__4795__auto__.push((arguments[i__4790__auto___31921]));

var G__31922 = (i__4790__auto___31921 + (1));
i__4790__auto___31921 = G__31922;
continue;
} else {
}
break;
...
var forms = (function (){var G__31895 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__31895) : zprint.zutil.edn_STAR_.call(null,G__31895));
})();
