...
var vec__61070 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__61073 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61073,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61073,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61070,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61070,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__61076){
var vec__61077 = p__61076;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61077,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61077,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61080,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61080,(1),null);
...
var vec__61084 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61084,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61084,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61084,(2),null);
var vec__61087 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61087,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61087,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61087,(2),null);
...
var G__61090 = special_option;
var G__61090__$1 = (((G__61090 instanceof cljs.core.Keyword))?G__61090.fqn:null);
switch (G__61090__$1) {
case "explain":
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__61091){
var vec__61092 = p__61091;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61092,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61092,(1),null);
...
var len__4789__auto___61170 = arguments.length;
var i__4790__auto___61171 = (0);
while(true){
if((i__4790__auto___61171 < len__4789__auto___61170)){
args__4795__auto__.push((arguments[i__4790__auto___61171]));

var G__61183 = (i__4790__auto___61171 + (1));
i__4790__auto___61171 = G__61183;
continue;
} else {
}
break;
...
var vec__61101 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61101,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61101,(1),null);
...
var G__61106 = zprint.core.parse_string_all_options(rest_options);
var G__61107 = zprint.core.zprint_str_internal;
var G__61108 = ":parse-string-all? call";
var G__61109 = (function (){var G__61110 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__61110) : zprint.zutil.edn_STAR_.call(null,G__61110));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__61106,G__61107,G__61108,G__61109) : zprint.core.process_multiple_forms.call(null,G__61106,G__61107,G__61108,G__61109));
} else {
throw (new Error(":parse-string-all? requires a string!"));
}
} else {
var actual_options = zprint.core.determine_options(rest_options);
var vec__61114 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61114,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61114,(1),null);
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq61097){
var G__61098 = cljs.core.first(seq61097);
var seq61097__$1 = cljs.core.next(seq61097);
var G__61099 = cljs.core.first(seq61097__$1);
var seq61097__$2 = cljs.core.next(seq61097__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__61098,G__61099,seq61097__$2);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___61185 = arguments.length;
var i__4790__auto___61186 = (0);
while(true){
if((i__4790__auto___61186 < len__4789__auto___61185)){
args__4795__auto__.push((arguments[i__4790__auto___61186]));

var G__61187 = (i__4790__auto___61186 + (1));
i__4790__auto___61186 = G__61187;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq61119){
var G__61120 = cljs.core.first(seq61119);
var seq61119__$1 = cljs.core.next(seq61119);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__61120,seq61119__$1);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___61189 = arguments.length;
var i__4790__auto___61190 = (0);
while(true){
if((i__4790__auto___61190 < len__4789__auto___61189)){
args__4795__auto__.push((arguments[i__4790__auto___61190]));

var G__61191 = (i__4790__auto___61190 + (1));
i__4790__auto___61190 = G__61191;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint_str.cljs$lang$applyTo = (function (seq61121){
var G__61122 = cljs.core.first(seq61121);
var seq61121__$1 = cljs.core.next(seq61121);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__61122,seq61121__$1);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___61192 = arguments.length;
var i__4790__auto___61193 = (0);
while(true){
if((i__4790__auto___61193 < len__4789__auto___61192)){
args__4795__auto__.push((arguments[i__4790__auto___61193]));

var G__61194 = (i__4790__auto___61193 + (1));
i__4790__auto___61193 = G__61194;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq61123){
var G__61124 = cljs.core.first(seq61123);
var seq61123__$1 = cljs.core.next(seq61123);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__61124,seq61123__$1);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___61195 = arguments.length;
var i__4790__auto___61196 = (0);
while(true){
if((i__4790__auto___61196 < len__4789__auto___61195)){
args__4795__auto__.push((arguments[i__4790__auto___61196]));

var G__61197 = (i__4790__auto___61196 + (1));
i__4790__auto___61196 = G__61197;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq61125){
var G__61126 = cljs.core.first(seq61125);
var seq61125__$1 = cljs.core.next(seq61125);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__61126,seq61125__$1);
}));
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__61131,form){
var vec__61132 = p__61131;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61132,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61132,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61132,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61132,(3),null);
var comment_QMARK_ = zprint.zutil.zcomment_QMARK_(form);
var whitespace_form_QMARK_ = zprint.zutil.whitespace_QMARK_(form);
var vec__61135 = (cljs.core.truth_((function (){var and__4174__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4174__auto__)){
if((indent === (0))){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61135,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61135,(1),null);
...
var forms = (function (){var G__61145 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__61145) : zprint.zutil.edn_STAR_.call(null,G__61145));
})();
